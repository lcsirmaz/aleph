...
static void a_1138(int a_F1,int a_A[1]); /* boxclassifier */
static int a_1139=0; /* calledrule */
static int a_1140=0; /* callstack */
static void a_1141(int a_A[1]); /* calltracearg */
static void a_1142(int a_A[1]); /* calltracecall */
static void a_1143(int a_F1); /* charfiledeclaration */
static void a_1144(int a_F1); /* charfileinitialization */
static int a_1145(int a_F1,int a_A[1]); /* checkBUFFERno */
static void a_1146(void); /* closetarget */
static void a_1147(void); /* constitem */
static void a_1148(int a_F1,int a_F2,int a_F3); /* copyaffix */
static void a_1149(int a_F1,int a_F2,int a_F3); /* copytextfromBUFFER */
static void a_1150(int a_F1,int a_A[1]); /* countfilearea */
static void a_1151(void); /* createrulenametable */
static void a_1152(void); /* datadeclaration */
static void a_1153(int a_F1); /* datafiledeclaration */
static void a_1154(int a_F1); /* datafileinitialization */
static void a_1155(void); /* datainitialization */
static void a_1156(int a_F1,int a_F2,int a_F3); /* declarecallargs */
static void a_1157(int a_F1,int a_F2,int a_F3); /* declarelocals */
static void a_1158(void); /* deletetarget */
static void a_1159(int a_F1,int a_F2,int a_F3); /* extensionblock */
static void a_1160(int a_A[1]); /* fillitem */
static int a_1161(int a_A[1]); /* fillrepeater */
static void a_1162(void); /* filltablehead */
static void a_1163(void); /* filltabletail */
static int a_1164=0; /* filltotal */
static void a_1165(int a_A[1]); /* findBUFFERalternative */
static void a_1166(int a_F1,int a_A[1]); /* findBUFFERversion */
static void a_1167(void); /* findsync */
...
static int a_1177(int a_F1); /* iscompletearea */
static int a_1178(int a_F1); /* isdummyaffix */
static int a_1179(int a_F1,int a_F2,int a_F3); /* isrulediscarded */
static void a_1180(int a_F1); /* jumptolabel */
static int a_1181=0; /* lastprofile */
static void a_1182(int a_F1,int a_F2); /* listdeclaration */
static void a_1183(int a_F1); /* listinitialization */
static void a_1184(int a_F1); /* localargument */
static int a_1185=0; /* moduleroots */
static void a_1186(int a_A[1]); /* nextaffix */
static int a_1187=0; /* nextnodeidx */
...
static void a_1200(int a_F1,int a_F2); /* printintindex */
...
static void a_1205(void); /* procwaitfor */
...
static int a_1217=0; /* rootasync */
static void a_1218(int a_F1); /* rootprototype */
static void a_1219(int a_F1,int a_F2); /* ruleargs */
static void a_1220(int a_F1,int a_F2,int a_F3,int a_F4,int a_F5,int a_F6,int a_F7); /* ruledeclarationhead */
static void a_1221(int a_F1); /* ruledeclarationtail */
static void a_1222(int a_F1); /* ruleprototype */
static void a_1223(int a_F1,int a_A[1]); /* ruletyper */
static void a_1224(int a_F1); /* showformalsascomment */
static void a_1225(void); /* skipfillinitializer */
static void a_1226(int a_F1); /* startrulebody */
static void a_1227(int a_F1,int a_A[2]); /* storerulename */
static void a_1228(void); /* targetmain */
static int a_1229=0; /* targetopened */
static void a_1230(void); /* targetpostlude */
static void a_1231(void); /* targetprelude */
static int a_1232=0; /* thisrule */
...
static int a_1236=0; /* waitforasync */
...
-1}; /* fill table size 2492 */
static void a_data_setup(void){
 a_virtual_min=16777216;a_virtual_max=2130706432;
 a_setup_list(0,a_1001,"@StringTable",1,2130705001,2130706359,1359); /* @StringTable */
 a_setup_list(1,a_1005,"NUMBER",1,2075075350,2130704999,0); /* NUMBER */
 a_setup_list(1,a_1022,"REGISTER",1,2047260524,2075075348,0); /* REGISTER */
 a_setup_list(1,a_1041,"NODE",6,1741296766,2019445010,0); /* NODE */
 a_setup_list(1,a_1042,"ZONE",3,2019445698,2047260520,0); /* ZONE */
 a_setup_list(1,a_1240,"EXPRESSION",1,1546592985,1741296759,0); /* EXPRESSION */
 a_setup_list(1,a_1311,"AUX",6,712148226,990296470,0); /* AUX */
 a_setup_list(1,a_1312,"ITEM",8,990296484,1546592976,0); /* ITEM */
 a_setup_list(1,a_1391,"FILES",3,128036792,155851614,0); /* FILES */
 a_setup_list(0,a_1430,"MESSAGE",1,2019445017,2019445694,678); /* MESSAGE */
 a_setup_list(0,a_1456,"BOLD",1,16777217,16777486,270); /* BOLD */
 a_setup_list(1,a_1457,"BUFFER",1,72407139,128036788,0); /* BUFFER */
 a_setup_list(1,a_1458,"HASH",1,16777488,72407137,0); /* HASH */
 a_setup_list(1,a_1461,"LEXT",2,155851619,712148218,101); /* LEXT */
 a_setup_stdarg(a_1504,"STDARG",1);
 a_setup_charfile(a_1118,"TARGET",2,a_1001,2130706056); /* TARGET */
 a_setup_charfile(a_1431,"PRINTFILE",2,a_1001,2130706308); /* PRINTFILE */
 a_setup_charfile(a_1462,"SOURCE",1,a_1001,2130706355); /* SOURCE */
 a_list_fill(a_FILL);
}
...
int a_L1;int a_P[1];
 a_waitfor(a_1001,2130705018); a_1026(1,a_1005,0,a_P);a_L1=a_P[0];
a_1017(a_L1,a_P);a_1020=a_P[0];
if(a_equal(to_LIST(a_1005)->alwb,to_LIST(a_1005)->aupb)){ goto a_G6;}
a_1437(a_1001,2130705013); return;
...
a_1478(); return;
a_G8:a_1432(a_1001,2130705065); return;
} /* findasyncrules */
...
a_L2=a_1472;
a_1478(); goto a_G5;
a_G4:a_1432(a_1001,2130705022); return;
...
a_1478();
a_1432(a_1001,2130705059); return;
...
a_1478(); return;
a_G6:a_1432(a_1001,2130705054); return;
} /* rulesection */
static void a_1104(void){ /* skiprule */
...
a_L4=2; goto a_G26;
a_G22:a_1432(a_1001,2130705049); return;
...
a_G11:a_P[0]=2019445031;a_P[1]=a_A[0];a_P[2]=a_L4;a_P[3]=a_L5;a_1433(4,a_P);
a_G12:if(!a_equal(16777442,a_1471)){ goto a_G14;}
a_1478(); goto a_G6;
a_G14:a_1083(a_F1);
if(a_is(a_L3)){ return;}
a_P[0]=2019445044;a_P[1]=a_A[0];a_1433(2,a_P); return;
} /* checkarea */
static void a_1047(void){ /* checkareas */
...
a_1478(); goto a_G6;
a_G13:a_1432(a_1001,2130705022); return;
a_G14:if(!a_1053(a_L1)){ goto a_G18;}
a_1099(2048);
if(a_more(a_L3,1)){ goto a_G20;}
a_P[0]=2019445069;a_P[1]=a_L2;a_1433(2,a_P); goto a_G20;
a_G18:a_P[0]=2019445057;a_P[1]=a_L2;a_1453(2,a_P);
a_1114=1;
...
a_L1=a_1472;
a_1478(); goto a_G6;
a_G5:a_1432(a_1001,2130705022); return;
...
a_1432(a_1001,2130705042); return;
} /* advancenode */
...
a_1478();
a_1432(a_1001,2130705037); return;
...
a_1478();
a_1432(a_1001,2130705032); return;
...
a_1478(); goto a_G23;
a_G22:a_1432(a_1001,2130705022); return;
a_G23:if(!a_equal(16777455,a_1471)){ goto a_G22;}
 goto a_G4;
a_G25:a_1432(a_1001,2130705027); return;
} /* skipaffix */
...
a_L2=a_1472;
a_1478(); goto a_G9;
a_G8:a_1432(a_1001,2130705022); return;
...
a_1478(); goto a_G17;
a_G16:a_1432(a_1001,2130705022); return;
...
a_1478(); goto a_G26;
a_G25:a_1432(a_1001,2130705022); return;
...
a_1478(); goto a_G16;
a_G15:a_1432(a_1001,2130705022); return;
...
a_L2=a_1472;
a_1478(); goto a_G7;
a_G6:a_1432(a_1001,2130705022); return;
...
a_1478(); goto a_G1;
a_G10:a_1432(a_1001,2130705022); return;
...
a_1478(); goto a_G1;
a_G9:a_1432(a_1001,2130705022); return;
...
a_1096();
a_G34:a_1060();
a_1220(a_L1,a_1039,a_1040,a_1114,a_L3,a_L4,a_1078);
a_unstackto(a_1457,a_L2);
a_1487();
a_1115=0;
a_1097();
if(!a_is(a_1079)){ goto a_G42;}
a_P[0]=2019445083;a_P[1]=to_LIST(a_1312)->offset[a_L1-4];a_P[2]=to_LIST(a_1312)->offset[a_L1-3];a_P[3]=to_LIST(a_1312)->offset[a_1079-4];a_1433(4,a_P); return;
a_G42:a_1226(a_1072);
a_1487();
a_1115=0;
a_1098();
a_1221(a_1072); return;
} /* makerule */
static void a_1189(void){ /* opentarget */
int a_L1;int a_P[3];
a_1405();
...
a_P[0]=2019445097;a_P[1]=to_LIST(a_1461)->aupb;a_P[2]=a_L1;a_1433(3,a_P); return;
} /* opentarget */
static void a_1146(void){ /* closetarget */

if(a_equal(a_1229,0)){ return;}
a_closefile(a_1118);
a_1229=0; return;
} /* closetarget */
static void a_1158(void){ /* deletetarget */
...
static void a_1184(int a_F1){ /* localargument+>a */

a_putchar(a_1118,97);
a_putchar(a_1118,76);
a_1198(a_F1); return;
} /* localargument */
static void a_1200(int a_F1,int a_F2){ /* printintindex+>a+>a */
...
int a_L2;int a_L3;int a_L4;int a_P[1];
a_L2=0;a_L4=0;
a_G2:a_1338(a_1232,a_L2,a_P);a_L3=a_P[0];
a_incr(a_L2);
if(a_equal(a_L3,16777376)){ goto a_G6;}
if(!a_equal(a_L3,16777382)){ goto a_G9;}
a_G6:if(!a_equal(a_L2,a_F1)){ goto a_G8;}
a_1200(65,a_L4); return;
a_G8:a_incr(a_L4); goto a_G2;
a_G9:if(!a_equal(a_L3,16777388)){ goto a_G20;}
a_incr(a_L2);
a_subtr(a_F1,a_L2,a_L2);
if(!a_less(a_L2,0)){ goto a_G15;}
a_putchar(a_1118,97);
a_putchar(a_1118,67); return;
a_G15:if(!a_equal(a_L2,0)){ goto a_G17;}
a_1501(a_1118,a_1001,2130706052); return;
a_G17:a_1501(a_1118,a_1001,2130706047);
a_1198(a_L2);
a_putchar(a_1118,93); return;
a_G20:if(!a_equal(a_L2,a_F1)){ goto a_G2;}
a_putchar(a_1118,97);
a_putchar(a_1118,70);
a_1198(a_F1); return;
} /* formalargument */
...
{register int a_r1=to_LIST(a_1312)->offset[a_F1-6];
 ...
 if(a_r1==16777349){ goto a_G3;}
  goto a_G4;}
a_G2:a_1203(to_LIST(a_1312)->offset[a_F1]); return;
...
a_1202(to_LIST(a_1312)->offset[a_F1]); return;
...
{ if(a_F1==0||a_F1==-1){ goto a_G2;}
 if(a_F1==-2){ goto a_G5;}
  goto a_G6;}
a_G2:if(!a_1350(a_1232,512)){ goto a_G4;}
a_1501(a_1118,a_1001,2130706042); return;
a_G4:a_1501(a_1118,a_1001,2130706037); return;
a_G5:a_1501(a_1118,a_1001,2130706032); return;
a_G6:a_1501(a_1118,a_1001,2130706027);
a_1198(a_F1);
a_1501(a_1118,a_1001,2130706023); return;
} /* printgoto */
static void a_1194(int a_F1){ /* printGOTO+>a */

if(!a_equal(a_F1,a_1187)){ goto a_G3;}
if(a_noteq(a_1187,0)){ return;}
...
{register int a_r1=to_LIST(a_1457)->offset[a_F1];
 ...
 if(a_r1==16777475){ goto a_G10;}
  goto a_G12;}
a_G2:a_incr(a_F1);
a_1204(to_LIST(a_1457)->offset[a_F1]); return;
a_G4:a_incr(a_F1);
a_1198(to_LIST(a_1457)->offset[a_F1]); return;
a_G6:a_incr(a_F1);
a_1184(to_LIST(a_1457)->offset[a_F1]); return;
a_G8:a_incr(a_F1);
a_1202(to_LIST(a_1457)->offset[a_F1]); return;
a_G10:a_incr(a_F1);
a_1169(to_LIST(a_1457)->offset[a_F1]); return;
a_G12:a_1437(a_1001,2130706018); return;
} /* printBUFFER */
...
a_1501(a_1118,a_1001,2130706013); return;
a_G12:a_1437(a_1001,2130706009); return;
} /* printptr */
...
a_1501(a_1118,a_1001,2130705991);
a_1198(a_F1);
a_putchar(a_1118,10);
a_1437(a_1001,2130705986); return;
} /* TE */
...
a_add(a_L3,1,a_L2);
a_G4:if(a_less(to_LIST(a_1457)->aupb,a_L2)){ goto a_G43;}
...
a_1501(a_1118,a_1001,2130705983); goto a_G7;
a_G24:a_1119(4); return;
a_G25:if(a_C<=1){ goto a_G28;} a_C--;a_V+=1;
if(a_equal(a_V[0],0)){ goto a_G7;}
a_1501(a_1118,a_1001,2130705979); goto a_G7;
...
a_1119(11); return;
a_G45:a_unstackto(a_1457,a_L3); return;
} /* T */
static void a_1141(int a_A[1]){ /* calltracearg+a> */
int a_P[1];
if(!a_equal(a_1140,0)){ goto a_G3;}
a_A[0]=0; return;
a_G3:a_P[0]=2130705975;a_1117(a_1001,1,a_P);
a_A[0]=1; return;
} /* calltracearg */
static void a_1142(int a_A[1]){ /* calltracecall+a> */
int a_P[1];
if(!a_equal(a_1140,0)){ goto a_G3;}
a_A[0]=0; return;
a_G3:a_P[0]=2130705972;a_1117(a_1001,1,a_P);
a_A[0]=1; return;
} /* calltracecall */
static void a_1131(int a_F1){ /* addcallstack+>a */
int a_P[2];
if(a_equal(a_1140,0)){ return;}
a_P[0]=2130705968;a_P[1]=to_LIST(a_1312)->offset[a_F1-2];a_1117(a_1001,2,a_P); return;
} /* addcallstack */
static void a_1234(void){ /* usecallstack */
...
a_P[0]=2130705957;a_P[1]=1;a_P[2]=1;a_1117(a_1001,3,a_P);
...
a_P[0]=2130705939;a_P[1]=to_LIST(a_1312)->offset[a_L1-5];a_1117(a_1001,2,a_P); goto a_G2;
a_G7:a_P[0]=2130705933;a_P[1]=a_L1;a_P[2]=to_LIST(a_1312)->offset[a_L1-5];a_1117(a_1001,3,a_P); goto a_G2;
a_G8:a_P[0]=2130705927;a_P[1]=155851707;a_1117(a_1001,2,a_P);
a_P[0]=2130705923;a_P[1]=a_1140;a_1117(a_1001,2,a_P);
a_P[0]=2130705914;a_P[1]=a_1171;a_1117(a_1001,2,a_P);
if(!a_1419(0,a_P)){ goto a_G18;}
a_P[0]=2130705905;a_1117(a_1001,1,a_P);
a_L1=0;
a_G14:if(!a_1419(a_L1,a_P)){ goto a_G17;}a_L2=a_P[0];
a_putchar(a_1118,a_L2);
a_incr(a_L1); goto a_G14;
a_G17:a_P[0]=2130705899;a_1117(a_1001,1,a_P);
a_G18:a_L1=0;
a_G19:a_P[0]=a_L1;if(!a_1340(1,a_P)){ goto a_G21;}a_L1=a_P[0];a_L2=a_P[1];
a_P[0]=2130705927;a_P[1]=a_L2;a_1117(a_1001,2,a_P); goto a_G19;
a_G21:a_P[0]=2130705895;a_P[1]=155851685;a_P[2]=155851692;a_1117(a_1001,3,a_P); return;
} /* targetprelude */
static void a_1230(void){ /* targetpostlude */
int a_L1;int a_L2;int a_P[2];
a_L1=0;
a_G2:a_P[0]=a_L1;if(!a_1340(0,a_P)){ goto a_G4;}a_L1=a_P[0];a_L2=a_P[1];
a_P[0]=2130705927;a_P[1]=a_L2;a_1117(a_1001,2,a_P); goto a_G2;
a_G4:a_P[0]=2130705927;a_P[1]=155851713;a_1117(a_1001,2,a_P); return;
} /* targetpostlude */
static void a_1235(int a_F1){ /* vardeclaration+>a */
int a_P[4];
if(a_1350(a_F1,16)){ return;}
a_P[0]=2130705881;a_P[1]=a_F1;a_P[2]=to_LIST(a_1312)->offset[a_F1-1];a_P[3]=a_F1;a_1117(a_1001,4,a_P); return;
} /* vardeclaration */
static void a_1182(int a_F1,int a_F2){ /* listdeclaration+>a+>a */
int a_L3;int a_L4;int a_L5;int a_L6;int a_P[8];
if(!a_1350(a_F2,16)){ goto a_G4;}
a_1334(a_F2,a_P);a_L3=a_P[0];
a_P[0]=2130705874;a_P[1]=a_F2;a_P[2]=a_F1;a_P[3]=a_F2;a_P[4]=a_L3;a_1117(a_1001,5,a_P); return;
a_G4:a_1334(a_F2,a_P);a_L3=a_P[0];
a_1345(a_F2,a_P);a_L5=a_P[0];
a_1344(a_F2,a_P);a_L4=a_P[0];
a_1337(a_F2,a_P);a_L6=a_P[0];
a_P[0]=2130705861;a_P[1]=a_F2;a_P[2]=a_F1;a_P[3]=a_F2;a_P[4]=a_L3;a_P[5]=a_L4;a_P[6]=a_L5;a_P[7]=a_L6;a_1117(a_1001,8,a_P); return;
} /* listdeclaration */
static void a_1143(int a_F1){ /* charfiledeclaration+>a */
int a_L2;int a_L3;int a_L4;int a_P[6];
if(!a_1350(a_F1,16)){ goto a_G3;}
a_P[0]=2130705847;a_P[1]=a_F1;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
...
a_G11:a_P[0]=2130705835;a_P[1]=a_F1;a_P[2]=a_F1;a_P[3]=a_L2;a_P[4]=a_L3;a_P[5]=a_L4;a_1117(a_1001,6,a_P); return;
} /* charfiledeclaration */
static void a_1153(int a_F1){ /* datafiledeclaration+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_P[7];
if(!a_1350(a_F1,16)){ goto a_G3;}
a_P[0]=2130705822;a_P[1]=a_F1;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
a_G3:if(!a_1350(a_F1,64)){ goto a_G5;}
a_L2=2; goto a_G6;
a_G5:a_L2=0;
a_G6:if(!a_1350(a_F1,32)){ goto a_G8;}
a_incr(a_L2);
a_G8:a_1336(a_F1,a_P);a_L3=a_P[0];a_L4=a_P[1];
a_1150(a_F1,a_P);a_L5=a_P[0];
if(!a_1350(a_L3,8)){ goto a_G12;}
a_L3=to_LIST(a_1312)->offset[a_L3];
a_G12:a_P[0]=2130705809;a_P[1]=a_F1;a_P[2]=a_F1;a_P[3]=a_L2;a_P[4]=a_L3;a_P[5]=a_L4;a_P[6]=a_L5;a_1117(a_1001,7,a_P); return;
} /* datafiledeclaration */
static void a_1222(int a_F1){ /* ruleprototype+>a */
int a_P[1];
if(!a_1350(a_F1,12288)){ goto a_G4;}
if(!a_1352(a_F1)){ return;}
a_1237=1; return;
a_G4:if(a_1349(a_F1,a_P)){ return;}
if(a_1350(a_F1,16384)){ return;}
if(!a_1351(a_F1)){ return;}
a_1315(2,a_F1); return;
} /* ruleprototype */
static void a_1218(int a_F1){ /* rootprototype+>a */

if(a_equal(to_LIST(a_1312)->offset[a_F1-5],155851718)){ return;}
a_incr(a_1185); return;
} /* rootprototype */
static void a_1151(void){ /* createrulenametable */
int a_L1;int a_L2;int a_L3;int a_P[2];
a_P[0]=2130705795;a_1117(a_1001,1,a_P);
a_L1=to_LIST(a_1312)->alwb;
a_L2=0;a_L3=0;
if(!a_is(a_1140)){ goto a_G9;}
if(!a_more(a_1185,0)){ goto a_G9;}
if(!a_is(a_1237)){ goto a_G9;}
a_P[0]=2130705788;a_1117(a_1001,1,a_P);
a_L2=1;a_L3=1;
...
a_P[0]=a_L2;a_P[1]=a_L3;a_1227(a_L1,a_P);a_L2=a_P[0];a_L3=a_P[1]; goto a_G11;
a_G14:a_P[0]=2130705783;a_1117(a_1001,1,a_P); return;
} /* createrulenametable */
static void a_1227(int a_F1,int a_A[2]){ /* storerulename+>a+>a>+>a> */
int a_P[2];
if(a_1350(a_F1,16)){ return;}
if(a_1349(a_F1,a_P)){ return;}
if(a_1350(a_F1,16384)){ return;}
if(a_is(a_1140)){ goto a_G6;}
if(!a_1350(a_F1,117440512)){ return;}
a_G6:a_P[0]=a_A[0];a_1136(a_P);a_A[0]=a_P[0];
a_P[0]=2130705779;a_P[1]=a_F1;a_1117(a_1001,2,a_P);
...
a_G7:a_1182(0,a_L1); goto a_G4;
a_G8:a_1182(1,a_L1); goto a_G4;
a_G9:a_1143(a_L1); goto a_G4;
a_G10:a_1153(a_L1); goto a_G4;
a_G11:a_1222(a_L1); goto a_G4;
a_G12:a_L2=0;
...
static void a_1162(void){ /* filltablehead */
int a_P[1];
a_P[0]=2130705775;a_1117(a_1001,1,a_P);
a_1164=0; return;
} /* filltablehead */
static void a_1163(void){ /* filltabletail */
int a_P[2];
a_P[0]=2130705768;a_P[1]=a_1164;a_1117(a_1001,2,a_P); return;
} /* filltabletail */
static void a_1233(int a_A[1]){ /* untilnextcomma+>a> */

a_G1:if(!a_more(a_A[0],to_LIST(a_1457)->aupb)){ goto a_G3;}
a_1437(a_1001,2130705758); return;
...
static int a_1161(int a_A[1]){ /* fillrepeater+a> */
int a_L2;int a_P[1];
...
a_L2=a_1472;
a_1478(); goto a_G10;
a_G9:a_1432(a_1001,2130705069); return 1;
...
a_1478(); goto a_G1;
a_G6:a_1432(a_1001,2130705069); return;
} /* skipfillinitializer */
static void a_1172(void){ /* generatefillentries */
...
a_L1=a_1472;
a_1478(); goto a_G5;
a_G4:a_1432(a_1001,2130705069); return;
...
a_1478();
a_incr(a_1164);
a_P[0]=2130705749;a_P[1]=a_L1;a_P[2]=a_L1;a_1117(a_1001,3,a_P);
a_L2=to_LIST(a_1457)->aupb;
a_L3=0;
a_G14:if(!a_equal(16777439,a_1471)){ goto a_G16;}
a_1478(); goto a_G25;
a_G16:a_1160(a_P);a_L4=a_P[0];
if(!a_1161(a_P)){ goto a_G23;}a_L5=a_P[0];
a_1168(a_L3,a_L4,a_L2);
a_P[0]=2130705744;a_P[1]=a_L5;a_1117(a_1001,2,a_P);
a_incr(a_1164);
a_unstackto(a_1457,a_L2);
a_L3=0; goto a_G24;
a_G23:a_add(a_L3,a_L4,a_L3);
a_G24:a_1225(); goto a_G14;
a_G25:a_1168(a_L3,0,a_L2);
a_unstackto(a_1457,a_L2);
a_incr(a_1164);
a_P[0]=2130705740;a_1117(a_1001,1,a_P); return;
} /* generatefillentries */
static void a_1183(int a_F1){ /* listinitialization+>a */
int a_L2;int a_P[4];
if(!a_1350(a_F1,16)){ return;}
a_1344(a_F1,a_P);a_L2=a_P[0];
a_P[0]=2130705736;a_P[1]=a_L2;a_P[2]=a_F1;a_P[3]=a_F1;a_1117(a_1001,4,a_P); return;
} /* listinitialization */
static void a_1144(int a_F1){ /* charfileinitialization+>a */
int a_P[4];
if(!a_1350(a_F1,16)){ goto a_G3;}
a_P[0]=2130705736;a_P[1]=to_LIST(a_1312)->offset[a_F1-1];a_P[2]=a_F1;a_P[3]=a_F1;a_1117(a_1001,4,a_P); return;
a_G3:a_P[0]=2130705730;a_P[1]=a_F1;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
} /* charfileinitialization */
static void a_1150(int a_F1,int a_A[1]){ /* countfilearea+>a+a> */
int a_L3;int a_P[1];
a_A[0]=1;
...
static void a_1154(int a_F1){ /* datafileinitialization+>a */
int a_L2;int a_L3;int a_L4;int a_P[4];
if(!a_1350(a_F1,16)){ goto a_G3;}
a_P[0]=2130705736;a_P[1]=to_LIST(a_1312)->offset[a_F1-1];a_P[2]=a_F1;a_P[3]=a_F1;a_1117(a_1001,4,a_P); return;
a_G3:a_P[0]=2130705723;a_P[1]=a_F1;a_1117(a_1001,2,a_P);
a_L4=0;
a_L3=1;
a_G6:a_1335(a_F1,a_L3,a_P);a_L2=a_P[0];
if(!a_equal(a_L2,0)){ goto a_G9;}
a_P[0]=2130705717;a_P[1]=a_F1;a_1117(a_1001,2,a_P); return;
a_G9:if(!a_1350(a_L2,8)){ goto a_G11;}
a_L2=to_LIST(a_1312)->offset[a_L2];
a_G11:a_P[0]=a_L4;a_1136(a_P);a_L4=a_P[0];
a_P[0]=2130705712;a_P[1]=a_L2;a_1117(a_1001,2,a_P);
a_incr(a_L3); goto a_G6;
} /* datafileinitialization */
static void a_1155(void){ /* datainitialization */
int a_L1;int a_P[1];
a_P[0]=2130705709;a_1117(a_1001,1,a_P);
a_L1=to_LIST(a_1312)->alwb;
...
a_G12:{register int a_r1=to_LIST(a_1312)->offset[a_L1-6];
 ...
 if(a_r1==16777345){ goto a_G14;}
  goto a_G11;}
a_G13:a_1144(a_L1); goto a_G11;
a_G14:a_1154(a_L1); goto a_G11;
} /* datainitialization */
static void a_1167(void){ /* findsync */
int a_L1;int a_L2;int a_P[2];
a_L1=0;
a_G2:a_P[0]=a_L1;if(!a_1340(2,a_P)){ return;}a_L1=a_P[0];a_L2=a_P[1];
if(!a_1350(a_L2,2048)){ goto a_G2;}
if(!a_equal(to_LIST(a_1312)->offset[a_L2-5],155851718)){ goto a_G6;}
a_1217=1; goto a_G2;
a_G6:a_1236=1; goto a_G2;
} /* findsync */
static void a_1205(void){ /* procwaitfor */
int a_L1;int a_L2;int a_L3;int a_L4;int a_P[6];
a_P[0]=2130705695;a_1117(a_1001,1,a_P);
a_P[0]=2130705686;a_P[1]=a_1236;a_1117(a_1001,2,a_P);
if(!a_equal(a_1140,0)){ goto a_G5;}
a_P[0]=2130705678;a_1117(a_1001,1,a_P); goto a_G6;
a_G5:a_P[0]=2130705673;a_1117(a_1001,1,a_P);
a_G6:a_L1=0;
a_G7:a_P[0]=a_L1;if(!a_1340(2,a_P)){ goto a_G19;}a_L1=a_P[0];a_L2=a_P[1];
a_L3=to_LIST(a_1312)->offset[a_L2-5];
if(a_equal(a_L3,155851718)){ goto a_G7;}
if(!a_1350(a_L2,2048)){ goto a_G12;}
a_L4=1; goto a_G13;
a_G12:a_L4=0;
a_G13:a_P[0]=2130705659;a_P[1]=a_L3;a_P[2]=a_L3;a_P[3]=a_L3;a_P[4]=a_L4;a_P[5]=a_L2;a_1117(a_1001,6,a_P);
a_1142(a_P);
a_P[0]=2130705634;a_P[1]=a_L3;a_P[2]=a_L3;a_P[3]=a_L3;a_1117(a_1001,4,a_P);
if(a_equal(a_1140,0)){ goto a_G18;}
a_P[0]=2130705613;a_1117(a_1001,1,a_P);
a_G18:a_P[0]=2130705609;a_1117(a_1001,1,a_P); goto a_G7;
a_G19:a_P[0]=2130705605;a_1117(a_1001,1,a_P); return;
} /* procwaitfor */
static void a_1228(void){ /* targetmain */
int a_L1;int a_L2;int a_L3;int a_L4;int a_L5;int a_P[3];
a_1167();
if(a_equal(a_1237,0)){ goto a_G5;}
if(a_more(a_1185,0)){ goto a_G5;}
a_P[0]=2019445112;a_1453(1,a_P);
a_G5:if(!a_equal(a_1237,0)){ goto a_G7;}
if(a_equal(a_1185,0)){ goto a_G8;}
a_G7:a_1205();
a_G8:a_P[0]=2130705602;a_P[1]=a_1217;a_1117(a_1001,2,a_P);
if(a_equal(a_1140,0)){ goto a_G11;}
a_P[0]=2130705594;a_1117(a_1001,1,a_P);
a_G11:a_1155();
a_L1=0;a_L4=0;
a_G13:a_P[0]=a_L1;if(!a_1340(2,a_P)){ goto a_G16;}a_L1=a_P[0];a_L2=a_P[1];
if(!a_equal(to_LIST(a_1312)->offset[a_L2-5],155851718)){ goto a_G13;}
a_L4=a_L2; goto a_G13;
a_G16:if(a_equal(a_1185,0)){ goto a_G21;}
a_P[0]=2130705583;a_1117(a_1001,1,a_P);
a_1142(a_P);a_L3=a_P[0];
a_P[0]=a_L3;a_1136(a_P);
a_P[0]=2130705578;a_1117(a_1001,1,a_P);
a_G21:if(!a_is(a_L4)){ goto a_G28;}
if(!a_1350(a_L4,2048)){ goto a_G24;}
a_L5=1; goto a_G25;
a_G24:a_L5=0;
a_G25:a_P[0]=2130705574;a_P[1]=a_L5;a_P[2]=a_L4;a_1117(a_1001,3,a_P);
a_1142(a_P);
a_P[0]=2130705570;a_1117(a_1001,1,a_P); return;
a_G28:a_1432(a_1001,2130705566); return;
} /* targetmain */
static void a_1223(int a_F1,int a_A[1]){ /* ruletyper+>a+a> */
int a_L3;int a_P[3];
if(!a_1350(a_F1,2048)){ goto a_G3;}
a_L3=1; goto a_G4;
a_G3:a_L3=0;
a_G4:a_P[0]=2130705561;a_P[1]=a_L3;a_P[2]=a_F1;a_1117(a_1001,3,a_P);
a_1141(a_P);a_A[0]=a_P[0]; return;
} /* ruletyper */
...
a_P[0]=2130705555;a_1117(a_1001,1,a_P); return;
} /* outargs */
static void a_1219(int a_F1,int a_F2){ /* ruleargs+>a+>a */
...
a_P[0]=a_F2;a_1190(a_L6,a_P);a_F2=a_P[0];
a_P[0]=a_F2;a_1136(a_P);
a_P[0]=2130705552;a_1117(a_1001,1,a_P); return;
a_G13:a_P[0]=a_F2;a_1136(a_P);a_F2=a_P[0];
a_P[0]=2130705546;a_P[1]=a_L4;a_1117(a_1001,2,a_P); goto a_G3;
a_G15:a_P[0]=a_F2;a_1190(a_L6,a_P);
a_putchar(a_1118,41); return;
} /* ruleargs */
static void a_1224(int a_F1){ /* showformalsascomment+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
...
{ if(a_L4==16777371){ goto a_G7;}
 ...
 goto a_G13;}
a_G7:a_P[0]=2130705542;a_1117(a_1001,1,a_P); goto a_G3;
a_G8:a_P[0]=2130705539;a_1117(a_1001,1,a_P); goto a_G3;
a_G9:a_P[0]=2130705536;a_1117(a_1001,1,a_P); goto a_G3;
a_G10:a_P[0]=2130705532;a_1117(a_1001,1,a_P); goto a_G3;
a_G11:a_P[0]=2130705528;a_1117(a_1001,1,a_P); goto a_G3;
a_G12:a_P[0]=2130705524;a_1117(a_1001,1,a_P); goto a_G3;
a_G13:a_P[0]=2130705520;a_1117(a_1001,1,a_P); goto a_G3;
} /* showformalsascomment */
static void a_1157(int a_F1,int a_F2,int a_F3){ /* declarelocals+>a+>a+>a */
int a_P[2];
a_G1:if(a_equal(a_F1,0)){ return;}
if(a_more(a_F1,a_F2)){ return;}
if(!a_equal(to_LIST(a_1457)->offset[a_F3],0)){ goto a_G6;}
a_G4:a_incr(a_F1);
a_incr(a_F3); goto a_G1;
a_G6:a_P[0]=2130705517;a_P[1]=a_F1;a_1117(a_1001,2,a_P); goto a_G4;
} /* declarelocals */
static void a_1156(int a_F1,int a_F2,int a_F3){ /* declarecallargs+>a+>a+>a */
int a_L4;int a_P[3];
if(a_equal(a_F2,0)){ goto a_G7;}
a_P[0]=2130705512;a_1117(a_1001,1,a_P);
a_G3:if(!a_equal(a_F2,0)){ goto a_G5;}
a_P[0]=2130705507;a_1117(a_1001,1,a_P); goto a_G7;
a_G5:a_putchar(a_1118,44);
a_decr(a_F2); goto a_G3;
a_G7:if(a_equal(a_F3,0)){ goto a_G10;}
a_1333(a_F1,a_P);a_L4=a_P[0];
a_P[0]=2130705504;a_P[1]=a_F3;a_P[2]=a_L4;a_1117(a_1001,3,a_P);
a_G10:a_putchar(a_1118,10); return;
} /* declarecallargs */
static void a_1220(int a_F1,int a_F2,int a_F3,int a_F4,int a_F5,int a_F6,int a_F7){ /* ruledeclarationhead+>a+>a+>a+>a+>a+>a+>a */
int a_L8;int a_P[2];
a_1232=a_F1;
a_1133();
a_1223(a_F1,a_P);a_L8=a_P[0];
a_1219(a_F1,a_L8);
a_P[0]=2130705494;a_P[1]=to_LIST(a_1312)->offset[a_F1-4];a_1117(a_1001,2,a_P);
a_1224(a_F1);
a_P[0]=2130705490;a_1117(a_1001,1,a_P);
a_add(a_F5,a_F7,a_F7);
a_1157(a_F5,a_F6,a_F7);
a_1156(a_F1,a_F2,a_F3);
a_1131(a_F1);
a_1134(a_F4);
a_1132();
a_1135(); return;
} /* ruledeclarationhead */
static void a_1226(int a_F1){ /* startrulebody+>a */
int a_P[1];
if(a_equal(a_F1,0)){ return;}
a_P[0]=2130705487;a_1117(a_1001,1,a_P); return;
} /* startrulebody */
static void a_1221(int a_F1){ /* ruledeclarationtail+>a */
int a_P[2];
if(!a_equal(a_F1,0)){ goto a_G3;}
a_P[0]=2130705475;a_P[1]=a_1232;a_1117(a_1001,2,a_P); return;
a_G3:a_P[0]=2130705470;a_P[1]=a_1232;a_1117(a_1001,2,a_P); return;
} /* ruledeclarationtail */
static void a_1133(void){ /* addprofilingdef */
int a_L1;int a_L2;int a_P[3];
if(!a_1350(a_1232,33554432)){ return;}
a_L1=to_LIST(a_1312)->offset[a_1232-2];
if(!a_mreq(a_L1,0)){ return;}
a_L2=to_LIST(a_1312)->offset[a_1232];
a_P[0]=2130705465;a_P[1]=a_L2;a_P[2]=a_L1;a_1117(a_1001,3,a_P);
if(!a_equal(a_1181,0)){ goto a_G8;}
a_P[0]=2130705454;a_1117(a_1001,1,a_P); goto a_G9;
a_G8:a_P[0]=2130705450;a_P[1]=a_1181;a_1117(a_1001,2,a_P);
a_G9:a_P[0]=2130705446;a_1117(a_1001,1,a_P);
a_1181=a_L2; return;
} /* addprofilingdef */
static void a_1132(void){ /* addprofilingcount */
int a_P[2];
if(!a_1350(a_1232,33554432)){ return;}
if(!a_mreq(to_LIST(a_1312)->offset[a_1232-2],0)){ return;}
a_P[0]=2130705442;a_P[1]=to_LIST(a_1312)->offset[a_1232];a_1117(a_1001,2,a_P); return;
} /* addprofilingcount */
static void a_1206(void){ /* profilingdeclaration */
int a_P[2];
a_P[0]=2130705435;a_1117(a_1001,1,a_P);
if(!a_equal(a_1181,0)){ goto a_G4;}
a_P[0]=2130705428;a_1117(a_1001,1,a_P); return;
a_G4:a_P[0]=2130705424;a_P[1]=a_1181;a_1117(a_1001,2,a_P); return;
} /* profilingdeclaration */
static void a_1135(void){ /* addtracing */
int a_L1;int a_L2;int a_L3;int a_L4;int a_P[3];
if(!a_1350(a_1232,16777216)){ return;}
if(!a_mreq(to_LIST(a_1312)->offset[a_1232-2],0)){ return;}
a_1342(a_1232,a_P);a_L1=a_P[0];
a_L3=0;a_L2=0;
a_G5:if(a_mreq(a_L3,a_L1)){ goto a_G10;}
a_1338(a_1232,a_L3,a_P);a_L4=a_P[0];
a_incr(a_L3);
if(a_equal(a_L4,16777376)){ goto a_G5;}
a_incr(a_L2); goto a_G5;
a_G10:a_P[0]=2130705419;a_P[1]=to_LIST(a_1312)->offset[a_1232-2];a_P[2]=a_L2;a_1117(a_1001,3,a_P);
a_L3=0;
...
a_G18:a_P[0]=2130705412;a_1117(a_1001,1,a_P); return;
} /* addtracing */
static void a_1134(int a_F1){ /* addrulename+>a */
int a_P[2];
if(a_equal(a_F1,0)){ return;}
if(a_mreq(to_LIST(a_1312)->offset[a_1232-2],0)){ return;}
a_P[0]=2130705408;a_P[1]=a_1232;a_1117(a_1001,2,a_P); return;
} /* addrulename */
...
a_P[0]=2130705399;a_P[1]=a_F1;a_1117(a_1001,2,a_P); return;
} /* Tlabel */
static void a_1180(int a_F1){ /* jumptolabel+>a */
int a_P[2];
if(a_equal(a_F1,a_1187)){ return;}
a_P[0]=2130705394;a_P[1]=a_F1;a_1117(a_1001,2,a_P); return;
} /* jumptolabel */
...
{register int a_r1=to_LIST(a_1457)->offset[a_A[0]];
 ...
 if(a_r1==16777448){ goto a_G5;}
  goto a_G7;}
a_G2:a_P[0]=2130705390;a_P[1]=a_A[0];a_1117(a_1001,2,a_P);
a_G3:a_incr(a_A[0]);
a_incr(a_A[0]); return;
a_G5:a_incr(a_A[0]);
...
a_incr(a_A[0]);
a_P[0]=2130705387;a_P[1]=a_A[0];a_P[2]=a_L2;a_1117(a_1001,3,a_P); goto a_G3;
} /* Taffixinner */
...
{ if(a_F1==16777231){ goto a_G2;}
 ...
 if(a_F1==16777299){ goto a_G6;}
  goto a_G7;}
a_G2:a_A[0]=2019445116; return;
a_G3:a_A[0]=2019445120; return;
a_G4:a_A[0]=2019445124; return;
a_G5:a_A[0]=2019445128; return;
a_G6:a_A[0]=2019445132; return;
a_G7:a_1437(a_1001,2130705383); return;
} /* Tlimittail */
static void a_1125(int a_A[1]){ /* Tindex+>a> */
int a_L2;int a_P[3];
if(!a_1350(a_1232,67108864)){ goto a_G15;}
a_P[0]=2130705378;a_P[1]=a_A[0];a_P[2]=a_A[0];a_1117(a_1001,3,a_P);
a_incr(a_A[0]);
a_incr(a_A[0]);
...
a_P[0]=2130705370;a_P[1]=a_L2;a_1117(a_1001,2,a_P);
a_G11:a_P[0]=2130705367;a_P[1]=to_LIST(a_1312)->offset[a_1232-2];a_1117(a_1001,2,a_P);
if(!a_equal(a_1140,0)){ goto a_G14;}
a_P[0]=2130705364;a_1117(a_1001,1,a_P); return;
a_G14:a_P[0]=2130705361;a_1117(a_1001,1,a_P); return;
a_G15:a_P[0]=2130705356;a_P[1]=a_A[0];a_P[2]=a_A[0];a_1117(a_1001,3,a_P);
a_incr(a_A[0]);
a_incr(a_A[0]);
a_P[0]=a_A[0];a_1121(a_P);a_A[0]=a_P[0];
a_incr(a_A[0]);
...
a_P[0]=2130705349;a_1117(a_1001,1,a_P); return;
a_G24:a_P[0]=2130705346;a_P[1]=a_L2;a_1117(a_1001,2,a_P); return;
} /* Tindex */
static void a_1159(int a_F1,int a_F2,int a_F3){ /* extensionblock+>a+>a+>a */
...
a_incr(a_L4);
a_P[0]=2130705342;a_P[1]=a_F1;a_P[2]=2019445135;a_P[3]=a_L5;a_1117(a_1001,4,a_P); goto a_G6;
a_G10:a_1120(a_F3);
...
a_incr(a_F1);
a_L3=a_F1;
a_P[0]=2130705336;a_P[1]=2019445135;a_P[2]=a_L3;a_P[3]=a_L4;a_1117(a_1001,4,a_P);
if(a_equal(a_1140,0)){ goto a_G8;}
a_P[0]=2130705613;a_1117(a_1001,1,a_P);
a_G8:a_P[0]=2130705327;a_1117(a_1001,1,a_P);
a_add(2,a_F1,a_F1);
a_G10:a_1159(a_L3,a_L4,a_F1);
a_F1=to_LIST(a_1457)->offset[a_F1];
if(!a_equal(a_F1,0)){ goto a_G10;}
a_P[0]=2130705324;a_P[1]=a_L3;a_P[2]=a_L4;a_1117(a_1001,3,a_P);
a_1180(a_F2); return;
} /* Textension */
...
static void a_1138(int a_F1,int a_A[1]){ /* boxclassifier+>a+a> */
int a_P[2];
{register int a_r1=to_LIST(a_1457)->offset[a_F1];
 if(!(a_r1==16777471||a_r1==16777479||a_r1==16777475||a_r1==16777459)){ goto a_G3;}
}
a_A[0]=a_F1; return;
a_G3:a_A[0]=2019445135;
a_P[0]=2130705318;a_P[1]=a_A[0];a_1117(a_1001,2,a_P);
a_1120(a_F1);
a_P[0]=2130705313;a_1117(a_1001,1,a_P); return;
} /* boxclassifier */
static int a_1177(int a_F1){ /* iscompletearea+>a */
...
a_P[0]=2130705310;a_P[1]=a_F3;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
a_G3:if(!a_1188(a_F1,a_1019)){ goto a_G5;}
a_P[0]=2130705306;a_P[1]=a_F3;a_P[2]=a_F2;a_1117(a_1001,3,a_P); return;
a_G5:if(!a_1188(a_F2,a_1018)){ goto a_G7;}
a_P[0]=2130705302;a_P[1]=a_F3;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
a_G7:a_P[0]=2130705298;a_P[1]=a_F1;a_P[2]=a_F3;a_P[3]=a_F3;a_P[4]=a_F2;a_1117(a_1001,5,a_P); return;
} /* Tsingleifcondition */
...
a_P[0]=2130705291;a_1117(a_1001,1,a_P); goto a_G1;
} /* Tifcondition */
...
a_incr(a_F1);
a_L3=to_LIST(a_1457)->offset[a_F1];
a_P[0]=2130705288;a_1117(a_1001,1,a_P);
a_1124(a_F1,a_F2);
a_P[0]=2130705284;a_P[1]=a_F2;a_1117(a_1001,2,a_P);
if(!a_mreq(to_LIST(a_1312)->offset[a_1232-2],0)){ goto a_G10;}
a_P[0]=2130705277;a_P[1]=to_LIST(a_1312)->offset[a_1232-2];a_1117(a_1001,2,a_P); goto a_G11;
a_G10:a_P[0]=2130705271;a_1117(a_1001,1,a_P);
a_G11:if(a_equal(a_1140,0)){ goto a_G13;}
a_P[0]=2130705613;a_1117(a_1001,1,a_P);
a_G13:a_P[0]=2130705266;a_1117(a_1001,1,a_P);
if(a_equal(a_L3,a_1187)){ return;}
a_P[0]=2130705262;a_P[1]=to_LIST(a_1457)->offset[a_F1];a_1117(a_1001,2,a_P); return;
a_G16:if(!a_1177(a_L5)){ goto a_G31;}
a_incr(a_F1);
a_L3=to_LIST(a_1457)->offset[a_F1];
a_incr(a_L5);
a_L4=to_LIST(a_1457)->offset[a_L5];
if(!a_equal(a_L3,a_1187)){ goto a_G26;}
if(a_equal(a_L3,a_L4)){ return;}
a_P[0]=2130705288;a_1117(a_1001,1,a_P);
a_1124(a_F1,a_F2);
a_P[0]=2130705259;a_P[1]=a_L4;a_1117(a_1001,2,a_P); return;
a_G26:a_P[0]=2130705254;a_1117(a_1001,1,a_P);
a_1124(a_F1,a_F2);
a_P[0]=2130705250;a_P[1]=a_L3;a_1117(a_1001,2,a_P);
if(a_equal(a_L4,a_1187)){ return;}
a_P[0]=2130705262;a_P[1]=a_L4;a_1117(a_1001,2,a_P); return;
a_G31:a_incr(a_F1);
a_P[0]=2130705254;a_1117(a_1001,1,a_P);
a_1124(a_F1,a_F2);
a_P[0]=2130705245;a_P[1]=to_LIST(a_1457)->offset[a_F1];a_1117(a_1001,2,a_P);
a_F1=a_L5; goto a_G1;
} /* Tjumptoareas */
static void a_1122(int a_F1,int a_F2){ /* Tbox+>a+>a */
int a_L3;int a_P[1];
a_P[0]=2130705241;a_1117(a_1001,1,a_P);
a_incr(a_F1);
a_1138(a_F1,a_P);a_L3=a_P[0];
a_incr(a_F2);
a_1126(a_F2,a_L3);
a_P[0]=2130705605;a_1117(a_1001,1,a_P); return;
} /* Tbox */
...
a_1139=a_F1;
a_incr(a_F7);
if(!a_1179(a_F7,a_F3,a_F4)){ goto a_G5;}
a_P[0]=2130705238;a_P[1]=a_F1;a_P[2]=a_F4;a_1117(a_1001,3,a_P); return;
...
int a_L2;int a_L3;int a_L4;int a_P[1];
a_1342(a_1139,a_P);a_L2=a_P[0];
a_L3=0;
a_G3:if(a_mreq(a_L3,a_L2)){ return 0;}
if(!a_1178(a_F1)){ goto a_G7;}
a_G5:a_incr(a_L3);
a_P[0]=a_F1;a_1186(a_P);a_F1=a_P[0]; goto a_G3;
a_G7:a_1338(a_1139,a_L3,a_P);a_L4=a_P[0];
if(a_equal(a_L4,16777376)){ return 1;}
if(a_equal(a_L4,16777382)){ return 1;}
if(a_equal(a_L4,16777388)){ return 1;} goto a_G5;
} /* hasoutaffix */
static int a_1179(int a_F1,int a_F2,int a_F3){ /* isrulediscarded+>a+>a+>a */

if(a_1350(a_1139,256)){ return 0;}
if(a_1350(a_1139,1024)){ return 0;}
if(a_1350(a_1139,32768)){ return 0;}
if(a_1176(a_F1)){ return 0;}
if(!a_1350(a_1139,512)){ return 1;}
if(!a_equal(a_F2,a_F3)){ return 0;} return 1;
} /* isrulediscarded */
static void a_1174(int a_F1,int a_F2){ /* genshiftaffix+>a+>a */
int a_L3;int a_P[4];
a_1333(a_1232,a_P);a_L3=a_P[0];
if(a_equal(a_F1,a_1187)){ goto a_G6;}
if(!a_equal(a_F1,a_F2)){ goto a_G5;}
a_F2=a_1187; goto a_G6;
a_G5:if(!a_noteq(a_F2,a_1187)){ goto a_G7;}
a_G6:a_P[0]=2130705232;a_P[1]=a_L3;a_P[2]=a_F2;a_P[3]=a_F1;a_1117(a_1001,4,a_P); return;
a_G7:a_P[0]=2130705221;a_P[1]=a_F1;a_P[2]=a_L3;a_1117(a_1001,3,a_P); return;
} /* genshiftaffix */
static void a_1173(int a_F1,int a_F2,int a_F3){ /* gengetaffixno+>a+>a+>a */
int a_P[2];
if(!a_noteq(a_F1,2)){ goto a_G3;}
a_1432(a_1001,2130705211); return;
a_G3:if(!a_1178(a_F2)){ goto a_G5;}
a_P[0]=2130705205;a_P[1]=a_F3;a_1117(a_1001,2,a_P); return;
a_G5:a_1120(a_F2);
a_P[0]=2130705201;a_P[1]=a_F3;a_1117(a_1001,2,a_P); return;
} /* gengetaffixno */
...
a_1120(a_F1);
a_P[0]=a_F1;a_1186(a_P);a_F1=a_P[0];
a_P[0]=a_L3;a_1136(a_P);
a_1120(a_F1);
a_P[0]=2130705196;a_P[1]=a_F2;a_1117(a_1001,2,a_P); return;
} /* genwaitfor */
...
a_A[0]=a_F1;
a_A[1]=0; return;
a_G4:a_A[0]=2019445135;
a_P[0]=2130705192;a_P[1]=a_A[0];a_1117(a_1001,2,a_P);
a_1120(a_F1);
a_putchar(a_1118,59);
a_A[1]=1; return;
} /* assignmentsource */
...
a_L5=a_F3;
a_P[0]=a_F3;a_1186(a_P);a_F3=a_P[0];
a_L8=0;
a_L9=1;
...
a_G26:a_P[0]=2130705187;a_P[1]=a_L6;a_1117(a_1001,2,a_P); goto a_G17;
a_G27:if(a_equal(a_F2,0)){ goto a_G29;}
a_P[0]=2130705183;a_P[1]=2019445138;a_P[2]=2019445138;a_P[3]=2019445138;a_P[4]=2019445138;a_P[5]=a_L6;a_1117(a_1001,6,a_P);
a_G29:if(a_equal(a_L7,0)){ goto a_G31;}
a_putchar(a_1118,125);
a_G31:a_P[0]=2130705205;a_P[1]=a_F4;a_1117(a_1001,2,a_P); return;
} /* genassignment */
...
a_G8:a_L7=a_L5;
a_G9:a_1333(a_1139,a_P);a_L6=a_P[0];
a_mult(a_L7,a_L6,a_L7);
a_G11:if(a_equal(a_L7,0)){ goto a_G25;}
a_1338(a_1139,a_L9,a_P);a_L8=a_P[0];
if(a_equal(a_L8,16777376)){ goto a_G19;}
if(!a_more(a_L5,0)){ goto a_G18;}
a_P[0]=2130705170;a_P[1]=a_F4;a_1117(a_1001,2,a_P);
a_G16:a_1120(a_F1);
a_putchar(a_1118,59); goto a_G19;
a_G18:a_P[0]=2130705166;a_P[1]=a_F4;a_1117(a_1001,2,a_P); goto a_G16;
a_G19:a_incr(a_L9);
if(a_less(a_L9,a_F2)){ goto a_G22;}
a_L9=a_F3;
a_G22:a_decr(a_L7);
a_incr(a_F4);
a_P[0]=a_F1;a_1186(a_P);a_F1=a_P[0]; goto a_G11;
...
a_1338(a_1139,a_L3,a_P);a_L5=a_P[0];
a_incr(a_L3);
if(!a_equal(a_L5,16777376)){ goto a_G9;}
a_incr(a_L4);
a_G8:a_P[0]=a_F1;a_1186(a_P);a_F1=a_P[0]; goto a_G3;
a_G9:if(!a_equal(a_L5,16777382)){ goto a_G14;}
a_P[0]=2130705170;a_P[1]=a_L4;a_1117(a_1001,2,a_P);
a_incr(a_L4);
a_1120(a_F1);
...
a_P[0]=2130705146;a_1117(a_1001,1,a_P);
a_G4:a_incr(a_F1);
a_L4=to_LIST(a_1457)->offset[a_F1];
...
a_subtr(0,a_L4,a_L4);
a_P[0]=2130705143;a_P[1]=a_L4;a_1117(a_1001,2,a_P); return;
a_G12:if(!a_equal(a_F2,0)){ goto a_G14;}
a_P[0]=2130705138;a_P[1]=a_L4;a_1117(a_1001,2,a_P); return;
a_G14:a_P[0]=2130705133;a_P[1]=a_L4;a_P[2]=a_F2;a_1117(a_1001,3,a_P); return;
} /* repeatblockcall */
static void a_1213(int a_F1){ /* regularrulecall+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_L6;int a_L7;int a_P[3];
a_1342(a_1139,a_P);a_L2=a_P[0];
a_L7=0;
if(!a_1350(a_1139,2048)){ goto a_G7;}
a_L7=1;
if(a_1350(a_1232,2048)){ goto a_G7;}
a_P[0]=2019445183;a_P[1]=a_1139;a_P[2]=a_1232;a_1433(3,a_P);
a_G7:a_P[0]=2130705128;a_P[1]=a_L7;a_P[2]=a_1139;a_1117(a_1001,3,a_P);
a_L3=0;a_L4=0;
if(!a_1350(a_1139,16)){ goto a_G11;}
a_L5=0; goto a_G12;
a_G11:a_1142(a_P);a_L5=a_P[0];
a_G12:if(!a_equal(a_L3,a_L2)){ goto a_G17;}
if(!a_equal(a_L4,0)){ goto a_G15;}
a_putchar(a_1118,41); return;
a_G15:a_P[0]=a_L5;a_1136(a_P);
a_P[0]=2130705124;a_1117(a_1001,1,a_P); return;
a_G17:a_1338(a_1139,a_L3,a_P);a_L6=a_P[0];
a_incr(a_L3);
if(a_equal(a_L6,16777376)){ goto a_G21;}
if(!a_equal(a_L6,16777382)){ goto a_G23;}
a_G21:a_incr(a_L4);
a_G22:a_P[0]=a_F1;a_1186(a_P);a_F1=a_P[0]; goto a_G12;
...
a_1338(a_1139,a_L7,a_P);a_L9=a_P[0];
if(a_1178(a_F1)){ goto a_G20;}
if(a_equal(a_L9,16777376)){ goto a_G16;}
if(!a_equal(a_L9,16777382)){ goto a_G20;}
a_G16:a_1120(a_F1);
if(!a_more(a_L5,0)){ goto a_G19;}
a_P[0]=2130705121;a_P[1]=a_F4;a_1117(a_1001,2,a_P); goto a_G20;
a_G19:a_P[0]=2130705116;a_P[1]=a_F4;a_1117(a_1001,2,a_P);
a_G20:a_incr(a_L7);
...
a_P[0]=2130705111;a_P[1]=a_L6;a_P[2]=a_F4;a_1117(a_1001,3,a_P); return;
} /* repeatblockpostload */
...
a_G8:if(a_1178(a_F1)){ goto a_G11;}
a_1120(a_F1);
a_P[0]=2130705121;a_P[1]=a_L4;a_1117(a_1001,2,a_P);
a_G11:a_incr(a_L4);
a_G12:a_P[0]=a_F1;a_1186(a_P);a_F1=a_P[0]; goto a_G3;
...
int a_P[1];
if(!a_1350(a_1139,512)){ goto a_G10;}
if(!a_noteq(a_F2,a_1187)){ goto a_G9;}
if(a_equal(a_F3,a_1187)){ goto a_G5;}
if(!a_lseq(a_F2,0)){ goto a_G9;}
a_G5:a_A[0]=2;
if(!a_equal(a_F1,0)){ goto a_G8;}
a_P[0]=2130705095;a_1117(a_1001,1,a_P); return;
a_G8:a_P[0]=2130705091;a_1117(a_1001,1,a_P); return;
...
a_P[0]=2130705088;a_1117(a_1001,1,a_P); return;
a_G3:if(!a_equal(a_F1,2)){ goto a_G5;}
a_P[0]=2130705085;a_P[1]=a_F2;a_1117(a_1001,2,a_P); return;
...
a_P[0]=2130705081;a_P[1]=a_F3;a_P[2]=a_F2;a_1117(a_1001,3,a_P); return;
a_G4:a_P[0]=2130705205;a_P[1]=a_F3;a_1117(a_1001,2,a_P); return;
} /* regularcalld3 */
static void a_1191(int a_F1,int a_A[1]){ /* pidginalttagtailtype+>a+a> */
int a_L3;int a_L4;int a_L5;int a_P[1];
a_1342(a_1139,a_P);a_L3=a_P[0];
a_L4=0;a_A[0]=0;
a_G3:if(a_equal(a_L4,a_L3)){ return;}
a_1338(a_1139,a_L4,a_P);a_L5=a_P[0];
a_incr(a_L4);
...
static int a_1145(int a_F1,int a_A[1]){ /* checkBUFFERno+>a+>a> */
int a_L3;
...
a_G7:a_1148(a_F2,a_F3,a_L4);
a_G8:a_incr(a_F1); goto a_G1;
a_G9:a_subtr(to_LIST(a_1457)->offset[a_F1],97,a_L4);
a_add(10,a_L4,a_L4); goto a_G7;
a_G11:a_incr(a_F1);
if(a_equal(a_1140,0)){ goto a_G1;}
a_1501(a_1118,a_1001,2130705613); goto a_G1;
a_G14:a_incr(a_F1);
if(a_equal(a_1140,0)){ goto a_G1;}
a_1501(a_1118,a_1001,2130705972); goto a_G1;
a_G17:a_putchar(a_1118,to_LIST(a_1457)->offset[a_F1]); goto a_G8;
} /* copytextfromBUFFER */
static void a_1148(int a_F1,int a_F2,int a_F3){ /* copyaffix+>a+>a+>a */
int a_P[4];
if(!a_more(a_F3,a_F1)){ goto a_G3;}
a_P[0]=2019445169;a_P[1]=to_LIST(a_1312)->offset[a_1139];a_P[2]=a_1139;a_P[3]=a_F3;a_1433(4,a_P); return;
a_G3:if(a_equal(a_F3,1)){ goto a_G6;}
a_decr(a_F3);
a_P[0]=a_F2;a_1186(a_P);a_F2=a_P[0]; goto a_G3;
a_G6:a_1120(a_F2); return;
} /* copyaffix */
static void a_1192(int a_F1,int a_F2){ /* pidginrulecall+>a+>a */
int a_L3;int a_L4;int a_L5;int a_P[1];
a_L3=to_LIST(a_1457)->aupb;
a_1470(to_LIST(a_1312)->offset[a_1139],a_P);a_L5=a_P[0];
a_unpackstring(a_1461,a_L5,a_1457);
a_1207(64);
a_L5=a_L3;
a_incr(a_L5);
if(!a_1350(a_1139,8192)){ goto a_G10;}
a_1191(a_F2,a_P);a_L4=a_P[0];
a_P[0]=a_L5;a_1166(a_L4,a_P);a_L5=a_P[0];
a_G10:if(a_noteq(a_F1,2)){ goto a_G12;}
a_P[0]=a_L5;a_1165(a_P);a_L5=a_P[0];
a_G12:a_1342(a_1139,a_P);a_L4=a_P[0];
a_1149(a_L5,a_L4,a_F2);
...
a_G3:a_1432(a_1001,2130706101); return;
} /* checklisttype */
...
a_G3:a_1432(a_1001,2130706095); return;
} /* checkcalibretype */
...
a_G5:a_1432(a_1001,2130706088); return;
} /* checkconstanttype */
static void a_1264(void){ /* readexpression */
int a_L1;int a_L2;int a_P[1];
if(!a_equal(16777471,a_1471)){ goto a_G4;}
a_L1=a_1472;
a_1478(); goto a_G5;
a_G4:a_1432(a_1001,2130706060); return;
a_G5:a_1246(a_L1,1);
if(a_equal(to_LIST(a_1312)->offset[a_L1-1],0)){ goto a_G8;}
a_G7:a_1432(a_1001,2130706081); return;
a_G8:a_1263(a_L1);
...
a_1437(a_1001,2130706075); return;
a_G3:if(a_1350(a_F1,32)){ return;}
if(!a_1350(a_F1,64)){ goto a_G8;}
a_P[0]=2019445197;a_P[1]=to_LIST(a_1312)->offset[a_F1-4];a_P[2]=a_F1;a_1433(3,a_P);
...
a_1432(a_1001,2130706075); return;
...
a_G24:a_1432(a_1001,2130706070); return;
} /* finalbase */
...
int a_L2;int a_L3;int a_P[3];
if(!a_1350(a_F1,8)){ goto a_G3;}
a_1437(a_1001,2130706065); return;
a_G3:if(a_1350(a_F1,32)){ return;}
if(!a_1350(a_F1,64)){ goto a_G8;}
a_P[0]=2019445197;a_P[1]=to_LIST(a_1312)->offset[a_F1-4];a_P[2]=a_F1;a_1433(3,a_P);
...
a_incr(a_1249);
if(a_was(a_1240,a_1249)){ goto a_G14;}
a_1432(a_1001,2130706065); return;
...
int a_L3;int a_L4;int a_L5;int a_P[1];
a_1267(155851685,a_P);a_L3=a_P[0];
a_1267(155851692,a_P);a_L4=a_P[0];
...
a_G3:if(!a_equal(16777486,a_1471)){ goto a_G6;}
a_1478();
a_1432(a_1001,2130706185); return;
a_G6:a_1478(); goto a_G1;
} /* skipentry */
static void a_1304(void){ /* skipdatasection */
...
a_1432(a_1001,2130706180); return;
} /* skipdatasection */
static void a_1278(void){ /* datasectioni */
...
if(a_equal(a_1471,16777285)){ return;}
a_1432(a_1001,2130706174); return;
} /* datasectioni */
...
if(!a_1350(a_F1,24)){ return;}
a_G3:a_1432(a_1001,2130706168); return;
} /* checklisttype */
...
a_G4:a_1432(a_1001,2130706162); return;
} /* checkconstanttype */
...
a_G3:a_1432(a_1001,2130706155); return;
...
if(!a_1350(a_F1,24)){ return;}
a_G3:a_1432(a_1001,2130706147); return;
} /* checkfiletype */
static void a_1283(void){ /* fileentry */
int a_L1;int a_L2;int a_L3;int a_P[1];
if(!a_equal(16777471,a_1471)){ goto a_G4;}
a_L1=a_1472;
a_1478(); goto a_G5;
a_G4:a_1432(a_1001,2130706105); return;
a_G5:a_1272(a_L1);
if(!a_equal(16777455,a_1471)){ goto a_G4;}
a_L2=a_1472;
a_1478();
...
a_L1=a_1472;
a_1478(); goto a_G7;
a_G6:a_1432(a_1001,2130706105); return;
...
a_G8:a_P[0]=2019445213;a_P[1]=to_LIST(a_1312)->offset[a_F1-4];a_P[2]=a_L3;a_P[3]=1000;a_1433(4,a_P); return;
a_G9:if(!a_equal(16777471,a_1471)){ goto a_G12;}
a_L2=a_1472;
a_1478(); goto a_G13;
a_G12:a_1432(a_1001,2130706105); return;
...
a_G10:a_1432(a_1001,2130706141); return;
...
a_G17:a_1432(a_1001,2130706134); return;
...
a_G3:a_P[0]=2019445228;a_P[1]=to_LIST(a_1312)->offset[a_F2-4];a_P[2]=a_F1;a_P[3]=a_F2;a_1453(4,a_P);
a_G4:a_min(100,a_F1);
a_max(1,a_F1);
a_subtr(0,a_F1,a_F1);
...
a_G3:a_P[0]=2019445241;a_P[1]=to_LIST(a_1312)->offset[a_F2-4];a_P[2]=a_F1;a_P[3]=a_F2;a_1453(4,a_P);
...
a_A[0]=1;
a_P[0]=2019445253;a_P[1]=to_LIST(a_1312)->offset[a_F2-4];a_P[2]=to_LIST(a_1312)->offset[a_F1-4];a_P[3]=a_F2;a_1433(4,a_P); return;
} /* getestimator */
static void a_1279(void){ /* datasectionii */
...
a_1437(a_1001,2130706129); return;
} /* datasectionii */
static void a_1282(void){ /* externalentry */
int a_L1;int a_L2;
if(!a_equal(16777471,a_1471)){ goto a_G4;}
...
a_G12:a_1432(a_1001,2130706123); return;
...
a_G9:if(!a_equal(16777471,a_1471)){ goto a_G11;}
 goto a_G7;
a_G11:a_1432(a_1001,2130706105); return;
...
a_G4:a_P[0]=2019445286;a_P[1]=to_LIST(a_1312)->offset[a_F1-4];a_P[2]=a_F2;a_P[3]=a_A[0];a_P[4]=to_LIST(a_1312)->offset[a_F3-4];a_P[5]=1000;a_1433(6,a_P);
a_A[0]=1; return;
a_G6:a_A[0]=1;
a_P[0]=2019445267;a_P[1]=to_LIST(a_1312)->offset[a_F1-4];a_P[2]=a_F2;a_P[3]=to_LIST(a_1312)->offset[a_F3-4];a_1433(4,a_P); return;
} /* repeatervalue */
...
a_L4=a_1472;
a_1478(); goto a_G10;
a_G9:a_1432(a_1001,2130706105); return;
...
if(a_equal(a_1471,16777285)){ return;}
a_1432(a_1001,2130706117); return;
} /* datasectioniii */
...
a_1248();
a_1277(); return;
a_G8:a_P[0]=2019445295;a_1433(1,a_P); return;
...
a_G12:a_1437(a_1001,2130706111); return;
...
a_L5=a_1472;
a_1478(); goto a_G7;
a_G6:a_1432(a_1001,2130706189); return;
a_G7:a_1363(a_L5);
...
a_incr(to_LIST(a_1311)->offset[a_F1-1]);
a_1363(a_L4); return;
a_G20:a_1432(a_1001,2130706222); return;
} /* formalaffixes */
...
a_L2=a_1472;
a_1478(); goto a_G5;
a_G4:a_1432(a_1001,2130706189); return;
...
a_1432(a_1001,2130706216); return;
} /* checkitemID */
static void a_1326(void){ /* enteritem */
int a_L1;int a_P[1];
...
a_1478(); goto a_G6;
a_G5:a_1432(a_1001,2130706189); return;
...
a_G19:a_1432(a_1001,2130706211); return;
...
to_LIST(a_1312)->offset[to_LIST(a_1312)->aupb-5]=155851718;
to_LIST(a_1312)->offset[to_LIST(a_1312)->aupb-4]=155851625;
...
to_LIST(a_1312)->offset[to_LIST(a_1312)->aupb-5]=155851718;
to_LIST(a_1312)->offset[to_LIST(a_1312)->aupb-4]=155851633;
...
to_LIST(a_1312)->offset[to_LIST(a_1312)->aupb-6]=16777349;
to_LIST(a_1312)->offset[to_LIST(a_1312)->aupb-5]=155851718;
to_LIST(a_1312)->offset[to_LIST(a_1312)->aupb-4]=155851641;
...
if(!a_equal(to_LIST(a_1312)->offset[a_F1],155851648)){ return 0;}
...
if(!a_equal(to_LIST(a_1312)->offset[a_F1],155851654)){ return 0;}
...
if(!a_equal(to_LIST(a_1312)->offset[a_F1-4],155851660)){ return 0;}
if(!a_equal(to_LIST(a_1312)->offset[a_F1-6],16777349)){ return 0;}
...
{register int a_r1=to_LIST(a_1312)->offset[a_F1-4];
 if(a_r1==155851633){ goto a_G2;}
 if(a_r1==155851641){ goto a_G3;}
  return 0;}
...
a_P[0]=2019445305;a_P[1]=to_LIST(a_1312)->offset[a_1357-6];a_1433(2,a_P); return;
...
a_G10:a_1432(a_1001,2130706206); return;
...
to_LIST(a_1312)->offset[to_LIST(a_1312)->aupb-4]=a_1472;
a_1478(); goto a_G15;
a_G14:a_1432(a_1001,2130706189); return;
...
a_1478();
a_1320(); goto a_G26;
a_G25:a_1432(a_1001,2130706199); return;
a_G26:a_1356();
if(!a_equal(16777455,a_1471)){ goto a_G14;}
a_L2=a_1472;
a_1478();
if(a_equal(a_L2,32)){ goto a_G32;}
a_P[0]=2019445317;a_1433(1,a_P);
a_G32:a_1360=0;
a_1368();
...
a_P[0]=2019445331;a_P[1]=to_LIST(a_1312)->offset[a_F1-4];a_P[2]=a_F1;a_1433(3,a_P); return;
a_G5:if(!a_1347(a_L2,a_F1)){ goto a_G7;}
a_P[0]=2019445342;a_P[1]=to_LIST(a_1312)->offset[a_F1-4];a_P[2]=a_L2;a_P[3]=a_F1;a_1433(4,a_P); return;
a_G7:if(!a_was(a_1312,to_LIST(a_1312)->offset[a_L2])){ goto a_G10;}
a_1381(a_L2,128);
a_1381(to_LIST(a_1312)->offset[a_L2],4); return;
a_G10:a_1437(a_1001,2130706194); return;
} /* scanitem */
...
a_P[0]=2019445352;a_P[1]=to_LIST(a_1312)->offset[a_F1-4];a_P[2]=to_LIST(a_1312)->offset[a_F1];a_P[3]=a_L4;a_1433(4,a_P); return;
} /* scanitemfordbledef */
static void a_1375(void){ /* scanfordoubledefinitions */
int a_L1;int a_L2;int a_P[1];
...
a_P[0]=2019445323;a_1433(1,a_P); return;
a_G3:a_1346(0);
a_1354=a_1361;
a_G5:a_L1=0;
...
a_P[0]=2019445360;a_P[1]=to_LIST(a_1312)->offset[a_F1-4];a_P[2]=a_F1;a_1453(3,a_P); return;
} /* reportitem */
static void a_1372(void){ /* reportnotusedpublicitems */
int a_L1;int a_L2;int a_P[1];
...
{register int *a_r1=a_extension(a_1391,3);a_r1[0]=a_r1[1]=0;a_r1[2]=a_F1;to_LIST(a_1391)->aupb+=3;}
  return;
a_G4:a_P[0]=2019445633;a_P[1]=200;a_1435(2,a_P); return;
} /* extendFILES */
...
a_P[0]=2019445612;a_1433(1,a_P); return;
a_G6:if(!a_1408(a_1001,2130706272)){ goto a_G8;}
a_P[0]=2019445526;a_P[1]=155851699;a_1438(2,a_P); return;
a_G8:if(!a_1408(a_1001,2130706268)){ goto a_G10;}
a_P[0]=2019445596;a_P[1]=1;a_P[2]=1;a_1438(3,a_P); return;
a_G10:if(!a_1408(a_1001,2130706263)){ goto a_G13;}
a_1396=0;
a_G12:a_previousstring(a_1504,a_1397); goto a_G4;
a_G13:if(!a_1408(a_1001,2130706258)){ goto a_G15;}
a_1171=1; goto a_G12;
a_G15:if(!a_1408(a_1001,2130706254)){ goto a_G20;}
a_previousstring(a_1504,a_1397);
if(!a_less(a_1397,to_LIST(a_1504)->alwb)){ goto a_G19;}
a_P[0]=2019445621;a_P[1]=111;a_1433(2,a_P); return;
a_G19:a_1424=a_1397; goto a_G12;
a_G20:if(!a_1408(a_1001,2130706251)){ goto a_G25;}
a_previousstring(a_1504,a_1397);
if(!a_less(a_1397,to_LIST(a_1504)->alwb)){ goto a_G24;}
a_P[0]=2019445621;a_P[1]=76;a_1433(2,a_P); return;
a_G24:a_1409=a_1397; goto a_G12;
a_G25:if(!a_1408(a_1001,2130706248)){ goto a_G27;}
a_1372(); goto a_G12;
a_G27:if(!a_1408(a_1001,2130706245)){ goto a_G29;}
a_1234(); goto a_G12;
a_G29:if(!a_1402(a_1001,2130706242)){ return;}
...
a_G4:a_1470(155851699,a_P);a_L3=a_P[0];
...
a_G6:a_1437(a_1001,2130706238); return;
} /* stringtoBUFFER */
...
a_1427(a_F1,155851671,a_P);a_A[0]=a_P[0]; return;
...
a_P[0]=2019445642;a_P[1]=a_F1;a_1435(2,a_P); return;
} /* tryopen */
static void a_1415(int a_F1){ /* openfileaslast+>a */
int a_L2;int a_P[2];
if(a_1407(a_F1,8)){ goto a_G3;}
a_1437(a_1001,2130706232); return;
...
a_P[0]=2019445653;a_P[1]=a_F1;a_1435(2,a_P); return;
...
a_L2=a_1472;
a_1478(); goto a_G10;
a_G9:a_1432(a_1001,2130706226); return;
...
a_1441(a_1001,2130706303); return;
...
a_G11:a_1437(a_1001,2130706299); return;
} /* printpointer */
...
a_1437(a_1001,2130706293); return;
...
if(a_lseq(a_L2,0)){ goto a_G4;}
a_1444(a_L2);
a_G4:if(a_equal(a_L3,155851718)){ goto a_G7;}
a_1443(47);
a_1442(a_L3);
a_G7:if(a_equal(a_L4,0)){ return;}
a_1443(32);
a_1441(a_1001,2130706288);
a_1450(a_L4);
a_1443(41); return;
} /* printitem */
...
if(a_lseq(a_L2,0)){ goto a_G4;}
a_1444(a_L2);
a_G4:if(a_equal(a_L3,155851718)){ return;}
a_1443(47);
a_1442(a_L3); return;
} /* printline */
...
a_G14:a_1441(a_1001,2130706283); goto a_G7;
...
a_1439(70);
a_1403(a_P);a_L2=a_P[0];
a_P[0]=2019445689;a_P[1]=a_L2;a_1436(2,a_P);
a_1441(a_F1,a_F2);
a_P[0]=2019445694;a_1436(1,a_P);
a_1440();
a_exit(3); return;
} /* corrupticefile */
...
int a_P[1];
a_1439(70);
a_P[0]=2019445676;a_1436(1,a_P);
a_1441(a_F1,a_F2);
a_P[0]=2019445681;a_1436(1,a_P);
a_1440();
a_exit(15); return;
} /* internalerror */
...
a_G8:a_1432(a_1001,2130706350); return;
...
a_G28:a_1432(a_1001,2130706345); return;
} /* readdestination */
...
a_G16:a_1437(a_1001,2130706339); return;
} /* rehash */
...
a_1477(); goto a_G12;
a_G11:a_1432(a_1001,2130706323); return;
...
a_1477(); goto a_G16;
a_G15:a_1432(a_1001,2130706318); return;
...
a_G16:a_1432(a_1001,2130706350); return;
...
a_G117:a_1432(a_1001,2130706313); return;
} /* nextsymbol */
