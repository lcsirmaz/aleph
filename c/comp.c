...
static int a_1350(int a_A[1]); /* getfirstsource */
static void a_1351(void); /* initprogramargs */
static int a_1352(int a_F1,int a_A[3]); /* iscmdlinepragmat */
static int a_1353=0; /* lastlinenum */
static int a_1354(int a_A[1]); /* nextinput */
static int a_1324(int a_A[3]); /* nextinputentry */
static void a_1357(void); /* readsources */
static void a_1358(void); /* readstdlib */
static void a_1360(int a_F1); /* setpragmats */
static int a_1362(int a_F1,int a_A[1]); /* wassourceadded */
static void a_1363(void); /* @root */
#define a_1364 (a_1340+sizeof_LIST) /* BOLD */
#define a_1011 (a_1364+sizeof_LIST) /* CONST */
#define a_1021 (a_1011+sizeof_LIST) /* LEXT */
static int a_1365=0; /* LEXTcnt */
static int a_1366=0; /* LEXTlen */
static int a_1367=-1; /* LEXTptr */
#define a_1368 (a_1021+sizeof_LIST) /* SOURCE */
#define a_1369 (a_1368+sizeof_CHFILE) /* SPECIAL */
static void a_1370(void); /* addextension */
static int a_1371(int a_A[1]); /* boldletter */
static int a_1372=32; /* char */
static void a_1346(void); /* closesource */
static void a_1298(void); /* createicename */
static void a_1373(int a_F2,int a_F3,int a_A[1]); /* decimaloverflow */
...
static void a_1383(int a_F2,int a_A[1]); /* hexoverflow */
static int a_1385(int a_A[1]); /* letgit */
static void a_1387(void); /* longcomment */
static void a_1388(void); /* nextchar */
static int a_1355(int a_F1,int a_F2); /* nextsource */
static void a_1389(void); /* nextvisiblechar */
static int a_1390(int a_F1,int a_F2); /* opensourcefile */
static int a_1391=0; /* optor */
extern void a_packstring(int a_F1,int a_F2,int a_F3);
static int a_1393=0; /* pchar */
static int a_1394=0; /* ppline */
static void a_1395(int a_A[1]); /* read */
static void a_1396(int a_A[1]); /* readbold */
static void a_1397(int a_A[1]); /* readbuiltin */
...
static void a_1414(int a_F2,int a_A[2]); /* trynextpath */
static void a_1415(int a_F1,int a_A[1]); /* trypath */
static void a_1416(int a_F1,int a_A[1]); /* trytoopen */
...
static int a_1578(int a_F1); /* declaration */
static void a_1579(void); /* externaldeclaration */
static void a_1356(void); /* passI */
static void a_1584(void); /* root */
static int a_1586=0; /* rootscanned */
static void a_1589(void); /* staticdeclaration */
static void a_1591(void); /* tagenquiry */
static void a_1462(void); /* wasrootscanned */
static void a_1593(void); /* @root */
static void a_1594(int a_F1); /* checktagformacro */
static void a_1595(int a_F1); /* checktagforpublic */
static void a_1596(void); /* dreadpragmat */
static void a_1597(int a_F1); /* dstoremacro */
static void a_1457(void); /* passII */
static void a_1458(void); /* passIII */
static void a_1599(void); /* @root */
static int a_1601(int a_A[1]); /* aheadrawtag */
static int a_1602=0; /* bounds */
static void a_1603(void); /* clearlibrary */
static void a_1347(void); /* cmdlinepragmat */
static void a_1604(int a_F1,int a_F2); /* conspragmat2 */
static int a_1605=0; /* count */
static int a_1606=0; /* dicton */
static void a_1607(int a_F1,int a_F2); /* discpragmat */
static void a_1608(int a_F1,int a_F2); /* dopragmatskip */
static void a_1609(int a_F1,int a_F2,int a_A[1]); /* findifcondition */
static void a_1610(void); /* findmatchingendif */
static void a_1113(int a_F1,int a_A[1]); /* getpragmatvalue */
static int a_1611=0; /* givetext */
static int a_1612=0; /* icename */
static int a_1613=0; /* includepath */
static int a_1614=1; /* incompile */
static int a_1615=0; /* inlibrary */
static int a_1616=0; /* inmodule */
static void a_1617(int a_F1); /* insertsymbol */
static int a_1321(int a_F1); /* ispragmatvalue */
static void a_1618(int a_F1,int a_F2); /* markrawtagasmacro */
static void a_1619(int a_F1,int a_F2); /* markrawtagaspublic */
static void a_1620(void); /* nextpragmatsymbol */
static void a_1621(int a_F1,int a_F3,int a_A[1]); /* onoffpragmats */
static int a_1622=0; /* pgmiftag */
static int a_1623=0; /* pgmskip */
static int a_1624=0; /* pgmstate */
static int a_1625=0; /* pgmtag */
static void a_1626(int a_F1); /* pragmatitem */
static void a_1583(int a_A[1]); /* programpragmat */
static void a_1627(int a_A[1]); /* programpragmat2 */
static void a_1628(int a_F1,int a_A[1]); /* programpragmatitem */
static void a_1629(int a_F1,int a_F2,int a_F3,int a_A[1]); /* programtagpragmat2 */
static int a_1630=1516190445; /* programtitle */
static int a_1631=2; /* protolevel */
static void a_1359(void); /* resetpragmats */
static void a_1632(void); /* restoreliblevel */
static int a_1633=120; /* rightmargin */
static int a_1634=0; /* saveproto */
static int a_1635=0; /* savewarning */
static void a_1636(void); /* setliblevel */
static void a_1637(void); /* setlibrary */
static void a_1361(int a_F1,int a_F2); /* setpragmatvalue */
static void a_1638(int a_F1,int a_F2); /* stringpragmat2 */
static int a_1639=8; /* tabwidth */
static void a_1640(int a_F1,int a_F2,int a_F3); /* tagpragmat2 */
static int a_1641=0; /* trace */
static int a_1642=1; /* usestdlib */
static int a_1643=4; /* warninglevel */
static void a_1644(void); /* @root */
static void a_1645(int a_F1); /* addlocalaffix */
static void a_1646(void); /* addlocalaffixes */
static void a_1647(void); /* affixform */
static void a_1648(void); /* alternative */
static void a_1649(void); /* alternativeseries */
static void a_1650(int a_A[1]); /* area */
static void a_1651(void); /* classification */
static void a_1652(void); /* classifier */
static void a_1653(int a_F1); /* closelocalrange */
static void a_1654(void); /* compoundmember */
static void a_1655(int a_F1); /* extension */
static int a_1656=0; /* formalrepeataffix */
static void a_1380(int a_A[1]); /* getruletag */
static void a_1657(int a_F1); /* handleformallist */
static void a_1658(int a_F1); /* indexsource */
static void a_1660(int a_F1); /* listtag */
static int a_1661(void); /* lookingatamember */
static void a_1662(void); /* member */
static void a_1663(int a_F1,int a_A[1]); /* opennewlocalrange */
static void a_1664(int a_A[1]); /* peekaftersource */
static void a_1665(int a_A[1]); /* peeklabel */
static int a_1666(void); /* repeataffix */
static void a_1585(void); /* rootbody */
static void a_1667(int a_F1,int a_F2); /* rulebody */
static void a_1668(int a_F1); /* rulepragmats */
static int a_1669=0; /* ruletag */
static void a_1670(int a_F1); /* searchjump */
static void a_1671(int a_F1,int a_F2); /* selector */
static void a_1672(int a_F1,int a_A[1]); /* setuplocalstack */
static void a_1673(int a_F1); /* skiplabel */
static void a_1674(void); /* skipoveranindex */
static void a_1675(void); /* skipoverdestination */
static void a_1676(int a_F1,int a_A[2]); /* skipoverextension */
static void a_1677(int a_A[1]); /* skipoversource */
static void a_1678(int a_F1); /* source */
static void a_1679(int a_F1); /* sourceorstring */
static void a_1680(int a_F1); /* specialaffixform */
static int a_1681=0; /* suppressmessages */
static int a_1682(void); /* terminator */
static void a_1683(int a_F1); /* toselectors */
static void a_1684(void); /* @root */
static void a_1685(int a_F1,int a_F3,int a_F4,int a_A[2]); /* checkasformal */
static void a_1686(int a_F1,int a_F3,int a_F4,int a_F5,int a_A[2]); /* checkasformallist */
static void a_1687(int a_F1,int a_F2,int a_A[2]); /* checkasformaltableaffix */
static void a_1688(int a_F1,int a_F2,int a_A[1]); /* checkformalaffixes */
static void a_1689(int a_F1,int a_F2,int a_F3,int a_F4,int a_F5,int a_F6,int a_A[1]); /* checkformallistdata */
static void a_1690(int a_F1,int a_F2); /* checkoutaffixes */
static void a_1691(int a_F1,int a_F2,int a_F3,int a_A[1]); /* checkruletype */
static void a_1692(int a_F1,int a_F2,int a_A[1]); /* checkselectorlist */
static void a_1693(int a_F1,int a_F2,int a_A[1]); /* createformalaffixes */
static void a_1694(int a_F1,int a_F2,int a_F3,int a_F4,int a_A[1]); /* createformalselector */
static void a_1695(int a_F1,int a_F3,int a_F4,int a_A[2]); /* defineasformal */
static void a_1696(int a_F1,int a_F3,int a_F4,int a_F5,int a_A[2]); /* defineasformallist */
static void a_1697(int a_F1,int a_F2,int a_A[2]); /* defineasformaltableaffix */
static void a_1698(int a_F1,int a_F2,int a_F3,int a_A[2]); /* defineselectorlist */
static void a_1699(int a_F1,int a_A[1]); /* expectformaltag */
static void a_1700(int a_F1,int a_F2,int a_A[2]); /* formalaffix */
static void a_1701(int a_F1,int a_F2,int a_F4,int a_F5,int a_A[2]); /* formalflataffix */
static void a_1702(int a_F1,int a_F2,int a_F4,int a_A[2]); /* formallistaffix */
static void a_1703(int a_F1,int a_F2,int a_F4,int a_A[2]); /* formaltableaffix */
static void a_1704(int a_A[3]); /* getlisttag */
static void a_1705(int a_A[1]); /* musttag */
static void a_1707(int a_F1,int a_A[2]); /* peekafterformalaffixes */
static int a_1711=0; /* repeatformalaffix */
static void a_1587(int a_F1,int a_F2); /* ruledeclaration */
static void a_1713(int a_F1,int a_F2); /* ruledeclarer */
static void a_1714(int a_F1,int a_F2,int a_F3); /* ruledefinition */
static void a_1715(int a_F1,int a_F2); /* ruledefinitionsequence */
static void a_1716(int a_F1,int a_F2); /* ruleexternaldeclarer */
static void a_1717(int a_F1,int a_F2); /* ruleprototype */
static void a_1718(int a_A[2]); /* skipfieldlist */
static void a_1719(int a_F1,int a_A[1]); /* skipformalaffix */
static void a_1720(int a_F1,int a_A[1]); /* subbus */
static void a_1721(void); /* @root */
#define a_1722 (a_1369+sizeof_LIST) /* RESTORE */
static void a_1419(int a_F1); /* Rskip */
static void a_1345(void); /* advancelinenum */
static int a_1723(void); /* aheadcons */
static void a_1724(int a_A[1]); /* countrestore */
static int a_1725=0; /* dorestore */
...
static int a_1726=1454738204; /* inrestore */
static int a_1430(int a_A[1]); /* iscons */
static int a_1582(int a_A[1]); /* israwtag */
static int a_1260(int a_A[1]); /* isstring */
static int a_1261(int a_A[1]); /* istag */
static int a_1262(int a_A[2]); /* istagdl */
static int a_1727=0; /* linenum */
static void a_1435(void); /* makerestore */
static void a_1263(int a_F1); /* must */
static void a_1077(void); /* nextsymbol */
static int a_1728=0; /* oldinpt */
static int a_1729=0; /* oldlinenum */
static int a_1730=0; /* oldrestore */
static int a_1731=1454738204; /* outrestore */
static int a_1732(void); /* readfromrestore */
static int a_1733=0; /* restorecount */
static void a_1734(void); /* savetorestore */
static void a_1088(int a_F1); /* setlinenum */
static void a_1735(void); /* setsymbolposition */
static void a_1268(void); /* skipall */
static void a_1588(void); /* skipsilently */
static void a_1736(void); /* skipsymbol */
static void a_1269(void); /* skiptopoint */
static void a_1737(void); /* @root */
#define a_1738 (a_1722+sizeof_LIST) /* DICT */
static void a_1739(int a_F1); /* DICTtag */
#define a_1020 (a_1738+sizeof_LIST) /* LADM */
#define a_1022 (a_1020+sizeof_LIST) /* LLOC */
#define a_1740 (a_1022+sizeof_LIST) /* RETAG */
#define a_1039 (a_1740+sizeof_LIST) /* TTAG */
static int a_1280(void); /* Xstringtablefilling */
static void a_1600(int a_F1,int a_F2); /* addDICT */
static void a_1741(int a_F1,int a_F2); /* addlinetoDICT */
static void a_1742(int a_F1,int a_F2); /* addspecialrule */
...
static void a_1743(int a_F1); /* assigntags */
static void a_1294(int a_F1,int a_F2); /* cleartagflag */
static void a_1744(int a_F1); /* enterpredefinedtag */
static void a_1376(int a_F1,int a_A[1]); /* entertag */
static void a_1745(int a_F1,int a_F2); /* expandDICT */
static void a_1746(int a_F1); /* extendBUFFER */
static void a_1747(int a_F1); /* extendDICT */
static void a_1580(int a_F1,int a_A[1]); /* findrawusage */
...
static void a_1581(int a_F1,int a_A[1]); /* gettagentry */
...
static void a_1748(void); /* initrules */
static void a_1749(void); /* initstdstringtable */
static void a_1750(void); /* inittags */
static int a_1659(int a_F1,int a_A[1]); /* isspecialrule */
static int a_1751(int a_F1); /* isspecialtag */
static int a_1205(int a_F1,int a_F2); /* istagflag */
static void a_1598(int a_F1,int a_F2,int a_F3); /* linkmacrorule */
static int a_1752=0; /* macroptr */
static void a_1706(int a_F1,int a_F2,int a_A[1]); /* newformaltag */
static void a_1436(int a_F1,int a_F2); /* newlistentry */
static void a_1264(int a_F1,int a_A[1]); /* newstdstring */
static void a_1753(int a_F1,int a_A[1]); /* newtagentry */
static int a_1469(int a_A[1]); /* nextmacrorule */
static void a_1754(int a_F1,int a_F2,int a_A[1]); /* pack2 */
static void a_1438(int a_F1,int a_F2,int a_A[1]); /* packselector */
static void a_1755(int a_F1); /* printdict */
...
static void a_1708(int a_F1,int a_F2); /* putformalcalibre */
static void a_1709(int a_F1,int a_F2); /* putformalssel */
...
static void a_1710(int a_F1,int a_F2); /* redefinetag */
extern void a_release(int a_F1);
static void a_1712(void); /* restoretags */
static void a_1757(int a_F1); /* reverseDICT */
...
static int a_1759=0; /* stdemptypointer */
static int a_1760=0; /* stdstrings */
static void a_1761(int a_F1,int a_A[2]); /* unpack2 */
static void a_1271(int a_F1); /* usetag */
static int a_1151(int a_F1,int a_F2); /* wastagpointer */
static void a_1762(void); /* @root */
...
static void a_1763(void); /* @root */
static void a_1577(int a_F1); /* constantdeclaration */
static void a_1764(int a_F2,int a_A[1]); /* declaration */
static void a_1765(int a_F1,int a_F2); /* declarationseries */
static void a_1766(int a_F1,int a_F2,int a_F3); /* declarer */
static void a_1767(int a_F1,int a_A[1]); /* expectconstanttag */
static void a_1768(int a_A[1]); /* expectexpression */
static void a_1769(int a_A[1]); /* expectlisttag */
static int a_1770(int a_A[1]); /* exprbase */
static void a_1771(int a_F1,int a_F2,int a_F3); /* externaldeclarer */
static int a_1772(int a_A[1]); /* isexpression */
static void a_1773(int a_F1,int a_F2,int a_F3); /* prototype */
static void a_1590(void); /* staticvariabledeclaration */
static void a_1774(int a_F1,int a_F2); /* tagredefined */
static void a_1592(int a_F1); /* variabledeclaration */
...
-1}; /* fill table size 3844 */
static void a_data_setup(void){
 a_setup_list(0,a_1001,1,16777217,16777505,289); /* @StringTable */
 a_setup_list(1,a_1006,1,2118415548,2130705808,0); /* BUFFER */
 a_setup_list(1,a_1007,2,2106125286,2118415545,0); /* RULE */
 a_setup_list(0,a_1014,1,2106125125,2106125283,159); /* DSYMB */
 a_setup_list(1,a_1026,1,2093834863,2106125123,0); /* QBUFFER */
 a_setup_list(0,a_1023,1,2093832711,2093834861,2151); /* MESSAGE */
 a_setup_list(1,a_1019,6,1848027490,2093832704,0); /* ITEM */
 a_setup_list(1,a_1024,5,1725124874,1848027479,0); /* NODE */
 a_setup_list(1,a_1339,3,1712834608,1725124866,0); /* INPUT */
 a_setup_stdarg(a_1340,1);
 a_setup_list(0,a_1364,3,1454738707,1454738952,248); /* BOLD */
 a_setup_list(1,a_1011,1,1454739123,1516190427,2); /* CONST */
 a_setup_list(1,a_1021,1,1516190429,1712834604,17); /* LEXT */
 a_setup_list(0,a_1369,1,1454738956,1454739121,166); /* SPECIAL */
 a_setup_list(1,a_1722,1,1454738204,1454738703,500); /* RESTORE */
 a_setup_list(1,a_1738,1,16777647,446936781,0); /* DICT */
 a_setup_list(1,a_1020,6,483807579,963127752,42); /* LADM */
 a_setup_list(1,a_1022,6,459227051,483807567,0); /* LLOC */
 a_setup_list(1,a_1740,2,446936784,459227043,0); /* RETAG */
 ...
 a_setup_charfile(a_1368,2,a_1001,16777384); /* SOURCE */
 a_list_fill(a_FILL);
}
...
a_MROOT(a_1363,"lexical")
a_MROOT(a_1418,"lists")
a_MROOT(a_1463,"macros")
a_MROOT(a_1474,"node")
a_MROOT(a_1576,"passi")
a_MROOT(a_1593,"passii")
a_MROOT(a_1599,"pragmats")
a_MROOT(a_1644,"rulebody")
a_MROOT(a_1684,"rules")
a_MROOT(a_1721,"symbols")
a_MROOT(a_1737,"tags")
a_MROOT(a_1762,"types")
a_MROOT(a_1763,"variables")
void a_ROOT(void){
 a_data_setup();
 ...
 a_Ra_1272(0,0); /* ice */
 a_Ra_1338(0,0); /* input */
 a_Ra_1363(0,0); /* lexical */
 a_Ra_1418(0,0); /* lists */
 a_Ra_1463(0,0); /* macros */
 a_Ra_1474(0,0); /* node */
 a_Ra_1576(0,0); /* passi */
 a_Ra_1593(0,0); /* passii */
 a_Ra_1599(0,0); /* pragmats */
 a_Ra_1644(0,0); /* rulebody */
 a_Ra_1684(0,0); /* rules */
 a_Ra_1721(0,0); /* symbols */
 a_Ra_1737(0,0); /* tags */
 a_Ra_1762(0,0); /* types */
 a_Ra_1763(0,0); /* variables */
 a_1454(); /* compiler */
}
static void a_1005(void){ /* @root */
...
a_P[0]=2093832725;a_P[1]=1516190434;a_P[2]=a_L2;a_1040(0,3,a_P);
exit(4);return;
} /* opendisc */
static void a_1042(void){ /* closedisc */
...
if(!__equal(a_1036,2106125166)){ goto a_G7;}
a_1028=0;
a_1031=0;
a_1076();return;
a_G7:if(!__equal(a_1036,2106125159)){ goto a_G11;}
a_1038=0;
__incr(a_1028);
...
a_G1:if(a_1027(2106125166)){return;}
if(a_1025(a_F1)){return;}
a_1076(); goto a_G1;
} /* Qskip */
...
a_G1:{register int a_r1=to_LIST(a_1026)->offset[a_A[0]];
 if(a_r1==2106125235||a_r1==2106125166){ goto a_G2;}
 if(a_r1==2106125159){  goto a_G4;}
  goto a_G7;}
a_G2:__incr(a_A[0]);
a_P[0]=2106125166;a_1080(1,a_P);return;
a_G4:__incr(a_A[0]);
a_P[0]=2106125159;a_P[1]=to_LIST(a_1026)->offset[a_A[0]];a_1080(2,a_P);
...
a_A[0]=a_1036;
if(a_1025(2106125276)){ return 1;}
if(a_1025(2106125280)){ return 1;}
if(a_1025(2106125208)){ return 1;}
if(a_1025(2106125272)){ return 1;}
if(!a_1025(2106125143)){ return 0;} return 1;
} /* limitop */
...
a_P[0]=2106125159;a_P[1]=a_L2;a_1080(2,a_P);
a_G3:a_A[0]=0;return;
a_G4:if(!a_1065(a_P)){ goto a_G8;}a_L2=a_P[0];
a_1074(a_P);a_L3=a_P[0];
a_P[0]=a_L2;a_P[1]=a_L3;a_1080(2,a_P); goto a_G3;
a_G8:if(!a_1025(2106125260)){ goto a_G15;}
a_1074(a_P);a_L3=a_P[0];
a_P[0]=2106125260;a_P[1]=a_L3;a_1080(2,a_P);
a_1049(a_P);a_A[0]=a_P[0];
a_1071(2106125138);
a_1083(a_P);a_L2=a_P[0];
a_P[0]=2106125138;a_P[1]=2106125159;a_P[2]=a_L2;a_1080(3,a_P);return;
a_G15:if(!a_1025(2106125219)){ goto a_G17;}
...
a_P[0]=2106125260;a_P[1]=a_L3;a_P[2]=2106125272;a_P[3]=a_L3;a_P[4]=2106125138;a_P[5]=2106125159;a_P[6]=a_L2;a_1080(7,a_P);return;
...
a_G15:a_P[0]=2106125219;a_1080(1,a_P);
a_G16:a_1050(a_L2,a_P);a_L2=a_P[0];
if(!__equal(a_L2,0)){ goto a_G20;}
a_L6=1;
a_1050(a_F1,a_P);a_L2=a_P[0];
a_G20:if(!a_1025(2106125235)){ goto a_G22;}
a_P[0]=2106125235;a_1080(1,a_P); goto a_G4;
...
a_1059(a_L2,a_L3);
a_P[0]=to_LIST(a_1020)->offset[a_L7-2];a_P[1]=2106125166;a_1080(2,a_P);
a_1050(a_L2,a_P);a_L2=a_P[0];
a_1050(a_L7,a_P);a_L7=a_P[0]; goto a_G24;
a_G33:a_P[0]=2106125166;a_1080(1,a_P);
...
a_G13:a_P[0]=2106125166;a_1080(1,a_P);
...
a_1121(a_F1,a_F2);
a_P[0]=2093832751;a_P[1]=a_F3;a_1111(2,a_P);
exit(256);return;
} /* internalerror */
static void a_1097(void){ /* @root */
...
a_P[0]=2093832775;a_P[1]=a_F1;a_1146(4,2,a_P);
...
a_G17:a_P[0]=2093832764;a_P[1]=a_F1;a_P[2]=to_LIST(a_1022)->offset[a_L2];a_1108(3,a_P);
...
int a_P[1];
if(!a_1025(2106125193)){ goto a_G5;}
a_1074(a_P);a_A[0]=a_P[0];
...
static void a_1234(void){ /* setuplocals */
int a_L1;int a_P[1];
if(!a_1025(2106125204)){return;}
a_G2:if(a_1025(2106125149)){return;}
...
a_P[0]=2093832783;a_P[1]=a_F1;a_1108(2,a_P);return;
...
a_P[0]=2093832808;a_P[1]=a_F3;a_1108(2,a_P);return;
a_G4:a_1243(a_F1,a_F2,a_P);a_L5=a_P[0];
a_P[0]=2093832820;a_P[1]=a_L5;a_P[2]=a_F1;a_P[3]=a_F3;a_P[4]=a_L4;a_1108(5,a_P);return;
} /* mustbeoflisttype */
...
a_P[0]=2093832830;a_P[1]=a_L5;a_P[2]=a_F1;a_P[3]=a_F3;a_1108(4,a_P);return;
} /* checkssel */
...
a_1243(a_F1,a_F2,a_P);a_L5=a_P[0];
a_P[0]=2093832839;a_P[1]=a_L5;a_P[2]=a_F1;a_P[3]=a_L4;a_1108(4,a_P);return;
} /* readselector */
static void a_1236(void){ /* skipsource */
int a_P[1];
if(a_1029(a_P)){return;}
if(a_1025(2106125208)){ goto a_G7;}
if(a_1025(2106125272)){ goto a_G7;}
if(a_1025(2106125276)){ goto a_G7;}
if(a_1025(2106125280)){ goto a_G7;}
if(!a_1025(2106125143)){ goto a_G8;}
a_G7:a_1074(a_P);return;
a_G8:if(!a_1025(2106125260)){ goto a_G14;}
a_1074(a_P);
a_1236();
a_1071(2106125138);
if(a_1029(a_P)){return;} goto a_G7;
a_G14:if(a_1025(2106125219)){return;} goto a_G7;
} /* skipsource */
static void a_1235(void){ /* skipaffixes */
...
a_P[0]=2093832926;a_P[1]=2093832802;a_P[2]=a_F1;a_P[3]=a_F3;a_P[4]=a_L4;a_1108(5,a_P); goto a_G16;
a_G15:a_P[0]=2093832926;a_P[1]=2093832797;a_P[2]=a_F1;a_P[3]=a_F3;a_P[4]=a_L4;a_1146(7,5,a_P);
a_G16:a_1055(a_F2,a_P);a_L4=a_P[0];
if(__equal(a_L4,a_L7)){return;}
if(!a_1205(a_F1,128)){ goto a_G20;}
a_P[0]=2093832939;a_P[1]=2093832802;a_P[2]=a_F1;a_P[3]=a_F3;a_1108(4,a_P);return;
a_G20:a_P[0]=2093832939;a_P[1]=2093832797;a_P[2]=a_F1;a_P[3]=a_F3;a_1146(7,4,a_P);return;
} /* checkcalibre */
...
a_P[0]=2093832952;a_P[1]=a_F1;a_1108(2,a_P);return;
a_G5:a_P[0]=2093832952;a_P[1]=a_F1;a_1108(2,a_P);
a_1236();return;
} /* fshiftaffix */
...
a_G5:if(a_1025(2106125276)){ goto a_G9;}
if(a_1025(2106125280)){ goto a_G9;}
if(a_1025(2106125208)){ goto a_G9;}
if(!a_1025(2106125272)){ goto a_G15;}
a_G9:a_A[0]=0;
...
a_G15:if(!a_1025(2106125143)){ goto a_G22;}
a_A[0]=0;
a_1213(a_P);a_L5=a_P[0];
if(a_1202(a_L5)){ goto a_G20;}
a_1214(a_F1,a_F2,a_L5);
a_G20:if(__equal(a_F3,4530946)){return;} goto a_G14;
a_G22:if(!a_1025(2106125260)){ goto a_G38;}
a_1213(a_P);a_L5=a_P[0];
...
a_G38:if(!a_1025(2106125219)){ goto a_G42;}
a_A[0]=0;
...
a_P[0]=2093832913;a_P[1]=a_L7;a_P[2]=a_F1;a_P[3]=a_L5;a_1146(2,4,a_P);return;
a_G68:if(a_1240(a_F3)){return;}
a_1229(a_L5,8);
if(!a_1205(a_1225,128)){ goto a_G72;}
a_P[0]=2093832967;a_P[1]=a_F1;a_P[2]=a_L5;a_1108(3,a_P);return;
a_G72:if(!a_1204(a_L5,4096)){return;}
a_P[0]=2093832983;a_P[1]=a_F1;a_P[2]=a_L5;a_1108(3,a_P);return;
...
a_G7:a_P[0]=2093832996;a_P[1]=a_F1;a_P[2]=a_L7;a_1108(3,a_P);return;
...
a_G23:a_P[0]=2093833018;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_L5;a_P[4]=a_L6;a_P[5]=a_L7;a_1108(6,a_P);return;
} /* matchrepeataffixes */
...
if(!a_1025(2106125235)){ goto a_G11;}
...
a_P[0]=2093832775;a_P[1]=a_F1;a_P[2]=a_L6;a_1146(4,3,a_P);
...
a_P[0]=2093833031;a_P[1]=a_F1;a_1108(2,a_P);return;
a_G4:if(!a_1205(a_F1,131072)){return;}
a_P[0]=2093833041;a_P[1]=a_F1;a_1108(2,a_P);return;
} /* checkmacrorule */
...
a_P[0]=2093832808;a_P[1]=a_L4;a_1108(2,a_P);
a_G7:a_1235();return;
a_G8:if(!__noteq(a_L5,16777571)){ goto a_G11;}
a_P[0]=2093833050;a_P[1]=a_L4;a_P[2]=a_L5;a_P[3]=a_L10;a_1108(4,a_P); goto a_G7;
a_G11:a_1169(a_L4);
...
if(!a_1027(2106125235)){ goto a_G43;}
if(!__equal(a_L7,0)){ goto a_G29;}
a_P[0]=2093833062;a_P[1]=a_L4;a_P[2]=a_L10;a_1108(3,a_P);
a_1235(); goto a_G43;
...
a_G36:if(!a_1025(2106125235)){ goto a_G42;}
a_1206(a_L4,a_L8,a_L6,a_P);a_L9=a_P[0];
if(!__is(a_L9)){ goto a_G40;}
a_A[2]=1;
a_G40:__incr(a_L8); goto a_G35;
a_G42:a_P[0]=2093833074;a_P[1]=a_L4;a_P[2]=a_L10;a_1108(3,a_P);
...
a_G4:a_P[0]=2093833107;a_P[1]=a_F1;a_1108(2,a_P);return;
...
a_P[0]=2093833124;a_P[1]=a_F1;a_P[2]=a_L4;a_P[3]=a_F2;a_1146(3,4,a_P);return;
} /* checkextensionblock */
static void a_1239(int a_F1,int a_F2){ /* transportdest+>a+>a */
int a_L3;int a_L4;int a_P[3];
a_G1:if(!a_1025(2106125268)){return;}
...
a_P[0]=2093833097;a_P[1]=a_F1;a_P[2]=a_L3;a_1108(3,a_P);
...
a_1239(a_F1,a_F2);
if(a_1025(2106125166)){ goto a_G10;}
if(!a_1025(2106125177)){ goto a_G6;}
...
a_P[0]=2093833085;a_P[1]=a_L1;a_P[2]=a_L2;a_1108(3,a_P);return;
...
a_G15:a_P[0]=2093832808;a_P[1]=a_L1;a_1108(2,a_P);
a_G16:a_1034(2106125177);return;
a_G17:a_P[0]=2093833085;a_P[1]=a_L1;a_P[2]=a_L2;a_1108(3,a_P); goto a_G16;
} /* extension */
static void a_1219(void){ /* readbox */
int a_P[1];
a_1194(0,0,4530946,a_P);
a_1071(2106125135);return;
} /* readbox */
...
a_P[0]=2093832808;a_P[1]=a_F1;a_1108(2,a_P);return;
a_G6:if(!a_1205(a_F1,16)){ goto a_G8;}
a_P[0]=2093833137;a_P[1]=a_F1;a_1108(2,a_P);return;
...
a_G14:a_P[0]=2093833148;a_P[1]=a_F1;a_P[2]=a_L3;a_P[3]=a_L4;a_1108(4,a_P);return;
} /* checkzonemember */
...
__incr(a_L4);
a_G5:if(!a_1025(2106125149)){ goto a_G10;}
...
a_A[0]=1;
a_G13:if(a_1025(2106125254)){ goto a_G1;}
a_1071(2106125131);return;
} /* classifier */
...
if(!a_1025(2106125254)){return;}
a_1231(a_F1);
if(!__is(a_L14)){ goto a_G4;}
a_P[0]=2093833158;a_1108(1,a_P); goto a_G4;
} /* classification */
...
a_A[5]=0;
a_1178(a_F1);
a_G5:if(!a_1025(2106125152)){ goto a_G26;}
if(!__equal(a_A[0],0)){ goto a_G9;}
a_L9=0;
a_P[0]=2093833167;a_1108(1,a_P);
a_G9:if(__equal(a_A[4],0)){ goto a_G13;}
if(__less(a_F1,a_A[4])){ goto a_G13;}
__next(a_1007,a_A[4]);
a_P[0]=2093833175;a_P[1]=to_LIST(a_1007)->offset[a_A[4]];a_1108(2,a_P);
...
a_1231(a_F1);
a_G29:if(!a_1025(2106125254)){ goto a_G36;}
if(__is(a_L14)){ goto a_G32;}
a_P[0]=2093833158;a_1108(1,a_P);
a_G32:if(__equal(a_L16,0)){ goto a_G4;}
if(__less(a_F1,a_L16)){ goto a_G4;}
__next(a_1007,a_L16);
a_P[0]=2093833175;a_P[1]=to_LIST(a_1007)->offset[a_L16];a_1108(2,a_P); goto a_G4;
...
if(!a_1025(2106125135)){ goto a_G12;}
a_1219();
...
a_P[0]=2093833191;a_P[1]=to_LIST(a_1022)->offset[to_LIST(a_1022)->aupb];a_1146(4,2,a_P); goto a_G27;
a_G26:a_P[0]=2093833184;a_P[1]=to_LIST(a_1022)->offset[to_LIST(a_1022)->aupb];a_1146(4,2,a_P);
...
a_P[0]=2093833198;a_P[1]=a_F1;a_1146(3,2,a_P);
...
a_G13:a_P[0]=2093833208;a_P[1]=a_F1;a_1108(2,a_P); goto a_G33;
a_G14:if(__is(a_L2)){ goto a_G17;}
a_L4=0;
a_P[0]=2093833216;a_P[1]=a_F1;a_1108(2,a_P);
a_G17:if(!__is(a_L3)){ goto a_G20;}
if(a_1205(a_F1,512)){ goto a_G23;}
a_P[0]=2093833223;a_P[1]=a_F1;a_1108(2,a_P); goto a_G23;
a_G20:a_L5=0;
if(!a_1205(a_F1,512)){ goto a_G23;}
a_P[0]=2093833231;a_P[1]=a_F1;a_1108(2,a_P);
a_G23:if(!__is(a_L4)){ goto a_G26;}
if(a_1205(a_F1,256)){ goto a_G29;}
a_P[0]=2093833241;a_P[1]=a_F1;a_1108(2,a_P); goto a_G29;
a_G26:if(__equal(a_L2,0)){ goto a_G29;}
if(!a_1205(a_F1,256)){ goto a_G29;}
a_P[0]=2093833252;a_P[1]=a_F1;a_1146(6,2,a_P);
a_G29:if(!__is(a_L5)){ goto a_G33;}
if(!a_1205(a_F1,256)){ goto a_G32;}
a_P[0]=2093833266;a_P[1]=a_F1;a_1146(5,2,a_P); goto a_G33;
a_G32:a_P[0]=2093833266;a_P[1]=a_F1;a_1108(2,a_P);
...
a_P[0]=2093833277;a_P[1]=a_F1;a_P[2]=a_L7;a_1146(2,3,a_P); goto a_G41;
a_G40:a_P[0]=2093833277;a_P[1]=a_F1;a_P[2]=a_L7;a_1146(4,3,a_P);
...
a_P[0]=2093833291;a_P[1]=a_F1;a_1146(4,2,a_P);
if(!a_1205(a_F1,65536)){ goto a_G61;}
a_P[0]=2093833351;a_P[1]=a_F1;a_1108(2,a_P); goto a_G61;
a_G48:a_L6=0;
if(a_1204(to_LIST(a_1022)->aupb,8)){ goto a_G61;}
a_P[0]=2093833305;a_P[1]=a_F1;a_P[2]=a_L7;a_1146(3,3,a_P); goto a_G61;
a_G51:a_L6=a_L3;
if(!a_1204(to_LIST(a_1022)->aupb,8)){ goto a_G61;}
a_P[0]=2093833320;a_P[1]=a_F1;a_P[2]=a_L7;a_1146(2,3,a_P); goto a_G61;
a_G54:a_L6=a_L3;
if(a_1204(to_LIST(a_1022)->aupb,2)){ goto a_G61;}
a_P[0]=2093833335;a_P[1]=a_F1;a_P[2]=a_L7;a_1108(3,a_P); goto a_G61;
a_G57:a_L6=a_L3;
if(a_1204(to_LIST(a_1022)->aupb,8)){ goto a_G61;}
a_P[0]=2093833364;a_P[1]=a_F1;a_P[2]=a_L7;a_1146(3,3,a_P); goto a_G61;
a_G60:a_L6=0;
...
a_L8=9; goto a_G66;
a_G65:a_L8=2;
a_G66:a_P[0]=2093833379;a_P[1]=a_F1;a_P[2]=a_L7;a_1146(a_L8,3,a_P);
a_G67:__unstack(a_1022); goto a_G33;
a_G68:a_1071(2106125238);return;
} /* dcheckrule */
static void a_1154(void){ /* @root */
...
a_P[0]=2093833405;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_L4;a_P[4]=a_L3;a_1108(5,a_P);return;
a_G5:a_P[0]=2093833415;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_L4;a_1108(4,a_P);return;
} /* tagredefined */
static void a_1255(int a_F1,int a_A[2]){ /* expectpath+>a+a>+a> */
int a_P[2];
a_A[1]=0;
if(!__equal(1454739046,a_1062)){ goto a_G5;}
a_1077();
__incr(a_A[1]);
a_G5:if(a_1260(a_P)){a_A[0]=a_P[0]; goto a_G8;}
a_A[0]=1516190441;
a_P[0]=2093833454;a_P[1]=a_F1;a_1108(2,a_P);
a_G8:a_1264(a_A[0],a_P);a_A[0]=a_P[0];
if(!__equal(1454739046,a_1062)){return;}
a_1077();
...
a_G10:a_P[0]=2093833466;a_P[1]=a_L1;a_P[2]=a_L2;a_1108(3,a_P); goto a_G12;
a_G11:a_P[0]=2093833477;a_1108(1,a_P);
a_G12:if(!__equal(a_L3,32)){ goto a_G14;}
a_P[0]=2093833487;a_P[1]=32;a_1108(2,a_P);
a_G14:if(!__equal(1454739079,a_1062)){ goto a_G16;}
a_1077(); goto a_G2;
a_G16:a_1263(1454739058);return;
} /* filearea */
...
a_L4=0;
a_L5=1;
a_P[0]=2093833394;a_P[1]=a_F2;a_P[2]=a_F1;a_1108(3,a_P);
a_1268();
...
if(!__equal(1454739040,a_1062)){ goto a_G11;}
a_1077();
if(!__equal(a_A[0],3)){ goto a_G7;}
a_G5:a_P[0]=2093833430;a_P[1]=a_F2;a_1108(2,a_P);
a_G6:a_1268();return;
...
a_P[0]=2093833443;a_P[1]=a_F2;a_P[2]=a_L3;a_1108(3,a_P); goto a_G6;
a_G14:if(!__equal(a_F2,16777567)){ goto a_G22;}
if(!__equal(1454739055,a_1062)){ goto a_G22;}
a_1077();
...
a_G27:a_P[0]=2093833497;a_P[1]=a_F2;a_1108(2,a_P);
a_1268();return;
} /* declaration */
static void a_1253(int a_F1,int a_F2){ /* declarationseries+>a+>a */
int a_P[1];
a_G1:a_P[0]=a_F1;a_1252(a_F2,a_P);a_F1=a_P[0];
if(!__equal(1454739076,a_1062)){ goto a_G4;}
a_1077(); goto a_G1;
a_G4:if(!__equal(1454739082,a_1062)){ goto a_G6;}
a_1077();return;
a_G6:a_1263(1454739082);
a_1269();return;
} /* declarationseries */
static void a_1251(int a_F1){ /* datafiledeclaration+>a */

a_1253(a_F1,16777567);return;
} /* datafiledeclaration */
static void a_1250(int a_F1){ /* charfiledeclaration+>a */

a_1253(a_F1,16777562);return;
} /* charfiledeclaration */
static void a_1244(void){ /* @root */
...
a_P[0]=2093833632;a_P[1]=to_LIST(a_1021)->aupb;a_P[2]=a_L1;a_1108(3,a_P);return;
} /* openicefile */
static void a_1295(void){ /* closeicefile */
...
a_1274(2106125213); goto a_G4;
a_G3:a_1274(2106125264);
a_G4:a_1113(3429891,a_P);a_L1=a_P[0];
a_1277(a_L1);
a_1310(a_P);a_1286=a_P[0];
__decr(a_1286);
a_L2=0;
a_G9:a_P[0]=a_L2;if(!a_1324(a_P)){ goto a_G12;}a_L2=a_P[0];a_L3=a_P[1];a_L4=a_P[2];
a_1276(a_L3);
a_1277(a_L4); goto a_G9;
a_G12:a_1274(2106125238);
a_1285();
a_1274(2106125238);
if(!a_1280()){return;}
...
a_P[0]=2093833510;a_P[1]=a_L2;a_P[2]=a_F1;a_1040(a_L6,3,a_P);
a_1294(a_F1,4);return;
a_G25:a_1267(a_F1,16777511);return;
} /* defineicetag */
...
a_P[0]=2093833503;a_P[1]=a_F1;a_1108(2,a_P);return;
a_G4:if(!__equal(a_F2,0)){ goto a_G6;}
a_P[0]=a_L3;a_P[1]=2093833525;a_P[2]=a_F1;a_1108(3,a_P);return;
a_G6:a_P[0]=2093833517;a_P[1]=a_L3;a_P[2]=a_F1;a_P[3]=a_F2;a_1108(4,a_P);return;
} /* wrongtype */
...
a_P[0]=2093833553;a_P[1]=a_L3;a_P[2]=a_F1;a_P[3]=a_L2;a_1108(4,a_P);return;
...
a_G15:a_1337(a_L3,16777516);
a_G16:a_1274(2106125238);
a_1071(2106125238);return;
a_G18:if(!a_1205(a_L1,256)){ goto a_G20;}
a_G19:a_1034(2106125238);return;
a_G20:a_1058(a_L1,a_P);a_L4=a_P[0];
a_P[0]=2093833531;a_P[1]=a_L4;a_P[2]=a_L1;a_1146(3,3,a_P); goto a_G19;
} /* dlistsize */
static void a_1333(void){ /* repeater */
int a_L1;int a_L2;int a_P[1];
if(!a_1025(2106125257)){return;}
a_1274(2106125257);
...
a_1327(a_L1);
a_1278(a_L1);return;
a_G10:a_1337(a_L1,16777516);return;
} /* repeater */
static void a_1318(void){ /* initializer */
int a_L1;int a_P[3];
a_G1:if(!a_1025(2106125149)){return;}
a_1074(a_P);a_L1=a_P[0];
if(!a_1205(a_L1,1)){ goto a_G6;}
a_1274(2106125149);
a_1278(a_L1); goto a_G1;
a_G6:a_P[0]=2093833531;a_P[1]=16777557;a_P[2]=a_L1;a_1146(3,3,a_P); goto a_G1;
} /* initializer */
...
a_P[0]=2093833601;a_P[1]=a_F1;a_P[2]=a_L3;a_P[3]=a_L2;a_1146(6,4,a_P); goto a_G9;
a_G6:if(!__noteq(a_L4,0)){ goto a_G8;}
__subtr(a_L2,a_L3,a_L4); goto a_G9;
a_G8:a_P[0]=2093833617;a_P[1]=a_F1;a_P[2]=a_L3;a_P[3]=a_L2;a_1146(4,4,a_P);
a_G9:a_L5=0;a_L6=0;
a_G10:if(a_1025(2106125146)){return;}
if(!a_1037(a_P)){ goto a_G15;}a_L5=a_P[0];
a_1278(a_L5);
a_1292(a_L5);
a_L6=1; goto a_G10;
a_G15:if(!a_1025(2106125257)){ goto a_G21;}
...
a_G5:a_P[0]=2093833585;a_P[1]=a_F1;a_1108(2,a_P);return;
...
if(!__less(a_L4,a_L5)){return;}
a_P[0]=2093833617;a_P[1]=a_F1;a_P[2]=a_L4;a_P[3]=a_F2;a_1146(3,4,a_P);return;
} /* checkblock2extension */
static void a_1289(int a_F1,int a_A[1]){ /* block2selector+>a+a> */
int a_L3;int a_L4;int a_P[3];
if(!a_1025(2106125257)){ goto a_G3;}
a_G2:a_A[0]=-1;return;
...
a_P[0]=2093833574;a_P[1]=a_F1;a_P[2]=a_L3;a_1108(3,a_P);return;
a_G11:a_P[0]=2093833564;a_P[1]=a_F1;a_P[2]=a_L3;a_1108(3,a_P); goto a_G2;
} /* block2selector */
...
a_L5=1;
a_G14:if(!a_1025(2106125268)){ goto a_G23;}
...
a_G23:if(!a_1025(2106125177)){ goto a_G9;}
a_L8=a_L2;
...
a_1336(a_L2);return;
a_G8:if(!a_1025(2106125226)){ goto a_G12;}
a_1274(2106125226);
a_1287(a_F1);
a_G11:a_1274(2106125146);return;
a_G12:a_1071(2106125177);
a_1274(2106125226);
...
a_P[0]=2093833531;a_P[1]=a_L2;a_P[2]=a_F1;a_1146(3,3,a_P); return 1;
a_G5:a_P[0]=2093833543;a_P[1]=a_L2;a_P[2]=a_F1;a_1108(3,a_P); return 0;
} /* isfilltagused */
static void a_1304(void){ /* dlistfilling */
int a_L1;int a_L2;int a_P[1];
a_1074(a_P);a_L1=a_P[0];
...
a_1275(a_L2);
a_G8:if(!a_1025(2106125238)){ goto a_G10;}
a_1274(2106125238);return;
a_G10:a_1323(a_L1);
a_1333();
a_1318(); goto a_G8;
a_G13:a_1034(2106125238);return;
} /* dlistfilling */
static void a_1309(void){ /* filearea */
int a_L1;int a_L2;int a_P[1];
a_G1:if(!a_1025(2106125138)){ goto a_G3;}
a_1274(2106125138);return;
...
a_1274(2106125181);
a_1278(a_L1);
if(!a_1025(2106125260)){ goto a_G8;}
a_1274(2106125260);
a_1309();
...
a_P[0]=2093833531;a_P[1]=a_L2;a_P[2]=a_L1;a_1146(3,3,a_P);
a_1034(2106125238);return;
} /* dfiledata */
...
if(!a_1025(2106125216)){ goto a_G3;}
a_G2:a_1274(2106125216);
a_G3:a_1306();
if(!a_1025(2106125229)){ goto a_G6;}
a_1274(2106125229); goto a_G3;
a_G6:if(!a_1025(2106125127)){ goto a_G8;}
a_1274(2106125127); goto a_G3;
a_G8:if(!a_1025(2106125283)){ goto a_G10;}
a_1274(2106125283); goto a_G3;
a_G10:if(!a_1025(2106125235)){ goto a_G12;}
a_1274(2106125235); goto a_G3;
a_G12:if(a_1025(2106125216)){ goto a_G2;}
if(!a_1025(2106125257)){ goto a_G16;}
a_1274(2106125257); goto a_G3;
a_G16:if(!a_1025(2106125162)){return;}
a_1274(2106125162); goto a_G3;
} /* expression */
static void a_1306(void){ /* exprbase */
int a_L1;int a_P[1];
...
a_1278(a_L1);
a_1291(a_L1);return;
a_G6:if(!a_1025(2106125155)){ goto a_G8;}
a_1274(2106125155); goto a_G1;
a_G8:if(!a_1025(2106125208)){ goto a_G13;}
a_1274(2106125208);
a_G10:a_1074(a_P);a_L1=a_P[0];
a_1278(a_L1);
a_1293(a_L1);return;
a_G13:if(!a_1025(2106125272)){ goto a_G18;}
a_1274(2106125272); goto a_G10;
a_G18:if(!a_1025(2106125143)){ goto a_G23;}
a_1274(2106125143); goto a_G10;
a_G23:a_1071(2106125226);
a_1274(2106125226);
a_1307();
a_1071(2106125146);
a_1274(2106125146);return;
} /* exprbase */
static void a_1301(void){ /* dexpression */
int a_L1;int a_L2;int a_P[3];
a_1074(a_P);a_L1=a_P[0];
...
a_P[0]=2093833531;a_P[1]=a_L2;a_P[2]=a_L1;a_1146(1,3,a_P); goto a_G12;
a_G11:a_P[0]=2093833531;a_P[1]=a_L2;a_P[2]=a_L1;a_1146(3,3,a_P);
a_G12:a_1034(2106125238);return;
} /* dexpression */
static void a_1272(void){ /* @root */
...
int a_L3;int a_P[3];
a_P[0]=a_A[0];if(!a_1352(a_F1,a_P)){ goto a_G3;}a_A[0]=a_P[0];
a_L3=4865; goto a_G4;
a_G3:a_L3=4866;
...
static int a_1350(int a_A[1]){ /* getfirstsource+a> */
int a_L2;
...
static int a_1362(int a_F1,int a_A[1]){ /* wassourceadded+>a+a> */
int a_L3;int a_P[1];
...
int a_L3;int a_P[2];
if(!a_1362(a_F1,a_P)){ goto a_G6;}a_L3=a_P[0];
if(!__equal(to_LIST(a_1339)->offset[a_L3-2],4866)){ goto a_G4;}
a_P[0]=2093833659;a_P[1]=a_F1;a_1146(8,2,a_P);return;
a_G4:if(__equal(to_LIST(a_1339)->offset[a_L3-2],a_F2)){return;}
a_P[0]=2093833673;a_P[1]=a_F1;a_1108(2,a_P);return;
...
static void a_1360(int a_F1){ /* setpragmats+>a */
int a_L2;
...
a_L2=1; goto a_G7;
a_G6:a_L2=0;
a_G7:a_1361(3429894,a_L2);return;
} /* setpragmats */
...
static int a_1352(int a_F1,int a_A[3]){ /* iscmdlinepragmat+>a+>a>+a>+a> */
int a_L5;int a_P[1];
...
a_P[0]=2093833645;a_1040(0,1,a_P);return;
...
static int a_1354(int a_A[1]){ /* nextinput+>a> */
int a_L2;int a_L3;int a_L4;int a_L5;int a_L6;int a_P[3];
...
a_P[0]=a_L2;if(!a_1352(to_LIST(a_1339)->offset[a_A[0]],a_P)){ goto a_G26;}a_L2=a_P[0];a_L3=a_P[1];a_L4=a_P[2];
if(!__less(a_L3,0)){ goto a_G17;}
if(!a_1355(0,to_LIST(a_1339)->offset[a_A[0]])){ goto a_G16;}
a_1077();
a_1347();
a_1346();
...
__next(a_1339,a_A[0]);
if(!__more(a_A[0],to_LIST(a_1339)->aupb)){ goto a_G21;}
a_P[0]=2093833645;a_1040(0,1,a_P); return 0;
a_G21:a_1314(a_P);to_LIST(a_1339)->offset[a_A[0]-1]=a_P[0];
a_1361(a_L3,to_LIST(a_1339)->offset[a_A[0]]); goto a_G16;
a_G24:a_1361(a_L3,a_L4); goto a_G16;
a_G26:if(!a_1355(a_L6,to_LIST(a_1339)->offset[a_A[0]])){ goto a_G31;}
__next(a_1339,a_A[0]);
{ if(a_L5==4866){ return 1;}
 if(!(a_L5==4867)){ goto a_G30;}
}
a_1360(1); return 1;
a_G30:a_1360(a_L5); return 1;
a_G31:a_P[0]=2093833690;a_P[1]=to_LIST(a_1339)->offset[a_A[0]];a_1103(9,0,2,a_P); goto a_G16;
} /* nextinput */
static void a_1357(void){ /* readsources */
int a_L1;int a_L2;int a_P[1];
a_1351();
...
a_1361(3429893,0);
a_1359();
a_G6:a_P[0]=a_L1;if(!a_1354(a_P)){ goto a_G13;}a_L1=a_P[0];
a_1077();
a_1356();
a_1346();
a_1359();
...
a_P[0]=2093833682;a_1040(0,1,a_P);return;
} /* readsources */
static void a_1358(void){ /* readstdlib */
int a_L1;int a_L2;int a_P[1];
a_1113(3429899,a_P);a_L2=a_P[0];
if(!__equal(a_L2,0)){ goto a_G4;}
a_1314(a_P);a_1353=a_P[0];return;
a_G4:a_1344(1516190438,4868);
a_L1=to_LIST(a_1339)->aupb;
a_G6:a_1359();
a_1361(3429893,1);
a_P[0]=a_L1;if(!a_1354(a_P)){ goto a_G14;}a_L1=a_P[0];
a_1077();
a_1356();
a_1346(); goto a_G6;
a_G14:a_1314(a_P);a_1353=a_P[0];
a_1359();return;
} /* readstdlib */
static void a_1338(void){ /* @root */
...
if(!__was(a_1369,a_F1)){ goto a_G3;}
a_copystring(a_1369,a_F1,a_F2); return 1;
...
a_L1=1; goto a_G5;
a_G4:a_L1=0;
a_G5:a_1106(a_1372,a_L1);
a_G6:if(!__more(a_1417,0)){ goto a_G10;}
__decr(a_1417);
a_1372=32;
__incr(a_1393);return;
a_G10:if(!__more(a_1367,0)){ goto a_G18;}
a_G11:if(!__equal(a_1365,a_1366)){ goto a_G14;}
a_1372=46;
__incr(a_1365); goto a_G20;
a_G14:if(!__less(a_1365,a_1366)){ goto a_G30;}
if(!a_stringelem(a_1021,a_1367,a_1365,a_P)){ goto a_G30;}a_1372=a_P[0];
__incr(a_1365);
if(__equal(a_1372,10)){ goto a_G11;} goto a_G20;
a_G18:if(!__equal(a_1367,0)){ goto a_G30;}
if(!a_getchar(a_1368,a_P)){ goto a_G30;}a_1372=a_P[0];
a_G20:__incr(a_1393);
{ if(a_1372==10){ goto a_G22;}
 if(a_1372==9){ goto a_G25;}
 if(a_1372<=31){  goto a_G6;}
 return;}
a_G22:a_1393=0;
a_1113(3429892,a_P);a_1381=a_P[0];
a_1113(3429888,a_P);a_1413=a_P[0];return;
a_G25:a_1372=32;
__subtr(a_1393,1,a_L2);
_divrem01(a_L2,a_1413,a_1417);
__subtr(a_1413,a_1417,a_1417);
__decr(a_1417);return;
a_G30:if(!__less(a_1377,-2)){ goto a_G33;}
__incr(a_1377);
a_1372=10;return;
a_G33:a_1372=19088743;return;
} /* nextchar */
static int a_1371(int a_A[1]){ /* boldletter+a> */

{ if(!((97<=a_1372 && a_1372<=122))){ return 0;}
}
a_A[0]=a_1372;
a_1388(); return 1;
} /* boldletter */
...
a_G1:{ if(a_1372==32){ goto a_G2;}
 if((48<=a_1372 && a_1372<=57)){  goto a_G3;}
  return 0;}
a_G2:a_1388(); goto a_G1;
a_G3:__subtr(a_1372,48,a_A[0]);
a_1388(); return 1;
} /* digit */
...
a_G1:{ if(a_1372==32){ goto a_G2;}
 if((48<=a_1372 && a_1372<=57)){ goto a_G3;}
 if((97<=a_1372 && a_1372<=102)){ goto a_G5;}
 if((65<=a_1372 && a_1372<=70)){  goto a_G8;}
  return 0;}
a_G2:a_1388(); goto a_G1;
a_G3:__subtr(a_1372,48,a_A[0]);
a_G4:a_1388(); return 1;
a_G5:__subtr(a_1372,97,a_A[0]);
__add(a_A[0],10,a_A[0]); goto a_G4;
a_G8:__subtr(a_1372,65,a_A[0]);
__add(a_A[0],10,a_A[0]);
a_1388(); return 1;
} /* hexdigit */
static int a_1385(int a_A[1]){ /* letgit+a> */

a_G1:{ if(a_1372==32){ goto a_G2;}
 if((65<=a_1372 && a_1372<=90)||(97<=a_1372 && a_1372<=122)||(48<=a_1372 && a_1372<=57)){ goto a_G3;}
 if(a_1372==64){  goto a_G5;}
  return 0;}
a_G2:a_1388(); goto a_G1;
a_G3:a_A[0]=a_1372;
a_1388(); return 1;
...
a_G1:{ if(a_1372==32){ goto a_G2;}
 if(a_1372==10){  goto a_G3;}
 return;}
a_G2:a_1388(); goto a_G1;
a_G3:__incr(a_1394);
a_1388(); goto a_G1;
} /* nextvisiblechar */
static void a_1416(int a_F1,int a_A[1]){ /* trytoopen+>a+a> */
int a_L3;
if(!a_openfile(a_1368,114,a_1021,a_F1)){ goto a_G3;}
a_A[0]=0;return;
a_G3:__getfileerror(a_1368,a_L3);
...
static void a_1414(int a_F2,int a_A[2]){ /* trynextpath+>a>+>a+>a> */
int a_L4;int a_L5;int a_L6;int a_P[1];
...
a_1416(to_LIST(a_1021)->aupb,a_P);a_A[1]=a_P[0];
...
static void a_1415(int a_F1,int a_A[1]){ /* trypath+>a+>a> */
...
a_P[0]=a_L4;a_P[1]=a_A[0];a_1414(a_F1,a_P);a_L4=a_P[0];a_A[0]=a_P[1];
if(!__equal(a_A[0],1)){ goto a_G12;}
__incr(a_L4); goto a_G8;
a_G12:__scratch(a_1006);return;
} /* trypath */
static int a_1390(int a_F1,int a_F2){ /* opensourcefile+>a+>a */
int a_L3;int a_L4;int a_P[1];
a_1416(a_F2,a_P);a_L3=a_P[0];
...
__scratch(a_1006);
a_1416(to_LIST(a_1021)->aupb,a_P);a_L3=a_P[0];
a_1312(to_LIST(a_1021)->aupb);
if(!__equal(a_L3,1)){ goto a_G14;}
if(!__equal(a_F1,2)){ goto a_G14;}
a_P[0]=a_L3;a_1415(a_F2,a_P);a_L3=a_P[0];
a_G14:if(!__equal(a_L3,0)){ return 0;} return 1;
} /* opensourcefile */
static int a_1355(int a_F1,int a_F2){ /* nextsource+>a+>a */
int a_P[1];
if(!__equal(a_F1,0)){ goto a_G6;}
a_1367=a_F2;
__stringlength(a_1021,a_1367,a_1366);
a_1365=2;
a_1381=0; goto a_G9;
a_G6:if(!a_1390(a_F1,a_F2)){ return 0;}
a_1367=0;
a_1113(3429892,a_P);a_1381=a_P[0];
a_G9:a_1393=0;
a_1113(3429888,a_P);a_1413=a_P[0];
a_1377=-4;
a_1394=0;
a_1417=0;
a_1391=0;
...
if(!__more(a_1367,0)){ goto a_G3;}
a_G2:a_1367=-1;return;
a_G3:if(!__equal(a_1367,0)){return;}
a_closefile(a_1368); goto a_G2;
} /* closesource */
static void a_1298(void){ /* createicename */
...
a_L5=0; goto a_G8;
a_G5:if(!a_1350(a_P)){ goto a_G7;}a_L2=a_P[0];
a_L5=1; goto a_G8;
a_G7:a_1063(a_1001,16777380,295);return;
...
if(!__equal(a_1372,61)){ goto a_G5;}
a_1388();
a_A[0]=1454739103;return;
a_G5:a_A[0]=1454739046;return;
a_G6:if(!__equal(a_1372,62)){ goto a_G9;}
a_1388();
...
a_G6:if(!__equal(a_1372,60)){ goto a_G9;}
a_1388();
a_A[0]=1454739049;return;
a_G9:if(!__equal(a_1372,62)){ goto a_G12;}
a_1388();
...
int a_P[1];
{ if(a_1372==62){ goto a_G2;}
 if(a_1372==61){  goto a_G4;}
  goto a_G6;}
a_G2:a_1388();
...
int a_P[1];
a_G1:{ if(a_1372==32){ goto a_G2;}
 if(a_1372==48){ goto a_G3;}
 if((49<=a_1372 && a_1372<=57)){  goto a_G5;}
  goto a_G6;}
a_G2:a_1388(); goto a_G1;
a_G3:a_1388();
...
a_G1:{ if(a_1372==32){ goto a_G2;}
 if((48<=a_1372 && a_1372<=57)){ goto a_G3;}
 if(a_1372==120||a_1372==88){  goto a_G4;}
  goto a_G6;}
a_G2:a_1388(); goto a_G1;
...
static void a_1373(int a_F2,int a_F3,int a_A[1]){ /* decimaloverflow+>a>+>a+>a */
...
__subtr(a_1372,48,a_L3);
a_L4=0;
a_1388();
a_G4:if(!a_1374(a_P)){ goto a_G7;}a_L5=a_P[0];
__addmult(a_L3,10,a_L5,a_L3);
a_P[0]=a_L4;a_1373(a_F1,a_L3,a_P);a_L4=a_P[0]; goto a_G4;
a_G7:if(!__is(a_L4)){ goto a_G9;}
a_P[0]=2093833697;a_1108(1,a_P); goto a_G11;
a_G9:if(!__is(a_F1)){ goto a_G11;}
__subtr(0,a_L3,a_L3);
a_G11:a_1375(a_L3,a_P);a_A[0]=a_P[0];return;
} /* readconst */
static void a_1383(int a_F2,int a_A[1]){ /* hexoverflow+>a>+>a */
int a_L3;
a_L3=a_F2;
__leftclear(a_L3,4);
__rightclear(a_L3,4);
...
int a_L3;int a_L4;int a_L5;int a_P[1];
if(!a_1382(a_P)){ goto a_G12;}a_L4=a_P[0];
a_L5=0;
a_G3:if(!a_1382(a_P)){ goto a_G7;}a_L3=a_P[0];
a_P[0]=a_L5;a_1383(a_L4,a_P);a_L5=a_P[0];
__leftclear(a_L4,4);
...
a_G9:if(!__is(a_F1)){ goto a_G11;}
__subtr(0,a_L4,a_L4);
a_G11:a_1375(a_L4,a_P);a_A[0]=a_P[0];return;
a_G12:a_P[0]=2093833706;a_1108(1,a_P);
a_A[0]=1454739123;return;
} /* readhex */
static void a_1398(int a_A[1]){ /* readchardenotation+a> */
int a_L2;int a_P[1];
a_L2=a_1372;
if(!__equal(a_1372,10)){ goto a_G4;}
a_G3:a_P[0]=2093833715;a_1108(1,a_P); goto a_G8;
a_G4:a_1388();
if(!__equal(a_1372,47)){ goto a_G3;}
a_1388();
a_G8:a_1375(a_L2,a_P);a_A[0]=a_P[0];return;
} /* readchardenotation */
static void a_1411(void){ /* skipchardenotation */

if(__equal(a_1372,10)){return;}
a_1388();
if(!__equal(a_1372,47)){return;}
a_1388();return;
} /* skipchardenotation */
...
a_L2=0;
a_G3:a_1388();
{ if(a_1372==34){ goto a_G5;}
 if(a_1372==10||a_1372==19088743){  goto a_G15;}
  goto a_G7;}
a_G5:a_1388();
if(!__equal(a_1372,34)){ goto a_G9;}
a_G7:a_1378(a_1372);
__incr(a_L2); goto a_G3;
a_G9:a_1389();
if(__equal(a_1372,34)){ goto a_G3;}
...
a_G15:a_P[0]=2093833722;a_1108(1,a_P); goto a_G12;
} /* readstring */
static void a_1412(void){ /* skipstring */

a_G1:{ if(a_1372==34){ goto a_G2;}
 if(a_1372==10||a_1372==19088743){ return;}
  goto a_G3;}
a_G2:a_1388();return;
a_G3:a_1388(); goto a_G1;
} /* skipstring */
...
a_G1:{ if(a_1372==10){return;}
 if(!(a_1372==36)){ goto a_G3;}
}
a_1388();return;
a_G3:a_1388(); goto a_G1;
} /* longcomment */
...
a_G2:a_1388(); goto a_G1;
a_G3:a_1388();
a_G4:{ if(!((65<=a_1372 && a_1372<=90)||(97<=a_1372 && a_1372<=122)||(48<=a_1372 && a_1372<=57)||a_1372==32)){ return 1;}
}
a_1388(); goto a_G4;
} /* shortcomment */
static void a_1396(int a_A[1]){ /* readbold+a> */
int a_L2;int a_L3;int a_P[2];
__scratch(a_1006);
a_L2=0;
a_G3:if(!a_1371(a_P)){ goto a_G6;}a_L3=a_P[0];
a_1378(a_L3);
__incr(a_L2); goto a_G3;
a_G6:if(!__equal(a_1372,39)){ goto a_G21;}
a_1388();
a_packstring(a_1006,a_L2,a_1021);
a_A[0]=1454738811;
a_G10:if(!__equal(a_A[0],0)){ goto a_G13;}
a_P[0]=2093833730;a_P[1]=to_LIST(a_1021)->aupb;a_1108(2,a_P);
a_A[0]=1454738959; goto a_G20;
a_G13:a_comparestring(a_1364,a_A[0],a_1021,to_LIST(a_1021)->aupb,a_P);a_L2=a_P[0];
__next(a_1364,a_A[0]);
if(!__more(a_L2,0)){ goto a_G17;}
a_A[0]=to_LIST(a_1364)->offset[a_A[0]-2]; goto a_G10;
a_G17:if(!__less(a_L2,0)){ goto a_G19;}
a_A[0]=to_LIST(a_1364)->offset[a_A[0]-1]; goto a_G10;
a_G19:a_A[0]=to_LIST(a_1364)->offset[a_A[0]];
a_G20:__unstackstring(a_1021);return;
a_G21:a_packstring(a_1006,a_L2,a_1021);
a_P[0]=2093833745;a_P[1]=to_LIST(a_1021)->aupb;a_1108(2,a_P);
...
a_1378(a_1372);
a_1388();
a_G4:if(!a_1385(a_P)){ goto a_G6;}a_L2=a_P[0];
a_1378(a_L2); goto a_G4;
a_G6:a_1376(a_1006,a_P);a_A[0]=a_P[0];return;
} /* readtag */
static void a_1397(int a_A[1]){ /* readbuiltin+a> */
int a_L2;int a_L3;int a_P[2];
__scratch(a_1006);
a_1378(95);
a_L2=1;
a_G4:if(!a_1371(a_P)){ goto a_G7;}a_L3=a_P[0];
a_1378(a_L3);
__incr(a_L2); goto a_G4;
a_G7:if(!__equal(a_1372,95)){ goto a_G32;}
a_1378(95);
__incr(a_L2);
a_1388();
a_packstring(a_1006,a_L2,a_1021);
...
a_P[0]=2093833737;a_P[1]=to_LIST(a_1021)->aupb;a_1108(2,a_P); goto a_G22;
a_G15:a_comparestring(a_1364,a_A[0],a_1021,to_LIST(a_1021)->aupb,a_P);a_L2=a_P[0];
__next(a_1364,a_A[0]);
if(!__more(a_L2,0)){ goto a_G19;}
a_A[0]=to_LIST(a_1364)->offset[a_A[0]-2]; goto a_G13;
a_G19:if(!__less(a_L2,0)){ goto a_G21;}
a_A[0]=to_LIST(a_1364)->offset[a_A[0]-1]; goto a_G13;
a_G21:a_A[0]=to_LIST(a_1364)->offset[a_A[0]];
...
a_P[0]=2093833753;a_P[1]=95;a_1108(2,a_P); goto a_G31;
a_G35:a_packstring(a_1006,a_L2,a_1021);
a_P[0]=2093833737;a_P[1]=to_LIST(a_1021)->aupb;a_1108(2,a_P);
__unstackstring(a_1021); goto a_G31;
} /* readbuiltin */
static void a_1395(int a_A[1]){ /* read+a> */
int a_L2;int a_P[2];
if(!__more(a_1394,0)){ goto a_G4;}
__decr(a_1394);
a_G3:a_A[0]=1454739121;return;
a_G4:a_L2=a_1391;
a_1391=0;
a_G6:{ if(a_1372==32){ goto a_G7;}
 if((65<=a_1372 && a_1372<=90)||(97<=a_1372 && a_1372<=122)){ goto a_G8;}
 if(a_1372==43){ goto a_G10;}
 if(a_1372==44){ goto a_G12;}
 if(a_1372==59){ goto a_G14;}
 if(a_1372==10){ goto a_G16;}
 if(a_1372==45){ goto a_G19;}
 if(a_1372==61){ goto a_G21;}
 if(a_1372==40){ goto a_G23;}
 if(a_1372==41){ goto a_G25;}
 if(a_1372==48){ goto a_G28;}
 if((49<=a_1372 && a_1372<=57)){ goto a_G31;}
 if(a_1372==39){ goto a_G33;}
 if(a_1372==60){ goto a_G35;}
 if(a_1372==62){ goto a_G37;}
 if(a_1372==42){ goto a_G39;}
 if(a_1372==58){ goto a_G41;}
 if(a_1372==47){ goto a_G43;}
 if(a_1372==46){ goto a_G48;}
 if(a_1372==64){ goto a_G50;}
 if(a_1372==63){ goto a_G55;}
 if(a_1372==36){ goto a_G57;}
 if(a_1372==91){ goto a_G59;}
 if(a_1372==93){ goto a_G61;}
 if(a_1372==35){ goto a_G64;}
 if(a_1372==34){ goto a_G67;}
 if(a_1372==33){ goto a_G68;}
 if(a_1372==126){ goto a_G73;}
 if(a_1372==124){ goto a_G75;}
 if(a_1372==38){ goto a_G77;}
 if(a_1372==94){ goto a_G79;}
 if(a_1372==95){ goto a_G81;}
 if(a_1372==19088743){  goto a_G83;}
  goto a_G85;}
a_G7:a_1388(); goto a_G6;
a_G8:a_1391=1;
...
a_P[0]=2093833753;a_P[1]=a_1372;a_1108(2,a_P); goto a_G7;
a_G55:a_1388();
...
a_G68:a_1388();
if(!__equal(a_1372,61)){ goto a_G72;}
a_1388();
a_A[0]=1454739097;return;
a_G72:a_P[0]=2093833753;a_P[1]=33;a_1108(2,a_P); goto a_G6;
a_G73:a_1388();
...
a_G85:a_P[0]=2093833753;a_P[1]=a_1372;a_1108(2,a_P);
a_1388(); goto a_G6;
} /* read */
...
__decr(a_1394);
a_G3:a_A[0]=1454739121;return;
a_G4:{ if(a_1372==10){ goto a_G5;}
 if(a_1372==47){ goto a_G7;}
 if(a_1372==46){ goto a_G9;}
 if(a_1372==34){ goto a_G11;}
 if(a_1372==35){ goto a_G13;}
 if(a_1372==36){ goto a_G15;}
 if(a_1372==19088743){  goto a_G17;}
  goto a_G18;}
a_G5:a_1388(); goto a_G3;
a_G7:a_1388();
a_1411(); goto a_G4;
a_G9:a_1388();
a_A[0]=1454739082;return;
...
a_1058(a_F1,a_P);a_L4=a_P[0];
if(!__more(a_L3,0)){ goto a_G5;}
a_P[0]=2093833904;a_P[1]=a_L4;a_P[2]=a_F1;a_P[3]=a_F2;a_P[4]=a_L3;a_1108(5,a_P);return;
a_G5:a_P[0]=2093833912;a_P[1]=a_L4;a_P[2]=a_F1;a_P[3]=a_F2;a_1108(4,a_P);return;
} /* tagredefined */
static void a_1449(int a_A[2]){ /* skipfieldlist+a>+a> */
int a_P[1];
if(!__equal(1454739067,a_1062)){ goto a_G17;}
a_1077();
a_A[0]=1;
a_G4:if(!a_1261(a_P)){ goto a_G15;}
if(!__equal(1454739076,a_1062)){ goto a_G8;}
a_1077();
__incr(a_A[0]); goto a_G4;
a_G8:if(!__equal(1454739040,a_1062)){ goto a_G10;}
a_1077(); goto a_G4;
a_G10:if(!__equal(1454739070,a_1062)){ goto a_G13;}
a_1077();
a_A[1]=0;return;
a_G13:a_P[0]=2093833759;a_1108(1,a_P);
a_G14:a_A[1]=1;return;
a_G15:a_P[0]=2093833766;a_1108(1,a_P); goto a_G14;
a_G17:a_A[1]=0;
a_A[0]=-1;return;
} /* skipfieldlist */
...
if(!__equal(1454739040,a_1062)){ goto a_G10;}
a_A[2]=1; goto a_G10;
a_G8:a_P[0]=2093833780;a_1108(1,a_P);
a_A[3]=1;
...
if(!__equal(1454739040,a_1062)){ goto a_G9;}
a_1077();
if(a_1260(a_P)){a_A[2]=a_P[0]; goto a_G13;}
a_G9:a_P[0]=2093833923;a_P[1]=a_A[0];a_1108(2,a_P);
a_G10:a_A[3]=1; goto a_G13;
a_G11:a_P[0]=2093833780;a_1108(1,a_P); goto a_G10;
...
if(!__equal(a_L11,16777550)){ goto a_G25;}
a_1056(a_L10,a_P);a_L8=a_P[0];
if(__equal(a_L8,a_L5)){ goto a_G31;}
if(!__equal(a_L8,0)){ goto a_G23;}
a_1266(a_L10,a_L5);
a_1447(a_L10,2);
a_1442(a_L10,a_L4); goto a_G31;
a_G23:a_1198(a_L10,a_P);a_L9=a_P[0];
a_P[0]=2093833791;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_L10;a_P[4]=a_L9;a_1108(5,a_P); goto a_G31;
a_G25:a_1267(a_L10,16777550);
a_1442(a_L10,a_L4);
a_1447(a_L10,2);
a_1266(a_L10,a_L5);
a_1440(a_L10,a_F2); goto a_G31;
a_G30:a_1063(a_1001,16777390,153);return;
a_G31:if(!__equal(1454739076,a_1062)){ goto a_G34;}
a_1077();
__decr(a_L5); goto a_G13;
a_G34:if(!__equal(1454739040,a_1062)){ goto a_G36;}
a_1077(); goto a_G13;
a_G36:a_1263(1454739070);
...
a_P[0]=2093833804;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_L7;a_P[4]=a_L9;a_1108(5,a_P); goto a_G50;
...
a_P[0]=2093833814;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_L6;a_P[4]=a_L9;a_1108(5,a_P);return;
} /* selectorlist */
...
a_P[0]=2093833804;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_L4;a_P[4]=a_L6;a_1108(5,a_P); goto a_G14;
a_G8:a_1267(a_L4,16777550);
a_1440(a_L4,a_F2);
a_1266(a_L4,1);
a_1443(a_F2,1);
...
a_P[0]=2093833814;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_L5;a_P[4]=a_L6;a_1108(5,a_P);return;
...
int a_P[2];
if(!__equal(1454739055,a_1062)){ goto a_G28;}
a_1077();
if(!__equal(1454739040,a_1062)){ goto a_G6;}
a_1077();
a_A[0]=1; goto a_G7;
a_G6:a_A[0]=0;
a_G7:if(!a_1430(a_P)){ goto a_G19;}a_A[1]=a_P[0];
__incr(a_A[0]);
{ if(a_A[1]<=0){ goto a_G10;}
 if(a_A[1]>=1000000){ goto a_G12;}
 if(a_A[1]>=101){  goto a_G16;}
  goto a_G26;}
a_G10:a_P[0]=2093833974;a_P[1]=a_A[1];a_1146(9,2,a_P);
a_A[1]=1; goto a_G26;
a_G12:a_P[0]=2093833974;a_P[1]=a_A[1];a_1146(6,2,a_P);
if(!__equal(a_A[0],1)){ goto a_G15;}
a_G14:a_A[1]=100; goto a_G26;
a_G15:a_A[1]=1000000; goto a_G26;
a_G16:if(!__equal(a_A[0],1)){ goto a_G26;}
a_P[0]=2093833974;a_P[1]=a_A[1];a_1146(6,2,a_P); goto a_G14;
a_G19:if(!a_1261(a_P)){ goto a_G22;}a_A[1]=a_P[0];
__add(a_A[0],3,a_A[0]);
a_1271(a_A[1]); goto a_G26;
a_G22:if(!__equal(a_A[0],1)){ goto a_G24;}
a_P[0]=2093833946;a_1108(1,a_P);
a_G24:a_A[1]=0;a_A[0]=0;
a_G26:a_1419(1454739040);
a_1263(1454739058);return;
...
a_L1=1;
a_L2=0;
if(!__equal(1454739064,a_1062)){ goto a_G13;}
a_1077();
if(!a_1430(a_P)){ goto a_G9;}a_L1=a_P[0];
{ if((1<=a_L1 && a_L1<=10000)){  goto a_G13;}
}
a_P[0]=2093833837;a_P[1]=a_L1;a_1146(9,2,a_P);
a_L1=1; goto a_G13;
a_G9:if(!a_1261(a_P)){ goto a_G12;}a_L2=a_P[0];
a_L1=-1;
a_1271(a_L2); goto a_G13;
a_G12:a_P[0]=2093833823;a_1108(1,a_P);
...
a_G4:if(!__equal(1454739037,a_1062)){ goto a_G7;}
a_1077();
a_1435(); return 1;
a_G7:a_1435(); return 0;
} /* isextendedblock */
static void a_1446(int a_F1,int a_A[1]){ /* selectors+>a+>a> */
int a_L3;int a_P[2];
if(!__equal(1454739037,a_1062)){ goto a_G17;}
a_G2:a_1077();
a_1012(2106125268);
if(!__equal(1454739064,a_1062)){ goto a_G10;}
a_1077();
if(!__equal(a_A[0],0)){ goto a_G9;}
a_A[0]=1;
a_1012(2106125257); goto a_G15;
a_G9:a_P[0]=2093833848;a_P[1]=a_F1;a_1108(2,a_P); goto a_G15;
a_G10:if(!a_1261(a_P)){ goto a_G13;}a_L3=a_P[0];
a_1438(a_L3,a_F1,a_P);a_L3=a_P[0];
a_1017(a_L3); goto a_G15;
a_G13:a_P[0]=2093833858;a_P[1]=a_F1;a_1108(2,a_P);
a_1268();
a_G15:if(!__equal(1454739037,a_1062)){return;} goto a_G2;
a_G17:a_P[0]=2093833858;a_P[1]=a_F1;a_1108(2,a_P);
a_1268();return;
} /* selectors */
...
a_L2=0;a_L4=0;
a_1012(2106125177);
a_G3:if(!__equal(1454739076,a_1062)){ goto a_G5;}
a_1077(); goto a_G3;
a_G5:if(!a_1430(a_P)){ goto a_G9;}a_L3=a_P[0];
a_1015(a_L3);
a_G7:a_P[0]=a_L4;a_1446(a_F1,a_P);a_L4=a_P[0];
__incr(a_L2); goto a_G3;
a_G9:if(!a_1261(a_P)){ goto a_G14;}a_L3=a_P[0];
a_1271(a_L3);
a_1017(a_L3); goto a_G7;
a_G14:if(!__equal(a_L2,0)){ goto a_G17;}
a_P[0]=2093833895;a_P[1]=a_F1;a_1108(2,a_P);
a_1268();return;
a_G17:a_1263(1454739070);
a_1012(2106125177);return;
} /* extendedblock */
...
a_G3:a_L4=0;a_L3=0;
a_1012(2106125226);
a_G5:if(!__equal(1454739076,a_1062)){ goto a_G7;}
a_1077(); goto a_G5;
a_G7:if(!a_1430(a_P)){ goto a_G10;}a_L2=a_P[0];
a_1015(a_L2);
...
a_P[0]=2093833895;a_P[1]=a_F1;a_1108(2,a_P);
a_1268();return;
a_G17:if(!__equal(1454739064,a_1062)){ goto a_G23;}
a_1077();
if(!__equal(a_L3,0)){ goto a_G22;}
a_L3=1;
a_1012(2106125257); goto a_G5;
a_G22:a_P[0]=2093833848;a_P[1]=a_F1;a_1108(2,a_P); goto a_G5;
a_G23:a_1263(1454739070);
a_1012(2106125146);return;
} /* listfillblock */
static void a_1428(int a_F1){ /* initializer+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_P[2];
a_G1:if(!__equal(1454739073,a_1062)){return;}
a_1077();
a_L5=0;
if(!a_1262(a_P)){ goto a_G15;}a_L2=a_P[0];a_L4=a_P[1];
a_1058(a_L2,a_P);a_L3=a_P[0];
if(__equal(a_L3,16777511)){ goto a_G8;}
if(!__equal(a_L3,16777516)){ goto a_G14;}
a_G8:a_P[0]=a_L5;a_1245(a_L2,a_L4,a_P);a_L5=a_P[0];
if(__is(a_L5)){ goto a_G1;}
a_1267(a_L2,16777557);
a_1440(a_L2,a_F1);
a_1012(2106125149);
a_1017(a_L2); goto a_G1;
a_G14:a_1453(a_L2,16777557); goto a_G1;
a_G15:a_P[0]=2093833886;a_P[1]=a_F1;a_1108(2,a_P);return;
} /* initializer */
static void a_1433(int a_F1,int a_F2){ /* listfill+>a+>a */
int a_L3;int a_P[3];
if(!__equal(1454739067,a_1062)){ goto a_G34;}
a_1077();
if(!__equal(1454739070,a_1062)){ goto a_G5;}
a_1077();return;
a_G5:if(!a_1205(a_F2,16)){ goto a_G7;}
a_P[0]=2093833867;a_P[1]=a_F1;a_P[2]=a_F2;a_1108(3,a_P);
a_G7:a_1012(2106125185);
a_1017(a_F2);
a_G9:if(!a_1430(a_P)){ goto a_G12;}a_L3=a_P[0];
a_1015(a_L3);
a_G11:a_1444(); goto a_G25;
...
a_G19:if(!__equal(1454739067,a_1062)){ goto a_G23;}
a_1077();
a_1434(a_F2); goto a_G11;
a_G23:a_P[0]=2093833876;a_P[1]=a_F1;a_P[2]=a_F2;a_1108(3,a_P);
a_1268();
a_G25:a_1428(a_F2);
if(!__equal(1454739076,a_1062)){ goto a_G28;}
a_1077(); goto a_G9;
a_G28:if(!__equal(1454739070,a_1062)){ goto a_G32;}
a_1077();
a_1012(2106125238);
a_1447(a_F2,256);return;
a_G32:a_P[0]=2093833876;a_P[1]=a_F1;a_P[2]=a_F2;a_1108(3,a_P);
a_1268();return;
a_G34:a_P[0]=2093833876;a_P[1]=a_F1;a_P[2]=a_F2;a_1108(3,a_P);
a_1268();return;
} /* listfill */
...
a_G10:a_1017(a_F4);
a_G11:a_1012(2106125238);return;
} /* listdeclarationtail */
...
a_P[0]=2093833867;a_P[1]=a_F1;a_P[2]=a_L3;a_1108(3,a_P);
...
a_G7:a_P[0]=2093833961;a_P[1]=a_F1;a_1108(2,a_P);
a_L9=1; goto a_G14;
...
a_G33:a_1419(a_L5);
if(!__equal(1454739040,a_1062)){return;}
a_1077();
...
a_G6:a_P[0]=2093833961;a_P[1]=a_F2;a_1108(2,a_P);
a_G7:a_1268();return;
a_G8:if(!__equal(a_A[0],1)){ goto a_G11;}
a_P[0]=2093833936;a_1108(1,a_P); goto a_G7;
a_G11:a_A[0]=2;
...
static void a_1470(void){ /* rulebody */
int a_P[1];
if(!a_1025(2106125193)){ goto a_G3;}
a_1074(a_P);
a_G3:if(!a_1025(2106125204)){ goto a_G5;}
a_1034(2106125149);
a_G5:if(!a_1025(2106125135)){ goto a_G8;}
a_1034(2106125135);
a_1467();return;
a_G8:a_1465();return;
} /* rulebody */
...
a_G1:a_1071(2106125131);
a_1034(2106125131);
a_1071(2106125152);
a_1464();
if(!a_1025(2106125254)){return;} goto a_G1;
} /* classification */
static void a_1464(void){ /* alternative */

a_G1:a_1468();
if(!a_1025(2106125152)){return;} goto a_G1;
} /* alternative */
static void a_1465(void){ /* altsequence */
...
static void a_1468(void){ /* member */
int a_L1;int a_P[1];
if(!a_1025(2106125226)){ goto a_G4;}
a_1470();
a_1071(2106125146);return;
a_G4:if(!a_1025(2106125177)){ goto a_G6;}
a_1034(2106125177);return;
a_G6:if(!a_1025(2106125189)){ goto a_G8;}
a_1074(a_P);return;
a_G8:if(a_1025(2106125235)){return;}
if(a_1025(2106125216)){return;}
a_1074(a_P);a_L1=a_P[0];
...
a_P[0]=2093833986;a_P[1]=a_F1;a_1108(2,a_P);
a_1294(a_F1,262144);
...
a_G2:if(!a_1025(2106125268)){ goto a_G5;}
if(a_1029(a_P)){ goto a_G2;}
a_1074(a_P); goto a_G2;
a_G5:if(a_1025(2106125177)){return;}
if(a_1027(2106125166)){return;} goto a_G1;
} /* gtransportlist */
static void a_1522(void){ /* gextension */
int a_P[1];
a_1074(a_P);
...
a_1314(a_P);a_L2=a_P[0];
a_P[0]=a_L2;a_1284(a_P);a_L2=a_P[0];
a_G7:a_P[0]=2106125159;a_P[1]=a_L2;a_1540(2,a_P);
a_G8:if(!a_1025(2106125131)){ goto a_G10;}
a_1512(2106125235);return;
a_G10:if(!a_1025(2106125149)){ goto a_G12;}
a_1512(2106125149); goto a_G8;
a_G12:if(!a_1025(2106125254)){ goto a_G14;}
a_1512(2106125254); goto a_G8;
...
a_1541(1048579,0);
a_1517();
if(!a_1025(2106125254)){ goto a_G11;}
...
a_G5:if(!a_1025(2106125260)){ goto a_G12;}
a_1074(a_P);
a_1553(a_F1,a_P);a_L4=a_P[0];
a_1531(a_L4,a_P);
a_1071(2106125138);
if(a_1029(a_P)){return;} goto a_G4;
a_G12:if(a_1025(2106125219)){return;}
a_1074(a_P);a_L3=a_P[0];
a_1058(a_L3,a_P);a_L4=a_P[0];
...
a_L5=0;a_L6=0;
a_1050(a_F1,a_P);a_L3=a_P[0];
a_G5:if(!a_1025(2106125235)){ goto a_G15;}
a_1058(a_L3,a_P);a_L4=a_P[0];
...
a_G1:if(!a_1025(2106125152)){return;}
a_1528(); goto a_G1;
} /* galttail */
static void a_1528(void){ /* gmember */
int a_L1;int a_P[1];
...
a_G4:if(!a_1025(2106125177)){ goto a_G6;}
a_1522();return;
a_G6:if(!a_1025(2106125189)){ goto a_G9;}
a_1074(a_P);a_L1=a_P[0];
a_1541(1048586,to_LIST(a_1022)->offset[a_L1-1]);return;
a_G9:if(!a_1025(2106125235)){ goto a_G11;}
a_1541(1048584,0);return;
a_G11:if(!a_1025(2106125216)){ goto a_G13;}
...
if(!a_1025(2106125135)){ goto a_G7;}
a_1529();
a_1519(); goto a_G8;
a_G7:a_1516();
...
__booland(to_LIST(a_1007)->offset[a_L4-1],512,a_L4);
if(!__noteq(a_L4,0)){return;}
a_P[0]=2093833999;a_P[1]=a_1544;a_P[2]=to_LIST(a_1022)->offset[a_F3];a_1146(4,3,a_P);return;
} /* diagnoselocal */
...
a_P[0]=2093834010;a_P[1]=a_1543;a_P[2]=to_LIST(a_1022)->offset[a_F2];a_1146(1,3,a_P);return;
a_G5:a_P[0]=2093834010;a_P[1]=a_1543;a_P[2]=to_LIST(a_1022)->offset[a_F2];a_1146(4,3,a_P);return;
} /* diagnoseoutaffix */
static void a_1506(void){ /* diagnoseformals */
int a_L1;int a_L2;int a_L3;int a_L4;int a_P[3];
...
__booland(to_LIST(a_1007)->offset[a_L4-1],512,a_L4);
if(!__noteq(a_L4,0)){ goto a_G13;}
a_G12:a_P[0]=2093834025;a_P[1]=a_1544;a_P[2]=to_LIST(a_1022)->offset[a_L1];a_1146(4,3,a_P);
...
a_P[0]=2093834040;a_P[1]=a_1544;a_P[2]=to_LIST(a_1022)->offset[a_L1];a_1146(4,3,a_P); goto a_G13;
...
a_G3:if(!a_1025(2106125268)){ goto a_G10;}
a_1512(2106125268);
__incr(a_A[0]);
if(a_1029(a_P)){a_L2=a_P[0]; goto a_G9;}
a_1074(a_P);a_L2=a_P[0];
a_1056(a_L2,a_P);a_L2=a_P[0];
a_G9:a_P[0]=2106125159;a_P[1]=a_L2;a_1540(2,a_P); goto a_G3;
a_G10:if(a_1025(2106125177)){return;}
if(a_1025(2106125166)){return;} goto a_G2;
} /* wtransportlist */
static void a_1566(void){ /* wextension */
...
a_1541(1048580,0);
a_1274(2106125177);
a_1274(to_LIST(a_1007)->offset[a_1491]);
a_1278(a_L1);
a_L3=to_LIST(a_1006)->aupb;
...
a_1541(1048581,0);
a_1568(a_1491);
a_1274(2106125152);return;
} /* wextension */
static int a_1569(int a_A[1]){ /* wlimit+a> */

if(!a_1025(2106125272)){ goto a_G3;}
a_A[0]=2106125272; return 1;
a_G3:if(!a_1025(2106125208)){ goto a_G5;}
a_A[0]=2106125208; return 1;
a_G5:if(!a_1025(2106125280)){ goto a_G7;}
a_A[0]=2106125280; return 1;
a_G7:if(!a_1025(2106125276)){ return 0;}
a_A[0]=2106125276; return 1;
} /* wlimit */
...
a_P[0]=2106125216;a_1540(1,a_P);return;
} /* whandleaffix */
...
a_G3:a_P[0]=2106125159;a_P[1]=a_L6;a_1540(2,a_P);return;
a_G4:if(!a_1025(2106125143)){ goto a_G10;}
a_1074(a_P);a_L3=a_P[0];
if(!a_1060(a_L3)){ goto a_G8;}
a_P[0]=2106125143;a_P[1]=a_L3;a_1540(2,a_P);return;
a_G8:a_1197(a_L3,a_P);a_L6=a_P[0]; goto a_G3;
a_G10:if(!a_1569(a_P)){ goto a_G13;}a_L6=a_P[0];
a_1074(a_P);a_L3=a_P[0];
a_P[0]=a_L6;a_P[1]=a_L3;a_1540(2,a_P);return;
a_G13:if(!a_1025(2106125219)){ goto a_G15;}
a_P[0]=2106125219;a_1540(1,a_P);return;
a_G15:if(!a_1025(2106125260)){ goto a_G25;}
a_1074(a_P);a_L3=a_P[0];
a_P[0]=2106125260;a_P[1]=a_L3;a_1540(2,a_P);
a_1553(a_F1,a_P);a_L4=a_P[0];
a_1574(a_L4,a_P);
a_1071(2106125138);
...
a_G24:a_P[0]=2106125138;a_P[1]=2106125159;a_P[2]=a_L6;a_1540(3,a_P);return;
...
{ if(a_L4==16777620){ goto a_G28;}
 ...
 if(a_L4==16777603||a_L4==16777608||a_L4==16777614||a_L4==16777641){  goto a_G32;}
  goto a_G33;}
a_G28:a_P[0]=2106125257;a_1540(1,a_P);
a_A[0]=a_L3;return;
a_G30:a_1514(a_L3,a_L5,a_P);a_L6=a_P[0];
a_P[0]=2106125260;a_P[1]=a_L3;a_P[2]=2106125272;a_P[3]=a_L3;a_P[4]=2106125138;a_P[5]=2106125159;a_P[6]=a_L6;a_1540(7,a_P);return;
a_G32:a_1567(a_F1);
a_G33:a_P[0]=a_L3;a_1540(1,a_P);return;
} /* wsimpleaffix */
...
if(__equal(to_LIST(a_1006)->offset[a_A[0]],2106125235)){return;}
if(!__equal(to_LIST(a_1006)->offset[a_A[0]],2106125216)){ goto a_G6;}
__incr(a_A[0]);
a_1541(1048593,0); goto a_G1;
a_G6:if(!__equal(to_LIST(a_1006)->offset[a_A[0]],2106125159)){ goto a_G10;}
__incr(a_A[0]);
...
if(__equal(to_LIST(a_1006)->offset[a_A[0]],2106125235)){return;}
if(!__equal(to_LIST(a_1006)->offset[a_A[0]],2106125159)){ goto a_G7;}
__incr(a_A[0]);
a_G7:__incr(a_A[0]); goto a_G3;
a_G9:a_1274(2106125149);
...
a_L7=a_L5; goto a_G4;
a_G13:__incr(a_F2);
if(!__equal(to_LIST(a_1006)->offset[a_F2],2106125257)){ goto a_G17;}
a_1274(2106125257);
__incr(a_F2); goto a_G26;
a_G17:if(__equal(a_L6,16777608)){ goto a_G19;}
if(!__equal(a_L6,16777614)){ goto a_G24;}
a_G19:if(!__equal(to_LIST(a_1006)->offset[a_F2],2106125216)){ goto a_G24;}
__incr(a_F2);
a_1541(1048593,0);
...
a_1050(a_F1,a_P);a_L3=a_P[0];
a_G9:if(!a_1025(2106125235)){ goto a_G26;}
a_1512(2106125235);
a_1058(a_L3,a_P);a_L4=a_P[0];
...
a_G21:a_1274(2106125152);return;
} /* wreadbox */
static void a_1563(void){ /* wclassification */
...
static void a_1462(void){ /* wasrootscanned */
int a_P[1];
if(__is(a_1586)){return;}
a_P[0]=2093834073;a_1040(0,1,a_P);return;
} /* wasrootscanned */
static void a_1356(void){ /* passI */
int a_L1;int a_P[2];
a_G1:if(__equal(1454738963,a_1062)){return;}
if(!__equal(1454739034,a_1062)){ goto a_G8;}
a_1077();
a_1583(a_P);a_L1=a_P[0];
if(__equal(a_L1,2)){return;}
if(!__equal(a_L1,1)){ goto a_G1;}
a_G7:a_1269(); goto a_G1;
a_G8:if(!a_1321(3429901)){ goto a_G11;}
a_1588();
a_1419(1454739082); goto a_G1;
a_G11:if(a_1578(0)){ goto a_G1;}
if(!__equal(1454739001,a_1062)){ goto a_G15;}
a_1077();
a_1589(); goto a_G1;
a_G15:if(!__equal(1454738991,a_1062)){ goto a_G18;}
a_1077();
a_1584(); goto a_G1;
a_G18:if(!__equal(1454739094,a_1062)){ goto a_G21;}
a_1077();
a_1591(); goto a_G1;
a_G21:if(!__equal(1454738996,a_1062)){ goto a_G24;}
a_1077();
a_1579(); goto a_G1;
a_G24:if(!__equal(1454738959,a_1062)){ goto a_G27;}
a_1077(); goto a_G7;
a_G27:a_P[0]=2093834047;a_P[1]=a_1062;a_1108(2,a_P);
a_1269(); goto a_G1;
} /* passI */
static void a_1591(void){ /* tagenquiry */
int a_L1;int a_L2;int a_L3;int a_L4;int a_P[4];
if(!a_1321(3429893)){ goto a_G15;}
if(!a_1582(a_P)){ goto a_G15;}a_L1=a_P[0];
a_1580(a_L1,a_P);a_L2=a_P[0];
if(!__equal(a_L2,0)){ goto a_G7;}
a_G5:a_1588();
a_1419(1454739082);return;
a_G7:if(!__equal(a_L2,2)){return;}
a_1581(a_L1,a_P);a_L1=a_P[0];
a_1198(a_L1,a_P);a_L2=a_P[0];
a_1314(a_P);a_L3=a_P[0];
a_1058(a_L1,a_P);a_L4=a_P[0];
a_P[0]=2093834084;a_P[1]=a_L4;a_P[2]=a_L1;a_P[3]=a_L3;a_1103(8,a_L2,4,a_P); goto a_G5;
a_G15:a_P[0]=2093834047;a_P[1]=1454739094;a_1108(2,a_P);
a_1269();return;
} /* tagenquiry */
static int a_1578(int a_F1){ /* declaration+>a */

if(!__equal(1454739025,a_1062)){ goto a_G4;}
a_1077();
a_1452(a_F1); return 1;
a_G4:if(!__equal(1454739029,a_1062)){ goto a_G7;}
a_1077();
a_1450(a_F1); return 1;
a_G7:if(!__equal(1454739021,a_1062)){ goto a_G10;}
a_1077();
a_1592(a_F1); return 1;
a_G10:if(!__equal(1454739016,a_1062)){ goto a_G13;}
a_1077();
a_1577(a_F1); return 1;
a_G13:if(!__equal(1454739006,a_1062)){ goto a_G16;}
a_1077();
a_1250(a_F1); return 1;
a_G16:if(!__equal(1454739011,a_1062)){ goto a_G19;}
a_1077();
a_1251(a_F1); return 1;
a_G19:if(!__equal(1454738968,a_1062)){ goto a_G22;}
a_1077();
a_1587(256,a_F1); return 1;
a_G22:if(!__equal(1454738973,a_1062)){ goto a_G25;}
a_1077();
a_1587(0,a_F1); return 1;
a_G25:if(!__equal(1454738983,a_1062)){ goto a_G28;}
a_1077();
a_1587(512,a_F1); return 1;
a_G28:if(!__equal(1454738978,a_1062)){ goto a_G31;}
a_1077();
a_1587(768,a_F1); return 1;
a_G31:if(!__equal(1454738987,a_1062)){ return 0;}
a_1077();
a_1587(1024,a_F1); return 1;
} /* declaration */
static void a_1579(void){ /* externaldeclaration */
int a_P[2];
if(!a_1321(3429893)){ goto a_G8;}
if(a_1578(1)){return;}
if(!__equal(1454738959,a_1062)){ goto a_G6;}
a_1077();
a_G5:a_1269();return;
a_G6:a_P[0]=2093834047;a_P[1]=a_1062;a_1108(2,a_P); goto a_G5;
a_G8:a_P[0]=2093834060;a_1108(1,a_P);
a_1269();return;
} /* externaldeclaration */
static void a_1589(void){ /* staticdeclaration */
int a_P[2];
if(!__equal(1454739021,a_1062)){ goto a_G4;}
a_1077();
a_1590();return;
a_G4:if(!__equal(1454739029,a_1062)){ goto a_G7;}
a_1077();
a_1451();return;
a_G7:if(!__equal(1454738959,a_1062)){ goto a_G10;}
a_1077();
a_1269();return;
a_G10:a_P[0]=2093834047;a_P[1]=a_1062;a_1108(2,a_P);
a_1269();return;
} /* staticdeclaration */
static void a_1584(void){ /* root */
int a_P[1];
if(!__is(a_1586)){ goto a_G4;}
a_P[0]=2093834068;a_1108(1,a_P);
a_1269();return;
a_G4:a_1586=1;
a_1585();return;
} /* root */
...
static void a_1457(void){ /* passII */
int a_L1;int a_P[1];
a_G1:if(!a_1025(2106125251)){ goto a_G5;}
a_1074(a_P);a_L1=a_P[0];
a_1597(a_L1);
a_G4:a_1185(a_L1); goto a_G1;
a_G5:if(!a_1025(2106125247)){ goto a_G8;}
a_1074(a_P);a_L1=a_P[0]; goto a_G4;
a_G8:if(!a_1025(2106125243)){ goto a_G10;}
a_1596(); goto a_G1;
a_G10:if(!a_1025(2106125172)){ goto a_G12;}
a_1301(); goto a_G1;
a_G12:if(!a_1025(2106125181)){ goto a_G14;}
a_1302(); goto a_G1;
a_G14:if(!a_1025(2106125185)){ goto a_G16;}
a_1304(); goto a_G1;
a_G16:if(!a_1025(2106125200)){ goto a_G18;}
a_1305(); goto a_G1;
a_G18:if(a_1025(2106125166)){return;}
a_1063(a_1001,16777454,50);return;
} /* passII */
static void a_1458(void){ /* passIII */
int a_L1;int a_P[1];
a_G1:if(!a_1025(2106125251)){ goto a_G4;}
a_G2:a_1074(a_P);a_L1=a_P[0];
a_1521(a_L1); goto a_G1;
a_G4:if(a_1025(2106125247)){ goto a_G2;}
if(!a_1025(2106125243)){ goto a_G11;}
a_1072(a_P);
if(a_1029(a_P)){ goto a_G1;}
a_1074(a_P); goto a_G1;
a_G11:if(!a_1025(2106125172)){ goto a_G13;}
a_G12:a_1034(2106125238); goto a_G1;
a_G13:if(a_1025(2106125181)){ goto a_G12;}
if(a_1025(2106125185)){ goto a_G12;}
if(a_1025(2106125200)){ goto a_G12;}
if(a_1025(2106125166)){return;}
a_1063(a_1001,16777450,61);return;
} /* passIII */
static void a_1597(int a_F1){ /* dstoremacro+>a */
int a_L2;int a_L3;int a_P[2];
if(a_1147()){return;}
if(!a_1205(a_F1,128)){return;}
a_1086(a_P);a_L2=a_P[0];a_L3=a_P[1];
a_1598(a_F1,a_L2,a_L3);return;
} /* dstoremacro */
static void a_1595(int a_F1){ /* checktagforpublic+>a */
int a_L2;int a_L3;int a_P[4];
if(!a_1205(a_F1,2)){ goto a_G8;}
a_1198(a_F1,a_P);a_L3=a_P[0];
a_1058(a_F1,a_P);a_L2=a_P[0];
if(!a_1205(a_F1,16)){ goto a_G6;}
a_G5:a_P[0]=2093834100;a_P[1]=a_L2;a_P[2]=a_F1;a_P[3]=a_L3;a_1108(4,a_P);return;
a_G6:if(!a_1205(a_F1,8)){return;} goto a_G5;
a_G8:if(!a_1205(a_F1,4)){return;}
a_P[0]=2093834090;a_P[1]=a_F1;a_1108(2,a_P);return;
} /* checktagforpublic */
static void a_1594(int a_F1){ /* checktagformacro+>a */
int a_L2;int a_L3;int a_P[4];
...
a_1294(a_F1,128);
a_P[0]=2093834110;a_P[1]=a_L2;a_P[2]=a_F1;a_P[3]=a_L3;a_1146(3,4,a_P);return;
a_G7:if(!a_1205(a_F1,16)){ goto a_G10;}
a_1294(a_F1,128);
a_P[0]=2093834110;a_P[1]=2093834116;a_P[2]=a_F1;a_P[3]=a_L3;a_1146(3,4,a_P);return;
a_G10:if(!a_1205(a_F1,8)){return;}
a_1294(a_F1,128);
a_P[0]=2093834110;a_P[1]=2093834122;a_P[2]=a_F1;a_P[3]=a_L3;a_1146(3,4,a_P);return;
a_G13:a_P[0]=2093834131;a_P[1]=a_F1;a_1146(3,2,a_P);return;
} /* checktagformacro */
static void a_1596(void){ /* dreadpragmat */
int a_L1;int a_L2;int a_P[1];
a_1072(a_P);a_L1=a_P[0];
...
{ if(a_F1==3429888){ goto a_G2;}
 ...
 if(a_F1==3429900){  goto a_G14;}
  goto a_G15;}
a_G2:a_A[0]=a_1639;return;
a_G3:a_A[0]=a_1611;return;
a_G4:a_A[0]=a_1615;return;
a_G5:a_A[0]=a_1614;return;
a_G6:a_A[0]=a_1616;return;
a_G7:a_A[0]=a_1606;return;
a_G8:a_A[0]=a_1643;return;
a_G9:a_A[0]=a_1642;return;
a_G10:a_A[0]=a_1631;return;
a_G11:a_A[0]=a_1630;return;
a_G12:a_A[0]=a_1613;return;
a_G13:a_A[0]=a_1612;return;
a_G14:a_A[0]=a_1633;return;
a_G15:a_1063(a_1001,16777466,124);return;
} /* getpragmatvalue */
...
{ if(a_F1==3429893){ goto a_G2;}
 ...
 if(a_F1==3429896){  goto a_G10;}
  return 0;}
a_G2:if(!__equal(a_1615,1)){ return 0;} return 1;
a_G3:if(!__equal(a_1614,1)){ return 0;} return 1;
a_G4:if(!__equal(a_1616,1)){ return 0;} return 1;
a_G5:if(!__equal(a_1611,1)){ return 0;} return 1;
a_G6:if(!__is(a_1623)){ return 0;} return 1;
a_G7:if(!__is(a_1606)){ return 0;} return 1;
a_G8:if(!__is(a_1641)){ return 0;} return 1;
a_G9:if(!__is(a_1605)){ return 0;} return 1;
a_G10:if(!__is(a_1602)){ return 0;} return 1;
} /* ispragmatvalue */
static void a_1361(int a_F1,int a_F2){ /* setpragmatvalue+>a+>a */
...
{ if(a_F1==3429888){ goto a_G2;}
 ...
 if(a_F1==3429907){  goto a_G21;}
  goto a_G22;}
a_G2:a_1639=a_F2;return;
a_G3:a_1611=a_F2;return;
a_G4:if(!__is(a_F2)){ goto a_G6;}
a_1637();return;
a_G6:a_1603();return;
a_G7:a_1614=a_F2;return;
a_G8:if(!__is(a_F2)){ goto a_G11;}
a_1616=1;
a_1631=2;return;
a_G11:a_1616=0;return;
a_G12:a_1606=a_F2;return;
a_G13:if(__equal(a_F2,a_1643)){return;}
if(__less(a_F2,0)){return;}
if(__more(a_F2,9)){return;}
a_1643=a_F2;return;
a_G17:a_1642=a_F2;return;
a_G18:a_1631=a_F2;return;
a_G19:a_1630=a_F2;return;
a_G20:a_1613=a_F2;return;
a_G21:a_1612=a_F2;return;
a_G22:a_1063(a_1001,16777460,155);return;
} /* setpragmatvalue */
static void a_1636(void){ /* setliblevel */
...
a_1634=a_1631;
a_1631=0;
if(!__less(a_1643,3)){ goto a_G6;}
a_1643=5;return;
a_G6:a_1643=5;return;
} /* setliblevel */
static void a_1632(void){ /* restoreliblevel */

a_1643=a_1635;
a_1631=a_1634;return;
} /* restoreliblevel */
static void a_1637(void){ /* setlibrary */

if(__is(a_1615)){return;}
a_1615=1;
a_1636();
a_1607(3429889,a_1643);return;
} /* setlibrary */
static void a_1603(void){ /* clearlibrary */
...
a_1631=0;
a_1614=1;
a_1641=0;a_1605=0;a_1602=0;
a_1623=0;a_1622=0;return;
} /* resetpragmats */
static void a_1347(void){ /* cmdlinepragmat */
int a_L1;int a_P[1];
a_G1:if(!a_1582(a_P)){ goto a_G10;}a_L1=a_P[0];
a_1263(1454739040);
a_1626(a_L1);
if(!__equal(1454739082,a_1062)){ goto a_G6;}
a_1077();return;
a_G6:if(!__equal(1454739076,a_1062)){ goto a_G8;}
a_1077(); goto a_G1;
a_G8:a_1263(1454739082);
a_1269();return;
a_G10:a_P[0]=2093834139;a_1108(1,a_P);
a_1269();return;
} /* cmdlinepragmat */
static void a_1626(int a_F1){ /* pragmatitem+>a */
int a_L2;int a_P[2];
if(!__equal(1454739067,a_1062)){ goto a_G7;}
a_G2:a_1077();
a_1626(a_F1);
if(__equal(1454739076,a_1062)){ goto a_G2;}
a_1263(1454739070);return;
a_G7:if(!a_1582(a_P)){ goto a_G9;}a_L2=a_P[0];
a_1640(a_F1,a_L2,0);return;
a_G9:if(!a_1430(a_P)){ goto a_G11;}a_L2=a_P[0];
a_1604(a_F1,a_L2);return;
a_G11:if(!a_1260(a_P)){ goto a_G13;}a_L2=a_P[0];
a_1638(a_F1,a_L2);return;
a_G13:a_P[0]=2093834146;a_P[1]=a_F1;a_1108(2,a_P);
a_1268();return;
} /* pragmatitem */
static void a_1618(int a_F1,int a_F2){ /* markrawtagasmacro+>a+>a */
int a_L3;int a_L4;int a_P[2];
if(__lseq(a_F2,0)){ goto a_G3;}
a_1600(a_F1,a_F2);
a_G3:a_1581(a_F1,a_P);a_L3=a_P[0];
a_1058(a_L3,a_P);a_L4=a_P[0];
if(!a_1205(a_L3,56)){ goto a_G7;}
a_P[0]=2093834207;a_P[1]=a_L3;a_1146(2,2,a_P);return;
...
a_1015(3429904);
a_1017(a_L3);return;
a_G13:a_P[0]=2093834207;a_P[1]=a_L3;a_1146(3,2,a_P);return;
} /* markrawtagasmacro */
static void a_1619(int a_F1,int a_F2){ /* markrawtagaspublic+>a+>a */
int a_L3;int a_L4;int a_P[1];
if(__lseq(a_F2,0)){ goto a_G3;}
a_1600(a_F1,a_F2);
a_G3:a_1581(a_F1,a_P);a_L3=a_P[0];
...
static int a_1601(int a_A[1]){ /* aheadrawtag+a> */

if(!__was(a_1039,a_1062)){ return 0;}
a_A[0]=a_1062; return 1;
} /* aheadrawtag */
static void a_1617(int a_F1){ /* insertsymbol+>a */

a_1062=a_F1;return;
} /* insertsymbol */
static void a_1620(void){ /* nextpragmatsymbol */
int a_P[1];
a_G1:{ if(a_1624==0){ goto a_G2;}
 if(a_1624==1){ goto a_G6;}
 if(a_1624==2){ goto a_G10;}
 if(a_1624==3){ goto a_G14;}
 if(a_1624==4){ goto a_G20;}
 if(a_1624==5){ goto a_G24;}
 if(a_1624==6){ goto a_G30;}
 if(a_1624==7){  goto a_G32;}
  goto a_G34;}
a_G2:a_1077();
if(!__equal(1454739076,a_1062)){ goto a_G5;}
a_1624=1;return;
a_G5:a_1624=100;return;
a_G6:a_1077();
if(!a_1601(a_P)){ goto a_G5;}a_1625=a_P[0];
a_1624=2;return;
a_G10:a_1077();
if(!__equal(1454739040,a_1062)){ goto a_G5;}
a_1624=3;return;
a_G14:a_1077();
{ if(!((1454739123<=a_1062 && a_1062<=1516190427)||(1516190429<=a_1062 && a_1062<=1712834604)||(963127759<=a_1062 && a_1062<=1454738198))){ goto a_G17;}
}
a_1624=0;return;
a_G17:if(!__equal(1454739067,a_1062)){ goto a_G5;}
a_1624=4; goto a_G1;
a_G20:a_1077();
...
a_1624=5;return;
a_G24:a_1077();
if(!__equal(1454739076,a_1062)){ goto a_G27;}
a_1624=6;return;
a_G27:if(!__equal(1454739070,a_1062)){ goto a_G5;}
a_1624=0; goto a_G1;
a_G30:a_1617(a_1625);
a_1624=7;return;
a_G32:a_1617(1454739040);
a_1624=4;return;
a_G34:if(__equal(1454738963,a_1062)){return;}
a_1077();return;
} /* nextpragmatsymbol */
static void a_1583(int a_A[1]){ /* programpragmat+a> */
int a_P[1];
a_1624=100;
a_1627(a_P);a_A[0]=a_P[0];return;
} /* programpragmat */
static void a_1627(int a_A[1]){ /* programpragmat2+a> */
int a_L2;int a_P[1];
a_A[0]=0;
a_G2:if(!a_1601(a_P)){ goto a_G15;}a_L2=a_P[0];
if(!__equal(a_1624,100)){ goto a_G6;}
a_1625=a_L2;
a_1624=2;
a_G6:a_1620();
if(!__equal(1454739040,a_1062)){ goto a_G15;}
a_1620();
a_P[0]=a_A[0];a_1628(a_1625,a_P);a_A[0]=a_P[0];
if(__is(a_A[0])){return;}
if(!__equal(1454739082,a_1062)){ goto a_G13;}
a_1077();return;
a_G13:if(!__equal(1454739076,a_1062)){ goto a_G15;}
a_1620(); goto a_G2;
a_G15:a_P[0]=2093834139;a_1108(1,a_P);
a_A[0]=1;return;
} /* programpragmat2 */
static void a_1628(int a_F1,int a_A[1]){ /* programpragmatitem+>a+>a> */
int a_L3;int a_L4;int a_P[2];
...
a_1620();
if(__is(a_1623)){return;}
a_1604(a_F1,a_L3);return;
a_G6:a_L3=a_1062;
a_1620();
if(__is(a_1623)){return;}
a_1638(a_F1,a_L3);return;
a_G10:a_L3=a_1062;
a_1314(a_P);a_L4=a_P[0];
a_1620();
a_P[0]=a_A[0];a_1629(a_F1,a_L3,a_L4,a_P);a_A[0]=a_P[0];return;
a_G14:a_P[0]=2093834146;a_P[1]=a_F1;a_1108(2,a_P);
a_A[0]=1;return;
} /* programpragmatitem */
static void a_1609(int a_F1,int a_F2,int a_A[1]){ /* findifcondition+>a+>a+a> */
int a_P[3];
{ if(a_F2==963127809){ goto a_G2;}
 ...
 if(a_F2==963127877){  goto a_G6;}
  goto a_G7;}
a_G2:a_A[0]=a_1611;return;
a_G3:a_A[0]=a_1606;return;
a_G4:a_A[0]=a_1614;return;
a_G5:a_A[0]=a_1616;return;
a_G6:a_A[0]=a_1615;return;
a_G7:a_P[0]=2093834155;a_P[1]=a_F1;a_P[2]=a_F2;a_1108(3,a_P);
a_A[0]=0;return;
} /* findifcondition */
static void a_1610(void){ /* findmatchingendif */
int a_L1;int a_P[2];
if(!__equal(1454739082,a_1062)){ goto a_G4;}
a_1077();
a_L1=0; goto a_G9;
a_G4:if(!__equal(1454739076,a_1062)){ goto a_G7;}
a_1620();
a_1627(a_P);a_L1=a_P[0]; goto a_G9;
a_G7:a_P[0]=2093834139;a_1108(1,a_P);
a_L1=1;
a_G9:if(!__equal(a_L1,1)){ goto a_G11;}
a_1269();
a_G11:if(__equal(a_L1,2)){return;}
a_1356();
if(!__equal(1454738963,a_1062)){return;}
a_P[0]=2093834175;a_P[1]=a_1622;a_1108(2,a_P);return;
} /* findmatchingendif */
static void a_1608(int a_F1,int a_F2){ /* dopragmatskip+>a+>a */
int a_L3;int a_L4;
a_L3=a_1622;
a_1622=a_F1;
a_L4=a_1623;
...
static void a_1629(int a_F1,int a_F2,int a_F3,int a_A[1]){ /* programtagpragmat2+>a+>a+>a+>a> */
int a_L5;int a_P[3];
{ if(a_F1==963127994){ goto a_G2;}
 ...
 if(a_F1==963128039){  goto a_G26;}
  goto a_G31;}
a_G2:a_1609(a_F1,a_F2,a_P);a_L5=a_P[0];
if(!__is(a_L5)){ goto a_G5;}
a_G4:a_1608(a_F2,0);return;
a_G5:a_1608(a_F2,1);return;
a_G6:a_1609(a_F1,a_F2,a_P);a_L5=a_P[0];
if(__is(a_L5)){ goto a_G5;} goto a_G4;
a_G10:a_1580(a_F2,a_P);a_L5=a_P[0];
if(__equal(a_L5,2)){ goto a_G4;} goto a_G5;
a_G14:a_1580(a_F2,a_P);a_L5=a_P[0];
if(__noteq(a_L5,2)){ goto a_G5;} goto a_G4;
a_G18:if(!__equal(a_1622,a_F2)){ goto a_G23;}
if(!__equal(a_1623,0)){ goto a_G21;}
a_G20:a_1623=1;return;
a_G21:if(!__equal(a_1623,1)){return;}
a_1623=0;return;
a_G23:a_P[0]=2093834186;a_P[1]=a_F1;a_P[2]=a_F2;a_1108(3,a_P);
if(__more(a_1623,0)){return;} goto a_G20;
a_G26:if(!__equal(a_1622,a_F2)){ goto a_G28;}
a_G27:a_A[0]=2;return;
a_G28:a_P[0]=2093834186;a_P[1]=a_F1;a_P[2]=a_F2;a_1108(3,a_P);
if(__equal(a_1622,0)){return;} goto a_G27;
a_G31:if(__is(a_1623)){return;}
a_1640(a_F1,a_F2,a_F3);return;
} /* programtagpragmat2 */
static void a_1607(int a_F1,int a_F2){ /* discpragmat+>a+>a */

a_1012(2106125243);
a_1015(a_F1);
a_1015(a_F2);return;
} /* discpragmat */
static void a_1621(int a_F1,int a_F3,int a_A[1]){ /* onoffpragmats+>a+>a>+>a */
int a_P[3];
if(!__equal(a_F3,963127766)){ goto a_G3;}
a_A[0]=1;return;
a_G3:if(!__equal(a_F3,963127774)){ goto a_G5;}
a_A[0]=0;return;
a_G5:a_P[0]=2093834155;a_P[1]=a_F1;a_P[2]=a_F3;a_1108(3,a_P);return;
} /* onoffpragmats */
static void a_1640(int a_F1,int a_F2,int a_F3){ /* tagpragmat2+>a+>a+>a */
int a_P[3];
...
a_1611=0;return;
a_G6:a_P[0]=2093834155;a_P[1]=a_F1;a_P[2]=a_F2;a_1108(3,a_P);return;
...
a_G24:a_1631=0;return;
a_G25:if(!__equal(a_F2,963127931)){ goto a_G27;}
a_1631=2;return;
a_G27:if(!__equal(a_F2,963127950)){ goto a_G6;}
a_1631=1;return;
a_G30:if(!__equal(a_1614,0)){ goto a_G32;}
a_P[0]=2093834198;a_P[1]=a_F1;a_1146(2,2,a_P);return;
a_G32:if(__equal(a_F2,963127782)){ goto a_G34;}
if(!__equal(a_F2,963127774)){ goto a_G6;}
a_G34:a_1642=0;return;
a_G36:a_1618(a_F2,a_F3);return;
a_G37:a_1619(a_F2,a_F3);return;
a_G38:a_P[0]=a_1641;a_1621(963127968,a_F2,a_P);a_1641=a_P[0];return;
a_G39:a_P[0]=a_1605;a_1621(963127986,a_F2,a_P);a_1605=a_P[0];return;
a_G40:a_P[0]=a_1602;a_1621(963127977,a_F2,a_P);a_1602=a_P[0];return;
a_G41:a_P[0]=2093834146;a_P[1]=a_F1;a_1108(2,a_P);return;
} /* tagpragmat2 */
static void a_1604(int a_F1,int a_F2){ /* conspragmat2+>a+>a */
int a_P[3];
...
a_1639=a_F2;return;
a_G4:a_P[0]=2093834166;a_P[1]=a_F1;a_P[2]=a_F2;a_1108(3,a_P);return;
...
a_1633=a_F2;return;
a_G12:a_P[0]=2093834146;a_P[1]=a_F1;a_1108(2,a_P);return;
} /* conspragmat2 */
static void a_1638(int a_F1,int a_F2){ /* stringpragmat2+>a+>a */
int a_P[2];
...
a_G4:if(!__is(a_1614)){return;}
a_1630=a_F2;return;
a_G6:if(!__is(a_1614)){return;}
a_1630=a_F2;
a_1616=1;
a_1631=2;return;
a_G10:a_1312(a_F2);
a_P[0]=2093834146;a_P[1]=a_F1;a_1108(2,a_P);return;
} /* stringpragmat2 */
static void a_1599(void){ /* @root */

} /* @root */
static void a_1657(int a_F1){ /* handleformallist+>a */
int a_P[1];
{register int a_r1=to_LIST(a_1022)->offset[to_LIST(a_1022)->aupb-2];
...
static void a_1672(int a_F1,int a_A[1]){ /* setuplocalstack+>a+a> */
int a_L3;int a_P[1];
__scratch(a_1022);
a_1050(a_F1,a_P);a_L3=a_P[0];
...
static void a_1663(int a_F1,int a_A[1]){ /* opennewlocalrange+>a+a> */
...
static void a_1645(int a_F1){ /* addlocalaffix+>a */
int a_L2;int a_L3;int a_P[1];
a_1056(a_F1,a_P);a_L2=a_P[0];
a_1058(a_F1,a_P);a_L3=a_P[0];
...
a_1267(a_F1,16777641);
a_1266(a_F1,to_LIST(a_1022)->aupb);return;
} /* addlocalaffix */
static void a_1653(int a_F1){ /* closelocalrange+>a */
...
static void a_1674(void){ /* skipoveranindex */
int a_P[2];
if(!__equal(1454739055,a_1062)){return;}
a_1077();
a_1677(a_P);
if(!__equal(1454739058,a_1062)){ goto a_G6;}
a_1077();return;
a_G6:if(__is(a_1681)){return;}
a_1681=1;
a_P[0]=2093834216;a_P[1]=1454739058;a_1108(2,a_P);return;
} /* skipoveranindex */
static void a_1677(int a_A[1]){ /* skipoversource+a> */
int a_L2;int a_P[2];
a_A[0]=0;
a_L2=a_1062;
if(a_1430(a_P)){return;}
if(!a_1261(a_P)){ goto a_G15;}
if(!__equal(1454739064,a_1062)){ goto a_G12;}
a_1077();
if(!a_1261(a_P)){ goto a_G9;}
a_G8:a_1674();return;
a_G9:if(__is(a_1681)){return;}
a_1681=1;
a_P[0]=2093834234;a_P[1]=1454739064;a_1108(2,a_P);return;
a_G12:if(__equal(1454739055,a_1062)){ goto a_G8;}
a_A[0]=1;return;
a_G15:if(!__equal(1454739049,a_1062)){ goto a_G17;}
a_G16:a_1077(); goto a_G25;
a_G17:if(__equal(1454739052,a_1062)){ goto a_G16;}
if(__equal(1454739043,a_1062)){ goto a_G16;}
if(__equal(1454739046,a_1062)){ goto a_G16;}
if(__equal(1454739061,a_1062)){ goto a_G16;} goto a_G29;
a_G25:if(a_1261(a_P)){return;}
if(__is(a_1681)){return;}
a_1681=1;
a_P[0]=2093834234;a_P[1]=a_L2;a_1108(2,a_P);return;
a_G29:if(__is(a_1681)){return;}
a_1681=1;
a_P[0]=2093834248;a_1108(1,a_P);return;
} /* skipoversource */
static void a_1675(void){ /* skipoverdestination */
int a_P[2];
if(!__equal(1454739037,a_1062)){ goto a_G9;}
a_G2:a_1077();
if(!a_1261(a_P)){ goto a_G6;}
if(!__equal(1454739037,a_1062)){return;} goto a_G2;
a_G6:if(__is(a_1681)){return;}
a_1681=1;
a_P[0]=2093834258;a_1108(1,a_P);return;
a_G9:if(__is(a_1681)){return;}
a_1681=1;
a_P[0]=2093834216;a_P[1]=1454739037;a_1108(2,a_P);return;
} /* skipoverdestination */
static void a_1676(int a_F1,int a_A[2]){ /* skipoverextension+>a+a>+a> */
int a_P[1];
a_1681=0;
a_A[0]=0;a_A[1]=0;
a_1429();
...
a_G5:a_1677(a_P);
a_1675();
if(!__equal(1454739076,a_1062)){ goto a_G9;}
a_1077(); goto a_G5;
a_G9:a_1263(1454739064);
if(!__is(a_F1)){ goto a_G14;}
if(!__equal(1454739070,a_1062)){ goto a_G14;}
a_1077();
a_A[1]=1;
a_G14:if(a_1261(a_P)){a_A[0]=a_P[0]; goto a_G18;}
if(__is(a_1681)){ goto a_G18;}
a_1681=1;
a_P[0]=2093834268;a_1108(1,a_P);
a_G18:if(!__is(a_1681)){ goto a_G21;}
a_1425();
a_1268();return;
a_G21:a_1435();return;
} /* skipoverextension */
static void a_1664(int a_A[1]){ /* peekaftersource+a> */
int a_L2;int a_P[1];
a_1681=0;
a_1429();
a_A[0]=0;
a_1677(a_P);a_L2=a_P[0];
if(a_1659(a_1062,a_P)){a_A[0]=a_P[0]; goto a_G10;}
if(__is(a_L2)){ goto a_G10;}
if(__is(a_1681)){ goto a_G10;}
a_1681=1;
a_P[0]=2093834275;a_1108(1,a_P);
a_G10:if(!__is(a_1681)){ goto a_G13;}
a_1425();
a_1268();return;
a_G13:a_1435();return;
} /* peekaftersource */
static void a_1670(int a_F1){ /* searchjump+>a */
int a_L2;int a_P[3];
a_L2=to_LIST(a_1022)->aupb;
a_G2:if(!__less(a_L2,to_LIST(a_1022)->alwb)){ goto a_G4;}
a_P[0]=2093834284;a_P[1]=a_1669;a_P[2]=a_F1;a_1108(3,a_P);return;
...
static int a_1682(void){ /* terminator */
int a_L1;int a_P[2];
if(!__equal(1454739088,a_1062)){ goto a_G4;}
a_1077();
a_1012(2106125235); return 1;
a_G4:if(!__equal(1454739085,a_1062)){ goto a_G7;}
a_1077();
a_1012(2106125216); return 1;
a_G7:if(!__equal(1454738987,a_1062)){ goto a_G14;}
a_1077();
a_1017(483807615);
a_1271(483807615);
a_1012(2106125235);
a_1681=0;
a_1678(483807615); return 1;
a_G14:if(!__equal(1454739073,a_1062)){ return 0;}
a_1077();
if(!a_1261(a_P)){ goto a_G18;}a_L1=a_P[0];
a_1670(a_L1); return 1;
a_G18:a_P[0]=2093834234;a_P[1]=1454739073;a_1108(2,a_P); return 1;
} /* terminator */
static void a_1658(int a_F1){ /* indexsource+>a */
int a_P[3];
if(!__equal(1454739055,a_1062)){ goto a_G12;}
a_1077();
a_1012(2106125260);
a_1017(a_F1);
a_1678(a_F1);
a_1012(2106125138);
if(!__equal(1454739058,a_1062)){ goto a_G9;}
a_1077();return;
a_G9:if(__is(a_1681)){return;}
a_1681=1;
a_P[0]=2093834226;a_P[1]=1454739058;a_P[2]=a_F1;a_1108(3,a_P);return;
a_G12:a_1012(2106125260);
a_1017(a_F1);
a_1012(2106125272);
a_1017(a_F1);
a_1012(2106125138);return;
} /* indexsource */
static void a_1671(int a_F1,int a_F2){ /* selector+>a+>a */
int a_L3;int a_L4;int a_P[2];
...
a_1015(a_L4);return;
a_G9:a_P[0]=2093834303;a_P[1]=a_F1;a_1108(2,a_P);return;
a_G10:a_1017(a_F1);return;
} /* selector */
static void a_1660(int a_F1){ /* listtag+>a */
int a_L2;int a_P[2];
if(!a_1261(a_P)){ goto a_G4;}a_L2=a_P[0];
a_1271(a_L2);
a_1017(a_L2);return;
a_G4:if(__is(a_1681)){return;}
a_1681=1;
a_P[0]=2093834234;a_P[1]=a_F1;a_1108(2,a_P);return;
} /* listtag */
static void a_1678(int a_F1){ /* source+>a */
int a_L2;int a_L3;int a_P[2];
...
a_1658(a_L3);
a_1271(a_L3);
a_1671(a_L2,a_L3);return;
a_G10:if(__is(a_1681)){return;}
a_1681=1;
a_P[0]=2093834234;a_P[1]=1454739064;a_1108(2,a_P);return;
a_G13:if(!__equal(1454739055,a_1062)){ goto a_G17;}
a_1658(a_L2);
a_1271(a_L2);
a_1671(a_L2,a_L2);return;
a_G17:a_1271(a_L2);
a_1017(a_L2);return;
a_G19:if(!__equal(1454739049,a_1062)){ goto a_G23;}
a_1077();
a_1012(2106125208);
a_1660(1454739049);return;
a_G23:if(!__equal(1454739052,a_1062)){ goto a_G27;}
a_1077();
a_1012(2106125272);
a_1660(1454739052);return;
a_G27:if(!__equal(1454739043,a_1062)){ goto a_G31;}
a_1077();
a_1012(2106125276);
a_1660(1454739043);return;
a_G31:if(!__equal(1454739046,a_1062)){ goto a_G35;}
a_1077();
a_1012(2106125280);
a_1660(1454739046);return;
a_G35:if(!__equal(1454739061,a_1062)){ goto a_G39;}
a_1077();
a_1012(2106125143);
a_1660(1454739061);return;
a_G39:if(__is(a_1681)){ goto a_G42;}
a_1681=1;
a_P[0]=2093834293;a_P[1]=a_F1;a_1108(2,a_P);
a_G42:a_1268();return;
} /* source */
static void a_1679(int a_F1){ /* sourceorstring+>a */
int a_L2;int a_L3;int a_P[1];
...
a_1012(2106125235);
a_1017(a_L3);return;
a_G7:if(!__equal(1454739091,a_1062)){ goto a_G11;}
a_G8:a_1077();
a_1012(2106125235);
a_1012(2106125219);return;
a_G11:if(__equal(1454739094,a_1062)){ goto a_G8;}
a_1012(2106125235);
a_1678(a_F1);return;
} /* sourceorstring */
static int a_1666(void){ /* repeataffix */
int a_P[2];
if(!__equal(1454739064,a_1062)){ return 0;}
a_1077();
if(!__is(a_1656)){ goto a_G6;}
a_1012(2106125235);
a_1017(a_1656); return 1;
a_G6:a_P[0]=2093834333;a_P[1]=a_1669;a_1108(2,a_P); return 1;
} /* repeataffix */
static void a_1647(void){ /* affixform */
int a_L1;int a_P[2];
if(!a_1261(a_P)){ goto a_G12;}a_L1=a_P[0];
if(!a_1060(a_L1)){ goto a_G5;}
a_P[0]=2093834323;a_P[1]=a_L1;a_1108(2,a_P);
a_1268();return;
a_G5:a_1017(a_L1);
a_1271(a_L1);
a_1681=0;
a_G8:if(!__equal(1454739088,a_1062)){return;}
a_1077();
if(a_1666()){return;}
a_1679(a_L1); goto a_G8;
a_G12:a_P[0]=2093834240;a_1108(1,a_P);
a_1268();return;
} /* affixform */
static void a_1680(int a_F1){ /* specialaffixform+>a */
...
a_1681=0;
a_1678(a_F1);
if(__is(a_1681)){ goto a_G8;}
a_1077();
a_G8:a_1012(2106125235);
a_1678(a_F1);
if(!__equal(a_F1,483807609)){return;}
a_G11:if(!__equal(1454739037,a_1062)){return;}
a_1077();
a_1012(2106125235);
a_1678(a_F1); goto a_G11;
} /* specialaffixform */
static void a_1683(int a_F1){ /* toselectors+>a */
int a_L2;int a_P[2];
if(!__equal(1454739037,a_1062)){ goto a_G12;}
a_G2:a_1077();
if(!a_1261(a_P)){ goto a_G8;}a_L2=a_P[0];
a_1012(2106125268);
a_1671(a_L2,a_F1);
if(!__equal(1454739037,a_1062)){return;} goto a_G2;
a_G8:if(__is(a_1681)){ goto a_G11;}
a_1681=1;
a_P[0]=2093834234;a_P[1]=1454739037;a_1108(2,a_P);
a_G11:a_1268();return;
a_G12:if(__is(a_1681)){return;}
a_1681=1;
a_P[0]=2093834216;a_P[1]=1454739037;a_1108(2,a_P);return;
} /* toselectors */
static void a_1655(int a_F1){ /* extension+>a */
...
a_G6:a_1678(a_F1);
a_1683(a_F1);
if(!__equal(1454739076,a_1062)){ goto a_G10;}
a_1077(); goto a_G6;
a_G10:a_1012(2106125177);
a_1419(1454739064);
a_1419(1454739070);
a_1419(a_F1);return;
} /* extension */
...
static void a_1662(void){ /* member */
int a_L1;int a_L2;int a_P[2];
if(!__equal(1454739067,a_1062)){ goto a_G10;}
a_1077();
if(!__equal(1454739064,a_1062)){ goto a_G8;}
a_1676(1,a_P);a_L1=a_P[0];a_L2=a_P[1];
if(__is(a_1681)){return;}
if(!__is(a_L2)){ goto a_G8;}
a_G7:a_1655(a_L1);return;
a_G8:a_1654();return;
a_G10:if(!__equal(1454739064,a_1062)){ goto a_G14;}
a_1676(0,a_P);a_L1=a_P[0];
if(__is(a_1681)){return;} goto a_G7;
a_G14:a_1664(a_P);a_L1=a_P[0];
if(__is(a_1681)){return;}
if(!__is(a_L1)){ goto a_G18;}
a_1680(a_L1);return;
a_G18:a_1647();return;
} /* member */
static void a_1665(int a_A[1]){ /* peeklabel+a> */
int a_P[1];
a_1429();
a_A[0]=0;
if(!a_1261(a_P)){ goto a_G7;}a_A[0]=a_P[0];
if(__equal(1454739073,a_1062)){ goto a_G7;}
if(__equal(1454739085,a_1062)){ goto a_G7;}
a_A[0]=0;
a_G7:a_1435();return;
} /* peeklabel */
static void a_1673(int a_F1){ /* skiplabel+>a */

if(!__is(a_F1)){return;}
a_1419(a_F1);
a_1419(1454739073);return;
} /* skiplabel */
static void a_1646(void){ /* addlocalaffixes */
int a_L1;int a_P[2];
a_1429();
if(!__equal(1454739085,a_1062)){ goto a_G19;}
a_1077();
if(!a_1261(a_P)){ goto a_G19;}
a_1435();
a_1012(2106125204);
a_G7:if(!__equal(1454739085,a_1062)){ goto a_G14;}
a_1077();
if(!a_1261(a_P)){ goto a_G12;}a_L1=a_P[0];
a_1017(a_L1);
a_1645(a_L1); goto a_G7;
a_G12:a_P[0]=2093834234;a_P[1]=1454739085;a_1108(2,a_P);
a_G13:a_1268();return;
a_G14:if(!__equal(1454739073,a_1062)){ goto a_G17;}
a_1077();
a_1012(2106125149);return;
a_G17:a_P[0]=2093834216;a_P[1]=1454739073;a_1108(2,a_P); goto a_G13;
a_G19:a_1435();return;
} /* addlocalaffixes */
static void a_1654(void){ /* compoundmember */
int a_L1;int a_L2;int a_P[2];
a_1012(2106125226);
a_1665(a_P);a_L1=a_P[0];
a_1663(a_L1,a_P);a_L2=a_P[0];
a_1673(a_L1);
a_1646();
if(!__equal(1454739040,a_1062)){ goto a_G9;}
a_1077();
a_1651(); goto a_G10;
a_G9:a_1649();
a_G10:if(!__equal(1454739070,a_1062)){ goto a_G12;}
a_1077(); goto a_G14;
a_G12:a_P[0]=2093834216;a_P[1]=1454739070;a_1108(2,a_P);
a_1268();
a_G14:a_1012(2106125146);
a_1653(a_L2);return;
} /* compoundmember */
static void a_1648(void){ /* alternative */
int a_P[2];
a_G1:if(a_1682()){return;}
if(!a_1661()){ goto a_G7;}
a_1662();
if(!__equal(1454739076,a_1062)){return;}
a_1077();
a_1012(2106125152); goto a_G1;
a_G7:a_P[0]=2093834312;a_P[1]=a_1669;a_1108(2,a_P);return;
} /* alternative */
static void a_1649(void){ /* alternativeseries */

a_G1:a_1648();
if(!__equal(1454739079,a_1062)){return;}
a_1077();
a_1012(2106125254); goto a_G1;
} /* alternativeseries */
static void a_1652(void){ /* classifier */
int a_L1;int a_L2;int a_P[2];
a_G1:a_L2=0;
...
a_G7:a_L2=1;
a_G8:if(!__equal(1454739073,a_1062)){ goto a_G17;}
a_1077();
a_L2=0;
a_1012(2106125149);
...
a_G15:if(!a_1430(a_P)){ goto a_G17;}a_L1=a_P[0];
a_1015(a_L1);
a_G17:if(!__is(a_L2)){ goto a_G19;}
a_P[0]=2093834345;a_P[1]=a_1669;a_1108(2,a_P);
a_G19:if(!__equal(1454739079,a_1062)){ goto a_G22;}
a_1077();
a_1012(2106125254); goto a_G1;
a_G22:a_1263(1454739058);return;
} /* classifier */
static void a_1650(int a_A[1]){ /* area+a> */
int a_P[2];
if(!__equal(1454739055,a_1062)){ goto a_G14;}
a_1077();
a_A[0]=0;
a_1012(2106125131);
a_1652();
...
a_G10:if(__is(a_1681)){ goto a_G13;}
a_1681=1;
a_P[0]=2093834216;a_P[1]=1454739076;a_1108(2,a_P);
a_G13:a_1648();return;
a_G14:a_A[0]=1;
a_1012(2106125131);
a_1012(2106125149);
...
a_1678(1454739040);
a_1012(2106125135);
if(!__equal(1454739040,a_1062)){ goto a_G8;}
a_1077(); goto a_G11;
a_G8:if(__is(a_1681)){ goto a_G11;}
a_1681=1;
a_P[0]=2093834216;a_P[1]=1454739040;a_1108(2,a_P);
a_G11:a_1650(a_P);a_L1=a_P[0];
if(__is(a_L1)){ goto a_G17;}
if(!__equal(1454739079,a_1062)){ goto a_G17;}
a_1077();
a_1012(2106125254);
__incr(a_L2); goto a_G11;
a_G17:if(!__is(a_1681)){ goto a_G19;}
a_1268();return;
a_G19:if(__equal(a_L1,0)){return;}
if(!__equal(a_L2,0)){return;}
a_P[0]=2093834354;a_1108(1,a_P);return;
} /* classification */
static void a_1380(int a_A[1]){ /* getruletag+a> */
int a_P[1];
if(!__is(a_1669)){ goto a_G6;}
a_1316(a_1669,a_P);a_A[0]=a_P[0];
__previous(a_1039,a_A[0]);
a_copystring(a_1039,a_A[0],a_1021);
a_A[0]=to_LIST(a_1021)->aupb;return;
a_G6:a_A[0]=1516190441;return;
} /* getruletag */
static void a_1668(int a_F1){ /* rulepragmats+>a */
...
static void a_1667(int a_F1,int a_F2){ /* rulebody+>a+>a */
int a_L3;int a_P[2];
a_1669=a_F1;
a_1656=a_F2;
a_1012(2106125251);
a_1017(a_1669);
a_1668(a_1669);
a_1672(a_F1,a_P);a_L3=a_P[0];
if(!__equal(1454739085,a_1062)){ goto a_G9;}
a_1646(); goto a_G13;
a_G9:if(!__equal(1454739073,a_1062)){ goto a_G11;}
a_1077(); goto a_G13;
a_G11:a_P[0]=2093834216;a_P[1]=1454739073;a_1108(2,a_P);
a_1268();
a_G13:if(!__equal(1454739040,a_1062)){ goto a_G16;}
a_1077();
a_1651(); goto a_G17;
a_G16:a_1649();
a_G17:a_1012(2106125238);
a_1653(a_L3);
a_1669=0;
if(!__equal(1454739082,a_1062)){ goto a_G22;}
a_1077();return;
a_G22:a_P[0]=2093834216;a_P[1]=1454739082;a_1108(2,a_P);
a_1269();return;
} /* rulebody */
static void a_1585(void){ /* rootbody */
int a_L1;int a_P[2];
...
a_1017(483807591);
a_1668(483807591);
a_1672(483807591,a_P);a_L1=a_P[0];
a_1646();
if(!__equal(1454739040,a_1062)){ goto a_G11;}
a_1077();
a_1651(); goto a_G12;
a_G11:a_1649();
a_G12:a_1012(2106125238);
a_1653(a_L1);
a_1669=0;
if(!__equal(1454739082,a_1062)){ goto a_G17;}
a_1077();return;
a_G17:a_P[0]=2093834216;a_P[1]=1454739082;a_1108(2,a_P);
a_1269();return;
} /* rootbody */
static void a_1644(void){ /* @root */

} /* @root */
static void a_1705(int a_A[1]){ /* musttag+a> */
int a_P[1];
if(a_1261(a_P)){a_A[0]=a_P[0];return;}
a_1063(a_1001,16777470,53);return;
} /* musttag */
static void a_1718(int a_A[2]){ /* skipfieldlist+a>+>a> */
int a_P[1];
if(!__equal(1454739067,a_1062)){ goto a_G16;}
a_1077();
a_A[0]=1;
...
a_G10:if(!__equal(1454739070,a_1062)){ goto a_G12;}
a_1077();return;
a_G12:a_P[0]=2093834362;a_1108(1,a_P);
a_G13:a_A[1]=1;return;
a_G14:a_P[0]=2093834372;a_1108(1,a_P); goto a_G13;
a_G16:a_A[0]=-1;return;
} /* skipfieldlist */
static void a_1704(int a_A[3]){ /* getlisttag+a>+a>+>a> */
int a_P[2];
a_1429();
a_P[1]=a_A[2];a_1718(a_P);a_A[1]=a_P[0];a_A[2]=a_P[1];
a_A[0]=0;
if(a_1261(a_P)){a_A[0]=a_P[0]; goto a_G8;}
if(__is(a_A[2])){ goto a_G8;}
a_P[0]=2093834381;a_1108(1,a_P);
a_A[2]=1;
a_G8:if(!__is(a_A[2])){ goto a_G10;}
a_1425();return;
a_G10:a_1435();return;
} /* getlisttag */
static void a_1720(int a_F1,int a_A[1]){ /* subbus+>a+>a> */
int a_P[3];
if(!__is(a_A[0])){ goto a_G4;}
a_1419(1454739055);
a_1419(1454739058);return;
a_G4:if(!__equal(1454739055,a_1062)){ goto a_G10;}
a_1077();
if(!__equal(1454739058,a_1062)){ goto a_G8;}
a_1077();return;
a_G8:a_A[0]=1;
a_P[0]=2093834392;a_P[1]=a_F1;a_P[2]=1454739058;a_1108(3,a_P);return;
a_G10:a_A[0]=1;
a_P[0]=2093834392;a_P[1]=a_F1;a_P[2]=1454739055;a_1108(3,a_P);return;
} /* subbus */
static void a_1699(int a_F1,int a_A[1]){ /* expectformaltag+>a+>a> */
int a_L3;int a_P[2];
if(!__is(a_A[0])){ goto a_G3;}
if(!a_1582(a_P)){return;}return;
a_G3:if(!a_1261(a_P)){ goto a_G7;}a_L3=a_P[0];
if(!__equal(a_L3,a_F1)){return;}
a_A[0]=1;
a_P[0]=2093834402;a_P[1]=a_L3;a_1108(2,a_P);return;
a_G7:a_A[0]=1;
a_P[0]=2093834412;a_P[1]=a_F1;a_1108(2,a_P);return;
} /* expectformaltag */
static void a_1719(int a_F1,int a_A[1]){ /* skipformalaffix+>a+>a> */
int a_P[3];
if(!__equal(1454739055,a_1062)){ goto a_G6;}
a_P[0]=a_A[0];a_1720(a_F1,a_P);a_A[0]=a_P[0];
a_G3:a_P[1]=a_A[0];a_1718(a_P);a_A[0]=a_P[1];
a_P[0]=a_A[0];a_1699(a_F1,a_P);a_A[0]=a_P[0];
a_G5:a_P[0]=a_A[0];a_1720(a_F1,a_P);a_A[0]=a_P[0];return;
a_G6:if(__equal(1454739067,a_1062)){ goto a_G3;}
if(!__equal(1516190441,a_1062)){ goto a_G13;}
a_1077();
a_P[0]=a_A[0];a_1699(a_F1,a_P);a_A[0]=a_P[0];return;
a_G13:if(!__equal(1454739046,a_1062)){ goto a_G17;}
a_1077();
a_P[0]=a_A[0];a_1699(a_F1,a_P);a_A[0]=a_P[0];
a_1419(1454739046);return;
a_G17:if(!__equal(1454739064,a_1062)){ goto a_G19;}
a_G18:a_1077();return;
a_G19:a_P[0]=a_A[0];a_1699(a_F1,a_P);a_A[0]=a_P[0];
if(__equal(1454739046,a_1062)){ goto a_G18;}
if(__equal(1454739055,a_1062)){ goto a_G5;}
if(__equal(1454739103,a_1062)){return;}
if(__is(a_A[0])){return;}
a_A[0]=1;
a_P[0]=2093834392;a_P[1]=a_F1;a_P[2]=1454739046;a_1108(3,a_P);return;
} /* skipformalaffix */
static void a_1707(int a_F1,int a_A[2]){ /* peekafterformalaffixes+>a+a>+>a> */
int a_P[2];
if(!__is(a_A[1])){ goto a_G3;}
a_A[0]=0;return;
a_G3:a_1429();
a_A[0]=0;
a_G5:if(!__equal(1454739088,a_1062)){ goto a_G8;}
a_1077();
a_P[0]=a_A[1];a_1719(a_F1,a_P);a_A[1]=a_P[0]; goto a_G5;
a_G8:if(__is(a_A[1])){ goto a_G21;}
if(!__equal(1454739082,a_1062)){ goto a_G11;}
a_G10:a_A[0]=1; goto a_G21;
a_G11:if(__equal(1454739076,a_1062)){ goto a_G10;}
if(__equal(1454739040,a_1062)){ goto a_G10;}
if(__equal(1454739103,a_1062)){ goto a_G10;}
if(__equal(1454739085,a_1062)){ goto a_G21;}
if(__equal(1454739073,a_1062)){ goto a_G21;}
a_P[0]=2093834421;a_P[1]=a_F1;a_1108(2,a_P);
a_A[1]=1;
a_G21:if(!__is(a_A[1])){ goto a_G23;}
a_1425();return;
a_G23:a_1435();return;
} /* peekafterformalaffixes */
static void a_1685(int a_F1,int a_F3,int a_F4,int a_A[2]){ /* checkasformal+>a+>a>+>a+>a+>a> */
...
a_1198(a_F1,a_P);a_L7=a_P[0];
a_P[0]=2093834455;a_P[1]=a_F1;a_P[2]=a_F3;a_P[3]=a_L6;a_P[4]=a_L7;a_1108(5,a_P);
a_A[1]=1;return;
a_G8:a_1706(a_F4,a_F3,a_P);a_A[0]=a_P[0];return;
} /* checkasformal */
static void a_1695(int a_F1,int a_F3,int a_F4,int a_A[2]){ /* defineasformal+>a+>a>+>a+>a+>a> */
int a_P[3];
if(__is(a_A[1])){return;}
if(!a_1060(a_F3)){ goto a_G5;}
a_A[1]=1;
a_P[0]=2093834521;a_P[1]=a_F1;a_P[2]=a_F3;a_1108(3,a_P);return;
a_G5:a_P[0]=a_A[0];a_P[1]=a_A[1];a_1685(a_F1,a_F3,a_F4,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];
if(__is(a_A[1])){return;}
if(!__equal(a_F3,483807579)){ goto a_G9;}
a_1711=a_A[0];return;
a_G9:a_1710(a_F3,a_A[0]);return;
} /* defineasformal */
static void a_1692(int a_F1,int a_F2,int a_A[1]){ /* checkselectorlist+>a+>a+a> */
int a_L4;int a_P[1];
if(!__equal(1454739067,a_1062)){ goto a_G13;}
a_1077();
a_A[0]=-1;
a_G4:a_1705(a_P);a_L4=a_P[0];
if(!__equal(a_F1,a_L4)){ goto a_G7;}
a_A[0]=a_F2;
a_G7:if(!__equal(1454739076,a_1062)){ goto a_G10;}
a_1077();
__decr(a_F2); goto a_G4;
a_G10:if(!__equal(1454739040,a_1062)){ goto a_G12;}
a_1077(); goto a_G4;
a_G12:a_1263(1454739070);return;
a_G13:a_A[0]=1;return;
} /* checkselectorlist */
static void a_1694(int a_F1,int a_F2,int a_F3,int a_F4,int a_A[1]){ /* createformalselector+>a+>a+>a+>a+>a> */
int a_L6;int a_L7;int a_P[4];
if(__is(a_A[0])){return;}
a_1438(a_F3,a_F2,a_P);a_L6=a_P[0];
if(!a_1060(a_L6)){ goto a_G6;}
a_P[0]=2093834509;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_F3;a_1108(4,a_P);
a_A[0]=1;return;
a_G6:a_1706(16777581,a_L6,a_P);a_L7=a_P[0];
a_1266(a_L7,a_F4);
a_1710(a_L6,a_L7);return;
} /* createformalselector */
static void a_1698(int a_F1,int a_F2,int a_F3,int a_A[2]){ /* defineselectorlist+>a+>a+>a+a>+>a> */
int a_L6;int a_P[1];
if(!__equal(1454739067,a_1062)){ goto a_G16;}
a_1077();
a_A[0]=-1;
a_G4:a_1705(a_P);a_L6=a_P[0];
if(!__equal(a_F2,a_L6)){ goto a_G7;}
a_A[0]=a_F3;
a_G7:a_P[0]=a_A[1];a_1694(a_F1,a_F2,a_L6,a_F3,a_P);a_A[1]=a_P[0];
if(!__equal(1454739076,a_1062)){ goto a_G11;}
a_1077();
__decr(a_F3); goto a_G4;
a_G11:if(!__equal(1454739040,a_1062)){ goto a_G13;}
a_1077(); goto a_G4;
a_G13:a_1263(1454739070);
if(__more(a_A[0],0)){return;}
a_P[0]=a_A[1];a_1694(a_F1,a_F2,a_F2,-1,a_P);a_A[1]=a_P[0];return;
a_G16:a_A[0]=1;
a_P[0]=a_A[1];a_1694(a_F1,a_F2,a_F2,1,a_P);a_A[1]=a_P[0];return;
} /* defineselectorlist */
static void a_1689(int a_F1,int a_F2,int a_F3,int a_F4,int a_F5,int a_F6,int a_A[1]){ /* checkformallistdata+>a+>a+>a+>a+>a+>a+>a> */
...
a_P[0]=2093834455;a_P[1]=a_F1;a_P[2]=a_F3;a_P[3]=a_L10;a_P[4]=a_L11;a_1108(5,a_P);
a_G7:a_A[0]=1;return;
a_G8:if(!__noteq(a_F5,a_L8)){ goto a_G11;}
a_P[0]=2093834472;a_P[1]=a_F1;a_P[2]=a_F3;a_P[3]=a_L11;a_1108(4,a_P); goto a_G7;
a_G11:if(!__noteq(a_F6,a_L9)){return;}
a_P[0]=2093834492;a_P[1]=a_F1;a_P[2]=a_F3;a_P[3]=a_L11;a_1108(4,a_P); goto a_G7;
} /* checkformallistdata */
static void a_1686(int a_F1,int a_F3,int a_F4,int a_F5,int a_A[2]){ /* checkasformallist+>a+>a>+>a+>a+>a+>a> */
int a_L7;int a_P[1];
a_1692(a_F3,a_F5,a_P);a_L7=a_P[0];
a_1419(a_F3);
a_P[0]=a_A[1];a_1720(a_F1,a_P);a_A[1]=a_P[0];
if(!__is(a_A[0])){ goto a_G6;}
a_P[0]=a_A[1];a_1689(a_F1,a_A[0],a_F3,a_F4,a_F5,a_L7,a_P);a_A[1]=a_P[0];return;
a_G6:a_1706(a_F4,a_F3,a_P);a_A[0]=a_P[0];
a_1708(a_A[0],a_F5);
a_1709(a_A[0],a_L7);return;
} /* checkasformallist */
static void a_1696(int a_F1,int a_F3,int a_F4,int a_F5,int a_A[2]){ /* defineasformallist+>a+>a>+>a+>a+>a+>a> */
int a_L7;int a_P[3];
if(!a_1060(a_F3)){ goto a_G4;}
a_A[1]=1;
a_P[0]=2093834521;a_P[1]=a_F1;a_P[2]=a_F3;a_1108(3,a_P);return;
a_G4:a_P[1]=a_A[1];a_1698(a_F1,a_F3,a_F5,a_P);a_L7=a_P[0];a_A[1]=a_P[1];
a_1419(a_F3);
a_P[0]=a_A[1];a_1720(a_F1,a_P);a_A[1]=a_P[0];
if(__is(a_A[1])){ goto a_G13;}
if(!__is(a_A[0])){ goto a_G10;}
a_P[0]=a_A[1];a_1689(a_F1,a_A[0],a_F3,a_F4,a_F5,a_L7,a_P);a_A[1]=a_P[0]; goto a_G13;
a_G10:a_1706(a_F4,a_F3,a_P);a_A[0]=a_P[0];
a_1708(a_A[0],a_F5);
a_1709(a_A[0],a_L7);
a_G13:if(__is(a_A[1])){return;}
a_1710(a_F3,a_A[0]);return;
} /* defineasformallist */
static void a_1702(int a_F1,int a_F2,int a_F4,int a_A[2]){ /* formallistaffix+>a+>a+>a>+>a+>a> */
int a_L6;int a_L7;int a_P[3];
a_P[2]=a_A[1];a_1704(a_P);a_L6=a_P[0];a_L7=a_P[1];a_A[1]=a_P[2];
if(__is(a_A[1])){return;}
if(!__is(a_F2)){ goto a_G5;}
a_P[0]=a_A[0];a_P[1]=a_A[1];a_1686(a_F1,a_L6,a_F4,a_L7,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];return;
a_G5:a_P[0]=a_A[0];a_P[1]=a_A[1];a_1696(a_F1,a_L6,a_F4,a_L7,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];return;
} /* formallistaffix */
static void a_1687(int a_F1,int a_F2,int a_A[2]){ /* checkasformaltableaffix+>a+>a+>a>+>a> */
int a_P[1];
if(!__is(a_A[0])){ goto a_G3;}
a_P[0]=a_A[1];a_1689(a_F1,a_A[0],a_F2,16777593,-1,1,a_P);a_A[1]=a_P[0];return;
a_G3:a_1706(16777593,a_F2,a_P);a_A[0]=a_P[0];
a_1708(a_A[0],-1);
a_1709(a_A[0],1);return;
} /* checkasformaltableaffix */
static void a_1697(int a_F1,int a_F2,int a_A[2]){ /* defineasformaltableaffix+>a+>a+>a>+>a> */
int a_P[3];
if(__is(a_A[1])){return;}
if(!a_1060(a_F2)){ goto a_G5;}
a_A[1]=1;
a_P[0]=2093834521;a_P[1]=a_F1;a_P[2]=a_F2;a_1108(3,a_P);return;
a_G5:a_P[0]=a_A[0];a_P[1]=a_A[1];a_1687(a_F1,a_F2,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];
if(__is(a_A[1])){return;}
a_P[0]=a_A[1];a_1694(a_F1,a_F2,a_F2,1,a_P);a_A[1]=a_P[0];
a_1710(a_F2,a_A[0]);return;
} /* defineasformaltableaffix */
static void a_1703(int a_F1,int a_F2,int a_F4,int a_A[2]){ /* formaltableaffix+>a+>a+>a>+>a+>a> */
int a_P[2];
if(!__is(a_F2)){ goto a_G3;}
a_P[0]=a_A[0];a_P[1]=a_A[1];a_1687(a_F1,a_F4,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];return;
a_G3:a_P[0]=a_A[0];a_P[1]=a_A[1];a_1697(a_F1,a_F4,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];return;
} /* formaltableaffix */
static void a_1701(int a_F1,int a_F2,int a_F4,int a_F5,int a_A[2]){ /* formalflataffix+>a+>a+>a>+>a+>a+>a> */
int a_P[2];
if(!__is(a_F2)){ goto a_G3;}
a_P[0]=a_A[0];a_P[1]=a_A[1];a_1685(a_F1,a_F4,a_F5,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];return;
a_G3:a_P[0]=a_A[0];a_P[1]=a_A[1];a_1695(a_F1,a_F4,a_F5,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];return;
} /* formalflataffix */
static void a_1700(int a_F1,int a_F2,int a_A[2]){ /* formalaffix+>a+>a+>a>+>a> */
int a_L5;int a_L6;int a_P[2];
if(__is(a_A[1])){return;}
if(!__equal(1454739055,a_1062)){ goto a_G6;}
a_1077();
a_1419(1454739058);
a_P[0]=a_A[0];a_P[1]=a_A[1];a_1702(a_F1,a_F2,16777587,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];return;
a_G6:if(!__equal(1454739067,a_1062)){ goto a_G8;}
a_P[0]=a_A[0];a_P[1]=a_A[1];a_1702(a_F1,a_F2,16777593,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];return;
a_G8:if(!__equal(1516190441,a_1062)){ goto a_G12;}
a_1077();
a_1705(a_P);a_L5=a_P[0];
a_P[0]=a_A[0];a_P[1]=a_A[1];a_1701(a_F1,a_F2,a_L5,16777598,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];return;
a_G12:if(!__equal(1454739046,a_1062)){ goto a_G22;}
a_1077();
a_1705(a_P);a_L5=a_P[0];
if(!__equal(1454739046,a_1062)){ goto a_G18;}
a_1077();
a_G17:a_L6=16777614; goto a_G21;
a_G18:if(__equal(1454739046,a_1062)){ goto a_G17;}
a_L6=16777603;
a_G21:a_P[0]=a_A[0];a_P[1]=a_A[1];a_1701(a_F1,a_F2,a_L5,a_L6,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];return;
a_G22:if(!__equal(1454739064,a_1062)){ goto a_G25;}
a_1077();
a_P[0]=a_A[0];a_P[1]=a_A[1];a_1701(a_F1,a_F2,483807579,16777620,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];return;
a_G25:a_1705(a_P);a_L5=a_P[0];
if(!__equal(1454739046,a_1062)){ goto a_G29;}
a_1077();
a_G28:a_P[0]=a_A[0];a_P[1]=a_A[1];a_1701(a_F1,a_F2,a_L5,16777608,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];return;
a_G29:if(__equal(1454739103,a_1062)){ goto a_G28;}
a_P[0]=a_A[1];a_1720(a_F1,a_P);a_A[1]=a_P[0];
a_P[0]=a_A[0];a_P[1]=a_A[1];a_1703(a_F1,a_F2,a_L5,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];return;
} /* formalaffix */
static void a_1691(int a_F1,int a_F2,int a_F3,int a_A[1]){ /* checkruletype+>a+>a+>a+a> */
int a_L5;int a_P[4];
a_A[0]=0;
a_1058(a_F2,a_P);a_L5=a_P[0];
if(!__equal(a_L5,16777511)){ goto a_G7;}
a_1267(a_F2,16777571);
a_1447(a_F2,a_F1);
...
a_P[0]=2093834439;a_P[1]=a_F2;a_P[2]=a_F3;a_1108(3,a_P);
a_G12:a_A[0]=1;return;
a_G13:a_1198(a_F2,a_P);a_F3=a_P[0];
a_P[0]=2093834531;a_P[1]=a_F2;a_P[2]=a_L5;a_P[3]=a_F3;a_1108(4,a_P); goto a_G12;
} /* checkruletype */
static void a_1688(int a_F1,int a_F2,int a_A[1]){ /* checkformalaffixes+>a+>a+a> */
...
if(!__equal(1454739088,a_1062)){ goto a_G13;}
a_1077();
if(!__equal(a_L4,0)){ goto a_G11;}
a_P[0]=2093834542;a_P[1]=a_F2;a_P[2]=a_L5;a_1108(3,a_P);
a_A[0]=1; goto a_G13;
a_G11:a_P[0]=a_L4;a_P[1]=a_A[0];a_1700(a_F2,a_F1,a_P);a_L4=a_P[0];a_A[0]=a_P[1];
a_1050(a_L4,a_P);a_L4=a_P[0]; goto a_G5;
a_G13:if(!__is(a_A[0])){ goto a_G15;}
a_1268();return;
a_G15:if(__equal(a_L4,0)){return;}
a_P[0]=2093834554;a_P[1]=a_F2;a_P[2]=a_L5;a_1108(3,a_P);
a_A[0]=1;return;
} /* checkformalaffixes */
static void a_1690(int a_F1,int a_F2){ /* checkoutaffixes+>a+>a */
int a_L3;int a_P[2];
a_1317(a_F1,1792,a_P);a_L3=a_P[0];
if(!__equal(a_L3,0)){ goto a_G5;}
if(!__equal(a_F2,0)){ goto a_G5;}
a_P[0]=2093834589;a_P[1]=a_F1;a_1146(5,2,a_P);return;
a_G5:if(!__equal(a_L3,1024)){return;}
if(!__noteq(a_F2,0)){return;}
a_P[0]=2093834600;a_P[1]=a_F1;a_1108(2,a_P);return;
} /* checkoutaffixes */
static void a_1693(int a_F1,int a_F2,int a_A[1]){ /* createformalaffixes+>a+>a+a> */
int a_L4;int a_L5;int a_L6;int a_L7;int a_L8;int a_L9;int a_P[2];
a_A[0]=0;a_L7=0;a_L8=0;
a_1711=0;
a_L4=a_F2;
a_G4:if(__is(a_A[0])){ goto a_G28;}
if(!__equal(1454739088,a_1062)){ goto a_G23;}
a_1077();
a_L5=0;
a_P[0]=a_L5;a_P[1]=a_A[0];a_1700(a_F2,a_F1,a_P);a_L5=a_P[0];a_A[0]=a_P[1];
if(__is(a_A[0])){ goto a_G28;}
a_1058(a_L5,a_P);a_L6=a_P[0];
{ if(a_L6==16777620){ goto a_G12;}
 if(a_L6==16777608){ goto a_G17;}
 if(a_L6==16777614){  goto a_G20;}
  goto a_G21;}
a_G12:if(!__is(a_L7)){ goto a_G15;}
a_A[0]=1;
a_P[0]=2093834565;a_P[1]=a_F2;a_1108(2,a_P); goto a_G21;
a_G15:a_L7=1;
a_1447(a_F2,32768); goto a_G21;
a_G17:a_L8=1;
if(!__is(a_L7)){ goto a_G21;}
a_1447(a_F2,65536); goto a_G21;
a_G20:a_L8=1;
a_G21:a_1440(a_L4,a_L5);
a_L4=a_L5; goto a_G4;
a_G23:if(__equal(a_L7,0)){ goto a_G28;}
a_1058(a_L4,a_P);a_L9=a_P[0];
if(!__equal(a_L9,16777620)){ goto a_G28;}
a_A[0]=1;
a_P[0]=2093834577;a_P[1]=a_F2;a_1108(2,a_P);
a_G28:if(!__is(a_A[0])){ goto a_G31;}
a_1440(a_F2,0);
a_1268();return;
a_G31:a_1447(a_F2,16384);
a_1690(a_F2,a_L8);return;
} /* createformalaffixes */
static void a_1716(int a_F1,int a_F2){ /* ruleexternaldeclarer+>a+>a */
int a_L3;int a_L4;int a_P[2];
if(!__equal(1454739103,a_1062)){ goto a_G3;}
a_1077(); goto a_G4;
a_G3:a_1263(1454739040);
a_G4:a_L4=0;
if(a_1260(a_P)){a_L3=a_P[0]; goto a_G9;}
a_L3=0;
a_L4=1;
a_P[0]=2093834611;a_P[1]=a_F1;a_1108(2,a_P);
a_G9:a_P[0]=a_L4;a_1246(a_F1,a_F2,a_P);a_L4=a_P[0];
if(__is(a_L4)){return;}
a_1266(a_F1,a_L3);return;
} /* ruleexternaldeclarer */
static void a_1717(int a_F1,int a_F2){ /* ruleprototype+>a+>a */
int a_L3;int a_L4;int a_P[1];
a_L4=0;
...
static void a_1714(int a_F1,int a_F2,int a_F3){ /* ruledefinition+>a+>a+>a */
int a_L4;int a_P[1];
if(!a_1205(a_F1,16384)){ goto a_G3;}
a_1688(1,a_F1,a_P);a_L4=a_P[0]; goto a_G4;
a_G3:a_1693(1,a_F1,a_P);a_L4=a_P[0];
a_G4:if(!__is(a_L4)){ goto a_G6;}
a_1268();return;
a_G6:if(!__is(a_F2)){ goto a_G8;}
a_1716(a_F1,a_F3);return;
a_G8:a_1717(a_F1,a_F3);return;
} /* ruledefinition */
static void a_1715(int a_F1,int a_F2){ /* ruledefinitionsequence+>a+>a */
int a_L3;int a_L4;int a_L5;int a_P[2];
a_G1:if(!__equal(1454739076,a_1062)){ goto a_G11;}
a_1077();
if(!a_1262(a_P)){ goto a_G9;}a_L3=a_P[0];a_L5=a_P[1];
a_1691(a_F1,a_L3,a_L5,a_P);a_L4=a_P[0];
a_P[1]=a_L4;a_1707(a_L3,a_P);a_L4=a_P[1];
if(!__is(a_L4)){ goto a_G8;}
a_G7:a_1268(); goto a_G1;
a_G8:a_1714(a_L3,a_F2,a_L5); goto a_G1;
a_G9:a_P[0]=2093834428;a_1108(1,a_P); goto a_G7;
a_G11:if(!__equal(1454739082,a_1062)){ goto a_G13;}
a_1077();return;
a_G13:a_1263(1454739082);
a_1269();return;
} /* ruledefinitionsequence */
static void a_1713(int a_F1,int a_F2){ /* ruledeclarer+>a+>a */
int a_L3;int a_P[1];
if(!a_1205(a_F1,16384)){ goto a_G3;}
a_1688(0,a_F1,a_P);a_L3=a_P[0]; goto a_G4;
a_G3:a_1693(0,a_F1,a_P);a_L3=a_P[0];
a_G4:a_P[0]=a_L3;a_1245(a_F1,a_F2,a_P);a_L3=a_P[0];
if(!__is(a_L3)){ goto a_G7;}
a_1269();return;
a_G7:a_1667(a_F1,a_1711);return;
} /* ruledeclarer */
static void a_1587(int a_F1,int a_F2){ /* ruledeclaration+>a+>a */
int a_L3;int a_L4;int a_L5;int a_L6;int a_P[2];
if(!a_1261(a_P)){ goto a_G13;}a_L3=a_P[0];
a_1314(a_P);a_L6=a_P[0];
a_1691(a_F1,a_L3,a_L6,a_P);a_L4=a_P[0];
a_P[1]=a_L4;a_1707(a_L3,a_P);a_L5=a_P[0];a_L4=a_P[1];
if(!__is(a_L4)){ goto a_G7;}
a_1269();return;
a_G7:if(__is(a_F2)){ goto a_G9;}
if(!__is(a_L5)){ goto a_G11;}
a_G9:a_1714(a_L3,a_F2,a_L6);
a_1715(a_F1,a_F2);return;
a_G11:a_1713(a_L3,a_L6);
a_1712();return;
a_G13:a_P[0]=2093834428;a_1108(1,a_P);
a_1269();return;
} /* ruledeclaration */
static void a_1684(void){ /* @root */
...
if(!__is(a_1725)){ goto a_G3;}
a_1063(a_1001,16777492,153);return;
a_G3:a_1730=a_1731;
a_1728=a_1062;
a_1729=a_1727;
a_1725=1;return;
...
static void a_1435(void){ /* makerestore */
int a_P[2];
if(!__equal(a_1725,0)){ goto a_G3;}
a_1063(a_1001,16777487,158);return;
a_G3:if(!__more(a_1733,500)){ goto a_G7;}
a_P[0]=2093834645;a_P[1]=500;a_1108(2,a_P);
a_1045();
exit(3);return;
a_G7:a_1731=a_1730;
a_1062=a_1728;
...
a_1435();
a_G2:if(!a_1732()){return;}
a_1735(); goto a_G2;
} /* forgetrestore */
static void a_1734(void){ /* savetorestore */
int a_P[1];
if(__equal(a_1725,0)){return;}
if(!__noteq(a_1731,a_1726)){ goto a_G4;}
a_1063(a_1001,16777482,171);return;
a_G4:__incr(a_1733);
a_P[0]=a_1726;a_1724(a_P);a_1726=a_P[0];
a_1731=a_1726;
to_LIST(a_1722)->offset[a_1726]=a_1062;return;
} /* savetorestore */
static int a_1732(void){ /* readfromrestore */
int a_P[1];
if(__equal(a_1726,a_1731)){ return 0;}
a_P[0]=a_1731;a_1724(a_P);a_1731=a_P[0];
a_1062=to_LIST(a_1722)->offset[a_1731];
if(__is(a_1725)){ goto a_G6;}
__decr(a_1733);
a_G6:if(__mreq(a_1733,0)){ return 1;}
a_1063(a_1001,16777476,179); return 1;
} /* readfromrestore */
static void a_1724(int a_A[1]){ /* countrestore+>a> */

if(!__mreq(a_A[0],to_LIST(a_1722)->aupb)){ goto a_G3;}
a_A[0]=to_LIST(a_1722)->alwb;return;
...
__incr(a_1727);
if(__is(a_1725)){return;}
a_1012(2106125196);return;
} /* setsymbolposition */
static void a_1077(void){ /* nextsymbol */
int a_P[1];
a_G1:if(a_1732()){ goto a_G4;}
a_1395(a_P);a_1062=a_P[0];
a_1734();
a_G4:a_1735();
...
if(!__equal(a_F1,a_1062)){ goto a_G3;}
a_1077();return;
a_G3:a_P[0]=2093834619;a_P[1]=a_F1;a_1108(2,a_P);return;
} /* must */
static int a_1582(int a_A[1]){ /* israwtag+a> */
...
int a_P[1];
if(!__was(a_1039,a_1062)){ return 0;}
if(!__equal(a_1726,a_1731)){ goto a_G4;}
a_1600(a_1062,a_1727);
a_G4:a_A[1]=a_1727;
a_1581(a_1062,a_P);a_A[0]=a_P[0];
a_1077(); return 1;
} /* istagdl */
...
if(!__equal(a_1726,a_1731)){ goto a_G4;}
a_1600(a_1062,a_1727);
a_G4:a_1581(a_1062,a_P);a_A[0]=a_P[0];
a_1077(); return 1;
} /* istag */
static void a_1736(void){ /* skipsymbol */
int a_P[1];
a_G1:if(a_1732()){ goto a_G4;}
a_1410(a_P);a_1062=a_P[0];
a_1734();
a_G4:a_1735();
if(!__equal(a_1062,1454739121)){return;} goto a_G1;
} /* skipsymbol */
...
a_G1:if(__equal(1454739082,a_1062)){return;}
if(__equal(1454738963,a_1062)){return;}
a_1736(); goto a_G1;
} /* skipsilently */
static void a_1268(void){ /* skipall */
int a_P[1];
if(__equal(1454739082,a_1062)){return;}
a_P[0]=2093834632;a_1116(1,a_P);
a_1588();return;
} /* skipall */
static void a_1269(void){ /* skiptopoint */
...
static void a_1708(int a_F1,int a_F2){ /* putformalcalibre+>a+>a */

to_LIST(a_1020)->offset[a_F1-5]=a_F2;return;
} /* putformalcalibre */
static void a_1709(int a_F1,int a_F2){ /* putformalssel+>a+>a */
...
a_1581(a_A[0],a_P);a_A[0]=a_P[0];return;
} /* packselector */
static void a_1744(int a_F1){ /* enterpredefinedtag+>a */
int a_L2;int a_L3;int a_L4;int a_P[2];
...
__next(a_1039,a_F1);
a_P[0]=2093834658;a_P[1]=a_F1;a_1040(0,2,a_P);
...
static void a_1742(int a_F1,int a_F2){ /* addspecialrule+>a+>a */
int a_L3;int a_P[1];
a_1753(a_F2,a_P);a_L3=a_P[0];
...
a_1742(963128116,963128185);
a_1742(963128125,963128193);
a_1742(963128134,963128201);
a_1742(963128143,963128209);
a_1742(963128152,963128217);
a_1742(963128161,963128225);
a_1749();
a_1748();return;
} /* inittags */
...
if(!__is(a_1759)){ goto a_G4;}
a_A[0]=a_1759;return;
a_G4:a_1753(963128169,a_P);a_A[0]=a_P[0];
a_1267(a_A[0],16777557);
...
a_1447(a_A[0],2);
a_1447(a_A[0],1);
 a_extension(a_1020,3);to_LIST(a_1020)->top[2]=a_A[0];to_LIST(a_1020)->top[1]=a_F1;to_LIST(a_1020)->top[3]=a_1760;to_LIST(a_1020)->aupb+=3;
a_1760=to_LIST(a_1020)->aupb;
if(!__equal(a_F1,1516190441)){return;}
a_1759=a_A[0];return;
} /* newstdstring */
static void a_1749(void){ /* initstdstringtable */
...
int a_L1;int a_L2;int a_P[1];
to_LIST(a_1039)->offset[963128058-2]=483807597;
a_1267(483807597,16777571);
a_1447(483807597,180778);
a_1706(16777626,483807579,a_P);a_L1=a_P[0];
a_1440(483807597,a_L1);
to_LIST(a_1039)->offset[963128069-2]=483807603;
a_1267(483807603,16777571);
a_1447(483807603,180266);
a_1706(16777608,483807579,a_P);a_L1=a_P[0];
a_1440(483807603,a_L1);
a_1706(16777626,483807579,a_P);a_L2=a_P[0];
a_1440(a_L1,a_L2);
to_LIST(a_1039)->offset[963128078-2]=483807591;
a_1267(483807591,16777571);
...
static void a_1753(int a_F1,int a_A[1]){ /* newtagentry+>a+a> */
...
static void a_1581(int a_F1,int a_A[1]){ /* gettagentry+>a+a> */
int a_P[1];
a_A[0]=to_LIST(a_1039)->offset[a_F1-2];
if(!__equal(a_A[0],0)){return;}
a_1753(a_F1,a_P);a_A[0]=a_P[0];
to_LIST(a_1039)->offset[a_F1-2]=a_A[0];return;
} /* gettagentry */
static void a_1706(int a_F1,int a_F2,int a_A[1]){ /* newformaltag+>a+>a+a> */
...
static void a_1580(int a_F1,int a_A[1]){ /* findrawusage+>a+a> */
...
a_P[0]=2093834719;a_P[1]=a_F1;a_1108(2,a_P);
a_G4:a_A[0]=1;return;
a_G5:if(!a_1205(a_F1,16)){ goto a_G8;}
a_P[0]=2093834679;a_P[1]=a_F1;a_P[2]=to_LIST(a_1020)->offset[a_F1-5];a_1108(3,a_P); goto a_G4;
a_G8:if(!a_1205(a_F1,2)){ goto a_G11;}
a_P[0]=2093834666;a_P[1]=a_F1;a_P[2]=to_LIST(a_1020)->offset[a_F1-5];a_1108(3,a_P); goto a_G4;
...
a_P[0]=2093834711;a_P[1]=a_F1;a_P[2]=to_LIST(a_1020)->offset[a_F1-5];a_1108(3,a_P);
a_A[0]=1;
...
a_P[0]=2093834691;a_P[1]=a_F1;a_P[2]=to_LIST(a_1020)->offset[a_F1-5];a_1108(3,a_P);
a_A[0]=1;return;
...
if(__is(a_A[0])){return;}
if(!a_1205(a_F1,32)){ goto a_G5;}
a_P[0]=2093834699;a_P[1]=a_F1;a_1108(2,a_P);
a_G4:a_A[0]=1;return;
a_G5:if(!a_1205(a_F1,16)){ goto a_G8;}
a_G6:a_P[0]=2093834691;a_P[1]=a_F1;a_P[2]=to_LIST(a_1020)->offset[a_F1-5];a_1108(3,a_P); goto a_G4;
...
static void a_1710(int a_F1,int a_F2){ /* redefinetag+>a+>a */
int a_L3;
a_L3=to_LIST(a_1020)->offset[a_F1];
to_LIST(a_1020)->offset[a_F2]=a_L3;
 a_extension(a_1740,2);to_LIST(a_1740)->top[2]=a_F1;to_LIST(a_1740)->top[1]=a_L3;to_LIST(a_1740)->aupb+=2;
to_LIST(a_1039)->offset[a_L3-2]=a_F2;return;
} /* redefinetag */
static void a_1712(void){ /* restoretags */

a_G1:if(__less(to_LIST(a_1740)->aupb,to_LIST(a_1740)->alwb)){return;}
to_LIST(a_1039)->offset[to_LIST(a_1740)->offset[to_LIST(a_1740)->aupb-1]-2]=to_LIST(a_1740)->offset[to_LIST(a_1740)->aupb];
__unstack(a_1740); goto a_G1;
} /* restoretags */
static int a_1659(int a_F1,int a_A[1]){ /* isspecialrule+>a+a> */
...
static void a_1747(int a_F1){ /* extendDICT+>a */

 a_extension(a_1738,1);to_LIST(a_1738)->top[1]=a_F1;to_LIST(a_1738)->aupb+=1;
 return;
} /* extendDICT */
static void a_1754(int a_F1,int a_F2,int a_A[1]){ /* pack2+>a+>a+a> */

a_A[0]=a_F1;
__leftclear(a_A[0],11);
__boolor(a_A[0],a_F2,a_A[0]);return;
} /* pack2 */
static void a_1761(int a_F1,int a_A[2]){ /* unpack2+>a+a>+a> */

__booland(a_F1,2047,a_A[1]);
a_A[0]=a_F1;
__rightclear(a_A[0],11);return;
} /* unpack2 */
static void a_1745(int a_F1,int a_F2){ /* expandDICT+>a+>a */
int a_L3;int a_P[1];
if(!__equal(a_F1,0)){ goto a_G3;}
a_L3=0; goto a_G5;
a_G3:__subtr(to_LIST(a_1738)->aupb,a_F1,a_L3);
__incr(a_L3);
a_G5:a_1754(a_L3,a_F2,a_P);a_L3=a_P[0];
a_1747(a_L3);return;
} /* expandDICT */
static void a_1741(int a_F1,int a_F2){ /* addlinetoDICT+>a+>a */

a_G1:if(!__less(a_F2,2030)){ goto a_G3;}
a_1745(a_F1,a_F2);return;
a_G3:a_1745(a_F1,2047);
__subtr(a_F2,2000,a_F2);
a_F1=to_LIST(a_1738)->aupb; goto a_G1;
} /* addlinetoDICT */
static void a_1600(int a_F1,int a_F2){ /* addDICT+>a+>a */
int a_L3;
...
a_1741(to_LIST(a_1039)->offset[a_F1],a_L3);
to_LIST(a_1039)->offset[a_F1-1]=a_F2;
to_LIST(a_1039)->offset[a_F1]=to_LIST(a_1738)->aupb;return;
} /* addDICT */
static void a_1757(int a_F1){ /* reverseDICT+>a */
...
a_L6=0;
a_G6:a_1761(to_LIST(a_1738)->offset[a_L2],a_P);a_L5=a_P[0];a_L4=a_P[1];
a_1754(a_L6,a_L4,a_P);to_LIST(a_1738)->offset[a_L2]=a_P[0];
...
static int a_1751(int a_F1){ /* isspecialtag+>a */
int a_L2;int a_P[1];
__previous(a_1039,a_F1);
...
static void a_1739(int a_F1){ /* DICTtag+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_P[2];
if(__lseq(to_LIST(a_1039)->offset[a_F1-1],0)){return;}
if(a_1751(a_F1)){return;}
...
a_G13:a_1101();return;
a_G14:a_1761(to_LIST(a_1738)->offset[a_L5],a_P);a_L4=a_P[0];a_L3=a_P[1];
...
static void a_1755(int a_F1){ /* printdict+>a */
int a_L2;
...
a_1755(963128042);
a_release(a_1738);return;
} /* printdictionary */
static void a_1743(int a_F1){ /* assigntags+>a */
int a_L2;
a_G1:if(__equal(a_F1,0)){return;}
__add(a_F1,5,a_L2);
a_1743(to_LIST(a_1039)->offset[a_L2-4]);
...
static void a_1598(int a_F1,int a_F2,int a_F3){ /* linkmacrorule+>a+>a+>a */

 a_extension(a_1020,4);to_LIST(a_1020)->top[2]=a_F3;to_LIST(a_1020)->top[1]=a_F2;to_LIST(a_1020)->top[4]=a_F1;to_LIST(a_1020)->top[3]=a_1752;to_LIST(a_1020)->aupb+=4;
a_1752=to_LIST(a_1020)->aupb;return;
} /* linkmacrorule */
...
static void a_1746(int a_F1){ /* extendBUFFER+>a */
...
static void a_1774(int a_F1,int a_F2){ /* tagredefined+>a+>a */
int a_L3;int a_L4;int a_P[5];
a_1198(a_F1,a_P);a_L3=a_P[0];
a_1058(a_F1,a_P);a_L4=a_P[0];
if(!__more(a_L3,0)){ goto a_G5;}
a_P[0]=2093834840;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_L4;a_P[4]=a_L3;a_1108(5,a_P);return;
a_G5:a_P[0]=2093834850;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_L4;a_1108(4,a_P);return;
} /* tagredefined */
static int a_1772(int a_A[1]){ /* isexpression+>a> */
int a_P[1];
if(!__equal(1454739085,a_1062)){ goto a_G4;}
a_G2:a_1077();
a_1012(2106125216);
a_G4:a_P[0]=a_A[0];if(!a_1770(a_P)){ return 0;}a_A[0]=a_P[0];
if(__is(a_A[0])){ return 1;}
if(!__equal(1454739112,a_1062)){ goto a_G9;}
a_1077();
a_1012(2106125229); goto a_G4;
a_G9:if(!__equal(1454739115,a_1062)){ goto a_G12;}
a_1077();
a_1012(2106125127); goto a_G4;
a_G12:if(!__equal(1454739118,a_1062)){ goto a_G15;}
a_1077();
a_1012(2106125283); goto a_G4;
a_G15:if(!__equal(1454739088,a_1062)){ goto a_G18;}
a_1077();
a_G17:a_1012(2106125235); goto a_G4;
a_G18:if(__equal(1454739085,a_1062)){ goto a_G2;}
if(a_1723()){ goto a_G17;}
if(!__equal(1454739064,a_1062)){ goto a_G26;}
a_1077();
a_1012(2106125257); goto a_G4;
a_G26:if(!__equal(1454739100,a_1062)){ return 1;}
a_1077();
a_1012(2106125162); goto a_G4;
} /* isexpression */
...
a_P[0]=2093834765;a_P[1]=a_L2;a_P[2]=a_L3;a_1108(3,a_P);
a_A[0]=1;
a_G10:if(!a_1205(a_L2,16)){ goto a_G13;}
a_A[0]=1;
a_P[0]=2093834786;a_P[1]=a_L2;a_1108(2,a_P);
a_G13:if(__is(a_A[0])){return;}
a_1271(a_L2);return;
a_G15:a_A[0]=1;
a_P[0]=2093834737;a_1108(1,a_P);return;
} /* expectlisttag */
static void a_1767(int a_F1,int a_A[1]){ /* expectconstanttag+>a+>a> */
int a_L3;int a_P[3];
a_1058(a_F1,a_P);a_L3=a_P[0];
a_1017(a_F1);
if(__equal(a_L3,16777511)){ goto a_G8;}
...
a_P[0]=2093834775;a_P[1]=a_F1;a_P[2]=a_L3;a_1108(3,a_P);
a_A[0]=1;
a_G8:if(!a_1205(a_F1,16)){ goto a_G11;}
a_A[0]=1;
a_P[0]=2093834786;a_P[1]=a_F1;a_1108(2,a_P);
...
a_P[0]=a_A[0];a_1767(a_L2,a_P);a_A[0]=a_P[0]; return 1;
a_G5:if(!__equal(1454739109,a_1062)){ goto a_G12;}
a_1077();
a_1012(2106125155);
a_P[0]=a_A[0];if(a_1770(a_P)){a_A[0]=a_P[0]; return 1;}
if(__is(a_A[0])){ return 1;}
a_A[0]=1;
a_P[0]=2093834727;a_1108(1,a_P); return 1;
a_G12:if(!__equal(1454739043,a_1062)){ goto a_G16;}
a_1077();
a_G14:a_1012(2106125208);
a_G15:a_P[0]=a_A[0];a_1769(a_P);a_A[0]=a_P[0]; return 1;
a_G16:if(!__equal(1454739046,a_1062)){ goto a_G20;}
a_1077();
a_G18:a_1012(2106125272); goto a_G15;
a_G20:if(!__equal(1454739049,a_1062)){ goto a_G25;}
a_1077();
a_P[0]=2093834861;a_1146(1,1,a_P); goto a_G14;
a_G25:if(!__equal(1454739052,a_1062)){ goto a_G30;}
a_1077();
a_P[0]=2093834861;a_1146(1,1,a_P); goto a_G18;
a_G30:if(!__equal(1454739061,a_1062)){ goto a_G34;}
a_1077();
a_1012(2106125143); goto a_G15;
a_G34:if(!__equal(1454739067,a_1062)){ return 0;}
a_1077();
a_1012(2106125226);
a_P[0]=a_A[0];if(a_1772(a_P)){a_A[0]=a_P[0]; goto a_G41;}
if(__is(a_A[0])){ goto a_G41;}
a_A[0]=1;
a_P[0]=2093834727;a_1108(1,a_P);
a_G41:a_1012(2106125146);
a_1263(1454739070); return 1;
} /* exprbase */
static void a_1768(int a_A[1]){ /* expectexpression+>a> */
int a_P[1];
a_P[0]=a_A[0];if(a_1772(a_P)){a_A[0]=a_P[0]; goto a_G4;}
a_A[0]=1;
a_P[0]=2093834746;a_1108(1,a_P);
a_G4:if(!__is(a_A[0])){return;}
a_1268();return;
} /* expectexpression */
static void a_1766(int a_F1,int a_F2,int a_F3){ /* declarer+>a+>a+>a */
int a_L4;int a_L5;int a_P[1];
a_L4=0;
a_1058(a_F1,a_P);a_L5=a_P[0];
if(__equal(a_L5,16777511)){ goto a_G7;}
...
a_1267(a_F1,a_F2);
a_G10:a_1012(2106125172);
a_1017(a_F1);
a_P[0]=a_L4;a_1768(a_P);
a_1012(2106125238);return;
} /* declarer */
static void a_1771(int a_F1,int a_F2,int a_F3){ /* externaldeclarer+>a+>a+>a */
int a_L4;int a_L5;int a_L6;int a_P[3];
a_L5=0;
a_1058(a_F1,a_P);a_L6=a_P[0];
if(__equal(a_L6,16777511)){ goto a_G7;}
...
a_L4=0;
a_L5=1;
a_P[0]=2093834814;a_P[1]=a_F2;a_P[2]=a_F1;a_1108(3,a_P);
a_1268();
a_G12:a_P[0]=a_L5;a_1246(a_F1,a_F3,a_P);a_L5=a_P[0];
if(__is(a_L5)){return;}
a_1267(a_F1,a_F2);
...
static void a_1773(int a_F1,int a_F2,int a_F3){ /* prototype+>a+>a+>a */
int a_L4;int a_L5;int a_L6;int a_P[1];
a_1113(3429890,a_P);a_L4=a_P[0];
a_1058(a_F1,a_P);a_L5=a_P[0];
a_L6=0;
...
static void a_1764(int a_F2,int a_A[1]){ /* declaration+>a>+>a */
int a_L3;int a_L4;int a_P[3];
if(!a_1262(a_P)){ goto a_G19;}a_L3=a_P[0];a_L4=a_P[1];
if(!__equal(1454739040,a_1062)){ goto a_G11;}
a_1077();
if(!__equal(a_A[0],3)){ goto a_G7;}
a_G5:a_P[0]=2093834829;a_P[1]=a_F2;a_1108(2,a_P);
a_G6:a_1268();return;
a_G7:if(!__equal(a_A[0],1)){ goto a_G9;}
a_1771(a_L3,a_F2,a_L4);return;
a_G9:a_A[0]=2;
a_1766(a_L3,a_F2,a_L4);return;
a_G11:if(!__equal(a_A[0],1)){ goto a_G14;}
a_P[0]=2093834799;a_P[1]=a_F2;a_P[2]=a_L3;a_1108(3,a_P); goto a_G6;
a_G14:if(__equal(a_A[0],2)){ goto a_G5;}
a_A[0]=3;
a_1773(a_L3,a_F2,a_L4);return;
a_G19:a_P[0]=2093834754;a_P[1]=a_F2;a_1108(2,a_P);
a_1268();return;
} /* declaration */
static void a_1765(int a_F1,int a_F2){ /* declarationseries+>a+>a */
int a_P[1];
a_G1:a_P[0]=a_F1;a_1764(a_F2,a_P);a_F1=a_P[0];
if(!__equal(1454739076,a_1062)){ goto a_G4;}
a_1077(); goto a_G1;
a_G4:if(!__equal(1454739082,a_1062)){ goto a_G6;}
a_1077();return;
...
static void a_1577(int a_F1){ /* constantdeclaration+>a */

a_1765(a_F1,16777516);return;
} /* constantdeclaration */
static void a_1592(int a_F1){ /* variabledeclaration+>a */

a_1765(a_F1,16777526);return;
} /* variabledeclaration */
static void a_1590(void){ /* staticvariabledeclaration */

a_1765(0,16777531);return;
