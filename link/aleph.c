...
#define a_1337 (a_1270+sizeof_LIST) /* TARGET */
...
static void a_1341(int a_F1,int a_F2); /* Tjumptoareas */
static void a_1268(int a_F1,int a_F2); /* Tlabel */
static void a_1342(int a_F1,int a_A[1]); /* Tlimittail */
static void a_1269(int a_F1,int a_F2,int a_F3,int a_F4,int a_F5,int a_F6,int a_F7); /* Trulecall */
static void a_1343(int a_F1,int a_F2,int a_F3); /* Tsingleifcondition */
static void a_1344(void); /* addprofiling */
static void a_1345(void); /* addrulenameasstatic */
static void a_1346(void); /* addtracing */
static void a_1347(int a_A[1]); /* argsep */
static void a_1348(int a_F1,int a_F2,int a_A[2]); /* assignmentsource */
static void a_1349(int a_F1,int a_F2,int a_F3); /* blockdeclaration */
static void a_1350(int a_F1,int a_A[1]); /* boxclassifier */
static int a_1351=0; /* calledrule */
static void a_1352(int a_F1); /* charfileinitialization */
static void a_1246(void); /* closetarget */
static void a_1353(int a_A[1]); /* constitem */
static void a_1354(int a_F1,int a_A[1]); /* countfilearea */
static void a_1247(void); /* datadeclaration */
static void a_1355(int a_F1); /* datafileinitialization */
static void a_1248(void); /* datainitialization */
static void a_1249(void); /* datasectioniii */
static void a_1250(void); /* datasectioniv */
static void a_1356(int a_F1,int a_F2,int a_F3,int a_F4); /* declarecallargs */
static void a_1357(int a_F1,int a_F2,int a_F3); /* declarelocals */
static void a_1251(void); /* deletetarget */
static void a_1358(int a_F1,int a_F2,int a_F3); /* extensionblock */
static int a_1359(int a_F1); /* externalplaindeclaration */
static void a_1360(int a_F1); /* externalruletyper */
static void a_1361(void); /* fillentries */
static void a_1362(int a_A[1]); /* fillitem */
static int a_1363(int a_A[1]); /* fillrepeater */
static void a_1252(void); /* filltablehead */
static void a_1253(void); /* filltabletail */
static int a_1364=0; /* filltotal */
static void a_1365(int a_F1,int a_F2,int a_F3); /* flushbuffer */
static void a_1366(int a_F1); /* formalargument */
static void a_1367(int a_F1,int a_F2,int a_F3,int a_F4); /* genassignment */
static void a_1368(int a_F1,int a_F2,int a_F3); /* gengetaffixno */
static void a_1369(int a_F1,int a_F2); /* genshiftaffix */
static int a_1370(int a_F1); /* iscompletearea */
static int a_1371(int a_F1); /* isdummyaffix */
static int a_1372(int a_F1); /* ispidginalt */
static int a_1373(int a_F1); /* ispidgindiscarded */
static int a_1301(int a_F1); /* ispidginrule */
static void a_1374(int a_F1,int a_A[1]); /* iswaitfor */
static void a_1375(int a_F1); /* jumptolabel */
static void a_1376(int a_F1,int a_F2); /* listinitialization */
static void a_1377(int a_F1); /* localargument */
static void a_1378(int a_A[1]); /* nextaffix */
static int a_1379=0; /* nextnodeidx */
static void a_1254(void); /* opentarget */
static void a_1380(int a_F1,int a_A[1]); /* outargs */
static void a_1381(int a_F1); /* pidginalttagtail */
static void a_1382(int a_F1); /* pidginrepeatblock */
static void a_1383(int a_F1,int a_F2); /* pidginruleargs */
static void a_1384(int a_F1); /* pidginrulecall */
static void a_1385(int a_F1); /* printBUFFER */
static void a_1386(int a_F1); /* printGOTO */
static void a_1387(int a_F1); /* printchar */
...
static void a_1396(void); /* printprefix */
static void a_1397(int a_F1); /* printptr */
static void a_1398(int a_F1); /* printrepr */
static void a_1399(int a_F1,int a_F2); /* printstr */
...
static void a_1313(int a_F1,int a_F2,int a_F3,int a_F4,int a_F5,int a_F6,int a_F7); /* ruledeclarationhead */
...
-1}; /* fill table size 1719 */
static void a_data_setup(void){
 a_setup_list(0,a_1001,1,16777217,16778243,1027); /* @StringTable */
 a_setup_list(1,a_1012,1,1922290981,2130706369,0); /* EXPRESSION */
 a_setup_list(0,a_1017,1,1922290645,1922290979,335); /* MESSAGE */
 a_setup_stdarg(a_1104,1);
 a_setup_list(1,a_1158,6,1029081828,1326818092,0); /* AUX */
 a_setup_list(1,a_1015,6,1326818104,1922290638,0); /* ITEM */
 a_setup_list(0,a_1205,1,344288151,344288396,246); /* BOLD */
 a_setup_list(1,a_1010,1,969534568,1029081821,0); /* BUFFER */
 a_setup_list(1,a_1206,1,344288398,374062024,0); /* HASH */
 a_setup_list(1,a_1016,2,374062027,969534565,48); /* LEXT */
 a_setup_list(1,a_1265,6,16778250,314514514,0); /* NODE */
 a_setup_list(1,a_1270,3,314514523,344288147,0); /* ZONE */
 a_setup_charfile(a_1103,2,a_1001,16777307); /* PRINTFILE */
 a_setup_charfile(a_1209,1,a_1001,16777379); /* SOURCE */
 a_setup_charfile(a_1337,2,a_1001,16778243); /* TARGET */
 a_list_fill(a_FILL);
}
a_MROOT(a_1009,"data")
...
{register int a_r1=to_LIST(a_1015)->offset[a_F1-4];
 if(a_r1==344288235||a_r1==344288239||a_r1==344288245){ return;}
}
a_1030(a_1001,16777268,28);return;
} /* checklisttype */
static void a_1025(int a_F1){ /* checkconstanttype+>a */

{register int a_r1=to_LIST(a_1015)->offset[a_F1-4];
 if(a_r1==344288221||a_r1==344288252){ return;}
}
a_1030(a_1001,16777264,32);return;
} /* checkconstanttype */
...
if(!__equal(344288381,a_1058)){ goto a_G4;}
a_L1=a_1059;
a_1078(); goto a_G5;
a_G4:a_1030(a_1001,16777220,26);return;
a_G5:a_1026(a_L1);
if(!a_1060(a_L1,8)){ goto a_G8;}
a_1030(a_1001,16777260,48);return;
a_G8:if(!__equal(344288369,a_1058)){ goto a_G4;}
a_L2=a_1059;
a_1078();
{ if(a_L2==1||a_L2==2){ goto a_G13;}
 if(a_L2==3||a_L2==4){  goto a_G17;}
  goto a_G22;}
a_G13:if(!__equal(344288369,a_1058)){ goto a_G4;}
a_L3=a_1059;
a_1078(); goto a_G23;
a_G17:if(!__equal(344288381,a_1058)){ goto a_G4;}
a_L3=a_1059;
a_1078();
a_1025(a_L3); goto a_G23;
a_G22:a_1030(a_1001,16777256,52);return;
a_G23:a_1084(a_L1,a_L2);
a_1083(a_L1,a_L3);
a_1088(a_L1);
if(!__equal(344288353,a_1058)){ goto a_G4;}

a_1078();return;
} /* listentry */
static void a_1039(void){ /* fillitem */
int a_L1;
if(!__equal(344288341,a_1058)){ goto a_G12;}
a_G2:a_1078();
a_G3:if(!__equal(344288320,a_1058)){ goto a_G5;}
a_G4:a_1078();return;
a_G5:if(__equal(344288369,a_1058)){ goto a_G2;}
if(!__equal(344288381,a_1058)){ goto a_G10;}
a_L1=a_1059;
a_1078(); goto a_G11;
a_G10:a_1030(a_1001,16777220,26);return;
a_G11:a_1025(a_L1); goto a_G3;
a_G12:if(__equal(344288369,a_1058)){ goto a_G4;}
if(!__equal(344288381,a_1058)){ goto a_G10;}
a_L1=a_1059;
a_1078();
a_1025(a_L1);return;
...
static void a_1040(void){ /* fillrepeater */
int a_L1;
if(!__equal(344288359,a_1058)){return;}
a_1078();
if(!__equal(344288369,a_1058)){ goto a_G5;}
a_1078();return;
a_G5:if(!__equal(344288381,a_1058)){ goto a_G8;}
a_L1=a_1059;
a_1078(); goto a_G9;
a_G8:a_1030(a_1001,16777220,26);return;
a_G9:a_1025(a_L1);return;
} /* fillrepeater */
static void a_1038(int a_F1){ /* fillinitializer+>a */
int a_L2;
a_G1:if(!__equal(344288323,a_1058)){return;}
a_1078();
if(!__equal(344288381,a_1058)){ goto a_G6;}
a_L2=a_1059;
a_1078(); goto a_G7;
a_G6:a_1030(a_1001,16777220,26);return;
a_G7:if(!__equal(to_LIST(a_1015)->offset[a_L2-4],344288252)){ goto a_G9;}
if(__equal(to_LIST(a_1015)->offset[a_L2-1],0)){ goto a_G10;}
a_G9:a_1030(a_1001,16777252,68);return;
...
a_1078();
a_1088(a_L1);
a_G11:if(!__equal(344288353,a_1058)){ goto a_G13;}
a_1078();return;
a_G13:a_1039();
a_1040();
...
a_G3:a_P[0]=1922290659;a_P[1]=to_LIST(a_1015)->offset[a_F2-3];a_P[2]=a_F1;a_P[3]=a_F2;a_1097(4,a_P+0);
a_G4:__min(100,a_F1);
__max(1,a_F1);
...
a_G3:a_P[0]=1922290673;a_P[1]=to_LIST(a_1015)->offset[a_F2-3];a_P[2]=a_F1;a_P[3]=a_F2;a_1097(4,a_P+0);
...
a_A[0]=1;
a_P[0]=1922290685;a_P[1]=to_LIST(a_1015)->offset[a_F2-3];a_P[2]=to_LIST(a_1015)->offset[a_F1-3];a_P[3]=a_F2;a_1036(4,a_P+0);return;
} /* getestimator */
static void a_1065(void){ /* loosebounds */
...
if(!__equal(344288341,a_1058)){ goto a_G14;}
a_1078();
a_A[0]=0;
a_G4:if(!__equal(344288320,a_1058)){ goto a_G6;}
a_1078();return;
a_G6:if(!__equal(344288369,a_1058)){ goto a_G9;}
a_G7:a_1078();
__incr(a_A[0]); goto a_G4;
a_G9:if(!__equal(344288381,a_1058)){ goto a_G12;}
 goto a_G7;
a_G12:a_1030(a_1001,16777220,26);return;
a_G14:if(!__equal(344288369,a_1058)){ goto a_G17;}
a_G15:a_1078();
a_A[0]=1;return;
a_G17:if(!__equal(344288381,a_1058)){ goto a_G12;}
 goto a_G15;
} /* loosefillitem */
...
a_G4:a_P[0]=1922290704;a_P[1]=to_LIST(a_1015)->offset[a_F1-3];a_P[2]=a_F2;a_P[3]=to_LIST(a_1015)->offset[a_F3-3];a_P[4]=a_A[0];a_1097(5,a_P+0);
a_A[0]=1;return;
a_G6:a_A[0]=1;
a_P[0]=1922290719;a_P[1]=to_LIST(a_1015)->offset[a_F1-3];a_P[2]=a_F2;a_P[3]=to_LIST(a_1015)->offset[a_F3-3];a_1036(4,a_P+0);return;
} /* repeatervalue */
static void a_1072(int a_F1,int a_F2,int a_F3){ /* looserepeater+>a+>a+>a */
int a_L4;int a_L5;int a_P[1];
if(!__equal(344288359,a_1058)){ goto a_G15;}
a_1078();
if(!__equal(344288369,a_1058)){ goto a_G6;}
a_L5=a_1059;
a_1078(); goto a_G12;
a_G6:if(!__equal(344288381,a_1058)){ goto a_G9;}
a_L4=a_1059;
a_1078(); goto a_G10;
a_G9:a_1030(a_1001,16777220,26);return;
...
a_1030(a_1001,16777248,154);return;
...
a_1088(a_L1);
a_G7:if(!__equal(344288369,a_1058)){ goto a_G4;}
a_L2=a_1059;
a_1078();
a_G11:if(!__equal(344288353,a_1058)){ goto a_G13;}
a_1078();return;
...
a_G10:a_P[0]=1922290728;a_1036(1,a_P+0);return;
...
if(!__equal(to_LIST(a_1015)->offset[a_L1-4],344288252)){ goto a_G7;}
if(!a_1053(a_L1,a_P)){ goto a_G6;}
a_1030(a_1001,16777244,210);return;
a_G6:a_1093(a_L1);
...
a_G5:{register int a_r1=to_LIST(a_1015)->offset[a_L1-4];
 if(a_r1==344288221||a_r1==344288226||a_r1==344288231){  goto a_G7;}
}
a_1030(a_1001,16777240,222);return;
a_G7:a_1080(a_L1);
a_L2=to_LIST(a_1012)->aupb;
a_1080(a_1061);
a_1061=a_L2;
to_LIST(a_1015)->offset[a_L1-1]=to_LIST(a_1012)->aupb;
a_G12:{ if(a_1058==344288353){ goto a_G13;}
 if(a_1058==344288369){ goto a_G15;}
 if(a_1058==344288381){ goto a_G18;}
 if(a_1058==344288186||a_1058==344288208||a_1058==344288161){ goto a_G21;}
 if(a_1058==344288350||a_1058==344288335||a_1058==344288359||a_1058==344288332||a_1058==344288314||a_1058==344288344||a_1058==344288365||a_1058==344288329||a_1058==344288341||a_1058==344288320){  goto a_G29;}
  goto a_G31;}
a_G13:a_1078();
a_1080(344288353);return;
a_G15:a_1080(344288369);
a_G16:a_1080(a_1059);
...
a_G31:a_1030(a_1001,16777236,232);return;
} /* readexpression */
static void a_1031(void){ /* datasection */

if(a_1099()){return;}
a_G2:if(!__equal(344288179,a_1058)){ goto a_G5;}
a_1078();
a_1095(); goto a_G2;
a_G5:if(!__equal(344288166,a_1058)){ goto a_G8;}
a_1078();
a_1085(); goto a_G2;
a_G8:if(!__equal(344288183,a_1058)){ goto a_G11;}
a_1078();
a_1063(); goto a_G2;
a_G11:if(!__equal(344288175,a_1058)){return;}
a_1078();
a_1037(); goto a_G2;
} /* datasection */
static void a_1094(void){ /* skipentry */

a_G1:if(!__equal(344288353,a_1058)){ goto a_G3;}
a_1078();return;
a_G3:a_1078(); goto a_G1;
} /* skipentry */
static void a_1032(void){ /* datasectionii */

a_G1:if(!__equal(344288166,a_1058)){ goto a_G4;}
a_G2:a_1078();
a_1094(); goto a_G1;
a_G4:if(__equal(344288183,a_1058)){ goto a_G2;}
if(__equal(344288175,a_1058)){ goto a_G2;}
if(!__equal(344288179,a_1058)){return;}
a_1078();
a_1069(); goto a_G1;
} /* datasectionii */
...
a_A[0]=to_LIST(a_1012)->offset[a_1035];
{ if(a_A[0]==344288365){ goto a_G3;}
 if(a_A[0]==344288314){ goto a_G6;}
 if(a_A[0]==344288344){ goto a_G9;}
 if(a_A[0]==344288350||a_A[0]==344288335){ goto a_G12;}
 if(a_A[0]==344288332||a_A[0]==344288359){  goto a_G15;}
  return 0;}
...
{ if(a_F1==344288365){ goto a_G2;}
 if(a_F1==344288314){ goto a_G3;}
 if(a_F1==344288344){ goto a_G4;}
 if(a_F1==344288350){ goto a_G5;}
 if(a_F1==344288335){ goto a_G6;}
 if(a_F1==344288359){ goto a_G7;}
 if(!(a_F1==344288332)){a_area_failed(a_F1);}
  goto a_G8;}
...
int a_P[1];
if(!a_1011(344288341)){ goto a_G4;}
if(!a_1068(0,a_P)){ return 0;}a_A[0]=a_P[0];
if(!a_1011(344288320)){ return 0;} return 1;
a_G4:if(!a_1011(344288369)){ goto a_G7;}
a_A[0]=to_LIST(a_1012)->offset[a_1035];
a_G6:__incr(a_1035); return 1;
a_G7:if(!a_1011(344288329)){ goto a_G10;}
if(!a_1064(a_P)){ return 0;}a_A[0]=a_P[0];
__boolinvert(a_A[0],a_A[0]); return 1;
a_G10:if(!a_1011(344288335)){ goto a_G13;}
if(!a_1064(a_P)){ return 0;}a_A[0]=a_P[0];
__subtr(0,a_A[0],a_A[0]); return 1;
a_G13:if(!a_1011(344288161)){ goto a_G16;}
a_1048(to_LIST(a_1012)->offset[a_1035],a_P);a_A[0]=a_P[0]; goto a_G6;
a_G16:if(!a_1013(a_P)){ return 0;}a_A[0]=a_P[0];
if(!__equal(to_LIST(a_1015)->offset[a_A[0]-4],344288221)){ return 0;}
a_1066(a_A[0]);
...
a_P[0]=1922290742;a_P[1]=to_LIST(a_1015)->offset[a_L2-3];a_P[2]=a_L2;a_1036(3,a_P+0);
...
a_1030(a_1001,16777232,305);return;
...
if(!__equal(a_F1,344288186)){ goto a_G4;}
...
if(!a_1011(344288320)){return;}return;
a_G4:if(!a_1011(344288369)){ goto a_G7;}
a_A[0]=to_LIST(a_1012)->offset[a_1035];
...
a_G13:if(!a_1011(344288161)){ goto a_G17;}
a_A[0]=to_LIST(a_1012)->offset[a_1035];
a_1048(a_A[0],a_P);a_A[0]=a_P[0]; goto a_G6;
a_G17:if(!a_1011(344288186)){ goto a_G20;}
a_1051(344288186,to_LIST(a_1012)->offset[a_1035],a_P);a_A[0]=a_P[0]; goto a_G6;
a_G20:if(!a_1011(344288208)){ goto a_G23;}
a_1051(344288208,to_LIST(a_1012)->offset[a_1035],a_P);a_A[0]=a_P[0]; goto a_G6;
a_G23:if(!a_1013(a_P)){ goto a_G26;}a_A[0]=a_P[0];
a_1043(a_A[0]);
a_A[0]=to_LIST(a_1015)->offset[a_A[0]];return;
a_G26:a_1030(a_1001,16777228,330);return;
} /* finalbase */
...
a_P[0]=1922290742;a_P[1]=to_LIST(a_1015)->offset[a_L2-3];a_P[2]=a_F1;a_1036(3,a_P+0);
a_1090(0,a_L2,a_F1);return;
...
a_1030(a_1001,16777224,342);return;
...
{register int a_r1=to_LIST(a_1015)->offset[a_L1-4];
 if(a_r1==344288226||a_r1==344288231){ goto a_G4;}
 if(a_r1==344288266||a_r1==344288235||a_r1==344288239||a_r1==344288245||a_r1==344288257||a_r1==344288262){  goto a_G5;}
  goto a_G7;}
a_G4:a_1028(a_L1);
a_G5:a_1019(a_L1);
a_G7:__next(a_1015,a_L1); goto a_G2;
...
a_G10:a_1116(a_1001,16777299,61);return;
} /* printpointer */
...
a_G7:a_1116(a_1001,16777295,66);return;
...
a_G14:__incr(a_L3);
if(__more(to_LIST(a_1010)->aupb,a_L3)){ goto a_G19;}
...
a_1122(a_L2);
a_G4:if(__equal(a_L3,374062060)){ goto a_G7;}
a_1121(47);
a_1120(a_L3);
a_G7:a_1121(32);
a_1121(40);
...
if(__lseq(a_L2,0)){ goto a_G4;}
a_1122(a_L2);
a_G4:if(__equal(a_L3,374062060)){return;}
a_1121(47);
a_1120(a_L3);return;
} /* printline */
...
a_P[0]=1922290751;a_1102(1,a_P+0);return;
} /* error */
...
int a_P[2];
a_1117(70);
a_P[0]=1922290759;a_P[1]=a_F3;a_1112(2,a_P+0);
a_1119(a_F1,a_F2);
a_P[0]=1922290766;a_1112(1,a_P+0);
a_1118();
a_1105();
exit(2);return;
} /* internalerror */
...
int a_P[2];
a_1117(70);
a_P[0]=1922290777;a_P[1]=a_F3;a_1112(2,a_P+0);
a_1119(a_F1,a_F2);
a_P[0]=1922290766;a_1112(1,a_P+0);
a_1118();
a_1105();
...
a_G4:if(!__equal(a_F1,344288252)){ return 1;}
if(!__equal(a_F2,344288221)){ return 0;} return 0;
} /* unequaltypes */
...
if(!__equal(a_L3,344288266)){ goto a_G5;}
if(!__noteq(to_LIST(a_1015)->offset[a_F1-1],to_LIST(a_1015)->offset[a_F2-1])){ return 0;} return 1;
a_G5:if(__equal(a_L3,344288239)){ goto a_G8;}
if(__equal(a_L3,344288235)){ goto a_G8;}
if(!__equal(a_L3,344288245)){ return 0;}
...
a_P[0]=1922290805;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_F3;a_1036(4,a_P+0);return;
a_G3:if(!a_1060(a_F2,16)){ goto a_G6;}
if(a_1060(a_F3,16)){return;}
a_P[0]=1922290816;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_F3;a_1036(4,a_P+0);return;
a_G6:if(!a_1060(a_F3,16)){ goto a_G8;}
a_P[0]=1922290816;a_P[1]=a_F1;a_P[2]=a_F3;a_P[3]=a_F2;a_1036(4,a_P+0);return;
a_G8:if(!a_1060(a_F2,4)){ goto a_G11;}
if(!a_1060(a_F3,4)){return;}
a_P[0]=1922290826;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_F3;a_1036(4,a_P+0);return;
...
__decr(a_L4);
__incr(a_L3);
if(!__equal(to_LIST(a_1158)->offset[a_L3],344288305)){ goto a_G4;}
a_A[0]=a_L4;return;
} /* getrepeatcount */
...
__decr(a_F2);
if(!__equal(344288373,a_1058)){ goto a_G6;}
a_L5=a_1059;
a_1078(); goto a_G7;
a_G6:a_1030(a_1001,16777315,26);return;
a_G7:a_1192(a_L5);
if(__equal(a_L5,344288272)){ goto a_G10;}
if(!__equal(a_L5,344288278)){ goto a_G1;}
a_G10:if(!__equal(344288369,a_1058)){ goto a_G6;}
a_L3=a_1059;
a_1078();
if(!__equal(344288369,a_1058)){ goto a_G6;}
a_L4=a_1059;
...
a_L2=a_1059;
a_1078(); goto a_G5;
a_G4:a_1030(a_1001,16777315,26);return;
...
a_1078(); goto a_G5;
a_G4:a_1030(a_1001,16777315,26);return;
a_G5:if(!__equal(344288369,a_1058)){ goto a_G4;}
a_L3=a_1059;
a_1078();
...
a_1030(a_1001,16777339,235);return;
} /* checkitemID */
static void a_1195(void){ /* readitem */
int a_L1;int a_L2;int a_L3;int a_P[1];
a_1174();
if(!__equal(344288373,a_1058)){ goto a_G5;}
to_LIST(a_1015)->offset[to_LIST(a_1015)->aupb-4]=a_1059;
a_1078(); goto a_G6;
a_G5:a_1030(a_1001,16777315,26);return;
a_G6:if(!__equal(344288381,a_1058)){ goto a_G5;}
a_L1=a_1059;
a_1078();
a_1168(a_L1);
if(!__equal(344288369,a_1058)){ goto a_G5;}
...
a_1030(a_1001,16777335,243);return;
...
a_G24:{register int a_r1=to_LIST(a_1015)->offset[to_LIST(a_1015)->aupb-4];
 if(a_r1==344288266){ goto a_G25;}
 if(a_r1==344288239||a_r1==344288235||a_r1==344288245){ goto a_G26;}
 if(a_r1==344288221||a_r1==344288226||a_r1==344288231||a_r1==344288252||a_r1==344288257||a_r1==344288262){  goto a_G28;}
  goto a_G27;}
...
a_G27:a_1030(a_1001,16777331,250);return;
a_G28:if(!__equal(344288393,a_1058)){ goto a_G5;}
...
if(a_1099()){return;}
a_G2:if(!__equal(344288353,a_1058)){ goto a_G4;}
a_1078();return;
...
{register int a_r1=to_LIST(a_1015)->offset[a_F1-4];
 if(a_r1==344288257||a_r1==344288262){ goto a_G2;}
 if(a_r1==344288235||a_r1==344288239||a_r1==344288245){  goto a_G3;}
  goto a_G4;}
a_G2:if(!__noteq(a_F2,344288175)){return;} goto a_G4;
a_G3:if(!__noteq(a_F2,344288183)){return;}
a_G4:a_1030(a_1001,16777327,265);return;
} /* checktype */
static void a_1175(int a_F1){ /* filearea+>a */
int a_L2;int a_L3;
if(!__equal(344288362,a_1058)){return;}
a_1078();
a_G3:if(!__equal(344288317,a_1058)){ goto a_G5;}
a_1078();return;
a_G5:if(!__equal(344288381,a_1058)){ goto a_G8;}
a_L2=a_1059;
a_1078(); goto a_G9;
a_G8:a_1030(a_1001,16777315,26);return;
a_G9:a_1170(a_L2,344288183);
if(!__equal(344288369,a_1058)){ goto a_G8;}
a_L3=a_1059;
a_1078();
...
a_G19:if(!__equal(344288381,a_1058)){ goto a_G4;}
a_L3=a_1059;
a_1078();
...
static void a_1163(void){ /* addstdstring */
 ...
 a_extension(a_1015,6);to_LIST(a_1015)->top[1]=4;to_LIST(a_1015)->top[2]=344288235;to_LIST(a_1015)->top[4]=0;to_LIST(a_1015)->top[3]=374062033;to_LIST(a_1015)->top[5]=to_LIST(a_1158)->aupb;to_LIST(a_1015)->top[6]=0;to_LIST(a_1015)->aupb+=6;
a_1193(374062033,to_LIST(a_1015)->aupb);return;
} /* addstdstring */
static void a_1159(void){ /* addassignmentexternal */
int a_L1;int a_P[1];
a_L1=to_LIST(a_1158)->aupb;
 ...
 a_extension(a_1015,6);to_LIST(a_1015)->top[1]=98320;to_LIST(a_1015)->top[2]=344288266;to_LIST(a_1015)->top[4]=0;to_LIST(a_1015)->top[3]=374062039;to_LIST(a_1015)->top[5]=to_LIST(a_1158)->aupb;to_LIST(a_1015)->top[6]=0;to_LIST(a_1015)->aupb+=6;
a_1192(344288288);
a_1192(344288305);
a_1192(344288293);
a_P[0]=to_LIST(a_1015)->offset[to_LIST(a_1015)->aupb-1];a_1197(a_L1,a_P);to_LIST(a_1015)->offset[to_LIST(a_1015)->aupb-1]=a_P[0];
a_1193(374062039,to_LIST(a_1015)->aupb);return;
...
a_L1=to_LIST(a_1158)->aupb;
 ...
 a_extension(a_1015,6);to_LIST(a_1015)->top[1]=772;to_LIST(a_1015)->top[2]=344288266;to_LIST(a_1015)->top[4]=0;to_LIST(a_1015)->top[3]=374062047;to_LIST(a_1015)->top[5]=to_LIST(a_1158)->aupb;to_LIST(a_1015)->top[6]=0;to_LIST(a_1015)->aupb+=6;
a_1192(344288311);
a_P[0]=to_LIST(a_1015)->offset[to_LIST(a_1015)->aupb-1];a_1197(a_L1,a_P);to_LIST(a_1015)->offset[to_LIST(a_1015)->aupb-1]=a_P[0];
a_1193(374062047,to_LIST(a_1015)->aupb);return;
...
a_L1=to_LIST(a_1158)->aupb;
 ...
 a_extension(a_1015,6);to_LIST(a_1015)->top[1]=4;to_LIST(a_1015)->top[2]=344288266;to_LIST(a_1015)->top[4]=0;to_LIST(a_1015)->top[3]=374062055;to_LIST(a_1015)->top[5]=to_LIST(a_1158)->aupb;to_LIST(a_1015)->top[6]=0;to_LIST(a_1015)->aupb+=6;
a_1192(344288293);
a_1192(344288311);
a_P[0]=to_LIST(a_1015)->offset[to_LIST(a_1015)->aupb-1];a_1197(a_L1,a_P);to_LIST(a_1015)->offset[to_LIST(a_1015)->aupb-1]=a_P[0];
a_1193(374062055,to_LIST(a_1015)->aupb);return;
...
{register int a_r1=to_LIST(a_1015)->offset[a_F1-3];
 if(a_r1==374062039){ goto a_G2;}
 if(a_r1==374062047){ goto a_G3;}
 if(a_r1==374062055){  goto a_G4;}
  return 0;}
...
a_P[0]=1922290847;a_P[1]=to_LIST(a_1015)->offset[to_LIST(a_1015)->aupb-3];a_1097(2,a_P+0);return;
a_G5:if(!__equal(to_LIST(a_1015)->offset[to_LIST(a_1015)->aupb-4],344288202)){ goto a_G8;}
if(!__equal(to_LIST(a_1015)->offset[a_L1-4],344288202)){ goto a_G8;}
a_P[0]=1922290856;a_P[1]=to_LIST(a_1015)->offset[to_LIST(a_1015)->aupb-3];a_P[2]=to_LIST(a_1015)->offset[a_L1-3];a_1036(3,a_P+0);return;
a_G8:a_L1=to_LIST(a_1015)->offset[a_L1]; goto a_G2;
} /* checkmoduletitle */
static void a_1194(void){ /* readdefinitionlist */
int a_L1;int a_L2;
a_G1:if(!__equal(344288369,a_1058)){ goto a_G4;}
a_L1=a_1059;
a_1078(); goto a_G5;
a_G4:a_1030(a_1001,16777315,26);return;
a_G5:if(!__mreq(a_L1,a_1191)){ goto a_G7;}
a_1191=a_L1; goto a_G8;
a_G7:a_1030(a_1001,16777323,352);return;
a_G8:if(!__equal(344288393,a_1058)){ goto a_G4;}
a_L2=a_1059;
a_1078();
...
a_G15:if(!__equal(344288353,a_1058)){ goto a_G1;}
a_1078();return;
} /* readdefinitionlist */
...
if(!__equal(344288190,a_1058)){ goto a_G6;}
a_1078();
to_LIST(a_1015)->offset[to_LIST(a_1015)->aupb-4]=344288190; goto a_G10;
a_G6:if(!__equal(344288202,a_1058)){ goto a_G9;}
a_1078();
to_LIST(a_1015)->offset[to_LIST(a_1015)->aupb-4]=344288202; goto a_G10;
a_G9:a_1030(a_1001,16777319,362);return;
a_G10:if(!__equal(344288393,a_1058)){ goto a_G13;}
to_LIST(a_1015)->offset[to_LIST(a_1015)->aupb-3]=a_1059;
a_1078(); goto a_G14;
a_G13:a_1030(a_1001,16777315,26);return;
a_G14:a_1169();
a_1191=0;
a_1194();
...
a_G3:a_A[0]=0;
a_A[1]=374062060;return;
a_G5:a_F1=to_LIST(a_1015)->offset[a_F1-1];
a_A[0]=a_F2;
__decr(a_A[0]);
__incr(a_F2);
a_G9:if(!__more(a_F2,to_LIST(a_1158)->offset[a_F1-1])){ goto a_G12;}
__subtr(a_F2,to_LIST(a_1158)->offset[a_F1-1],a_A[0]);
__add(a_F1,2,a_F1); goto a_G9;
a_G12:a_A[1]=to_LIST(a_1158)->offset[a_F1];return;
} /* searchforline */
...
if(!__equal(to_LIST(a_1015)->offset[a_L1-4],344288202)){ goto a_G6;}
a_L3=1; goto a_G7;
a_G6:if(!__equal(to_LIST(a_1015)->offset[a_L1-4],344288190)){ goto a_G8;}
...
a_P[0]=1922290837;a_P[1]=to_LIST(a_1015)->offset[a_L1-3];a_P[2]=a_L1;a_1036(3,a_P+0); goto a_G7;
a_G14:if(__equal(a_L3,1)){return;}
a_P[0]=1922290862;a_1036(1,a_P+0);return;
} /* checkallitems */
static void a_1157(void){ /* @root */
...
a_G4:a_1030(a_1001,16777375,107);return;
...
a_G8:a_1030(a_1001,16777371,125);return;
} /* readdestination */
...
a_G17:a_1116(a_1001,16777367,173);return;
} /* rehash */
...
a_1228(); goto a_G10;
a_G9:a_1030(a_1001,16777359,260);return;
...
if(!__equal(a_A[0],344288154)){ goto a_G17;}
a_1030(a_1001,16777355,264);return;
...
a_1228(); goto a_G14;
a_G13:a_1030(a_1001,16777351,274);return;
...
if(!__equal(a_A[0],344288221)){ goto a_G21;}
a_1030(a_1001,16777347,278);return;
...
a_G4:a_1058=344288369;
a_1238(a_P);a_1059=a_P[0];return;
a_G6:a_1058=344288369;
a_G7:a_1234(0,a_P);a_1059=a_P[0];return;
a_G8:a_1058=344288385;
a_G9:a_1228(); goto a_G7;
a_G11:a_1058=344288381;
a_1228();
a_1234(0,a_P);a_1059=a_P[0];
a_1172();return;
a_G15:a_1058=344288389; goto a_G9;
a_G18:a_1058=344288377; goto a_G9;
a_G21:a_1231(a_P);a_1058=a_P[0];return;
a_G22:a_1058=344288373;
a_1237(a_P);a_1059=a_P[0];return;
a_G24:a_1058=344288393;
a_1236(a_P);a_1059=a_P[0];return;
a_G26:a_1058=344288314;
a_G27:a_1228();return;
a_G28:a_1058=344288317; goto a_G27;
a_G30:a_1058=344288320; goto a_G27;
a_G32:a_1058=344288323; goto a_G27;
a_G34:a_1058=344288326; goto a_G27;
a_G36:a_1058=344288329; goto a_G27;
a_G38:a_1058=344288332; goto a_G27;
a_G40:a_1228();
a_1235(a_P);a_1058=a_P[0];a_1059=a_P[1];return;
a_G42:a_1058=344288338; goto a_G27;
a_G44:a_1058=344288341; goto a_G27;
a_G46:a_1058=344288344; goto a_G27;
a_G48:a_1058=344288347;
a_1228();
a_1232(a_P);a_1059=a_P[0];return;
a_G51:a_1058=344288350; goto a_G27;
a_G53:a_1058=344288353; goto a_G27;
a_G55:a_1058=344288356; goto a_G27;
a_G57:a_1058=344288359; goto a_G27;
a_G59:a_1058=344288362; goto a_G27;
a_G61:a_1058=344288365; goto a_G27;
a_G63:a_1058=344288396;return;
a_G64:a_1030(a_1001,16777343,314);return;
} /* nextsymbol */
static void a_1204(void){ /* @root */
...
a_G4:a_A[1]=a_A[0];
a_L4=1; goto a_G22;
a_G6:if(!__equal(344288381,a_1058)){ goto a_G21;}
a_L3=a_1059;
a_1078();
if(a_1053(a_L3,a_P)){a_L3=a_P[0];}
{register int a_r1=to_LIST(a_1015)->offset[a_L3-4];
 if(a_r1==344288221||a_r1==344288252){ goto a_G11;}
 if(a_r1==344288239||a_r1==344288235||a_r1==344288245){  goto a_G14;}
  goto a_G20;}
...
a_L4=2; goto a_G22;
a_G20:a_1030(a_1001,16777411,61);return;
a_G21:a_A[0]=0;a_A[1]=0;a_L4=0;
a_G22:if(!__equal(344288323,a_1058)){ goto a_G39;}
a_1078();
if(!__equal(a_L4,0)){ goto a_G26;}
a_A[0]=(-2147483647-1); goto a_G28;
a_G26:if(__equal(a_L4,1)){ goto a_G28;}
a_1030(a_1001,16777407,63);return;
a_G28:if(!__equal(344288369,a_1058)){ goto a_G31;}
a_A[1]=a_1059;
a_1078();return;
a_G31:if(!__equal(344288381,a_1058)){ goto a_G38;}
a_L3=a_1059;
a_1078();
if(a_1053(a_L3,a_P)){a_L3=a_P[0];}
{register int a_r1=to_LIST(a_1015)->offset[a_L3-4];
 if(!(a_r1==344288221||a_r1==344288252)){ goto a_G37;}
}
a_A[1]=to_LIST(a_1015)->offset[a_L3];return;
a_G37:a_1030(a_1001,16777403,68);return;
a_G38:a_A[1]=2147483647;return;
a_G39:if(!__equal(a_L4,0)){return;}
a_1030(a_1001,16777399,70);return;
} /* readareainterval */
...
a_A[0]=a_1059;
a_1078(); goto a_G5;
a_G4:a_1030(a_1001,16777387,26);return;
a_G5:a_L3=0;
...
a_G9:a_P[0]=1922290877;a_P[1]=a_A[0];a_P[2]=a_L4;a_P[3]=a_L5;a_1036(4,a_P+0);
a_G10:if(!__equal(344288356,a_1058)){ goto a_G12;}
a_1078(); goto a_G6;
a_G12:a_1306(a_F1);
if(__is(a_L3)){return;}
a_P[0]=1922290890;a_P[1]=a_A[0];a_1036(2,a_P+0);return;
} /* checkarea */
static void a_1276(void){ /* checkareas */
int a_L1;int a_L2;int a_L3;int a_P[2];
__scratch(a_1270);
...
a_L2=0;a_L3=0;
a_G5:if(!__equal(344288154,a_1058)){ goto a_G13;}
a_1078();
__incr(a_L3);
a_1275(a_L1,a_P);a_L2=a_P[0];
if(!__equal(344288347,a_1058)){ goto a_G12;}

a_1078(); goto a_G5;
a_G12:a_1030(a_1001,16777387,26);return;
a_G13:if(!a_1280(a_L1)){ goto a_G17;}
a_1321(2048);
if(__more(a_L3,1)){return;}
a_P[0]=1922290915;a_P[1]=a_L2;a_1036(2,a_P+0);return;
a_G17:a_P[0]=1922290903;a_P[1]=a_L2;a_1097(2,a_P+0);return;
} /* checkareas */
static int a_1300(int a_F1){ /* isnodeflag+>a */
int a_L2;
__booland(to_LIST(a_1265)->offset[a_1334-4],a_F1,a_L2);
...
__boolor(a_F1,to_LIST(a_1265)->offset[a_1334-4],to_LIST(a_1265)->offset[a_1334-4]);return;
} /* setnodeflag */
...
a_L1=a_1059;
a_1078(); goto a_G6;
a_G5:a_1030(a_1001,16777387,26);return;
...
if(!__equal(344288377,a_1058)){ goto a_G4;}

a_1078(); goto a_G5;
a_G4:a_1030(a_1001,16777387,26);return;
a_G5:if(!__equal(a_1334,0)){ goto a_G7;}
a_1334=to_LIST(a_1265)->alwb; goto a_G8;
a_G7:__next(a_1265,a_1334);
a_G8:if(__lseq(a_1334,to_LIST(a_1265)->aupb)){return;}
a_1030(a_1001,16777395,139);return;
} /* advancenode */
static void a_1322(void){ /* setrulehead */
int a_L1;int a_L2;int a_L3;int a_L4;int a_P[1];
if(!__equal(344288381,a_1058)){ goto a_G4;}
...
to_LIST(a_1265)->offset[a_1334-3]=a_L1;
if(!__equal(344288369,a_1058)){ goto a_G4;}
a_L2=a_1059;
a_1078();
if(!__equal(344288369,a_1058)){ goto a_G4;}
...
static void a_1326(void){ /* skiptocomma */
int a_L1;
a_G1:if(!__equal(344288326,a_1058)){ goto a_G3;}
a_1078();return;
a_G3:if(!__equal(344288389,a_1058)){ goto a_G7;}
a_L1=a_1059;
a_1078();
...
a_G1:if(!__equal(344288347,a_1058)){ goto a_G4;}
a_A[0]=a_1059;
a_1078();return;
...
if(!__equal(344288161,a_1058)){ goto a_G3;}
a_G2:a_1078(); return 1;
a_G3:if(__equal(344288186,a_1058)){ goto a_G2;}
if(__equal(344288208,a_1058)){ goto a_G2;}
if(__equal(344288212,a_1058)){ goto a_G2;}
if(!__equal(344288216,a_1058)){ return 0;}
a_1078(); return 1;
} /* islimit */
static void a_1324(void){ /* skiplist */

if(!__equal(344288385,a_1058)){ goto a_G3;}
a_G2:a_1078();return;
a_G3:if(!__equal(344288381,a_1058)){ goto a_G6;}
 goto a_G2;
a_G6:a_1030(a_1001,16777387,26);return;
} /* skiplist */
static void a_1323(void){ /* skipaffix */
int a_L1;
if(!__equal(344288323,a_1058)){ goto a_G3;}
a_1078();
a_G3:if(!__equal(344288385,a_1058)){ goto a_G5;}
a_G4:a_1078();return;
a_G5:if(!__equal(344288389,a_1058)){ goto a_G9;}
a_L1=a_1059;
a_1078();
a_1304(a_L1);return;
a_G9:if(__equal(344288381,a_1058)){ goto a_G4;}
if(__equal(344288338,a_1058)){ goto a_G4;}
if(__equal(344288369,a_1058)){ goto a_G4;}
if(!a_1299()){ goto a_G17;}
a_1324();return;
a_G17:if(!__equal(344288362,a_1058)){ goto a_G29;}
a_1078();
a_1324();
a_1323();
if(!__equal(344288317,a_1058)){ goto a_G24;}

a_1078(); goto a_G25;
a_G24:a_1030(a_1001,16777387,26);return;
a_G25:if(!__equal(344288369,a_1058)){ goto a_G24;}
 goto a_G4;
a_G29:a_1030(a_1001,16777391,204);return;
} /* skipaffix */
...
a_L2=a_1059;
a_1078();
a_P[0]=a_F1;a_P[1]=344288385;a_P[2]=a_L2;a_1309(3,a_P+0);return;
a_G5:if(!__equal(344288381,a_1058)){ goto a_G8;}
a_L2=a_1059;
a_1078(); goto a_G9;
a_G8:a_1030(a_1001,16777387,26);return;
a_G9:a_P[0]=a_F1;a_P[1]=344288381;a_P[2]=a_L2;a_1309(3,a_P+0);return;
} /* storelist */
static void a_1330(void){ /* storelimit */

if(!__equal(344288186,a_1058)){ goto a_G4;}
a_1078();
a_1331(344288186);return;
a_G4:if(!__equal(344288208,a_1058)){ goto a_G7;}
a_1078();
a_1331(344288208);return;
a_G7:if(!__equal(344288212,a_1058)){ goto a_G10;}
a_1078();
a_1331(344288212);return;
a_G10:if(!__equal(344288216,a_1058)){ goto a_G13;}
a_1078();
a_1331(344288216);return;
a_G13:if(!__equal(344288161,a_1058)){ goto a_G16;}

a_1078(); goto a_G17;
a_G16:a_1030(a_1001,16777387,26);return;
a_G17:a_1331(344288161);return;
} /* storelimit */
static void a_1329(void){ /* storeaffix */
int a_L1;int a_P[2];
if(!__equal(344288385,a_1058)){ goto a_G5;}
a_L1=a_1059;
a_1078();
a_P[0]=344288385;a_P[1]=a_L1;a_1309(2,a_P+0);return;
a_G5:if(!__equal(344288389,a_1058)){ goto a_G9;}
a_L1=a_1059;
a_1078();
a_P[0]=344288389;a_P[1]=a_L1;a_1309(2,a_P+0);return;
a_G9:if(!__equal(344288381,a_1058)){ goto a_G13;}
a_L1=a_1059;
a_1078();
a_P[0]=344288381;a_P[1]=a_L1;a_1309(2,a_P+0);return;
a_G13:if(!__equal(344288369,a_1058)){ goto a_G17;}
a_L1=a_1059;
a_1078();
a_P[0]=344288369;a_P[1]=a_L1;a_1309(2,a_P+0);return;
a_G17:if(!__equal(344288362,a_1058)){ goto a_G30;}
a_1078();
a_1331(344288362);
a_1329();
if(!__equal(344288317,a_1058)){ goto a_G24;}
...
a_L1=a_1059;
a_1078();
a_P[0]=344288317;a_P[1]=a_L1;a_1309(2,a_P+0);return;
a_G30:a_1330();return;
} /* storeaffix */
static void a_1332(int a_A[1]){ /* storeruleaffix+a> */
int a_L2;int a_P[2];
if(!__equal(344288323,a_1058)){ goto a_G6;}
a_1078();
a_A[0]=344288323;
a_P[0]=344288323;a_1309(1,a_P+0);
a_1329();return;
a_G6:if(!__equal(344288338,a_1058)){ goto a_G10;}
a_1078();
a_A[0]=344288338;
a_P[0]=344288338;a_1309(1,a_P+0);return;
a_G10:if(!__equal(344288359,a_1058)){ goto a_G18;}
a_1078();
a_A[0]=344288359;
if(!__equal(344288369,a_1058)){ goto a_G16;}
a_L2=a_1059;
a_1078(); goto a_G17;
a_G16:a_L2=0;
a_G17:a_P[0]=344288359;a_P[1]=a_L2;a_1309(2,a_P+0);return;
a_G18:a_A[0]=0;
a_1329();return;
} /* storeruleaffix */
static void a_1333(void){ /* storeruleaffixes */
int a_P[2];
a_G1:{ if(a_1058==344288389){ goto a_G2;}
 if(a_1058==344288385||a_1058==344288381||a_1058==344288369){ goto a_G3;}
 if(a_1058==344288186||a_1058==344288208||a_1058==344288212||a_1058==344288216||a_1058==344288161||a_1058==344288338||a_1058==344288362||a_1058==344288317||a_1058==344288359||a_1058==344288323){  goto a_G7;}
  goto a_G9;}
a_G2:a_1304(a_1059);
a_G3:a_P[0]=a_1058;a_P[1]=a_1059;a_1309(2,a_P+0);
a_G4:a_1078(); goto a_G1;
a_G7:a_P[0]=a_1058;a_1309(1,a_P+0); goto a_G4;
a_G9:if(!__equal(344288347,a_1058)){ goto a_G12;}
to_LIST(a_1265)->offset[a_1334-1]=a_1059;
a_1078(); goto a_G13;
a_G12:a_1030(a_1001,16777387,26);return;
a_G13:if(!__equal(344288347,a_1058)){ goto a_G12;}
to_LIST(a_1265)->offset[a_1334]=a_1059;
a_1078();
if(!__equal(344288326,a_1058)){ goto a_G12;}
...
a_1333();
a_blockhash(a_1010,a_L1,a_P);to_LIST(a_1265)->offset[a_1334-5]=a_P[0];
...
if(__equal(to_LIST(a_1010)->offset[a_F1],344288326)){ return 1;}
__decr(a_F1);
__decr(a_F2); goto a_G1;
} /* equalaffixes */
static void a_1279(int a_F1){ /* comparetostoredaffixes+>a */
int a_L2;int a_L3;int a_L4;
a_L3=to_LIST(a_1265)->offset[a_1334-5];
a_L4=1;
a_L2=to_LIST(a_1265)->alwb;
a_G4:if(__mreq(a_L2,a_1334)){ goto a_G12;}
if(!a_1298(a_L2,4096)){ goto a_G11;}
if(!__equal(to_LIST(a_1265)->offset[a_L2-5],a_L3)){ goto a_G11;}
if(!a_1285(to_LIST(a_1265)->offset[a_1334-2],to_LIST(a_1265)->offset[a_L2-2])){ goto a_G11;}
a_L4=0;
to_LIST(a_1265)->offset[a_1334-2]=a_L2;
...
static void a_1277(void){ /* checknodehash */
int a_L1;int a_P[1];
if(!a_1308(a_1334)){ goto a_G7;}
a_L1=to_LIST(a_1010)->aupb;
a_P[0]=344288326;a_1309(1,a_P+0);
a_1333();
to_LIST(a_1265)->offset[a_1334-2]=to_LIST(a_1010)->aupb;
a_1279(a_L1);return;
a_G7:a_1326();return;
} /* checknodehash */
...
a_1305(a_L1,to_LIST(a_1265)->offset[a_1334-1]);
a_1305(a_L1,to_LIST(a_1265)->offset[a_1334]);return;
} /* rulelabel */
static void a_1273(void){ /* arealabels */
int a_L1;int a_L2;int a_L3;int a_P[1];
a_1289(a_P);a_L1=a_P[0];
a_L2=0;a_L3=0;
a_G3:if(!__equal(344288154,a_1058)){ goto a_G8;}
a_1078();
a_1305(0,a_L2);
a_L2=a_L3;
...
__subtr(a_1334,to_LIST(a_1265)->alwb,a_L1);
__div(a_L1,6,a_L1);
...
a_G19:if(!__equal(344288347,a_1058)){ goto a_G25;}
a_1078();
if(!__equal(344288347,a_1058)){ goto a_G4;}

a_1078(); goto a_G34;
a_G25:a_1332(a_P);a_L1=a_P[0];
a_P[0]=344288350;a_1309(1,a_P+0);
__incr(a_L2);
if(!__is(a_L5)){ goto a_G30;}
__incr(a_L5);
a_G30:if(!__equal(a_L1,344288359)){ goto a_G19;}
if(!__is(a_L5)){ goto a_G33;}
a_L6=1; goto a_G19;
a_G33:a_L5=1; goto a_G19;
a_G34:a_1290(to_LIST(a_1265)->offset[a_1334-1],a_P);a_L3=a_P[0];
a_1290(to_LIST(a_1265)->offset[a_1334],a_P);a_L4=a_P[0];
a_1269(to_LIST(a_1265)->offset[a_1334-3],a_L2,a_L3,a_L4,a_L5,a_L6,a_L7);
...
a_G11:a_1329();
a_P[0]=344288350;a_1309(1,a_P+0);
a_G13:if(!__equal(344288205,a_1058)){ goto a_G20;}
a_1078();
if(!__equal(344288369,a_1058)){ goto a_G6;}
a_L2=a_1059;
a_1078();
a_P[0]=a_L2;a_1309(1,a_P+0); goto a_G13;
a_G20:if(!__equal(344288347,a_1058)){ goto a_G26;}
a_L4=a_1059;
a_1078();
...
if(!__equal(344288356,a_1058)){return;}
a_1078();
a_P[0]=344288356;a_1309(1,a_P+0); goto a_G1;
} /* generatearea */
static void a_1292(void){ /* generateareas */
int a_L1;int a_L2;int a_L3;int a_P[3];
a_L1=0;
if(!__equal(344288154,a_1058)){ goto a_G5;}

a_1078(); goto a_G6;
a_G5:a_1030(a_1001,16777387,26);return;
a_G6:if(!__equal(344288369,a_1058)){ goto a_G5;}
...
a_L2=to_LIST(a_1010)->aupb;
a_1291();
if(!__equal(344288347,a_1058)){ goto a_G5;}
a_L3=a_1059;
a_1078();
a_1290(a_L3,a_P);to_LIST(a_1010)->offset[a_L2]=a_P[0];
if(!__equal(344288154,a_1058)){ goto a_G25;}
a_1078();
a_P[0]=344288350;a_1309(1,a_P+0); goto a_G6;
a_G25:if(!a_1300(2048)){ goto a_G28;}
__unstackto(a_1010,a_L2);
a_P[0]=(-2147483647-1);a_P[1]=2147483647;a_P[2]=344288350;a_1309(3,a_P+0);return;
a_G28:a_P[0]=344288350;a_1309(1,a_P+0);return;
} /* generateareas */
static void a_1293(void){ /* generatebox */
int a_L1;int a_L2;int a_P[1];
a_L1=to_LIST(a_1010)->aupb;
...
a_G1:if(!__equal(344288157,a_1058)){ goto a_G11;}
a_1078();
a_1272();
a_1321(4);
a_1323();
a_1276();
if(!__equal(344288326,a_1058)){ goto a_G10;}

a_1078(); goto a_G1;
a_G10:a_1030(a_1001,16777387,26);return;
a_G11:if(!__equal(344288171,a_1058)){ goto a_G16;}
a_1078();
a_1272();
a_1321(2);
a_1326(); goto a_G1;
a_G16:if(!__equal(344288194,a_1058)){ goto a_G22;}
a_1078();
a_1272();
a_1321(1);
a_1322();
a_1281(); goto a_G1;
a_G22:if(!__equal(344288353,a_1058)){ goto a_G10;}
...
int a_L1;
a_L1=to_LIST(a_1010)->aupb;
a_G2:if(!__equal(344288157,a_1058)){ goto a_G6;}
a_G3:a_1078();
a_1272();
a_1326(); goto a_G2;
a_G6:if(__equal(344288171,a_1058)){ goto a_G3;}
if(!__equal(344288194,a_1058)){ goto a_G15;}
a_1078();
a_1272();
a_1325();
a_1277(); goto a_G2;
a_G15:if(!__equal(344288353,a_1058)){ goto a_G18;}

a_1078(); goto a_G19;
a_G18:a_1030(a_1001,16777387,26);return;
a_G19:__unstackto(a_1010,a_L1);
a_1287();return;
} /* scanii */
static void a_1319(void){ /* scaniii */

a_G1:if(!__equal(344288157,a_1058)){ goto a_G10;}
a_1078();
a_1272();
a_1323();
a_1273();
a_G6:if(!__equal(344288326,a_1058)){ goto a_G9;}

a_1078(); goto a_G1;
a_G9:a_1030(a_1001,16777387,26);return;
a_G10:if(!__equal(344288171,a_1058)){ goto a_G18;}
a_1078();
a_1272();
a_1286(); goto a_G6;
a_G18:if(!__equal(344288194,a_1058)){ goto a_G23;}
a_1078();
a_1272();
a_1315();
a_1326(); goto a_G1;
a_G23:if(!__equal(344288353,a_1058)){ goto a_G9;}

a_1078();return;
} /* scaniii */
static void a_1320(void){ /* scaniv */

a_G1:if(!__equal(344288157,a_1058)){ goto a_G9;}
a_1078();
a_1295();
a_1293();
a_G5:if(!__equal(344288326,a_1058)){ goto a_G8;}

a_1078(); goto a_G1;
a_G8:a_1030(a_1001,16777387,26);return;
a_G9:if(!__equal(344288171,a_1058)){ goto a_G17;}
a_1078();
a_1295();
a_1294(); goto a_G5;
a_G17:if(!__equal(344288194,a_1058)){ goto a_G27;}
a_1078();
a_1295();
if(!a_1300(16384)){ goto a_G22;}
a_1326(); goto a_G1;
a_G22:a_1296(); goto a_G5;
a_G27:if(!__equal(344288353,a_1058)){ goto a_G8;}
...
a_1317();
a_1284=0;
if(a_1307()){ goto a_G25;}
a_1240();
a_1334=0;
a_1318();
a_G25:a_1313(a_L1,a_1262,a_1263,a_1264,a_L3,a_L4,a_1302);
__unstackto(a_1010,a_L2);
a_1240();
a_1334=0;
a_1319();
...
static void a_1254(void){ /* opentarget */
int a_P[2];
if(a_openfile(a_1337,119,a_1017,1922290919)){return;}
a_P[0]=1922290929;a_P[1]=1922290919;a_1102(2,a_P+0);return;
} /* opentarget */
static void a_1246(void){ /* closetarget */
...
a_1246();
a_unlinkfile(a_1017,1922290919);return;
} /* deletetarget */
static void a_1387(int a_F1){ /* printchar+>a */

a_putchar(a_1337,a_F1);return;
} /* printchar */
...
static void a_1399(int a_F1,int a_F2){ /* printstr+t[]+>a */

a_1402(a_1337,a_F1,a_F2);return;
} /* printstr */
static void a_1396(void){ /* printprefix */
...
static void a_1377(int a_F1){ /* localargument+>a */
...
static void a_1366(int a_F1){ /* formalargument+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_L2=0;a_L4=0;
a_G2:a_1180(a_1418,a_L2,a_P);a_L3=a_P[0];
__incr(a_L2);
if(__equal(a_L3,344288293)){ goto a_G6;}
if(!__equal(a_L3,344288299)){ goto a_G9;}
a_G6:if(!__equal(a_L2,a_F1)){ goto a_G8;}
a_1392(65,a_L4);return;
a_G8:__incr(a_L4); goto a_G2;
a_G9:if(!__equal(a_L3,344288305)){ goto a_G16;}
__incr(a_L2);
__subtr(a_F1,a_L2,a_L2);
if(!__less(a_L2,0)){ goto a_G15;}
a_1396();
a_1387(67);return;
a_G15:a_1392(86,a_L2);return;
...
a_G8:a_1397(a_F1);return;
} /* printpidginrepr */
static void a_1388(int a_F1){ /* printexternalrepr+>a */

{register int a_r1=to_LIST(a_1015)->offset[a_F1-4];
 if(a_r1==344288221||a_r1==344288226){ goto a_G2;}
 if(a_r1==344288266){  goto a_G3;}
  goto a_G6;}
a_G2:a_1397(a_F1);return;
a_G3:if(!a_1301(a_F1)){ goto a_G2;}
a_1395(a_F1);return;
a_G6:a_1396();
a_1390(to_LIST(a_1015)->offset[a_F1]);return;
} /* printexternalrepr */
static void a_1398(int a_F1){ /* printrepr+>a */
int a_P[1];
...
a_G5:{register int a_r1=to_LIST(a_1015)->offset[a_F1-4];
 if(a_r1==344288221||a_r1==344288252){  goto a_G7;}
}
a_1396();
a_G7:a_1390(to_LIST(a_1015)->offset[a_F1]);return;
a_G8:a_1397(a_F1);return;
} /* printrepr */
...
a_G1:{ if(a_F1==0){ goto a_G2;}
 ...
 if(a_F1==-2){  goto a_G8;}
  goto a_G9;}
a_G2:if(!a_1060(a_1351,1024)){ goto a_G4;}
a_F1=-1; goto a_G1;
a_G4:a_1116(a_1001,16778239,127);return;
a_G5:if(!a_1060(a_1418,512)){ goto a_G7;}
a_1399(a_1001,16778235);return;
a_G7:a_1399(a_1001,16778230);return;
a_G8:a_1399(a_1001,16778226);return;
a_G9:a_1399(a_1001,16778221);
a_1394(a_F1);
a_1387(59);return;
} /* printgoto */
static void a_1386(int a_F1){ /* printGOTO+>a */

if(!__equal(a_F1,a_1379)){ goto a_G3;}
if(__noteq(a_1379,0)){return;}
a_G3:a_1389(a_F1);return;
} /* printGOTO */
static void a_1385(int a_F1){ /* printBUFFER+>a */

{register int a_r1=to_LIST(a_1010)->offset[a_F1];
 if(a_r1==344288381){ goto a_G2;}
 if(a_r1==344288369){ goto a_G4;}
 if(a_r1==344288389){ goto a_G6;}
 if(a_r1==344288385){  goto a_G8;}
  goto a_G10;}
a_G2:__incr(a_F1);
a_1398(to_LIST(a_1010)->offset[a_F1]);return;
a_G4:__incr(a_F1);
a_1390(to_LIST(a_1010)->offset[a_F1]);return;
a_G6:__incr(a_F1);
a_1377(to_LIST(a_1010)->offset[a_F1]);return;
a_G8:__incr(a_F1);
a_1366(to_LIST(a_1010)->offset[a_F1]);return;
a_G10:a_1116(a_1001,16778217,144);return;
} /* printBUFFER */
static void a_1397(int a_F1){ /* printptr+>a */
int a_P[1];
a_G1:if(!__was(a_1015,a_F1)){ goto a_G3;}
a_F1=to_LIST(a_1015)->offset[a_F1-3]; goto a_G1;
a_G3:if(!__was(a_1016,a_F1)){ goto a_G6;}
a_1115(a_F1,a_P);a_F1=a_P[0];
a_1399(a_1016,a_F1);return;
a_G6:if(!__was(a_1017,a_F1)){ goto a_G8;}
a_1399(a_1017,a_F1);return;
a_G8:if(!__was(a_1010,a_F1)){ goto a_G10;}
a_1385(a_F1);return;
a_G10:a_1116(a_1001,16778213,150);return;
} /* printptr */
...
a_1399(a_1001,16778209);
a_G38:__unstackto(a_1010,a_L3);return;
} /* T */
static void a_1260(void){ /* targetprelude */
int a_L1;int a_P[2];
a_P[0]=16778205;a_1336(a_1001,1,a_P+0);
a_L1=to_LIST(a_1015)->alwb;
a_G3:if(__more(a_L1,to_LIST(a_1015)->aupb)){ goto a_G8;}
{register int a_r1=to_LIST(a_1015)->offset[a_L1-4];
 if(a_r1==344288202){ goto a_G5;}
 if(a_r1==344288190){  goto a_G6;}
  goto a_G7;}
a_G5:a_P[0]=16778194;a_P[1]=to_LIST(a_1015)->offset[a_L1-3];a_1336(a_1001,2,a_P+0); goto a_G7;
a_G6:a_P[0]=16778190;a_P[1]=to_LIST(a_1015)->offset[a_L1-3];a_1336(a_1001,2,a_P+0);
a_G7:__next(a_1015,a_L1); goto a_G3;
a_G8:a_P[0]=16778187;a_1336(a_1001,1,a_P+0);return;
} /* targetprelude */
static void a_1374(int a_F1,int a_A[1]){ /* iswaitfor+>a+>a> */
int a_P[1];
if(__is(a_A[0])){return;}
if(!a_1053(a_F1,a_P)){return;}a_F1=a_P[0];
if(!a_1060(a_F1,16)){return;}
if(!__equal(to_LIST(a_1015)->offset[a_F1-3],374062073)){return;}
a_A[0]=1;return;
} /* iswaitfor */
static void a_1400(void){ /* procwaitfor */
int a_L1;int a_L2;int a_P[2];
a_P[0]=16778177;a_1336(a_1001,1,a_P+0);
a_L1=to_LIST(a_1015)->alwb;
a_L2=0;
a_G4:if(__more(a_L1,to_LIST(a_1015)->aupb)){ goto a_G12;}
{register int a_r1=to_LIST(a_1015)->offset[a_L1-4];
 if(a_r1==344288190){ goto a_G6;}
 if(a_r1==344288202){ goto a_G7;}
 if(a_r1==344288266){  goto a_G8;}
  goto a_G11;}
a_G6:a_L2=to_LIST(a_1015)->offset[a_L1-3]; goto a_G11;
a_G7:a_L2=0; goto a_G11;
a_G8:if(__equal(a_L2,0)){ goto a_G11;}
if(__noteq(374062066,to_LIST(a_1015)->offset[a_L1-3])){ goto a_G11;}
a_P[0]=16778166;a_P[1]=a_L1;a_1336(a_1001,2,a_P+0);
a_G11:__next(a_1015,a_L1); goto a_G4;
a_G12:a_P[0]=16778155;a_1336(a_1001,1,a_P+0);return;
} /* procwaitfor */
static void a_1259(void){ /* targetmain */
int a_L1;int a_L2;int a_L3;int a_P[3];
a_L1=to_LIST(a_1015)->alwb;
...
a_G8:a_P[0]=a_L3;a_1374(a_L1,a_P);a_L3=a_P[0];
if(__equal(a_L2,0)){ goto a_G12;}
if(__noteq(374062066,to_LIST(a_1015)->offset[a_L1-3])){ goto a_G12;}
a_P[0]=16778149;a_P[1]=a_L1;a_P[2]=a_L2;a_1336(a_1001,3,a_P+0);
a_G12:__next(a_1015,a_L1); goto a_G4;
a_G13:if(__equal(a_L3,0)){ goto a_G15;}
a_1400();
a_G15:a_P[0]=16778142;a_1336(a_1001,1,a_P+0);
a_L1=to_LIST(a_1015)->alwb;
a_L2=0;
a_G18:if(__more(a_L1,to_LIST(a_1015)->aupb)){ goto a_G26;}
{register int a_r1=to_LIST(a_1015)->offset[a_L1-4];
 if(a_r1==344288190){ goto a_G20;}
 if(a_r1==344288202){ goto a_G21;}
 if(a_r1==344288266){  goto a_G22;}
  goto a_G25;}
a_G20:a_L2=to_LIST(a_1015)->offset[a_L1-3]; goto a_G25;
a_G21:a_L2=0; goto a_G25;
a_G22:if(__equal(a_L2,0)){ goto a_G25;}
if(__noteq(374062066,to_LIST(a_1015)->offset[a_L1-3])){ goto a_G25;}
a_P[0]=16778130;a_P[1]=a_L1;a_P[2]=a_L2;a_1336(a_1001,3,a_P+0);
a_G25:__next(a_1015,a_L1); goto a_G18;
a_G26:a_L1=to_LIST(a_1015)->alwb;
a_L2=0;
a_G28:if(__more(a_L1,to_LIST(a_1015)->aupb)){ goto a_G36;}
{register int a_r1=to_LIST(a_1015)->offset[a_L1-4];
 if(a_r1==344288190){ goto a_G30;}
 if(a_r1==344288202){ goto a_G31;}
 if(a_r1==344288266){  goto a_G32;}
  goto a_G35;}
a_G30:a_L2=0; goto a_G35;
a_G31:a_L2=to_LIST(a_1015)->offset[a_L1-3]; goto a_G35;
a_G32:if(__equal(a_L2,0)){ goto a_G35;}
if(__noteq(374062066,to_LIST(a_1015)->offset[a_L1-3])){ goto a_G35;}
a_P[0]=16778122;a_P[1]=a_L1;a_P[2]=a_L2;a_1336(a_1001,3,a_P+0);
a_G35:__next(a_1015,a_L1); goto a_G28;
a_G36:a_P[0]=16778115;a_1336(a_1001,1,a_P+0);return;
} /* targetmain */
static void a_1414(int a_F1){ /* ruletyper+>a */
int a_P[2];
if(!a_1060(a_F1,512)){ goto a_G3;}
a_P[0]=16778112;a_P[1]=a_F1;a_1336(a_1001,2,a_P+0);return;
a_G3:a_P[0]=16778106;a_P[1]=a_F1;a_1336(a_1001,2,a_P+0);return;
} /* ruletyper */
static void a_1360(int a_F1){ /* externalruletyper+>a */
int a_P[2];
if(!a_1060(a_F1,512)){ goto a_G3;}
a_P[0]=16778100;a_P[1]=to_LIST(a_1015)->offset[a_F1-3];a_1336(a_1001,2,a_P+0);return;
a_G3:a_P[0]=16778094;a_P[1]=to_LIST(a_1015)->offset[a_F1-3];a_1336(a_1001,2,a_P+0);return;
} /* externalruletyper */
static void a_1347(int a_A[1]){ /* argsep+>a> */

if(!__equal(a_A[0],0)){ goto a_G3;}
a_A[0]=1;return;
a_G3:a_1387(44);return;
} /* argsep */
static void a_1380(int a_F1,int a_A[1]){ /* outargs+>a+>a> */
int a_P[2];
if(__equal(a_F1,0)){return;}
a_P[0]=a_A[0];a_1347(a_P);a_A[0]=a_P[0];
a_P[0]=16778088;a_P[1]=a_F1;a_1336(a_1001,2,a_P+0);return;
} /* outargs */
...
__incr(a_L3);
if(__equal(a_L4,344288293)){ goto a_G8;}
if(!__equal(a_L4,344288299)){ goto a_G9;}
a_G8:__incr(a_L5); goto a_G3;
a_G9:if(!__equal(a_L4,344288305)){ goto a_G13;}
a_P[0]=a_L6;a_1380(a_L5,a_P);a_L6=a_P[0];
a_P[0]=a_L6;a_1347(a_P);
a_P[0]=16778083;a_1336(a_1001,1,a_P+0);return;
a_G13:a_P[0]=a_L6;a_1347(a_P);a_L6=a_P[0];
a_P[0]=16778076;a_P[1]=a_L3;a_1336(a_1001,2,a_P+0); goto a_G3;
a_G15:if(!__equal(a_L2,0)){ goto a_G17;}
a_P[0]=16778071;a_1336(a_1001,1,a_P+0); goto a_G18;
a_G17:a_P[0]=a_L6;a_1380(a_L5,a_P);
a_G18:a_1387(41);return;
} /* ruleargs */
...
static int a_1372(int a_F1){ /* ispidginalt+>a */
int a_L2;int a_P[1];
a_1115(to_LIST(a_1015)->offset[a_F1-3],a_P);a_L2=a_P[0];
if(!a_stringelem(a_1016,a_L2,0,a_P)){ return 0;}a_L2=a_P[0];
...
a_1180(a_F1,a_L3,a_P);a_L4=a_P[0];
__incr(a_L3);
{ if(a_L4==344288288){ goto a_G7;}
 if(a_L4==344288293){ goto a_G8;}
 if(a_L4==344288299){ goto a_G9;}
 if(a_L4==344288278){ goto a_G10;}
 if(a_L4==344288272){ goto a_G11;}
 if(a_L4==344288283){ goto a_G12;}
 if(!(a_L4==344288305)){a_area_failed(a_L4);}
  goto a_G13;}
a_G7:a_P[0]=16778067;a_1336(a_1001,1,a_P+0); goto a_G3;
a_G8:a_P[0]=16778064;a_1336(a_1001,1,a_P+0); goto a_G3;
a_G9:a_P[0]=16778061;a_1336(a_1001,1,a_P+0); goto a_G3;
a_G10:a_P[0]=16778057;a_1336(a_1001,1,a_P+0); goto a_G3;
a_G11:a_P[0]=16778053;a_1336(a_1001,1,a_P+0); goto a_G3;
a_G12:a_P[0]=16778049;a_1336(a_1001,1,a_P+0); goto a_G3;
a_G13:a_P[0]=16778045;a_1336(a_1001,1,a_P+0); goto a_G3;
} /* showformalsascomment */
static void a_1357(int a_F1,int a_F2,int a_F3){ /* declarelocals+>a+>a+>a */
int a_P[2];
...
a_G6:a_P[0]=16778042;a_P[1]=a_F1;a_1336(a_1001,2,a_P+0); goto a_G4;
} /* declarelocals */
static void a_1356(int a_F1,int a_F2,int a_F3,int a_F4){ /* declarecallargs+>a+>a+>a+>a */
int a_L5;int a_P[3];
if(__equal(a_F3,0)){ goto a_G3;}
a_P[0]=16778037;a_P[1]=a_F3;a_1336(a_1001,2,a_P+0);
a_G3:if(__equal(a_F4,0)){ goto a_G6;}
a_1182(a_F1,a_P);a_L5=a_P[0];
a_P[0]=16778031;a_P[1]=a_F4;a_P[2]=a_L5;a_1336(a_1001,3,a_P+0);
a_G6:a_1387(10);return;
} /* declarecallargs */
static void a_1345(void){ /* addrulenameasstatic */
int a_P[2];
if(!a_1060(a_1418,117440512)){return;}
a_P[0]=16778018;a_P[1]=a_1418;a_1336(a_1001,2,a_P+0);return;
} /* addrulenameasstatic */
static void a_1344(void){ /* addprofiling */
int a_P[1];
if(!a_1060(a_1418,33554432)){return;}
a_P[0]=16778007;a_1336(a_1001,1,a_P+0);return;
} /* addprofiling */
static void a_1346(void){ /* addtracing */
int a_L1;int a_L2;int a_P[2];
if(!a_1060(a_1418,16777216)){return;}
a_1181(a_1418,a_P);a_L1=a_P[0];
a_L2=0;
a_P[0]=16777984;a_P[1]=a_L1;a_1336(a_1001,2,a_P+0);
a_G5:if(!__less(a_L2,a_L1)){ goto a_G9;}
a_1387(44);
__incr(a_L2);
a_1366(a_L2); goto a_G5;
a_G9:a_P[0]=16777975;a_1336(a_1001,1,a_P+0);return;
} /* addtracing */
static void a_1313(int a_F1,int a_F2,int a_F3,int a_F4,int a_F5,int a_F6,int a_F7){ /* ruledeclarationhead+>a+>a+>a+>a+>a+>a+>a */
int a_P[2];
a_1418=a_F1;
a_1414(a_F1);
a_1412(a_F1);
a_P[0]=16777971;a_P[1]=to_LIST(a_1015)->offset[a_F1-3];a_1336(a_1001,2,a_P+0);
a_1415(a_F1);
a_P[0]=16777967;a_1336(a_1001,1,a_P+0);
__add(a_F5,a_F7,a_F7);
a_1357(a_F5,a_F6,a_F7);
a_1356(a_F1,a_F2,a_F3,a_F4);
a_1345();
a_1344();
a_1346();return;
} /* ruledeclarationhead */
static void a_1314(void){ /* ruledeclarationtail */
int a_P[2];
a_P[0]=16777963;a_P[1]=a_1418;a_1336(a_1001,2,a_P+0);return;
} /* ruledeclarationtail */
static int a_1359(int a_F1){ /* externalplaindeclaration+>a */
int a_P[2];
if(!a_1060(a_F1,16)){ return 0;}
a_P[0]=16777957;a_P[1]=to_LIST(a_1015)->offset[a_F1-3];a_1336(a_1001,2,a_P+0); return 1;
} /* externalplaindeclaration */
static void a_1420(int a_F1){ /* vardeclaration+>a */
int a_P[4];
if(a_1359(a_F1)){return;}
a_P[0]=16777950;a_P[1]=a_F1;a_P[2]=to_LIST(a_1015)->offset[a_F1-1];a_P[3]=to_LIST(a_1015)->offset[a_F1-3];a_1336(a_1001,4,a_P+0);return;
} /* vardeclaration */
static void a_1349(int a_F1,int a_F2,int a_F3){ /* blockdeclaration+>a+>a+>a */
int a_P[3];
a_P[0]=16777940;a_P[1]=a_F1;a_1336(a_1001,2,a_P+0);
if(!__equal(a_F2,0)){ goto a_G4;}
a_P[0]=16777934;a_1336(a_1001,1,a_P+0); goto a_G5;
a_G4:a_P[0]=16777931;a_P[1]=a_F2;a_P[2]=a_F3;a_1336(a_1001,3,a_P+0);
a_G5:a_P[0]=16777927;a_P[1]=to_LIST(a_1015)->offset[a_F1-3];a_1336(a_1001,2,a_P+0);
if(!a_1060(a_F1,16)){return;}
a_P[0]=16777921;a_P[1]=to_LIST(a_1015)->offset[a_F1-3];a_1336(a_1001,2,a_P+0);return;
} /* blockdeclaration */
...
a_1360(a_F1);
a_1412(a_F1);
a_P[0]=16777912;a_1336(a_1001,1,a_P+0);return;
a_G7:a_1414(a_F1);
a_1412(a_F1);
a_P[0]=16777909;a_P[1]=to_LIST(a_1015)->offset[a_F1-3];a_1336(a_1001,2,a_P+0);return;
} /* ruleprototype */
static void a_1247(void){ /* datadeclaration */
...
a_G7:{register int a_r1=to_LIST(a_1015)->offset[a_L1-4];
 if(a_r1==344288221){ goto a_G8;}
 if(a_r1==344288226||a_r1==344288231){ goto a_G9;}
 if(a_r1==344288239||a_r1==344288235||a_r1==344288245){ goto a_G10;}
 if(a_r1==344288257){ goto a_G13;}
 if(a_r1==344288262){ goto a_G16;}
 if(a_r1==344288266){  goto a_G19;}
  goto a_G6;}
a_G8:if(a_1359(a_L1)){ goto a_G6;} goto a_G6;
a_G9:a_1420(a_L1); goto a_G6;
a_G10:a_1349(a_L1,a_L3,a_L4);
a_L3=a_L1;
a_L4=1922290934; goto a_G6;
a_G13:a_1349(a_L1,a_L3,a_L4);
a_L3=a_L1;
a_L4=1922290940; goto a_G6;
a_G16:a_1349(a_L1,a_L3,a_L4);
a_L3=a_L1;
a_L4=1922290946; goto a_G6;
a_G19:a_1413(a_L1); goto a_G6;
a_G21:if(!__equal(a_L3,0)){ goto a_G23;}
a_P[0]=16777903;a_P[1]=1922290951;a_1336(a_1001,2,a_P+0); goto a_G24;
a_G23:a_P[0]=16777897;a_P[1]=1922290951;a_P[2]=a_L3;a_P[3]=a_L4;a_1336(a_1001,4,a_P+0);
a_G24:a_P[0]=16777889;a_P[1]=1922290951;a_1336(a_1001,2,a_P+0);return;
} /* datadeclaration */
...
static void a_1252(void){ /* filltablehead */
int a_P[1];
a_P[0]=16777881;a_1336(a_1001,1,a_P+0);
a_1364=0;return;
} /* filltablehead */
static void a_1253(void){ /* filltabletail */
int a_P[2];
a_P[0]=16777868;a_P[1]=a_1364;a_1336(a_1001,2,a_P+0);return;
} /* filltabletail */
static void a_1353(int a_A[1]){ /* constitem+a> */
int a_P[1];
if(!__equal(344288369,a_1058)){ goto a_G4;}
a_A[0]=a_1059;
a_1078();return;
a_G4:if(!__equal(344288381,a_1058)){ goto a_G7;}
a_A[0]=a_1059;
a_1078(); goto a_G8;
a_G7:a_1030(a_1001,16777415,26);return;
a_G8:if(a_1053(a_A[0],a_P)){a_A[0]=a_P[0];}
{register int a_r1=to_LIST(a_1015)->offset[a_A[0]-4];
 if(!(a_r1==344288221||a_r1==344288252)){ goto a_G11;}
}
a_A[0]=to_LIST(a_1015)->offset[a_A[0]];return;
a_G11:a_1116(a_1001,16777858,407);return;
} /* constitem */
static void a_1362(int a_A[1]){ /* fillitem+a> */
int a_L2;int a_P[1];
if(!__equal(344288341,a_1058)){ goto a_G9;}
a_1078();
a_A[0]=0;
a_G4:if(!__equal(344288320,a_1058)){ goto a_G6;}
a_1078();return;
a_G6:__incr(a_A[0]);
a_1353(a_P);a_L2=a_P[0];
a_1401(a_L2); goto a_G4;
a_G9:a_A[0]=1;
a_1353(a_P);a_L2=a_P[0];
a_1401(a_L2);return;
} /* fillitem */
static int a_1363(int a_A[1]){ /* fillrepeater+a> */
int a_P[1];
if(!__equal(344288359,a_1058)){ return 0;}
a_1078();
a_1353(a_P);a_A[0]=a_P[0]; return 1;
} /* fillrepeater */
static void a_1365(int a_F1,int a_F2,int a_F3){ /* flushbuffer+>a+>a+>a */
int a_P[2];
__add(a_F1,a_1364,a_1364);
__add(a_F2,a_1364,a_1364);
__incr(a_F3);
if(__equal(a_F1,0)){ goto a_G7;}
a_P[0]=16777854;a_P[1]=a_F1;a_1336(a_1001,2,a_P+0);
__incr(a_1364);
a_G7:if(__equal(a_F1,0)){ goto a_G11;}
a_P[0]=16777851;a_P[1]=to_LIST(a_1010)->offset[a_F3];a_1336(a_1001,2,a_P+0);
__incr(a_F3);
__decr(a_F1); goto a_G7;
a_G11:if(__equal(a_F2,0)){ goto a_G14;}
a_P[0]=16777848;a_P[1]=a_F2;a_1336(a_1001,2,a_P+0);
__incr(a_1364);
a_G14:if(__equal(a_F2,0)){return;}
a_P[0]=16777845;a_P[1]=to_LIST(a_1010)->offset[a_F3];a_1336(a_1001,2,a_P+0);
__incr(a_F3);
...
a_1078(); goto a_G1;
a_G6:a_1030(a_1001,16777415,26);return;
} /* skipfillinitializer */
static void a_1361(void){ /* fillentries */
...
a_L1=a_1059;
a_1078(); goto a_G5;
a_G4:a_1030(a_1001,16777415,26);return;
a_G5:if(!__equal(344288369,a_1058)){ goto a_G4;}

a_1078();
__incr(a_1364);
a_P[0]=16777842;a_P[1]=a_L1;a_P[2]=to_LIST(a_1015)->offset[a_L1-3];a_1336(a_1001,3,a_P+0);
a_L2=to_LIST(a_1010)->aupb;
a_L3=0;
a_G13:if(!__equal(344288353,a_1058)){ goto a_G15;}
a_1078(); goto a_G24;
a_G15:a_1362(a_P);a_L4=a_P[0];
if(!a_1363(a_P)){ goto a_G22;}a_L5=a_P[0];
a_1365(a_L3,a_L4,a_L2);
a_P[0]=16777836;a_P[1]=a_L5;a_1336(a_1001,2,a_P+0);
__incr(a_1364);
__unstackto(a_1010,a_L2);
a_L3=0; goto a_G23;
a_G22:__add(a_L3,a_L4,a_L3);
a_G23:a_1417(); goto a_G13;
a_G24:a_1365(a_L3,0,a_L2);
__unstackto(a_1010,a_L2);
__incr(a_1364);
a_P[0]=16777832;a_1336(a_1001,1,a_P+0);return;
} /* fillentries */
static void a_1416(void){ /* skipentry */
...
a_G4:if(__equal(344288183,a_1058)){ goto a_G2;}
if(__equal(344288175,a_1058)){ goto a_G2;}
if(__equal(344288179,a_1058)){ goto a_G2;}
a_G13:if(!__equal(344288198,a_1058)){ goto a_G16;}
a_1078();
a_1303(); goto a_G13;
a_G16:if(!__equal(344288396,a_1058)){ goto a_G18;}
a_1078();return;
a_G18:a_1030(a_1001,16777828,452);return;
} /* datasectioniv */
...
static void a_1375(int a_F1){ /* jumptolabel+>a */
int a_P[2];
if(__equal(a_F1,a_1379)){return;}
a_P[0]=16777824;a_P[1]=a_F1;a_1336(a_1001,2,a_P+0);return;
} /* jumptolabel */
static void a_1342(int a_F1,int a_A[1]){ /* Tlimittail+>a+a> */

{ if(a_F1==344288161){ goto a_G2;}
 if(a_F1==344288186){ goto a_G3;}
 if(a_F1==344288208){ goto a_G4;}
 if(a_F1==344288212){ goto a_G5;}
 if(a_F1==344288216){  goto a_G6;}
  goto a_G7;}
a_G2:a_A[0]=1922290955;return;
a_G3:a_A[0]=1922290959;return;
a_G4:a_A[0]=1922290963;return;
a_G5:a_A[0]=1922290967;return;
a_G6:a_A[0]=1922290971;return;
a_G7:a_1030(a_1001,16777820,484);return;
} /* Tlimittail */
static void a_1338(int a_F1){ /* Taffix+>a */
int a_P[1];
{register int a_r1=to_LIST(a_1010)->offset[a_F1];
 if(a_r1==344288323){ goto a_G2;}
 if(a_r1==344288338){ return;}
  goto a_G3;}
a_G2:__incr(a_F1);
...
{register int a_r1=to_LIST(a_1010)->offset[a_A[0]];
 if(a_r1==344288385||a_r1==344288389||a_r1==344288381||a_r1==344288369){ goto a_G2;}
 if(a_r1==344288362){  goto a_G5;}
  goto a_G16;}
a_G2:a_P[0]=16777816;a_P[1]=a_A[0];a_1336(a_1001,2,a_P+0);
a_G3:__incr(a_A[0]);
__incr(a_A[0]);return;
a_G5:__incr(a_A[0]);
a_P[0]=16777813;a_P[1]=a_A[0];a_1336(a_1001,2,a_P+0);
__incr(a_A[0]);
__incr(a_A[0]);
...
a_P[0]=16777805;a_1336(a_1001,1,a_P+0);return;
a_G15:a_P[0]=16777802;a_P[1]=a_L2;a_1336(a_1001,2,a_P+0);return;
a_G16:a_1342(to_LIST(a_1010)->offset[a_A[0]],a_P);a_L2=a_P[0];
__incr(a_A[0]);
a_P[0]=16777798;a_P[1]=a_A[0];a_P[2]=a_L2;a_1336(a_1001,3,a_P+0); goto a_G3;
} /* Taffixinner */
static void a_1369(int a_F1,int a_F2){ /* genshiftaffix+>a+>a */
int a_L3;int a_P[4];
a_1182(a_1418,a_P);a_L3=a_P[0];
if(__equal(a_F1,a_1379)){ goto a_G6;}
if(!__equal(a_F1,a_F2)){ goto a_G5;}
a_F2=a_1379; goto a_G6;
a_G5:if(!__noteq(a_F2,a_1379)){ goto a_G7;}
a_G6:a_P[0]=16777792;a_P[1]=a_L3;a_P[2]=a_F2;a_P[3]=a_F1;a_1336(a_1001,4,a_P+0);return;
a_G7:a_P[0]=16777781;a_P[1]=a_F1;a_P[2]=a_L3;a_1336(a_1001,3,a_P+0);return;
} /* genshiftaffix */
static void a_1368(int a_F1,int a_F2,int a_F3){ /* gengetaffixno+>a+>a+>a */
int a_P[2];
if(!__noteq(a_F1,2)){ goto a_G3;}
a_1030(a_1001,16777771,514);return;
a_G3:if(__equal(to_LIST(a_1010)->offset[a_F2],344288338)){return;}
if(__equal(to_LIST(a_1010)->offset[a_F2],344288323)){return;}
a_1338(a_F2);
a_P[0]=16777767;a_P[1]=a_F3;a_1336(a_1001,2,a_P+0);return;
} /* gengetaffixno */
static void a_1378(int a_A[1]){ /* nextaffix+>a> */

a_G1:if(!__equal(to_LIST(a_1010)->offset[a_A[0]],344288350)){ goto a_G3;}
__incr(a_A[0]);return;
a_G3:__incr(a_A[0]); goto a_G1;
} /* nextaffix */
static void a_1348(int a_F1,int a_F2,int a_A[2]){ /* assignmentsource+>a+>a+a>+a> */
int a_P[2];
{register int a_r1=to_LIST(a_1010)->offset[a_F1];
 if(!(a_r1==344288381||a_r1==344288389||a_r1==344288385||a_r1==344288369)){ goto a_G7;}
}
a_A[0]=a_F1;
if(!__is(a_F2)){ goto a_G6;}
a_P[0]=16777762;a_P[1]=1922290979;a_1336(a_1001,2,a_P+0);
a_G5:a_A[1]=1;return;
a_G6:a_A[1]=0;return;
a_G7:a_A[0]=1922290975;
a_P[0]=16777755;a_P[1]=a_A[0];a_1336(a_1001,2,a_P+0);
a_1338(a_F1);
if(!__is(a_F2)){ goto a_G12;}
a_P[0]=16777748;a_P[1]=1922290979;a_1336(a_1001,2,a_P+0);
a_G12:a_1387(59); goto a_G5;
} /* assignmentsource */
static void a_1367(int a_F1,int a_F2,int a_F3,int a_F4){ /* genassignment+>a+>a+>a+>a */
int a_L5;int a_L6;int a_L7;int a_L8;int a_L9;int a_P[6];
a_L5=a_F3;
a_P[0]=a_F3;a_1378(a_P);a_F3=a_P[0];
a_L8=0;
a_L9=1;
...
{register int a_r1=to_LIST(a_1010)->offset[a_F3];
 if(a_r1==344288359||a_r1==344288338||a_r1==344288323){  goto a_G5;}
}
__incr(a_L8); goto a_G5;
a_G10:if(__more(a_L8,1)){ goto a_G12;}
if(!__is(a_F2)){ goto a_G13;}
a_G12:a_1348(a_L5,a_F2,a_P);a_L6=a_P[0];a_L7=a_P[1]; goto a_G14;
a_G13:a_L6=0;a_L7=0;
a_G14:a_F3=a_L5;
a_P[0]=a_F3;a_1378(a_P);a_F3=a_P[0];
a_L9=1;
...
a_P[0]=a_F3;a_1378(a_P);a_F3=a_P[0];
{register int a_r1=to_LIST(a_1010)->offset[a_F3];
 if(a_r1==344288359||a_r1==344288338||a_r1==344288323){  goto a_G17;}
}
a_1338(a_F3);
if(!__equal(a_L6,0)){ goto a_G26;}
a_1387(61);
a_1338(a_L5);
a_1387(59); goto a_G17;
a_G26:a_P[0]=16777745;a_P[1]=a_L6;a_1336(a_1001,2,a_P+0); goto a_G17;
a_G27:if(__equal(a_F2,0)){ goto a_G29;}
a_P[0]=16777741;a_P[1]=1922290979;a_P[2]=1922290979;a_P[3]=1922290979;a_P[4]=1922290979;a_P[5]=a_L6;a_1336(a_1001,6,a_P+0);
a_G29:if(__equal(a_L7,0)){ goto a_G31;}
a_1387(125);
a_G31:a_P[0]=16777730;a_P[1]=a_F4;a_1336(a_1001,2,a_P+0);return;
} /* genassignment */
...
a_P[0]=a_F1;a_1378(a_P);a_F1=a_P[0];
a_L6=a_F3;
...
a_1180(a_1351,a_L6,a_P);a_L8=a_P[0];
if(__equal(a_L8,344288293)){ goto a_G19;}
if(!__more(a_L5,0)){ goto a_G16;}
a_P[0]=16777726;a_P[1]=a_F4;a_1336(a_1001,2,a_P+0);
a_G14:a_1338(a_F1);
a_1387(59); goto a_G19;
a_G16:a_P[0]=16777721;a_P[1]=a_F4;a_1336(a_1001,2,a_P+0); goto a_G14;
a_G19:if(!__equal(a_L6,a_F2)){ goto a_G21;}
a_L6=a_F3; goto a_G22;
a_G21:__incr(a_L6);
a_G22:__decr(a_L7);
__incr(a_F4);
a_P[0]=a_F1;a_1378(a_P);a_F1=a_P[0]; goto a_G9;
a_G25:if(__mreq(a_L5,0)){return;}
a_1182(a_1351,a_P);a_L6=a_P[0];
a_P[0]=16777716;a_P[1]=a_F4;a_P[2]=a_L6;a_1336(a_1001,3,a_P+0);return;
} /* repeatblockpreload */
static void a_1407(int a_F1){ /* regularcallpreload+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_P[2];
a_1181(a_1351,a_P);a_L2=a_P[0];
a_L3=0;a_L4=0;
a_G3:if(__equal(a_L3,a_L2)){return;}
a_1180(a_1351,a_L3,a_P);a_L5=a_P[0];
__incr(a_L3);
if(!__equal(a_L5,344288293)){ goto a_G9;}
__incr(a_L4);
a_G8:a_P[0]=a_F1;a_1378(a_P);a_F1=a_P[0]; goto a_G3;
a_G9:if(!__equal(a_L5,344288299)){ goto a_G15;}
a_P[0]=16777704;a_P[1]=a_L4;a_1336(a_1001,2,a_P+0);
__incr(a_L4);
a_1338(a_F1);
a_1387(59); goto a_G8;
a_G15:if(!__equal(a_L5,344288305)){ goto a_G8;}
...
if(__equal(a_F2,0)){ goto a_G4;}
a_P[0]=a_F3;a_1347(a_P);a_F3=a_P[0];
a_P[0]=16777699;a_1336(a_1001,1,a_P+0);
a_G4:a_1182(a_1351,a_P);a_L5=a_P[0];
__incr(a_F1);
a_L4=to_LIST(a_1010)->offset[a_F1];
if(!__equal(a_L4,0)){ goto a_G10;}
a_P[0]=a_F3;a_1347(a_P);
a_P[0]=16777696;a_1336(a_1001,1,a_P+0);return;
a_G10:if(!__less(a_L4,0)){ goto a_G15;}
a_P[0]=a_F3;a_1347(a_P);
__subtr(0,a_L4,a_L4);
__div(a_L4,a_L5,a_L4);
a_P[0]=16777691;a_P[1]=a_L4;a_1336(a_1001,2,a_P+0);return;
a_G15:a_P[0]=a_F3;a_1347(a_P);
__div(a_L4,a_L5,a_L4);
a_P[0]=16777686;a_P[1]=a_L4;a_P[2]=a_F2;a_1336(a_1001,3,a_P+0);return;
} /* repeatblockcall */
static void a_1408(int a_F1){ /* regularrulecall+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_L6;int a_P[2];
a_1181(a_1351,a_P);a_L2=a_P[0];
a_P[0]=16777681;a_P[1]=a_1351;a_1336(a_1001,2,a_P+0);
a_L3=0;a_L4=0;a_L5=0;
a_G4:if(!__equal(a_L3,a_L2)){ goto a_G9;}
if(!__equal(a_L4,0)){ goto a_G7;}
a_1387(41);return;
a_G7:a_P[0]=a_L5;a_1347(a_P);
a_P[0]=16777678;a_1336(a_1001,1,a_P+0);return;
a_G9:a_1180(a_1351,a_L3,a_P);a_L6=a_P[0];
__incr(a_L3);
if(__equal(a_L6,344288293)){ goto a_G13;}
if(!__equal(a_L6,344288299)){ goto a_G15;}
a_G13:__incr(a_L4);
a_G14:a_P[0]=a_F1;a_1378(a_P);a_F1=a_P[0]; goto a_G4;
a_G15:if(!__equal(a_L6,344288305)){ goto a_G17;}
a_1409(a_F1,a_L4,a_L5);return;
a_G17:a_P[0]=a_L5;a_1347(a_P);a_L5=a_P[0];
a_1338(a_F1); goto a_G14;
} /* regularrulecall */
static int a_1371(int a_F1){ /* isdummyaffix+>a */

{register int a_r1=to_LIST(a_1010)->offset[a_F1];
 if(a_r1==344288338||a_r1==344288323){  return 1;}
  return 0;}
} /* isdummyaffix */
...
a_1180(a_1351,a_L6,a_P);a_L8=a_P[0];
if(a_1371(a_F1)){ goto a_G18;}
if(__equal(a_L8,344288293)){ goto a_G14;}
if(!__equal(a_L8,344288299)){ goto a_G18;}
a_G14:a_1338(a_F1);
if(!__more(a_L5,0)){ goto a_G17;}
a_P[0]=16777674;a_P[1]=a_F4;a_1336(a_1001,2,a_P+0); goto a_G18;
a_G17:a_P[0]=16777669;a_P[1]=a_F4;a_1336(a_1001,2,a_P+0);
...
a_1182(a_1351,a_P);a_L6=a_P[0];
a_P[0]=16777664;a_P[1]=a_F4;a_P[2]=a_L6;a_1336(a_1001,3,a_P+0);return;
} /* repeatblockpostload */
...
a_1180(a_1351,a_L3,a_P);a_L5=a_P[0];
__incr(a_L3);
if(__equal(a_L5,344288293)){ goto a_G8;}
if(!__equal(a_L5,344288299)){ goto a_G13;}
a_G8:if(a_1371(a_F1)){ goto a_G11;}
a_1338(a_F1);
a_P[0]=16777652;a_P[1]=a_L4;a_1336(a_1001,2,a_P+0);
a_G11:__incr(a_L4);
a_G12:a_P[0]=a_F1;a_1378(a_P);a_F1=a_P[0]; goto a_G3;
a_G13:if(!__equal(a_L5,344288305)){ goto a_G12;}
a_1410(a_F1,a_L2,a_L3,a_L4);return;
} /* regularcallpostload */
static void a_1403(int a_F1,int a_F2,int a_A[1]){ /* regularcalld1+>a+>a+a> */
int a_P[1];
if(!a_1060(a_1351,512)){ goto a_G9;}
if(!__noteq(a_F1,a_1379)){ goto a_G7;}
if(__equal(a_F2,a_1379)){ goto a_G5;}
if(!__lseq(a_F1,0)){ goto a_G7;}
a_G5:a_A[0]=2;
a_P[0]=16777647;a_1336(a_1001,1,a_P+0);return;
a_G7:a_A[0]=1;
a_P[0]=16777643;a_1336(a_1001,1,a_P+0);return;
a_G9:a_A[0]=0;return;
} /* regularcalld1 */
static void a_1404(int a_F1,int a_F2){ /* regularcalld2+>a+>a */
int a_P[2];
if(!__equal(a_F1,1)){ goto a_G3;}
a_P[0]=16777640;a_1336(a_1001,1,a_P+0);return;
a_G3:if(!__equal(a_F1,2)){ goto a_G5;}
a_P[0]=16777637;a_P[1]=a_F2;a_1336(a_1001,2,a_P+0);return;
a_G5:a_1387(59);return;
} /* regularcalld2 */
static void a_1405(int a_F1,int a_F2,int a_F3){ /* regularcalld3+>a+>a+>a */
int a_P[3];
if(!__equal(a_F1,1)){ goto a_G3;}
a_P[0]=16777633;a_P[1]=a_F3;a_P[2]=a_F2;a_1336(a_1001,3,a_P+0);return;
a_G3:if(!__equal(a_F1,2)){ goto a_G5;}
a_P[0]=16777629;a_P[1]=a_F3;a_1336(a_1001,2,a_P+0);return;
a_G5:a_P[0]=16777625;a_P[1]=a_F3;a_1336(a_1001,2,a_P+0);return;
} /* regularcalld3 */
static int a_1373(int a_F1){ /* ispidgindiscarded+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
if(a_1060(a_1351,1792)){ return 0;}
a_1181(a_1351,a_P);a_L2=a_P[0];
a_L3=0;
a_G4:if(__equal(a_L3,a_L2)){ return 1;}
a_1180(a_1351,a_L3,a_P);a_L4=a_P[0];
__incr(a_L3);
if(!a_1371(a_F1)){ goto a_G9;}
a_G8:a_P[0]=a_F1;a_1378(a_P);a_F1=a_P[0]; goto a_G4;
a_G9:if(__equal(a_L4,344288293)){ return 0;}
if(__equal(a_L4,344288299)){ return 0;}
if(__equal(a_L4,344288305)){ return 0;} goto a_G8;
} /* ispidgindiscarded */
static void a_1381(int a_F1){ /* pidginalttagtail+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_1181(a_1351,a_P);a_L2=a_P[0];
a_L3=0;
a_G3:if(__equal(a_L3,a_L2)){return;}
a_1180(a_1351,a_L3,a_P);a_L4=a_P[0];
__incr(a_L3);
if(!__equal(a_L4,344288293)){ goto a_G10;}
if(!__equal(to_LIST(a_1010)->offset[a_F1],344288338)){ goto a_G9;}
a_1387(48); goto a_G10;
a_G9:a_1387(49);
a_G10:if(__equal(a_L4,344288305)){return;}
a_P[0]=a_F1;a_1378(a_P);a_F1=a_P[0]; goto a_G3;
} /* pidginalttagtail */
static void a_1382(int a_F1){ /* pidginrepeatblock+>a */
int a_L2;int a_L3;int a_P[1];
__incr(a_F1);
...
a_1338(a_F1);
__decr(a_L3);
a_P[0]=a_F1;a_1378(a_P);a_F1=a_P[0]; goto a_G8;
a_G13:if(__more(a_L2,0)){return;}
a_P[0]=16777621;a_1336(a_1001,1,a_P+0);return;
} /* pidginrepeatblock */
static void a_1383(int a_F1,int a_F2){ /* pidginruleargs+>a+>a */
int a_L3;int a_L4;int a_L5;int a_L6;int a_P[1];
a_1181(a_1351,a_P);a_L3=a_P[0];
a_L4=0;a_L5=0;
a_G3:if(__equal(a_L4,a_L3)){return;}
a_1180(a_1351,a_L4,a_P);a_L6=a_P[0];
__incr(a_L4);
if(!__equal(a_L6,344288305)){ goto a_G9;}
a_P[0]=a_L5;a_1347(a_P);
a_1382(a_F1);return;
a_G9:if(!__equal(a_L6,344288293)){ goto a_G12;}
if(!__is(a_F2)){ goto a_G12;}
if(__equal(to_LIST(a_1010)->offset[a_F1],344288338)){ goto a_G14;}
a_G12:a_P[0]=a_L5;a_1347(a_P);a_L5=a_P[0];
a_1338(a_F1);
a_G14:a_P[0]=a_F1;a_1378(a_P);a_F1=a_P[0]; goto a_G3;
} /* pidginruleargs */
static void a_1384(int a_F1){ /* pidginrulecall+>a */
int a_L2;int a_P[2];
a_P[0]=16777616;a_P[1]=a_1351;a_1336(a_1001,2,a_P+0);
if(!a_1372(a_1351)){ goto a_G5;}
a_L2=1;
a_1381(a_F1); goto a_G6;
a_G5:a_L2=0;
a_G6:a_1387(40);
a_1383(a_F1,a_L2);
a_1387(41);return;
...
a_1369(a_F3,a_F4);return;
a_G6:if(!__equal(a_L8,3)){ goto a_G8;}
a_1368(a_F2,a_F7,a_F4);return;
a_G8:a_1367(a_F5,a_F6,a_F7,a_F4);return;
a_G9:if(!a_1301(a_F1)){ goto a_G15;}
if(a_1373(a_F7)){return;}
a_1403(a_F3,a_F4,a_P);a_L9=a_P[0];
a_1384(a_F7);
a_1404(a_L9,a_F3);
a_G14:a_1405(a_L9,a_F3,a_F4);return;
a_G15:a_1407(a_F7);
a_1403(a_F3,a_F4,a_P);a_L9=a_P[0];
a_1408(a_F7);
a_1404(a_L9,a_F3);
a_1406(a_F7); goto a_G14;
} /* Trulecall */
static void a_1358(int a_F1,int a_F2,int a_F3){ /* extensionblock+>a+>a+>a */
int a_L4;int a_L5;int a_P[3];
__incr(a_F3);
a_L4=a_F3;
a_G3:if(__equal(to_LIST(a_1010)->offset[a_L4],344288350)){ goto a_G5;}
...
__incr(a_L5);
__incr(a_L4);
a_P[0]=16777613;a_P[1]=a_F2;a_P[2]=a_L5;a_1336(a_1001,3,a_P+0); goto a_G6;
a_G11:a_1338(a_F3);
a_1387(59);return;
} /* extensionblock */
...
__incr(a_F1);
a_L3=a_F1;
a_P[0]=16777605;a_P[1]=a_L3;a_P[2]=a_L4;a_1336(a_1001,3,a_P+0);
__add(2,a_F1,a_F1);
a_G7:a_1358(a_L4,a_L3,a_F1);
a_F1=to_LIST(a_1010)->offset[a_F1];
if(!__equal(a_F1,0)){ goto a_G7;}
a_P[0]=16777597;a_P[1]=a_L3;a_P[2]=a_L4;a_1336(a_1001,3,a_P+0);
a_1375(a_F2);return;
} /* Textension */
static void a_1350(int a_F1,int a_A[1]){ /* boxclassifier+>a+a> */
int a_P[2];
{register int a_r1=to_LIST(a_1010)->offset[a_F1];
 if(!(a_r1==344288381||a_r1==344288389||a_r1==344288385||a_r1==344288369)){ goto a_G3;}
}
a_A[0]=a_F1;return;
a_G3:a_A[0]=1922290975;
a_P[0]=16777588;a_P[1]=a_A[0];a_1336(a_1001,2,a_P+0);
a_1338(a_F1);
a_P[0]=16777581;a_1336(a_1001,1,a_P+0);return;
} /* boxclassifier */
static int a_1370(int a_F1){ /* iscompletearea+>a */
...
static void a_1343(int a_F1,int a_F2,int a_F3){ /* Tsingleifcondition+>a+>a+>a */
int a_P[5];
if(!__equal(a_F1,a_F2)){ goto a_G3;}
a_P[0]=16777578;a_P[1]=a_F3;a_P[2]=a_F1;a_1336(a_1001,3,a_P+0);return;
a_G3:if(!__equal(a_F1,(-2147483647-1))){ goto a_G5;}
a_P[0]=16777574;a_P[1]=a_F3;a_P[2]=a_F2;a_1336(a_1001,3,a_P+0);return;
a_G5:if(!__equal(a_F2,2147483647)){ goto a_G7;}
a_P[0]=16777570;a_P[1]=a_F3;a_P[2]=a_F1;a_1336(a_1001,3,a_P+0);return;
a_G7:a_P[0]=16777566;a_P[1]=a_F1;a_P[2]=a_F3;a_P[3]=a_F3;a_P[4]=a_F2;a_1336(a_1001,5,a_P+0);return;
} /* Tsingleifcondition */
...
__incr(a_F1);
a_L4=to_LIST(a_1010)->offset[a_F1];
a_1343(a_L3,a_L4,a_F2);
__incr(a_F1);
if(!__equal(to_LIST(a_1010)->offset[a_F1],344288356)){return;}
a_P[0]=16777559;a_1336(a_1001,1,a_P+0); goto a_G1;
} /* Tifcondition */
static void a_1341(int a_F1,int a_F2){ /* Tjumptoareas+>a+>a */
int a_L3;int a_L4;int a_L5;int a_P[2];
a_G1:a_L5=to_LIST(a_1010)->offset[a_F1];
if(!__equal(a_L5,0)){ goto a_G10;}
__incr(a_F1);
a_L3=to_LIST(a_1010)->offset[a_F1];
a_P[0]=16777556;a_1336(a_1001,1,a_P+0);
a_1340(a_F1,a_F2);
a_P[0]=16777552;a_P[1]=a_F2;a_1336(a_1001,2,a_P+0);
if(__equal(a_L3,a_1379)){return;}
a_P[0]=16777543;a_P[1]=to_LIST(a_1010)->offset[a_F1];a_1336(a_1001,2,a_P+0);return;
a_G10:if(!a_1370(a_L5)){ goto a_G25;}
__incr(a_F1);
a_L3=to_LIST(a_1010)->offset[a_F1];
__incr(a_L5);
a_L4=to_LIST(a_1010)->offset[a_L5];
if(!__equal(a_L3,a_1379)){ goto a_G20;}
if(__equal(a_L3,a_L4)){return;}
a_P[0]=16777540;a_1336(a_1001,1,a_P+0);
a_1340(a_F1,a_F2);
a_P[0]=16777536;a_P[1]=a_L4;a_1336(a_1001,2,a_P+0);return;
a_G20:a_P[0]=16777531;a_1336(a_1001,1,a_P+0);
a_1340(a_F1,a_F2);
a_P[0]=16777527;a_P[1]=a_L3;a_1336(a_1001,2,a_P+0);
if(__equal(a_L4,a_1379)){return;}
a_P[0]=16777522;a_P[1]=a_L4;a_1336(a_1001,2,a_P+0);return;
a_G25:__incr(a_F1);
a_P[0]=16777519;a_1336(a_1001,1,a_P+0);
a_1340(a_F1,a_F2);
a_P[0]=16777515;a_P[1]=to_LIST(a_1010)->offset[a_F1];a_1336(a_1001,2,a_P+0);
a_F1=a_L5; goto a_G1;
} /* Tjumptoareas */
static void a_1266(int a_F1,int a_F2){ /* Tbox+>a+>a */
int a_L3;int a_P[1];
a_P[0]=16777511;a_1336(a_1001,1,a_P+0);
__incr(a_F1);
a_1350(a_F1,a_P);a_L3=a_P[0];
__incr(a_F2);
a_1341(a_F2,a_L3);
a_P[0]=16777508;a_1336(a_1001,1,a_P+0);return;
} /* Tbox */
static void a_1376(int a_F1,int a_F2){ /* listinitialization+>a+>a */
int a_L3;int a_L4;int a_L5;int a_L6;int a_P[8];
if(!a_1060(a_F2,16)){ goto a_G4;}
a_1048(a_F2,a_P);a_L3=a_P[0];
a_P[0]=16777505;a_P[1]=to_LIST(a_1015)->offset[a_F2-3];a_P[2]=a_F2;a_P[3]=a_L3;a_1336(a_1001,4,a_P+0);return;
a_G4:a_1048(a_F2,a_P);a_L3=a_P[0];
a_1056(a_F2,a_P);a_L5=a_P[0];
a_1055(a_F2,a_P);a_L4=a_P[0];
a_1052(a_F2,a_P);a_L6=a_P[0];
a_P[0]=16777499;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_L3;a_P[4]=a_L4;a_P[5]=a_L5;a_P[6]=a_L6;a_P[7]=to_LIST(a_1015)->offset[a_F2-3];a_1336(a_1001,8,a_P+0);return;
} /* listinitialization */
static void a_1352(int a_F1){ /* charfileinitialization+>a */
int a_L2;int a_L3;int a_L4;int a_P[6];
if(!a_1060(a_F1,16)){ goto a_G3;}
a_P[0]=16777485;a_P[1]=to_LIST(a_1015)->offset[a_F1-3];a_P[2]=a_F1;a_1336(a_1001,3,a_P+0);return;
...
a_P[0]=16777480;a_P[1]=a_F1;a_P[2]=a_L2;a_P[3]=a_L3;a_P[4]=a_L4;a_P[5]=to_LIST(a_1015)->offset[a_F1-3];a_1336(a_1001,6,a_P+0);return;
} /* charfileinitialization */
static void a_1354(int a_F1,int a_A[1]){ /* countfilearea+>a+a> */
int a_P[3];
a_A[0]=0;
...
static void a_1355(int a_F1){ /* datafileinitialization+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_L6;int a_P[7];
if(!a_1060(a_F1,16)){ goto a_G3;}
a_P[0]=16777467;a_P[1]=to_LIST(a_1015)->offset[a_F1-3];a_P[2]=a_F1;a_1336(a_1001,3,a_P+0);return;
a_G3:if(!a_1060(a_F1,64)){ goto a_G5;}
a_L2=2; goto a_G6;
a_G5:a_L2=0;
a_G6:if(!a_1060(a_F1,32)){ goto a_G8;}
...
a_1354(a_L5,a_P);a_L6=a_P[0];
a_P[0]=16777462;a_P[1]=a_F1;a_P[2]=a_L2;a_P[3]=a_L3;a_P[4]=a_L4;a_P[5]=a_L6;a_P[6]=to_LIST(a_1015)->offset[a_F1-3];a_1336(a_1001,7,a_P+0);
a_G11:if(__equal(a_L5,0)){return;}
a_P[0]=a_L5;a_1179(a_P);a_L5=a_P[0];a_L6=a_P[1];a_L3=a_P[2];
a_P[0]=16777449;a_P[1]=a_F1;a_P[2]=a_L3;a_P[3]=a_L6;a_1336(a_1001,4,a_P+0); goto a_G11;
} /* datafileinitialization */
static void a_1248(void){ /* datainitialization */
int a_L1;int a_L2;int a_P[1];
a_P[0]=16777439;a_1336(a_1001,1,a_P+0);
a_L1=to_LIST(a_1015)->alwb;
...
a_G6:__next(a_1015,a_L1); goto a_G3;
a_G7:{register int a_r1=to_LIST(a_1015)->offset[a_L1-4];
 if(a_r1==344288235){ goto a_G8;}
 if(a_r1==344288239||a_r1==344288245){  goto a_G9;}
  goto a_G6;}
a_G8:a_1376(0,a_L1); goto a_G6;
a_G9:a_1376(1,a_L1); goto a_G6;
...
a_G16:{register int a_r1=to_LIST(a_1015)->offset[a_L1-4];
 if(a_r1==344288257){ goto a_G17;}
 if(a_r1==344288262){  goto a_G18;}
  goto a_G15;}
a_G17:a_1352(a_L1); goto a_G15;
a_G18:a_1355(a_L1); goto a_G15;
a_G20:a_P[0]=16777428;a_1336(a_1001,1,a_P+0);return;
} /* datainitialization */
static void a_1335(void){ /* @root */
