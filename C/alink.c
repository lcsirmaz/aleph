...
static int a_1062(int a_F1); /* hasoutaffix */
static int a_1063=0; /* indexedaffix */
static void a_1064(int a_F1,int a_A[1]); /* indextonode */
static int a_1065(void); /* islimit */
static int a_1066(int a_F1); /* isnodediscarded */
static int a_1067=0; /* localaffixptr */
static int a_1068=0; /* loopfound */
static void a_1069(void); /* makerule */
static void a_1070(int a_F1); /* marklocalaffix */
static void a_1071(int a_F1,int a_F2); /* marknode */
static void a_1072(int a_F1); /* mergeintervals */
static int a_1073(void); /* nodehashdifferent */
static int a_1074(int a_F1); /* nodewithsamehash */
static void a_1075(void); /* omitemptynodes */
static void a_1076(int a_C,int *a_V); /* pushBUFFER */
static void a_1077(int a_F1,int a_F2); /* putnodeflag */
static void a_1078(int a_A[2]); /* readareainterval */
static void a_1079(int a_F1,int a_F2); /* replacelabels */
static void a_1080(int a_F1,int a_F2); /* replacenlabels */
static void a_1081(void); /* rulelabel */
static void a_1082(void); /* rulesection */
static int a_1083(int a_F1,int a_F2); /* samenodes */
static void a_1084(void); /* scani */
static void a_1085(void); /* scanii */
static void a_1086(void); /* scaniii */
static void a_1087(void); /* scaniv */
static void a_1088(int a_F1); /* setnodeflag */
...
static void a_1095(int a_A[1]); /* skiptolabel */
static void a_1096(int a_F1,int a_F2); /* startlocalaffixcheck */
static void a_1097(void); /* storeaffix */
static void a_1098(void); /* storelimit */
static void a_1099(int a_F1); /* storelist */
static void a_1100(int a_A[1]); /* storeruleaffix */
static void a_1101(void); /* storeruleaffixes */
static int a_1102=0; /* storerulename */
static int a_1103=0; /* thisnode */
static void a_1105(int a_F1,int a_C,int *a_V); /* T */
#define a_1106 (a_1033+sizeof_LIST) /* TARGET */
static void a_1107(int a_F1); /* Taffix */
static void a_1108(int a_A[1]); /* Taffixinner */
static void a_1109(int a_F1,int a_F2); /* Tbox */
static void a_1110(int a_F1,int a_F2); /* Textension */
static void a_1111(int a_F1,int a_F2); /* Tifcondition */
static void a_1112(int a_A[1]); /* Tindex */
static void a_1113(int a_F1,int a_F2); /* Tjumptoareas */
static void a_1114(int a_F1,int a_F2); /* Tlabel */
static void a_1115(int a_F1,int a_A[1]); /* Tlimittail */
static void a_1116(int a_F1,int a_F2,int a_F3,int a_F4,int a_F5,int a_F6,int a_F7); /* Trulecall */
static void a_1117(int a_F1,int a_F2,int a_F3); /* Tsingleifcondition */
static void a_1118(int a_F1); /* addcallstack */
static void a_1119(void); /* addprofilingcount */
static void a_1120(void); /* addprofilingdef */
static void a_1121(void); /* addtracing */
static void a_1122(int a_A[1]); /* argsep */
static void a_1123(int a_F1,int a_F2,int a_A[2]); /* assignmentsource */
static void a_1124(int a_F1,int a_F2,int a_F3); /* blockdeclaration */
static void a_1125(int a_F1,int a_A[1]); /* boxclassifier */
static int a_1126=0; /* calledrule */
static int a_1127=0; /* callstack */
static void a_1128(int a_A[1]); /* calltracearg */
static void a_1129(int a_A[1]); /* calltracecall */
static void a_1130(int a_F1); /* charfileinitialization */
static void a_1131(void); /* closetarget */
static void a_1132(void); /* constitem */
static void a_1133(int a_F1,int a_A[1]); /* countfilearea */
static void a_1134(void); /* datadeclaration */
static void a_1135(int a_F1); /* datafileinitialization */
static void a_1136(void); /* datainitialization */
static void a_1137(int a_F1,int a_F2,int a_F3,int a_F4); /* declarecallargs */
static void a_1138(int a_F1,int a_F2,int a_F3); /* declarelocals */
static void a_1139(void); /* deletetarget */
static void a_1140(int a_F1,int a_F2,int a_F3); /* extensionblock */
static void a_1141(int a_A[1]); /* fillitem */
static int a_1142(int a_A[1]); /* fillrepeater */
static void a_1143(void); /* filltablehead */
static void a_1144(void); /* filltabletail */
static int a_1145=0; /* filltotal */
static void a_1146(int a_F1,int a_F2,int a_F3); /* flushbuffer */
static void a_1147(int a_F1); /* formalargument */
static void a_1148(int a_F1,int a_F2,int a_F3,int a_F4); /* genassignment */
static void a_1149(void); /* generatefillentries */
static void a_1150(int a_F1,int a_F2,int a_F3); /* gengetaffixno */
static void a_1151(int a_F1,int a_F2); /* genshiftaffix */
static void a_1152(int a_F1,int a_F2); /* genwaitfor */
static int a_1153(int a_F1); /* hasoutaffix */
static int a_1154(int a_F1); /* iscompletearea */
static int a_1155(int a_F1); /* isdummyaffix */
static int a_1156(int a_F1,int a_F2,int a_F3); /* isrulediscarded */
static void a_1157(int a_F1); /* jumptolabel */
static int a_1158=0; /* lastprofile */
static void a_1159(int a_F1,int a_F2); /* listinitialization */
static void a_1160(int a_F1); /* localargument */
static int a_1161=0; /* moduleroots */
static void a_1162(int a_A[1]); /* nextaffix */
static int a_1163=0; /* nextnodeidx */
static int a_1164(int a_F1,int a_F2); /* numbersequal */
static void a_1165(void); /* opentarget */
static void a_1166(int a_F1,int a_A[1]); /* outargs */
static void a_1167(int a_F1); /* pidginalttagtail */
static void a_1168(int a_F1); /* pidginrepeatblock */
static void a_1169(int a_F1,int a_F2); /* pidginruleargs */
static void a_1170(int a_F1); /* pidginrulecall */
static void a_1171(int a_F1); /* printBUFFER */
static void a_1172(int a_F1); /* printGOTO */
static void a_1173(int a_F1); /* printexternalrepr */
static void a_1174(int a_F1); /* printgoto */
static void a_1175(int a_F1); /* printint */
static void a_1176(int a_F1,int a_F2); /* printint1 */
static void a_1177(int a_F1,int a_F2); /* printintindex */
static void a_1178(void); /* printlabelprefix */
static void a_1179(int a_F1); /* printlocallabel */
static void a_1180(int a_F1); /* printnlptr */
static void a_1181(int a_F1); /* printnumber */
static void a_1182(int a_F1); /* printpidginrepr */
static void a_1183(int a_F1); /* printptr */
static void a_1184(int a_F1); /* printrepr */
static void a_1185(void); /* procwaitfor */
static void a_1186(void); /* profilingdeclaration */
static void a_1187(int a_F1); /* pushBUFFER */
static void a_1188(int a_F1,int a_F2,int a_A[1]); /* regularcalld1 */
static void a_1189(int a_F1,int a_F2); /* regularcalld2 */
static void a_1190(int a_F1,int a_F2,int a_F3); /* regularcalld3 */
static void a_1191(int a_F1); /* regularcallpostload */
static void a_1192(int a_F1); /* regularcallpreload */
static void a_1193(int a_F1); /* regularrulecall */
static void a_1194(int a_F1,int a_F2,int a_F3); /* repeatblockcall */
static void a_1195(int a_F1,int a_F2,int a_F3,int a_F4); /* repeatblockpostload */
static void a_1196(int a_F1,int a_F2,int a_F3,int a_F4); /* repeatblockpreload */
static void a_1197(int a_F1); /* rootprototype */
static void a_1198(int a_F1,int a_F2); /* ruleargs */
static void a_1199(int a_F1,int a_F2,int a_F3,int a_F4,int a_F5,int a_F6,int a_F7,int a_F8,int a_F9); /* ruledeclarationhead */
static void a_1200(void); /* ruledeclarationtail */
static void a_1201(int a_F1); /* ruleprototype */
static void a_1202(int a_F1,int a_A[1]); /* ruletyper */
static void a_1203(int a_F1); /* showformalsascomment */
static void a_1204(void); /* skipfillinitializer */
static void a_1205(void); /* targetmain */
static int a_1206=0; /* targetopened */
static void a_1207(void); /* targetpostlude */
static void a_1208(void); /* targetprelude */
static int a_1209=0; /* thisrule */
static void a_1210(int a_A[1]); /* untilnextcomma */
static void a_1211(void); /* usecallstack */
static void a_1212(int a_F1); /* vardeclaration */
static int a_1213=0; /* waitforused */
static int a_1215(int a_F1); /* E */
#define a_1216 (a_1106+sizeof_CHFILE) /* EXPRESSION */
static int a_1217(int a_A[1]); /* Eitem */
static int a_1218(int a_F1,int a_A[2]); /* Eop */
static int a_1219=0; /* Raddr */
static int a_1220=0; /* Rby */
static void a_1221(int a_F1); /* checkcalibretype */
static void a_1222(int a_F1,int a_F2); /* checkconstanttype */
static void a_1223(int a_F1); /* checklisttype */
static void a_1224(void); /* clearvirtualspace */
static int a_1225=0; /* eptr */
static void a_1226(int a_A[1]); /* finalbase */
static void a_1227(int a_F1); /* finaleval */
static void a_1228(void); /* finalevaluation */
static void a_1229(int a_F1,int a_A[1]); /* finalexpr */
static void a_1230(int a_F1,int a_F2,int a_A[1]); /* getexprlimit */
static void a_1231(int a_A[1]); /* getitemdef */
static int a_1232=0; /* linkexpr */
static int a_1233(int a_A[1]); /* loosebase */
static void a_1234(int a_F1); /* looseeval */
static void a_1235(void); /* looseevaluation */
static int a_1236(int a_F1,int a_A[1]); /* looseexpr */
static void a_1237(int a_F1,int a_F2,int a_F3,int a_A[2]); /* nextvirtualblock */
static void a_1238(int a_F1,int a_F2,int a_F3); /* optor */
static void a_1239(int a_F1); /* pushEXPR */
static void a_1240(void); /* readexpression */
static void a_1241(int a_F1,int a_F2); /* setfinalvalue */
static int a_1242(int a_F1,int a_F2); /* splitvirtualspace */
static void a_1243(int a_F1,int a_A[1]); /* storenumstring */
static void a_1244(int a_F1,int a_F2,int a_A[1]); /* virtualaddressoffset */
static void a_1246(void); /* assignreprnumbers */
static void a_1247(int a_F1,int a_F2); /* checkconstanttype */
static void a_1248(int a_F1); /* checkfiletype */
static void a_1249(int a_F1); /* checkfillconstanttype */
static void a_1250(void); /* checkfillitem */
static void a_1251(int a_F1); /* checklisttype */
static void a_1252(int a_A[2]); /* collectlistsizeclaims */
...
static int a_1260=0; /* filltablesize */
static void a_1261(int a_F1,int a_F2); /* fixsize */
static int a_1262(int a_F1,int a_A[1]); /* getconstvalue */
static void a_1263(int a_F1,int a_F2,int a_A[1]); /* getestimator */
static void a_1264(int a_A[1]); /* getitemdef */
static int a_1265=-1; /* linklists */
static void a_1266(void); /* listentry */
static void a_1267(void); /* loosebounds */
static void a_1268(void); /* loosefill */
static void a_1269(int a_A[1]); /* loosefillitem */
static void a_1270(int a_F1); /* looseinitializer */
static void a_1271(int a_F1,int a_F2,int a_F3); /* looserepeater */
static int a_1272=1000; /* nextreprno */
static void a_1273(int a_F1); /* readmatter */
static void a_1274(int a_F1,int a_F2); /* relativesize */
static void a_1275(int a_F1); /* rememberlist */
static void a_1276(int a_F1,int a_F2,int a_F3,int a_A[1]); /* repeatervalue */
static void a_1277(void); /* setlistbounds */
static void a_1278(int a_F1); /* setpointervalue */
static void a_1279(int a_F1); /* setreprnumber */
static void a_1280(void); /* skipdatasection */
static void a_1281(void); /* skipentry */
static void a_1282(void); /* skipfill */
static void a_1283(int a_F1); /* skipfillinitializer */
static void a_1284(void); /* skipfillitem */
static void a_1285(int a_F1); /* skipfillrepeater */
#define a_1287 (a_1216+sizeof_LIST) /* AUX */
#define a_1288 (a_1287+sizeof_LIST) /* ITEM */
static void a_1289(void); /* addbuiltinformals */
static void a_1290(int a_F2,int a_A[1],int a_C,int *a_V); /* addformalaffixes */
static void a_1291(int a_F1,int a_F2); /* addmatter */
static void a_1292(void); /* addshiftaffixrules */
static void a_1293(void); /* addstdstring */
static void a_1294(int a_A[1]); /* advancemodbase */
static void a_1295(int a_F1); /* checkitemID */
static void a_1296(void); /* checkmainmodule */
static void a_1297(void); /* cleanupitems */
static void a_1298(int a_F1,int a_F2); /* clearitemflag */
static int a_1299(int a_F1,int a_F2); /* compareformals */
static void a_1300(int a_A[1]); /* converttoitem */
static int a_1301=0; /* doreport */
static void a_1302(void); /* enteritem */
static void a_1303(void); /* expandITEM */
static void a_1304(int a_F1,int a_A[1]); /* finditemdef */
static void a_1305(int a_F1,int a_A[3]); /* finditemlineno */
static void a_1306(int a_F1,int a_A[2]); /* findlineno */
static int a_1307=0; /* firstmodule */
static void a_1308(int a_F1,int a_F2); /* formalaffixes */
static void a_1309(int a_F1,int a_A[1]); /* getanchorcount */
static void a_1310(int a_F1,int a_A[1]); /* getcalibre */
static void a_1311(int a_F1,int a_F2,int a_A[1]); /* getfilearea */
static void a_1312(int a_F1,int a_A[2]); /* getfiledata */
static void a_1313(int a_F1,int a_A[1]); /* getfill */
static void a_1314(int a_F1,int a_F2,int a_A[1]); /* getformal */
static void a_1315(int a_F1,int a_A[1]); /* getlistlink */
static int a_1316(int a_F2,int a_A[2]); /* getmatter */
static void a_1317(int a_A[1]); /* getnextmodulehead */
static void a_1318(int a_F1,int a_A[1]); /* getnumberofformals */
static void a_1319(int a_F1,int a_A[1]); /* getssel */
static void a_1320(int a_F1,int a_A[1]); /* getvlwb */
static void a_1321(int a_F1,int a_A[1]); /* getvupb */
static void a_1322(int a_F1); /* headsection */
static int a_1323(int a_F1,int a_F2); /* incompatibletypes */
static int a_1324(int a_F1); /* isassignitem */
static int a_1325(int a_F1,int a_A[1]); /* isbuiltinrule */
static int a_1326(int a_F1,int a_F2); /* isitemflag */
static int a_1327(int a_F1); /* isrootitem */
static int a_1328(int a_F1); /* iswaitforitem */
static void a_1329(void); /* itemsection */
static int a_1330=0; /* lastmodule */
static int a_1331=0; /* linkformals */
static void a_1332(void); /* linkmoduleheader */
static int a_1333=0; /* mainmodule */
static int a_1334=0; /* makeformals */
static int a_1335=0; /* matterlink */
static int a_1336=0; /* maxlineno */
static int a_1337=0; /* modbase */
static int a_1338(int a_F1); /* nocallstackrule */
static void a_1339(int a_A[1]); /* opennextmodule */
static void a_1340(int a_F1); /* pushAUX */
static void a_1341(int a_F1,int a_F2); /* putfill */
static void a_1342(int a_F1,int a_F2); /* putlistlink */
static void a_1343(int a_F1,int a_F2); /* putvlwb */
static void a_1344(int a_F1,int a_F2); /* putvupb */
static void a_1345(void); /* readdefinitionlist */
static void a_1346(int a_F1); /* readfileinfo */
static void a_1347(void); /* readitem */
static void a_1348(int a_F1); /* reportitem */
static void a_1349(void); /* reportnotusedpublicitems */
static int a_1350=0; /* rootformals */
static void a_1351(int a_A[1]); /* scanfordefinitions */
static void a_1352(void); /* scanfordoubledefinitions */
static void a_1353(int a_F1); /* scanitem */
static void a_1354(int a_F1); /* scanitemfordbledef */
static void a_1355(void); /* scanlinkedmodules */
static void a_1356(int a_F1,int a_F2,int a_A[2]); /* searchforline */
static void a_1357(int a_F1,int a_A[1]); /* searchformals */
static void a_1358(int a_F1,int a_F2); /* setitemflag */
static void a_1359(void); /* skipheadsection */
static void a_1360(void); /* skipitemsection */
static int a_1361(int a_F1,int a_F2); /* stacksizemismatch */
static void a_1362(int a_A[1]); /* storeformalaffixes */
static void a_1363(int a_A[1]); /* storelistbounds */
static int a_1364(int a_F1,int a_F2); /* unequaltypes */
static int a_1365=0; /* waitforformals */
#define a_1367 (a_1288+sizeof_LIST) /* REGISTER */
static void a_1368(int a_F1,int a_A[1]); /* duplregister */
static void a_1369(int a_F1); /* freeregister */
static void a_1370(int a_F1); /* freeregistersfrommark */
static void a_1371(int a_F1,int a_A[1]); /* getcstregister */
static void a_1372(int a_A[1]); /* getregister */
static int a_1373(int a_F1); /* istargetconst */
static void a_1374(int a_A[1]); /* markregisters */
static void a_1375(int a_F1,int a_A[1]); /* putcstregister */
static void a_1376(int a_F1,int a_F2,int a_A[1]); /* readregister */
static int a_1377(int a_F1,int a_F2); /* regcompare */
static int a_1378(int a_F1,int a_F2,int a_F3); /* regcompare2 */
static void a_1379(int a_F1,int a_F2,int a_F3); /* regoperator */
static int a_1380=1; /* targetwordwidth */
static void a_1381(int a_F1,int a_F2); /* writeregister */
#define a_1384 (a_1367+sizeof_LIST) /* FILES */
static int a_1385=0; /* actualptr */
static void a_1386(void); /* adddirseparator */
static void a_1387(void); /* addextension */
static void a_1388(int a_F1); /* addincludedicefiles */
static int a_1389=1; /* addstdlib */
static int a_1390=0; /* argtop */
static void a_1391(void); /* checkcommandlinearguments */
static void a_1392(int a_F1); /* extendBUFFER */
static void a_1393(int a_F1); /* extendFILES */
static int a_1394=0; /* fileno */
static void a_1395(int a_A[1]); /* geticefile */
static int a_1396(int a_A[1]); /* getnextsource */
static void a_1397(void); /* gettargetfile */
static void a_1398(int a_F1,int a_A[1]); /* handlesourcefile */
static int a_1399(int a_F1,int a_F2); /* isfileflag */
static int a_1400(int a_F1,int a_F2); /* isfirstarg */
static int a_1401=0; /* libdir */
static int a_1402=0; /* libfile */
static int a_1403=0; /* mainfile */
static int a_1404(void); /* notstdlibsource */
static void a_1405(int a_A[1]); /* openBUFFER */
static void a_1406(int a_F1,int a_A[1]); /* openfileasgiven */
static void a_1407(int a_F1); /* opensource */
static void a_1408(int a_F1,int a_F2); /* setfileflag */
static void a_1409(int a_F1); /* setsource */
static void a_1410(int a_F1); /* stringtoBUFFER */
static int a_1411=0; /* targetfile */
static void a_1412(int a_F1,int a_A[1]); /* tryfilefirst */
static int a_1413(int a_F1,int a_A[1]); /* wasicesource */
#define a_1415 (a_1384+sizeof_LIST) /* MESSAGE */
#define a_1416 (a_1415+sizeof_LIST) /* PRINTFILE */
static void a_1417(int a_F1,int a_F2); /* corrupticefile */
static void a_1418(int a_C,int *a_V); /* error */
static int a_1419=0; /* errorno */
static void a_1420(int a_C,int *a_V); /* fatalerror */
static void a_1421(int a_C,int *a_V); /* formatprint */
static void a_1422(int a_F1,int a_F2); /* internalerror */
static void a_1423(int a_C,int *a_V); /* message */
static void a_1424(int a_F1); /* messagehead */
static void a_1425(void); /* nlcr */
static void a_1426(int a_F1,int a_F2); /* print */
static void a_1427(int a_F1); /* printbase */
static void a_1428(int a_F1); /* printchar */
static void a_1429(int a_F1); /* printform */
static void a_1430(int a_F1,int a_F2); /* printform1 */
static void a_1431(int a_F1); /* printint */
static void a_1432(int a_F1,int a_F2); /* printint1 */
static void a_1433(int a_F1); /* printitem */
static void a_1434(int a_F1); /* printline */
static void a_1435(int a_F1); /* printpointer */
static int a_1436=0; /* prpos */
static void a_1437(int a_F1); /* tabline */
static void a_1438(int a_C,int *a_V); /* warning */
static int a_1439(void); /* waserror */
#define a_1441 (a_1416+sizeof_CHFILE) /* BOLD */
#define a_1442 (a_1441+sizeof_LIST) /* BUFFER */
#define a_1443 (a_1442+sizeof_LIST) /* HASH */
static int a_1444=1; /* HASHentries */
static int a_1445=1023; /* HASHsize */
#define a_1446 (a_1443+sizeof_LIST) /* LEXT */
#define a_1447 (a_1446+sizeof_LIST) /* SOURCE */
static void a_1448(int a_A[1]); /* addLEXTentry */
static int a_1449=32; /* char */
static void a_1450(void); /* closesource */
static void a_1451(void); /* comment */
static void a_1452(int a_F1,int a_A[1]); /* enterstring */
static void a_1453(int a_F1); /* extendBUFFER */
static void a_1454(int a_F1,int a_A[1]); /* gettagdata */
static void a_1455(int a_F1,int a_A[1]); /* gettagimage */
static int a_1456=0; /* inpt */
static int a_1457=0; /* inptvalue */
static int a_1458=0; /* lastchar */
static int a_1459=0; /* lastfilepos */
static int a_1460=0; /* lastinpt */
static int a_1461=0; /* lastinptvalue */
static void a_1462(void); /* nextchar */
static void a_1463(void); /* nextsymbol */
static void a_1464(int a_F1,int a_F2); /* puttagdata */
static void a_1465(int a_A[1]); /* readbold */
static void a_1466(int a_A[1]); /* readdestination */
static void a_1467(int a_A[1]); /* readstring */
static void a_1468(int a_A[1]); /* readtargetnumber */
static void a_1469(int a_A[2]); /* readtargetstring */
static void a_1470(int a_A[1]); /* readtype */
static void a_1471(void); /* rehash */
static void a_1472(void); /* restoreinputposition */
static void a_1473(void); /* saveinputposition */
static int a_1474=1; /* sourceline */
static void a_1475(int a_A[1]); /* trytoopensource */
static int a_1476=0; /* xnumber */
static void a_1478(void); /* pass1 */
static void a_1479(void); /* pass2 */
static void a_1480(void); /* pass3 */
static void a_1481(void); /* pass4 */
static void a_1482(void); /* pass5 */
static void a_1485(int a_F1,int a_F2,int a_F3); /* putstring */
#define a_1488 (a_1447+sizeof_CHFILE) /* STDARG */
static void a_1477(void); /* @main root */
static void a_1440(void); /* lexical root */
static void a_1366(void); /* arithmetic root */
static void a_1286(void); /* item root */
static void a_1004(void); /* number root */
#define BLOCK_TOTAL (a_1488+sizeof_LIST)
...
a_1001,/* @StringTable */
4,1953723757,0,4,4,0,
-1}; /* fill table size 2352 */
static void a_data_setup(void){
 a_virtual_min=16777216;a_virtual_max=2130706432;
 a_setup_list(0,a_1001,"@StringTable",1,2130705079,2130706360,1282); /* @StringTable */
 ...
 a_setup_list(1,a_1367,"REGISTER",1,155851627,183666453,0); /* REGISTER */
 a_setup_list(1,a_1384,"FILES",2,128036799,155851624,0); /* FILES */
 a_setup_list(0,a_1415,"MESSAGE",1,2047259986,2047260592,607); /* MESSAGE */
 a_setup_list(0,a_1441,"BOLD",1,16777217,16777486,270); /* BOLD */
 a_setup_list(1,a_1442,"BUFFER",1,72407143,128036796,0); /* BUFFER */
 a_setup_list(1,a_1443,"HASH",1,16777488,72407141,0); /* HASH */
 a_setup_list(1,a_1446,"LEXT",2,183666456,739963094,100); /* LEXT */
 a_setup_stdarg(a_1488,"STDARG",1);
 a_setup_charfile(a_1106,"TARGET",2,a_1001,2130706054); /* TARGET */
 a_setup_charfile(a_1416,"PRINTFILE",2,a_1001,2130706305); /* PRINTFILE */
 a_setup_charfile(a_1447,"SOURCE",1,a_1001,2130706352); /* SOURCE */
 a_list_fill(a_FILL);
}
static void a_waitfor(int a_F1,int a_F2){
 a_MODROOT(a_1440,"lexical")
...
static void a_1009(int a_F1){ /* extendBUFFER+>a */
 ...
 a_extension(a_1442,1);to_LIST(a_1442)->top[1]=a_F1;to_LIST(a_1442)->aupb+=1;
  return;
} /* extendBUFFER */
...
{register int a_r1=to_LIST(a_1442)->offset[a_F1];
 if(!((48<=a_r1 && a_r1<=57))){ goto a_G3;}
}
a_subtr(to_LIST(a_1442)->offset[a_F1],48,a_A[0]); return;
a_G3:a_1422(a_1001,2130705099); return;
} /* getdigit */
...
a_G2:a_incr(a_F2);
if(a_more(a_F2,to_LIST(a_1442)->aupb)){ goto a_G20;}
a_1010(a_F2,a_P);a_L5=a_P[0];
if(!a_1378(21,a_L4,a_1018)){ goto a_G8;}
a_G6:a_1006(a_L4,a_L5); goto a_G2;
a_G8:if(!a_1378(21,a_L4,a_1018)){ goto a_G10;}
a_G9:a_1417(a_1001,2130705094); return;
a_G10:if(a_less(a_L5,a_1016)){ goto a_G6;}
if(a_less(a_L5,a_1016)){ goto a_G9;}
if(!a_is(a_F1)){ goto a_G9;}
if(a_equal(a_F2,to_LIST(a_1442)->aupb)){ goto a_G6;} goto a_G9;
...
a_subtr(to_LIST(a_1442)->aupb,a_F1,a_L4);
a_packstring(a_1442,a_L4,a_1446);
a_copystring(a_1446,to_LIST(a_1446)->aupb,a_1442);
a_unstackstring(a_1446);
a_stringwidth(a_1442,to_LIST(a_1442)->aupb,a_A[0]);
a_L5=a_A[0];
a_G7:if(!a_less(a_L5,1)){ goto a_G9;}
a_A[1]=to_LIST(a_1005)->aupb; return;
a_G9:a_1017(1,to_LIST(a_1442)->offset[to_LIST(a_1442)->aupb],a_P);a_L6=a_P[0];
a_1381(a_L6,a_1005);
a_decr(a_L5);
a_unstack(a_1442); goto a_G7;
} /* entertargetstring */
...
a_G1:if(!a_equal(16777285,a_1456)){ goto a_G4;}
a_1463();
a_1069(); goto a_G1;
a_G4:if(!a_equal(16777486,a_1456)){ goto a_G6;}
a_1463(); return;
a_G6:a_1417(a_1001,2130705135); return;
} /* rulesection */
static void a_1092(void){ /* skiprule */

a_G1:if(!a_equal(16777439,a_1456)){ goto a_G3;}
a_G2:a_1463(); return;
a_G3:if(a_equal(16777486,a_1456)){ goto a_G2;}
a_1463(); goto a_G1;
} /* skiprule */
...
a_G6:if(!a_1378(21,a_F2,to_LIST(a_1033)->offset[a_L5-2])){ goto a_G13;}
a_A[0]=1;
if(!a_1378(21,a_F3,to_LIST(a_1033)->offset[a_L5-2])){ goto a_G11;}
...
a_G13:if(!a_1378(22,a_F2,to_LIST(a_1033)->offset[a_L5-1])){ goto a_G17;}
if(a_1378(22,a_F3,to_LIST(a_1033)->offset[a_L5-1])){ return;}
a_A[0]=1; goto a_G12;
a_G17:a_F1=a_L5; goto a_G1;
} /* addinterval */
static void a_1072(int a_F1){ /* mergeintervals+>a */
int a_L2;
...
static void a_1078(int a_A[2]){ /* readareainterval+a>+a> */
int a_L3;int a_L4;int a_L5;int a_L6;int a_P[1];
if(!a_equal(16777459,a_1456)){ goto a_G6;}
a_A[0]=a_1457;
a_1463();
a_G4:a_A[1]=a_A[0];
a_L4=1; goto a_G28;
a_G6:if(!a_equal(16777471,a_1456)){ goto a_G25;}
a_L3=a_1457;
a_1463();
a_P[0]=a_L3;a_1060(a_P);a_L3=a_P[0];
{register int a_r1=to_LIST(a_1288)->offset[a_L3-5];
...
a_G14:a_1320(a_L3,a_P);a_A[0]=a_P[0];
...
a_L4=2; goto a_G28;
a_G24:a_1417(a_1001,2130705130); return;
a_G25:a_1012(a_P);a_A[0]=a_P[0];
a_1012(a_P);a_A[1]=a_P[0];
a_L4=0;
a_G28:if(!a_equal(16777409,a_1456)){ goto a_G45;}
a_1463();
if(!a_equal(a_L4,0)){ goto a_G32;}
a_A[0]=a_1026; goto a_G34;
a_G32:if(!a_equal(a_L4,1)){ goto a_G24;}
a_G34:if(!a_equal(16777459,a_1456)){ goto a_G37;}
a_A[1]=a_1457;
a_1463(); return;
a_G37:if(!a_equal(16777471,a_1456)){ goto a_G44;}
a_L3=a_1457;
a_1463();
a_P[0]=a_L3;a_1060(a_P);a_L3=a_P[0];
{register int a_r1=to_LIST(a_1288)->offset[a_L3-5];
...
if(!a_equal(16777455,a_1456)){ goto a_G4;}
a_A[0]=a_1457;
a_1463(); goto a_G5;
a_G4:a_1417(a_1001,2130705103); return;
a_G5:a_L3=0;
...
a_G11:a_P[0]=2047260000;a_P[1]=a_A[0];a_P[2]=a_L4;a_P[3]=a_L5;a_1418(4,a_P);
a_G12:if(!a_equal(16777442,a_1456)){ goto a_G14;}
a_1463(); goto a_G6;
a_G14:a_1072(a_F1);
if(a_is(a_L3)){ return;}
a_P[0]=2047260013;a_P[1]=a_A[0];a_1418(2,a_P); return;
} /* checkarea */
static void a_1039(void){ /* checkareas */
...
a_L2=0;a_L3=0;
a_G6:if(!a_equal(16777220,a_1456)){ goto a_G14;}
a_1463();
a_incr(a_L3);
a_1038(a_L1,a_P);a_L2=a_P[0];
if(!a_equal(16777433,a_1456)){ goto a_G13;}

a_1463(); goto a_G6;
a_G13:a_1417(a_1001,2130705103); return;
a_G14:if(!a_1044(a_L1)){ goto a_G18;}
a_1088(2048);
if(a_more(a_L3,1)){ goto a_G20;}
a_P[0]=2047260038;a_P[1]=a_L2;a_1418(2,a_P); goto a_G20;
a_G18:a_P[0]=2047260026;a_P[1]=a_L2;a_1438(2,a_P);
a_1102=1;
a_G20:a_1370(a_L4); return;
} /* checkareas */
static void a_1088(int a_F1){ /* setnodeflag+>a */

a_boolor(a_F1,to_LIST(a_1032)->offset[a_1103-4],to_LIST(a_1032)->offset[a_1103-4]); return;
} /* setnodeflag */
static void a_1077(int a_F1,int a_F2){ /* putnodeflag+>a+>a */
...
int a_L1;
a_scratch(a_1032);
if(!a_equal(16777455,a_1456)){ goto a_G5;}
a_L1=a_1457;
a_1463(); goto a_G6;
a_G5:a_1417(a_1001,2130705103); return;
...
if(!a_equal(16777467,a_1456)){ goto a_G4;}
...
a_1417(a_1001,2130705123); return;
} /* advancenode */
...
static void a_1064(int a_F1,int a_A[1]){ /* indextonode+>a+a> */
...
if(!a_equal(16777471,a_1456)){ goto a_G4;}
a_L1=a_1457;
a_1463(); goto a_G5;
a_G4:a_1417(a_1001,2130705103); return;
...
a_L4=a_1457;
a_1463();
if(a_1326(a_L1,12288)){ goto a_G25;}
if(!a_1326(a_L1,16384)){ goto a_G22;}
a_1088(8); goto a_G25;
a_G22:a_max(a_L2,a_1029);
a_max(a_L3,a_1030);
a_max(a_L4,a_1031);
a_G25:a_booland(to_LIST(a_1032)->offset[a_1103-4],8,a_L5);
...
static void a_1070(int a_F1){ /* marklocalaffix+>a */

if(a_equal(a_1047,0)){ return;}
a_add(a_1067,a_F1,a_F1);
to_LIST(a_1442)->offset[a_F1]=1; return;
} /* marklocalaffix */
static void a_1096(int a_F1,int a_F2){ /* startlocalaffixcheck+>a+>a */
int a_P[1];
if(!a_equal(a_F1,0)){ goto a_G3;}
a_1047=0; return;
a_G3:a_1047=1;
a_subtr(to_LIST(a_1442)->aupb,a_F1,a_1067);
a_incr(a_1067);
...
static void a_1094(void){ /* skiptocomma */
int a_L1;
a_G1:if(!a_equal(16777412,a_1456)){ goto a_G3;}
a_1463(); return;
a_G3:if(!a_equal(16777479,a_1456)){ goto a_G7;}
a_L1=a_1457;
a_1463();
a_1070(a_L1); goto a_G1;
a_G7:if(!a_equal(16777448,a_1456)){ goto a_G10;}
a_1463();
a_1063=1; goto a_G1;
a_G10:if(!a_equal(16777486,a_1456)){ goto a_G13;}
a_1463();
a_1417(a_1001,2130705118); return;
a_G13:a_1463(); goto a_G1;
} /* skiptocomma */
static void a_1095(int a_A[1]){ /* skiptolabel+a> */

a_G1:if(!a_equal(16777433,a_1456)){ goto a_G4;}
a_A[0]=a_1457;
a_1463(); return;
a_G4:if(!a_equal(16777486,a_1456)){ goto a_G7;}
a_1463();
a_1417(a_1001,2130705113); return;
a_G7:a_1463(); goto a_G1;
} /* skiptolabel */
static int a_1065(void){ /* islimit */

if(!a_equal(16777231,a_1456)){ goto a_G3;}
a_G2:a_1463(); return 1;
a_G3:if(a_equal(16777269,a_1456)){ goto a_G2;}
if(a_equal(16777291,a_1456)){ goto a_G2;}
if(a_equal(16777295,a_1456)){ goto a_G2;}
if(!a_equal(16777299,a_1456)){ return 0;}
a_1463(); return 1;
} /* islimit */
static void a_1091(void){ /* skiplist */

if(!a_equal(16777475,a_1456)){ goto a_G3;}
a_G2:a_1463(); return;
a_G3:if(!a_equal(16777471,a_1456)){ goto a_G6;}
 goto a_G2;
a_G6:a_1417(a_1001,2130705103); return;
} /* skiplist */
static void a_1090(void){ /* skipaffix */
int a_L1;
if(!a_equal(16777409,a_1456)){ goto a_G3;}
a_1463();
a_G3:if(!a_equal(16777475,a_1456)){ goto a_G5;}
a_G4:a_1463(); return;
a_G5:if(!a_equal(16777479,a_1456)){ goto a_G9;}
a_L1=a_1457;
a_1463();
a_1070(a_L1); return;
a_G9:if(a_equal(16777471,a_1456)){ goto a_G4;}
if(a_equal(16777424,a_1456)){ goto a_G4;}
if(a_equal(16777459,a_1456)){ goto a_G4;}
if(!a_1065()){ goto a_G17;}
a_1091(); return;
a_G17:if(!a_equal(16777448,a_1456)){ goto a_G30;}
a_1463();
a_1063=1;
a_1091();
a_1090();
if(!a_equal(16777403,a_1456)){ goto a_G25;}

a_1463(); goto a_G26;
a_G25:a_1417(a_1001,2130705103); return;
a_G26:if(!a_equal(16777455,a_1456)){ goto a_G25;}
 goto a_G4;
a_G30:a_1417(a_1001,2130705108); return;
} /* skipaffix */
static void a_1076(int a_C,int *a_V){ /* pushBUFFER+@+>a */

a_G1: a_extension(a_1442,1);to_LIST(a_1442)->top[1]=a_V[0];to_LIST(a_1442)->aupb+=1;
if(a_C>1){a_C--;a_V+=1; goto a_G1;}  return;
} /* pushBUFFER */
static void a_1099(int a_F1){ /* storelist+>a */
int a_L2;int a_P[3];
if(!a_equal(16777475,a_1456)){ goto a_G5;}
a_L2=a_1457;
a_1463();
a_P[0]=a_F1;a_P[1]=16777475;a_P[2]=a_L2;a_1076(3,a_P); return;
a_G5:if(!a_equal(16777471,a_1456)){ goto a_G8;}
a_L2=a_1457;
a_1463(); goto a_G9;
a_G8:a_1417(a_1001,2130705103); return;
a_G9:a_P[0]=a_L2;a_1060(a_P);a_L2=a_P[0];
a_P[0]=a_F1;a_P[1]=16777471;a_P[2]=a_L2;a_1076(3,a_P); return;
} /* storelist */
static void a_1098(void){ /* storelimit */

if(!a_equal(16777269,a_1456)){ goto a_G4;}
a_1463();
a_1099(16777269); return;
a_G4:if(!a_equal(16777291,a_1456)){ goto a_G7;}
a_1463();
a_1099(16777291); return;
a_G7:if(!a_equal(16777295,a_1456)){ goto a_G10;}
a_1463();
a_1099(16777295); return;
a_G10:if(!a_equal(16777299,a_1456)){ goto a_G13;}
a_1463();
a_1099(16777299); return;
a_G13:if(!a_equal(16777231,a_1456)){ goto a_G16;}

a_1463(); goto a_G17;
a_G16:a_1417(a_1001,2130705103); return;
...
a_G9:if(!a_equal(16777471,a_1456)){ goto a_G14;}
a_L1=a_1457;
a_1463();
a_P[0]=a_L1;a_1060(a_P);a_L1=a_P[0];
a_P[0]=16777471;a_P[1]=a_L1;a_1076(2,a_P); return;
a_G14:if(!a_equal(16777459,a_1456)){ goto a_G18;}
a_L1=a_1457;
a_1463();
a_P[0]=16777459;a_P[1]=a_L1;a_1076(2,a_P); return;
a_G18:if(!a_equal(16777448,a_1456)){ goto a_G31;}
a_1463();
a_1099(16777448);
a_1097();
if(!a_equal(16777403,a_1456)){ goto a_G25;}
...
static void a_1100(int a_A[1]){ /* storeruleaffix+a> */
int a_L2;int a_P[2];
if(!a_equal(16777409,a_1456)){ goto a_G6;}
a_1463();
a_A[0]=16777409;
a_P[0]=16777409;a_1076(1,a_P);
a_1097(); return;
a_G6:if(!a_equal(16777424,a_1456)){ goto a_G10;}
a_1463();
a_A[0]=16777424;
a_P[0]=16777424;a_1076(1,a_P); return;
a_G10:if(!a_equal(16777397,a_1456)){ goto a_G18;}
a_1463();
a_A[0]=16777397;
if(!a_equal(16777455,a_1456)){ goto a_G16;}
a_L2=a_1457;
a_1463(); goto a_G17;
a_G16:a_L2=0;
...
static void a_1101(void){ /* storeruleaffixes */
int a_L1;int a_P[2];
a_G1:{ if(a_1456==16777479){ goto a_G2;}
 if(a_1456==16777471){ goto a_G5;}
 if(a_1456==16777475||a_1456==16777459||a_1456==16777455){ goto a_G3;}
 if(a_1456==16777448){ goto a_G10;}
 if(a_1456==16777269||a_1456==16777291||a_1456==16777295||a_1456==16777299||a_1456==16777231||a_1456==16777424||a_1456==16777403||a_1456==16777397||a_1456==16777409){  goto a_G15;}
  goto a_G17;}
a_G2:a_1070(a_1457);
a_G3:a_P[0]=a_1456;a_P[1]=a_1457;a_1076(2,a_P);
a_G4:a_1463(); goto a_G1;
a_G5:a_P[0]=a_1457;a_1060(a_P);a_1457=a_P[0]; goto a_G3;
a_G10:a_P[0]=a_1456;a_1076(1,a_P);
a_1463();
a_booland(to_LIST(a_1032)->offset[a_1103-4],8,a_L1);
if(a_noteq(a_L1,0)){ goto a_G1;}
a_1063=1; goto a_G1;
a_G15:a_P[0]=a_1456;a_1076(1,a_P); goto a_G4;
a_G17:if(!a_equal(16777433,a_1456)){ goto a_G20;}
to_LIST(a_1032)->offset[a_1103-1]=a_1457;
a_1463(); goto a_G21;
a_G20:a_1417(a_1001,2130705103); return;
a_G21:if(!a_equal(16777433,a_1456)){ goto a_G20;}
to_LIST(a_1032)->offset[a_1103]=a_1457;
a_1463();
if(!a_equal(16777412,a_1456)){ goto a_G20;}

a_1463(); return;
} /* storeruleaffixes */
static void a_1045(void){ /* computeruleaffixhash */
int a_L1;int a_P[1];
a_L1=to_LIST(a_1442)->aupb;
a_1101();
a_blockhash(a_1442,a_L1,a_P);to_LIST(a_1032)->offset[a_1103-5]=a_P[0];
a_unstackto(a_1442,a_L1); return;
} /* computeruleaffixhash */
static int a_1074(int a_F1){ /* nodewithsamehash+>a */
...
a_G1:if(!a_equal(to_LIST(a_1442)->offset[a_F1],to_LIST(a_1442)->offset[a_F2])){ return 0;}
if(a_equal(to_LIST(a_1442)->offset[a_F1],16777412)){ return 1;}
a_decr(a_F1);
...
a_unstackto(a_1442,a_F1); return;
a_G24:a_1088(4096); return;
...
a_1101();
to_LIST(a_1032)->offset[a_1103-2]=to_LIST(a_1442)->aupb;
a_1043(a_L1); return;
a_G7:a_1094(); return;
} /* checknodehash */
static int a_1083(int a_F1,int a_F2){ /* samenodes+>a+>a */
int a_L3;
...
static int a_1062(int a_F1){ /* hasoutaffix+>a */
...
static int a_1066(int a_F1){ /* isnodediscarded+>a */
int a_L2;int a_L3;int a_P[1];
...
static void a_1079(int a_F1,int a_F2){ /* replacelabels+>a+>a */
int a_L3;
...
static void a_1080(int a_F1,int a_F2){ /* replacenlabels+>a+>a */
int a_P[1];
...
a_G1:a_L1=0;
a_L2=to_LIST(a_1032)->alwb;
a_G3:if(a_more(a_L2,to_LIST(a_1032)->aupb)){ goto a_G30;}
...
if(a_noteq(a_L4,0)){ goto a_G17;}
if(!a_1083(a_L2,a_L3)){ goto a_G17;}
a_L1=1;
a_1080(a_L2,a_L3); goto a_G17;
a_G30:if(a_equal(a_L1,0)){ return;}
...
a_L3=0;
a_G8:a_booland(to_LIST(a_1032)->offset[a_F1-4],16384,a_L5);
if(!a_noteq(a_L5,0)){ goto a_G11;}
a_F1=to_LIST(a_1032)->offset[a_F1-2]; goto a_G8;
a_G11:if(!a_more(a_L3,a_L4)){ goto a_G14;}
a_1041(a_F1,8);
a_1068=to_LIST(a_1032)->offset[a_F1-3]; goto a_G18;
a_G14:a_booland(to_LIST(a_1032)->offset[a_F1-4],8,a_L5);
if(!a_noteq(a_L5,0)){ goto a_G18;}
a_1064(to_LIST(a_1032)->offset[a_F1],a_P);a_F1=a_P[0];
a_incr(a_L3); goto a_G8;
a_G18:a_1061(a_F1,a_P);a_A[0]=a_P[0]; return;
} /* findreallabel */
...
static void a_1071(int a_F1,int a_F2){ /* marknode+>a+>a */
int a_P[1];
...
a_1052(a_P);a_L1=a_P[0];
a_L2=0;a_L3=0;
a_G3:if(!a_equal(16777220,a_1456)){ goto a_G8;}
a_1463();
a_1071(0,a_L2);
a_L2=a_L3;
...
a_1463(); goto a_G5;
a_G4:a_1417(a_1001,2130705103); return;
a_G5:if(!a_equal(16777455,a_1456)){ goto a_G4;}
...
a_1463();
a_L7=to_LIST(a_1442)->aupb;
a_L2=0;a_L5=0;a_L6=0;
a_G19:if(!a_equal(16777433,a_1456)){ goto a_G25;}
a_1463();
if(!a_equal(16777433,a_1456)){ goto a_G4;}

a_1463(); goto a_G34;
a_G25:a_1100(a_P);a_L1=a_P[0];
...
a_G34:a_1053(to_LIST(a_1032)->offset[a_1103-1],a_P);a_L3=a_P[0];
a_1053(to_LIST(a_1032)->offset[a_1103],a_P);a_L4=a_P[0];
a_1116(to_LIST(a_1032)->offset[a_1103-3],a_L2,a_L3,a_L4,a_L5,a_L6,a_L7);
a_unstackto(a_1442,a_L7); return;
} /* generaterulecall */
static void a_1057(void){ /* generateextension */
int a_L1;int a_L2;int a_L3;int a_L4;int a_P[2];
a_L1=to_LIST(a_1442)->aupb;
a_1099(0);
if(!a_equal(16777455,a_1456)){ goto a_G6;}
a_L2=a_1457;
a_1463(); goto a_G7;
a_G6:a_1417(a_1001,2130705103); return;
a_G7:a_add(a_L1,1,a_L3);
to_LIST(a_1442)->offset[a_L3]=a_L2;
a_P[0]=0;a_1076(1,a_P);
a_L3=to_LIST(a_1442)->aupb;
a_G11:a_1097();
a_P[0]=16777436;a_1076(1,a_P);
a_G13:if(!a_equal(16777288,a_1456)){ goto a_G20;}
a_1463();
if(!a_equal(16777455,a_1456)){ goto a_G6;}
a_L2=a_1457;
a_1463();
a_P[0]=a_L2;a_1076(1,a_P); goto a_G13;
a_G20:if(!a_equal(16777433,a_1456)){ goto a_G26;}
a_L4=a_1457;
a_1463();
a_1053(a_L4,a_P);a_L4=a_P[0];
a_P[0]=-1;a_1076(1,a_P);
a_1110(a_L1,a_L4); goto a_G28;
a_G26:a_P[0]=-1;a_P[1]=0;a_1076(2,a_P);
{register int a_r1=to_LIST(a_1442)->aupb;to_LIST(a_1442)->offset[a_L3]=a_r1;a_L3=a_r1;} goto a_G11;
a_G28:a_unstackto(a_1442,a_L1); return;
} /* generateextension */
static void a_1054(void){ /* generatearea */
int a_L1;int a_L2;int a_P[2];
a_G1:a_1078(a_P);a_L1=a_P[0];a_L2=a_P[1];
a_P[0]=a_L1;a_P[1]=a_L2;a_1076(2,a_P);
if(!a_equal(16777442,a_1456)){ return;}
a_1463();
...
a_L1=0;
if(!a_equal(16777220,a_1456)){ goto a_G5;}

a_1463(); goto a_G6;
a_G5:a_1417(a_1001,2130705103); return;
a_G6:if(!a_equal(16777455,a_1456)){ goto a_G5;}

a_1463();
a_P[0]=0;a_1076(1,a_P);
if(a_equal(a_L1,0)){ goto a_G13;}
to_LIST(a_1442)->offset[a_L1]=to_LIST(a_1442)->aupb;
a_G13:a_L1=to_LIST(a_1442)->aupb;
a_P[0]=0;a_1076(1,a_P);
a_L2=to_LIST(a_1442)->aupb;
a_1054();
if(!a_equal(16777433,a_1456)){ goto a_G5;}
a_L3=a_1457;
a_1463();
a_1053(a_L3,a_P);to_LIST(a_1442)->offset[a_L2]=a_P[0];
if(!a_equal(16777220,a_1456)){ goto a_G25;}
a_1463();
a_P[0]=16777436;a_1076(1,a_P); goto a_G6;
a_G25:a_booland(to_LIST(a_1032)->offset[a_1103-4],2048,a_L4);
if(!a_noteq(a_L4,0)){ goto a_G29;}
a_unstackto(a_1442,a_L2);
a_P[0]=a_1026;a_P[1]=a_1025;a_P[2]=16777436;a_1076(3,a_P); return;
a_G29:a_P[0]=16777436;a_1076(1,a_P); return;
} /* generateareas */
static void a_1056(void){ /* generatebox */
int a_L1;int a_L2;int a_P[1];
a_L1=to_LIST(a_1442)->aupb;
...
a_G1:if(!a_equal(16777227,a_1456)){ goto a_G11;}
a_1463();
a_1036();
a_1088(4);
a_1090();
a_1039();
if(!a_equal(16777412,a_1456)){ goto a_G10;}

a_1463(); goto a_G1;
a_G10:a_1417(a_1001,2130705103); return;
a_G11:if(!a_equal(16777241,a_1456)){ goto a_G16;}
a_1463();
a_1036();
a_1088(2);
a_1094(); goto a_G1;
a_G16:if(!a_equal(16777281,a_1456)){ goto a_G22;}
a_1463();
a_1036();
a_1088(1);
a_1089();
a_1045(); goto a_G1;
a_G22:if(!a_equal(16777439,a_1456)){ goto a_G10;}
...
int a_L1;
a_L1=to_LIST(a_1442)->aupb;
a_G2:if(!a_equal(16777227,a_1456)){ goto a_G6;}
a_G3:a_1463();
a_1036();
a_1094(); goto a_G2;
a_G6:if(a_equal(16777241,a_1456)){ goto a_G3;}
if(!a_equal(16777281,a_1456)){ goto a_G15;}
a_1463();
a_1036();
a_1093();
a_1040(); goto a_G2;
a_G15:if(!a_equal(16777439,a_1456)){ goto a_G18;}

a_1463(); goto a_G19;
a_G18:a_1417(a_1001,2130705103); return;
a_G19:a_unstackto(a_1442,a_L1); return;
} /* scanii */
static void a_1086(void){ /* scaniii */

a_G1:if(!a_equal(16777227,a_1456)){ goto a_G10;}
a_1463();
a_1036();
a_1090();
a_1037();
a_G6:if(!a_equal(16777412,a_1456)){ goto a_G9;}

a_1463(); goto a_G1;
a_G9:a_1417(a_1001,2130705103); return;
a_G10:if(!a_equal(16777241,a_1456)){ goto a_G18;}
a_1463();
a_1036();
a_1049(); goto a_G6;
a_G18:if(!a_equal(16777281,a_1456)){ goto a_G23;}
a_1463();
a_1036();
a_1081();
a_1094(); goto a_G1;
a_G23:if(!a_equal(16777439,a_1456)){ goto a_G9;}

a_1463(); return;
} /* scaniii */
static void a_1087(void){ /* scaniv */
int a_L1;
a_G1:if(!a_equal(16777227,a_1456)){ goto a_G9;}
a_1463();
a_1058();
a_1056();
a_G5:if(!a_equal(16777412,a_1456)){ goto a_G8;}

a_1463(); goto a_G1;
a_G8:a_1417(a_1001,2130705103); return;
a_G9:if(!a_equal(16777241,a_1456)){ goto a_G17;}
a_1463();
a_1058();
a_1057(); goto a_G5;
a_G17:if(!a_equal(16777281,a_1456)){ goto a_G31;}
a_1463();
a_1058();
a_booland(to_LIST(a_1032)->offset[a_1103-4],16384,a_L1);
if(!a_noteq(a_L1,0)){ goto a_G23;}
a_G22:a_1094(); goto a_G1;
a_G23:a_booland(to_LIST(a_1032)->offset[a_1103-4],8,a_L1);
if(a_noteq(a_L1,0)){ goto a_G22;}
a_1059(); goto a_G5;
a_G31:if(!a_equal(16777439,a_1456)){ goto a_G8;}
...
a_L4=a_1457;
a_1463();
if(!a_1326(a_L1,16384)){ goto a_G15;}
a_1092(); return;
a_G15:a_1046();
a_1034=0;a_1063=0;
if(!a_1326(a_L1,16777216)){ goto a_G19;}
a_1102=1; goto a_G20;
a_G19:a_1102=0;
a_G20:a_L2=to_LIST(a_1442)->aupb;
a_1042();
a_1096(a_L3,a_L4);
a_1473();
a_1103=0;
...
a_1068=0;
a_1075();
if(a_is(a_1102)){ goto a_G32;}
if(!a_1326(a_L1,67108864)){ goto a_G32;}
a_1102=a_1063;
a_G32:if(a_1073()){ goto a_G36;}
a_1472();
a_1103=0;
a_1085();
a_G36:a_1050();
...
a_1103=0;
a_1086();
if(!a_is(a_1068)){ goto a_G44;}
a_P[0]=2047260052;a_P[1]=to_LIST(a_1288)->offset[a_L1-3];a_P[2]=to_LIST(a_1288)->offset[a_L1-2];a_P[3]=to_LIST(a_1288)->offset[a_1068-3];a_1418(4,a_P); return;
a_G44:a_1472();
a_1103=0;
a_1087();
a_1200(); return;
...
int a_L1;int a_P[3];
a_1397();
if(!a_openfile(a_1106,119,a_1446,to_LIST(a_1446)->aupb)){ goto a_G5;}
a_unstackstring(a_1446);
a_1206=1; return;
a_G5:a_getfileerror(a_1106,a_L1);
a_P[0]=2047260066;a_P[1]=to_LIST(a_1446)->aupb;a_P[2]=a_L1;a_1418(3,a_P); return;
} /* opentarget */
static void a_1131(void){ /* closetarget */
...
a_1131();
a_1397();
a_unlinkfile(a_1446,to_LIST(a_1446)->aupb);
a_unstackstring(a_1446); return;
} /* deletetarget */
static void a_1175(int a_F1){ /* printint+>a */
...
a_putchar(a_1106,45);
a_getabs(a_F1,a_F1);
a_1176(a_F1,48); return;
a_G12:a_1176(a_F1,48); return;
} /* printint */
static void a_1176(int a_F1,int a_F2){ /* printint1+>a+>a */
int a_L3;int a_L4;
...
static void a_1160(int a_F1){ /* localargument+>a */
...
static void a_1177(int a_F1,int a_F2){ /* printintindex+>a+>a */
...
static void a_1147(int a_F1){ /* formalargument+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_L2=0;a_L4=0;
...
static void a_1182(int a_F1){ /* printpidginrepr+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_1455(to_LIST(a_1288)->offset[a_F1],a_P);a_L2=a_P[0];
a_L4=1;
a_G3:if(!a_stringelem(a_1446,a_L2,a_L4,a_P)){ return;}a_L3=a_P[0];
a_putchar(a_1106,a_L3);
a_incr(a_L4); goto a_G3;
} /* printpidginrepr */
static void a_1173(int a_F1){ /* printexternalrepr+>a */

{register int a_r1=to_LIST(a_1288)->offset[a_F1-5];
...
static void a_1184(int a_F1){ /* printrepr+>a */

if(!a_was(a_1288,a_F1)){ goto a_G9;}
if(!a_1326(a_F1,16)){ goto a_G4;}
a_1173(a_F1); return;
a_G4:{register int a_r1=to_LIST(a_1288)->offset[a_F1-5];
...
static void a_1179(int a_F1){ /* printlocallabel+>a */

a_1178();
a_1175(a_F1); return;
} /* printlocallabel */
static void a_1174(int a_F1){ /* printgoto+>a */

{ if(a_F1==0||a_F1==-1){ goto a_G2;}
 if(a_F1==-2){  goto a_G5;}
  goto a_G6;}
a_G2:if(!a_1326(a_1209,512)){ goto a_G4;}
a_1485(a_1106,a_1001,2130706050); return;
a_G4:a_1485(a_1106,a_1001,2130706045); return;
a_G5:a_1485(a_1106,a_1001,2130706040); return;
a_G6:a_1485(a_1106,a_1001,2130706035);
a_1179(a_F1);
...
static void a_1171(int a_F1){ /* printBUFFER+>a */
...
{register int a_r1=to_LIST(a_1442)->offset[a_F1];
 ...
 if(a_r1==16777475){  goto a_G10;}
  goto a_G12;}
a_G2:a_incr(a_F1);
a_1184(to_LIST(a_1442)->offset[a_F1]); return;
a_G4:a_incr(a_F1);
a_1175(to_LIST(a_1442)->offset[a_F1]); return;
a_G6:a_incr(a_F1);
a_1160(to_LIST(a_1442)->offset[a_F1]); return;
a_G8:a_incr(a_F1);
a_1181(to_LIST(a_1442)->offset[a_F1]); return;
a_G10:a_incr(a_F1);
a_1147(to_LIST(a_1442)->offset[a_F1]); return;
a_G12:a_1422(a_1001,2130706031); return;
} /* printBUFFER */
static void a_1183(int a_F1){ /* printptr+>a */
int a_P[1];
a_G1:if(!a_was(a_1288,a_F1)){ goto a_G3;}
a_F1=to_LIST(a_1288)->offset[a_F1-3]; goto a_G1;
a_G3:if(!a_was(a_1446,a_F1)){ goto a_G6;}
a_1455(a_F1,a_P);a_F1=a_P[0];
a_1485(a_1106,a_1446,a_F1); return;
a_G6:if(!a_was(a_1415,a_F1)){ goto a_G8;}
a_1485(a_1106,a_1415,a_F1); return;
a_G8:if(!a_was(a_1442,a_F1)){ goto a_G10;}
a_1171(a_F1); return;
a_G10:if(!a_equal(a_F1,0)){ goto a_G12;}
a_1485(a_1106,a_1001,2130706026); return;
a_G12:a_1422(a_1001,2130706022); return;
} /* printptr */
static void a_1180(int a_F1){ /* printnlptr+>a */
int a_L2;int a_L3;int a_P[1];
if(!a_was(a_1446,a_F1)){ goto a_G16;}
a_1455(a_F1,a_P);a_F1=a_P[0];
{register int a_r1=to_LIST(a_1442)->aupb;a_L2=a_r1;a_L3=a_r1;}
a_unpackstring(a_1446,a_F1,a_1442);
a_G5:if(!a_lseq(to_LIST(a_1442)->aupb,a_L3)){ goto a_G7;}
a_unstackto(a_1442,a_L2); return;
a_G7:a_incr(a_L3);
if(!a_noteq(to_LIST(a_1442)->offset[a_L3],37)){ goto a_G10;}
a_G9:a_putchar(a_1106,to_LIST(a_1442)->offset[a_L3]); goto a_G5;
a_G10:a_incr(a_L3);
if(a_less(to_LIST(a_1442)->aupb,a_L3)){ goto a_G5;}
if(!a_equal(to_LIST(a_1442)->offset[a_L3],110)){ goto a_G14;}
a_putchar(a_1106,10); goto a_G5;
a_G14:a_putchar(a_1106,37); goto a_G9;
a_G16:a_1183(a_F1); return;
} /* printnlptr */
static void a_1181(int a_F1){ /* printnumber+>a */
int a_L2;int a_L3;
{register int a_r1=to_LIST(a_1442)->aupb;a_L2=a_r1;a_L3=a_r1;}
a_1011(a_F1);
a_G3:if(!a_lseq(to_LIST(a_1442)->aupb,a_L3)){ goto a_G5;}
a_unstackto(a_1442,a_L2); return;
a_G5:a_incr(a_L3);
a_putchar(a_1106,to_LIST(a_1442)->offset[a_L3]); goto a_G3;
} /* printnumber */
static void a_1105(int a_F1,int a_C,int *a_V){ /* T+t[]+@+>a */
int a_L2;int a_L3;
a_L3=to_LIST(a_1442)->aupb;
a_unpackstring(a_F1,a_V[0],a_1442);
a_add(a_L3,1,a_L2);
a_G4:if(a_less(to_LIST(a_1442)->aupb,a_L2)){ goto a_G46;}
if(!a_noteq(to_LIST(a_1442)->offset[a_L2],37)){ goto a_G8;}
a_G6:a_putchar(a_1106,to_LIST(a_1442)->offset[a_L2]);
a_G7:a_incr(a_L2); goto a_G4;
a_G8:a_incr(a_L2);
if(!a_more(a_L2,to_LIST(a_1442)->aupb)){ goto a_G11;}
a_putchar(a_1106,37); goto a_G46;
a_G11:{register int a_r1=to_LIST(a_1442)->offset[a_L2];
...
a_G18:a_putchar(a_1106,63); goto a_G7;
a_G20:if(a_C<=1){ goto a_G22;} a_C--;a_V+=1;
a_1172(a_V[0]); goto a_G7;
a_G22:a_putchar(a_1106,63); goto a_G7;
a_G24:a_1183(183666549); goto a_G7;
a_G26:a_putchar(a_1106,10); goto a_G7;
a_G28:if(a_C<=1){ goto a_G30;} a_C--;a_V+=1;
a_1175(a_V[0]); goto a_G7;
a_G30:a_putchar(a_1106,63); goto a_G7;
a_G32:if(a_C<=1){ goto a_G34;} a_C--;a_V+=1;
a_1183(a_V[0]); goto a_G7;
a_G34:a_putchar(a_1106,63); goto a_G7;
a_G36:if(a_C<=1){ goto a_G38;} a_C--;a_V+=1;
a_1180(a_V[0]); goto a_G7;
a_G38:a_putchar(a_1106,63); goto a_G7;
a_G40:if(a_C<=1){ goto a_G42;} a_C--;a_V+=1;
a_1181(a_V[0]); goto a_G7;
a_G42:a_putchar(a_1106,63); goto a_G7;
a_G46:if(a_C<=1){ goto a_G48;} a_C--;a_V+=1;
a_1485(a_1106,a_1001,2130706017);
a_G48:a_unstackto(a_1442,a_L3); return;
} /* T */
static void a_1128(int a_A[1]){ /* calltracearg+a> */
int a_P[1];
if(!a_equal(a_1127,0)){ goto a_G3;}
a_A[0]=0; return;
a_G3:a_P[0]=2130706013;a_1105(a_1001,1,a_P);
a_A[0]=1; return;
} /* calltracearg */
static void a_1129(int a_A[1]){ /* calltracecall+a> */
int a_P[1];
if(!a_equal(a_1127,0)){ goto a_G3;}
a_A[0]=0; return;
a_G3:a_P[0]=2130706007;a_1105(a_1001,1,a_P);
a_A[0]=1; return;
} /* calltracecall */
static void a_1118(int a_F1){ /* addcallstack+>a */
int a_P[1];
if(a_equal(a_1127,0)){ return;}
if(!a_equal(a_F1,0)){ goto a_G4;}
a_P[0]=2130706003;a_1105(a_1001,1,a_P); return;
a_G4:a_P[0]=2130705992;a_1105(a_1001,1,a_P); return;
} /* addcallstack */
static void a_1211(void){ /* usecallstack */
...
a_P[0]=2130705981;a_P[1]=2;a_P[2]=0;a_P[3]=32;a_1105(a_1001,4,a_P);
...
a_P[0]=2130705962;a_P[1]=to_LIST(a_1288)->offset[a_L1-4];a_1105(a_1001,2,a_P); goto a_G2;
a_G7:a_P[0]=2130705956;a_P[1]=a_L1;a_P[2]=to_LIST(a_1288)->offset[a_L1-4];a_1105(a_1001,3,a_P); goto a_G2;
a_G8:if(a_equal(a_1127,0)){ goto a_G10;}
a_P[0]=2130705950;a_1105(a_1001,1,a_P);
a_G10:a_P[0]=2130705939;a_P[1]=183666544;a_1105(a_1001,2,a_P);
a_L1=0;
a_G12:a_P[0]=a_L1;if(!a_1316(1,a_P)){ return;}a_L1=a_P[0];a_L2=a_P[1];
a_P[0]=2130705939;a_P[1]=a_L2;a_1105(a_1001,2,a_P); goto a_G12;
} /* targetprelude */
static void a_1207(void){ /* targetpostlude */
int a_L1;int a_L2;int a_P[2];
a_L1=0;
a_G2:a_P[0]=a_L1;if(!a_1316(0,a_P)){ goto a_G4;}a_L1=a_P[0];a_L2=a_P[1];
a_P[0]=2130705939;a_P[1]=a_L2;a_1105(a_1001,2,a_P); goto a_G2;
a_G4:a_P[0]=2130705935;a_1105(a_1001,1,a_P); return;
} /* targetpostlude */
static void a_1202(int a_F1,int a_A[1]){ /* ruletyper+>a+a> */
int a_P[2];
if(!a_1326(a_F1,512)){ goto a_G3;}
a_P[0]=2130705930;a_P[1]=a_F1;a_1105(a_1001,2,a_P); goto a_G4;
a_G3:a_P[0]=2130705924;a_P[1]=a_F1;a_1105(a_1001,2,a_P);
a_G4:a_1128(a_P);a_A[0]=a_P[0]; return;
} /* ruletyper */
static void a_1122(int a_A[1]){ /* argsep+>a> */

if(!a_equal(a_A[0],0)){ goto a_G3;}
a_A[0]=1; return;
a_G3:a_putchar(a_1106,44); return;
} /* argsep */
static void a_1166(int a_F1,int a_A[1]){ /* outargs+>a+>a> */
int a_P[2];
if(a_equal(a_F1,0)){ return;}
a_P[0]=a_A[0];a_1122(a_P);a_A[0]=a_P[0];
a_P[0]=2130705918;a_P[1]=a_F1;a_1105(a_1001,2,a_P); return;
} /* outargs */
static void a_1198(int a_F1,int a_F2){ /* ruleargs+>a+>a */
...
a_P[0]=2130705913;a_1105(a_1001,1,a_P); return;
a_G13:a_P[0]=a_F2;a_1122(a_P);a_F2=a_P[0];
a_P[0]=2130705907;a_P[1]=a_L4;a_1105(a_1001,2,a_P); goto a_G3;
a_G15:a_P[0]=a_F2;a_1166(a_L6,a_P);a_F2=a_P[0];
if(a_is(a_F2)){ goto a_G18;}
a_P[0]=2130705902;a_1105(a_1001,1,a_P);
a_G18:a_putchar(a_1106,41); return;
} /* ruleargs */
static void a_1212(int a_F1){ /* vardeclaration+>a */
int a_P[4];
if(a_1326(a_F1,16)){ return;}
a_P[0]=2130705898;a_P[1]=a_F1;a_P[2]=to_LIST(a_1288)->offset[a_F1-1];a_P[3]=a_F1;a_1105(a_1001,4,a_P); return;
} /* vardeclaration */
static void a_1124(int a_F1,int a_F2,int a_F3){ /* blockdeclaration+>a+>a+>a */
int a_P[3];
a_P[0]=2130705889;a_P[1]=a_F1;a_1105(a_1001,2,a_P);
if(!a_equal(a_F2,0)){ goto a_G4;}
a_P[0]=2130705883;a_1105(a_1001,1,a_P); goto a_G5;
a_G4:a_P[0]=2130705880;a_P[1]=a_F2;a_P[2]=a_F3;a_1105(a_1001,3,a_P);
a_G5:a_P[0]=2130705876;a_P[1]=a_F1;a_1105(a_1001,2,a_P); return;
} /* blockdeclaration */
static void a_1201(int a_F1){ /* ruleprototype+>a */
int a_L2;int a_P[2];
...
a_1198(a_F1,a_L2);
a_P[0]=2130705870;a_P[1]=a_F1;a_1105(a_1001,2,a_P); return;
} /* ruleprototype */
static void a_1197(int a_F1){ /* rootprototype+>a */
int a_L2;int a_P[2];
a_1202(a_F1,a_P);a_L2=a_P[0];
a_1198(a_F1,a_L2);
if(!a_equal(to_LIST(a_1288)->offset[a_F1-4],183666554)){ goto a_G5;}
a_P[0]=2130705864;a_1105(a_1001,1,a_P); return;
a_G5:a_incr(a_1161);
a_P[0]=2130705856;a_P[1]=to_LIST(a_1288)->offset[a_F1-4];a_1105(a_1001,2,a_P); return;
} /* rootprototype */
static void a_1134(void){ /* datadeclaration */
int a_L1;int a_L2;int a_L3;int a_L4;int a_P[4];
a_L1=to_LIST(a_1288)->alwb;
a_L2=0;a_L3=0;
a_G3:if(a_more(a_L1,to_LIST(a_1288)->aupb)){ goto a_G19;}
if(!a_1326(a_L1,8)){ goto a_G6;}
a_G5:a_next(a_1288,a_L1); goto a_G3;
a_G6:{register int a_r1=to_LIST(a_1288)->offset[a_L1-5];
...
a_G19:a_L4=0;
a_G20:a_P[0]=a_L4;if(!a_1316(2,a_P)){ goto a_G22;}a_L4=a_P[0];a_L1=a_P[1];
a_1197(a_L1); goto a_G20;
a_G22:if(!a_equal(a_L2,0)){ goto a_G24;}
a_P[0]=2130705849;a_P[1]=2047260088;a_1105(a_1001,2,a_P); goto a_G25;
a_G24:a_P[0]=2130705843;a_P[1]=2047260088;a_P[2]=a_L2;a_P[3]=a_L3;a_1105(a_1001,4,a_P);
a_G25:a_P[0]=2130705835;a_P[1]=2047260088;a_1105(a_1001,2,a_P); return;
} /* datadeclaration */
static void a_1187(int a_F1){ /* pushBUFFER+>a */
...
static void a_1143(void){ /* filltablehead */
int a_P[1];
a_P[0]=2130705827;a_1105(a_1001,1,a_P);
a_1145=0; return;
} /* filltablehead */
static void a_1144(void){ /* filltabletail */
int a_P[2];
a_P[0]=2130705815;a_P[1]=a_1145;a_1105(a_1001,2,a_P); return;
} /* filltabletail */
static void a_1210(int a_A[1]){ /* untilnextcomma+>a> */

a_G1:if(!a_more(a_A[0],to_LIST(a_1442)->aupb)){ goto a_G3;}
a_1422(a_1001,2130705805); return;
a_G3:if(!a_equal(to_LIST(a_1442)->offset[a_A[0]],44)){ goto a_G6;}
a_putchar(a_1106,44);
a_incr(a_A[0]); return;
a_G6:a_putchar(a_1106,to_LIST(a_1442)->offset[a_A[0]]);
a_incr(a_A[0]); goto a_G1;
} /* untilnextcomma */
static void a_1132(void){ /* constitem */
int a_L1;
if(!a_equal(a_1456,16777459)){ goto a_G4;}
a_1011(a_1457);
a_1463(); return;
a_G4:if(!a_equal(16777471,a_1456)){ goto a_G7;}
a_L1=a_1457;
a_1463(); goto a_G8;
a_G7:a_1417(a_1001,2130705139); return;
a_G8:if(!a_1326(a_L1,8)){ goto a_G10;}
a_L1=to_LIST(a_1288)->offset[a_L1];
a_G10:a_1011(to_LIST(a_1288)->offset[a_L1]); return;
} /* constitem */
static void a_1141(int a_A[1]){ /* fillitem+a> */

if(!a_equal(16777427,a_1456)){ goto a_G9;}
a_1463();
a_A[0]=0;
a_G4:if(!a_equal(16777406,a_1456)){ goto a_G6;}
a_1463(); return;
a_G6:a_incr(a_A[0]);
a_1132();
a_1187(44); goto a_G4;
...
static int a_1142(int a_A[1]){ /* fillrepeater+a> */
int a_L2;int a_P[1];
if(!a_equal(16777445,a_1456)){ return 0;}
a_1463();
if(!a_equal(16777455,a_1456)){ goto a_G6;}
a_A[0]=a_1457;
a_1463(); return 1;
a_G6:if(!a_equal(16777471,a_1456)){ goto a_G9;}
a_L2=a_1457;
a_1463(); goto a_G10;
a_G9:a_1417(a_1001,2130705139); return 1;
...
a_G1:if(!a_equal(16777409,a_1456)){ return;}
a_1463();
if(!a_equal(16777471,a_1456)){ goto a_G6;}

a_1463(); goto a_G1;
a_G6:a_1417(a_1001,2130705139); return;
} /* skipfillinitializer */
static void a_1149(void){ /* generatefillentries */
...
a_L1=a_1457;
a_1463(); goto a_G5;
a_G4:a_1417(a_1001,2130705139); return;
a_G5:if(!a_1326(a_L1,8)){ goto a_G7;}
a_L1=to_LIST(a_1288)->offset[a_L1];
a_G7:if(!a_equal(16777455,a_1456)){ goto a_G4;}

a_1463();
a_incr(a_1145);
a_P[0]=2130705796;a_P[1]=a_L1;a_P[2]=a_L1;a_1105(a_1001,3,a_P);
a_L2=to_LIST(a_1442)->aupb;
a_L3=0;
a_G15:if(!a_equal(16777439,a_1456)){ goto a_G17;}
a_1463(); goto a_G26;
a_G17:a_1141(a_P);a_L4=a_P[0];
if(!a_1142(a_P)){ goto a_G24;}a_L5=a_P[0];
a_1146(a_L3,a_L4,a_L2);
a_P[0]=2130705790;a_P[1]=a_L5;a_1105(a_1001,2,a_P);
a_incr(a_1145);
a_unstackto(a_1442,a_L2);
a_L3=0; goto a_G25;
a_G24:a_add(a_L3,a_L4,a_L3);
a_G25:a_1204(); goto a_G15;
a_G26:a_1146(a_L3,0,a_L2);
a_unstackto(a_1442,a_L2);
a_incr(a_1145);
a_P[0]=2130705786;a_1105(a_1001,1,a_P); return;
} /* generatefillentries */
static void a_1159(int a_F1,int a_F2){ /* listinitialization+>a+>a */
...
a_P[0]=2130705782;a_P[1]=a_L4;a_P[2]=a_F2;a_P[3]=a_F2;a_P[4]=a_L3;a_1105(a_1001,5,a_P); return;
a_G5:a_1310(a_F2,a_P);a_L3=a_P[0];
a_1321(a_F2,a_P);a_L5=a_P[0];
a_1320(a_F2,a_P);a_L4=a_P[0];
a_1313(a_F2,a_P);a_L6=a_P[0];
a_P[0]=2130705775;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_F2;a_P[4]=a_L3;a_P[5]=a_L4;a_P[6]=a_L5;a_P[7]=a_L6;a_P[8]=a_F2;a_1105(a_1001,9,a_P); return;
} /* listinitialization */
static void a_1130(int a_F1){ /* charfileinitialization+>a */
int a_L2;int a_L3;int a_L4;int a_P[7];
if(!a_1326(a_F1,16)){ goto a_G3;}
a_P[0]=2130705760;a_P[1]=to_LIST(a_1288)->offset[a_F1-1];a_P[2]=a_F1;a_P[3]=a_F1;a_1105(a_1001,4,a_P); return;
...
a_G11:a_P[0]=2130705754;a_P[1]=a_F1;a_P[2]=a_F1;a_P[3]=a_L2;a_P[4]=a_L3;a_P[5]=a_L4;a_P[6]=a_F1;a_1105(a_1001,7,a_P); return;
} /* charfileinitialization */
static void a_1133(int a_F1,int a_A[1]){ /* countfilearea+>a+a> */
int a_L3;int a_P[1];
a_A[0]=1;
...
static void a_1135(int a_F1){ /* datafileinitialization+>a */
...
a_L3=to_LIST(a_1288)->offset[a_L3];
a_G12:a_P[0]=2130705740;a_P[1]=a_F1;a_P[2]=a_F1;a_P[3]=a_L2;a_P[4]=a_L3;a_P[5]=a_L4;a_P[6]=a_L6;a_P[7]=a_F1;a_1105(a_1001,8,a_P);
a_L6=1;
a_G14:a_1311(a_F1,a_L6,a_P);a_L5=a_P[0];
if(a_equal(a_L5,0)){ return;}
if(!a_1326(a_L5,8)){ goto a_G18;}
a_L5=to_LIST(a_1288)->offset[a_L5];
a_G18:a_P[0]=2130705726;a_P[1]=a_F1;a_P[2]=a_L5;a_P[3]=a_L6;a_P[4]=a_L5;a_1105(a_1001,5,a_P);
a_incr(a_L6); goto a_G14;
} /* datafileinitialization */
static void a_1136(void){ /* datainitialization */
int a_L1;int a_P[3];
a_P[0]=2130705714;a_1105(a_1001,1,a_P);
a_P[0]=2130705703;a_P[1]=183666527;a_P[2]=183666534;a_1105(a_1001,3,a_P);
a_L1=to_LIST(a_1288)->alwb;
a_G4:if(a_more(a_L1,to_LIST(a_1288)->aupb)){ goto a_G11;}
if(!a_1326(a_L1,8)){ goto a_G7;}
a_G6:a_next(a_1288,a_L1); goto a_G4;
a_G7:{register int a_r1=to_LIST(a_1288)->offset[a_L1-5];
...
a_G11:a_L1=to_LIST(a_1288)->alwb;
a_G12:if(a_more(a_L1,to_LIST(a_1288)->aupb)){ goto a_G19;}
if(!a_1326(a_L1,8)){ goto a_G15;}
a_G14:a_next(a_1288,a_L1); goto a_G12;
a_G15:{register int a_r1=to_LIST(a_1288)->offset[a_L1-5];
 if(a_r1==16777340){ goto a_G16;}
 if(a_r1==16777345){  goto a_G17;}
  goto a_G14;}
a_G16:a_1130(a_L1); goto a_G14;
a_G17:a_1135(a_L1); goto a_G14;
a_G19:a_P[0]=2130705691;a_1105(a_1001,1,a_P); return;
} /* datainitialization */
static void a_1185(void){ /* procwaitfor */
int a_L1;int a_L2;int a_L3;int a_P[3];
a_P[0]=2130705682;a_1105(a_1001,1,a_P);
a_1128(a_P);a_L3=a_P[0];
a_P[0]=a_L3;a_1122(a_P);
a_P[0]=2130705674;a_1105(a_1001,1,a_P);
if(a_equal(a_1127,0)){ goto a_G7;}
a_P[0]=2130705667;a_1105(a_1001,1,a_P);
a_G7:a_L1=0;
...
a_P[0]=2130705656;a_P[1]=a_L2;a_P[2]=to_LIST(a_1288)->offset[a_L2-4];a_1105(a_1001,3,a_P); goto a_G8;
a_G11:a_P[0]=2130705648;a_1105(a_1001,1,a_P); return;
} /* procwaitfor */
static void a_1205(void){ /* targetmain */
int a_L1;int a_L2;int a_L3;int a_L4;int a_P[2];
if(a_equal(a_1213,0)){ goto a_G4;}
if(a_more(a_1161,0)){ goto a_G4;}
a_P[0]=2047260103;a_1438(1,a_P);
a_G4:if(!a_equal(a_1213,0)){ goto a_G6;}
if(a_equal(a_1161,0)){ goto a_G7;}
a_G6:a_1185();
a_G7:a_P[0]=2130705645;a_1105(a_1001,1,a_P);
if(a_equal(a_1127,0)){ goto a_G10;}
a_P[0]=2130705637;a_1105(a_1001,1,a_P);
a_G10:a_P[0]=2130705627;a_1105(a_1001,1,a_P);
a_L1=0;a_L4=0;
...
a_P[0]=2130705620;a_1105(a_1001,1,a_P);
a_1129(a_P);a_L3=a_P[0];
a_P[0]=a_L3;a_1122(a_P);
a_P[0]=2130705615;a_1105(a_1001,1,a_P);
a_G20:if(!a_is(a_L4)){ goto a_G24;}
a_P[0]=2130705611;a_P[1]=a_L4;a_1105(a_1001,2,a_P);
a_1129(a_P);
a_P[0]=2130705607;a_1105(a_1001,1,a_P); return;
a_G24:a_1417(a_1001,2130705603); return;
} /* targetmain */
static void a_1203(int a_F1){ /* showformalsascomment+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
...
{ if(a_L4==16777371){ goto a_G7;}
 ...
 if(!(a_L4==16777388)){a_area_failed(a_rulename,a_L4);}
  goto a_G13;}
a_G7:a_P[0]=2130705598;a_1105(a_1001,1,a_P); goto a_G3;
a_G8:a_P[0]=2130705595;a_1105(a_1001,1,a_P); goto a_G3;
a_G9:a_P[0]=2130705592;a_1105(a_1001,1,a_P); goto a_G3;
a_G10:a_P[0]=2130705588;a_1105(a_1001,1,a_P); goto a_G3;
a_G11:a_P[0]=2130705584;a_1105(a_1001,1,a_P); goto a_G3;
a_G12:a_P[0]=2130705580;a_1105(a_1001,1,a_P); goto a_G3;
a_G13:a_P[0]=2130705576;a_1105(a_1001,1,a_P); goto a_G3;
} /* showformalsascomment */
static void a_1138(int a_F1,int a_F2,int a_F3){ /* declarelocals+>a+>a+>a */
int a_P[2];
a_G1:if(a_equal(a_F1,0)){ return;}
if(a_more(a_F1,a_F2)){ return;}
if(!a_equal(to_LIST(a_1442)->offset[a_F3],0)){ goto a_G6;}
a_G4:a_incr(a_F1);
a_incr(a_F3); goto a_G1;
a_G6:a_P[0]=2130705573;a_P[1]=a_F1;a_1105(a_1001,2,a_P); goto a_G4;
} /* declarelocals */
static void a_1137(int a_F1,int a_F2,int a_F3,int a_F4){ /* declarecallargs+>a+>a+>a+>a */
int a_L5;int a_P[3];
if(a_equal(a_F3,0)){ goto a_G3;}
a_P[0]=2130705568;a_P[1]=a_F3;a_1105(a_1001,2,a_P);
a_G3:if(a_equal(a_F4,0)){ goto a_G6;}
a_1309(a_F1,a_P);a_L5=a_P[0];
a_P[0]=2130705563;a_P[1]=a_F4;a_P[2]=a_L5;a_1105(a_1001,3,a_P);
a_G6:a_putchar(a_1106,10); return;
} /* declarecallargs */
static void a_1199(int a_F1,int a_F2,int a_F3,int a_F4,int a_F5,int a_F6,int a_F7,int a_F8,int a_F9){ /* ruledeclarationhead+>a+>a+>a+>a+>a+>a+>a+>a+>a */
int a_L10;int a_P[2];
a_1209=a_F1;
a_1120();
a_1202(a_F1,a_P);a_L10=a_P[0];
a_1198(a_F1,a_L10);
a_P[0]=2130705551;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_1105(a_1001,2,a_P);
a_1203(a_F1);
a_P[0]=2130705547;a_1105(a_1001,1,a_P);
...
a_P[0]=2130705543;a_P[1]=a_F1;a_1105(a_1001,2,a_P);
a_G15:a_1118(a_F9);
a_1119();
a_1121(); return;
} /* ruledeclarationhead */
static void a_1200(void){ /* ruledeclarationtail */
int a_P[2];
a_P[0]=2130705531;a_P[1]=a_1209;a_1105(a_1001,2,a_P); return;
} /* ruledeclarationtail */
static void a_1120(void){ /* addprofilingdef */
int a_P[4];
if(!a_1326(a_1209,33554432)){ return;}
if(!a_equal(a_1158,0)){ goto a_G4;}
a_P[0]=2130705525;a_P[1]=to_LIST(a_1288)->offset[a_1209];a_P[2]=a_1209;a_1105(a_1001,3,a_P); goto a_G5;
a_G4:a_P[0]=2130705514;a_P[1]=to_LIST(a_1288)->offset[a_1209];a_P[2]=a_1209;a_P[3]=to_LIST(a_1288)->offset[a_1158];a_1105(a_1001,4,a_P);
a_G5:a_1158=a_1209; return;
} /* addprofilingdef */
static void a_1119(void){ /* addprofilingcount */
int a_P[2];
if(!a_1326(a_1209,33554432)){ return;}
a_P[0]=2130705502;a_P[1]=to_LIST(a_1288)->offset[a_1209];a_1105(a_1001,2,a_P); return;
} /* addprofilingcount */
static void a_1186(void){ /* profilingdeclaration */
int a_P[2];
a_P[0]=2130705494;a_1105(a_1001,1,a_P);
if(!a_equal(a_1158,0)){ goto a_G4;}
a_P[0]=2130705486;a_1105(a_1001,1,a_P); return;
a_G4:a_P[0]=2130705482;a_P[1]=to_LIST(a_1288)->offset[a_1158];a_1105(a_1001,2,a_P); return;
...
a_G9:a_P[0]=2130705477;a_P[1]=a_L2;a_1105(a_1001,2,a_P);
a_L3=0;
...
a_G17:a_P[0]=2130705468;a_1105(a_1001,1,a_P); return;
} /* addtracing */
static void a_1114(int a_F1,int a_F2){ /* Tlabel+>a+>a */
...
static void a_1157(int a_F1){ /* jumptolabel+>a */
int a_P[2];
if(a_equal(a_F1,a_1163)){ return;}
a_P[0]=2130705464;a_P[1]=a_F1;a_1105(a_1001,2,a_P); return;
} /* jumptolabel */
static void a_1107(int a_F1){ /* Taffix+>a */
int a_P[1];
{register int a_r1=to_LIST(a_1442)->offset[a_F1];
...
static void a_1108(int a_A[1]){ /* Taffixinner+>a> */
int a_L2;int a_P[3];
{register int a_r1=to_LIST(a_1442)->offset[a_A[0]];
 if(a_r1==16777475||a_r1==16777479||a_r1==16777471){ goto a_G2;}
 if(a_r1==16777459){ goto a_G2;}
 if(a_r1==16777448){  goto a_G8;}
  goto a_G10;}
a_G2:a_P[0]=2130705460;a_P[1]=a_A[0];a_1105(a_1001,2,a_P);
a_G3:a_incr(a_A[0]);
a_incr(a_A[0]); return;
a_G8:a_incr(a_A[0]);
a_P[0]=a_A[0];a_1112(a_P);a_A[0]=a_P[0]; return;
a_G10:a_1115(to_LIST(a_1442)->offset[a_A[0]],a_P);a_L2=a_P[0];
a_incr(a_A[0]);
a_P[0]=2130705457;a_P[1]=a_A[0];a_P[2]=a_L2;a_1105(a_1001,3,a_P); goto a_G3;
} /* Taffixinner */
static void a_1115(int a_F1,int a_A[1]){ /* Tlimittail+>a+a> */
...
a_G7:a_1422(a_1001,2130705451); return;
} /* Tlimittail */
static void a_1112(int a_A[1]){ /* Tindex+>a> */
int a_L2;int a_P[2];
if(!a_1326(a_1209,67108864)){ goto a_G13;}
a_P[0]=2130705446;a_P[1]=a_A[0];a_1105(a_1001,2,a_P);
a_1129(a_P);a_L2=a_P[0];
a_P[0]=a_L2;a_1122(a_P);
a_P[0]=2130705436;a_P[1]=a_A[0];a_1105(a_1001,2,a_P);
a_incr(a_A[0]);
a_incr(a_A[0]);
a_P[0]=a_A[0];a_1108(a_P);a_A[0]=a_P[0];
a_incr(a_A[0]);
a_subtr(to_LIST(a_1442)->offset[a_A[0]],1,a_L2);
a_incr(a_A[0]);
a_P[0]=2130705433;a_P[1]=a_L2;a_1105(a_1001,2,a_P); return;
a_G13:a_P[0]=2130705426;a_P[1]=a_A[0];a_1105(a_1001,2,a_P);
a_incr(a_A[0]);
a_incr(a_A[0]);
a_P[0]=a_A[0];a_1108(a_P);a_A[0]=a_P[0];
a_incr(a_A[0]);
...
a_P[0]=2130705418;a_1105(a_1001,1,a_P); return;
a_G22:a_P[0]=2130705415;a_P[1]=a_L2;a_1105(a_1001,2,a_P); return;
} /* Tindex */
static void a_1140(int a_F1,int a_F2,int a_F3){ /* extensionblock+>a+>a+>a */
int a_L4;int a_L5;int a_P[3];
a_incr(a_F3);
a_L4=a_F3;
a_G3:if(a_equal(to_LIST(a_1442)->offset[a_L4],16777436)){ goto a_G5;}
a_incr(a_L4); goto a_G3;
a_G5:a_incr(a_L4);
a_G6:if(a_less(to_LIST(a_1442)->offset[a_L4],0)){ goto a_G11;}
a_subtr(a_F1,to_LIST(a_1442)->offset[a_L4],a_L5);
a_incr(a_L5);
a_incr(a_L4);
a_P[0]=2130705411;a_P[1]=a_F2;a_P[2]=a_L5;a_1105(a_1001,3,a_P); goto a_G6;
a_G11:a_1107(a_F3);
a_putchar(a_1106,59); return;
} /* extensionblock */
static void a_1110(int a_F1,int a_F2){ /* Textension+>a+>a */
int a_L3;int a_L4;int a_P[3];
a_incr(a_F1);
a_L4=to_LIST(a_1442)->offset[a_F1];
a_incr(a_F1);
a_L3=a_F1;
a_P[0]=2130705403;a_P[1]=a_L3;a_P[2]=a_L4;a_1105(a_1001,3,a_P);
a_add(2,a_F1,a_F1);
a_G7:a_1140(a_L4,a_L3,a_F1);
a_F1=to_LIST(a_1442)->offset[a_F1];
if(!a_equal(a_F1,0)){ goto a_G7;}
a_P[0]=2130705395;a_P[1]=a_L3;a_P[2]=a_L4;a_1105(a_1001,3,a_P);
a_1157(a_F2); return;
} /* Textension */
static int a_1164(int a_F1,int a_F2){ /* numbersequal+>a+>a */
int a_L3;int a_P[1];
...
static void a_1125(int a_F1,int a_A[1]){ /* boxclassifier+>a+a> */
int a_P[2];
{register int a_r1=to_LIST(a_1442)->offset[a_F1];
...
a_P[0]=2130705386;a_P[1]=a_A[0];a_1105(a_1001,2,a_P);
a_1107(a_F1);
a_P[0]=2130705380;a_1105(a_1001,1,a_P); return;
} /* boxclassifier */
static int a_1154(int a_F1){ /* iscompletearea+>a */

if(!a_equal(to_LIST(a_1442)->offset[a_F1],0)){ return 0;}
a_incr(a_F1);
a_incr(a_F1);
if(!a_equal(to_LIST(a_1442)->offset[a_F1],a_1026)){ return 0;}
a_incr(a_F1);
if(!a_equal(to_LIST(a_1442)->offset[a_F1],a_1025)){ return 0;} return 1;
} /* iscompletearea */
static void a_1117(int a_F1,int a_F2,int a_F3){ /* Tsingleifcondition+>a+>a+>a */
int a_P[5];
if(!a_1164(a_F1,a_F2)){ goto a_G3;}
a_P[0]=2130705377;a_P[1]=a_F3;a_P[2]=a_F1;a_1105(a_1001,3,a_P); return;
a_G3:if(!a_1164(a_F1,a_1026)){ goto a_G5;}
a_P[0]=2130705373;a_P[1]=a_F3;a_P[2]=a_F2;a_1105(a_1001,3,a_P); return;
a_G5:if(!a_1164(a_F2,a_1025)){ goto a_G7;}
a_P[0]=2130705369;a_P[1]=a_F3;a_P[2]=a_F1;a_1105(a_1001,3,a_P); return;
a_G7:a_P[0]=2130705365;a_P[1]=a_F1;a_P[2]=a_F3;a_P[3]=a_F3;a_P[4]=a_F2;a_1105(a_1001,5,a_P); return;
} /* Tsingleifcondition */
static void a_1111(int a_F1,int a_F2){ /* Tifcondition+>a+>a */
int a_L3;int a_L4;int a_P[1];
a_G1:a_incr(a_F1);
a_L3=to_LIST(a_1442)->offset[a_F1];
a_incr(a_F1);
a_L4=to_LIST(a_1442)->offset[a_F1];
a_1117(a_L3,a_L4,a_F2);
a_incr(a_F1);
if(!a_equal(to_LIST(a_1442)->offset[a_F1],16777442)){ return;}
a_P[0]=2130705358;a_1105(a_1001,1,a_P); goto a_G1;
} /* Tifcondition */
static void a_1113(int a_F1,int a_F2){ /* Tjumptoareas+>a+>a */
int a_L3;int a_L4;int a_L5;int a_P[2];
a_G1:a_L5=to_LIST(a_1442)->offset[a_F1];
if(!a_equal(a_L5,0)){ goto a_G10;}
a_incr(a_F1);
a_L3=to_LIST(a_1442)->offset[a_F1];
a_P[0]=2130705355;a_1105(a_1001,1,a_P);
a_1111(a_F1,a_F2);
a_P[0]=2130705351;a_P[1]=a_F2;a_1105(a_1001,2,a_P);
if(a_equal(a_L3,a_1163)){ return;}
a_P[0]=2130705340;a_P[1]=to_LIST(a_1442)->offset[a_F1];a_1105(a_1001,2,a_P); return;
a_G10:if(!a_1154(a_L5)){ goto a_G25;}
a_incr(a_F1);
a_L3=to_LIST(a_1442)->offset[a_F1];
a_incr(a_L5);
a_L4=to_LIST(a_1442)->offset[a_L5];
if(!a_equal(a_L3,a_1163)){ goto a_G20;}
if(a_equal(a_L3,a_L4)){ return;}
a_P[0]=2130705355;a_1105(a_1001,1,a_P);
a_1111(a_F1,a_F2);
a_P[0]=2130705337;a_P[1]=a_L4;a_1105(a_1001,2,a_P); return;
a_G20:a_P[0]=2130705332;a_1105(a_1001,1,a_P);
a_1111(a_F1,a_F2);
a_P[0]=2130705328;a_P[1]=a_L3;a_1105(a_1001,2,a_P);
if(a_equal(a_L4,a_1163)){ return;}
a_P[0]=2130705340;a_P[1]=a_L4;a_1105(a_1001,2,a_P); return;
a_G25:a_incr(a_F1);
a_P[0]=2130705332;a_1105(a_1001,1,a_P);
a_1111(a_F1,a_F2);
a_P[0]=2130705323;a_P[1]=to_LIST(a_1442)->offset[a_F1];a_1105(a_1001,2,a_P);
a_F1=a_L5; goto a_G1;
} /* Tjumptoareas */
static void a_1109(int a_F1,int a_F2){ /* Tbox+>a+>a */
int a_L3;int a_P[1];
a_P[0]=2130705319;a_1105(a_1001,1,a_P);
a_incr(a_F1);
a_1125(a_F1,a_P);a_L3=a_P[0];
a_incr(a_F2);
a_1113(a_F2,a_L3);
a_P[0]=2130705648;a_1105(a_1001,1,a_P); return;
} /* Tbox */
static void a_1116(int a_F1,int a_F2,int a_F3,int a_F4,int a_F5,int a_F6,int a_F7){ /* Trulecall+>a+>a+>a+>a+>a+>a+>a */
int a_L8;int a_L9;int a_P[3];
a_1126=a_F1;
a_incr(a_F7);
if(!a_1156(a_F7,a_F3,a_F4)){ goto a_G5;}
a_P[0]=2130705316;a_P[1]=a_F1;a_P[2]=a_F4;a_1105(a_1001,3,a_P); return;
...
static void a_1162(int a_A[1]){ /* nextaffix+>a> */

a_G1:if(!a_equal(to_LIST(a_1442)->offset[a_A[0]],16777436)){ goto a_G3;}
a_incr(a_A[0]); return;
a_G3:a_incr(a_A[0]); goto a_G1;
} /* nextaffix */
static int a_1155(int a_F1){ /* isdummyaffix+>a */

{register int a_r1=to_LIST(a_1442)->offset[a_F1];
 if(a_r1==16777424||a_r1==16777409){  return 1;}
  return 0;}
} /* isdummyaffix */
static int a_1153(int a_F1){ /* hasoutaffix+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
...
static int a_1156(int a_F1,int a_F2,int a_F3){ /* isrulediscarded+>a+>a+>a */
...
static void a_1151(int a_F1,int a_F2){ /* genshiftaffix+>a+>a */
int a_L3;int a_P[4];
...
a_G6:a_P[0]=2130705310;a_P[1]=a_L3;a_P[2]=a_F2;a_P[3]=a_F1;a_1105(a_1001,4,a_P); return;
a_G7:a_P[0]=2130705299;a_P[1]=a_F1;a_P[2]=a_L3;a_1105(a_1001,3,a_P); return;
} /* genshiftaffix */
static void a_1150(int a_F1,int a_F2,int a_F3){ /* gengetaffixno+>a+>a+>a */
int a_P[2];
if(!a_noteq(a_F1,2)){ goto a_G3;}
a_1417(a_1001,2130705289); return;
a_G3:if(a_1155(a_F2)){ return;}
a_1107(a_F2);
a_P[0]=2130705283;a_P[1]=a_F3;a_1105(a_1001,2,a_P); return;
} /* gengetaffixno */
static void a_1152(int a_F1,int a_F2){ /* genwaitfor+>a+>a */
int a_L3;int a_P[2];
a_P[0]=2130705620;a_1105(a_1001,1,a_P);
a_1129(a_P);a_L3=a_P[0];
...
a_P[0]=a_L3;a_1122(a_P);
a_1107(a_F1);
a_P[0]=2130705278;a_P[1]=a_F2;a_1105(a_1001,2,a_P); return;
} /* genwaitfor */
static void a_1123(int a_F1,int a_F2,int a_A[2]){ /* assignmentsource+>a+>a+a>+a> */
int a_P[2];
{register int a_r1=to_LIST(a_1442)->offset[a_F1];
...
a_P[0]=2130705274;a_P[1]=2047260131;a_1105(a_1001,2,a_P);
a_G5:a_A[1]=1; return;
a_G6:a_A[1]=0; return;
a_G7:a_A[0]=2047260127;
a_P[0]=2130705267;a_P[1]=a_A[0];a_1105(a_1001,2,a_P);
a_1107(a_F1);
if(!a_is(a_F2)){ goto a_G12;}
a_P[0]=2130705260;a_P[1]=2047260131;a_1105(a_1001,2,a_P);
a_G12:a_putchar(a_1106,59); goto a_G5;
} /* assignmentsource */
static void a_1148(int a_F1,int a_F2,int a_F3,int a_F4){ /* genassignment+>a+>a+>a+>a */
...
a_incr(a_L9);
a_P[0]=a_F3;a_1162(a_P);a_F3=a_P[0];
{register int a_r1=to_LIST(a_1442)->offset[a_F3];
...
a_G26:a_P[0]=2130705257;a_P[1]=a_L6;a_1105(a_1001,2,a_P); goto a_G17;
a_G27:if(a_equal(a_F2,0)){ goto a_G29;}
a_P[0]=2130705253;a_P[1]=2047260131;a_P[2]=2047260131;a_P[3]=2047260131;a_P[4]=2047260131;a_P[5]=a_L6;a_1105(a_1001,6,a_P);
a_G29:if(a_equal(a_L7,0)){ goto a_G31;}
a_putchar(a_1106,125);
a_G31:a_P[0]=2130705242;a_P[1]=a_F4;a_1105(a_1001,2,a_P); return;
} /* genassignment */
static void a_1196(int a_F1,int a_F2,int a_F3,int a_F4){ /* repeatblockpreload+>a+>a+>a+>a */
int a_L5;int a_L6;int a_L7;int a_L8;int a_L9;int a_P[3];
a_incr(a_F1);
a_L5=to_LIST(a_1442)->offset[a_F1];
a_P[0]=a_F1;a_1162(a_P);a_F1=a_P[0];
a_L9=a_F3;
...
a_P[0]=2130705238;a_P[1]=a_F4;a_1105(a_1001,2,a_P);
a_1107(a_F1);
a_putchar(a_1106,59); goto a_G21;
a_G18:a_P[0]=2130705233;a_P[1]=a_F4;a_1105(a_1001,2,a_P);
a_1107(a_F1);
a_putchar(a_1106,59);
a_G21:a_incr(a_L9);
...
a_P[0]=2130705228;a_P[1]=a_F4;a_P[2]=a_L6;a_1105(a_1001,3,a_P); return;
} /* repeatblockpreload */
static void a_1192(int a_F1){ /* regularcallpreload+>a */
...
a_P[0]=2130705238;a_P[1]=a_L4;a_1105(a_1001,2,a_P);
a_incr(a_L4);
a_1107(a_F1);
...
static void a_1194(int a_F1,int a_F2,int a_F3){ /* repeatblockcall+>a+>a+>a */
int a_L4;int a_P[3];
if(a_equal(a_F2,0)){ goto a_G4;}
a_P[0]=a_F3;a_1122(a_P);a_F3=a_P[0];
a_P[0]=2130705216;a_1105(a_1001,1,a_P);
a_G4:a_incr(a_F1);
a_L4=to_LIST(a_1442)->offset[a_F1];
a_P[0]=a_F3;a_1122(a_P);
if(!a_equal(a_L4,0)){ goto a_G9;}
a_P[0]=2130705213;a_1105(a_1001,1,a_P); return;
a_G9:if(!a_less(a_L4,0)){ goto a_G12;}
a_subtr(0,a_L4,a_L4);
a_P[0]=2130705208;a_P[1]=a_L4;a_1105(a_1001,2,a_P); return;
a_G12:if(!a_equal(a_F2,0)){ goto a_G14;}
a_P[0]=2130705203;a_P[1]=a_L4;a_1105(a_1001,2,a_P); return;
a_G14:a_P[0]=2130705199;a_P[1]=a_L4;a_P[2]=a_F2;a_1105(a_1001,3,a_P); return;
} /* repeatblockcall */
static void a_1193(int a_F1){ /* regularrulecall+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_L6;int a_P[2];
a_1318(a_1126,a_P);a_L2=a_P[0];
a_P[0]=2130705194;a_P[1]=a_1126;a_1105(a_1001,2,a_P);
a_L3=0;a_L4=0;
...
a_P[0]=2130705191;a_1105(a_1001,1,a_P); return;
...
static void a_1195(int a_F1,int a_F2,int a_F3,int a_F4){ /* repeatblockpostload+>a+>a+>a+>a */
int a_L5;int a_L6;int a_L7;int a_L8;int a_L9;int a_P[3];
a_incr(a_F1);
a_L5=to_LIST(a_1442)->offset[a_F1];
a_P[0]=a_F1;a_1162(a_P);a_F1=a_P[0];
...
a_P[0]=2130705187;a_P[1]=a_F4;a_1105(a_1001,2,a_P); goto a_G20;
a_G19:a_P[0]=2130705182;a_P[1]=a_F4;a_1105(a_1001,2,a_P);
a_G20:a_incr(a_L7);
...
a_P[0]=2130705177;a_P[1]=a_F4;a_P[2]=a_L6;a_1105(a_1001,3,a_P); return;
} /* repeatblockpostload */
static void a_1191(int a_F1){ /* regularcallpostload+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_P[2];
a_1318(a_1126,a_P);a_L2=a_P[0];
a_L3=0;a_L4=0;
a_G3:if(a_equal(a_L3,a_L2)){ return;}
...
a_1107(a_F1);
a_P[0]=2130705187;a_P[1]=a_L4;a_1105(a_1001,2,a_P);
a_G11:a_incr(a_L4);
...
static void a_1188(int a_F1,int a_F2,int a_A[1]){ /* regularcalld1+>a+>a+a> */
int a_P[1];
...
a_G5:a_A[0]=2;
a_P[0]=2130705165;a_1105(a_1001,1,a_P); return;
a_G7:a_A[0]=1;
a_P[0]=2130705161;a_1105(a_1001,1,a_P); return;
a_G9:a_A[0]=0; return;
} /* regularcalld1 */
static void a_1189(int a_F1,int a_F2){ /* regularcalld2+>a+>a */
int a_P[2];
if(!a_equal(a_F1,1)){ goto a_G3;}
a_P[0]=2130705158;a_1105(a_1001,1,a_P); return;
a_G3:if(!a_equal(a_F1,2)){ goto a_G5;}
a_P[0]=2130705155;a_P[1]=a_F2;a_1105(a_1001,2,a_P); return;
a_G5:a_putchar(a_1106,59); return;
} /* regularcalld2 */
static void a_1190(int a_F1,int a_F2,int a_F3){ /* regularcalld3+>a+>a+>a */
int a_P[3];
if(!a_equal(a_F1,1)){ goto a_G4;}
a_P[0]=2130705151;a_P[1]=a_F3;a_P[2]=a_F2;a_1105(a_1001,3,a_P); return;
a_G4:a_P[0]=2130705242;a_P[1]=a_F3;a_1105(a_1001,2,a_P); return;
} /* regularcalld3 */
static void a_1167(int a_F1){ /* pidginalttagtail+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_1318(a_1126,a_P);a_L2=a_P[0];
a_L3=0;
a_G3:if(a_equal(a_L3,a_L2)){ return;}
...
if(!a_equal(to_LIST(a_1442)->offset[a_F1],16777424)){ goto a_G9;}
a_putchar(a_1106,48); goto a_G10;
a_G9:a_putchar(a_1106,49);
a_G10:if(a_equal(a_L4,16777388)){ return;}
a_P[0]=a_F1;a_1162(a_P);a_F1=a_P[0]; goto a_G3;
} /* pidginalttagtail */
static void a_1168(int a_F1){ /* pidginrepeatblock+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_incr(a_F1);
a_L2=to_LIST(a_1442)->offset[a_F1];
a_P[0]=a_F1;a_1162(a_P);a_F1=a_P[0];
a_1175(a_L2);
...
a_P[0]=2130705147;a_1105(a_1001,1,a_P); return;
} /* pidginrepeatblock */
static void a_1169(int a_F1,int a_F2){ /* pidginruleargs+>a+>a */
int a_L3;int a_L4;int a_L5;int a_L6;int a_P[1];
...
if(!a_is(a_F2)){ goto a_G12;}
if(a_equal(to_LIST(a_1442)->offset[a_F1],16777424)){ goto a_G14;}
a_G12:a_P[0]=a_L5;a_1122(a_P);a_L5=a_P[0];
a_1107(a_F1);
a_G14:a_P[0]=a_F1;a_1162(a_P);a_F1=a_P[0]; goto a_G3;
} /* pidginruleargs */
static void a_1170(int a_F1){ /* pidginrulecall+>a */
int a_L2;int a_P[2];
a_P[0]=2130705142;a_P[1]=a_1126;a_1105(a_1001,2,a_P);
...
static void a_1239(int a_F1){ /* pushEXPR+>a */

 a_extension(a_1216,1);to_LIST(a_1216)->top[1]=a_F1;to_LIST(a_1216)->aupb+=1;
  return;
} /* pushEXPR */
static void a_1231(int a_A[1]){ /* getitemdef+>a> */

if(!a_1326(a_A[0],8)){ return;}
a_A[0]=to_LIST(a_1288)->offset[a_A[0]]; return;
} /* getitemdef */
static void a_1223(int a_F1){ /* checklisttype+>a */

{register int a_r1=to_LIST(a_1288)->offset[a_F1-5];
 if(!(a_r1==16777318||a_r1==16777322||a_r1==16777328)){ goto a_G3;}
}
if(!a_1326(a_F1,24)){ return;}
a_G3:a_1417(a_1001,2130706099); return;
} /* checklisttype */
static void a_1221(int a_F1){ /* checkcalibretype+>a */

{register int a_r1=to_LIST(a_1288)->offset[a_F1-5];
 if(!(a_r1==16777318||a_r1==16777322||a_r1==16777328)){ goto a_G3;}
}
if(!a_1326(a_F1,8)){ return;}
a_G3:a_1417(a_1001,2130706093); return;
} /* checkcalibretype */
static void a_1222(int a_F1,int a_F2){ /* checkconstanttype+>a+>a */
...
a_G3:if(!a_1326(a_F1,24)){ return;} goto a_G7;
a_G5:if(!a_equal(a_F2,0)){ goto a_G3;}
a_G7:a_1417(a_1001,2130706086); return;
} /* checkconstanttype */
static void a_1240(void){ /* readexpression */
int a_L1;int a_L2;int a_P[1];
if(!a_equal(16777471,a_1456)){ goto a_G4;}
a_L1=a_1457;
a_1463(); goto a_G5;
a_G4:a_1417(a_1001,2130706058); return;
a_G5:a_1222(a_L1,1);
if(a_equal(to_LIST(a_1288)->offset[a_L1-1],0)){ goto a_G8;}
a_G7:a_1417(a_1001,2130706079); return;
a_G8:a_1239(a_L1);
a_L2=to_LIST(a_1216)->aupb;
a_1239(a_1232);
a_1232=a_L2;
to_LIST(a_1288)->offset[a_L1-1]=to_LIST(a_1216)->aupb;
a_G13:{ if(a_1456==16777439){ goto a_G14;}
 if(a_1456==16777459){ goto a_G16;}
 if(a_1456==16777471){ goto a_G19;}
 if(a_1456==16777269||a_1456==16777291){ goto a_G24;}
 if(a_1456==16777231){ goto a_G33;}
 if(a_1456==16777436||a_1456==16777421||a_1456==16777445||a_1456==16777418||a_1456==16777400||a_1456==16777430||a_1456==16777451||a_1456==16777415||a_1456==16777427||a_1456==16777406){  goto a_G42;}
  goto a_G7;}
a_G14:a_1463();
a_1239(16777439); return;
a_G16:a_1239(16777459);
a_1239(a_1457);
a_G18:a_1463(); goto a_G13;
a_G19:a_L1=a_1457;
...
a_G42:a_1239(a_1456); goto a_G18;
} /* readexpression */
static int a_1215(int a_F1){ /* E+>a */

if(!a_equal(to_LIST(a_1216)->offset[a_1225],a_F1)){ return 0;}
a_incr(a_1225); return 1;
} /* E */
static int a_1217(int a_A[1]){ /* Eitem+a> */

a_A[0]=to_LIST(a_1216)->offset[a_1225];
if(!a_was(a_1288,a_A[0])){ return 0;}
a_incr(a_1225); return 1;
} /* Eitem */
static int a_1218(int a_F1,int a_A[2]){ /* Eop+>a+a>+a> */
...
static void a_1238(int a_F1,int a_F2,int a_F3){ /* optor+>a+>a+>a */
...
static int a_1233(int a_A[1]){ /* loosebase+a> */
int a_P[1];
...
static int a_1236(int a_F1,int a_A[1]){ /* looseexpr+>a+a> */
int a_L3;int a_L4;int a_L5;int a_P[2];
if(!a_1233(a_P)){ return 0;}a_A[0]=a_P[0];
...
static void a_1241(int a_F1,int a_F2){ /* setfinalvalue+>a+>a */

a_1298(a_F2,64);
to_LIST(a_1288)->offset[a_F2]=a_F1;
a_1358(a_F2,32); return;
} /* setfinalvalue */
static void a_1234(int a_F1){ /* looseeval+>a */
int a_L2;int a_L3;int a_P[3];
if(!a_1326(a_F1,8)){ goto a_G3;}
a_1422(a_1001,2130706073); return;
a_G3:if(a_1326(a_F1,32)){ return;}
if(!a_1326(a_F1,64)){ goto a_G8;}
a_P[0]=2047260145;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_F1;a_1418(3,a_P);
...
a_1417(a_1001,2130706073); return;
...
static void a_1230(int a_F1,int a_F2,int a_A[1]){ /* getexprlimit+>a+>a+a> */
int a_P[1];
...
static void a_1226(int a_A[1]){ /* finalbase+a> */
int a_P[1];
if(!a_1215(16777427)){ goto a_G4;}
...
a_1310(to_LIST(a_1216)->offset[a_1225],a_P);a_A[0]=a_P[0];
a_1017(1,a_A[0],a_P);a_A[0]=a_P[0]; goto a_G6;
a_G17:if(!a_1215(16777269)){ goto a_G20;}
a_1230(16777269,to_LIST(a_1216)->offset[a_1225],a_P);a_A[0]=a_P[0]; goto a_G6;
a_G20:if(!a_1215(16777291)){ goto a_G23;}
a_1230(16777291,to_LIST(a_1216)->offset[a_1225],a_P);a_A[0]=a_P[0]; goto a_G6;
a_G23:if(!a_1217(a_P)){ goto a_G27;}a_A[0]=a_P[0];
a_P[0]=a_A[0];a_1231(a_P);a_A[0]=a_P[0];
a_1227(a_A[0]);
a_1017(0,to_LIST(a_1288)->offset[a_A[0]],a_P);a_A[0]=a_P[0]; return;
a_G27:a_1417(a_1001,2130706068); return;
} /* finalbase */
static void a_1229(int a_F1,int a_A[1]){ /* finalexpr+>a+a> */
int a_L3;int a_L4;int a_L5;int a_P[2];
a_1226(a_P);a_A[0]=a_P[0];
...
static void a_1227(int a_F1){ /* finaleval+>a */
int a_L2;int a_L3;int a_P[3];
if(!a_1326(a_F1,8)){ goto a_G3;}
a_1422(a_1001,2130706063); return;
a_G3:if(a_1326(a_F1,32)){ return;}
if(!a_1326(a_F1,64)){ goto a_G8;}
a_P[0]=2047260145;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_F1;a_1418(3,a_P);
...
a_incr(a_1225);
if(a_was(a_1216,a_1225)){ goto a_G14;}
a_1417(a_1001,2130706063); return;
...
static void a_1243(int a_F1,int a_A[1]){ /* storenumstring+>a+a> */
int a_L3;int a_P[1];
a_L3=to_LIST(a_1442)->aupb;
a_previous(a_1446,a_F1);
a_unpackstring(a_1446,a_F1,a_1442);
a_1007(0,a_L3,a_P);a_A[0]=a_P[0];
a_unstackto(a_1442,a_L3); return;
} /* storenumstring */
static int a_1242(int a_F1,int a_F2){ /* splitvirtualspace+>a+>a */
int a_L3;int a_L4;int a_L5;int a_P[1];
if(!a_1373(a_F1)){ return 0;}
if(!a_1373(a_F2)){ return 0;}
a_1243(183666527,a_P);a_L3=a_P[0];
a_1243(183666534,a_P);a_L4=a_P[0];
...
static void a_1237(int a_F1,int a_F2,int a_F3,int a_A[2]){ /* nextvirtualblock+>a+>a+>a+a>+a> */
...
static void a_1244(int a_F1,int a_F2,int a_A[1]){ /* virtualaddressoffset+>a+>a+a> */
int a_L4;int a_L5;int a_P[1];
a_1017(1,a_F2,a_P);a_L5=a_P[0];
...
static void a_1264(int a_A[1]){ /* getitemdef+>a> */
...
a_G1:if(!a_equal(16777439,a_1456)){ goto a_G3;}
a_1463(); return;
a_G3:if(!a_equal(16777486,a_1456)){ goto a_G6;}
a_1463();
a_1417(a_1001,2130706183); return;
a_G6:a_1463(); goto a_G1;
} /* skipentry */
static void a_1280(void){ /* skipdatasection */

a_G1:if(!a_equal(16777254,a_1456)){ goto a_G4;}
a_G2:a_1463();
a_1281(); goto a_G1;
a_G4:if(a_equal(16777236,a_1456)){ goto a_G2;}
if(a_equal(16777266,a_1456)){ goto a_G2;}
if(a_equal(16777250,a_1456)){ goto a_G2;}
if(a_equal(16777224,a_1456)){ goto a_G2;}
if(a_equal(16777258,a_1456)){ goto a_G2;}
if(a_equal(16777246,a_1456)){ goto a_G2;}
if(a_equal(a_1456,16777285)){ return;}
a_1417(a_1001,2130706178); return;
} /* skipdatasection */
static void a_1254(void){ /* datasectioni */

if(a_1439()){ return;}
a_G2:if(!a_equal(16777254,a_1456)){ goto a_G5;}
a_1463();
a_1282(); goto a_G2;
a_G5:if(!a_equal(16777236,a_1456)){ goto a_G8;}
a_1463();
a_1240(); goto a_G2;
a_G8:if(!a_equal(16777266,a_1456)){ goto a_G11;}
a_1463();
a_1266(); goto a_G2;
a_G11:if(!a_equal(16777250,a_1456)){ goto a_G14;}
a_1463();
a_1259(); goto a_G2;
a_G14:if(!a_equal(16777224,a_1456)){ goto a_G17;}
a_G15:a_1463();
a_1281(); goto a_G2;
a_G17:if(a_equal(16777258,a_1456)){ goto a_G15;}
if(a_equal(16777246,a_1456)){ goto a_G15;}
if(a_equal(a_1456,16777285)){ return;}
a_1417(a_1001,2130706172); return;
} /* datasectioni */
static void a_1251(int a_F1){ /* checklisttype+>a */

{register int a_r1=to_LIST(a_1288)->offset[a_F1-5];
 if(!(a_r1==16777318||a_r1==16777322||a_r1==16777328)){ goto a_G3;}
}
if(!a_1326(a_F1,24)){ return;}
a_G3:a_1417(a_1001,2130706166); return;
} /* checklisttype */
static void a_1247(int a_F1,int a_F2){ /* checkconstanttype+>a+>a */
...
a_G5:a_1417(a_1001,2130706160); return;
} /* checkconstanttype */
static void a_1249(int a_F1){ /* checkfillconstanttype+>a */
...
a_G3:a_1417(a_1001,2130706153); return;
} /* checkfillconstanttype */
static void a_1248(int a_F1){ /* checkfiletype+>a */

{register int a_r1=to_LIST(a_1288)->offset[a_F1-5];
 if(!(a_r1==16777340||a_r1==16777345)){ goto a_G3;}
}
if(!a_1326(a_F1,24)){ return;}
a_G3:a_1417(a_1001,2130706145); return;
} /* checkfiletype */
static void a_1259(void){ /* fileentry */
int a_L1;int a_L2;int a_L3;int a_P[1];
if(!a_equal(16777471,a_1456)){ goto a_G4;}
a_L1=a_1457;
a_1463(); goto a_G5;
a_G4:a_1417(a_1001,2130706103); return;
a_G5:a_1248(a_L1);
if(!a_equal(16777455,a_1456)){ goto a_G4;}
a_L2=a_1457;
a_1463();
...
a_G12:a_1358(a_L1,32);
a_G13:if(a_equal(a_L2,2)){ goto a_G15;}
if(!a_equal(a_L2,3)){ goto a_G16;}
a_G15:a_1358(a_L1,64);
a_G16:a_1346(a_L1);
if(!a_equal(16777439,a_1456)){ goto a_G4;}
...
a_1463();
a_1275(a_L1);
a_G12:if(!a_equal(16777439,a_1456)){ goto a_G14;}
a_1463(); return;
a_G14:a_1284();
a_1285(a_L1);
a_1283(a_L1); goto a_G12;
} /* skipfill */
static void a_1250(void){ /* checkfillitem */
int a_L1;
if(!a_equal(16777459,a_1456)){ goto a_G3;}
a_1463(); return;
a_G3:if(!a_equal(16777471,a_1456)){ goto a_G6;}
a_L1=a_1457;
a_1463(); goto a_G7;
a_G6:a_1417(a_1001,2130706103); return;
a_G7:a_1249(a_L1); return;
} /* checkfillitem */
static void a_1284(void){ /* skipfillitem */

if(!a_equal(16777427,a_1456)){ goto a_G6;}
a_1463();
a_G3:if(!a_equal(16777406,a_1456)){ goto a_G5;}
a_1463(); return;
a_G5:a_1250(); goto a_G3;
a_G6:a_1250(); return;
} /* skipfillitem */
static void a_1285(int a_F1){ /* skipfillrepeater+>a */
int a_L2;int a_L3;int a_P[4];
if(!a_equal(16777445,a_1456)){ return;}
a_1463();
if(!a_equal(16777455,a_1456)){ goto a_G9;}
a_L3=a_1457;
a_1463();
if(!a_lseq(1,a_L3)){ goto a_G8;}
if(a_lseq(a_L3,1000)){ return;}
a_G8:a_P[0]=2047260161;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_L3;a_P[3]=1000;a_1418(4,a_P); return;
a_G9:if(!a_equal(16777471,a_1456)){ goto a_G12;}
a_L2=a_1457;
a_1463(); goto a_G13;
a_G12:a_1417(a_1001,2130706103); return;
a_G13:a_1247(a_L2,1); return;
} /* skipfillrepeater */
static void a_1283(int a_F1){ /* skipfillinitializer+>a */
int a_L2;
a_G1:if(!a_equal(16777409,a_1456)){ return;}
a_1463();
if(!a_equal(16777471,a_1456)){ goto a_G6;}
...
a_G10:a_1417(a_1001,2130706139); return;
a_G11:to_LIST(a_1288)->offset[a_L2-1]=a_F1; goto a_G1;
} /* skipfillinitializer */
static void a_1275(int a_F1){ /* rememberlist+>a */
int a_L2;int a_P[1];
...
{ if(a_L2==0||a_L2==1||a_L2==2){ goto a_G11;}
 if(a_L2==3||a_L2==4){  goto a_G15;}
  goto a_G20;}
a_G11:if(!a_equal(16777455,a_1456)){ goto a_G4;}
a_L3=a_1457;
a_1463(); goto a_G21;
a_G15:if(!a_equal(16777471,a_1456)){ goto a_G4;}
a_L3=a_1457;
a_1463();
a_1247(a_L3,1); goto a_G21;
a_G20:a_1417(a_1001,2130706132); return;
a_G21:a_1344(a_L1,a_L2);
a_1343(a_L1,a_L3);
a_1275(a_L1);
if(!a_equal(16777439,a_1456)){ goto a_G4;}
...
static void a_1274(int a_F1,int a_F2){ /* relativesize+>a+>a */
int a_P[4];
if(a_less(a_F1,1)){ goto a_G3;}
if(!a_more(a_F1,100)){ goto a_G4;}
a_G3:a_P[0]=2047260176;a_P[1]=to_LIST(a_1288)->offset[a_F2-3];a_P[2]=a_F1;a_P[3]=a_F2;a_1438(4,a_P);
a_G4:a_min(100,a_F1);
a_max(1,a_F1);
a_subtr(0,a_F1,a_F1);
a_1344(a_F2,a_F1); return;
} /* relativesize */
static void a_1261(int a_F1,int a_F2){ /* fixsize+>a+>a */
int a_P[4];
if(a_less(a_F1,1)){ goto a_G3;}
if(!a_more(a_F1,100000)){ goto a_G4;}
a_G3:a_P[0]=2047260189;a_P[1]=to_LIST(a_1288)->offset[a_F2-3];a_P[2]=a_F1;a_P[3]=a_F2;a_1438(4,a_P);
a_G4:a_min(100000,a_F1);
a_max(1,a_F1);
a_1344(a_F2,a_F1); return;
} /* fixsize */
static int a_1262(int a_F1,int a_A[1]){ /* getconstvalue+>a+a> */
int a_P[1];
a_P[0]=a_F1;a_1264(a_P);a_F1=a_P[0];
if(!a_1326(a_F1,32)){ return 0;}
a_1014(to_LIST(a_1288)->offset[a_F1],a_P);a_A[0]=a_P[0]; return 1;
} /* getconstvalue */
static void a_1263(int a_F1,int a_F2,int a_A[1]){ /* getestimator+>a+>a+a> */
int a_P[4];
if(a_1262(a_F1,a_P)){a_A[0]=a_P[0]; return;}
a_A[0]=1;
a_P[0]=2047260201;a_P[1]=to_LIST(a_1288)->offset[a_F2-3];a_P[2]=to_LIST(a_1288)->offset[a_F1-3];a_P[3]=a_F2;a_1418(4,a_P); return;
} /* getestimator */
static void a_1255(void){ /* datasectionii */
...
a_G6:a_1463();
a_1281(); goto a_G2;
a_G8:if(a_equal(16777266,a_1456)){ goto a_G6;}
if(a_equal(16777250,a_1456)){ goto a_G6;}
if(!a_equal(16777224,a_1456)){ goto a_G17;}
a_1463();
a_1273(0); goto a_G2;
a_G17:if(!a_equal(16777258,a_1456)){ goto a_G20;}
a_1463();
a_1273(1); goto a_G2;
a_G20:if(!a_equal(16777246,a_1456)){ goto a_G23;}
a_1463();
a_1258(); goto a_G2;
a_G23:if(a_equal(a_1456,16777285)){ return;}
a_1422(a_1001,2130706127); return;
} /* datasectionii */
static void a_1258(void){ /* externalentry */
int a_L1;int a_L2;
if(!a_equal(16777471,a_1456)){ goto a_G4;}
...
a_1463(); goto a_G5;
a_G4:a_1417(a_1001,2130706103); return;
a_G5:if(!a_equal(16777483,a_1456)){ goto a_G4;}
a_L2=a_1457;
a_1463();
if(!a_equal(16777439,a_1456)){ goto a_G4;}

a_1463();
if(a_1326(a_L1,16)){ goto a_G15;}
a_G14:a_1417(a_1001,2130706121); return;
a_G15:if(a_1326(a_L1,8)){ goto a_G14;}
{register int a_r1=to_LIST(a_1288)->offset[a_L1-5];
 ...
 if(a_r1==16777318||a_r1==16777322){  goto a_G20;}
  goto a_G14;}
a_G18:to_LIST(a_1288)->offset[a_L1]=a_L2; return;
a_G19:to_LIST(a_1288)->offset[a_L1-1]=a_L2; return;
a_G20:a_1343(a_L1,a_L2); return;
} /* externalentry */
static void a_1273(int a_F1){ /* readmatter+>a */
int a_L2;
if(!a_equal(16777483,a_1456)){ goto a_G4;}
a_L2=a_1457;
a_1463(); goto a_G5;
a_G4:a_1417(a_1001,2130706103); return;
a_G5:if(!a_equal(16777439,a_1456)){ goto a_G4;}
...
a_L2=a_1457;
a_1463();
a_G10:if(!a_equal(16777439,a_1456)){ goto a_G12;}
a_1463(); return;
a_G12:a_1269(a_P);a_L3=a_P[0];
a_add(a_L3,a_1260,a_1260);
a_1271(a_L1,a_L2,a_L3);
a_1270(a_L1); goto a_G10;
} /* loosefill */
static void a_1269(int a_A[1]){ /* loosefillitem+a> */

if(!a_equal(16777427,a_1456)){ goto a_G14;}
a_1463();
a_A[0]=0;
a_G4:if(!a_equal(16777406,a_1456)){ goto a_G6;}
a_1463(); return;
a_G6:if(!a_equal(16777459,a_1456)){ goto a_G9;}
a_G7:a_1463();
a_incr(a_A[0]); goto a_G4;
a_G9:if(!a_equal(16777471,a_1456)){ goto a_G12;}
 goto a_G7;
a_G12:a_1417(a_1001,2130706103); return;
a_G14:if(!a_equal(16777459,a_1456)){ goto a_G17;}
a_G15:a_1463();
a_A[0]=1; return;
a_G17:if(!a_equal(16777471,a_1456)){ goto a_G12;}
 goto a_G15;
} /* loosefillitem */
static void a_1276(int a_F1,int a_F2,int a_F3,int a_A[1]){ /* repeatervalue+>a+>a+>a+a> */
int a_P[6];
if(!a_1262(a_F3,a_P)){ goto a_G6;}a_A[0]=a_P[0];
if(!a_lseq(1,a_A[0])){ goto a_G4;}
if(a_lseq(a_A[0],1000)){ return;}
a_G4:a_P[0]=2047260234;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_F2;a_P[3]=a_A[0];a_P[4]=to_LIST(a_1288)->offset[a_F3-3];a_P[5]=1000;a_1418(6,a_P);
a_A[0]=1; return;
a_G6:a_A[0]=1;
a_P[0]=2047260215;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_F2;a_P[3]=to_LIST(a_1288)->offset[a_F3-3];a_1418(4,a_P); return;
} /* repeatervalue */
static void a_1271(int a_F1,int a_F2,int a_F3){ /* looserepeater+>a+>a+>a */
int a_L4;int a_L5;int a_P[1];
if(!a_equal(16777445,a_1456)){ goto a_G15;}
a_1463();
if(!a_equal(16777455,a_1456)){ goto a_G6;}
a_L5=a_1457;
a_1463(); goto a_G12;
...
a_L4=a_1457;
a_1463(); goto a_G10;
a_G9:a_1417(a_1001,2130706103); return;
...
static void a_1270(int a_F1){ /* looseinitializer+>a */
int a_L2;int a_L3;int a_P[1];
a_G1:if(!a_equal(16777409,a_1456)){ return;}
a_1463();
if(!a_equal(16777471,a_1456)){ goto a_G6;}
...
a_1463();
a_1149(); goto a_G1;
a_G4:if(!a_equal(16777236,a_1456)){ goto a_G7;}
a_G5:a_1463();
a_1281(); goto a_G1;
a_G7:if(a_equal(16777266,a_1456)){ goto a_G5;}
if(a_equal(16777250,a_1456)){ goto a_G5;}
if(a_equal(16777224,a_1456)){ goto a_G5;}
if(a_equal(16777258,a_1456)){ goto a_G5;}
if(a_equal(16777246,a_1456)){ goto a_G5;}
if(a_equal(a_1456,16777285)){ return;}
a_1417(a_1001,2130706115); return;
} /* datasectioniii */
static void a_1252(int a_A[2]){ /* collectlistsizeclaims+a>+a> */
int a_L3;int a_L4;int a_L5;int a_P[1];
a_A[0]=0;a_A[1]=0;
a_L3=a_1265;
...
a_G13:a_1315(a_L3,a_P);a_L3=a_P[0]; goto a_G3;
...
a_1224();
a_1253(); return;
a_G8:a_P[0]=2047260243;a_1418(1,a_P); return;
...
static void a_1278(int a_F1){ /* setpointervalue+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
...
static void a_1279(int a_F1){ /* setreprnumber+>a */
int a_L2;int a_P[1];
...
{register int a_r1=to_LIST(a_1288)->offset[a_F1-5];
 ...
 if(a_r1==16777340||a_r1==16777345||a_r1==16777318||a_r1==16777322){  goto a_G9;}
  goto a_G11;}
a_G3:a_1455(to_LIST(a_1288)->offset[a_F1],a_P);a_L2=a_P[0];
if(!a_stringelem(a_1446,a_L2,0,a_P)){ goto a_G7;}a_L2=a_P[0];
...
a_G12:{register int a_r1=to_LIST(a_1288)->offset[a_F1-5];
...
a_G5:{register int a_r1=to_LIST(a_1288)->offset[a_L1-5];
...
static void a_1303(void){ /* expandITEM */
 ...
 a_extension(a_1288,7);to_LIST(a_1288)->top[1]=to_LIST(a_1288)->top[2]=to_LIST(a_1288)->top[3]=to_LIST(a_1288)->top[4]=to_LIST(a_1288)->top[5]=to_LIST(a_1288)->top[6]=to_LIST(a_1288)->top[7]=0;to_LIST(a_1288)->aupb+=7;
  return;
} /* expandITEM */
static int a_1326(int a_F1,int a_F2){ /* isitemflag+>a+>a */
int a_L3;
a_booland(to_LIST(a_1288)->offset[a_F1-6],a_F2,a_L3);
if(!a_is(a_L3)){ return 0;} return 1;
} /* isitemflag */
static void a_1358(int a_F1,int a_F2){ /* setitemflag+>a+>a */

a_boolor(to_LIST(a_1288)->offset[a_F1-6],a_F2,to_LIST(a_1288)->offset[a_F1-6]); return;
} /* setitemflag */
static void a_1298(int a_F1,int a_F2){ /* clearitemflag+>a+>a */
int a_L3;
a_boolinvert(a_F2,a_L3);
a_booland(a_L3,to_LIST(a_1288)->offset[a_F1-6],to_LIST(a_1288)->offset[a_F1-6]); return;
} /* clearitemflag */
static void a_1300(int a_A[1]){ /* converttoitem+>a> */

a_addmult(a_A[0],7,a_1337,a_A[0]); return;
} /* converttoitem */
static void a_1340(int a_F1){ /* pushAUX+>a */

 a_extension(a_1287,1);to_LIST(a_1287)->top[1]=a_F1;to_LIST(a_1287)->aupb+=1;
  return;
} /* pushAUX */
static void a_1310(int a_F1,int a_A[1]){ /* getcalibre+>a+a> */

a_A[0]=to_LIST(a_1287)->offset[to_LIST(a_1288)->offset[a_F1-1]-2]; return;
} /* getcalibre */
static void a_1319(int a_F1,int a_A[1]){ /* getssel+>a+a> */

a_A[0]=to_LIST(a_1287)->offset[to_LIST(a_1288)->offset[a_F1-1]-1]; return;
} /* getssel */
static void a_1321(int a_F1,int a_A[1]){ /* getvupb+>a+a> */

a_A[0]=to_LIST(a_1287)->offset[to_LIST(a_1288)->offset[a_F1-1]-4]; return;
} /* getvupb */
static void a_1320(int a_F1,int a_A[1]){ /* getvlwb+>a+a> */

a_A[0]=to_LIST(a_1287)->offset[to_LIST(a_1288)->offset[a_F1-1]-5]; return;
} /* getvlwb */
static void a_1313(int a_F1,int a_A[1]){ /* getfill+>a+a> */

a_A[0]=to_LIST(a_1287)->offset[to_LIST(a_1288)->offset[a_F1-1]-3]; return;
} /* getfill */
static void a_1315(int a_F1,int a_A[1]){ /* getlistlink+>a+a> */

a_A[0]=to_LIST(a_1287)->offset[to_LIST(a_1288)->offset[a_F1-1]]; return;
} /* getlistlink */
static void a_1343(int a_F1,int a_F2){ /* putvlwb+>a+>a */

to_LIST(a_1287)->offset[to_LIST(a_1288)->offset[a_F1-1]-5]=a_F2; return;
} /* putvlwb */
static void a_1344(int a_F1,int a_F2){ /* putvupb+>a+>a */

to_LIST(a_1287)->offset[to_LIST(a_1288)->offset[a_F1-1]-4]=a_F2; return;
} /* putvupb */
static void a_1341(int a_F1,int a_F2){ /* putfill+>a+>a */

to_LIST(a_1287)->offset[to_LIST(a_1288)->offset[a_F1-1]-3]=a_F2; return;
} /* putfill */
static void a_1342(int a_F1,int a_F2){ /* putlistlink+>a+>a */

to_LIST(a_1287)->offset[to_LIST(a_1288)->offset[a_F1-1]]=a_F2; return;
} /* putlistlink */
static void a_1318(int a_F1,int a_A[1]){ /* getnumberofformals+>a+a> */

a_A[0]=to_LIST(a_1287)->offset[to_LIST(a_1288)->offset[a_F1-1]-2]; return;
} /* getnumberofformals */
static void a_1314(int a_F1,int a_F2,int a_A[1]){ /* getformal+>a+>a+a> */
int a_L4;
...
static void a_1309(int a_F1,int a_A[1]){ /* getanchorcount+>a+a> */
int a_L3;int a_L4;
a_A[0]=0;
...
static void a_1291(int a_F1,int a_F2){ /* addmatter+>a+>a */

 a_extension(a_1287,3);to_LIST(a_1287)->top[1]=a_F1;to_LIST(a_1287)->top[2]=a_F2;to_LIST(a_1287)->top[3]=a_1335;to_LIST(a_1287)->aupb+=3;
a_1335=to_LIST(a_1287)->aupb; return;
} /* addmatter */
static int a_1316(int a_F2,int a_A[2]){ /* getmatter+>a>+>a+a> */
...
static int a_1299(int a_F1,int a_F2){ /* compareformals+>a+>a */
int a_L3;
...
static void a_1357(int a_F1,int a_A[1]){ /* searchformals+>a+>a> */
int a_L3;
a_L3=a_1331;
...
static void a_1308(int a_F1,int a_F2){ /* formalaffixes+>a+>a */
int a_L3;int a_L4;int a_L5;
a_G1:if(a_equal(a_F2,0)){ return;}
a_decr(a_F2);
if(!a_equal(16777463,a_1456)){ goto a_G6;}
a_L5=a_1457;
a_1463(); goto a_G7;
a_G6:a_1417(a_1001,2130706187); return;
a_G7:a_1340(a_L5);
{ if(a_L5==16777355||a_L5==16777361){ goto a_G9;}
 if(a_L5==16777371||a_L5==16777376||a_L5==16777382||a_L5==16777366||a_L5==16777388||a_L5==16777394){  goto a_G1;}
  goto a_G22;}
a_G9:if(!a_equal(16777455,a_1456)){ goto a_G6;}
a_L3=a_1457;
a_1463();
if(!a_equal(16777455,a_1456)){ goto a_G6;}
a_L4=a_1457;
...
a_incr(to_LIST(a_1287)->offset[a_F1-1]);
a_1340(a_L4); return;
a_G22:a_1417(a_1001,2130706220); return;
} /* formalaffixes */
static void a_1362(int a_A[1]){ /* storeformalaffixes+a> */
int a_L2;int a_L3;int a_P[1];
if(!a_equal(16777455,a_1456)){ goto a_G4;}
a_L2=a_1457;
a_1463(); goto a_G5;
a_G4:a_1417(a_1001,2130706187); return;
a_G5:a_L3=to_LIST(a_1287)->aupb;
 a_extension(a_1287,3);to_LIST(a_1287)->top[1]=to_LIST(a_1287)->top[2]=a_L2;to_LIST(a_1287)->top[3]=0;to_LIST(a_1287)->aupb+=3;
a_A[0]=to_LIST(a_1287)->aupb;
a_1308(a_A[0],a_L2);
a_P[0]=a_A[0];a_1357(a_L3,a_P);a_A[0]=a_P[0]; return;
} /* storeformalaffixes */
static void a_1363(int a_A[1]){ /* storelistbounds+a> */
int a_L2;int a_L3;
if(!a_equal(16777455,a_1456)){ goto a_G4;}
a_L2=a_1457;
a_1463(); goto a_G5;
...
a_L3=a_1457;
a_1463();
 a_extension(a_1287,6);to_LIST(a_1287)->top[1]=to_LIST(a_1287)->top[2]=to_LIST(a_1287)->top[3]=0;to_LIST(a_1287)->top[4]=a_L2;to_LIST(a_1287)->top[5]=a_L3;to_LIST(a_1287)->top[6]=0;to_LIST(a_1287)->aupb+=6;
a_A[0]=to_LIST(a_1287)->aupb; return;
} /* storelistbounds */
static void a_1295(int a_F1){ /* checkitemID+>a */

if(a_equal(a_F1,to_LIST(a_1288)->aupb)){ return;}
a_1417(a_1001,2130706214); return;
} /* checkitemID */
static void a_1302(void){ /* enteritem */
int a_L1;int a_P[1];
if(!a_1326(to_LIST(a_1288)->aupb,4)){ return;}
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb]=a_1337;
 a_extension(a_1287,3);to_LIST(a_1287)->top[1]=to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-4];to_LIST(a_1287)->top[2]=to_LIST(a_1288)->aupb;to_LIST(a_1287)->top[3]=0;to_LIST(a_1287)->aupb+=3;
a_1454(to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-3],a_P);a_L1=a_P[0];
a_G5:if(!a_equal(a_L1,0)){ goto a_G7;}
a_1464(to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-3],to_LIST(a_1287)->aupb); return;
...
int a_L1;int a_L2;int a_L3;int a_P[1];
a_1303();
if(!a_equal(16777463,a_1456)){ goto a_G5;}
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-5]=a_1457;
a_1463(); goto a_G6;
a_G5:a_1417(a_1001,2130706187); return;
a_G6:if(!a_equal(16777471,a_1456)){ goto a_G5;}
a_L1=a_1457;
a_1463();
a_1295(a_L1);
if(!a_equal(16777455,a_1456)){ goto a_G5;}
...
if(!a_more(a_L3,a_1336)){ goto a_G23;}
a_G22:a_1417(a_1001,2130706209); return;
a_G23:to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-2]=a_L3;
a_G24:{register int a_r1=to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-5];
 ...
 if(a_r1==16777304||a_r1==16777309||a_r1==16777314||a_r1==16777335||a_r1==16777340||a_r1==16777345){  goto a_G28;}
  goto a_G22;}
a_G25:a_1362(a_P);to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-1]=a_P[0]; goto a_G28;
a_G26:a_1363(a_P);to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-1]=a_P[0];
a_G28:if(!a_equal(16777483,a_1456)){ goto a_G5;}
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-4]=a_1457;
a_1463();
if(!a_equal(16777483,a_1456)){ goto a_G5;}
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-3]=a_1457;
a_1463();
a_1302(); return;
} /* readitem */
static void a_1329(void){ /* itemsection */
...
if(a_1439()){ return;}
a_G2:if(!a_equal(16777439,a_1456)){ goto a_G4;}
a_1463(); return;
...
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-3]=183666462;
 a_extension(a_1287,6);to_LIST(a_1287)->top[1]=to_LIST(a_1287)->top[2]=to_LIST(a_1287)->top[3]=0;to_LIST(a_1287)->top[4]=to_LIST(a_1287)->top[5]=1;to_LIST(a_1287)->top[6]=0;to_LIST(a_1287)->aupb+=6;
...
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-4]=183666554;
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-3]=183666470;
...
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-5]=16777349;
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-4]=183666554;
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-3]=183666478;
a_P[1]=16777376;a_P[2]=16777394;a_1290(2,a_P,2,a_P+1);to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-1]=a_P[0];
a_1302(); return;
} /* addshiftaffixrules */
static void a_1290(int a_F2,int a_A[1],int a_C,int *a_V){ /* addformalaffixes+a>+>a+@+>a */
int a_L4;int a_P[1];
a_L4=to_LIST(a_1287)->aupb;
 a_extension(a_1287,3);to_LIST(a_1287)->top[1]=a_F2;to_LIST(a_1287)->top[2]=to_LIST(a_1287)->top[3]=0;to_LIST(a_1287)->aupb+=3;
a_A[0]=to_LIST(a_1287)->aupb;
...
static int a_1328(int a_F1){ /* iswaitforitem+>a */

if(!a_equal(to_LIST(a_1288)->offset[a_F1],183666485)){ return 0;}
...
static int a_1324(int a_F1){ /* isassignitem+>a */

if(!a_equal(to_LIST(a_1288)->offset[a_F1],183666491)){ return 0;}
if(!a_1326(a_F1,16)){ return 0;}
if(!a_equal(to_LIST(a_1288)->offset[a_F1-5],16777349)){ return 0;}
if(!a_equal(to_LIST(a_1288)->offset[a_F1-1],a_1334)){ return 0;} return 1;
} /* isassignitem */
static int a_1327(int a_F1){ /* isrootitem+>a */

if(!a_equal(to_LIST(a_1288)->offset[a_F1-3],183666497)){ return 0;}
if(!a_equal(to_LIST(a_1288)->offset[a_F1-5],16777349)){ return 0;}
if(!a_equal(to_LIST(a_1288)->offset[a_F1-1],a_1350)){ return 0;}
if(!a_1326(a_F1,16)){ return 1;} return 0;
} /* isrootitem */
static int a_1325(int a_F1,int a_A[1]){ /* isbuiltinrule+>a+a> */

{register int a_r1=to_LIST(a_1288)->offset[a_F1-3];
...
static int a_1338(int a_F1){ /* nocallstackrule+>a */
int a_P[1];
if(a_1328(a_F1)){ return 0;}
if(a_1326(a_F1,1024)){ return 0;}
if(!a_1326(a_F1,16)){ goto a_G5;}
if(!a_noteq(to_LIST(a_1288)->offset[a_F1-3],183666504)){ return 0;} return 1;
a_G5:if(!a_1325(a_F1,a_P)){ return 0;} return 1;
} /* nocallstackrule */
static void a_1346(int a_F1){ /* readfileinfo+>a */
int a_L2;int a_L3;int a_L4;
if(!a_equal(16777471,a_1456)){ goto a_G4;}
a_L3=a_1457;
a_1463(); goto a_G5;
a_G4:a_1417(a_1001,2130706187); return;
a_G5:if(!a_equal(16777471,a_1456)){ goto a_G4;}
a_L4=a_1457;
a_1463();
 a_extension(a_1287,3);to_LIST(a_1287)->top[1]=0;to_LIST(a_1287)->top[2]=a_L3;to_LIST(a_1287)->top[3]=a_L4;to_LIST(a_1287)->aupb+=3;
{register int a_r1=to_LIST(a_1287)->aupb;a_L2=a_r1;to_LIST(a_1288)->offset[a_F1-1]=a_r1;}
if(!a_equal(16777448,a_1456)){ return;}
a_1463();
a_G13:if(!a_equal(16777403,a_1456)){ goto a_G15;}
a_1463(); return;
a_G15:if(!a_equal(16777471,a_1456)){ goto a_G4;}
a_L3=a_1457;
a_1463();
a_1340(a_L3);
a_incr(to_LIST(a_1287)->offset[a_L2-2]); goto a_G13;
} /* readfileinfo */
static void a_1312(int a_F1,int a_A[2]){ /* getfiledata+>a+a>+a> */
int a_L4;
a_L4=to_LIST(a_1288)->offset[a_F1-1];
a_A[0]=to_LIST(a_1287)->offset[a_L4-1];
a_A[1]=to_LIST(a_1287)->offset[a_L4]; return;
} /* getfiledata */
static void a_1311(int a_F1,int a_F2,int a_A[1]){ /* getfilearea+>a+>a+a> */
int a_L4;
a_L4=to_LIST(a_1288)->offset[a_F1-1];
...
a_P[0]=2047260253;a_P[1]=to_LIST(a_1288)->offset[a_1333-5];a_1418(2,a_P); return;
a_G3:a_1333=to_LIST(a_1288)->aupb; return;
} /* checkmainmodule */
static void a_1345(void){ /* readdefinitionlist */
int a_L1;int a_L2;int a_L3;
a_G1:if(!a_equal(16777455,a_1456)){ goto a_G4;}
a_L1=a_1457;
a_1463(); goto a_G5;
a_G4:a_1417(a_1001,2130706187); return;
a_G5:if(!a_equal(16777455,a_1456)){ goto a_G4;}
a_L2=a_1457;
a_1463();
if(!a_mreq(a_L2,a_1336)){ goto a_G11;}
a_1336=a_L2; goto a_G12;
a_G11:a_1417(a_1001,2130706204); return;
a_G12:if(!a_equal(16777483,a_1456)){ goto a_G4;}
a_L3=a_1457;
a_1463();
 a_extension(a_1287,3);to_LIST(a_1287)->top[1]=a_L1;to_LIST(a_1287)->top[2]=a_L2;to_LIST(a_1287)->top[3]=a_L3;to_LIST(a_1287)->aupb+=3;
if(!a_equal(to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-1],0)){ goto a_G19;}
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-1]=to_LIST(a_1287)->aupb;
a_G19:if(!a_equal(16777439,a_1456)){ goto a_G1;}
a_1463(); return;
} /* readdefinitionlist */
static void a_1332(void){ /* linkmoduleheader */
...
static void a_1322(int a_F1){ /* headsection+>a */
int a_L2;int a_P[1];
...
if(!a_equal(16777277,a_1456)){ goto a_G19;}
a_1463();
a_1358(to_LIST(a_1288)->aupb,2);
if(!a_equal(16777483,a_1456)){ goto a_G14;}
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-3]=a_1457;
a_1463(); goto a_G15;
a_G14:a_1417(a_1001,2130706187); return;
a_G15:if(!a_equal(16777483,a_1456)){ goto a_G14;}
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-4]=a_1457;
a_1463(); goto a_G28;
a_G19:if(!a_equal(16777273,a_1456)){ goto a_G27;}
a_1463();
...
a_1463();
a_1296(); goto a_G28;
a_G27:a_1417(a_1001,2130706197); return;
a_G28:a_1332();
if(!a_equal(16777455,a_1456)){ goto a_G14;}
a_L2=a_1457;
a_1463();
if(a_equal(a_L2,32)){ goto a_G35;}
a_P[0]=2047260265;a_1418(1,a_P);
a_G35:a_1336=0;
a_1345();
...
a_G1:if(!a_equal(16777439,a_1456)){ goto a_G3;}
a_1463(); return;
a_G3:a_1463(); goto a_G1;
} /* skipheadsection */
static void a_1356(int a_F1,int a_F2,int a_A[2]){ /* searchforline+>a+>a+a>+a> */
...
static void a_1306(int a_F1,int a_A[2]){ /* findlineno+>a+a>+a> */
int a_P[2];
...
static void a_1305(int a_F1,int a_A[3]){ /* finditemlineno+>a+a>+a>+a> */
...
static int a_1361(int a_F1,int a_F2){ /* stacksizemismatch+>a+>a */
int a_L3;int a_L4;int a_P[1];
...
static int a_1364(int a_F1,int a_F2){ /* unequaltypes+>a+>a */

if(a_equal(a_F1,a_F2)){ return 0;}
if(!a_equal(a_F1,16777335)){ return 1;}
if(!a_equal(a_F2,16777304)){ return 1;} return 0;
} /* unequaltypes */
static int a_1323(int a_F1,int a_F2){ /* incompatibletypes+>a+>a */
int a_L3;
...
static void a_1304(int a_F1,int a_A[1]){ /* finditemdef+>a+a> */
int a_L3;int a_L4;int a_P[1];
a_L3=to_LIST(a_1288)->offset[a_F1-4];
a_1454(to_LIST(a_1288)->offset[a_F1-3],a_P);a_L4=a_P[0];
...
static void a_1353(int a_F1){ /* scanitem+>a */
int a_L2;int a_P[4];
if(!a_1326(a_F1,8)){ return;}
a_1304(a_F1,a_P);a_L2=a_P[0];
if(!a_equal(a_L2,0)){ goto a_G5;}
a_P[0]=2047260279;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_F1;a_1418(3,a_P); return;
a_G5:if(!a_1323(a_L2,a_F1)){ goto a_G7;}
a_P[0]=2047260290;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_L2;a_P[3]=a_F1;a_1418(4,a_P); return;
a_G7:if(!a_was(a_1288,to_LIST(a_1288)->offset[a_L2])){ goto a_G10;}
a_1358(a_L2,128);
a_1358(to_LIST(a_1288)->offset[a_L2],4); return;
a_G10:a_1422(a_1001,2130706192); return;
} /* scanitem */
static void a_1351(int a_A[1]){ /* scanfordefinitions+>a> */
int a_L2;int a_L3;int a_P[1];
...
static void a_1354(int a_F1){ /* scanitemfordbledef+>a */
int a_L2;int a_L3;int a_L4;int a_P[4];
a_L2=to_LIST(a_1288)->offset[a_F1-4];
a_1454(to_LIST(a_1288)->offset[a_F1-3],a_P);a_L3=a_P[0];
...
a_P[0]=2047260300;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=to_LIST(a_1288)->offset[a_F1];a_P[3]=a_L4;a_1418(4,a_P); return;
} /* scanitemfordbledef */
static void a_1352(void){ /* scanfordoubledefinitions */
int a_L1;int a_L2;int a_P[1];
...
a_P[0]=2047260271;a_1418(1,a_P); return;
a_G3:a_1322(0);
a_1330=a_1337;
a_G5:a_L1=0;
a_P[0]=a_L1;a_1351(a_P);a_L1=a_P[0];
if(a_is(a_L1)){ goto a_G5;}
if(a_1439()){ goto a_G10;}
a_1352();
a_G10:if(a_1439()){ return;}
a_1297(); return;
} /* scanlinkedmodules */
static void a_1348(int a_F1){ /* reportitem+>a */
int a_P[3];
if(a_1326(a_F1,128)){ return;}
if(a_1325(a_F1,a_P)){ return;}
if(!a_1326(a_F1,4)){ return;}
a_P[0]=2047260308;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_F1;a_1438(3,a_P); return;
} /* reportitem */
static void a_1349(void){ /* reportnotusedpublicitems */
int a_L1;int a_L2;int a_P[1];
...
if(a_equal(a_L2,0)){ return;}
if(!a_1326(a_1337,4)){ goto a_G1;}
a_1409(to_LIST(a_1288)->offset[a_1337-5]);
if(!a_1404()){ goto a_G1;}
a_L1=a_1337;
...
static void a_1294(int a_A[1]){ /* advancemodbase+a> */
...
static void a_1339(int a_A[1]){ /* opennextmodule+a> */
int a_L2;int a_P[1];
...
static void a_1317(int a_A[1]){ /* getnextmodulehead+a> */
int a_P[1];
a_G1:a_1294(a_P);a_A[0]=a_P[0];
if(a_equal(a_A[0],0)){ return;}
if(!a_1326(a_1337,4)){ goto a_G1;}
...
static void a_1372(int a_A[1]){ /* getregister+a> */
int a_L2;
 a_extension(a_1367,1);to_LIST(a_1367)->top[1]=0;to_LIST(a_1367)->aupb+=1;
...
static void a_1369(int a_F1){ /* freeregister+>a */
int a_L2;
...
static void a_1374(int a_A[1]){ /* markregisters+a> */

a_A[0]=to_LIST(a_1367)->aupb; return;
} /* markregisters */
static void a_1370(int a_F1){ /* freeregistersfrommark+>a */

a_unstackto(a_1367,a_F1); return;
} /* freeregistersfrommark */
static void a_1368(int a_F1,int a_A[1]){ /* duplregister+>a+a> */
int a_L3;int a_L4;int a_P[1];
...
static void a_1376(int a_F1,int a_F2,int a_A[1]){ /* readregister+t[]+>a+a> */
int a_L3;int a_L4;int a_P[1];
a_1372(a_P);a_A[0]=a_P[0];
a_L3=a_A[0];
a_L4=a_1380;
...
static void a_1381(int a_F1,int a_F2){ /* writeregister+>a+[]st[] */
int a_L2;int a_L3;
a_L2=a_1380;
a_L3=a_F1;
a_G3:if(a_less(a_L2,1)){ goto a_G7;}
 a_extension(a_F2,1);to_LIST(a_F2)->top[1]=to_LIST(a_1367)->offset[a_L3];to_LIST(a_F2)->aupb+=1;
a_decr(a_L2);
a_incr(a_L3); goto a_G3;
a_G7:a_1369(a_F1); return;
} /* writeregister */
static int a_1373(int a_F1){ /* istargetconst+>a */

if(!a_equal(a_F1,a_F1)){ return 0;} return 1;
} /* istargetconst */
static void a_1375(int a_F1,int a_A[1]){ /* putcstregister+>a+a> */
int a_P[1];
a_1372(a_P);a_A[0]=a_P[0];
to_LIST(a_1367)->offset[a_A[0]]=a_F1; return;
} /* putcstregister */
static void a_1371(int a_F1,int a_A[1]){ /* getcstregister+>a+a> */

a_A[0]=to_LIST(a_1367)->offset[a_F1];
a_1369(a_F1); return;
} /* getcstregister */
static void a_1379(int a_F1,int a_F2,int a_F3){ /* regoperator+>a+>a+>a */
...
a_G6:a_boolor(to_LIST(a_1367)->offset[a_F3],to_LIST(a_1367)->offset[a_F2],to_LIST(a_1367)->offset[a_F3]); goto a_G3;
a_G8:a_add(to_LIST(a_1367)->offset[a_F3],to_LIST(a_1367)->offset[a_F2],to_LIST(a_1367)->offset[a_F3]); goto a_G3;
a_G10:a_subtr(to_LIST(a_1367)->offset[a_F3],to_LIST(a_1367)->offset[a_F2],to_LIST(a_1367)->offset[a_F3]); goto a_G3;
a_G12:a_mult(to_LIST(a_1367)->offset[a_F3],to_LIST(a_1367)->offset[a_F2],to_LIST(a_1367)->offset[a_F3]); goto a_G3;
a_G14:a_div(to_LIST(a_1367)->offset[a_F3],to_LIST(a_1367)->offset[a_F2],to_LIST(a_1367)->offset[a_F3]); goto a_G3;
a_G16:a_boolinvert(to_LIST(a_1367)->offset[a_F3],to_LIST(a_1367)->offset[a_F3]); return;
a_G17:a_subtr(0,to_LIST(a_1367)->offset[a_F3],to_LIST(a_1367)->offset[a_F3]); return;
} /* regoperator */
static int a_1377(int a_F1,int a_F2){ /* regcompare+>a+>a */
...
static int a_1378(int a_F1,int a_F2,int a_F3){ /* regcompare2+>a+>a+>a */
int a_L4;
...
a_G6: a_waitfor(a_1001,2130706229); if(!a_equal(32,32)){ goto a_G9;}
if(a_equal(32,32)){ return;}
a_G9:a_1422(a_1001,2130706225); return;
} /* @root */
static int a_1399(int a_F1,int a_F2){ /* isfileflag+>a+>a */
int a_L3;
a_booland(to_LIST(a_1384)->offset[a_F1-1],a_F2,a_L3);
if(!a_is(a_L3)){ return 0;} return 1;
} /* isfileflag */
static void a_1408(int a_F1,int a_F2){ /* setfileflag+>a+>a */

a_boolor(to_LIST(a_1384)->offset[a_F1-1],a_F2,to_LIST(a_1384)->offset[a_F1-1]); return;
} /* setfileflag */
static void a_1392(int a_F1){ /* extendBUFFER+>a */

 a_extension(a_1442,1);to_LIST(a_1442)->top[1]=a_F1;to_LIST(a_1442)->aupb+=1;
  return;
} /* extendBUFFER */
static void a_1393(int a_F1){ /* extendFILES+>a */
int a_P[2];
a_incr(a_1394);
if(!a_less(a_1394,200)){ goto a_G4;}
 a_extension(a_1384,2);to_LIST(a_1384)->top[1]=0;to_LIST(a_1384)->top[2]=a_F1;to_LIST(a_1384)->aupb+=2;
  return;
a_G4:a_P[0]=2047260531;a_P[1]=200;a_1420(2,a_P); return;
} /* extendFILES */
static int a_1400(int a_F1,int a_F2){ /* isfirstarg+t[]+>a */
int a_L2;int a_P[1];
a_comparestring(a_1488,a_1390,a_F1,a_F2,a_P);a_L2=a_P[0];
if(!a_equal(a_L2,0)){ return 0;} return 1;
} /* isfirstarg */
static void a_1391(void){ /* checkcommandlinearguments */
int a_P[3];
a_1390=to_LIST(a_1488)->aupb;
a_1389=1;
a_G3:if(!a_less(a_1390,to_LIST(a_1488)->alwb)){ goto a_G5;}
a_P[0]=2047260510;a_1418(1,a_P); return;
a_G5:if(!a_1400(a_1001,2130706269)){ goto a_G7;}
a_P[0]=2047260427;a_1423(1,a_P); return;
a_G7:if(!a_1400(a_1001,2130706265)){ goto a_G9;}
a_P[0]=2047260494;a_P[1]=2;a_P[2]=0;a_1423(3,a_P); return;
a_G9:if(!a_1400(a_1001,2130706260)){ goto a_G12;}
a_1389=0;
a_G11:a_previousstring(a_1488,a_1390); goto a_G3;
a_G12:if(!a_1400(a_1001,2130706255)){ goto a_G18;}
a_previousstring(a_1488,a_1390);
if(!a_less(a_1390,to_LIST(a_1488)->alwb)){ goto a_G16;}
a_P[0]=2047260519;a_P[1]=111;a_1418(2,a_P); return;
a_G16:a_1411=a_1390; goto a_G11;
a_G18:if(!a_1400(a_1001,2130706252)){ goto a_G24;}
a_previousstring(a_1488,a_1390);
if(!a_less(a_1390,to_LIST(a_1488)->alwb)){ goto a_G22;}
a_P[0]=2047260519;a_P[1]=76;a_1418(2,a_P); return;
a_G22:a_1401=a_1390; goto a_G11;
a_G24:if(!a_1400(a_1001,2130706249)){ goto a_G27;}
a_1349(); goto a_G11;
a_G27:if(!a_1400(a_1001,2130706246)){ return;}
a_1211(); goto a_G11;
} /* checkcommandlinearguments */
static int a_1396(int a_A[1]){ /* getnextsource+a> */
int a_L2;int a_P[1];
...
a_G8:if(!a_lseq(to_LIST(a_1488)->alwb,a_1390)){ goto a_G13;}
a_1393(a_1390);
a_previousstring(a_1488,a_1390); goto a_G6;
a_G13:if(!a_is(a_1389)){ return 0;}
a_1393(183666520);
...
static void a_1395(int a_A[1]){ /* geticefile+a> */
int a_P[1];
if(a_1413(a_1385,a_P)){a_A[0]=a_P[0]; return;}
a_A[0]=0; return;
} /* geticefile */
static int a_1413(int a_F1,int a_A[1]){ /* wasicesource+>a+a> */
...
if(a_equal(to_LIST(a_1442)->offset[to_LIST(a_1442)->aupb],47)){ return;}
a_1392(47); return;
} /* adddirseparator */
static void a_1405(int a_A[1]){ /* openBUFFER+a> */
int a_L2;int a_P[1];
a_listlength(a_1442,a_L2);
if(!a_lseq(a_L2,0)){ goto a_G4;}
a_A[0]=1; return;
a_G4:a_packstring(a_1442,a_L2,a_1446);
a_scratch(a_1442);
a_1450();
a_1475(a_P);a_A[0]=a_P[0]; return;
} /* openBUFFER */
static void a_1410(int a_F1){ /* stringtoBUFFER+>a */
int a_P[1];
if(!a_was(a_1446,a_F1)){ goto a_G4;}
a_1455(a_F1,a_P);a_F1=a_P[0];
a_unpackstring(a_1446,a_F1,a_1442); return;
a_G4:if(!a_was(a_1488,a_F1)){ goto a_G6;}
a_unpackstring(a_1488,a_F1,a_1442); return;
a_G6:a_1422(a_1001,2130706243); return;
} /* stringtoBUFFER */
static void a_1406(int a_F1,int a_A[1]){ /* openfileasgiven+>a+a> */
int a_P[2];
a_scratch(a_1442);
if(!a_1399(a_F1,2)){ goto a_G5;}
a_1410(a_1401);
a_1386();
a_G5:if(!a_1399(a_F1,4)){ goto a_G8;}
a_1410(183666514);
a_1386();
a_G8:a_1410(to_LIST(a_1384)->offset[a_F1]);
if(!a_1399(a_F1,1)){ goto a_G11;}
a_1387();
a_G11:a_1405(a_P);a_A[0]=a_P[0];
if(a_mreq(a_A[0],0)){ return;}
a_P[0]=2047260540;a_P[1]=a_F1;a_1420(2,a_P); return;
} /* openfileasgiven */
static void a_1409(int a_F1){ /* setsource+>a */

a_1385=a_F1; return;
} /* setsource */
static void a_1407(int a_F1){ /* opensource+>a */
int a_L2;int a_P[2];
if(!a_equal(a_F1,0)){ goto a_G3;}
a_1385=0; return;
a_G3:a_1385=a_F1;
a_1406(a_F1,a_P);a_L2=a_P[0];
if(a_equal(a_L2,0)){ return;}
a_P[0]=2047260540;a_P[1]=a_F1;a_1420(2,a_P); return;
} /* opensource */
static void a_1412(int a_F1,int a_A[1]){ /* tryfilefirst+>a+a> */
int a_P[1];
to_LIST(a_1384)->offset[a_F1-1]=0;
...
to_LIST(a_1384)->offset[a_F1-1]=2;
a_1406(a_F1,a_P);a_A[0]=a_P[0];
if(a_equal(a_A[0],0)){ return;}
a_1408(a_F1,1);
a_1406(a_F1,a_P);a_A[0]=a_P[0];
if(a_equal(a_A[0],0)){ return;}
a_G14:to_LIST(a_1384)->offset[a_F1-1]=4;
a_1406(a_F1,a_P);a_A[0]=a_P[0];
if(a_equal(a_A[0],0)){ return;}
a_1408(a_F1,1);
a_1406(a_F1,a_P);a_A[0]=a_P[0];
...
static void a_1398(int a_F1,int a_A[1]){ /* handlesourcefile+>a+a> */
int a_P[2];
a_1412(a_F1,a_P);a_A[0]=a_P[0];
if(!a_is(a_A[0])){ goto a_G4;}
a_P[0]=2047260540;a_P[1]=a_F1;a_1420(2,a_P); return;
a_G4:if(!a_equal(a_1456,16777273)){ goto a_G6;}
a_1403=a_F1; return;
a_G6:if(!a_equal(a_1456,16777262)){ return;}
a_1388(a_F1);
a_A[0]=1; return;
} /* handlesourcefile */
static void a_1388(int a_F1){ /* addincludedicefiles+>a */
int a_L2;int a_P[2];
if(!a_noteq(a_F1,to_LIST(a_1384)->aupb)){ goto a_G3;}
a_P[0]=2047260551;a_P[1]=a_F1;a_1420(2,a_P); return;
a_G3:a_unstack(a_1384);
a_G4:if(!a_equal(16777262,a_1456)){ goto a_G11;}
a_1463();
if(!a_equal(16777483,a_1456)){ goto a_G9;}
a_L2=a_1457;
a_1463(); goto a_G10;
a_G9:a_1417(a_1001,2130706237); return;
a_G10:a_1393(a_L2); goto a_G4;
a_G11:a_1450(); return;
} /* addincludedicefiles */
static void a_1397(void){ /* gettargetfile */
int a_L1;int a_L2;int a_L3;int a_L4;int a_L5;int a_L6;
if(!a_is(a_1411)){ goto a_G4;}
a_L5=0;
a_L2=a_1411; goto a_G6;
a_G4:a_L5=1;
a_L2=to_LIST(a_1384)->offset[a_1403];
a_G6:a_L1=to_LIST(a_1442)->aupb;
a_1410(a_L2);
a_L4=to_LIST(a_1442)->aupb;
a_L6=1;
a_G10:if(a_lseq(a_L4,a_L1)){ goto a_G22;}
{register int a_r1=to_LIST(a_1442)->offset[a_L4];
...
a_L6=0;
a_unstackto(a_1442,a_L4); goto a_G10;
a_G19:if(a_equal(a_L5,1)){ goto a_G22;} goto a_G14;
a_G21:a_decr(a_L4); goto a_G10;
a_G22:if(a_equal(a_L5,2)){ goto a_G25;}
a_1392(46);
a_1392(99);
a_G25:a_subtr(to_LIST(a_1442)->aupb,a_L4,a_L3);
a_packstring(a_1442,a_L3,a_1446);
a_unstackto(a_1442,a_L1); return;
} /* gettargetfile */
static void a_1428(int a_F1){ /* printchar+>a */

a_incr(a_1436);
a_putchar(a_1416,a_F1); return;
} /* printchar */
static void a_1425(void){ /* nlcr */

if(!a_lseq(a_1436,1)){ goto a_G3;}
a_1436=1; return;
a_G3:a_1436=0;
a_1428(10); return;
} /* nlcr */
static void a_1437(int a_F1){ /* tabline+>a */

a_G1:if(a_equal(a_1436,a_F1)){ return;}
if(!a_more(a_1436,a_F1)){ goto a_G4;}
a_1425(); goto a_G1;
a_G4:a_1428(32); goto a_G1;
} /* tabline */
static void a_1431(int a_F1){ /* printint+>a */

if(!a_equal(a_F1,(-1-2147483647))){ goto a_G5;}
a_1428(45);
a_subtr(-1,a_F1,a_F1);
a_1432(a_F1,49); return;
a_G5:if(!a_less(a_F1,0)){ goto a_G9;}
a_1428(45);
a_getabs(a_F1,a_F1);
a_1432(a_F1,48); return;
a_G9:a_1432(a_F1,48); return;
} /* printint */
static void a_1432(int a_F1,int a_F2){ /* printint1+>a+>a */
int a_L3;int a_L4;
a_divrem11(a_F1,10,a_L3,a_L4);
if(a_equal(a_L3,0)){ goto a_G4;}
a_1432(a_L3,48);
...
static void a_1429(int a_F1){ /* printform+>a */

a_1430(a_F1,4); return;
} /* printform */
static void a_1430(int a_F1,int a_F2){ /* printform1+>a+>a */
int a_L3;int a_L4;
...
static void a_1426(int a_F1,int a_F2){ /* print+t[]+>a */
int a_L2;
if(!a_was(a_F1,a_F2)){ return;}
a_1485(a_1416,a_F1,a_F2);
a_stringlength(a_F1,a_F2,a_L2);
a_add(a_1436,a_L2,a_1436); return;
} /* print */
static void a_1435(int a_F1){ /* printpointer+>a */
int a_P[1];
a_G1:if(!a_equal(a_F1,0)){ goto a_G3;}
a_1426(a_1001,2130706300); return;
a_G3:if(a_1413(a_F1,a_P)){a_F1=a_P[0]; goto a_G1;}
if(!a_was(a_1415,a_F1)){ goto a_G6;}
a_1426(a_1415,a_F1); return;
a_G6:if(!a_was(a_1488,a_F1)){ goto a_G8;}
a_1426(a_1488,a_F1); return;
a_G8:if(!a_was(a_1446,a_F1)){ goto a_G11;}
a_1455(a_F1,a_P);a_F1=a_P[0];
a_1426(a_1446,a_F1); return;
a_G11:a_1422(a_1001,2130706296); return;
} /* printpointer */
static void a_1427(int a_F1){ /* printbase+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_L2=to_LIST(a_1442)->aupb;
if(!a_was(a_1446,a_F1)){ goto a_G5;}
a_1455(a_F1,a_P);a_F1=a_P[0];
a_unpackstring(a_1446,a_F1,a_1442); goto a_G9;
a_G5:if(!a_was(a_1488,a_F1)){ goto a_G7;}
a_unpackstring(a_1488,a_F1,a_1442); goto a_G9;
a_G7:if(a_equal(a_F1,0)){ goto a_G9;}
a_1422(a_1001,2130706290); return;
a_G9:a_L3=to_LIST(a_1442)->aupb;
a_L4=0;
a_G11:if(a_lseq(a_L3,a_L2)){ goto a_G19;}
if(!a_equal(to_LIST(a_1442)->offset[a_L3],46)){ goto a_G15;}
a_incr(a_L4);
a_G14:a_decr(a_L3); goto a_G11;
a_G15:if(a_equal(to_LIST(a_1442)->offset[a_L3],47)){ goto a_G19;}
if(a_equal(to_LIST(a_1442)->offset[a_L3],92)){ goto a_G19;}
if(!a_equal(to_LIST(a_1442)->offset[a_L3],58)){ goto a_G14;}
a_G19:a_incr(a_L3);
if(a_more(a_L3,to_LIST(a_1442)->aupb)){ goto a_G28;}
if(!a_equal(to_LIST(a_1442)->offset[a_L3],46)){ goto a_G26;}
if(a_lseq(a_L4,1)){ goto a_G28;}
a_decr(a_L4);
a_1428(46); goto a_G19;
a_G26:a_1428(to_LIST(a_1442)->offset[a_L3]); goto a_G19;
a_G28:a_unstackto(a_1442,a_L2); return;
} /* printbase */
static void a_1433(int a_F1){ /* printitem+>a */
...
a_1428(32);
a_1426(a_1001,2130706285);
a_1435(a_L4);
a_1428(41); return;
} /* printitem */
static void a_1434(int a_F1){ /* printline+>a */
...
static void a_1421(int a_C,int *a_V){ /* formatprint+@+>a */
int a_L2;int a_L3;
a_L2=to_LIST(a_1442)->aupb;
a_unpackstring(a_1415,a_V[0],a_1442);
a_add(a_L2,1,a_L3);
a_G4:if(a_less(to_LIST(a_1442)->aupb,a_L3)){ goto a_G36;}
if(!a_noteq(to_LIST(a_1442)->offset[a_L3],37)){ goto a_G8;}
a_G6:a_1428(to_LIST(a_1442)->offset[a_L3]);
a_G7:a_incr(a_L3); goto a_G4;
a_G8:a_incr(a_L3);
if(!a_less(to_LIST(a_1442)->aupb,a_L3)){ goto a_G11;}
a_1428(37); goto a_G36;
a_G11:{register int a_r1=to_LIST(a_1442)->offset[a_L3];
...
a_G14:a_1426(a_1001,2130706280); goto a_G7;
...
a_G32:a_1428(10); goto a_G7;
a_G36:if(a_C<=1){ goto a_G38;} a_C--;a_V+=1;
a_1426(a_1001,2130706277);
a_G38:a_unstackto(a_1442,a_L2); return;
} /* formatprint */
static int a_1439(void){ /* waserror */

if(!a_more(a_1419,0)){ return 0;} return 1;
} /* waserror */
static void a_1424(int a_F1){ /* messagehead+>a */
int a_L2;int a_P[1];
a_1425();
a_1428(a_F1);
a_1428(32);
...
static void a_1418(int a_C,int *a_V){ /* error+@+>a */
int a_P[1];
if(a_mreq(a_1419,51)){ return;}
a_1424(69);
a_1421(a_C,a_V);
a_1425();
a_incr(a_1419);
if(a_less(a_1419,51)){ return;}
a_1424(70);
a_P[0]=2047260566;a_1421(1,a_P);
a_1425(); return;
} /* error */
static void a_1438(int a_C,int *a_V){ /* warning+@+>a */
...
static void a_1423(int a_C,int *a_V){ /* message+@+>a */

a_1421(a_C,a_V);
a_1425();
a_incr(a_1419); return;
} /* message */
static void a_1420(int a_C,int *a_V){ /* fatalerror+@+>a */
...
static void a_1417(int a_F1,int a_F2){ /* corrupticefile+t[]+>a */
int a_L2;int a_P[2];
a_1424(70);
a_1395(a_P);a_L2=a_P[0];
a_P[0]=2047260587;a_P[1]=a_L2;a_1421(2,a_P);
a_1426(a_F1,a_F2);
a_P[0]=2047260592;a_1421(1,a_P);
a_1425();
a_exit(3); return;
} /* corrupticefile */
static void a_1422(int a_F1,int a_F2){ /* internalerror+t[]+>a */
int a_P[1];
a_1424(70);
a_P[0]=2047260574;a_1421(1,a_P);
a_1426(a_F1,a_F2);
a_P[0]=2047260579;a_1421(1,a_P);
a_1425();
a_exit(15); return;
} /* internalerror */
static void a_1453(int a_F1){ /* extendBUFFER+>a */

 a_extension(a_1442,1);to_LIST(a_1442)->top[1]=a_F1;to_LIST(a_1442)->aupb+=1;
  return;
} /* extendBUFFER */
static void a_1475(int a_A[1]){ /* trytoopensource+a> */
int a_L2;
if(!a_openfile(a_1447,114,a_1446,to_LIST(a_1446)->aupb)){ goto a_G8;}
a_A[0]=0;
a_unstackstring(a_1446);
a_1474=1;
a_1449=32;
a_1462();
a_1463(); return;
a_G8:a_unstackstring(a_1446);
a_getfileerror(a_1447,a_L2);
...
a_closefile(a_1447); return;
} /* closesource */
static void a_1462(void){ /* nextchar */
int a_P[1];
a_G1:if(!a_getchar(a_1447,a_P)){ goto a_G4;}a_1449=a_P[0];
{ if(a_1449==10){ goto a_G3;}
 if(a_1449<=31){  goto a_G1;}
  return;}
a_G3:a_incr(a_1474); return;
a_G4:a_1449=1; return;
} /* nextchar */
static void a_1473(void){ /* saveinputposition */
int a_P[1];
a_getfilepos(a_1447,a_P);a_1459=a_P[0];
a_1458=a_1449;
a_1460=a_1456;
a_1461=a_1457; return;
} /* saveinputposition */
static void a_1472(void){ /* restoreinputposition */

a_setfilepos(a_1447,a_1459);
a_1449=a_1458;
a_1456=a_1460;
a_1457=a_1461; return;
} /* restoreinputposition */
static void a_1451(void){ /* comment */

a_G1:if(a_equal(a_1449,10)){ return;}
if(a_equal(a_1449,1)){ return;}
a_1462(); goto a_G1;
} /* comment */
static void a_1466(int a_A[1]){ /* readdestination+a> */
int a_L2;
{ if(a_1449==78){ goto a_G2;}
 if(a_1449==48){ goto a_G15;}
 if(a_1449==45){  goto a_G17;}
  goto a_G30;}
a_G2:a_1462();
{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G8;}
}
a_subtr(a_1449,48,a_A[0]);
a_1462();
if(a_more(a_A[0],0)){ goto a_G9;}
if(a_equal(0,0)){ goto a_G9;}
a_G8:a_1417(a_1001,2130706347); return;
a_G9:{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G13;}
}
a_subtr(a_1449,48,a_L2);
a_1462();
...
a_G24:{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G28;}
}
a_subtr(a_1449,48,a_L2);
a_1462();
a_addmult(a_A[0],10,a_L2,a_A[0]); goto a_G24;
a_G28:if(!a_is(1)){ return;} goto a_G14;
a_G30:a_1417(a_1001,2130706342); return;
} /* readdestination */
static void a_1468(int a_A[1]){ /* readtargetnumber+a> */
int a_L2;int a_L3;int a_P[1];
a_L2=to_LIST(a_1442)->aupb;
a_L3=0;
a_G3:{ if(a_1449==45){ goto a_G4;}
 if((48<=a_1449 && a_1449<=57)){  goto a_G6;}
  goto a_G8;}
a_G4:a_L3=1;
a_G5:a_1462(); goto a_G3;
a_G6:a_1453(a_1449); goto a_G5;
a_G8:a_1007(a_L3,a_L2,a_P);a_A[0]=a_P[0];
a_unstackto(a_1442,a_L2); return;
} /* readtargetnumber */
static void a_1454(int a_F1,int a_A[1]){ /* gettagdata+>a+a> */

a_A[0]=to_LIST(a_1446)->offset[a_F1]; return;
} /* gettagdata */
static void a_1455(int a_F1,int a_A[1]){ /* gettagimage+>a+a> */

a_subtr(a_F1,2,a_A[0]); return;
} /* gettagimage */
static void a_1464(int a_F1,int a_F2){ /* puttagdata+>a+>a */

to_LIST(a_1446)->offset[a_F1]=a_F2; return;
} /* puttagdata */
static void a_1448(int a_A[1]){ /* addLEXTentry+a> */
int a_P[1];
 a_extension(a_1446,2);to_LIST(a_1446)->top[1]=to_LIST(a_1446)->top[2]=0;to_LIST(a_1446)->aupb+=2;
a_1452(to_LIST(a_1446)->aupb,a_P);a_A[0]=a_P[0];
if(a_equal(a_A[0],to_LIST(a_1446)->aupb)){ return;}
a_unstack(a_1446);
a_unstackstring(a_1446); return;
} /* addLEXTentry */
static void a_1452(int a_F1,int a_A[1]){ /* enterstring+>a+a> */
int a_L3;int a_L4;int a_L5;int a_L6;int a_L7;int a_P[1];
a_subtr(a_F1,2,a_L3);
a_stringhash(a_1446,a_L3,a_P);a_L4=a_P[0];
a_booland(a_L4,2147483647,a_L4);
a_divrem01(a_L4,a_1445,a_L4);
a_add(a_L4,to_LIST(a_1443)->alwb,a_L4);
a_L5=to_LIST(a_1443)->offset[a_L4];
a_G7:if(!a_equal(a_L5,0)){ goto a_G14;}
to_LIST(a_1446)->offset[a_F1-1]=to_LIST(a_1443)->offset[a_L4];
to_LIST(a_1443)->offset[a_L4]=a_F1;a_A[0]=a_F1;
a_incr(a_1444);
if(a_less(a_1444,a_1445)){ return;}
a_add(a_1445,1024,a_1445);
a_1471(); return;
a_G14:a_subtr(a_L5,2,a_L6);
a_comparestring(a_1446,a_L3,a_1446,a_L6,a_P);a_L7=a_P[0];
if(!a_equal(a_L7,0)){ goto a_G18;}
a_A[0]=a_L5; return;
a_G18:a_L5=to_LIST(a_1446)->offset[a_L5-1]; goto a_G7;
} /* enterstring */
static void a_1471(void){ /* rehash */
int a_L1;int a_L2;int a_P[1];
a_1444=0;
a_L1=to_LIST(a_1443)->aupb;
a_G3:if(a_less(a_L1,to_LIST(a_1443)->alwb)){ goto a_G6;}
to_LIST(a_1443)->offset[a_L1]=0;
a_previous(a_1443,a_L1); goto a_G3;
a_G6:a_subtr(to_LIST(a_1443)->aupb,to_LIST(a_1443)->alwb,a_L2);
a_G7:a_incr(a_L2);
if(a_mreq(a_L2,a_1445)){ goto a_G11;}
 a_extension(a_1443,1);to_LIST(a_1443)->top[1]=0;to_LIST(a_1443)->aupb+=1;
  goto a_G7;
a_G11:a_L1=to_LIST(a_1446)->aupb;
a_G12:if(a_less(a_L1,to_LIST(a_1446)->alwb)){ return;}
a_1452(a_L1,a_P);a_L2=a_P[0];
if(!a_equal(a_L2,a_L1)){ goto a_G17;}
a_previous(a_1446,a_L1);
a_previousstring(a_1446,a_L1); goto a_G12;
a_G17:a_1422(a_1001,2130706336); return;
} /* rehash */
static void a_1467(int a_A[1]){ /* readstring+a> */
int a_L2;int a_L3;int a_P[1];
a_L3=to_LIST(a_1442)->aupb;
a_L2=0;
a_G3:a_1462();
{ if(a_1449==34){ goto a_G5;}
 if(a_1449==10||a_1449==1){  goto a_G14;}
  goto a_G7;}
a_G5:a_1462();
if(!a_equal(a_1449,34)){ goto a_G9;}
a_G7:a_1453(a_1449);
a_incr(a_L2); goto a_G3;
a_G9:if(!a_equal(a_L2,0)){ goto a_G11;}
a_A[0]=183666554; return;
a_G11:a_packstring(a_1442,a_L2,a_1446);
a_unstackto(a_1442,a_L3);
a_1448(a_P);a_A[0]=a_P[0]; return;
a_G14:a_1417(a_1001,2130706332); return;
} /* readstring */
static void a_1469(int a_A[2]){ /* readtargetstring+a>+a> */
int a_L3;int a_P[2];
a_L3=to_LIST(a_1442)->aupb;
if(a_equal(a_1449,34)){ goto a_G4;}
a_G3:a_1417(a_1001,2130706327); return;
a_G4:a_1462();
{ if(a_1449==34){ goto a_G6;}
 if(a_1449==10||a_1449==1){  goto a_G3;}
  goto a_G8;}
a_G6:a_1462();
if(!a_equal(a_1449,34)){ goto a_G9;}
a_G8:a_1453(a_1449); goto a_G4;
a_G9:a_1008(a_L3,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];
a_unstackto(a_1442,a_L3); return;
} /* readtargetstring */
static void a_1465(int a_A[1]){ /* readbold+a> */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_1462();
a_L3=to_LIST(a_1442)->aupb;
a_L2=0;
a_G4:{ if(!((97<=a_1449 && a_1449<=122))){ goto a_G9;}
}
a_L4=a_1449;
a_1462();
a_1453(a_L4);
a_incr(a_L2); goto a_G4;
a_G9:if(!a_equal(a_1449,39)){ goto a_G11;}
a_1462(); goto a_G12;
a_G11:a_1417(a_1001,2130706320); return;
a_G12:a_packstring(a_1442,a_L2,a_1446);
a_unstackto(a_1442,a_L3);
a_A[0]=16777299;
a_G15:a_comparestring(a_1441,a_A[0],a_1446,to_LIST(a_1446)->aupb,a_P);a_L2=a_P[0];
if(a_equal(a_L2,0)){ goto a_G20;}
if(a_equal(a_A[0],16777220)){ goto a_G11;}
a_previousstring(a_1441,a_A[0]); goto a_G15;
a_G20:a_unstackstring(a_1446); return;
} /* readbold */
static void a_1470(int a_A[1]){ /* readtype+a> */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_1462();
a_L3=to_LIST(a_1442)->aupb;
a_L2=0;
...
a_1453(a_L4);
a_incr(a_L2); goto a_G4;
a_G9:if(!a_equal(a_1449,32)){ goto a_G13;}
a_1453(32);
a_incr(a_L2);
a_1462(); goto a_G4;
a_G13:if(!a_equal(a_1449,62)){ goto a_G15;}
a_1462(); goto a_G16;
a_G15:a_1417(a_1001,2130706315); return;
a_G16:a_packstring(a_1442,a_L2,a_1446);
a_unstackto(a_1442,a_L3);
a_A[0]=16777394;
a_G19:a_comparestring(a_1441,a_A[0],a_1446,to_LIST(a_1446)->aupb,a_P);a_L2=a_P[0];
if(a_equal(a_L2,0)){ goto a_G24;}
if(a_equal(a_A[0],16777304)){ goto a_G15;}
a_previousstring(a_1441,a_A[0]); goto a_G19;
a_G24:a_unstackstring(a_1446); return;
} /* readtype */
static void a_1463(void){ /* nextsymbol */
int a_L1;int a_P[2];
a_G1:a_P[0]=a_1476;a_1020(a_P);a_1476=a_P[0];a_1457=a_P[1];
if(!a_more(a_1476,0)){ goto a_G4;}
a_1456=16777459; return;
a_G4:{ if(a_1449==32||a_1449==10){ goto a_G5;}
 if(a_1449==36){ goto a_G6;}
 if(a_1449==48){ goto a_G7;}
 if((49<=a_1449 && a_1449<=57)){ goto a_G10;}
 if(a_1449==70){ goto a_G23;}
 if(a_1449==73){ goto a_G37;}
 if(a_1449==76){ goto a_G52;}
 if(a_1449==78){ goto a_G66;}
 if(a_1449==88){ goto a_G80;}
 if(a_1449==84){ goto a_G83;}
 if(a_1449==39){ goto a_G86;}
 if(a_1449==60){ goto a_G87;}
 if(a_1449==34){ goto a_G89;}
 if(a_1449==38){ goto a_G91;}
 if(a_1449==93){ goto a_G93;}
 if(a_1449==41){ goto a_G95;}
 if(a_1449==58){ goto a_G97;}
 if(a_1449==44){ goto a_G99;}
 if(a_1449==126){ goto a_G101;}
 if(a_1449==47){ goto a_G103;}
 if(a_1449==45){ goto a_G105;}
 if(a_1449==35){ goto a_G122;}
 if(a_1449==40){ goto a_G124;}
 if(a_1449==124){ goto a_G126;}
 if(a_1449==62){ goto a_G128;}
 if(a_1449==43){ goto a_G131;}
 if(a_1449==46){ goto a_G133;}
 if(a_1449==59){ goto a_G135;}
 if(a_1449==42){ goto a_G137;}
 if(a_1449==91){ goto a_G139;}
 if(a_1449==94){ goto a_G141;}
 if(a_1449==64){ goto a_G143;}
 if(a_1449==1){  goto a_G145;}
  goto a_G146;}
a_G5:a_1462(); goto a_G1;
a_G6:a_1451(); goto a_G1;
a_G7:a_1456=16777455;
a_1457=0;
a_G9:a_1462(); return;
a_G10:a_1456=16777455;
{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G16;}
}
a_subtr(a_1449,48,a_1457);
a_1462();
if(a_more(a_1457,0)){ goto a_G17;}
if(a_equal(0,0)){ goto a_G17;}
a_G16:a_1417(a_1001,2130706347); return;
a_G17:{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G21;}
}
a_subtr(a_1449,48,a_L1);
a_1462();
a_addmult(a_1457,10,a_L1,a_1457); goto a_G17;
a_G21:if(!a_is(0)){ return;}
a_G22:a_subtr(0,a_1457,a_1457); return;
a_G23:a_1456=16777475;
a_1462();
{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G16;}
}
a_subtr(a_1449,48,a_1457);
a_1462();
if(a_more(a_1457,0)){ goto a_G31;}
if(!a_equal(0,0)){ goto a_G16;}
a_G31:{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G21;}
}
a_subtr(a_1449,48,a_L1);
a_1462();
a_addmult(a_1457,10,a_L1,a_1457); goto a_G31;
a_G37:a_1456=16777471;
a_1462();
{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G16;}
}
a_subtr(a_1449,48,a_1457);
a_1462();
if(a_more(a_1457,0)){ goto a_G45;}
if(!a_equal(0,0)){ goto a_G16;}
a_G45:{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G49;}
}
a_subtr(a_1449,48,a_L1);
a_1462();
a_addmult(a_1457,10,a_L1,a_1457); goto a_G45;
a_G49:if(!a_is(0)){ goto a_G51;}
a_subtr(0,a_1457,a_1457);
a_G51:a_P[0]=a_1457;a_1300(a_P);a_1457=a_P[0]; return;
a_G52:a_1456=16777479;
a_1462();
{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G16;}
}
a_subtr(a_1449,48,a_1457);
a_1462();
if(a_more(a_1457,0)){ goto a_G60;}
if(!a_equal(0,0)){ goto a_G16;}
a_G60:{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G21;}
}
a_subtr(a_1449,48,a_L1);
a_1462();
a_addmult(a_1457,10,a_L1,a_1457); goto a_G60;
a_G66:a_1456=16777467;
a_1462();
{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G16;}
}
a_subtr(a_1449,48,a_1457);
a_1462();
if(a_more(a_1457,0)){ goto a_G74;}
if(!a_equal(0,0)){ goto a_G16;}
a_G74:{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G21;}
}
a_subtr(a_1449,48,a_L1);
a_1462();
a_addmult(a_1457,10,a_L1,a_1457); goto a_G74;
a_G80:a_1456=16777459;
a_1462();
a_1468(a_P);a_1457=a_P[0]; return;
a_G83:a_1456=16777459;
a_1462();
a_1469(a_P);a_1476=a_P[0];a_1457=a_P[1]; return;
a_G86:a_1465(a_P);a_1456=a_P[0]; return;
a_G87:a_1456=16777463;
a_1470(a_P);a_1457=a_P[0]; return;
a_G89:a_1456=16777483;
a_1467(a_P);a_1457=a_P[0]; return;
a_G91:a_1456=16777400; goto a_G9;
a_G93:a_1456=16777403; goto a_G9;
a_G95:a_1456=16777406; goto a_G9;
a_G97:a_1456=16777409; goto a_G9;
a_G99:a_1456=16777412; goto a_G9;
a_G101:a_1456=16777415; goto a_G9;
a_G103:a_1456=16777418; goto a_G9;
a_G105:a_1462();
{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G120;}
}
a_1456=16777455;
{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G16;}
}
a_subtr(a_1449,48,a_1457);
a_1462();
if(a_more(a_1457,0)){ goto a_G114;}
if(!a_equal(1,0)){ goto a_G16;}
a_G114:{ if(!((48<=a_1449 && a_1449<=57))){ goto a_G118;}
}
a_subtr(a_1449,48,a_L1);
a_1462();
a_addmult(a_1457,10,a_L1,a_1457); goto a_G114;
a_G118:if(!a_is(1)){ return;} goto a_G22;
a_G120:a_1456=16777421;
a_1457=0; return;
a_G122:a_1456=16777424; goto a_G9;
a_G124:a_1456=16777427; goto a_G9;
a_G126:a_1456=16777430; goto a_G9;
a_G128:a_1456=16777433;
a_1462();
a_1466(a_P);a_1457=a_P[0]; return;
a_G131:a_1456=16777436; goto a_G9;
a_G133:a_1456=16777439; goto a_G9;
a_G135:a_1456=16777442; goto a_G9;
a_G137:a_1456=16777445; goto a_G9;
a_G139:a_1456=16777448; goto a_G9;
a_G141:a_1456=16777451; goto a_G9;
a_G143:a_1456=16777397; goto a_G9;
a_G145:a_1456=16777486; return;
a_G146:a_1417(a_1001,2130706310); return;
} /* nextsymbol */
static void a_1440(void){ /* @root */

a_1471(); return;
} /* @root */
static void a_1478(void){ /* pass1 */
int a_L1;int a_P[1];
a_G1:if(a_1439()){ return;}
...
static void a_1485(int a_F1,int a_F2,int a_F3){ /* putstring+""f+t[]+>a */
int a_L2;int a_L3;int a_P[1];
a_L2=0;
