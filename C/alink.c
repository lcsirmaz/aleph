...
static void a_data_setup(void){
 ...
 a_setup_stdarg(a_1486,1); /* STDARG */
 a_setup_charfile(a_1105,"TARGET",2,a_1001,2130706054); /* TARGET */
 a_setup_charfile(a_1414,"PRINTFILE",2,a_1001,2130706305); /* PRINTFILE */
 a_setup_charfile(a_1445,"SOURCE",1,a_1001,2130706352); /* SOURCE */
 a_list_fill(a_FILL);
}
...
a_1483(a_1105,a_1001,2130706050); return;
a_G4:a_1483(a_1105,a_1001,2130706045); return;
a_G5:a_1483(a_1105,a_1001,2130706040); return;
a_G6:a_1483(a_1105,a_1001,2130706035);
a_1177(a_F1);
...
a_G12:a_1420(a_1001,2130706031); return;
} /* printBUFFER */
...
a_1483(a_1105,a_1001,2130706026); return;
a_G12:a_1420(a_1001,2130706022); return;
} /* printptr */
...
a_1483(a_1105,a_1001,2130706017);
...
a_A[0]=0; return;
a_G3:a_P[0]=2130706013;a_1104(a_1001,1,a_P);
a_A[0]=1; return;
} /* calltracearg */
...
if(!a_equal(a_1126,0)){ goto a_G3;}
a_A[0]=0; return;
a_G3:a_P[0]=2130706007;a_1104(a_1001,1,a_P);
a_A[0]=1; return;
} /* calltracecall */
...
a_P[0]=2130706003;a_1104(a_1001,1,a_P); return;
a_G4:a_P[0]=2130705992;a_1104(a_1001,1,a_P); return;
} /* addcallstack */
static void a_1209(void){ /* usecallstack */
...
a_P[0]=2130705981;a_P[1]=2;a_P[2]=0;a_P[3]=32;a_1104(a_1001,4,a_P);
...
a_P[0]=2130705962;a_P[1]=to_LIST(a_1286)->offset[a_L1-4];a_1104(a_1001,2,a_P); goto a_G2;
a_G7:a_P[0]=2130705956;a_P[1]=a_L1;a_P[2]=to_LIST(a_1286)->offset[a_L1-4];a_1104(a_1001,3,a_P); goto a_G2;
a_G8:if(a_equal(a_1126,0)){ goto a_G10;}
a_P[0]=2130705950;a_1104(a_1001,1,a_P);
a_G10:a_P[0]=2130705939;a_P[1]=183666544;a_1104(a_1001,2,a_P);
a_L1=0;
a_G12:a_P[0]=a_L1;if(!a_1314(1,a_P)){ return;}a_L1=a_P[0];a_L2=a_P[1];
a_P[0]=2130705939;a_P[1]=a_L2;a_1104(a_1001,2,a_P); goto a_G12;
} /* targetprelude */
static void a_1205(void){ /* targetpostlude */
int a_L1;int a_L2;int a_P[2];
a_L1=0;
a_G2:a_P[0]=a_L1;if(!a_1314(0,a_P)){ goto a_G4;}a_L1=a_P[0];a_L2=a_P[1];
a_P[0]=2130705939;a_P[1]=a_L2;a_1104(a_1001,2,a_P); goto a_G2;
a_G4:a_P[0]=2130705935;a_1104(a_1001,1,a_P); return;
} /* targetpostlude */
static void a_1200(int a_F1,int a_A[1]){ /* ruletyper+>a+a> */
int a_P[2];
if(!a_1324(a_F1,512)){ goto a_G3;}
a_P[0]=2130705930;a_P[1]=a_F1;a_1104(a_1001,2,a_P); goto a_G4;
a_G3:a_P[0]=2130705924;a_P[1]=a_F1;a_1104(a_1001,2,a_P);
...
a_P[0]=2130705918;a_P[1]=a_F1;a_1104(a_1001,2,a_P); return;
} /* outargs */
...
a_P[0]=2130705913;a_1104(a_1001,1,a_P); return;
a_G13:a_P[0]=a_F2;a_1121(a_P);a_F2=a_P[0];
a_P[0]=2130705907;a_P[1]=a_L4;a_1104(a_1001,2,a_P); goto a_G3;
a_G15:a_P[0]=a_F2;a_1164(a_L6,a_P);a_F2=a_P[0];
if(a_is(a_F2)){ goto a_G18;}
a_P[0]=2130705902;a_1104(a_1001,1,a_P);
a_G18:a_putchar(a_1105,41); return;
} /* ruleargs */
static void a_1210(int a_F1){ /* vardeclaration+>a */
int a_P[4];
if(a_1324(a_F1,16)){ return;}
a_P[0]=2130705898;a_P[1]=a_F1;a_P[2]=to_LIST(a_1286)->offset[a_F1-1];a_P[3]=a_F1;a_1104(a_1001,4,a_P); return;
} /* vardeclaration */
static void a_1123(int a_F1,int a_F2,int a_F3){ /* blockdeclaration+>a+>a+>a */
int a_P[3];
a_P[0]=2130705889;a_P[1]=a_F1;a_1104(a_1001,2,a_P);
if(!a_equal(a_F2,0)){ goto a_G4;}
a_P[0]=2130705883;a_1104(a_1001,1,a_P); goto a_G5;
a_G4:a_P[0]=2130705880;a_P[1]=a_F2;a_P[2]=a_F3;a_1104(a_1001,3,a_P);
a_G5:a_P[0]=2130705876;a_P[1]=a_F1;a_1104(a_1001,2,a_P); return;
} /* blockdeclaration */
...
a_1196(a_F1,a_L2);
a_P[0]=2130705870;a_P[1]=a_F1;a_1104(a_1001,2,a_P); return;
} /* ruleprototype */
...
a_P[0]=2130705864;a_1104(a_1001,1,a_P); return;
a_G5:a_incr(a_1159);
a_P[0]=2130705856;a_P[1]=to_LIST(a_1286)->offset[a_F1-4];a_1104(a_1001,2,a_P); return;
} /* rootprototype */
static void a_1133(void){ /* datadeclaration */
int a_L1;int a_L2;int a_L3;int a_L4;int a_P[4];
...
a_P[0]=2130705849;a_P[1]=2047260088;a_1104(a_1001,2,a_P); goto a_G25;
a_G24:a_P[0]=2130705843;a_P[1]=2047260088;a_P[2]=a_L2;a_P[3]=a_L3;a_1104(a_1001,4,a_P);
a_G25:a_P[0]=2130705835;a_P[1]=2047260088;a_1104(a_1001,2,a_P); return;
} /* datadeclaration */
...
static void a_1142(void){ /* filltablehead */
int a_P[1];
a_P[0]=2130705827;a_1104(a_1001,1,a_P);
a_1144=0; return;
} /* filltablehead */
static void a_1143(void){ /* filltabletail */
int a_P[2];
a_P[0]=2130705815;a_P[1]=a_1144;a_1104(a_1001,2,a_P); return;
} /* filltabletail */
static void a_1208(int a_A[1]){ /* untilnextcomma+>a> */

a_G1:if(!a_more(a_A[0],to_LIST(a_1440)->aupb)){ goto a_G3;}
a_1420(a_1001,2130705805); return;
...
a_1461();
a_incr(a_1144);
a_P[0]=2130705796;a_P[1]=a_L1;a_P[2]=a_L1;a_1104(a_1001,3,a_P);
a_L2=to_LIST(a_1440)->aupb;
a_L3=0;
...
a_P[0]=2130705790;a_P[1]=a_L5;a_1104(a_1001,2,a_P);
a_incr(a_1144);
a_unstackto(a_1440,a_L2);
a_L3=0; goto a_G25;
...
a_unstackto(a_1440,a_L2);
a_incr(a_1144);
a_P[0]=2130705786;a_1104(a_1001,1,a_P); return;
} /* generatefillentries */
...
a_P[0]=2130705782;a_P[1]=a_L4;a_P[2]=a_F2;a_P[3]=a_L3;a_P[4]=a_F2;a_1104(a_1001,5,a_P); return;
a_G5:a_1308(a_F2,a_P);a_L3=a_P[0];
a_1319(a_F2,a_P);a_L5=a_P[0];
a_1318(a_F2,a_P);a_L4=a_P[0];
a_1311(a_F2,a_P);a_L6=a_P[0];
a_P[0]=2130705774;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_F2;a_P[4]=a_L3;a_P[5]=a_L4;a_P[6]=a_L5;a_P[7]=a_L6;a_P[8]=a_F2;a_1104(a_1001,9,a_P); return;
} /* listinitialization */
static void a_1129(int a_F1){ /* charfileinitialization+>a */
int a_L2;int a_L3;int a_L4;int a_P[7];
if(!a_1324(a_F1,16)){ goto a_G3;}
a_P[0]=2130705759;a_P[1]=to_LIST(a_1286)->offset[a_F1-1];a_P[2]=a_F1;a_P[3]=a_F1;a_1104(a_1001,4,a_P); return;
...
a_G3:a_1415(a_1001,2130706099); return;
} /* checklisttype */
...
a_G3:a_1415(a_1001,2130706093); return;
} /* checkcalibretype */
...
a_G7:a_1415(a_1001,2130706086); return;
} /* checkconstanttype */
static void a_1238(void){ /* readexpression */
int a_L1;int a_L2;int a_P[1];
if(!a_equal(16777471,a_1454)){ goto a_G4;}
a_L1=a_1455;
a_1461(); goto a_G5;
a_G4:a_1415(a_1001,2130706058); return;
a_G5:a_1220(a_L1,1);
if(a_equal(to_LIST(a_1286)->offset[a_L1-1],0)){ goto a_G8;}
a_G7:a_1415(a_1001,2130706079); return;
a_G8:a_1237(a_L1);
...
a_1420(a_1001,2130706073); return;
...
a_1415(a_1001,2130706073); return;
...
a_G27:a_1415(a_1001,2130706068); return;
} /* finalbase */
...
int a_L2;int a_L3;int a_P[3];
if(!a_1324(a_F1,8)){ goto a_G3;}
a_1420(a_1001,2130706063); return;
a_G3:if(a_1324(a_F1,32)){ return;}
if(!a_1324(a_F1,64)){ goto a_G8;}
a_P[0]=2047260145;a_P[1]=to_LIST(a_1286)->offset[a_F1-3];a_P[2]=a_F1;a_1416(3,a_P);
...
a_incr(a_1223);
if(a_was(a_1214,a_1223)){ goto a_G14;}
a_1415(a_1001,2130706063); return;
...
a_1461();
a_1415(a_1001,2130706183); return;
...
a_1415(a_1001,2130706178); return;
} /* skipdatasection */
static void a_1252(void){ /* datasectioni */
...
if(a_equal(a_1454,16777285)){ return;}
a_1415(a_1001,2130706172); return;
} /* datasectioni */
...
if(!a_1324(a_F1,24)){ return;}
a_G3:a_1415(a_1001,2130706166); return;
} /* checklisttype */
...
a_G5:a_1415(a_1001,2130706160); return;
} /* checkconstanttype */
...
a_G3:a_1415(a_1001,2130706153); return;
...
if(!a_1324(a_F1,24)){ return;}
a_G3:a_1415(a_1001,2130706145); return;
} /* checkfiletype */
static void a_1257(void){ /* fileentry */
int a_L1;int a_L2;int a_L3;int a_P[1];
if(!a_equal(16777471,a_1454)){ goto a_G4;}
a_L1=a_1455;
a_1461(); goto a_G5;
a_G4:a_1415(a_1001,2130706103); return;
a_G5:a_1246(a_L1);
if(!a_equal(16777455,a_1454)){ goto a_G4;}
a_L2=a_1455;
a_1461();
...
a_L1=a_1455;
a_1461(); goto a_G7;
a_G6:a_1415(a_1001,2130706103); return;
...
a_L2=a_1455;
a_1461(); goto a_G13;
a_G12:a_1415(a_1001,2130706103); return;
...
a_G10:a_1415(a_1001,2130706139); return;
...
a_G20:a_1415(a_1001,2130706132); return;
...
a_1420(a_1001,2130706127); return;
} /* datasectionii */
static void a_1256(void){ /* externalentry */
int a_L1;int a_L2;
if(!a_equal(16777471,a_1454)){ goto a_G4;}
...
a_G14:a_1415(a_1001,2130706121); return;
...
a_L4=a_1455;
a_1461(); goto a_G10;
a_G9:a_1415(a_1001,2130706103); return;
...
if(a_equal(a_1454,16777285)){ return;}
a_1415(a_1001,2130706115); return;
} /* datasectioniii */
...
a_G11:a_1420(a_1001,2130706109); return;
...
a_L5=a_1455;
a_1461(); goto a_G7;
a_G6:a_1415(a_1001,2130706187); return;
a_G7:a_1338(a_L5);
...
a_incr(to_LIST(a_1285)->offset[a_F1-1]);
a_1338(a_L4); return;
a_G22:a_1415(a_1001,2130706220); return;
} /* formalaffixes */
...
a_L2=a_1455;
a_1461(); goto a_G5;
a_G4:a_1415(a_1001,2130706187); return;
...
a_1415(a_1001,2130706214); return;
} /* checkitemID */
static void a_1300(void){ /* enteritem */
int a_L1;int a_P[1];
...
a_1461(); goto a_G6;
a_G5:a_1415(a_1001,2130706187); return;
...
a_G22:a_1415(a_1001,2130706209); return;
...
a_G11:a_1415(a_1001,2130706204); return;
...
to_LIST(a_1286)->offset[to_LIST(a_1286)->aupb-3]=a_1455;
a_1461(); goto a_G15;
a_G14:a_1415(a_1001,2130706187); return;
...
a_1461();
a_1294(); goto a_G28;
a_G27:a_1415(a_1001,2130706197); return;
a_G28:a_1330();
...
a_G10:a_1420(a_1001,2130706192); return;
} /* scanitem */
...
a_G9:a_1420(a_1001,2130706225); return;
} /* @root */
...
a_G5:if(!a_1398(a_1001,2130706269)){ goto a_G7;}
a_P[0]=2047260427;a_1421(1,a_P); return;
a_G7:if(!a_1398(a_1001,2130706265)){ goto a_G9;}
a_P[0]=2047260494;a_P[1]=2;a_P[2]=0;a_1421(3,a_P); return;
a_G9:if(!a_1398(a_1001,2130706260)){ goto a_G12;}
a_1387=0;
a_G11:a_previousstring(a_1486,a_1388); goto a_G3;
a_G12:if(!a_1398(a_1001,2130706255)){ goto a_G18;}
...
a_G18:if(!a_1398(a_1001,2130706252)){ goto a_G24;}
a_previousstring(a_1486,a_1388);
...
a_G24:if(!a_1398(a_1001,2130706249)){ goto a_G27;}
a_1347(); goto a_G11;
a_G27:if(!a_1398(a_1001,2130706246)){ return;}
a_1209(); goto a_G11;
...
a_G6:a_1420(a_1001,2130706243); return;
} /* stringtoBUFFER */
...
a_L2=a_1455;
a_1461(); goto a_G10;
a_G9:a_1415(a_1001,2130706237); return;
...
a_1424(a_1001,2130706300); return;
...
a_G11:a_1420(a_1001,2130706296); return;
} /* printpointer */
...
a_1420(a_1001,2130706290); return;
...
a_G14:a_1424(a_1001,2130706280); goto a_G7;
...
a_G8:a_1415(a_1001,2130706347); return;
...
a_G30:a_1415(a_1001,2130706342); return;
} /* readdestination */
...
a_G17:a_1420(a_1001,2130706336); return;
} /* rehash */
...
a_1460(); goto a_G12;
a_G11:a_1415(a_1001,2130706320); return;
...
a_1460(); goto a_G16;
a_G15:a_1415(a_1001,2130706315); return;
...
a_G16:a_1415(a_1001,2130706347); return;
...
a_G146:a_1415(a_1001,2130706310); return;
} /* nextsymbol */
