...
static void a_1123(int a_F1,int a_A[2]); /* assignmentsource */
...
static void a_1137(int a_F1,int a_F2,int a_F3); /* declarecallargs */
static void a_1138(int a_F1,int a_F2,int a_F3); /* declarelocals */
static void a_1139(void); /* deletetarget */
static void a_1140(int a_F1,int a_F2); /* extensionblock */
...
static void a_1199(int a_F1,int a_F2,int a_F3,int a_F4,int a_F5,int a_F6,int a_F7,int a_F8); /* ruledeclarationhead */
...
static int a_1405(int a_F1,int a_A[1]); /* nthpath */
static void a_1406(int a_A[1]); /* openBUFFER */
static void a_1407(int a_F1); /* openfileaslast */
static void a_1408(int a_F1,int a_A[1]); /* openfilefirst */
static void a_1409(int a_F1); /* opensource */
static int a_1410(int a_F1); /* selectpath */
static void a_1411(int a_F1,int a_F2); /* setfileflag */
static void a_1412(int a_F1); /* setsource */
static void a_1413(int a_F1); /* stringtoBUFFER */
static int a_1414=0; /* targetfile */
static void a_1415(int a_F1,int a_A[1]); /* tryfilefirst */
static void a_1416(int a_F1,int a_A[1]); /* tryopen */
static void a_1417(int a_F1,int a_F2,int a_A[1]); /* tryopenwithpath */
static int a_1418(int a_F1,int a_A[1]); /* wasicesource */
#define a_1420 (a_1384+sizeof_LIST) /* MESSAGE */
#define a_1421 (a_1420+sizeof_LIST) /* PRINTFILE */
static void a_1422(int a_F1,int a_F2); /* corrupticefile */
static void a_1423(int a_C,int *a_V); /* error */
static int a_1424=0; /* errorno */
static void a_1425(int a_C,int *a_V); /* fatalerror */
static void a_1426(int a_C,int *a_V); /* formatprint */
static void a_1427(int a_F1,int a_F2); /* internalerror */
static void a_1428(int a_C,int *a_V); /* message */
static void a_1429(int a_F1); /* messagehead */
static void a_1430(void); /* nlcr */
static void a_1431(int a_F1,int a_F2); /* print */
static void a_1432(int a_F1); /* printbase */
static void a_1433(int a_F1); /* printchar */
static void a_1434(int a_F1); /* printform */
static void a_1435(int a_F1,int a_F2); /* printform1 */
static void a_1436(int a_F1); /* printint */
static void a_1437(int a_F1,int a_F2); /* printint1 */
static void a_1438(int a_F1); /* printitem */
static void a_1439(int a_F1); /* printline */
static void a_1440(int a_F1); /* printpointer */
static int a_1441=0; /* prpos */
static void a_1442(int a_F1); /* tabline */
static void a_1443(int a_C,int *a_V); /* warning */
static int a_1444(void); /* waserror */
#define a_1446 (a_1421+sizeof_CHFILE) /* BOLD */
#define a_1447 (a_1446+sizeof_LIST) /* BUFFER */
#define a_1448 (a_1447+sizeof_LIST) /* HASH */
static int a_1449=1; /* HASHentries */
static int a_1450=1023; /* HASHsize */
#define a_1451 (a_1448+sizeof_LIST) /* LEXT */
#define a_1452 (a_1451+sizeof_LIST) /* SOURCE */
static void a_1453(int a_A[1]); /* addLEXTentry */
static int a_1454=32; /* char */
static void a_1455(void); /* closesource */
static void a_1456(void); /* comment */
static void a_1457(int a_F1,int a_A[1]); /* enterstring */
static void a_1458(int a_F1); /* extendBUFFER */
static void a_1459(int a_F1,int a_A[1]); /* gettagdata */
static void a_1460(int a_F1,int a_A[1]); /* gettagimage */
static int a_1461=0; /* inpt */
static int a_1462=0; /* inptvalue */
static int a_1463=0; /* lastchar */
static int a_1464=0; /* lastfilepos */
static int a_1465=0; /* lastinpt */
static int a_1466=0; /* lastinptvalue */
static void a_1467(void); /* nextchar */
static void a_1468(void); /* nextsymbol */
static void a_1469(int a_F1,int a_F2); /* puttagdata */
static void a_1470(int a_A[1]); /* readbold */
static void a_1471(int a_A[1]); /* readdestination */
static void a_1472(int a_A[1]); /* readstring */
static void a_1473(int a_A[1]); /* readtargetnumber */
static void a_1474(int a_A[2]); /* readtargetstring */
static void a_1475(int a_A[1]); /* readtype */
static void a_1476(void); /* rehash */
static void a_1477(void); /* restoreinputposition */
static void a_1478(void); /* saveinputposition */
static int a_1479=1; /* sourceline */
static void a_1480(int a_A[1]); /* trytoopensource */
static int a_1481=0; /* xnumber */
...
static void a_1490(int a_F1,int a_F2,int a_F3); /* putstring */
...
-1}; /* fill table size 2339 */
static void a_data_setup(void){
 a_virtual_min=16777216;a_virtual_max=2130706432;
 a_setup_list(0,a_1001,"@StringTable",1,2130705157,2130706430,1274); /* @StringTable */
 a_setup_list(1,a_1005,"NUMBER",1,2075075500,2130705155,0); /* NUMBER */
 a_setup_list(1,a_1032,"NODE",6,1769111778,2047260052,0); /* NODE */
 a_setup_list(1,a_1033,"ZONE",3,2047260671,2075075496,0); /* ZONE */
 a_setup_list(1,a_1216,"EXPRESSION",1,1574407976,1769111771,0); /* EXPRESSION */
 a_setup_list(1,a_1287,"AUX",6,739963128,1018111402,0); /* AUX */
 a_setup_list(1,a_1288,"ITEM",7,1018111415,1574407968,0); /* ITEM */
 a_setup_list(1,a_1367,"REGISTER",1,155851633,183666460,0); /* REGISTER */
 a_setup_list(1,a_1384,"FILES",3,128036804,155851629,0); /* FILES */
 a_setup_list(0,a_1420,"MESSAGE",1,2047260059,2047260667,609); /* MESSAGE */
 a_setup_list(0,a_1446,"BOLD",1,16777217,16777486,270); /* BOLD */
 a_setup_list(1,a_1447,"BUFFER",1,72407145,128036800,0); /* BUFFER */
 a_setup_list(1,a_1448,"HASH",1,16777488,72407143,0); /* HASH */
 a_setup_list(1,a_1451,"LEXT",2,183666463,739963120,99); /* LEXT */
 a_setup_stdarg(a_1493,"STDARG",1);
 a_setup_charfile(a_1106,"TARGET",2,a_1001,2130706126); /* TARGET */
 a_setup_charfile(a_1421,"PRINTFILE",2,a_1001,2130706379); /* PRINTFILE */
 a_setup_charfile(a_1452,"SOURCE",1,a_1001,2130706426); /* SOURCE */
 a_list_fill(a_FILL);
}
...
{register int *a_r1=a_extension(a_1447,1);a_r1[0]=a_F1;to_LIST(a_1447)->aupb+=1;}
  return;
} /* extendBUFFER */
...
{register int a_r1=to_LIST(a_1447)->offset[a_F1];
 if(!((48<=a_r1 && a_r1<=57))){ goto a_G3;}
}
a_subtr(to_LIST(a_1447)->offset[a_F1],48,a_A[0]); return;
a_G3:a_1427(a_1001,2130705177); return;
} /* getdigit */
...
a_G8:a_1422(a_1001,2130705172); return;
...
static void a_1004(void){ /* @root */
 ...
 a_waitfor(a_1001,2130705165); a_1015(); return;
} /* @root */
static void a_1082(void){ /* rulesection */
...
a_1468(); return;
a_G6:a_1422(a_1001,2130705213); return;
} /* rulesection */
static void a_1092(void){ /* skiprule */
...
a_L4=2; goto a_G26;
a_G22:a_1422(a_1001,2130705208); return;
...
a_A[0]=a_1462;
a_1468(); goto a_G5;
a_G4:a_1422(a_1001,2130705181); return;
a_G5:a_L3=0;
...
a_G11:a_P[0]=2047260073;a_P[1]=a_A[0];a_P[2]=a_L4;a_P[3]=a_L5;a_1423(4,a_P);
a_G12:if(!a_equal(16777442,a_1461)){ goto a_G14;}
a_1468(); goto a_G6;
a_G14:a_1072(a_F1);
if(a_is(a_L3)){ return;}
a_P[0]=2047260086;a_P[1]=a_A[0];a_1423(2,a_P); return;
} /* checkarea */
static void a_1039(void){ /* checkareas */
...
a_1468(); goto a_G6;
a_G13:a_1422(a_1001,2130705181); return;
a_G14:if(!a_1044(a_L1)){ goto a_G18;}
a_1088(2048);
if(a_more(a_L3,1)){ goto a_G20;}
a_P[0]=2047260111;a_P[1]=a_L2;a_1423(2,a_P); goto a_G20;
a_G18:a_P[0]=2047260099;a_P[1]=a_L2;a_1443(2,a_P);
a_1102=1;
...
a_L1=a_1462;
a_1468(); goto a_G6;
a_G5:a_1422(a_1001,2130705181); return;
...
a_1422(a_1001,2130705201); return;
} /* advancenode */
...
a_1468();
a_1422(a_1001,2130705196); return;
...
a_1468();
a_1422(a_1001,2130705191); return;
...
a_1468(); goto a_G23;
a_G22:a_1422(a_1001,2130705181); return;
a_G23:if(!a_equal(16777455,a_1461)){ goto a_G22;}
 goto a_G4;
a_G25:a_1422(a_1001,2130705186); return;
} /* skipaffix */
static void a_1076(int a_C,int *a_V){ /* pushBUFFER+@+>a */

a_G1:{register int *a_r1=a_extension(a_1447,1);a_r1[0]=a_V[0];to_LIST(a_1447)->aupb+=1;}
...
a_L2=a_1462;
a_1468(); goto a_G9;
a_G8:a_1422(a_1001,2130705181); return;
...
a_1468(); goto a_G17;
a_G16:a_1422(a_1001,2130705181); return;
...
a_1468(); goto a_G26;
a_G25:a_1422(a_1001,2130705181); return;
...
a_1468(); goto a_G16;
a_G15:a_1422(a_1001,2130705181); return;
...
a_L2=a_1462;
a_1468(); goto a_G7;
a_G6:a_1422(a_1001,2130705181); return;
...
{register int a_r1=to_LIST(a_1447)->aupb;to_LIST(a_1447)->offset[a_L3]=a_r1;a_L3=a_r1;} goto a_G11;
...
a_1468(); goto a_G1;
a_G10:a_1422(a_1001,2130705181); return;
...
a_1468(); goto a_G1;
a_G9:a_1422(a_1001,2130705181); return;
...
a_P[0]=2047260125;a_P[1]=to_LIST(a_1288)->offset[a_L1-3];a_P[2]=to_LIST(a_1288)->offset[a_L1-2];a_P[3]=to_LIST(a_1288)->offset[a_1068-3];a_1423(4,a_P); return;
a_G42:a_1477();
a_1103=0;
a_1087();
a_1200(); return;
...
a_P[0]=2047260139;a_P[1]=to_LIST(a_1451)->aupb;a_P[2]=a_L1;a_1423(3,a_P); return;
} /* opentarget */
static void a_1131(void){ /* closetarget */
...
a_1490(a_1106,a_1001,2130706122); return;
a_G4:a_1490(a_1106,a_1001,2130706117); return;
a_G5:a_1490(a_1106,a_1001,2130706112); return;
a_G6:a_1490(a_1106,a_1001,2130706107);
a_1179(a_F1);
...
a_G12:a_1427(a_1001,2130706103); return;
} /* printBUFFER */
...
a_1490(a_1106,a_1001,2130706098); return;
a_G12:a_1427(a_1001,2130706094); return;
} /* printptr */
static void a_1180(int a_F1){ /* printnlptr+>a */
int a_L2;int a_L3;int a_P[1];
if(!a_was(a_1451,a_F1)){ goto a_G15;}
a_1460(a_F1,a_P);a_F1=a_P[0];
{register int a_r1=to_LIST(a_1447)->aupb;a_L2=a_r1;a_L3=a_r1;}
...
a_G11:{register int a_r1=to_LIST(a_1447)->offset[a_L2];
...
a_G19:a_1490(a_1106,a_1001,2130706089); goto a_G7;
...
a_1490(a_1106,a_1001,2130706086);
...
a_A[0]=0; return;
a_G3:a_P[0]=2130706082;a_1105(a_1001,1,a_P);
a_A[0]=1; return;
} /* calltracearg */
...
if(!a_equal(a_1127,0)){ goto a_G3;}
a_A[0]=0; return;
a_G3:a_P[0]=2130706076;a_1105(a_1001,1,a_P);
a_A[0]=1; return;
} /* calltracecall */
...
a_P[0]=2130706072;a_1105(a_1001,1,a_P); return;
a_G4:a_P[0]=2130706061;a_1105(a_1001,1,a_P); return;
} /* addcallstack */
static void a_1211(void){ /* usecallstack */
...
a_P[0]=2130706050;a_P[1]=2;a_P[2]=1;a_P[3]=32;a_1105(a_1001,4,a_P);
...
a_P[0]=2130706031;a_P[1]=to_LIST(a_1288)->offset[a_L1-4];a_1105(a_1001,2,a_P); goto a_G2;
a_G7:a_P[0]=2130706025;a_P[1]=a_L1;a_P[2]=to_LIST(a_1288)->offset[a_L1-4];a_1105(a_1001,3,a_P); goto a_G2;
a_G8:if(a_equal(a_1127,0)){ goto a_G10;}
a_P[0]=2130706019;a_1105(a_1001,1,a_P);
a_G10:a_P[0]=2130706008;a_P[1]=183666555;a_1105(a_1001,2,a_P);
a_L1=0;
a_G12:a_P[0]=a_L1;if(!a_1316(1,a_P)){ return;}a_L1=a_P[0];a_L2=a_P[1];
a_P[0]=2130706008;a_P[1]=a_L2;a_1105(a_1001,2,a_P); goto a_G12;
} /* targetprelude */
static void a_1207(void){ /* targetpostlude */
int a_L1;int a_L2;int a_P[2];
a_L1=0;
a_G2:a_P[0]=a_L1;if(!a_1316(0,a_P)){ goto a_G4;}a_L1=a_P[0];a_L2=a_P[1];
a_P[0]=2130706008;a_P[1]=a_L2;a_1105(a_1001,2,a_P); goto a_G2;
a_G4:a_P[0]=2130706004;a_1105(a_1001,1,a_P); return;
} /* targetpostlude */
static void a_1202(int a_F1,int a_A[1]){ /* ruletyper+>a+a> */
int a_P[2];
if(!a_1326(a_F1,512)){ goto a_G3;}
a_P[0]=2130705999;a_P[1]=a_F1;a_1105(a_1001,2,a_P); goto a_G4;
a_G3:a_P[0]=2130705993;a_P[1]=a_F1;a_1105(a_1001,2,a_P);
...
a_P[0]=2130705987;a_P[1]=a_F1;a_1105(a_1001,2,a_P); return;
} /* outargs */
...
a_P[0]=2130705982;a_1105(a_1001,1,a_P); return;
a_G13:a_P[0]=a_F2;a_1122(a_P);a_F2=a_P[0];
a_P[0]=2130705976;a_P[1]=a_L4;a_1105(a_1001,2,a_P); goto a_G3;
a_G15:a_P[0]=a_F2;a_1166(a_L6,a_P);a_F2=a_P[0];
if(a_is(a_F2)){ goto a_G18;}
a_P[0]=2130705971;a_1105(a_1001,1,a_P);
a_G18:a_putchar(a_1106,41); return;
} /* ruleargs */
static void a_1212(int a_F1){ /* vardeclaration+>a */
int a_P[4];
if(a_1326(a_F1,16)){ return;}
a_P[0]=2130705967;a_P[1]=a_F1;a_P[2]=to_LIST(a_1288)->offset[a_F1-1];a_P[3]=a_F1;a_1105(a_1001,4,a_P); return;
} /* vardeclaration */
static void a_1124(int a_F1,int a_F2,int a_F3){ /* blockdeclaration+>a+>a+>a */
int a_P[3];
a_P[0]=2130705958;a_P[1]=a_F1;a_1105(a_1001,2,a_P);
if(!a_equal(a_F2,0)){ goto a_G4;}
a_P[0]=2130705952;a_1105(a_1001,1,a_P); goto a_G5;
a_G4:a_P[0]=2130705949;a_P[1]=a_F2;a_P[2]=a_F3;a_1105(a_1001,3,a_P);
a_G5:a_P[0]=2130705945;a_P[1]=a_F1;a_1105(a_1001,2,a_P); return;
} /* blockdeclaration */
...
a_1198(a_F1,a_L2);
a_P[0]=2130705939;a_P[1]=a_F1;a_1105(a_1001,2,a_P); return;
} /* ruleprototype */
static void a_1197(int a_F1){ /* rootprototype+>a */
int a_L2;int a_P[2];
a_1202(a_F1,a_P);a_L2=a_P[0];
a_1198(a_F1,a_L2);
if(!a_equal(to_LIST(a_1288)->offset[a_F1-4],183666560)){ goto a_G5;}
a_P[0]=2130705933;a_1105(a_1001,1,a_P); return;
a_G5:a_incr(a_1161);
a_P[0]=2130705925;a_P[1]=to_LIST(a_1288)->offset[a_F1-4];a_1105(a_1001,2,a_P); return;
} /* rootprototype */
static void a_1134(void){ /* datadeclaration */
int a_L1;int a_L2;int a_L3;int a_L4;int a_P[4];
...
a_P[0]=2130705918;a_P[1]=2047260161;a_1105(a_1001,2,a_P); goto a_G24;
a_G23:a_P[0]=2130705912;a_P[1]=2047260161;a_P[2]=a_L2;a_P[3]=a_L3;a_1105(a_1001,4,a_P);
a_G24:a_P[0]=2130705904;a_P[1]=2047260161;a_1105(a_1001,2,a_P); return;
} /* datadeclaration */
...
static void a_1143(void){ /* filltablehead */
int a_P[1];
a_P[0]=2130705896;a_1105(a_1001,1,a_P);
a_1145=0; return;
} /* filltablehead */
static void a_1144(void){ /* filltabletail */
int a_P[2];
a_P[0]=2130705884;a_P[1]=a_1145;a_1105(a_1001,2,a_P); return;
} /* filltabletail */
static void a_1210(int a_A[1]){ /* untilnextcomma+>a> */

a_G1:if(!a_more(a_A[0],to_LIST(a_1447)->aupb)){ goto a_G3;}
a_1427(a_1001,2130705874); return;
...
a_L1=a_1462;
a_1468(); goto a_G8;
a_G7:a_1422(a_1001,2130705217); return;
...
a_L2=a_1462;
a_1468(); goto a_G10;
a_G9:a_1422(a_1001,2130705217); return 1;
...
a_1468(); goto a_G1;
a_G6:a_1422(a_1001,2130705217); return;
} /* skipfillinitializer */
static void a_1149(void){ /* generatefillentries */
...
a_L1=a_1462;
a_1468(); goto a_G5;
a_G4:a_1422(a_1001,2130705217); return;
...
a_1468();
a_incr(a_1145);
a_P[0]=2130705865;a_P[1]=a_L1;a_P[2]=a_L1;a_1105(a_1001,3,a_P);
a_L2=to_LIST(a_1447)->aupb;
a_L3=0;
...
a_P[0]=2130705859;a_P[1]=a_L5;a_1105(a_1001,2,a_P);
a_incr(a_1145);
a_unstackto(a_1447,a_L2);
a_L3=0; goto a_G24;
...
a_unstackto(a_1447,a_L2);
a_incr(a_1145);
a_P[0]=2130705855;a_1105(a_1001,1,a_P); return;
} /* generatefillentries */
...
a_P[0]=2130705851;a_P[1]=a_L4;a_P[2]=a_F2;a_P[3]=a_F2;a_P[4]=a_L3;a_1105(a_1001,5,a_P); return;
a_G5:a_1310(a_F2,a_P);a_L3=a_P[0];
a_1321(a_F2,a_P);a_L5=a_P[0];
a_1320(a_F2,a_P);a_L4=a_P[0];
a_1313(a_F2,a_P);a_L6=a_P[0];
a_P[0]=2130705844;a_P[1]=a_F1;a_P[2]=a_F2;a_P[3]=a_F2;a_P[4]=a_L3;a_P[5]=a_L4;a_P[6]=a_L5;a_P[7]=a_L6;a_P[8]=a_F2;a_1105(a_1001,9,a_P); return;
} /* listinitialization */
static void a_1130(int a_F1){ /* charfileinitialization+>a */
int a_L2;int a_L3;int a_L4;int a_P[7];
if(!a_1326(a_F1,16)){ goto a_G3;}
a_P[0]=2130705829;a_P[1]=to_LIST(a_1288)->offset[a_F1-1];a_P[2]=a_F1;a_P[3]=a_F1;a_1105(a_1001,4,a_P); return;
...
a_G11:a_P[0]=2130705823;a_P[1]=a_F1;a_P[2]=a_F1;a_P[3]=a_L2;a_P[4]=a_L3;a_P[5]=a_L4;a_P[6]=a_F1;a_1105(a_1001,7,a_P); return;
...
a_L3=to_LIST(a_1288)->offset[a_L3];
a_G12:a_P[0]=2130705809;a_P[1]=a_F1;a_P[2]=a_F1;a_P[3]=a_L2;a_P[4]=a_L3;a_P[5]=a_L4;a_P[6]=a_L6;a_P[7]=a_F1;a_1105(a_1001,8,a_P);
a_L6=1;
a_G14:a_1311(a_F1,a_L6,a_P);a_L5=a_P[0];
if(a_equal(a_L5,0)){ return;}
if(!a_1326(a_L5,8)){ goto a_G18;}
a_L5=to_LIST(a_1288)->offset[a_L5];
a_G18:a_P[0]=2130705795;a_P[1]=a_F1;a_P[2]=a_L5;a_P[3]=a_L6;a_P[4]=a_L5;a_1105(a_1001,5,a_P);
a_incr(a_L6); goto a_G14;
} /* datafileinitialization */
static void a_1136(void){ /* datainitialization */
int a_L1;int a_P[3];
a_P[0]=2130705783;a_1105(a_1001,1,a_P);
a_P[0]=2130705772;a_P[1]=183666538;a_P[2]=183666545;a_1105(a_1001,3,a_P);
a_L1=to_LIST(a_1288)->alwb;
...
a_G14:{register int a_r1=to_LIST(a_1288)->offset[a_L1-5];
 if(a_r1==16777340){ goto a_G15;}
 if(a_r1==16777345){ goto a_G16;}
  goto a_G13;}
a_G15:a_1130(a_L1); goto a_G13;
a_G16:a_1135(a_L1); goto a_G13;
a_G17:a_P[0]=2130705760;a_1105(a_1001,1,a_P); return;
} /* datainitialization */
static void a_1185(void){ /* procwaitfor */
int a_L1;int a_L2;int a_L3;int a_P[3];
a_P[0]=2130705751;a_1105(a_1001,1,a_P);
a_1128(a_P);a_L3=a_P[0];
a_P[0]=a_L3;a_1122(a_P);
a_P[0]=2130705743;a_1105(a_1001,1,a_P);
if(a_equal(a_1127,0)){ goto a_G7;}
a_P[0]=2130705736;a_1105(a_1001,1,a_P);
a_G7:a_L1=0;
a_G8:a_P[0]=a_L1;if(!a_1316(2,a_P)){ goto a_G11;}a_L1=a_P[0];a_L2=a_P[1];
if(a_equal(to_LIST(a_1288)->offset[a_L2-4],183666560)){ goto a_G8;}
a_P[0]=2130705725;a_P[1]=a_L2;a_P[2]=to_LIST(a_1288)->offset[a_L2-4];a_1105(a_1001,3,a_P); goto a_G8;
a_G11:a_P[0]=2130705717;a_1105(a_1001,1,a_P); return;
} /* procwaitfor */
static void a_1205(void){ /* targetmain */
int a_L1;int a_L2;int a_L3;int a_L4;int a_P[2];
if(a_equal(a_1213,0)){ goto a_G4;}
if(a_more(a_1161,0)){ goto a_G4;}
a_P[0]=2047260176;a_1443(1,a_P);
a_G4:if(!a_equal(a_1213,0)){ goto a_G6;}
if(a_equal(a_1161,0)){ goto a_G7;}
a_G6:a_1185();
a_G7:a_P[0]=2130705714;a_1105(a_1001,1,a_P);
if(a_equal(a_1127,0)){ goto a_G10;}
a_P[0]=2130705706;a_1105(a_1001,1,a_P);
a_G10:a_P[0]=2130705696;a_1105(a_1001,1,a_P);
a_L1=0;a_L4=0;
a_G12:a_P[0]=a_L1;if(!a_1316(2,a_P)){ goto a_G15;}a_L1=a_P[0];a_L2=a_P[1];
if(!a_equal(to_LIST(a_1288)->offset[a_L2-4],183666560)){ goto a_G12;}
a_L4=a_L2; goto a_G12;
a_G15:if(a_equal(a_1161,0)){ goto a_G20;}
a_P[0]=2130705689;a_1105(a_1001,1,a_P);
a_1129(a_P);a_L3=a_P[0];
a_P[0]=a_L3;a_1122(a_P);
a_P[0]=2130705684;a_1105(a_1001,1,a_P);
a_G20:if(!a_is(a_L4)){ goto a_G24;}
a_P[0]=2130705680;a_P[1]=a_L4;a_1105(a_1001,2,a_P);
a_1129(a_P);
a_P[0]=2130705676;a_1105(a_1001,1,a_P); return;
a_G24:a_1422(a_1001,2130705672); return;
} /* targetmain */
...
{ if(a_L4==16777371){ goto a_G7;}
 ...
 goto a_G13;}
a_G7:a_P[0]=2130705667;a_1105(a_1001,1,a_P); goto a_G3;
a_G8:a_P[0]=2130705664;a_1105(a_1001,1,a_P); goto a_G3;
a_G9:a_P[0]=2130705661;a_1105(a_1001,1,a_P); goto a_G3;
a_G10:a_P[0]=2130705657;a_1105(a_1001,1,a_P); goto a_G3;
a_G11:a_P[0]=2130705653;a_1105(a_1001,1,a_P); goto a_G3;
a_G12:a_P[0]=2130705649;a_1105(a_1001,1,a_P); goto a_G3;
a_G13:a_P[0]=2130705645;a_1105(a_1001,1,a_P); goto a_G3;
...
a_G6:a_P[0]=2130705642;a_P[1]=a_F1;a_1105(a_1001,2,a_P); goto a_G4;
} /* declarelocals */
static void a_1137(int a_F1,int a_F2,int a_F3){ /* declarecallargs+>a+>a+>a */
int a_L4;int a_P[3];
if(a_equal(a_F2,0)){ goto a_G3;}
a_P[0]=2130705637;a_P[1]=a_F2;a_1105(a_1001,2,a_P);
a_G3:if(a_equal(a_F3,0)){ goto a_G6;}
a_1309(a_F1,a_P);a_L4=a_P[0];
a_P[0]=2130705632;a_P[1]=a_F3;a_P[2]=a_L4;a_1105(a_1001,3,a_P);
a_G6:a_putchar(a_1106,10); return;
} /* declarecallargs */
static void a_1199(int a_F1,int a_F2,int a_F3,int a_F4,int a_F5,int a_F6,int a_F7,int a_F8){ /* ruledeclarationhead+>a+>a+>a+>a+>a+>a+>a+>a */
int a_L9;int a_P[2];
a_1209=a_F1;
a_1120();
a_1202(a_F1,a_P);a_L9=a_P[0];
a_1198(a_F1,a_L9);
a_P[0]=2130705620;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_1105(a_1001,2,a_P);
a_1203(a_F1);
a_P[0]=2130705616;a_1105(a_1001,1,a_P);
...
a_P[0]=2130705612;a_P[1]=a_F1;a_1105(a_1001,2,a_P);
a_G15:a_1118(a_F8);
a_1119();
a_1121(); return;
} /* ruledeclarationhead */
static void a_1200(void){ /* ruledeclarationtail */
int a_P[2];
a_P[0]=2130705600;a_P[1]=a_1209;a_1105(a_1001,2,a_P); return;
} /* ruledeclarationtail */
static void a_1120(void){ /* addprofilingdef */
int a_P[4];
if(!a_1326(a_1209,33554432)){ return;}
if(!a_equal(a_1158,0)){ goto a_G4;}
a_P[0]=2130705594;a_P[1]=to_LIST(a_1288)->offset[a_1209];a_P[2]=a_1209;a_1105(a_1001,3,a_P); goto a_G5;
a_G4:a_P[0]=2130705583;a_P[1]=to_LIST(a_1288)->offset[a_1209];a_P[2]=a_1209;a_P[3]=to_LIST(a_1288)->offset[a_1158];a_1105(a_1001,4,a_P);
a_G5:a_1158=a_1209; return;
} /* addprofilingdef */
static void a_1119(void){ /* addprofilingcount */
int a_P[2];
if(!a_1326(a_1209,33554432)){ return;}
a_P[0]=2130705571;a_P[1]=to_LIST(a_1288)->offset[a_1209];a_1105(a_1001,2,a_P); return;
} /* addprofilingcount */
static void a_1186(void){ /* profilingdeclaration */
int a_P[2];
a_P[0]=2130705563;a_1105(a_1001,1,a_P);
if(!a_equal(a_1158,0)){ goto a_G4;}
a_P[0]=2130705555;a_1105(a_1001,1,a_P); return;
a_G4:a_P[0]=2130705551;a_P[1]=to_LIST(a_1288)->offset[a_1158];a_1105(a_1001,2,a_P); return;
...
a_G9:a_P[0]=2130705546;a_P[1]=a_L2;a_1105(a_1001,2,a_P);
a_L3=0;
...
a_G17:a_P[0]=2130705537;a_1105(a_1001,1,a_P); return;
} /* addtracing */
...
a_P[0]=2130705533;a_P[1]=a_F1;a_1105(a_1001,2,a_P); return;
} /* jumptolabel */
...
a_incr(a_A[0]);
a_P[0]=2130705526;a_P[1]=a_A[0];a_P[2]=a_L2;a_1105(a_1001,3,a_P); goto a_G3;
} /* Taffixinner */
...
a_G7:a_1427(a_1001,2130705520); return;
} /* Tlimittail */
static void a_1112(int a_A[1]){ /* Tindex+>a> */
int a_L2;int a_P[2];
if(!a_1326(a_1209,67108864)){ goto a_G13;}
a_P[0]=2130705515;a_P[1]=a_A[0];a_1105(a_1001,2,a_P);
a_1129(a_P);a_L2=a_P[0];
a_P[0]=a_L2;a_1122(a_P);
a_P[0]=2130705505;a_P[1]=a_A[0];a_1105(a_1001,2,a_P);
a_incr(a_A[0]);
a_incr(a_A[0]);
...
a_incr(a_A[0]);
a_P[0]=2130705502;a_P[1]=a_L2;a_1105(a_1001,2,a_P); return;
a_G13:a_P[0]=2130705495;a_P[1]=a_A[0];a_1105(a_1001,2,a_P);
a_incr(a_A[0]);
a_incr(a_A[0]);
a_P[0]=a_A[0];a_1108(a_P);a_A[0]=a_P[0];
a_incr(a_A[0]);
...
a_P[0]=2130705487;a_1105(a_1001,1,a_P); return;
a_G22:a_P[0]=2130705484;a_P[1]=a_L2;a_1105(a_1001,2,a_P); return;
} /* Tindex */
static void a_1140(int a_F1,int a_F2){ /* extensionblock+>a+>a */
...
a_incr(a_L3);
a_P[0]=2130705480;a_P[1]=2047260200;a_P[2]=a_L4;a_1105(a_1001,3,a_P); goto a_G6;
a_G10:a_1107(a_F2);
a_putchar(a_1106,59); return;
} /* extensionblock */
...
a_incr(a_F1);
a_L3=a_F1;
a_P[0]=2130705476;a_P[1]=2047260200;a_P[2]=a_L3;a_P[3]=a_L4;a_1105(a_1001,4,a_P);
a_add(2,a_F1,a_F1);
a_G7:a_1140(a_L4,a_F1);
a_F1=to_LIST(a_1447)->offset[a_F1];
if(!a_equal(a_F1,0)){ goto a_G7;}
a_P[0]=2130705464;a_P[1]=a_L3;a_P[2]=a_L4;a_1105(a_1001,3,a_P);
a_1157(a_F2); return;
} /* Textension */
...
a_P[0]=2130705455;a_P[1]=a_A[0];a_1105(a_1001,2,a_P);
a_1107(a_F1);
a_P[0]=2130705449;a_1105(a_1001,1,a_P); return;
} /* boxclassifier */
...
a_P[0]=2130705446;a_P[1]=a_F3;a_P[2]=a_F1;a_1105(a_1001,3,a_P); return;
a_G3:if(!a_1164(a_F1,a_1026)){ goto a_G5;}
a_P[0]=2130705442;a_P[1]=a_F3;a_P[2]=a_F2;a_1105(a_1001,3,a_P); return;
a_G5:if(!a_1164(a_F2,a_1025)){ goto a_G7;}
a_P[0]=2130705438;a_P[1]=a_F3;a_P[2]=a_F1;a_1105(a_1001,3,a_P); return;
a_G7:a_P[0]=2130705434;a_P[1]=a_F1;a_P[2]=a_F3;a_P[3]=a_F3;a_P[4]=a_F2;a_1105(a_1001,5,a_P); return;
} /* Tsingleifcondition */
...
a_P[0]=2130705427;a_1105(a_1001,1,a_P); goto a_G1;
} /* Tifcondition */
...
a_incr(a_F1);
a_L3=to_LIST(a_1447)->offset[a_F1];
a_P[0]=2130705424;a_1105(a_1001,1,a_P);
a_1111(a_F1,a_F2);
a_P[0]=2130705420;a_P[1]=a_F2;a_1105(a_1001,2,a_P);
if(a_equal(a_L3,a_1163)){ return;}
a_P[0]=2130705409;a_P[1]=to_LIST(a_1447)->offset[a_F1];a_1105(a_1001,2,a_P); return;
...
a_P[0]=2130705424;a_1105(a_1001,1,a_P);
a_1111(a_F1,a_F2);
a_P[0]=2130705406;a_P[1]=a_L4;a_1105(a_1001,2,a_P); return;
a_G20:a_P[0]=2130705401;a_1105(a_1001,1,a_P);
a_1111(a_F1,a_F2);
a_P[0]=2130705397;a_P[1]=a_L3;a_1105(a_1001,2,a_P);
if(a_equal(a_L4,a_1163)){ return;}
a_P[0]=2130705393;a_P[1]=a_L4;a_1105(a_1001,2,a_P); return;
a_G25:a_incr(a_F1);
a_P[0]=2130705401;a_1105(a_1001,1,a_P);
a_1111(a_F1,a_F2);
a_P[0]=2130705397;a_P[1]=to_LIST(a_1447)->offset[a_F1];a_1105(a_1001,2,a_P);
a_F1=a_L5; goto a_G1;
} /* Tjumptoareas */
static void a_1109(int a_F1,int a_F2){ /* Tbox+>a+>a */
int a_L3;int a_P[1];
a_P[0]=2130705390;a_1105(a_1001,1,a_P);
a_incr(a_F1);
a_1125(a_F1,a_P);a_L3=a_P[0];
a_incr(a_F2);
a_1113(a_F2,a_L3);
a_P[0]=2130705717;a_1105(a_1001,1,a_P); return;
} /* Tbox */
...
a_P[0]=2130705387;a_P[1]=a_F1;a_P[2]=a_F4;a_1105(a_1001,3,a_P); return;
...
a_G6:a_P[0]=2130705381;a_P[1]=a_L3;a_P[2]=a_F2;a_P[3]=a_F1;a_1105(a_1001,4,a_P); return;
a_G7:a_P[0]=2130705370;a_P[1]=a_F1;a_P[2]=a_L3;a_1105(a_1001,3,a_P); return;
} /* genshiftaffix */
static void a_1150(int a_F1,int a_F2,int a_F3){ /* gengetaffixno+>a+>a+>a */
int a_P[2];
if(!a_noteq(a_F1,2)){ goto a_G3;}
a_1422(a_1001,2130705360); return;
a_G3:if(!a_1155(a_F2)){ goto a_G5;}
a_P[0]=2130705354;a_P[1]=a_F3;a_1105(a_1001,2,a_P); return;
a_G5:a_1107(a_F2);
a_P[0]=2130705350;a_P[1]=a_F3;a_1105(a_1001,2,a_P); return;
} /* gengetaffixno */
...
a_P[0]=a_L3;a_1122(a_P);
a_1107(a_F1);
a_P[0]=2130705345;a_P[1]=a_F2;a_1105(a_1001,2,a_P); return;
} /* genwaitfor */
static void a_1123(int a_F1,int a_A[2]){ /* assignmentsource+>a+a>+a> */
int a_P[2];
{register int a_r1=to_LIST(a_1447)->offset[a_F1];
...
a_A[0]=a_F1;
a_A[1]=0; return;
a_G4:a_A[0]=2047260200;
a_A[1]=1;
a_P[0]=2130705341;a_P[1]=a_A[0];a_1105(a_1001,2,a_P);
a_1107(a_F1);
a_putchar(a_1106,59); return;
} /* assignmentsource */
...
a_incr(a_L9);
a_P[0]=a_F3;a_1162(a_P);a_F3=a_P[0];
{register int a_r1=to_LIST(a_1447)->offset[a_F3];
...
a_G12:a_1123(a_L5,a_P);a_L6=a_P[0];a_L7=a_P[1]; goto a_G14;
a_G13:a_L6=0;a_L7=0;
a_G14:a_F3=a_L5;
a_P[0]=a_F3;a_1162(a_P);a_F3=a_P[0];
a_L9=1;
...
a_G26:a_P[0]=2130705334;a_P[1]=a_L6;a_1105(a_1001,2,a_P); goto a_G17;
a_G27:if(a_equal(a_F2,0)){ goto a_G29;}
a_P[0]=2130705330;a_P[1]=2047260204;a_P[2]=2047260204;a_P[3]=2047260204;a_P[4]=2047260204;a_P[5]=a_L6;a_1105(a_1001,6,a_P);
a_G29:if(a_equal(a_L7,0)){ goto a_G31;}
a_putchar(a_1106,125);
a_G31:a_P[0]=2130705354;a_P[1]=a_F4;a_1105(a_1001,2,a_P); return;
} /* genassignment */
...
a_P[0]=2130705316;a_P[1]=a_F4;a_1105(a_1001,2,a_P);
a_G16:a_1107(a_F1);
a_putchar(a_1106,59); goto a_G19;
a_G18:a_P[0]=2130705311;a_P[1]=a_F4;a_1105(a_1001,2,a_P); goto a_G16;
a_G19:a_incr(a_L9);
...
a_P[0]=2130705306;a_P[1]=a_F4;a_P[2]=a_L6;a_1105(a_1001,3,a_P); return;
} /* repeatblockpreload */
...
a_P[0]=2130705316;a_P[1]=a_L4;a_1105(a_1001,2,a_P);
a_incr(a_L4);
a_1107(a_F1);
...
a_P[0]=2130705294;a_1105(a_1001,1,a_P);
a_G4:a_incr(a_F1);
a_L4=to_LIST(a_1447)->offset[a_F1];
a_P[0]=a_F3;a_1122(a_P);
if(!a_equal(a_L4,0)){ goto a_G9;}
a_P[0]=2130705291;a_1105(a_1001,1,a_P); return;
a_G9:if(!a_less(a_L4,0)){ goto a_G12;}
a_subtr(0,a_L4,a_L4);
a_P[0]=2130705286;a_P[1]=a_L4;a_1105(a_1001,2,a_P); return;
a_G12:if(!a_equal(a_F2,0)){ goto a_G14;}
a_P[0]=2130705281;a_P[1]=a_L4;a_1105(a_1001,2,a_P); return;
a_G14:a_P[0]=2130705277;a_P[1]=a_L4;a_P[2]=a_F2;a_1105(a_1001,3,a_P); return;
} /* repeatblockcall */
static void a_1193(int a_F1){ /* regularrulecall+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_L6;int a_P[2];
a_1318(a_1126,a_P);a_L2=a_P[0];
a_P[0]=2130705272;a_P[1]=a_1126;a_1105(a_1001,2,a_P);
a_L3=0;a_L4=0;
...
a_P[0]=2130705269;a_1105(a_1001,1,a_P); return;
...
a_P[0]=2130705265;a_P[1]=a_F4;a_1105(a_1001,2,a_P); goto a_G20;
a_G19:a_P[0]=2130705260;a_P[1]=a_F4;a_1105(a_1001,2,a_P);
a_G20:a_incr(a_L7);
...
a_P[0]=2130705255;a_P[1]=a_F4;a_P[2]=a_L6;a_1105(a_1001,3,a_P); return;
} /* repeatblockpostload */
...
a_1107(a_F1);
a_P[0]=2130705265;a_P[1]=a_L4;a_1105(a_1001,2,a_P);
a_G11:a_incr(a_L4);
...
a_G5:a_A[0]=2;
a_P[0]=2130705243;a_1105(a_1001,1,a_P); return;
a_G7:a_A[0]=1;
a_P[0]=2130705239;a_1105(a_1001,1,a_P); return;
a_G9:a_A[0]=0; return;
} /* regularcalld1 */
static void a_1189(int a_F1,int a_F2){ /* regularcalld2+>a+>a */
int a_P[2];
if(!a_equal(a_F1,1)){ goto a_G3;}
a_P[0]=2130705236;a_1105(a_1001,1,a_P); return;
a_G3:if(!a_equal(a_F1,2)){ goto a_G5;}
a_P[0]=2130705233;a_P[1]=a_F2;a_1105(a_1001,2,a_P); return;
...
a_P[0]=2130705229;a_P[1]=a_F3;a_P[2]=a_F2;a_1105(a_1001,3,a_P); return;
a_G4:a_P[0]=2130705354;a_P[1]=a_F3;a_1105(a_1001,2,a_P); return;
} /* regularcalld3 */
...
a_P[0]=2130705225;a_1105(a_1001,1,a_P); return;
} /* pidginrepeatblock */
...
int a_L2;int a_P[2];
a_P[0]=2130705220;a_P[1]=a_1126;a_1105(a_1001,2,a_P);
...
{register int *a_r1=a_extension(a_1216,1);a_r1[0]=a_F1;to_LIST(a_1216)->aupb+=1;}
  return;
} /* pushEXPR */
...
a_G3:a_1422(a_1001,2130706171); return;
} /* checklisttype */
...
a_G3:a_1422(a_1001,2130706165); return;
} /* checkcalibretype */
...
a_G5:a_1422(a_1001,2130706158); return;
} /* checkconstanttype */
static void a_1240(void){ /* readexpression */
int a_L1;int a_L2;int a_P[1];
if(!a_equal(16777471,a_1461)){ goto a_G4;}
a_L1=a_1462;
a_1468(); goto a_G5;
a_G4:a_1422(a_1001,2130706130); return;
a_G5:a_1222(a_L1,1);
if(a_equal(to_LIST(a_1288)->offset[a_L1-1],0)){ goto a_G8;}
a_G7:a_1422(a_1001,2130706151); return;
a_G8:a_1239(a_L1);
...
a_1427(a_1001,2130706145); return;
a_G3:if(a_1326(a_F1,32)){ return;}
if(!a_1326(a_F1,64)){ goto a_G8;}
a_P[0]=2047260218;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_F1;a_1423(3,a_P);
...
a_1422(a_1001,2130706145); return;
...
a_G24:a_1422(a_1001,2130706140); return;
} /* finalbase */
...
int a_L2;int a_L3;int a_P[3];
if(!a_1326(a_F1,8)){ goto a_G3;}
a_1427(a_1001,2130706135); return;
a_G3:if(a_1326(a_F1,32)){ return;}
if(!a_1326(a_F1,64)){ goto a_G8;}
a_P[0]=2047260218;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_F1;a_1423(3,a_P);
...
a_incr(a_1225);
if(a_was(a_1216,a_1225)){ goto a_G14;}
a_1422(a_1001,2130706135); return;
...
a_1243(183666538,a_P);a_L3=a_P[0];
a_1243(183666545,a_P);a_L4=a_P[0];
...
a_1468();
a_1422(a_1001,2130706255); return;
...
a_1422(a_1001,2130706250); return;
} /* skipdatasection */
static void a_1254(void){ /* datasectioni */
...
if(a_equal(a_1461,16777285)){ return;}
a_1422(a_1001,2130706244); return;
} /* datasectioni */
...
if(!a_1326(a_F1,24)){ return;}
a_G3:a_1422(a_1001,2130706238); return;
} /* checklisttype */
...
a_G4:a_1422(a_1001,2130706232); return;
} /* checkconstanttype */
...
a_G3:a_1422(a_1001,2130706225); return;
...
if(!a_1326(a_F1,24)){ return;}
a_G3:a_1422(a_1001,2130706217); return;
} /* checkfiletype */
static void a_1259(void){ /* fileentry */
int a_L1;int a_L2;int a_L3;int a_P[1];
if(!a_equal(16777471,a_1461)){ goto a_G4;}
a_L1=a_1462;
a_1468(); goto a_G5;
a_G4:a_1422(a_1001,2130706175); return;
a_G5:a_1248(a_L1);
if(!a_equal(16777455,a_1461)){ goto a_G4;}
a_L2=a_1462;
a_1468();
...
a_L1=a_1462;
a_1468(); goto a_G7;
a_G6:a_1422(a_1001,2130706175); return;
...
a_G8:a_P[0]=2047260234;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_L3;a_P[3]=1000;a_1423(4,a_P); return;
a_G9:if(!a_equal(16777471,a_1461)){ goto a_G12;}
a_L2=a_1462;
a_1468(); goto a_G13;
a_G12:a_1422(a_1001,2130706175); return;
...
a_G10:a_1422(a_1001,2130706211); return;
...
a_G17:a_1422(a_1001,2130706204); return;
...
a_G3:a_P[0]=2047260249;a_P[1]=to_LIST(a_1288)->offset[a_F2-3];a_P[2]=a_F1;a_P[3]=a_F2;a_1443(4,a_P);
a_G4:a_min(100,a_F1);
a_max(1,a_F1);
a_subtr(0,a_F1,a_F1);
...
a_G3:a_P[0]=2047260262;a_P[1]=to_LIST(a_1288)->offset[a_F2-3];a_P[2]=a_F1;a_P[3]=a_F2;a_1443(4,a_P);
...
a_A[0]=1;
a_P[0]=2047260274;a_P[1]=to_LIST(a_1288)->offset[a_F2-3];a_P[2]=to_LIST(a_1288)->offset[a_F1-3];a_P[3]=a_F2;a_1423(4,a_P); return;
} /* getestimator */
static void a_1255(void){ /* datasectionii */
...
a_1427(a_1001,2130706199); return;
} /* datasectionii */
static void a_1258(void){ /* externalentry */
int a_L1;int a_L2;
if(!a_equal(16777471,a_1461)){ goto a_G4;}
...
a_G12:a_1422(a_1001,2130706193); return;
...
a_G9:if(!a_equal(16777471,a_1461)){ goto a_G11;}
 goto a_G7;
a_G11:a_1422(a_1001,2130706175); return;
...
a_G4:a_P[0]=2047260307;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_F2;a_P[3]=a_A[0];a_P[4]=to_LIST(a_1288)->offset[a_F3-3];a_P[5]=1000;a_1423(6,a_P);
a_A[0]=1; return;
a_G6:a_A[0]=1;
a_P[0]=2047260288;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_F2;a_P[3]=to_LIST(a_1288)->offset[a_F3-3];a_1423(4,a_P); return;
} /* repeatervalue */
...
a_L4=a_1462;
a_1468(); goto a_G10;
a_G9:a_1422(a_1001,2130706175); return;
...
if(a_equal(a_1461,16777285)){ return;}
a_1422(a_1001,2130706187); return;
} /* datasectioniii */
...
a_1224();
a_1253(); return;
a_G8:a_P[0]=2047260316;a_1423(1,a_P); return;
...
a_G11:a_1427(a_1001,2130706181); return;
...
{register int *a_r1=a_extension(a_1288,7);a_r1[0]=a_r1[1]=a_r1[2]=a_r1[3]=a_r1[4]=a_r1[5]=a_r1[6]=0;to_LIST(a_1288)->aupb+=7;}
  return;
} /* expandITEM */
...
{register int *a_r1=a_extension(a_1287,1);a_r1[0]=a_F1;to_LIST(a_1287)->aupb+=1;}
  return;
} /* pushAUX */
...
{register int *a_r1=a_extension(a_1287,3);a_r1[0]=a_F1;a_r1[1]=a_F2;a_r1[2]=a_1335;to_LIST(a_1287)->aupb+=3;}
...
a_L5=a_1462;
a_1468(); goto a_G7;
a_G6:a_1422(a_1001,2130706259); return;
a_G7:a_1340(a_L5);
...
a_incr(to_LIST(a_1287)->offset[a_F1-1]);
a_1340(a_L4); return;
a_G20:a_1422(a_1001,2130706292); return;
} /* formalaffixes */
...
a_L2=a_1462;
a_1468(); goto a_G5;
a_G4:a_1422(a_1001,2130706259); return;
a_G5:a_L3=to_LIST(a_1287)->aupb;
{register int *a_r1=a_extension(a_1287,3);a_r1[0]=a_r1[1]=a_L2;a_r1[2]=0;to_LIST(a_1287)->aupb+=3;}
...
a_L3=a_1462;
a_1468();
{register int *a_r1=a_extension(a_1287,6);a_r1[0]=a_r1[1]=a_r1[2]=0;a_r1[3]=a_L2;a_r1[4]=a_L3;a_r1[5]=0;to_LIST(a_1287)->aupb+=6;}
a_A[0]=to_LIST(a_1287)->aupb; return;
} /* storelistbounds */
static void a_1295(int a_F1){ /* checkitemID+>a */

if(a_equal(a_F1,to_LIST(a_1288)->aupb)){ return;}
a_1422(a_1001,2130706286); return;
} /* checkitemID */
static void a_1302(void){ /* enteritem */
int a_L1;int a_P[1];
if(!a_1326(to_LIST(a_1288)->aupb,4)){ return;}
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb]=a_1337;
{register int *a_r1=a_extension(a_1287,3);a_r1[0]=to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-4];a_r1[1]=to_LIST(a_1288)->aupb;a_r1[2]=0;to_LIST(a_1287)->aupb+=3;}
...
a_1468(); goto a_G6;
a_G5:a_1422(a_1001,2130706259); return;
...
a_G19:a_1422(a_1001,2130706281); return;
a_G20:to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-2]=a_L3;
a_G21:{register int a_r1=to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-5];
...
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-4]=183666560;
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-3]=183666469;
{register int *a_r1=a_extension(a_1287,6);a_r1[0]=a_r1[1]=a_r1[2]=0;a_r1[3]=a_r1[4]=1;a_r1[5]=0;to_LIST(a_1287)->aupb+=6;}
...
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-4]=183666560;
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-3]=183666477;
...
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-5]=16777349;
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-4]=183666560;
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-3]=183666485;
...
{register int *a_r1=a_extension(a_1287,3);a_r1[0]=a_F2;a_r1[1]=a_r1[2]=0;to_LIST(a_1287)->aupb+=3;}
a_A[0]=to_LIST(a_1287)->aupb;
...
if(!a_equal(to_LIST(a_1288)->offset[a_F1],183666498)){ return 0;}
...
if(!a_equal(to_LIST(a_1288)->offset[a_F1-3],183666504)){ return 0;}
if(!a_equal(to_LIST(a_1288)->offset[a_F1-5],16777349)){ return 0;}
...
if(!a_noteq(to_LIST(a_1288)->offset[a_F1-3],183666511)){ return 0;} return 1;
...
a_L4=a_1462;
a_1468();
{register int *a_r1=a_extension(a_1287,3);a_r1[0]=0;a_r1[1]=a_L3;a_r1[2]=a_L4;to_LIST(a_1287)->aupb+=3;}
...
a_P[0]=2047260326;a_P[1]=to_LIST(a_1288)->offset[a_1333-5];a_1423(2,a_P); return;
...
a_G10:a_1422(a_1001,2130706276); return;
a_G11:if(!a_equal(16777483,a_1461)){ goto a_G4;}
a_L3=a_1462;
a_1468();
{register int *a_r1=a_extension(a_1287,3);a_r1[0]=a_L1;a_r1[1]=a_L2;a_r1[2]=a_L3;to_LIST(a_1287)->aupb+=3;}
...
to_LIST(a_1288)->offset[to_LIST(a_1288)->aupb-3]=a_1462;
a_1468(); goto a_G15;
a_G14:a_1422(a_1001,2130706259); return;
...
a_1468();
a_1296(); goto a_G26;
a_G25:a_1422(a_1001,2130706269); return;
a_G26:a_1332();
if(!a_equal(16777455,a_1461)){ goto a_G14;}
a_L2=a_1462;
a_1468();
if(a_equal(a_L2,32)){ goto a_G32;}
a_P[0]=2047260338;a_1423(1,a_P);
a_G32:a_1336=0;
a_1345();
...
a_P[0]=2047260352;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_F1;a_1423(3,a_P); return;
a_G5:if(!a_1323(a_L2,a_F1)){ goto a_G7;}
a_P[0]=2047260363;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_L2;a_P[3]=a_F1;a_1423(4,a_P); return;
a_G7:if(!a_was(a_1288,to_LIST(a_1288)->offset[a_L2])){ goto a_G10;}
a_1358(a_L2,128);
a_1358(to_LIST(a_1288)->offset[a_L2],4); return;
a_G10:a_1427(a_1001,2130706264); return;
} /* scanitem */
...
a_P[0]=2047260373;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=to_LIST(a_1288)->offset[a_F1];a_P[3]=a_L4;a_1423(4,a_P); return;
} /* scanitemfordbledef */
static void a_1352(void){ /* scanfordoubledefinitions */
int a_L1;int a_L2;int a_P[1];
...
a_P[0]=2047260344;a_1423(1,a_P); return;
a_G3:a_1322(0);
a_1330=a_1337;
a_G5:a_L1=0;
...
a_P[0]=2047260381;a_P[1]=to_LIST(a_1288)->offset[a_F1-3];a_P[2]=a_F1;a_1443(3,a_P); return;
} /* reportitem */
static void a_1349(void){ /* reportnotusedpublicitems */
int a_L1;int a_L2;int a_P[1];
...
int a_L2;
{register int *a_r1=a_extension(a_1367,1);a_r1[0]=0;to_LIST(a_1367)->aupb+=1;}
...
{register int *a_r1=a_extension(a_F2,1);a_r1[0]=to_LIST(a_1367)->offset[a_L3];to_LIST(a_F2)->aupb+=1;}
a_decr(a_L2);
a_incr(a_L3); goto a_G3;
...
a_G6: a_waitfor(a_1001,2130706301); if(!a_equal(32,32)){ goto a_G9;}
if(a_equal(32,32)){ return;}
a_G9:a_1427(a_1001,2130706297); return;
} /* @root */
...
static void a_1411(int a_F1,int a_F2){ /* setfileflag+>a+>a */
...
{register int *a_r1=a_extension(a_1384,3);a_r1[0]=a_r1[1]=0;a_r1[2]=a_F1;to_LIST(a_1384)->aupb+=3;}
  return;
a_G4:a_P[0]=2047260606;a_P[1]=200;a_1425(2,a_P); return;
} /* extendFILES */
...
a_P[0]=2047260585;a_1423(1,a_P); return;
a_G5:if(!a_1400(a_1001,2130706343)){ goto a_G7;}
a_P[0]=2047260502;a_1428(1,a_P); return;
a_G7:if(!a_1400(a_1001,2130706339)){ goto a_G9;}
a_P[0]=2047260569;a_P[1]=2;a_P[2]=1;a_1428(3,a_P); return;
a_G9:if(!a_1400(a_1001,2130706334)){ goto a_G12;}
a_1389=0;
a_G11:a_previousstring(a_1493,a_1390); goto a_G3;
a_G12:if(!a_1400(a_1001,2130706329)){ goto a_G17;}
a_previousstring(a_1493,a_1390);
if(!a_less(a_1390,to_LIST(a_1493)->alwb)){ goto a_G16;}
a_P[0]=2047260594;a_P[1]=111;a_1423(2,a_P); return;
a_G16:a_1414=a_1390; goto a_G11;
a_G17:if(!a_1400(a_1001,2130706326)){ goto a_G22;}
a_previousstring(a_1493,a_1390);
if(!a_less(a_1390,to_LIST(a_1493)->alwb)){ goto a_G21;}
a_P[0]=2047260594;a_P[1]=76;a_1423(2,a_P); return;
a_G21:a_1401=a_1390; goto a_G11;
a_G22:if(!a_1400(a_1001,2130706323)){ goto a_G24;}
a_1349(); goto a_G11;
a_G24:if(!a_1400(a_1001,2130706320)){ return;}
a_1211(); goto a_G11;
...
static int a_1418(int a_F1,int a_A[1]){ /* wasicesource+>a+a> */
...
static void a_1406(int a_A[1]){ /* openBUFFER+a> */
int a_L2;int a_P[1];
...
static void a_1413(int a_F1){ /* stringtoBUFFER+>a */
int a_P[1];
...
a_G6:a_1427(a_1001,2130706317); return;
} /* stringtoBUFFER */
static int a_1405(int a_F1,int a_A[1]){ /* nthpath+>a+a> */
int a_L3;
...
static int a_1410(int a_F1){ /* selectpath+>a */
int a_L2;int a_L3;int a_P[1];
...
static void a_1408(int a_F1,int a_A[1]){ /* openfilefirst+>a+a> */
int a_P[1];
a_scratch(a_1447);
if(!a_1399(a_F1,2)){ goto a_G4;}
a_1417(a_F1,a_1401,a_P);a_A[0]=a_P[0]; return;
a_G4:if(!a_1399(a_F1,4)){ goto a_G6;}
a_1417(a_F1,183666525,a_P);a_A[0]=a_P[0]; return;
a_G6:a_1416(a_F1,a_P);a_A[0]=a_P[0]; return;
} /* openfilefirst */
static void a_1417(int a_F1,int a_F2,int a_A[1]){ /* tryopenwithpath+>a+>a+a> */
int a_P[1];
...
static void a_1416(int a_F1,int a_A[1]){ /* tryopen+>a+a> */
int a_P[2];
...
a_P[0]=2047260615;a_P[1]=a_F1;a_1425(2,a_P); return;
} /* tryopen */
static void a_1407(int a_F1){ /* openfileaslast+>a */
int a_L2;int a_P[2];
if(a_1399(a_F1,8)){ goto a_G3;}
a_1427(a_1001,2130706311); return;
...
static void a_1412(int a_F1){ /* setsource+>a */

a_1385=a_F1; return;
} /* setsource */
static void a_1409(int a_F1){ /* opensource+>a */
...
static void a_1415(int a_F1,int a_A[1]){ /* tryfilefirst+>a+a> */
int a_P[1];
...
a_P[0]=2047260626;a_P[1]=a_F1;a_1425(2,a_P); return;
...
a_L2=a_1462;
a_1468(); goto a_G10;
a_G9:a_1422(a_1001,2130706305); return;
...
{register int a_r1=to_LIST(a_1447)->offset[a_L4];
...
static void a_1433(int a_F1){ /* printchar+>a */
...
static void a_1442(int a_F1){ /* tabline+>a */
...
static void a_1436(int a_F1){ /* printint+>a */
...
static void a_1437(int a_F1,int a_F2){ /* printint1+>a+>a */
int a_L3;int a_L4;
a_divrem11(a_F1,10,a_L3,a_L4);
if(a_equal(a_L3,0)){ goto a_G4;}
a_1437(a_L3,48);
...
static void a_1434(int a_F1){ /* printform+>a */

a_1435(a_F1,4); return;
} /* printform */
static void a_1435(int a_F1,int a_F2){ /* printform1+>a+>a */
int a_L3;int a_L4;
...
static void a_1431(int a_F1,int a_F2){ /* print+t[]+>a */
int a_L2;
...
static void a_1440(int a_F1){ /* printpointer+>a */
int a_P[1];
a_G1:if(!a_equal(a_F1,0)){ goto a_G3;}
a_1431(a_1001,2130706374); return;
...
a_G11:a_1427(a_1001,2130706370); return;
} /* printpointer */
static void a_1432(int a_F1){ /* printbase+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_L2=to_LIST(a_1447)->aupb;
...
a_1427(a_1001,2130706364); return;
...
static void a_1438(int a_F1){ /* printitem+>a */
...
a_1433(32);
a_1431(a_1001,2130706359);
a_1440(a_L4);
a_1433(41); return;
} /* printitem */
static void a_1439(int a_F1){ /* printline+>a */
...
static void a_1426(int a_C,int *a_V){ /* formatprint+@+>a */
int a_L2;int a_L3;
a_L2=to_LIST(a_1447)->aupb;
...
a_G11:{register int a_r1=to_LIST(a_1447)->offset[a_L3];
...
a_G14:a_1431(a_1001,2130706354); goto a_G7;
a_G15:if(a_C<=1){ goto a_G14;} a_C--;a_V+=1;
...
static void a_1429(int a_F1){ /* messagehead+>a */
int a_L2;int a_P[1];
a_1430();
a_1433(a_F1);
a_1433(32);
...
static void a_1423(int a_C,int *a_V){ /* error+@+>a */
int a_P[1];
...
a_1429(70);
a_P[0]=2047260641;a_1426(1,a_P);
a_1430(); return;
} /* error */
static void a_1443(int a_C,int *a_V){ /* warning+@+>a */
...
static void a_1428(int a_C,int *a_V){ /* message+@+>a */

a_1426(a_C,a_V);
a_1430();
a_incr(a_1424); return;
} /* message */
static void a_1425(int a_C,int *a_V){ /* fatalerror+@+>a */
...
static void a_1422(int a_F1,int a_F2){ /* corrupticefile+t[]+>a */
int a_L2;int a_P[2];
a_1429(70);
a_1395(a_P);a_L2=a_P[0];
a_P[0]=2047260662;a_P[1]=a_L2;a_1426(2,a_P);
a_1431(a_F1,a_F2);
a_P[0]=2047260667;a_1426(1,a_P);
a_1430();
a_exit(3); return;
} /* corrupticefile */
static void a_1427(int a_F1,int a_F2){ /* internalerror+t[]+>a */
int a_P[1];
a_1429(70);
a_P[0]=2047260649;a_1426(1,a_P);
a_1431(a_F1,a_F2);
a_P[0]=2047260654;a_1426(1,a_P);
a_1430();
a_exit(15); return;
} /* internalerror */
...
static void a_1480(int a_A[1]){ /* trytoopensource+a> */
int a_L2;
...
static void a_1471(int a_A[1]){ /* readdestination+a> */
int a_L2;
...
a_G8:a_1422(a_1001,2130706421); return;
...
a_G28:a_1422(a_1001,2130706416); return;
} /* readdestination */
static void a_1473(int a_A[1]){ /* readtargetnumber+a> */
int a_L2;int a_L3;int a_P[1];
a_L2=to_LIST(a_1447)->aupb;
a_L3=0;
...
static void a_1459(int a_F1,int a_A[1]){ /* gettagdata+>a+a> */

a_A[0]=to_LIST(a_1451)->offset[a_F1]; return;
} /* gettagdata */
static void a_1460(int a_F1,int a_A[1]){ /* gettagimage+>a+a> */

a_subtr(a_F1,2,a_A[0]); return;
} /* gettagimage */
static void a_1469(int a_F1,int a_F2){ /* puttagdata+>a+>a */

to_LIST(a_1451)->offset[a_F1]=a_F2; return;
} /* puttagdata */
static void a_1453(int a_A[1]){ /* addLEXTentry+a> */
int a_P[1];
{register int *a_r1=a_extension(a_1451,2);a_r1[0]=a_r1[1]=0;to_LIST(a_1451)->aupb+=2;}
a_1457(to_LIST(a_1451)->aupb,a_P);a_A[0]=a_P[0];
if(a_equal(a_A[0],to_LIST(a_1451)->aupb)){ return;}
a_unstack(a_1451);
a_unstackstring(a_1451); return;
} /* addLEXTentry */
static void a_1457(int a_F1,int a_A[1]){ /* enterstring+>a+a> */
...
{register int *a_r1=a_extension(a_1448,1);a_r1[0]=0;to_LIST(a_1448)->aupb+=1;}
  goto a_G7;
...
a_G16:a_1427(a_1001,2130706410); return;
} /* rehash */
static void a_1472(int a_A[1]){ /* readstring+a> */
int a_L2;int a_L3;int a_P[1];
a_L3=to_LIST(a_1447)->aupb;
a_L2=0;
a_G3:a_1467();
...
a_G14:a_1422(a_1001,2130706406); return;
} /* readstring */
static void a_1474(int a_A[2]){ /* readtargetstring+a>+a> */
int a_L3;int a_P[2];
a_L3=to_LIST(a_1447)->aupb;
if(a_equal(a_1454,34)){ goto a_G4;}
a_G3:a_1422(a_1001,2130706401); return;
a_G4:a_1467();
...
static void a_1470(int a_A[1]){ /* readbold+a> */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_1467();
a_L3=to_LIST(a_1447)->aupb;
a_L2=0;
...
a_1467(); goto a_G12;
a_G11:a_1422(a_1001,2130706394); return;
...
static void a_1475(int a_A[1]){ /* readtype+a> */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_1467();
a_L3=to_LIST(a_1447)->aupb;
a_L2=0;
...
a_1467(); goto a_G16;
a_G15:a_1422(a_1001,2130706389); return;
...
a_G16:a_1422(a_1001,2130706421); return;
...
a_G117:a_1422(a_1001,2130706384); return;
} /* nextsymbol */
...
static void a_1490(int a_F1,int a_F2,int a_F3){ /* putstring+""f+t[]+>a */
int a_L2;int a_L3;int a_P[1];
a_L2=0;
