...
static void a_1007(int a_F1,int a_F2); /* corrupticefile */
static void a_1008(int a_F1,int a_C,int *a_V); /* error */
static void a_1009(int a_F1,int a_C,int *a_V); /* formatprint */
static void a_1010(int a_F1,int a_F2); /* internalerror */
static void a_1011(void); /* nlcr */
static void a_1012(int a_F1,int a_F2); /* print */
static void a_1013(int a_F1); /* printchar */
static void a_1014(int a_F1); /* printnum */
static void a_1015(int a_F1,int a_F2); /* printnum1 */
#define a_1017 (a_1006+sizeof_LIST) /* AUX */
#define a_1018 (a_1017+sizeof_LIST) /* ITEM */
static void a_1019(int a_F1,int a_F2); /* addpull */
static void a_1020(int a_A[1]); /* converttoitem */
static void a_1021(void); /* copydatasection */
static void a_1022(int a_F1); /* copyexpression */
static void a_1023(int a_F1); /* copyexternal */
static void a_1024(void); /* copyfileareas */
static void a_1025(int a_F1); /* copyfileentry */
static void a_1026(int a_F1); /* copyfillentry */
...
static void a_1033(int a_F1); /* copyitem */
static void a_1034(void); /* copyitemsection */
static void a_1035(void); /* copylistbounds */
static void a_1036(int a_F1); /* copylistentry */
static void a_1037(int a_F1); /* copymatter */
static void a_1038(void); /* copynode */
static void a_1039(int a_F1); /* copyrule */
...
static void a_1045(int a_F1); /* fileareas */
static void a_1046(void); /* fileentry */
static void a_1047(void); /* fillentry */
static void a_1048(int a_F1); /* fillinitializers */
static void a_1049(int a_F1); /* fillitem */
static void a_1050(int a_F1); /* fillitempack */
static void a_1051(int a_F1); /* fillrepeater */
static void a_1052(int a_F1,int a_A[1]); /* getitemrepr */
static void a_1053(void); /* handlenode */
static void a_1054(int a_F1); /* handlerule */
static void a_1055(void); /* headsection */
static int a_1056(int a_F1,int a_F2); /* isitemflag */
static int a_1057(int a_F1,int a_F2); /* ispulleditem */
static void a_1058(void); /* itemsection */
static void a_1059(void); /* listentry */
static void a_1060(int a_F1); /* markifrequested */
static int a_1061=0; /* nextitem */
static int a_1062=1; /* nodeoptimization */
static void a_1063(void); /* readexpression */
static void a_1064(void); /* readitem */
static void a_1065(int a_F1); /* readnode */
static void a_1066(void); /* readrule */
static void a_1067(void); /* rulesection */
static void a_1068(int a_F1,int a_F2); /* setitemflag */
static void a_1069(void); /* skipentry */
static void a_1070(void); /* skipformalaffixes */
static void a_1071(int a_F1); /* skipitem */
static void a_1072(void); /* skiplistbounds */
static void a_1073(int a_F1,int a_A[1]); /* traverseitem */
static void a_1074(void); /* traverseitems */
static void a_1075(int a_A[1]); /* traverseonce */
#define a_1077 (a_1018+sizeof_LIST) /* BOLD */
#define a_1078 (a_1077+sizeof_LIST) /* BUFFER */
#define a_1079 (a_1078+sizeof_LIST) /* HASH */
static int a_1080=1; /* HASHentries */
static int a_1081=1023; /* HASHsize */
#define a_1082 (a_1079+sizeof_LIST) /* LEXT */
#define a_1083 (a_1082+sizeof_LIST) /* RESULT */
#define a_1084 (a_1083+sizeof_CHFILE) /* SOURCE */
static void a_1085(int a_F1); /* W */
static void a_1086(int a_F1,int a_F2); /* WW */
static void a_1087(int a_A[1]); /* addLEXTentry */
static int a_1088=32; /* char */
static void a_1089(void); /* closesource */
static void a_1090(void); /* comment */
static void a_1091(void); /* copysourcetoresult */
static void a_1092(int a_F1,int a_A[1]); /* enterstring */
static void a_1093(int a_F1); /* extendBUFFER */
static void a_1094(int a_F1,int a_A[1]); /* gettagimage */
static int a_1095=0; /* inf */
static int a_1096=0; /* inpt */
static int a_1097=0; /* inptvalue */
static void a_1098(void); /* movetempfile */
static void a_1099(void); /* nextchar */
static void a_1100(void); /* nextsymbol */
static void a_1101(int a_F1); /* opensource */
static void a_1102(int a_F1); /* opensourcefile */
static int a_1103=0; /* outf */
static int a_1104=0; /* output */
static void a_1105(int a_A[1]); /* readbold */
static void a_1106(int a_A[1]); /* readdestination */
static void a_1107(int a_A[1]); /* readstring */
static void a_1108(int a_A[1]); /* readtargetnumber */
static void a_1109(int a_A[1]); /* readtargetstring */
static void a_1110(int a_A[1]); /* readtype */
static void a_1111(void); /* rehash */
static void a_1112(int a_F1,int a_F2); /* rewindsource */
static int a_1113=1; /* sourceline */
static void a_1114(int a_F1); /* toggleout */
static void a_1115(int a_A[1]); /* trytoopen */
static void a_1116(int a_F1,int a_F2); /* wnum1 */
static void a_1117(int a_F1); /* writenum */
static int a_1118=1; /* wsep */
static void a_1119(void); /* wspace */
static int a_1121=0; /* argtop */
static void a_1122(void); /* checkcommandlinearguments */
static void a_1123(void); /* firstpass */
static int a_1124=0; /* ifile */
static int a_1125(int a_F1,int a_F2); /* isfirstarg */
static int a_1126=1; /* nextID */
static int a_1127=0; /* ofile */
static void a_1128(void); /* parseSTDARG */
static void a_1129(void); /* renumberitems */
static int a_1130=0; /* replacearg */
static void a_1131(void); /* secondpass */
static void a_1132(int a_F1); /* setrepr */
#define a_1134 (a_1084+sizeof_CHFILE) /* AUX */
static void a_1135(int a_F1); /* N */
static void a_1136(int a_F1,int a_F2); /* NN */
#define a_1137 (a_1134+sizeof_LIST) /* NODE */
static int a_1138(int a_F1); /* checknode */
static void a_1139(int a_F1,int a_F2); /* dumpAUX */
static void a_1140(void); /* dumprule */
static void a_1141(void); /* enternode */
static void a_1142(int a_F1,int a_A[1]); /* getnoderepr */
static int a_1143=0; /* nnode */
static void a_1144(int a_F1); /* pushAUX */
static void a_1145(void); /* renumbernodes */
static void a_1146(void); /* replaceall */
static void a_1147(int a_F1,int a_F2); /* replacenode */
static int a_1148(int a_F1,int a_F2); /* samecontent */
static void a_1149(int a_F1,int a_F2); /* startnode */
static void a_1150(int a_F1); /* startrule */
static int a_1151=0; /* thisnode */
static int a_1152=0; /* xnode */
static void a_1155(int a_F1,int a_F2,int a_F3); /* putasstring */
static void a_1157(int a_F1,int a_F2,int a_F3); /* putstring */
...
-1}; /* fill table size 755 */
static void a_data_setup(void){
 a_virtual_min=16777216;a_virtual_max=2130706432;
 a_setup_list(0,a_1001,"@StringTable",1,2130706182,2130706362,181); /* @StringTable */
 a_setup_list(0,a_1006,"MESSAGE",1,2130705924,2130706180,257); /* MESSAGE */
 ...
 a_setup_charfile(a_1005,"ERRFILE",2,a_1001,2130706190); /* ERRFILE */
 a_setup_charfile(a_1083,"RESULT",2,a_1001,2130706310); /* RESULT */
 a_setup_charfile(a_1084,"SOURCE",1,a_1001,2130706315); /* SOURCE */
 a_list_fill(a_FILL);
}
...
static void a_1014(int a_F1){ /* printnum+>a */
...
static void a_1015(int a_F1,int a_F2){ /* printnum1+>a+>a */
int a_L3;int a_L4;
...
static void a_1012(int a_F1,int a_F2){ /* print+t[]+>a */

a_1157(a_1005,a_F1,a_F2); return;
} /* print */
static void a_1009(int a_F1,int a_C,int *a_V){ /* formatprint+t[]+@+>a */
int a_L2;int a_L3;
...
a_G11:{register int a_r1=to_LIST(a_1078)->offset[a_L3];
...
static void a_1008(int a_F1,int a_C,int *a_V){ /* error+>a+@+>a */

a_1009(a_1006,a_C,a_V);
a_1011();
a_exit(a_F1); return;
} /* error */
static void a_1007(int a_F1,int a_F2){ /* corrupticefile+t[]+>a */
int a_P[3];
a_P[0]=2130705936;a_P[1]=a_1113;a_P[2]=a_F2;a_1009(a_F1,3,a_P);
a_1011();
a_exit(1); return;
} /* corrupticefile */
static void a_1010(int a_F1,int a_F2){ /* internalerror+t[]+>a */
int a_P[3];
a_P[0]=2130705951;a_P[1]=a_1113;a_P[2]=a_F2;a_1009(a_F1,3,a_P);
a_1011();
a_exit(15); return;
} /* internalerror */
static int a_1057(int a_F1,int a_F2){ /* ispulleditem+>a+>a */
int a_L3;
...
static void a_1019(int a_F1,int a_F2){ /* addpull+>a+>a */

if(a_1057(a_F1,a_F2)){ return;}
{register int *a_r1=a_extension(a_1017,2);a_r1[0]=a_F2;a_r1[1]=to_LIST(a_1018)->offset[a_F1-1];to_LIST(a_1017)->aupb+=2;}
to_LIST(a_1018)->offset[a_F1-1]=to_LIST(a_1017)->aupb; return;
} /* addpull */
static void a_1044(void){ /* expandITEM */

a_incr(a_1061);
{register int *a_r1=a_extension(a_1018,7);a_r1[0]=a_r1[1]=a_r1[2]=a_r1[3]=a_r1[4]=a_r1[5]=0;a_r1[6]=a_1061;to_LIST(a_1018)->aupb+=7;}
  return;
} /* expandITEM */
static int a_1056(int a_F1,int a_F2){ /* isitemflag+>a+>a */
int a_L3;
a_booland(to_LIST(a_1018)->offset[a_F1-6],a_F2,a_L3);
if(!a_is(a_L3)){ return 0;} return 1;
} /* isitemflag */
static void a_1068(int a_F1,int a_F2){ /* setitemflag+>a+>a */

a_boolor(to_LIST(a_1018)->offset[a_F1-6],a_F2,to_LIST(a_1018)->offset[a_F1-6]); return;
} /* setitemflag */
static void a_1020(int a_A[1]){ /* converttoitem+>a> */

a_addmult(a_A[0],7,1559373916,a_A[0]); return;
} /* converttoitem */
static void a_1052(int a_F1,int a_A[1]){ /* getitemrepr+>a+a> */
...
static void a_1060(int a_F1){ /* markifrequested+>a */
...
a_G4:a_1007(a_1001,2130706194); return;
...
if(!a_equal(588109463,a_1096)){ goto a_G4;}
 goto a_G3;
a_G16:a_1007(a_1001,2130706256); return;
} /* skipformalaffixes */
static void a_1072(void){ /* skiplistbounds */
...
a_1100();
{register int a_r1=to_LIST(a_1018)->offset[to_LIST(a_1018)->aupb-5];
...
static void a_1071(int a_F1){ /* skipitem+>a */
int a_L2;int a_L3;
if(!a_equal(588109475,a_1096)){ goto a_G4;}
a_L2=a_1097;
a_1100(); goto a_G5;
...
a_1010(a_1001,2130706244); return;
...
static void a_1033(int a_F1){ /* copyitem+>a */
...
a_1010(a_1001,2130706239); return;
...
a_1100();
a_1007(a_1001,2130706234); return;
a_G6:a_1100(); goto a_G1;
} /* skipentry */
static void a_1045(int a_F1){ /* fileareas+>a */
int a_L2;
...
a_L2=a_1097;
a_1100(); goto a_G9;
a_G8:a_1007(a_1001,2130706194); return;
...
static void a_1050(int a_F1){ /* fillitempack+>a */
...
static void a_1049(int a_F1){ /* fillitem+>a */
int a_L2;
...
a_L2=a_1097;
a_1100(); goto a_G8;
a_G7:a_1007(a_1001,2130706194); return;
a_G8:a_1019(a_F1,a_L2); return;
} /* fillitem */
static void a_1051(int a_F1){ /* fillrepeater+>a */
int a_L2;
...
static void a_1048(int a_F1){ /* fillinitializers+>a */
int a_L2;
...
a_L2=a_1097;
a_1100(); goto a_G7;
a_G6:a_1007(a_1001,2130706194); return;
...
a_G13:a_1007(a_1001,2130706229); return;
} /* readexpression */
static void a_1059(void){ /* listentry */
int a_L1;int a_L2;
if(!a_equal(588109483,a_1096)){ goto a_G4;}
...
a_1007(a_1001,2130706223); return;
} /* datasection */
static void a_1025(int a_F1){ /* copyfileentry+>a */
int a_L2;
a_1085(588109259);
...
a_L1=a_1097;
a_1100(); goto a_G11;
a_G10:a_1007(a_1001,2130706194); return;
a_G11:a_1086(588109483,a_L1); goto a_G4;
} /* copyfileareas */
static void a_1026(int a_F1){ /* copyfillentry+>a */
int a_L2;
a_1085(588109263);
a_1086(588109483,a_F1);
if(!a_equal(588109463,a_1096)){ goto a_G6;}
...
a_L1=a_1097;
a_1100(); goto a_G13;
a_G12:a_1007(a_1001,2130706194); return;
...
a_L1=a_1097;
a_1100(); goto a_G12;
a_G11:a_1007(a_1001,2130706194); return;
...
static void a_1022(int a_F1){ /* copyexpression+>a */
int a_L2;
a_1085(588109245);
a_1086(588109483,a_F1);
...
a_L2=a_1097;
a_1100(); goto a_G16;
a_G15:a_1007(a_1001,2130706194); return;
a_G16:a_1086(588109483,a_L2); goto a_G3;
a_G17:a_1085(a_1096); goto a_G8;
} /* copyexpression */
static void a_1036(int a_F1){ /* copylistentry+>a */
int a_L2;
a_1085(588109271);
a_1086(588109483,a_F1);
if(!a_equal(588109463,a_1096)){ goto a_G6;}
...
static void a_1037(int a_F1){ /* copymatter+>a */
int a_L2;
a_1085(a_F1);
if(!a_equal(588109495,a_1096)){ goto a_G5;}
a_L2=a_1097;
...
static void a_1023(int a_F1){ /* copyexternal+>a */
int a_L2;
a_1085(588109255);
a_1086(588109483,a_F1);
...
static void a_1065(int a_F1){ /* readnode+>a */
...
a_1100(); return;
a_G6:a_1007(a_1001,2130706218); return;
} /* rulesection */
static void a_1040(void){ /* copyrulesection */
...
static void a_1039(int a_F1){ /* copyrule+>a */
int a_L2;
a_1085(588109290);
a_1086(588109483,a_F1);
if(!a_equal(588109463,a_1096)){ goto a_G6;}
...
a_1100(); return;
a_G12:a_1007(a_1001,2130706213); return;
} /* copyruleswithoutoptimization */
static void a_1054(int a_F1){ /* handlerule+>a */
int a_L2;
a_1085(588109290);
a_1086(588109483,a_F1);
if(!a_equal(588109463,a_1096)){ goto a_G6;}
...
a_G10:if(!a_equal(588109498,a_1096)){ goto a_G12;}
a_1100(); return;
a_G12:a_1007(a_1001,2130706203); return;
} /* copyruleswithoptimization */
static void a_1073(int a_F1,int a_A[1]){ /* traverseitem+>a+>a> */
int a_L3;
...
static void a_1075(int a_A[1]){ /* traverseonce+a> */
int a_L2;int a_P[1];
a_A[0]=0;
...
static void a_1093(int a_F1){ /* extendBUFFER+>a */

{register int *a_r1=a_extension(a_1078,1);a_r1[0]=a_F1;to_LIST(a_1078)->aupb+=1;}
  return;
} /* extendBUFFER */
static void a_1115(int a_A[1]){ /* trytoopen+a> */
...
static void a_1102(int a_F1){ /* opensourcefile+>a */
...
static void a_1101(int a_F1){ /* opensource+>a */
int a_P[1];
a_1102(a_F1);
...
static void a_1112(int a_F1,int a_F2){ /* rewindsource+>a+>a */
int a_P[2];
...
static void a_1114(int a_F1){ /* toggleout+>a */
...
static void a_1106(int a_A[1]){ /* readdestination+a> */
int a_L2;
...
a_G8:a_1007(a_1001,2130706304); return;
...
a_G28:a_1007(a_1001,2130706299); return;
} /* readdestination */
static void a_1092(int a_F1,int a_A[1]){ /* enterstring+>a+a> */
...
{register int *a_r1=a_extension(a_1079,1);a_r1[0]=0;to_LIST(a_1079)->aupb+=1;}
  goto a_G7;
...
a_G16:a_1010(a_1001,2130706293); return;
} /* rehash */
static void a_1076(void){ /* @root */

a_1111(); return;
} /* @root */
static void a_1094(int a_F1,int a_A[1]){ /* gettagimage+>a+a> */

a_subtr(a_F1,2,a_A[0]); return;
} /* gettagimage */
static void a_1087(int a_A[1]){ /* addLEXTentry+a> */
int a_P[1];
{register int *a_r1=a_extension(a_1082,2);a_r1[0]=a_r1[1]=0;to_LIST(a_1082)->aupb+=2;}
a_1092(to_LIST(a_1082)->aupb,a_P);a_A[0]=a_P[0];
if(a_equal(a_A[0],to_LIST(a_1082)->aupb)){ return;}
a_unstack(a_1082);
a_unstackstring(a_1082); return;
} /* addLEXTentry */
static void a_1107(int a_A[1]){ /* readstring+a> */
...
a_G14:a_1007(a_1001,2130706289); return;
} /* readstring */
static void a_1109(int a_A[1]){ /* readtargetstring+a> */
int a_L2;int a_L3;int a_P[1];
a_L3=to_LIST(a_1078)->aupb;
a_L2=0;
if(a_equal(a_1088,34)){ goto a_G5;}
a_G4:a_1007(a_1001,2130706284); return;
a_G5:a_1099();
...
static void a_1108(int a_A[1]){ /* readtargetnumber+a> */
int a_L2;int a_L3;int a_P[1];
a_L3=to_LIST(a_1078)->aupb;
a_L2=1;
a_1093(88);
...
static void a_1105(int a_A[1]){ /* readbold+a> */
...
a_1099(); goto a_G12;
a_G11:a_1007(a_1001,2130706277); return;
...
static void a_1110(int a_A[1]){ /* readtype+a> */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_1099();
a_L3=to_LIST(a_1078)->aupb;
a_L2=0;
...
a_1099(); goto a_G16;
a_G15:a_1007(a_1001,2130706272); return;
...
a_G13:a_1007(a_1001,2130706304); return;
...
a_G114:a_1007(a_1001,2130706267); return;
} /* nextsymbol */
static void a_1117(int a_F1){ /* writenum+>a */
...
static void a_1116(int a_F1,int a_F2){ /* wnum1+>a+>a */
int a_L3;int a_L4;
a_divrem11(a_F1,10,a_L3,a_L4);
if(a_equal(a_L3,0)){ goto a_G4;}
a_1116(a_L3,48);
...
static void a_1085(int a_F1){ /* W+>a */
...
a_G18:a_1010(a_1001,2130706262); return;
} /* W */
static void a_1086(int a_F1,int a_F2){ /* WW+>a+>a */
int a_P[1];
...
a_G27:a_1010(a_1001,2130706259); return;
} /* WW */
static int a_1125(int a_F1,int a_F2){ /* isfirstarg+t[]+>a */
int a_L2;int a_P[1];
...
a_1130=1;
a_G3:if(a_less(a_1121,to_LIST(a_1159)->alwb)){ return;}
if(!a_1125(a_1001,2130706340)){ goto a_G6;}
a_P[0]=2130706062;a_1008(1,1,a_P); return;
a_G6:if(!a_1125(a_1001,2130706336)){ goto a_G8;}
a_P[0]=2130706131;a_P[1]=1;a_P[2]=2;a_1008(1,3,a_P); return;
a_G8:if(!a_1125(a_1001,2130706331)){ goto a_G15;}
a_previousstring(a_1159,a_1121);
if(!a_less(a_1121,to_LIST(a_1159)->alwb)){ goto a_G12;}
a_P[0]=2130706159;a_1008(1,1,a_P); return;
a_G12:a_1127=a_1121;
a_1130=0;
a_G14:a_previousstring(a_1159,a_1121); goto a_G3;
a_G15:if(!a_1125(a_1001,2130706328)){ goto a_G18;}
a_previousstring(a_1159,a_1121);
a_1062=0; goto a_G3;
a_G18:if(!a_is(a_1124)){ goto a_G20;}
a_P[0]=2130706173;a_1008(1,1,a_P); return;
a_G20:a_1124=a_1121; goto a_G14;
} /* parseSTDARG */
static void a_1122(void){ /* checkcommandlinearguments */
int a_P[1];
a_1128();
if(!a_equal(a_1124,0)){ goto a_G4;}
a_P[0]=2130706145;a_1008(1,1,a_P); return;
...
static void a_1132(int a_F1){ /* setrepr+>a */
...
a_1074();
a_1129();
a_1112(a_1127,2130706180);
a_1131();
a_1089(); return;
} /* @root */
static void a_1144(int a_F1){ /* pushAUX+>a */

{register int *a_r1=a_extension(a_1134,1);a_r1[0]=a_F1;to_LIST(a_1134)->aupb+=1;}
  return;
} /* pushAUX */
static void a_1150(int a_F1){ /* startrule+>a */
...
{register int *a_r1=a_extension(a_1137,8);a_r1[0]=a_r1[1]=a_r1[2]=a_r1[3]=a_r1[4]=a_r1[5]=0;a_r1[6]=a_r1[7]=-1000;to_LIST(a_1137)->aupb+=8;}
a_decr(a_F1); goto a_G5;
} /* startrule */
static int a_1148(int a_F1,int a_F2){ /* samecontent+>a+>a */
int a_L3;
...
static void a_1149(int a_F1,int a_F2){ /* startnode+>a+>a */

a_incr(a_1143);
if(a_equal(a_1143,a_F2)){ goto a_G4;}
a_G3:a_1007(a_1001,2130706362); return;
...
static void a_1136(int a_F1,int a_F2){ /* NN+>a+>a */
...
a_G2:a_1144(a_F1);
a_1144(a_F2); return;
a_G4:a_1007(a_1001,2130706357); return;
a_G5:{register int a_r1=to_LIST(a_1137)->offset[a_1151-7];
...
static void a_1135(int a_F1){ /* N+>a */
...
a_1007(a_1001,2130706354); return;
...
a_1010(a_1001,2130706354); return;
...
static void a_1142(int a_F1,int a_A[1]){ /* getnoderepr+>a+a> */
...
static void a_1147(int a_F1,int a_F2){ /* replacenode+>a+>a */
int a_L3;int a_L4;int a_L5;
if(a_less(a_F1,a_F2)){ goto a_G3;}
a_G2:a_1010(a_1001,2130706349); return;
a_G3:a_L4=to_LIST(a_1137)->offset[a_F2-6];
{register int a_r1=to_LIST(a_1137)->offset[a_F1-6];a_L5=a_r1;to_LIST(a_1137)->offset[a_F2-6]=a_r1;}
...
static int a_1138(int a_F1){ /* checknode+>a */
int a_L2;
...
static void a_1139(int a_F1,int a_F2){ /* dumpAUX+>a+>a */
int a_L3;int a_P[1];
a_incr(a_F1);
...
static void a_1155(int a_F1,int a_F2,int a_F3){ /* putasstring+""f+t[]+>a */
int a_L2;int a_L3;int a_P[1];
a_L2=0;
a_putchar(a_F1,34);
...
static void a_1157(int a_F1,int a_F2,int a_F3){ /* putstring+""f+t[]+>a */
int a_L2;int a_L3;int a_P[1];
a_L2=0;
