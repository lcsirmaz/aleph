...
int a_P[3];
if(!a_equal(1164737731,a_1692)){ goto a_G4;}
a_1702();
a_A[1]=2; goto a_G5;
a_G4:a_A[1]=0;
...
if(!a_equal(a_L2,0)){ return 0;}
a_P[0]=2130704561;a_P[1]=2;a_P[2]=4;a_1239(3,a_P); return 1;
} /* isversionargument */
static void a_1360(void){ /* readcommandlinearguments */
int a_L1;int a_L2;int a_P[1];
a_1371=1178737320;
...
a_1122(a_F1);
a_subtr(to_LIST(a_1150)->aupb,a_L2,a_L3);
a_packstring(a_1150,a_L3,a_1374);
a_unstackto(a_1150,a_L2);
a_copystring(a_1374,to_LIST(a_1374)->aupb,a_1150);
a_unstackstring(a_1374); return 1;
} /* waslexicalpointer */
