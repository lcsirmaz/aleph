...
static void a_1427(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4); /* declarerbody */
static void a_1428(void); /* extendedblock */
static void a_1429(a_word a_F1); /* externaldeclarer */
static void a_1430(a_word a_A[1]); /* filleritem */
static void a_1431(void); /* findssel */
static void a_1432(a_word a_A[1]); /* getlisttag */
static void a_1433(void); /* initializer */
static a_word a_1434(void); /* isextendedblock */
static a_word a_1435=0; /* lcalibre */
static void a_1436(void); /* listfill */
static void a_1437(void); /* listfillblock */
static void a_1438(a_word a_F1); /* listprototype */
static a_word a_1439=0; /* lqf */
static a_word a_1440=0; /* lssel */
static a_word a_1441=0; /* ltag */
static a_word a_1442=0; /* ltype */
static void a_1443(a_word a_F1,a_word a_A[1]); /* prototypeorfill */
static void a_1444(a_word a_F1,a_word a_A[1]); /* prototypeorfillbody */
static void a_1445(a_word a_A[2]); /* readfieldlist */
static void a_1446(a_word a_A[2]); /* readfieldlists */
static void a_1447(a_word a_F1); /* repeatcount */
static a_word a_1448(a_word a_A[3]); /* sizeestimator */
static void a_1449(a_word a_F1); /* stackdeclaration */
static void a_1450(void); /* staticstackdeclaration */
static void a_1451(a_word a_F1); /* tabledeclaration */
static void a_1452(a_word a_A[1]); /* toselectors */
static a_word a_1455(a_word a_F1); /* declaration */
...
static a_word a_1460=0; /* rootscanned */
static void a_1461(void); /* staticdeclaration */
static void a_1463(void); /* addaleextension */
static void a_1464(void); /* createicename */
static void a_1465(a_word a_F1); /* extendBUFFER */
static a_word a_1466(a_word a_F1,a_word a_F2); /* opensrcfile */
static void a_1467(a_word a_F1,a_word a_A[1]); /* trybuffer */
static void a_1468(a_word a_F2,a_word a_A[2]); /* trynextpath */
static void a_1469(a_word a_F1,a_word a_F2,a_word a_A[1]); /* trytoopenwithpath */
static a_word a_1471(a_word a_A[1]); /* aheadrawtag */
static a_word a_1472=0; /* bounds */
static void a_1473(void); /* cmdlinepragmat */
static void a_1474(a_word a_F1,a_word a_F2); /* conspragmat2 */
static a_word a_1475=0; /* count */
static a_word a_1476=0; /* dicton */
static void a_1477(a_word a_F1,a_word a_F2); /* discpragmat */
static void a_1478(a_word a_F1,a_word a_F2); /* dopragmatskip */
static void a_1479(a_word a_F1,a_word a_F2,a_word a_A[1]); /* findifcondition */
static void a_1480(void); /* findmatchingendif */
static void a_1481(a_word a_F1,a_word a_A[1]); /* getpragmatvalue */
static a_word a_1482=0; /* givetext */
static a_word a_1483=0; /* icename */
static a_word a_1484=0; /* includepath */
static a_word a_1485=1; /* incompile */
static a_word a_1486=0; /* inlibrary */
static a_word a_1487=0; /* inmodule */
static void a_1488(a_word a_F1); /* insertsymbol */
static a_word a_1489(a_word a_F1); /* ispragmatvalue */
static a_word a_1490=0; /* librarypath */
static void a_1491(void); /* nextpragmatsymbol */
static void a_1492(a_word a_F1,a_word a_F3,a_word a_A[1]); /* onoffpragmats */
static a_word a_1493=0; /* pgmiftag */
static a_word a_1494=0; /* pgmskip */
static a_word a_1495=0; /* pgmstate */
static a_word a_1496=0; /* pgmtag */
static void a_1497(a_word a_F1); /* pragmatitem */
static void a_1498(a_word a_A[1]); /* programpragmat */
static void a_1499(a_word a_A[1]); /* programpragmat2 */
static void a_1500(a_word a_F1,a_word a_A[1]); /* programpragmatitem */
static void a_1501(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_A[1]); /* programtagpragmat2 */
static a_word a_1502=0; /* programtitle */
static a_word a_1503=0; /* protolevel */
static void a_1504(void); /* resetpragmats */
static a_word a_1505=120; /* rightmargin */
static void a_1506(a_word a_F1,a_word a_F2); /* setmoduletag */
static void a_1507(a_word a_F1,a_word a_F2); /* setpragmatvalue */
static void a_1508(a_word a_F1,a_word a_F2); /* setprogramtitle */
static void a_1509(a_word a_F1,a_word a_F2); /* stringpragmat2 */
static a_word a_1510=8; /* tabwidth */
static void a_1511(a_word a_F1,a_word a_F2,a_word a_F3); /* tagpragmat2 */
static a_word a_1512=0; /* trace */
static a_word a_1513=1; /* usestdlib */
static a_word a_1514=10; /* warninglevel */
static void a_1516(a_word a_F1,a_word a_F2,a_word a_A[1]); /* checkformalaffixes */
static void a_1517(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4,a_word a_A[1]); /* createruledefinition */
static void a_1518(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4); /* externalrule */
static void a_1519(a_word a_F1,a_word a_A[1]); /* fieldlist */
static void a_1520(a_word a_F1); /* fieldlists */
static void a_1521(void); /* findlocalssel */
static void a_1522(a_word a_F1,a_word a_A[1]); /* formalatag */
static a_word a_1523=0; /* hasoutvararg */
static a_word a_1524=0; /* hasvararg */
static void a_1525(a_word a_F1); /* nextformalaffix */
static void a_1526(a_word a_F1,a_word a_A[1]); /* readformalaffixes */
static void a_1527(a_word a_F1,a_word a_F2); /* ruledeclaration */
static void a_1528(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4); /* ruledeclarer */
static void a_1529(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4); /* ruleprototype */
static void a_1530(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4); /* simpleexternalrule */
static void a_1531(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4); /* simpleruleprototype */
static void a_1532(a_word a_F1); /* subbus */
static void a_1534(a_word a_F1,a_word a_F2,a_word a_F3); /* Dqloc */
static void a_1535(a_word a_F1); /* addlocalaffix */
...
static a_word a_1540(void); /* anchoraffix */
static void a_1541(void); /* area */
static void a_1542(a_word a_A[1]); /* class */
static void a_1543(void); /* classification */
static void a_1544(a_word a_F1); /* closelocalrange */
static void a_1545(void); /* closelocalstack */
static void a_1546(void); /* compoundmember */
static a_word a_1547=0; /* emptyrule */
static void a_1548(a_word a_F1,a_word a_F2); /* extension */
static a_word a_1549=0; /* formalanchoraffix */
static void a_1550(a_word a_F1,a_word a_F2,a_word a_A[1]); /* getformalaffix */
static void a_1551(a_word a_A[1]); /* getruletag */
static void a_1552(a_word a_F1,a_word a_F2,a_word a_F3); /* indexsource */
static a_word a_1553(a_word a_A[3]); /* isqltag */
static void a_1554(a_word a_F1); /* listtag */
static a_word a_1555(void); /* lookingatamember */
static void a_1556(void); /* member */
static void a_1557(a_word a_F1); /* mustformallist */
static void a_1558(a_word a_F1,a_word a_A[1]); /* openlocalrange */
static void a_1559(a_word a_A[2]); /* peekaftersource */
static void a_1560(a_word a_A[1]); /* peeklabel */
static void a_1561(a_word a_F1); /* restorelocalrepr */
static void a_1562(void); /* rootbody */
static void a_1563(a_word a_F1); /* rulebody */
static void a_1564(a_word a_F1); /* rulepragmats */
static a_word a_1565=0; /* ruletag */
static void a_1566(a_word a_F1); /* searchjump */
static void a_1567(a_word a_F1,a_word a_F2,a_word a_F3); /* selector */
static void a_1568(a_word a_F1); /* setlocalrepr */
static void a_1569(a_word a_F1); /* setuplocalstack */
static void a_1570(a_word a_F1); /* skiplabel */
static void a_1571(void); /* skipoveranindex */
static void a_1572(void); /* skipoverdestination */
static void a_1573(a_word a_F1,a_word a_A[4]); /* skipoverextension */
static void a_1574(a_word a_A[1]); /* skipoversource */
static void a_1575(a_word a_F1); /* source */
static void a_1576(a_word a_F1); /* sourceorstring */
static void a_1577(a_word a_F1); /* specialaffixform */
static a_word a_1578(void); /* terminator */
static void a_1579(a_word a_F1,a_word a_F2); /* toselectors */
static void a_1581(void); /* affixform */
static void a_1582(void); /* alternative */
static void a_1583(a_word a_F1); /* checkconstanttype */
static void a_1584(a_word a_F1); /* checklisttype */
static void a_1585(a_word a_F1,a_word a_A[1]); /* checkprototype */
static void a_1586(a_word a_A[1]); /* checkruletype */
static void a_1587(a_word a_F1); /* checkstrictconstanttype */
static void a_1588(a_word a_F1); /* checktagformacro */
...
static void a_1598(a_word a_F1); /* filler */
static void a_1599(void); /* fillerblock1 */
static void a_1600(void); /* fillerblock2 */
static void a_1601(a_word a_F1); /* fillerinitializer */
...
static a_word a_1606(a_word a_F1); /* islisttype */
static void a_1607(void); /* limitlist */
static void a_1608(void); /* listdeclarer */
static void a_1609(void); /* listfill */
static void a_1610(a_word a_F1); /* noexternal */
static void a_1611(void); /* pragmat */
static void a_1612(void); /* prototype */
static void a_1613(a_word a_F1,a_word a_F2); /* readlistselectors */
static void a_1614(void); /* readqtloc */
static void a_1615(a_word a_F1); /* ruledeclarer */
static void a_1616(a_word a_A[1]); /* ruleprototype */
static a_word a_1617=0; /* rulescanned */
static void a_1618(void); /* secondpass */
static void a_1619(a_word a_F1,a_word a_F2); /* selectorerror */
...
static a_word a_1624(a_word a_F1,a_word a_F2); /* typemismatch */
static void a_1625(void); /* zone */
static void a_1627(void); /* ICEheader */
static void a_1628(void); /* ICEitemlist */
static void a_1629(a_word a_F1); /* defineiceitems */
static void a_1630(a_word a_F1); /* emitfill */
static void a_1631(void); /* exprbase */
static void a_1632(void); /* expression */
static void a_1633(a_word a_F1); /* extendBUFFER */
...
static void a_1638(a_word a_F1); /* fillerblock1 */
static void a_1639(a_word a_F1); /* fillerblock2 */
static void a_1640(a_word a_F1); /* filleritem */
static void a_1641(a_word a_F1); /* formalaffixes */
static void a_1642(a_word a_F1,a_word a_A[1]); /* getqualifier */
static void a_1643(a_word a_F1); /* handletag */
static void a_1644(void); /* initializer */
static void a_1645(void); /* isexpression */
static a_word a_1646(a_word a_F1); /* isitemtag */
static void a_1647(a_word a_F1); /* listdata */
static void a_1648(void); /* listdeclarer */
static void a_1649(void); /* listfilling */
static a_word a_1650=0; /* nextnitem */
...
static void a_1657(a_word a_F1,a_word a_F3,a_word a_A[1]); /* toselectors */
static void a_1658(a_word a_F1); /* traversestdstringpointers */
static void a_1659(a_word a_F1); /* traversetags */
static void a_1660(a_word a_F1); /* warnnotused */
static void a_1661(a_word a_F1); /* writeICEitem */
...
static void a_1669(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4); /* addlistselector */
static void a_1670(a_word a_F1,a_word a_F2,a_word a_F3); /* createlistextension */
static void a_1671(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_A[1]); /* createselectorblock */
static void a_1672(a_word a_F1,a_word a_F2); /* dumptempselectors */
static a_word a_1673(a_word a_F1,a_word a_F2,a_word a_F3); /* entertempselector */
static a_word a_1674(a_word a_F1,a_word a_F2,a_word a_A[1]); /* findlistselector */
static a_word a_1675(a_word a_F1,a_word a_F2,a_word a_A[1]); /* findpermselector */
static a_word a_1676(a_word a_F1,a_word a_F2,a_word a_A[1]); /* findtempselector */
static void a_1677(a_word a_F1,a_word a_A[1]); /* getcalibre */
static void a_1678(a_word a_F1,a_word a_A[1]); /* getselectornext */
static void a_1679(a_word a_F1,a_word a_A[1]); /* getselectoroffs */
static void a_1680(a_word a_F1,a_word a_A[1]); /* getssel */
static void a_1681(void); /* resettempselectorstack */
#define a_1683 (a_1668+sizeof_LIST) /* RESTORE */
static void a_1684(a_word a_F1); /* Rskip */
static void a_1685(void); /* advancelinenum */
static a_word a_1686(void); /* aheadnumber */
static void a_1687(a_word a_A[1]); /* countrestore */
static a_word a_1688=0; /* dorestore */
static void a_1689(void); /* forgetrestore */
static void a_1690(a_word a_A[1]); /* getlinenum */
static void a_1691(void); /* initrestore */
static a_word a_1692=0; /* inpt */
static a_word a_1693=16777337; /* inrestore */
static a_word a_1694(a_word a_A[2]); /* isnumber */
static a_word a_1695(a_word a_A[2]); /* isqtag */
static a_word a_1696(a_word a_A[1]); /* israwttag */
static a_word a_1697(a_word a_A[1]); /* isstring */
static a_word a_1698(a_word a_A[1]); /* isttag */
static a_word a_1699=0; /* linenum */
static void a_1700(void); /* makerestore */
static void a_1701(a_word a_F1); /* must */
static void a_1702(void); /* nextsymbol */
static a_word a_1703=0; /* oldinpt */
static a_word a_1704=0; /* oldlinenum */
static a_word a_1705=0; /* oldrestore */
static a_word a_1706=16777337; /* outrestore */
static a_word a_1707(void); /* readfromrestore */
static a_word a_1708=0; /* restorecount */
static void a_1709(void); /* savetorestore */
static void a_1710(a_word a_F1); /* setlinenum */
...
static void a_1721(a_word a_F1,a_word a_F2); /* addpragmatmatter */
static void a_1722(a_word a_F1,a_word a_F2); /* cleartagflag */
static a_word a_1723(a_word a_F1,a_word a_F2); /* compareAFFS */
static void a_1724(a_word a_F1,a_word a_F2); /* createlocalaffix */
static void a_1725(a_word a_A[1]); /* enterformalaffixes */
static void a_1726(a_word a_F1); /* enterpredefinedtag */
static void a_1727(a_word a_F1,a_word a_A[1]); /* entertag */
static void a_1728(a_word a_F1); /* extendBUFFER */
static void a_1729(a_word a_F1,a_word a_A[1]); /* getadm */
static void a_1730(a_word a_F1,a_word a_A[1]); /* getdefline */
static void a_1731(a_word a_F1,a_word a_A[1]); /* getformalaffixno */
static void a_1732(a_word a_F1,a_word a_F2,a_word a_A[2]); /* getformallistext */
static void a_1733(a_word a_F1,a_word a_F2,a_word a_A[1]); /* getformaltype */
static a_word a_1734(a_word a_A[3]); /* getnextmatter */
static void a_1735(a_word a_F1,a_word a_A[1]); /* getnexttag */
static void a_1736(a_word a_F1,a_word a_A[1]); /* getrepr */
static void a_1737(a_word a_A[1]); /* getstdstringhead */
static void a_1738(a_word a_F1,a_word a_F2,a_word a_A[1]); /* gettagflag */
static void a_1739(a_word a_F1,a_word a_A[1]); /* getttag */
static void a_1740(a_word a_A[1]); /* getttaghead */
static void a_1741(a_word a_F1,a_word a_A[1]); /* gettype */
static void a_1742(void); /* inittags */
static void a_1743(a_word a_F2,a_word a_A[1]); /* inserttoAFFS */
static a_word a_1744(a_word a_F1,a_word a_A[1]); /* isspecialrule */
static a_word a_1745(a_word a_F1,a_word a_A[1]); /* isstdstringstored */
static a_word a_1746(a_word a_F1,a_word a_F2); /* istagflag */
static void a_1747(a_word a_F1,a_word a_F2,a_word a_F3); /* linkmacrorule */
static a_word a_1748=0; /* macroptr */
static a_word a_1749=0; /* matters */
static void a_1750(a_word a_F1,a_word a_F2,a_word a_A[1]); /* newstdstring */
static a_word a_1751(a_word a_A[1]); /* nextmacrorule */
static void a_1752(a_word a_F1); /* pushAFFS */
static void a_1753(a_word a_F1,a_word a_F2); /* putadm */
static void a_1754(a_word a_F1,a_word a_F2); /* putdefline */
static void a_1755(a_word a_F1,a_word a_F2); /* putrepr */
static void a_1756(a_word a_F1,a_word a_A[2]); /* searchmacrorule */
static void a_1757(a_word a_F1,a_word a_F2); /* settagflag */
static void a_1758(a_word a_F1); /* usetag */
static a_word a_1759(a_word a_F1); /* wastagpointer */
#define a_1761 (a_1720+sizeof_LIST) /* INDICATOR */
static a_word a_1762(a_word a_F1); /* wastypepointer */
static void a_1764(a_word a_F1); /* constantdeclaration */
static void a_1765(a_word a_A[1]); /* declaration */
static void a_1766(a_word a_F1); /* declarationseries */
static void a_1767(a_word a_F1); /* declarer */
static void a_1768(void); /* expectexpression */
static void a_1769(a_word a_A[1]); /* expectlisttag */
static a_word a_1770(a_word a_A[1]); /* exprbase */
static void a_1771(a_word a_F1); /* externaldeclarer */
static a_word a_1772(a_word a_A[1]); /* isexpression */
static a_word a_1773=0; /* lqf */
static a_word a_1774=0; /* ltag */
static a_word a_1775=0; /* ltype */
static void a_1776(a_word a_F1); /* prototype */
static void a_1777(void); /* staticvariabledeclaration */
static void a_1778(a_word a_F1); /* variabledeclaration */
static void a_1780(void); /* Bback */
static a_word a_1781(a_word a_F1,a_word a_A[1]); /* Bdata */
static void a_1782(a_word a_A[1]); /* Bgetptr */
static void a_1783(a_word a_F1); /* Bsetdata */
static void a_1784(a_word a_F1); /* Bsetflag */
static a_word a_1785=0; /* C1 */
static a_word a_1786=0; /* C2 */
static a_word a_1787=0; /* C3 */
static void a_1788(a_word a_F1); /* DUalternative */
static a_word a_1789(a_word a_F1); /* DUmember */
static void a_1790(a_word a_F1); /* DUregion */
static a_word a_1791(a_word a_F1); /* DUrule */
static void a_1792(void); /* Lfindlabels */
static void a_1793(a_word a_F1,a_word a_F2,a_word a_A[1]); /* Lscani */
static void a_1794(void); /* Lscanii */
static void a_1795(a_word a_F1); /* Lunroll */
static a_word a_1796=0; /* RULEtop */
static a_word a_1797(a_word a_F1,a_word a_F2); /* Uactualrule */
static void a_1798(a_word a_F1); /* Ualternative */
static a_word a_1799=0; /* Ufinalchanged */
static a_word a_1800(a_word a_F1,a_word a_F2); /* Umember */
static a_word a_1801=0; /* Uptr */
static void a_1802(a_word a_F1); /* Uregion */
static a_word a_1803=3; /* addRULEflag */
static void a_1804(void); /* assignnodes */
static void a_1805(a_word a_F1,a_word a_F2,a_word a_F3); /* clearRULEflag */
static void a_1806(a_word a_F1); /* closerange */
static void a_1807(void); /* computeDUflags */
static void a_1808(a_word a_F1,a_word a_F2,a_word a_F3); /* copyUf1toUf2 */
static void a_1809(a_word a_F1,a_word a_F2); /* copyjumpUf */
static void a_1810(a_word a_F1,a_word a_A[1]); /* copyspareaffix */
static void a_1811(a_word a_F1,a_word a_A[1]); /* correctselector */
static void a_1812(void); /* diagnoseformals */
static void a_1813(a_word a_F1,a_word a_F2,a_word a_F3); /* diagnoselocal */
static void a_1814(a_word a_F1,a_word a_F2); /* diagnoseoutaffix */
static void a_1815(a_word a_F1); /* diagnoserule */
static a_word a_1816=0; /* expandflag */
static void a_1817(a_word a_F1); /* expandmacro */
static void a_1818(a_word a_F1); /* extendBUFFER */
static void a_1819(a_word a_F1,a_word a_F2); /* extendRULE */
static void a_1820(a_word a_F1,a_word a_F2,a_word a_A[1]); /* finalssel */
static void a_1821(a_word a_F1); /* gactualrule */
static void a_1822(void); /* galtsequence */
static void a_1823(void); /* galttail */
static void a_1824(a_word a_A[1]); /* garea */
static void a_1825(void); /* gclassification */
static void a_1826(void); /* gcompound */
static void a_1827(a_word a_F1); /* generaterule */
static void a_1828(void); /* gextension */
static void a_1829(a_word a_F1,a_word a_F2); /* ghandleaffix */
static void a_1830(a_word a_F1); /* ghandleshiftrule */
static void a_1831(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4); /* ghandlevarargblock */
static a_word a_1832(void); /* glimit */
static void a_1833(a_word a_F1,a_word a_A[1]); /* gmatchformalactual */
static void a_1834(void); /* gmember */
static void a_1835(void); /* greadbox */
static void a_1836(void); /* grulebody */
static void a_1837(a_word a_F1,a_word a_A[1]); /* gsimpleaffix */
static void a_1838(void); /* gtransportlist */
static a_word a_1839(a_word a_F1); /* inutype */
static a_word a_1840=0; /* maxlocal */
static void a_1841(a_word a_F1,a_word a_F2); /* mergeDUflags */
static void a_1842(a_word a_F1,a_word a_F2,a_word a_F3); /* mergeUf1toUf2 */
static a_word a_1843=0; /* minlocal */
static a_word a_1844=0; /* nodecount */
static a_word a_1845(a_word a_F1); /* oututype */
static void a_1846(a_word a_C,a_word *a_V); /* pushBUFFER */
static void a_1847(a_word a_F1,a_word a_F2); /* pushRULE */
static void a_1848(a_word a_F1,a_word a_F2); /* recoverflagsfromregion */
static a_word a_1849=0; /* rulecalled */
static a_word a_1850=0; /* rulecompiled */
static void a_1851(a_word a_F1,a_word a_F2,a_word a_F3); /* setRULEflag */
static void a_1852(a_word a_F1,a_word a_F2,a_word a_F3); /* setflagsforregion */
static void a_1853(a_word a_F1); /* setflagsforrule */
static void a_1854(a_word a_F1); /* setupformalstack */
static void a_1855(a_word a_A[1]); /* setuplabel */
static void a_1856(void); /* setuplocals */
static void a_1857(a_word a_F1,a_word a_A[1]); /* startrange */
static void a_1858(a_word a_F1); /* traverseRULE */
static void a_1859(a_word a_F1,a_word a_A[1]); /* utypetoslice */
static void a_1860(a_word a_F1); /* wactualrule */
static void a_1861(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4,a_word a_F5); /* wafteraffixes */
static void a_1862(a_word a_F1); /* waftershiftrule */
static void a_1863(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4); /* waftervarargblock */
static void a_1864(void); /* waltsequence */
static void a_1865(void); /* walttail */
static void a_1866(a_word a_F1); /* warea */
static void a_1867(a_word a_F1); /* wbeforeshiftrule */
static void a_1868(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4); /* wbeforevarargblock */
static void a_1869(void); /* wclassification */
static void a_1870(void); /* wcompound */
static void a_1871(a_word a_A[1]); /* wcopyaffixfromBUFFER */
static void a_1872(void); /* wextension */
static void a_1873(a_word a_F1); /* whandleaffix */
static void a_1874(a_word a_F1); /* wlabel */
static a_word a_1875(a_word a_A[1]); /* wlimit */
static void a_1876(a_word a_F1,a_word a_A[1]); /* wmatchformalactual */
static void a_1877(void); /* wmember */
static void a_1878(void); /* wreadbox */
static void a_1879(void); /* wrulebody */
static void a_1880(a_word a_F1,a_word a_A[1]); /* wsimpleaffix */
static void a_1881(a_word a_F1,a_word a_A[1]); /* wtransportlist */
static void a_1884(a_word a_F1,a_word a_F2,a_word a_F3); /* putasstring */
static void a_1886(a_word a_F1,a_word a_F2,a_word a_F3); /* putstring */
...
a_1374,/* LEXT */
27,1886221359,1701601583,1479370864,1482184792,88,17,7,1818308398,795373669,1818522739,792355433,796029813,1633906540,1818308460,795373669,1818522739,25193,38,12,1818522739,25193,6,4,1885695073,104,5,4,0,
a_1236,/* MESSAGE */
...
-1}; /* fill table size 4234 */
static void a_data_setup(void){
 a_virtual_min=16777216;a_virtual_max=2130706432;
 a_setup_list(0,a_1001,"@StringTable",1,2130705916,2130706306,391); /* @StringTable */
 ...
 a_setup_list(0,a_1236,"MESSAGE",1,2130703585,2130705914,2330); /* MESSAGE */
 ...
 a_setup_charfile(a_1085,"ICE",2,a_1001,2130705946); /* ICE */
 a_setup_dfile(a_1155,"DISCR",1,a_1001,2130706064,7); /* DISCR */
 ...
 a_setup_dfile(a_1156,"DISCW",2,a_1001,2130706064,7); /* DISCW */
 ...
 a_setup_charfile(a_1237,"PRINTFILE",2,a_1001,2130706115); /* PRINTFILE */
 a_setup_charfile(a_1378,"SOURCE",1,a_1001,2130706178); /* SOURCE */
 a_list_fill(a_FILL);
}
...
a_G17:a_P[0]=2130703597;a_P[1]=a_F1;a_P[2]=to_LIST(a_1719)->offset[a_L2];a_1238(-1,3,a_P);
...
a_1044(a_L5,a_P);a_L6=a_P[0];
if(!a_was(a_1719,a_L5)){ goto a_G48;}
...
a_1068(a_L5,8);
if(!a_1746(a_1066,128)){ goto a_G73;}
...
a_G13:a_1248(a_1001,2130705922); return;
} /* matchformalactual */
...
a_P[0]=2130704013;a_P[1]=to_LIST(a_1719)->offset[to_LIST(a_1719)->aupb];a_1240(4,-1,2,a_P); goto a_G27;
a_G26:a_P[0]=2130704006;a_P[1]=to_LIST(a_1719)->offset[to_LIST(a_1719)->aupb];a_1240(4,-1,2,a_P);
...
a_G54:{register a_word a_r1=to_LIST(a_1719)->offset[to_LIST(a_1719)->aupb-2];
...
a_1886(a_1085,a_1236,2130704254);
a_1100(2);
a_putchar(a_1085,46);
a_1100(2);
a_1091(); return;
...
a_1092(a_F1); return;
a_G12:a_1248(a_1001,2130705941); return;
} /* W */
...
a_G8:a_1248(a_1001,2130705938); return;
a_G9:if(!a_was(a_1719,a_F1)){ goto a_G8;}
if(!a_equal(to_LIST(a_1719)->offset[a_F1-2],16777331)){ goto a_G14;}
a_putchar(a_1085,76);
...
a_G5:a_1248(a_1001,2130705934); return;
} /* Wstring */
...
a_G4:a_1248(a_1001,2130705930); return;
} /* Wfstr */
...
a_G11:a_1248(a_1001,2130705926); return;
} /* Wbase */
...
a_G3:a_1248(a_1001,2130705961); return;
} /* getdigit */
...
a_G7:a_1248(a_1001,2130705956); return;
} /* gethexdigit */
...
static void a_1112(void){ /* @root */
 ...
 a_waitfor(a_1001,2130705951); a_1126(); return;
} /* @root */
...
a_G6: a_waitfor(a_1001,2130705970); if(!a_equal(32,32)){ goto a_G9;}
if(a_equal(32,32)){ return;}
a_G9:a_1248(a_1001,2130705966); return;
} /* @root */
...
a_G5:a_1248(a_1001,2130706058); return;
} /* opendisc */
...
a_G20:a_1248(a_1001,2130706053); return;
} /* openthisdisc */
static void a_1182(void){ /* closediscs */
...
a_G5:a_1248(a_1001,2130706047); return;
} /* D */
...
a_G4:a_1248(a_1001,2130706044); return;
} /* Dstring */
static void a_1163(a_word a_F1){ /* Dttag+>a */

if(!a_was(a_1720,a_F1)){ goto a_G3;}
a_1214(a_F1,1); return;
a_G3:a_1248(a_1001,2130706040); return;
} /* Dttag */
...
a_G3:if(!a_lseq(to_LIST(a_1719)->vlwb,a_F1)){ goto a_G6;}
if(a_less(a_F1,to_LIST(a_1719)->vupb)){ goto a_G2;}
a_G6:a_1248(a_1001,2130706036); return;
} /* Dtag */
static void a_1207(void){ /* readfromQBUFFER */
...
a_1248(a_1001,2130706032); return;
a_G3:a_A[0]=a_1173;
a_A[1]=a_1169; return;
} /* savediscposition */
...
if(!a_is(a_1167)){ goto a_G3;}
a_1248(a_1001,2130706025); return;
...
a_1248(a_1001,2130706018); return;
} /* mustQ */
...
a_A[0]=a_1178;
a_1203(); return;
a_G5:a_1248(a_1001,2130705994); return;
} /* mustQtype */
...
a_1248(a_1001,2130705989); return;
} /* readselector */
...
a_G29:a_1248(a_1001,2130705983); return;
} /* fsimpleaffix */
...
a_G6:a_1248(a_1001,2130705977); return;
} /* matchformalactual */
...
if(!a_equal(a_F1,0)){ goto a_G3;}
a_1255(a_1001,2130706110); return;
...
a_G12:a_1255(a_1001,2130706106);
a_1260(a_F1);
a_1255(a_1001,2130706103); return;
} /* printpointer */
...
a_word a_L2;a_word a_P[2];
if(!a_1695(a_P)){ goto a_G28;}a_1286=a_P[0];a_1287=a_P[1];
...
if(!a_equal(1164737740,a_1692)){ goto a_G23;}
a_1702();
...
{register a_word *a_r1=a_extension(a_1718,8);a_r1[0]=a_L6;a_r1[1]=a_F1;a_r1[2]=a_F4;a_r1[3]=0;a_r1[4]=a_F3;a_r1[5]=a_r1[6]=0;a_r1[7]=a_F2;to_LIST(a_1718)->aupb+=8;}
...
a_word a_P[3];
a_P[0]=2130704727;a_P[1]=a_F1;a_P[2]=to_LIST(a_1718)->offset[a_F2-5];a_1238(to_LIST(a_1718)->offset[a_F1-5],3,a_P); return;
} /* doublydefinederror */
...
a_P[0]=2130704739;a_P[1]=a_F2;a_P[2]=a_F3;a_P[3]=to_LIST(a_1718)->offset[a_A[0]-5];a_P[4]=to_LIST(a_1718)->offset[a_L7-5];a_1238(-1,5,a_P);
a_A[0]=0; return 1;
...
a_1248(a_1001,2130706173); return;
...
a_G3:a_1248(a_1001,2130706165); return;
} /* getbasename */
...
a_word a_L5;a_word a_P[1];
a_comparestring(a_1374,a_F1,a_1001,2130706160,a_P);a_L5=a_P[0];
if(!a_equal(a_L5,0)){ goto a_G6;}
a_A[1]=22025;
a_G4:a_A[0]=0;
a_A[2]=1; return 1;
a_G6:a_comparestring(a_1374,a_F1,a_1001,2130706157,a_P);a_L5=a_P[0];
if(!a_equal(a_L5,0)){ goto a_G11;}
a_A[1]=22023; goto a_G4;
a_G11:a_comparestring(a_1374,a_F1,a_1001,2130706154,a_P);a_L5=a_P[0];
if(!a_equal(a_L5,0)){ goto a_G16;}
a_A[1]=22017;
a_A[0]=0;
a_A[2]=3; return 1;
a_G16:a_comparestring(a_1374,a_F1,a_1001,2130706151,a_P);a_L5=a_P[0];
if(!a_equal(a_L5,0)){ goto a_G21;}
a_A[1]=22017;
a_G19:a_A[0]=0;
a_G20:a_A[2]=0; return 1;
a_G21:a_comparestring(a_1374,a_F1,a_1001,2130706147,a_P);a_L5=a_P[0];
if(!a_equal(a_L5,0)){ goto a_G26;}
a_A[1]=22033;
a_G24:a_A[0]=1; goto a_G20;
a_G26:a_comparestring(a_1374,a_F1,a_1001,2130706144,a_P);a_L5=a_P[0];
if(!a_equal(a_L5,0)){ goto a_G31;}
a_A[1]=22037; goto a_G24;
a_G31:a_comparestring(a_1374,a_F1,a_1001,2130706141,a_P);a_L5=a_P[0];
if(!a_equal(a_L5,0)){ goto a_G36;}
a_A[1]=22038; goto a_G24;
a_G36:a_comparestring(a_1374,a_F1,a_1001,2130706138,a_P);a_L5=a_P[0];
if(!a_equal(a_L5,0)){ goto a_G41;}
a_A[1]=22036; goto a_G24;
a_G41:a_comparestring(a_1374,a_F1,a_1001,2130706135,a_P);a_L5=a_P[0];
if(!a_equal(a_L5,0)){ goto a_G46;}
a_A[1]=22034; goto a_G24;
a_G46:a_comparestring(a_1374,a_F1,a_1001,2130706132,a_P);a_L5=a_P[0];
...
a_comparestring(a_1374,to_LIST(a_1317)->offset[a_F1],a_1001,2130706129,a_P);a_L2=a_P[0];
...
a_comparestring(a_1374,to_LIST(a_1317)->offset[a_F1],a_1001,2130706125,a_P);a_L2=a_P[0];
if(!a_equal(a_L2,0)){ return 0;}
a_P[0]=2130704563;a_P[1]=2;a_P[2]=2;a_1239(3,a_P); return 1;
} /* isversionargument */
static void a_1360(void){ /* readcommandlinearguments */
a_word a_L1;a_word a_L2;a_word a_P[1];
a_1371=1178737320;
...
a_G32:a_1481(22020,a_P);a_A[0]=a_P[0];
if(a_is(a_A[0])){ return;}
a_A[0]=1696719077; return;
...
a_G14:a_1727(a_L5,a_P);a_A[0]=a_P[0];
a_unstackto(a_1150,a_L3); return;
} /* enterstringtag */
...
a_G53:if(!a_1489(22022)){ goto a_G56;}
a_1397=1;
...
static void a_1446(a_word a_A[2]){ /* readfieldlists+a>+a> */
a_word a_L3;a_word a_P[2];
...
a_A[1]=1;
a_P[0]=2130704917;a_P[1]=a_1442;a_1238(-1,2,a_P); goto a_G5;
a_G12:a_A[0]=-1;
a_A[1]=0; return;
} /* readfieldlists */
static void a_1445(a_word a_A[2]){ /* readfieldlist+a>+>a> */
a_word a_L3;a_word a_P[2];
a_A[0]=1;
...
a_1702(); return;
a_G13:a_P[0]=2130704927;a_P[1]=a_1442;a_1238(-1,2,a_P);
a_G14:a_A[1]=1; return;
a_G15:a_P[0]=2130704936;a_P[1]=a_1442;a_1238(-1,2,a_P); goto a_G14;
} /* readfieldlist */
static void a_1431(void){ /* findssel */
a_word a_P[1];
...
static void a_1432(a_word a_A[1]){ /* getlisttag+a> */
a_word a_P[2];
a_1681();
...
a_1431(); return;
a_G6:a_P[0]=2130704944;a_P[1]=a_1442;a_1238(-1,2,a_P);
a_A[0]=1; return;
} /* getlisttag */
static a_word a_1448(a_word a_A[3]){ /* sizeestimator+a>+a>+a> */
a_word a_P[3];
...
a_1701(1164737743);
a_P[0]=2130705070;a_P[1]=a_1442;a_1238(-1,2,a_P); return 1;
a_G7:if(!a_equal(1164737725,a_1692)){ goto a_G10;}
a_1702();
a_A[0]=1; goto a_G11;
a_G10:a_A[0]=0;
a_G11:if(!a_1694(a_P)){ goto a_G24;}a_A[2]=a_P[1];
a_A[1]=0;
a_incr(a_A[0]);
{ if(a_A[2]<=0){ goto a_G15;}
 ...
 if(a_A[2]>=101){  goto a_G21;}
  goto a_G30;}
a_G15:a_P[0]=2130705084;a_P[1]=a_1442;a_P[2]=a_A[2];a_1240(9,-1,3,a_P);
a_A[2]=1; goto a_G30;
a_G17:a_P[0]=2130705084;a_P[1]=a_1442;a_P[2]=a_A[2];a_1240(6,-1,3,a_P);
if(!a_equal(a_A[0],1)){ goto a_G20;}
a_A[2]=100; goto a_G30;
a_G20:a_A[2]=100000; goto a_G30;
a_G21:if(!a_equal(a_A[0],1)){ goto a_G30;}
a_P[0]=2130705084;a_P[1]=a_1442;a_P[2]=a_A[2];a_1240(6,-1,3,a_P);
a_A[2]=100; goto a_G30;
a_G24:if(!a_1695(a_P)){ goto a_G26;}a_A[1]=a_P[0];a_A[2]=a_P[1];
a_add(a_A[0],3,a_A[0]); goto a_G30;
a_G26:if(!a_equal(1164737743,a_1692)){ goto a_G28;}
a_A[2]=0;a_A[1]=0;a_A[0]=0; goto a_G30;
a_G28:a_P[0]=2130704955;a_P[1]=a_1442;a_1238(-1,2,a_P);
a_A[0]=0;a_A[1]=0;a_A[2]=0;
a_G30:a_1684(1164737725);
...
static void a_1452(a_word a_A[1]){ /* toselectors+>a> */
a_word a_L2;a_word a_P[3];
if(!a_equal(1164737722,a_1692)){ goto a_G16;}
a_G2:a_1702();
a_1154(1696719031);
...
a_G9:a_P[0]=2130704967;a_P[1]=a_1442;a_P[2]=a_1441;a_1238(-1,3,a_P); goto a_G14;
a_G10:if(!a_1698(a_P)){ goto a_G12;}a_L2=a_P[0];
a_1163(a_L2); goto a_G14;
a_G12:a_P[0]=2130704978;a_P[1]=a_1442;a_P[2]=a_1441;a_1238(-1,3,a_P);
a_1712();
a_G14:if(!a_equal(1164737722,a_1692)){ return;} goto a_G2;
a_G16:a_P[0]=2130704978;a_P[1]=a_1442;a_P[2]=a_1441;a_1238(-1,3,a_P);
a_1712(); return;
} /* toselectors */
static void a_1428(void){ /* extendedblock */
...
a_G9:if(!a_1695(a_P)){ goto a_G13;}a_L2=a_P[0];a_L3=a_P[1];
a_1160(a_L2,a_L3); goto a_G7;
a_G13:if(!a_equal(a_L1,0)){ goto a_G16;}
a_P[0]=2130704987;a_P[1]=a_1442;a_P[2]=a_1441;a_1238(-1,3,a_P);
a_1712(); return;
a_G16:a_1701(1164737761);
...
a_G10:if(!a_1695(a_P)){ goto a_G13;}a_L1=a_P[0];a_L2=a_P[1];
a_1160(a_L1,a_L2); goto a_G9;
a_G13:if(!a_equal(a_L4,0)){ goto a_G16;}
a_P[0]=2130704987;a_P[1]=a_1442;a_P[2]=a_1441;a_1238(-1,3,a_P);
a_1712(); return;
a_G16:if(!a_equal(1164737755,a_1692)){ goto a_G22;}
a_1702();
if(!a_equal(a_L3,0)){ goto a_G21;}
a_L3=1;
a_1154(1696719024); goto a_G5;
a_G21:a_P[0]=2130704967;a_P[1]=a_1442;a_P[2]=a_1441;a_1238(-1,3,a_P); goto a_G5;
a_G22:a_1701(1164737761);
a_1154(1696718882); return;
} /* listfillblock */
static void a_1430(a_word a_A[1]){ /* filleritem+a> */
a_word a_L2;a_word a_L3;a_word a_P[3];
if(!a_1694(a_P)){ goto a_G4;}a_L2=a_P[0];
a_1154(a_L2);
a_G3:a_A[0]=0; return;
a_G4:if(!a_1695(a_P)){ goto a_G7;}a_L2=a_P[0];a_L3=a_P[1];
a_1160(a_L2,a_L3); goto a_G3;
a_G7:if(!a_1697(a_P)){ goto a_G10;}a_L2=a_P[0];
a_1161(a_L2);
a_A[0]=1; return;
a_G10:if(!a_equal(1164737758,a_1692)){ goto a_G14;}
a_1702();
a_1437(); goto a_G3;
a_G14:a_P[0]=2130704997;a_P[1]=a_1442;a_P[2]=a_1441;a_1238(-1,3,a_P);
a_1712(); goto a_G3;
} /* filleritem */
static void a_1447(a_word a_F1){ /* repeatcount+>a */
a_word a_L2;a_word a_L3;a_word a_L4;a_word a_P[5];
if(!a_equal(1164737755,a_1692)){ return;}
a_1702();
if(a_equal(a_F1,0)){ goto a_G5;}
a_P[0]=2130705021;a_P[1]=a_1442;a_P[2]=a_1441;a_1238(-1,3,a_P);
a_G5:if(!a_1694(a_P)){ goto a_G12;}a_L2=a_P[1];
{ if((1<=a_L2 && a_L2<=1000)){  goto a_G9;}
}
a_P[0]=2130705011;a_P[1]=a_1442;a_P[2]=a_1441;a_P[3]=a_L2;a_P[4]=1000;a_1238(-1,5,a_P);
a_L2=1;
...
a_G15:a_P[0]=2130705031;a_P[1]=a_1442;a_P[2]=a_1441;a_1238(-1,3,a_P); return;
} /* repeatcount */
static void a_1433(void){ /* initializer */
a_word a_L1;a_word a_L2;a_word a_L3;a_word a_L4;a_word a_P[3];
...
a_G10:a_P[0]=2130705040;a_P[1]=a_1442;a_P[2]=a_1441;a_1238(-1,3,a_P); return;
} /* initializer */
static void a_1423(void){ /* createlistfiller */
a_word a_L1;a_word a_L2;a_word a_P[3];
if(!a_equal(1164737758,a_1692)){ goto a_G17;}
a_1702();
...
a_G14:a_1712(); return;
a_G15:a_P[0]=2130704997;a_P[1]=a_1442;a_P[2]=a_1441;a_1238(-1,3,a_P); goto a_G14;
a_G17:a_P[0]=2130704997;a_P[1]=a_1442;a_P[2]=a_1441;a_1238(-1,3,a_P);
a_1712(); return;
} /* createlistfiller */
static void a_1436(void){ /* listfill */
...
static void a_1429(a_word a_F1){ /* externaldeclarer+>a */
...
a_L4=0;
a_P[0]=2130705050;a_P[1]=a_1442;a_P[2]=a_1441;a_1238(-1,3,a_P);
a_G13:a_1154(1696718920);
a_1162(a_L3);
a_1161(a_L4);
a_1154(1696718991); return;
} /* externaldeclarer */
static void a_1438(a_word a_F1){ /* listprototype+>a */
a_word a_L2;a_word a_L3;a_word a_P[1];
a_1481(22019,a_P);a_L2=a_P[0];
...
static void a_1443(a_word a_F1,a_word a_A[1]){ /* prototypeorfill+>a+>a> */
a_word a_L3;a_word a_P[1];
...
static void a_1444(a_word a_F1,a_word a_A[1]){ /* prototypeorfillbody+>a+>a> */
a_word a_P[2];
if(!a_equal(1164737725,a_1692)){ goto a_G8;}
a_1702();
if(!a_equal(a_A[0],3)){ goto a_G6;}
a_P[0]=2130705061;a_P[1]=a_1442;a_1238(-1,2,a_P);
a_1712(); return;
a_G6:a_A[0]=4;
a_G7:a_1436(); return;
a_G8:if(!a_equal(a_A[0],4)){ goto a_G11;}
...
static void a_1427(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4){ /* declarerbody+>a+>a+>a+>a */
a_word a_L5;a_word a_P[2];
if(!a_equal(1164737740,a_1692)){ goto a_G4;}
a_1702();
a_1701(1164737743); goto a_G5;
a_G4:a_P[0]=2130705070;a_P[1]=a_1442;a_1238(-1,2,a_P);
...
a_word a_L2;a_word a_L3;a_word a_L4;a_word a_L5;a_word a_L6;a_word a_P[3];
a_1690(a_P);a_L2=a_P[0];
...
a_G9:a_P[0]=2130705061;a_P[1]=a_1442;a_1238(-1,2,a_P);
a_G10:a_1712(); return;
a_G11:if(!a_1448(a_P)){ goto a_G17;}a_L3=a_P[0];a_L4=a_P[1];a_L5=a_P[2];
if(!a_equal(a_A[0],0)){ goto a_G9;}
a_A[0]=2; goto a_G6;
a_G17:if(!a_equal(a_A[0],0)){ goto a_G26;}
a_1432(a_P);a_L6=a_P[0];
if(a_is(a_L6)){ goto a_G10;}
if(!a_equal(a_1442,16777240)){ goto a_G25;}
if(!a_equal(1164737740,a_1692)){ goto a_G25;}
a_A[0]=2;
a_1427(a_L2,0,0,0); return;
a_G25:a_P[0]=a_A[0];a_1444(a_L2,a_P);a_A[0]=a_P[0]; return;
a_G26:a_P[0]=a_A[0];a_1443(a_L2,a_P);a_A[0]=a_P[0]; return;
} /* declaration */
static void a_1425(a_word a_F1,a_word a_F2){ /* declarationseries+>a+>a */
a_word a_P[1];
a_1442=a_F2;
a_G2:a_P[0]=a_F1;a_1424(a_P);a_F1=a_P[0];
if(!a_equal(1164737770,a_1692)){ goto a_G6;}
a_1702(); goto a_G2;
a_G6:if(!a_equal(1164737776,a_1692)){ goto a_G8;}
a_1702(); return;
a_G8:a_1701(1164737776);
a_1715(); return;
} /* declarationseries */
static void a_1451(a_word a_F1){ /* tabledeclaration+>a */

a_1425(a_F1,16777240); return;
} /* tabledeclaration */
static void a_1449(a_word a_F1){ /* stackdeclaration+>a */
...
a_P[0]=2130705117;a_1238(0,1,a_P);
...
a_1702();
a_1456(); goto a_G1;
a_G21:if(!a_equal(1164737644,a_1692)){ goto a_G24;}
a_1702(); goto a_G7;
a_G24:a_P[0]=2130705091;a_P[1]=a_1692;a_1238(-1,2,a_P);
a_1715(); goto a_G1;
} /* pass1 */
static a_word a_1455(a_word a_F1){ /* declaration+>a */
...
static void a_1456(void){ /* externaldeclaration */
a_word a_P[2];
if(!a_1489(22022)){ goto a_G8;}
if(a_1455(1)){ return;}
if(!a_equal(1164737644,a_1692)){ goto a_G6;}
a_1702();
a_G5:a_1715(); return;
a_G6:a_P[0]=2130705091;a_P[1]=a_1692;a_1238(-1,2,a_P); goto a_G5;
a_G8:a_P[0]=2130705104;a_1238(-1,1,a_P);
a_1715(); return;
} /* externaldeclaration */
static void a_1461(void){ /* staticdeclaration */
a_word a_P[2];
...
a_1702();
a_1715(); return;
a_G10:a_P[0]=2130705091;a_P[1]=a_1692;a_1238(-1,2,a_P);
a_1715(); return;
} /* staticdeclaration */
static void a_1459(void){ /* root */
a_word a_P[1];
if(!a_is(a_1460)){ goto a_G4;}
a_P[0]=2130705112;a_1238(-1,1,a_P);
a_1715(); return;
a_G4:a_1460=1;
a_1562(); return;
} /* root */
...
static void a_1467(a_word a_F1,a_word a_A[1]){ /* trybuffer+>a+a> */
a_word a_L3;a_word a_L4;a_word a_P[1];
a_L3=0;
...
static void a_1468(a_word a_F2,a_word a_A[2]){ /* trynextpath+>a>+>a+a> */
a_word a_L4;a_word a_L5;a_word a_P[1];
a_L4=to_LIST(a_1150)->aupb;
a_L5=58;
...
static void a_1469(a_word a_F1,a_word a_F2,a_word a_A[1]){ /* trytoopenwithpath+>a+>a+a> */
...
static a_word a_1466(a_word a_F1,a_word a_F2){ /* opensrcfile+>a+>a */
a_word a_L3;a_word a_L4;a_word a_P[1];
a_L3=to_LIST(a_1150)->aupb;
a_unpackstring(a_1374,a_F2,a_1150);
...
a_1469(a_F2,1696719066,a_P);a_L4=a_P[0];
...
static void a_1465(a_word a_F1){ /* extendBUFFER+>a */

{register a_word *a_r1=a_extension(a_1150,1);a_r1[0]=a_F1;to_LIST(a_1150)->aupb+=1;}
  return;
} /* extendBUFFER */
static void a_1481(a_word a_F1,a_word a_A[1]){ /* getpragmatvalue+>a+a> */
...
a_G14:a_1248(a_1001,2130706190); return;
} /* getpragmatvalue */
static a_word a_1489(a_word a_F1){ /* ispragmatvalue+>a */
...
static void a_1507(a_word a_F1,a_word a_F2){ /* setpragmatvalue+>a+>a */
a_word a_P[1];
{ if(a_F1==22016){ goto a_G2;}
...
a_G26:a_1248(a_1001,2130706184); return;
} /* setpragmatvalue */
static void a_1504(void){ /* resetpragmats */
...
a_G8:a_1701(1164737776);
a_1715(); return;
a_G10:a_P[0]=2130705125;a_1238(-1,1,a_P);
a_1715(); return;
} /* cmdlinepragmat */
static void a_1497(a_word a_F1){ /* pragmatitem+>a */
a_word a_L2;a_word a_P[2];
if(!a_equal(1164737758,a_1692)){ goto a_G7;}
a_G2:a_1702();
a_1497(a_F1);
if(a_equal(1164737770,a_1692)){ goto a_G2;}
a_1701(1164737761); return;
a_G7:if(!a_1696(a_P)){ goto a_G9;}a_L2=a_P[0];
a_1511(a_F1,a_L2,0); return;
a_G9:if(!a_1694(a_P)){ goto a_G11;}a_L2=a_P[1];
a_1474(a_F1,a_L2); return;
a_G11:if(!a_1697(a_P)){ goto a_G13;}a_L2=a_P[0];
a_1509(a_F1,a_L2); return;
a_G13:a_P[0]=2130705133;a_P[1]=a_F1;a_1238(-1,2,a_P);
a_1712(); return;
} /* pragmatitem */
static void a_1477(a_word a_F1,a_word a_F2){ /* discpragmat+>a+>a */
...
static a_word a_1471(a_word a_A[1]){ /* aheadrawtag+a> */

if(!a_was(a_1720,a_1692)){ return 0;}
a_A[0]=a_1692; return 1;
} /* aheadrawtag */
static void a_1488(a_word a_F1){ /* insertsymbol+>a */
...
a_G1:{ if(a_1495==0){ goto a_G2;}
 ...
 if(a_1495==2){ goto a_G10;}
 if(a_1495==3){ goto a_G14;}
 if(a_1495==4){ goto a_G20;}
 if(a_1495==5){ goto a_G24;}
 if(a_1495==6){ goto a_G30;}
 if(a_1495==7){  goto a_G32;}
  goto a_G34;}
a_G2:a_1702();
...
a_G6:a_1702();
if(!a_1471(a_P)){ goto a_G9;}a_1496=a_P[0];
a_1495=2; return;
a_G9:a_1495=100; return;
a_G10:a_1702();
if(!a_equal(1164737725,a_1692)){ goto a_G13;}
a_1495=3; return;
a_G13:a_1495=100; return;
a_G14:a_1702();
{ if(!((1962709583<=a_1692 && a_1692<=1990708582)||(1696719048<=a_1692 && a_1692<=1920711077)||(604756899<=a_1692 && a_1692<=1164737376))){ goto a_G17;}
}
a_1495=0; return;
a_G17:if(!a_equal(1164737758,a_1692)){ goto a_G19;}
a_1495=4; goto a_G1;
a_G19:a_1495=100; return;
a_G20:a_1702();
{ if(!((1962709583<=a_1692 && a_1692<=1990708582)||(1696719048<=a_1692 && a_1692<=1920711077)||(604756899<=a_1692 && a_1692<=1164737376))){ goto a_G23;}
}
a_1495=5; return;
a_G23:a_1495=100; return;
a_G24:a_1702();
if(!a_equal(1164737770,a_1692)){ goto a_G27;}
a_1495=6; return;
a_G27:if(!a_equal(1164737761,a_1692)){ goto a_G29;}
a_1495=0; goto a_G1;
a_G29:a_1495=100; return;
a_G30:a_1488(a_1496);
a_1495=7; return;
a_G32:a_1488(1164737725);
a_1495=4; return;
a_G34:if(a_equal(1164737648,a_1692)){ return;}
a_1702(); return;
} /* nextpragmatsymbol */
static void a_1498(a_word a_A[1]){ /* programpragmat+a> */
a_word a_P[1];
a_1495=100;
a_1499(a_P);a_A[0]=a_P[0]; return;
} /* programpragmat */
static void a_1499(a_word a_A[1]){ /* programpragmat2+a> */
a_word a_L2;a_word a_P[1];
a_A[0]=0;
...
a_1491(); goto a_G2;
a_G15:a_P[0]=2130705125;a_1238(-1,1,a_P);
a_A[0]=1; return;
} /* programpragmat2 */
static void a_1500(a_word a_F1,a_word a_A[1]){ /* programpragmatitem+>a+>a> */
a_word a_L3;a_word a_L4;a_word a_P[2];
{ if((1962709583<=a_1692 && a_1692<=1990708582)){ goto a_G2;}
 if((1696719048<=a_1692 && a_1692<=1920711077)){ goto a_G6;}
...
a_G14:a_P[0]=2130705133;a_P[1]=a_F1;a_1238(-1,2,a_P);
a_A[0]=1; return;
} /* programpragmatitem */
static void a_1479(a_word a_F1,a_word a_F2,a_word a_A[1]){ /* findifcondition+>a+>a+a> */
a_word a_P[3];
...
a_G7:a_P[0]=2130705144;a_P[1]=a_F1;a_P[2]=a_F2;a_1238(-1,3,a_P);
a_A[0]=0; return;
} /* findifcondition */
static void a_1480(void){ /* findmatchingendif */
a_word a_L1;a_word a_P[2];
...
a_G7:a_P[0]=2130705125;a_1238(-1,1,a_P);
a_L1=1;
...
a_P[0]=2130705175;a_P[1]=a_1493;a_1238(-1,2,a_P); return;
} /* findmatchingendif */
static void a_1478(a_word a_F1,a_word a_F2){ /* dopragmatskip+>a+>a */
a_word a_L3;a_word a_L4;
a_L3=a_1493;
a_1493=a_F1;
a_L4=a_1494;
if(!a_is(a_1494)){ goto a_G6;}
a_G5:a_incr(a_1494); goto a_G8;
a_G6:if(a_is(a_F2)){ goto a_G5;}
a_G8:a_1480();
a_1494=a_L4;
a_1493=a_L3; return;
} /* dopragmatskip */
static void a_1501(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_A[1]){ /* programtagpragmat2+>a+>a+>a+>a> */
...
a_G16:if(!a_equal(a_1493,a_F2)){ goto a_G21;}
if(!a_equal(a_1494,0)){ goto a_G19;}
a_G18:a_1494=1; return;
a_G19:if(!a_equal(a_1494,1)){ return;}
a_1494=0; return;
a_G21:a_P[0]=2130705186;a_P[1]=a_F1;a_P[2]=a_F2;a_1238(-1,3,a_P);
if(a_more(a_1494,0)){ return;} goto a_G18;
a_G24:if(!a_equal(a_1493,a_F2)){ goto a_G26;}
a_G25:a_A[0]=2; return;
a_G26:a_P[0]=2130705186;a_P[1]=a_F1;a_P[2]=a_F2;a_1238(-1,3,a_P);
if(a_equal(a_1493,0)){ return;} goto a_G25;
a_G29:if(a_is(a_1494)){ return;}
a_1511(a_F1,a_F2,a_F3); return;
} /* programtagpragmat2 */
static void a_1492(a_word a_F1,a_word a_F3,a_word a_A[1]){ /* onoffpragmats+>a+>a>+>a */
a_word a_P[3];
if(!a_equal(a_F3,604756906)){ goto a_G3;}
a_A[0]=1; return;
a_G3:if(!a_equal(a_F3,604756914)){ goto a_G5;}
a_A[0]=0; return;
a_G5:a_P[0]=2130705144;a_P[1]=a_F1;a_P[2]=a_F3;a_1238(-1,3,a_P); return;
} /* onoffpragmats */
static void a_1511(a_word a_F1,a_word a_F2,a_word a_F3){ /* tagpragmat2+>a+>a+>a */
a_word a_P[3];
...
a_1482=0; return;
a_G6:a_P[0]=2130705144;a_P[1]=a_F1;a_P[2]=a_F2;a_1238(-1,3,a_P); return;
...
a_G18:a_1503=0; return;
a_G19:if(a_equal(a_F2,604756931)){ goto a_G18;}
if(!a_equal(a_F2,604757148)){ goto a_G23;}
a_G22:a_1503=1; return;
a_G23:if(!a_equal(a_F2,604757139)){ goto a_G25;}
a_G24:a_1503=2; return;
a_G25:if(a_equal(a_F2,604757157)){ goto a_G24;}
if(!a_equal(a_F2,604757166)){ goto a_G6;}
{ if(a_1503==1){ goto a_G24;}
 if(a_1503==2){  goto a_G22;}
  return;}
a_G32:if(!a_equal(a_1485,0)){ goto a_G34;}
a_P[0]=2130705195;a_P[1]=a_F1;a_1240(4,-1,2,a_P); return;
a_G34:if(a_equal(a_F2,604756922)){ goto a_G36;}
if(!a_equal(a_F2,604756914)){ goto a_G6;}
a_G36:a_1513=0; return;
a_G38:if(a_lseq(a_F3,0)){ goto a_G40;}
a_1219(a_F2,a_F3);
a_G40:a_1313(a_F2,a_F3); return;
a_G41:if(a_lseq(a_F3,0)){ goto a_G43;}
a_1219(a_F2,a_F3);
a_G43:a_1477(22032,a_F2); return;
a_G44:a_P[0]=a_1512;a_1492(604757175,a_F2,a_P);a_1512=a_P[0]; return;
a_G45:a_P[0]=a_1475;a_1492(604757193,a_F2,a_P);a_1475=a_P[0]; return;
a_G46:a_P[0]=a_1472;a_1492(604757184,a_F2,a_P);a_1472=a_P[0]; return;
a_G47:a_1506(a_F1,a_F2); return;
a_G48:a_P[0]=2130705133;a_P[1]=a_F1;a_1238(-1,2,a_P); return;
} /* tagpragmat2 */
static void a_1474(a_word a_F1,a_word a_F2){ /* conspragmat2+>a+>a */
a_word a_P[3];
...
a_1510=a_F2; return;
a_G4:a_P[0]=2130705155;a_P[1]=a_F1;a_P[2]=a_F2;a_1238(-1,3,a_P); return;
...
a_1505=a_F2; return;
a_G12:a_P[0]=2130705133;a_P[1]=a_F1;a_1238(-1,2,a_P); return;
} /* conspragmat2 */
static void a_1509(a_word a_F1,a_word a_F2){ /* stringpragmat2+>a+>a */
a_word a_P[3];
if(!a_equal(a_F2,1696719077)){ goto a_G3;}
a_P[0]=2130705144;a_P[1]=a_F1;a_P[2]=a_F2;a_1238(-1,3,a_P); return;
a_G3:{ if(a_F1==604756989){ goto a_G4;}
 ...
 if(a_F1==604756940){  goto a_G19;}
  goto a_G20;}
a_G4:a_P[0]=2130705208;a_P[1]=a_F2;a_1238(-1,2,a_P);
a_G5:a_1387(a_F2); return;
a_G6:a_P[0]=2130705208;a_P[1]=a_F2;a_1240(9,-1,2,a_P); goto a_G5;
a_G8:if(!a_is(a_1486)){ goto a_G10;}
a_1721(1,a_F2); return;
a_G10:a_P[0]=2130705205;a_P[1]=a_F1;a_1238(-1,2,a_P); return;
a_G11:if(!a_is(a_1486)){ goto a_G10;}
a_1721(2,a_F2); return;
a_G14:a_1321(a_F2); return;
a_G15:a_1325(a_F2); return;
a_G16:if(!a_equal(a_1485,0)){ goto a_G18;}
a_P[0]=2130705195;a_P[1]=a_F1;a_1240(4,-1,2,a_P); return;
a_G18:a_1323(a_F2); return;
a_G19:a_1508(a_F1,a_F2); return;
a_G20:a_1387(a_F2);
a_P[0]=2130705133;a_P[1]=a_F1;a_1238(-1,2,a_P); return;
} /* stringpragmat2 */
static void a_1508(a_word a_F1,a_word a_F2){ /* setprogramtitle+>a+>a */
a_word a_L3;a_word a_P[3];
...
a_P[0]=2130705166;a_P[1]=a_F1;a_P[2]=a_1502;a_1238(-1,3,a_P); goto a_G2;
} /* setprogramtitle */
static void a_1506(a_word a_F1,a_word a_F2){ /* setmoduletag+>a+>a */
a_word a_L3;a_word a_P[3];
a_1359(a_F2);
a_1343(a_P);a_L3=a_P[0];
if(a_equal(a_L3,a_F2)){ goto a_G5;}
a_P[0]=2130705166;a_P[1]=a_F1;a_P[2]=a_L3;a_1238(-1,3,a_P);
a_G5:if(!a_is(a_1485)){ goto a_G8;}
a_1487=1;
a_1503=2; return;
a_G8:a_1503=1; return;
} /* setmoduletag */
static void a_1520(a_word a_F1){ /* fieldlists+>a */
a_word a_L2;a_word a_P[2];
...
a_P[0]=2130705233;a_P[1]=a_F1;a_1235(2,a_P); goto a_G4;
} /* fieldlists */
static void a_1519(a_word a_F1,a_word a_A[1]){ /* fieldlist+>a+a> */
a_word a_L3;a_word a_P[3];
a_A[0]=1;
...
a_P[0]=2130705220;a_P[1]=a_F1;a_P[2]=a_L3;a_1235(3,a_P);
...
a_1702(); return;
a_G14:a_P[0]=2130705243;a_P[1]=a_F1;a_1235(2,a_P); return;
a_G15:a_P[0]=2130705255;a_P[1]=a_F1;a_1235(2,a_P); return;
} /* fieldlist */
static void a_1521(void){ /* findlocalssel */
a_word a_L1;a_word a_P[1];
...
static void a_1522(a_word a_F1,a_word a_A[1]){ /* formalatag+>a+a> */
a_word a_P[2];
if(!a_1698(a_P)){ goto a_G4;}a_A[0]=a_P[0];
if(a_noteq(a_A[0],a_F1)){ return;}
a_P[0]=2130705295;a_P[1]=a_F1;a_1235(2,a_P); return;
a_G4:a_A[0]=a_F1;
a_P[0]=2130705265;a_P[1]=a_F1;a_1235(2,a_P); return;
} /* formalatag */
static void a_1532(a_word a_F1){ /* subbus+>a */
a_word a_P[3];
if(!a_equal(1164737740,a_1692)){ goto a_G6;}
a_1702();
if(!a_equal(1164737743,a_1692)){ goto a_G5;}
a_1702(); return;
a_G5:a_P[0]=2130705276;a_P[1]=1164737743;a_1235(2,a_P); return;
a_G6:a_P[0]=2130705276;a_P[1]=a_F1;a_P[2]=1164737740;a_1235(3,a_P); return;
} /* subbus */
static void a_1525(a_word a_F1){ /* nextformalaffix+>a */
a_word a_L2;a_word a_P[1];
...
a_1532(a_F1);
a_1521(); return;
a_G8:if(!a_equal(1164737758,a_1692)){ goto a_G14;}
a_1724(16777283,0); goto a_G4;
a_G14:if(!a_equal(1696719077,a_1692)){ goto a_G18;}
a_1702();
a_1522(a_F1,a_P);a_L2=a_P[0];
a_1724(16777288,a_L2); return;
a_G18:if(!a_equal(1164737746,a_1692)){ goto a_G21;}
a_1702();
a_1724(16777310,604757376); return;
a_G21:if(!a_equal(1164737731,a_1692)){ goto a_G30;}
a_1702();
a_1522(a_F1,a_P);a_L2=a_P[0];
if(!a_equal(1164737731,a_1692)){ goto a_G27;}
a_1702();
a_G26:a_1724(16777304,a_L2); return;
a_G27:if(a_equal(1164737791,a_1692)){ goto a_G26;}
a_1724(16777293,a_L2); return;
a_G30:a_1522(a_F1,a_P);a_L2=a_P[0];
if(!a_equal(1164737731,a_1692)){ goto a_G34;}
a_1702();
a_G33:a_1724(16777298,a_L2); return;
a_G34:if(a_equal(1164737791,a_1692)){ goto a_G33;}
a_1532(a_F1);
a_1724(16777283,a_L2);
a_1521(); return;
} /* nextformalaffix */
static void a_1526(a_word a_F1,a_word a_A[1]){ /* readformalaffixes+>a+a> */
a_word a_L3;a_word a_P[2];
a_scratch(a_1719);
a_1681();
...
if(!a_equal(1164737725,a_1692)){ goto a_G18;}
a_G17:a_A[0]=2; return;
a_G18:if(a_equal(1164737791,a_1692)){ goto a_G17;}
if(!a_equal(1164737779,a_1692)){ goto a_G22;}
a_G21:a_A[0]=3; return;
a_G22:if(a_equal(1164737764,a_1692)){ goto a_G21;}
a_P[0]=2130705285;a_P[1]=a_F1;a_1238(-1,2,a_P); goto a_G5;
} /* readformalaffixes */
static void a_1516(a_word a_F1,a_word a_F2,a_word a_A[1]){ /* checkformalaffixes+>a+>a+>a> */
a_word a_L4;a_word a_L5;a_word a_L6;a_word a_P[3];
a_L4=to_LIST(a_1719)->alwb;
a_L5=0;
a_1524=0;a_1523=0;
a_G4:if(a_more(a_L4,to_LIST(a_1719)->aupb)){ goto a_G21;}
if(!a_equal(to_LIST(a_1719)->offset[a_L4-2],16777310)){ goto a_G12;}
if(!a_equal(a_L5,0)){ goto a_G9;}
a_L5=1;
a_1524=1; goto a_G11;
a_G9:a_A[0]=0;
a_P[0]=2130705305;a_P[1]=a_F1;a_1238(-1,2,a_P);
a_G11:a_next(a_1719,a_L4); goto a_G4;
a_G12:if(!a_equal(to_LIST(a_1719)->offset[a_L4-2],16777298)){ goto a_G17;}
if(a_equal(a_L5,0)){ goto a_G11;}
a_L5=2;
a_1523=1; goto a_G11;
...
a_A[0]=0;
a_P[0]=2130705316;a_P[1]=a_F1;a_1238(-1,2,a_P);
a_G24:a_L4=to_LIST(a_1719)->alwb;
a_L6=0;
a_G26:if(a_more(a_L4,to_LIST(a_1719)->aupb)){ goto a_G34;}
{register a_word a_r1=to_LIST(a_1719)->offset[a_L4-2];
 if(!(a_r1==16777298||a_r1==16777304)){ goto a_G30;}
}
if(!a_noteq(a_F2,1024)){ goto a_G31;}
a_L6=1;
a_G30:a_next(a_1719,a_L4); goto a_G26;
a_G31:a_A[0]=0;
a_P[0]=2130705328;a_P[1]=a_F1;a_P[2]=a_L4;a_1238(-1,3,a_P);
a_G34:if(a_equal(a_A[0],0)){ return;}
if(a_is(a_L6)){ return;}
if(a_noteq(a_F2,0)){ return;}
a_A[0]=0;
a_P[0]=2130705348;a_P[1]=a_F1;a_1238(-1,2,a_P); return;
} /* checkformalaffixes */
static void a_1529(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4){ /* ruleprototype+>a+>a+>a+>a */
a_word a_L5;a_word a_P[2];
a_G1:a_1531(a_F1,a_F2,a_F3,a_F4);
if(!a_equal(1164737770,a_1692)){ goto a_G15;}
a_1702();
if(!a_1695(a_P)){ goto a_G13;}a_F1=a_P[0];a_F2=a_P[1];
...
if(!a_equal(a_L5,0)){ goto a_G11;}
a_G10:a_1715(); return;
a_G11:a_P[0]=2130705285;a_P[1]=a_F2;a_1238(-1,2,a_P); goto a_G10;
a_G13:a_P[0]=2130705355;a_1238(-1,1,a_P); goto a_G10;
a_G15:if(!a_equal(1164737776,a_1692)){ goto a_G17;}
a_1702(); return;
a_G17:a_1701(1164737776);
a_1715(); return;
} /* ruleprototype */
static void a_1531(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4){ /* simpleruleprototype+>a+>a+>a+>a */
a_word a_L5;a_word a_L6;a_word a_P[1];
...
static void a_1518(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4){ /* externalrule+>a+>a+>a+>a */
a_word a_L5;a_word a_P[2];
...
static void a_1530(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4){ /* simpleexternalrule+>a+>a+>a+>a */
...
a_L6=0;
a_P[0]=2130705339;a_P[1]=a_F2;a_1238(-1,2,a_P);
a_G10:a_1154(1696718920);
a_1162(a_L5);
a_1161(a_L6);
a_1154(1696718991); return;
} /* simpleexternalrule */
static void a_1517(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4,a_word a_A[1]){ /* createruledefinition+>a+>a+>a+>a+a> */
...
static void a_1528(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4){ /* ruledeclarer+>a+>a+>a+>a */
a_word a_L5;a_word a_L6;a_word a_P[1];
a_1517(a_F1,a_F2,a_F3,a_F4,a_P);a_L5=a_P[0];
a_P[0]=a_L5;a_1299(a_P);a_L5=a_P[0];
a_1154(1696719013);
...
static void a_1527(a_word a_F1,a_word a_F2){ /* ruledeclaration+>a+>a */
a_word a_L3;a_word a_L4;a_word a_L5;a_word a_L6;a_word a_P[2];
if(!a_1695(a_P)){ goto a_G19;}a_L3=a_P[0];a_L4=a_P[1];
...
a_G7:a_P[0]=2130705285;a_P[1]=a_L4;a_1238(-1,2,a_P);
a_G8:a_1715(); return;
...
a_G19:a_P[0]=2130705355;a_1238(-1,1,a_P);
a_1715(); return;
} /* ruledeclaration */
static void a_1568(a_word a_F1){ /* setlocalrepr+>a */
a_word a_L2;
...
static void a_1561(a_word a_F1){ /* restorelocalrepr+>a */
a_word a_L2;
a_L2=to_LIST(a_1719)->offset[a_F1];
to_LIST(a_1720)->offset[a_L2-2]=to_LIST(a_1719)->offset[a_F1-1]; return;
} /* restorelocalrepr */
static void a_1569(a_word a_F1){ /* setuplocalstack+>a */
a_word a_L2;a_word a_L3;a_word a_P[3];
a_L2=to_LIST(a_1719)->alwb;
a_1549=0;
a_G3:if(a_more(a_L2,to_LIST(a_1719)->aupb)){ goto a_G11;}
...
a_P[0]=2130705452;a_P[1]=a_F1;a_P[2]=a_L2;a_1238(-1,3,a_P); goto a_G6;
a_G11:a_1739(a_F1,a_P);a_L3=a_P[0];
...
static void a_1558(a_word a_F1,a_word a_A[1]){ /* openlocalrange+>a+a> */
...
static void a_1535(a_word a_F1){ /* addlocalaffix+>a */

a_1724(16777331,a_F1);
a_1568(to_LIST(a_1719)->aupb); return;
} /* addlocalaffix */
static void a_1544(a_word a_F1){ /* closelocalrange+>a */
...
static void a_1550(a_word a_F1,a_word a_F2,a_word a_A[1]){ /* getformalaffix+>a+>a+a> */
...
static a_word a_1553(a_word a_A[3]){ /* isqltag+a>+a>+a> */
a_word a_P[2];
if(!a_1695(a_P)){ return 0;}a_A[0]=a_P[0];a_A[1]=a_P[1];
a_1550(a_A[0],a_A[1],a_P);a_A[2]=a_P[0]; return 1;
} /* isqltag */
static void a_1534(a_word a_F1,a_word a_F2,a_word a_F3){ /* Dqloc+>a+>a+>a */

if(!a_equal(a_F3,0)){ goto a_G3;}
a_1160(a_F1,a_F2); return;
a_G3:a_1162(a_F3); return;
} /* Dqloc */
static void a_1557(a_word a_F1){ /* mustformallist+>a */
a_word a_P[2];
if(a_equal(a_F1,0)){ return;}
{register a_word a_r1=to_LIST(a_1719)->offset[a_F1-2];
 if(a_r1==16777283||a_r1==16777277){  return;}
}
a_P[0]=2130705482;a_P[1]=a_F1;a_1235(2,a_P); return;
} /* mustformallist */
static void a_1571(void){ /* skipoveranindex */
a_word a_P[2];
...
a_1702(); return;
a_G6:a_P[0]=2130705364;a_P[1]=1164737743;a_1235(2,a_P); return;
} /* skipoveranindex */
static void a_1574(a_word a_A[1]){ /* skipoversource+a> */
a_word a_L2;a_word a_L3;a_word a_P[2];
a_A[0]=0;
a_L2=a_1692;
if(a_1694(a_P)){ return;}
if(!a_1695(a_P)){ goto a_G14;}a_L3=a_P[0];
if(!a_equal(a_L3,0)){ goto a_G11;}
if(!a_equal(1164737755,a_1692)){ goto a_G11;}
a_1702();
if(!a_1695(a_P)){ goto a_G10;}
a_G9:a_1571(); return;
a_G10:a_P[0]=2130705382;a_P[1]=1164737755;a_1235(2,a_P); return;
a_G11:if(a_equal(1164737740,a_1692)){ goto a_G9;}
a_A[0]=1; return;
a_G14:if(!a_equal(1164737734,a_1692)){ goto a_G16;}
a_G15:a_1702(); goto a_G24;
a_G16:if(a_equal(1164737737,a_1692)){ goto a_G15;}
if(a_equal(1164737728,a_1692)){ goto a_G15;}
if(a_equal(1164737731,a_1692)){ goto a_G15;}
if(a_equal(1164737752,a_1692)){ goto a_G15;} goto a_G26;
a_G24:if(a_1695(a_P)){ return;}
a_P[0]=2130705382;a_P[1]=a_L2;a_1235(2,a_P); return;
a_G26:a_P[0]=2130705396;a_1235(1,a_P); return;
} /* skipoversource */
static void a_1572(void){ /* skipoverdestination */
a_word a_P[2];
if(!a_equal(1164737722,a_1692)){ goto a_G7;}
a_G2:a_1702();
if(!a_1698(a_P)){ goto a_G6;}
if(!a_equal(1164737722,a_1692)){ return;} goto a_G2;
a_G6:a_P[0]=2130705415;a_1235(1,a_P); return;
a_G7:a_P[0]=2130705364;a_P[1]=1164737722;a_1235(2,a_P); return;
} /* skipoverdestination */
static void a_1573(a_word a_F1,a_word a_A[4]){ /* skipoverextension+>a+a>+a>+a>+a> */
a_word a_P[2];
...
static void a_1559(a_word a_A[2]){ /* peekaftersource+a>+a> */
a_word a_L3;a_word a_P[1];
...
static void a_1566(a_word a_F1){ /* searchjump+>a */
a_word a_L2;a_word a_P[3];
a_L2=to_LIST(a_1719)->aupb;
a_G2:if(!a_less(a_L2,to_LIST(a_1719)->alwb)){ goto a_G4;}
a_P[0]=2130705441;a_P[1]=a_1565;a_P[2]=a_F1;a_1238(-1,3,a_P); return;
...
a_G16:a_P[0]=2130705382;a_P[1]=1164737764;a_1238(-1,2,a_P); return 1;
} /* terminator */
static void a_1552(a_word a_F1,a_word a_F2,a_word a_F3){ /* indexsource+>a+>a+>a */
a_word a_P[3];
a_1557(a_F3);
...
a_1702(); return;
a_G10:a_P[0]=2130705374;a_P[1]=1164737743;a_P[2]=a_F2;a_1235(3,a_P); return;
...
static void a_1567(a_word a_F1,a_word a_F2,a_word a_F3){ /* selector+>a+>a+>a */
a_word a_L4;a_word a_P[3];
if(!a_equal(a_F3,0)){ goto a_G3;}
a_1163(a_F1); return;
a_G3:a_1557(a_F3);
...
a_1158(a_L4); return;
a_G6:a_P[0]=2130705472;a_P[1]=a_F1;a_P[2]=a_F2;a_1238(-1,3,a_P); return;
} /* selector */
static void a_1554(a_word a_F1){ /* listtag+>a */
a_word a_L2;a_word a_L3;a_word a_L4;a_word a_P[3];
if(!a_1553(a_P)){ goto a_G4;}a_L2=a_P[0];a_L3=a_P[1];a_L4=a_P[2];
a_1557(a_L4);
a_1534(a_L2,a_L3,a_L4); return;
a_G4:a_P[0]=2130705382;a_P[1]=a_F1;a_1235(2,a_P); return;
} /* listtag */
static void a_1575(a_word a_F1){ /* source+>a */
...
a_G35:a_P[0]=2130705461;a_P[1]=a_F1;a_1235(2,a_P);
a_1712(); return;
} /* source */
static void a_1576(a_word a_F1){ /* sourceorstring+>a */
a_word a_L2;a_word a_L3;a_word a_L4;a_word a_P[1];
...
a_G6:a_P[0]=2130705501;a_P[1]=a_1565;a_1238(-1,2,a_P); return 1;
} /* anchoraffix */
static void a_1537(void){ /* affixform */
...
a_G8:a_P[0]=2130705388;a_1238(-1,1,a_P);
a_1712(); return;
} /* affixform */
static void a_1577(a_word a_F1){ /* specialaffixform+>a */
a_word a_L2;a_word a_P[1];
a_1160(0,a_F1);
a_1154(1696718988);
a_1547=0;
...
static void a_1579(a_word a_F1,a_word a_F2){ /* toselectors+>a+>a */
a_word a_L3;a_word a_P[2];
if(!a_equal(1164737722,a_1692)){ goto a_G10;}
a_G2:a_1702();
if(!a_1698(a_P)){ goto a_G8;}a_L3=a_P[0];
a_1154(1696719031);
a_1567(a_L3,a_F1,a_F2);
if(!a_equal(1164737722,a_1692)){ return;} goto a_G2;
a_G8:a_P[0]=2130705382;a_P[1]=1164737722;a_1238(-1,2,a_P);
a_1712(); return;
a_G10:a_P[0]=2130705364;a_P[1]=1164737722;a_1238(-1,2,a_P); return;
} /* toselectors */
static void a_1548(a_word a_F1,a_word a_F2){ /* extension+>a+>a */
a_word a_L3;a_word a_P[1];
...
{ if(a_1692==1164737758||a_1692==1164737755||a_1692==1164737734||a_1692==1164737737||a_1692==1164737728||a_1692==1164737731||a_1692==1164737752||(1962709583<=a_1692 && a_1692<=1990708582)||(604756899<=a_1692 && a_1692<=1164737376)){  return 1;}
  return 0;}
} /* lookingatamember */
static void a_1556(void){ /* member */
a_word a_L1;a_word a_L2;a_word a_L3;a_word a_L4;a_word a_P[4];
if(!a_equal(1164737758,a_1692)){ goto a_G10;}
a_1702();
...
a_G8:a_1546(); return;
a_G10:if(!a_equal(1164737755,a_1692)){ goto a_G15;}
a_P[0]=2130705405;a_1240(8,-1,1,a_P);
a_1573(0,a_P);a_L1=a_P[0];a_L2=a_P[1];a_L4=a_P[3];
if(a_is(a_L4)){ return;} goto a_G7;
a_G15:a_1559(a_P);a_L2=a_P[0];a_L4=a_P[1];
if(a_is(a_L4)){ return;}
if(!a_is(a_L2)){ goto a_G19;}
a_1577(a_L2); return;
a_G19:a_1537(); return;
} /* member */
static void a_1560(a_word a_A[1]){ /* peeklabel+a> */
a_word a_P[1];
a_1691();
a_A[0]=0;
...
static void a_1570(a_word a_F1){ /* skiplabel+>a */
...
a_word a_L1;a_word a_P[2];
a_1691();
if(!a_equal(1164737779,a_1692)){ goto a_G19;}
a_1702();
if(!a_1698(a_P)){ goto a_G19;}
a_1700();
a_1154(1696718953);
...
a_G12:a_P[0]=2130705382;a_P[1]=1164737779;a_1238(-1,2,a_P);
a_G13:a_1712(); return;
a_G14:if(!a_equal(1164737764,a_1692)){ goto a_G17;}
a_1702();
a_1154(1696718885); return;
a_G17:a_P[0]=2130705364;a_P[1]=1164737764;a_1238(-1,2,a_P); goto a_G13;
a_G19:a_1700(); return;
} /* addlocalaffixes */
static void a_1546(void){ /* compoundmember */
a_word a_L1;a_word a_L2;a_word a_P[2];
...
a_1702(); goto a_G14;
a_G12:a_P[0]=2130705364;a_P[1]=1164737761;a_1238(-1,2,a_P);
a_1712();
...
a_G7:a_P[0]=2130705491;a_P[1]=a_1565;a_1238(-1,2,a_P); return;
} /* alternative */
static void a_1539(void){ /* alternativeseries */
...
a_P[0]=2130705513;a_P[1]=a_1565;a_1238(-1,2,a_P);
a_G17:if(!a_equal(1164737773,a_1692)){ goto a_G20;}
a_1702();
a_1154(1696719016); goto a_G1;
a_G20:a_1701(1164737743); return;
} /* area */
static void a_1542(a_word a_A[1]){ /* class+a> */
a_word a_P[2];
...
if(!a_equal(1164737770,a_1692)){ goto a_G10;}
a_1702(); goto a_G11;
a_G10:a_P[0]=2130705364;a_P[1]=1164737770;a_1238(-1,2,a_P);
a_G11:a_1538(); return;
a_G12:a_A[0]=1;
a_1154(1696718860);
a_1154(1696718885);
...
if(!a_equal(1164737725,a_1692)){ goto a_G9;}
a_1702(); goto a_G10;
a_G9:a_P[0]=2130705364;a_P[1]=1164737725;a_1238(-1,2,a_P);
...
if(!a_equal(a_L3,0)){ return;}
a_P[0]=2130705522;a_1238(-1,1,a_P); return;
} /* classification */
static void a_1551(a_word a_A[1]){ /* getruletag+a> */
a_word a_P[1];
if(!a_is(a_1565)){ goto a_G3;}
a_1739(a_1565,a_P);a_A[0]=a_P[0]; return;
a_G3:a_A[0]=0; return;
} /* getruletag */
static void a_1564(a_word a_F1){ /* rulepragmats+>a */
...
static void a_1563(a_word a_F1){ /* rulebody+>a */
a_word a_P[2];
a_1565=a_F1;
a_1564(a_1565);
a_1569(a_F1);
...
a_1702(); goto a_G11;
a_G9:a_P[0]=2130705364;a_P[1]=1164737764;a_1238(-1,2,a_P);
a_1712();
...
a_1702(); return;
a_G22:a_P[0]=2130705364;a_P[1]=1164737776;a_1238(-1,2,a_P);
a_1715(); return;
} /* rulebody */
static void a_1562(void){ /* rootbody */
a_word a_L1;a_word a_P[2];
...
a_1702(); return;
a_G23:a_P[0]=2130705364;a_P[1]=1164737776;a_1238(-1,2,a_P);
a_1715(); return;
} /* rootbody */
static void a_1610(a_word a_F1){ /* noexternal+>a */
a_word a_L2;a_word a_P[4];
if(!a_1746(a_F1,16)){ return;}
a_1741(a_F1,a_P);a_L2=a_P[0];
a_P[0]=2130705532;a_P[1]=a_L2;a_P[2]=a_F1;a_P[3]=to_LIST(a_1718)->offset[a_F1-5];a_1238(-1,4,a_P); return;
} /* noexternal */
static void a_1583(a_word a_F1){ /* checkconstanttype+>a */
a_word a_L2;a_word a_P[5];
a_1741(a_F1,a_P);a_L2=a_P[0];
if(!a_equal(a_L2,16777226)){ goto a_G4;}
a_1610(a_F1); return;
a_G4:if(a_equal(a_L2,16777257)){ return;}
a_P[0]=2130705575;a_P[1]=a_L2;a_P[2]=a_F1;a_P[3]=16777226;a_P[4]=to_LIST(a_1718)->offset[a_F1-5];a_1238(-1,5,a_P); return;
} /* checkconstanttype */
static void a_1587(a_word a_F1){ /* checkstrictconstanttype+>a */
a_word a_L2;a_word a_P[5];
a_1741(a_F1,a_P);a_L2=a_P[0];
if(!a_equal(a_L2,16777226)){ goto a_G4;}
a_1610(a_F1); return;
a_G4:a_P[0]=2130705575;a_P[1]=a_L2;a_P[2]=a_F1;a_P[3]=16777226;a_P[4]=to_LIST(a_1718)->offset[a_F1-5];a_1238(-1,5,a_P); return;
} /* checkstrictconstanttype */
static void a_1584(a_word a_F1){ /* checklisttype+>a */
a_word a_L2;a_word a_P[4];
a_1741(a_F1,a_P);a_L2=a_P[0];
{ if(!(a_L2==16777240||a_L2==16777244||a_L2==16777250)){ goto a_G4;}
}
a_1610(a_F1); return;
a_G4:a_P[0]=2130705543;a_P[1]=a_L2;a_P[2]=a_F1;a_P[3]=to_LIST(a_1718)->offset[a_F1-5];a_1238(-1,4,a_P); return;
} /* checklisttype */
static a_word a_1606(a_word a_F1){ /* islisttype+>a */

{register a_word a_r1=to_LIST(a_1718)->offset[a_F1-3];
...
a_1248(a_1001,2130706195); return;
} /* secondpass */
static void a_1615(a_word a_F1){ /* ruledeclarer+>a */
a_word a_L2;a_word a_P[1];
...
static void a_1586(a_word a_A[1]){ /* checkruletype+>a> */
a_word a_L2;a_word a_P[5];
if(a_equal(a_A[0],0)){ return;}
a_1741(a_A[0],a_P);a_L2=a_P[0];
if(a_equal(a_L2,16777271)){ return;}
a_P[0]=2130705575;a_P[1]=a_L2;a_P[2]=a_A[0];a_P[3]=16777271;a_P[4]=to_LIST(a_1718)->offset[a_A[0]-5];a_1238(-1,5,a_P);
a_A[0]=0; return;
} /* checkruletype */
static void a_1581(void){ /* affixform */
a_word a_L1;a_word a_L2;a_word a_L3;a_word a_P[2];
...
a_P[0]=2130705584;a_P[1]=a_L3;a_P[2]=to_LIST(a_1718)->offset[a_L3-5];a_1238(-1,3,a_P); return;
...
static void a_1613(a_word a_F1,a_word a_F2){ /* readlistselectors+>a+>a */
...
static void a_1619(a_word a_F1,a_word a_F2){ /* selectorerror+>a+>a */
a_word a_L3;a_word a_P[4];
a_1741(a_F1,a_P);a_L3=a_P[0];
...
a_P[0]=2130705575;a_P[1]=a_L1;a_P[2]=a_L5;a_P[3]=a_L2;a_P[4]=to_LIST(a_1718)->offset[a_L5-5];a_1238(-1,5,a_P); goto a_G6;
a_G16:a_1613(0,a_L5);
a_1196(1696718885);
a_1598(a_L5);
a_1154(1696718991); return;
} /* listfill */
static void a_1598(a_word a_F1){ /* filler+>a */
...
static void a_1601(a_word a_F1){ /* fillerinitializer+>a */
a_word a_L2;a_word a_P[1];
...
a_P[0]=2130705643;a_P[1]=to_LIST(a_1718)->offset[a_L1-3];a_P[2]=a_L1;a_P[3]=to_LIST(a_1718)->offset[a_L1-5];a_1238(-1,4,a_P); return;
a_G6:if(a_1489(22021)){ goto a_G8;}
if(!a_was(a_1720,to_LIST(a_1718)->offset[a_L1-6])){ goto a_G10;}
a_G8:a_1758(a_L1);
a_1757(a_L1,4); return;
a_G10:a_P[0]=2130705619;a_P[1]=to_LIST(a_1718)->offset[a_L1-3];a_P[2]=a_L1;a_1238(-1,3,a_P); return;
} /* exportprototype */
static void a_1612(void){ /* prototype */
a_word a_P[1];
a_1585(0,a_P); return;
} /* prototype */
static a_word a_1624(a_word a_F1,a_word a_F2){ /* typemismatch+>a+>a */
a_word a_L3;a_word a_P[1];
...
static void a_1585(a_word a_F1,a_word a_A[1]){ /* checkprototype+>a+a> */
...
a_G8:if(!a_1624(a_L3,a_A[0])){ goto a_G12;}
a_P[0]=2130705575;a_P[1]=to_LIST(a_1718)->offset[a_A[0]-3];a_P[2]=a_A[0];a_P[3]=a_L3;a_P[4]=to_LIST(a_1718)->offset[a_A[0]-5];a_1238(-1,5,a_P);
a_A[0]=0; goto a_G7;
a_G12:if(!a_1606(a_A[0])){ goto a_G7;}
a_1613(a_F1,a_A[0]); goto a_G7;
} /* checkprototype */
static void a_1616(a_word a_A[1]){ /* ruleprototype+a> */
...
a_P[0]=2130705575;a_P[1]=a_L6;a_P[2]=a_A[0];a_P[3]=16777271;a_P[4]=to_LIST(a_1718)->offset[a_A[0]-5];a_1238(-1,5,a_P);
a_G10:a_A[0]=0; return;
a_G11:a_1738(a_A[0],1792,a_P);a_L6=a_P[0];
if(!a_noteq(a_L6,a_L2)){ goto a_G15;}
a_P[0]=2130705595;a_P[1]=a_A[0];a_P[2]=to_LIST(a_1718)->offset[a_A[0]-5];a_1238(-1,3,a_P); goto a_G10;
a_G15:a_1729(a_A[0],a_P);a_L6=a_P[0];
if(!a_noteq(a_L6,a_L5)){ return;}
a_P[0]=2130705607;a_P[1]=a_A[0];a_P[2]=to_LIST(a_1718)->offset[a_A[0]-5];a_1238(-1,3,a_P); goto a_G10;
} /* ruleprototype */
static void a_1604(void){ /* importprototype */
a_word a_L1;a_word a_L2;a_word a_P[3];
a_1200(a_P);a_L1=a_P[0];
...
if(a_is(a_L2)){ goto a_G7;}
a_P[0]=2130705631;a_P[1]=to_LIST(a_1718)->offset[a_L1-3];a_P[2]=a_L1;a_1238(-1,3,a_P);
...
static void a_1588(a_word a_F1){ /* checktagformacro+>a */
a_word a_L2;a_word a_L3;a_word a_P[4];
if(!a_1746(a_F1,2)){ goto a_G9;}
a_1730(a_F1,a_P);a_L3=a_P[0];
a_1741(a_F1,a_P);a_L2=a_P[0];
if(!a_noteq(a_L2,16777271)){ goto a_G6;}
a_G5:a_P[0]=2130705652;a_P[1]=a_L2;a_P[2]=a_F1;a_P[3]=a_L3;a_1240(3,-1,4,a_P); return;
a_G6:if(a_1746(a_F1,56)){ goto a_G5;}
a_1757(a_F1,128); return;
a_G9:a_P[0]=2130705661;a_P[1]=a_F1;a_1240(3,-1,2,a_P); return;
} /* checktagformacro */
static void a_1660(a_word a_F1){ /* warnnotused+>a */
a_word a_L2;a_word a_L3;a_word a_P[3];
...
a_P[0]=2130705698;a_P[1]=a_L2;a_P[2]=a_F1;a_1240(a_L3,-1,3,a_P); return;
} /* warnnotused */
static void a_1656(void){ /* thirdpass */
...
static void a_1661(a_word a_F1){ /* writeICEitem+>a */
a_word a_L2;a_word a_L3;a_word a_P[1];
a_1741(a_F1,a_P);a_L2=a_P[0];
a_1096(a_L2);
a_1095(a_F1);
...
a_G11:a_1248(a_1001,2130706205); return;
...
static void a_1642(a_word a_F1,a_word a_A[1]){ /* getqualifier+>a+a> */
a_word a_P[1];
a_A[0]=to_LIST(a_1718)->offset[a_F1-6];
if(a_equal(a_A[0],0)){ return;}
...
static void a_1647(a_word a_F1){ /* listdata+>a */
a_word a_L2;a_word a_P[1];
...
static void a_1641(a_word a_F1){ /* formalaffixes+>a */
a_word a_L2;a_word a_L3;a_word a_L4;a_word a_L5;a_word a_P[2];
a_1731(a_F1,a_P);a_L2=a_P[0];
a_1089(a_L2);
a_L3=1;
...
static void a_1659(a_word a_F1){ /* traversetags+>a */
a_word a_L2;
a_G1:if(a_equal(a_F1,0)){ return;}
a_add(a_F1,5,a_L2);
...
static void a_1629(a_word a_F1){ /* defineiceitems+>a */
a_word a_P[1];
a_G1:if(a_equal(a_F1,0)){ return;}
a_1643(a_F1);
a_1735(a_F1,a_P);a_F1=a_P[0]; goto a_G1;
} /* defineiceitems */
static a_word a_1646(a_word a_F1){ /* isitemtag+>a */
a_word a_L2;a_word a_P[1];
...
static void a_1643(a_word a_F1){ /* handletag+>a */
...
static void a_1658(a_word a_F1){ /* traversestdstringpointers+>a */
a_word a_P[1];
a_G1:if(a_equal(a_F1,0)){ return;}
a_incr(a_1650);
a_1755(a_F1,a_1650);
...
a_1248(a_1001,2130706199); return;
} /* pass3 */
static void a_1634(void){ /* externaldeclarer */
a_word a_L1;a_word a_L2;a_word a_P[1];
a_1200(a_P);a_L1=a_P[0];
...
static void a_1640(a_word a_F1){ /* filleritem+>a */
a_word a_L2;a_word a_P[1];
...
static void a_1630(a_word a_F1){ /* emitfill+>a */
...
static void a_1638(a_word a_F1){ /* fillerblock1+>a */
...
a_P[0]=2130705714;a_P[1]=a_F1;a_P[2]=a_L5;a_P[3]=a_L4;a_1240(6,-1,4,a_P); goto a_G21;
a_G18:if(!a_more(a_L6,0)){ goto a_G20;}
a_subtr(a_L4,a_L5,a_L8); goto a_G21;
a_G20:a_P[0]=2130705730;a_P[1]=a_F1;a_P[2]=a_L5;a_P[3]=a_L4;a_1240(4,-1,4,a_P);
a_G21:a_L5=1;
a_L3=a_L2;
a_G23:a_incr(a_L3);
...
static void a_1657(a_word a_F1,a_word a_F3,a_word a_A[1]){ /* toselectors+>a+>a>+>a */
a_word a_L4;a_word a_L5;a_word a_L6;a_word a_P[3];
a_G1:if(!a_1164(1696719031)){ return;}
if(!a_1164(1696719024)){ goto a_G4;}
...
a_G10:a_P[0]=2130705682;a_P[1]=a_F1;a_P[2]=a_L4;a_1238(-1,3,a_P); goto a_G1;
a_G11:a_P[0]=2130705672;a_P[1]=a_F1;a_P[2]=a_L4;a_1238(-1,3,a_P); goto a_G1;
} /* toselectors */
static void a_1639(a_word a_F1){ /* fillerblock2+>a */
a_word a_L2;a_word a_L3;a_word a_L4;a_word a_L5;a_word a_L6;a_word a_L7;a_word a_L8;a_word a_P[4];
a_L2=to_LIST(a_1150)->aupb;
a_1677(a_F1,a_P);a_L4=a_P[0];
a_L5=0;
...
a_P[0]=2130705692;a_P[1]=a_F1;a_1238(-1,2,a_P); goto a_G15;
a_G26:if(a_equal(a_L7,0)){ goto a_G30;}
if(a_1275(a_L8)){ goto a_G30;}
a_subtr(a_L4,a_L7,a_L7);
a_P[0]=2130705730;a_P[1]=a_F1;a_P[2]=a_L7;a_P[3]=a_L4;a_1240(4,-1,4,a_P);
...
a_G6:a_P[0]=2130705698;a_P[1]=16777257;a_P[2]=a_L1;a_1240(3,-1,3,a_P); goto a_G1;
} /* initializer */
static void a_1633(a_word a_F1){ /* extendBUFFER+>a */
...
a_1248(a_1001,2130706209); return;
} /* pass4 */
static void a_1665(void){ /* pragmat */
a_word a_L1;a_word a_P[1];
a_1197(a_P);
...
static a_word a_1676(a_word a_F1,a_word a_F2,a_word a_A[1]){ /* findtempselector+>a+>a+a> */
a_word a_L4;
...
static a_word a_1673(a_word a_F1,a_word a_F2,a_word a_F3){ /* entertempselector+>a+>a+>a */
a_word a_L4;a_word a_P[1];
if(!a_1676(a_F1,a_F2,a_P)){ goto a_G3;}a_L4=a_P[0];
if(!a_equal(a_L4,a_F3)){ return 0;} return 1;
a_G3:{register a_word *a_r1=a_extension(a_1668,3);a_r1[0]=a_F2;a_r1[1]=a_F1;a_r1[2]=a_F3;to_LIST(a_1668)->aupb+=3;}
  return 1;
} /* entertempselector */
static void a_1672(a_word a_F1,a_word a_F2){ /* dumptempselectors+>a+>a */
a_word a_L3;
a_1158(a_F1);
a_1158(a_F2);
...
static void a_1678(a_word a_F1,a_word a_A[1]){ /* getselectornext+>a+a> */

a_A[0]=to_LIST(a_1718)->offset[a_F1]; return;
} /* getselectornext */
static void a_1679(a_word a_F1,a_word a_A[1]){ /* getselectoroffs+>a+a> */

a_A[0]=to_LIST(a_1718)->offset[a_F1-2]; return;
} /* getselectoroffs */
static void a_1677(a_word a_F1,a_word a_A[1]){ /* getcalibre+>a+a> */

a_A[0]=to_LIST(a_1718)->offset[to_LIST(a_1718)->offset[a_F1-1]-3]; return;
} /* getcalibre */
static void a_1680(a_word a_F1,a_word a_A[1]){ /* getssel+>a+a> */

a_A[0]=to_LIST(a_1718)->offset[to_LIST(a_1718)->offset[a_F1-1]-2]; return;
} /* getssel */
static void a_1671(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_A[1]){ /* createselectorblock+>a+>a+>a+a> */

{register a_word *a_r1=a_extension(a_1718,4);a_r1[0]=a_F3;a_r1[3]=0;a_r1[2]=a_F1;a_r1[1]=a_F2;to_LIST(a_1718)->aupb+=4;}
a_A[0]=to_LIST(a_1718)->aupb; return;
} /* createselectorblock */
static a_word a_1675(a_word a_F1,a_word a_F2,a_word a_A[1]){ /* findpermselector+>a+>a+a> */
a_word a_P[1];
...
static void a_1670(a_word a_F1,a_word a_F2,a_word a_F3){ /* createlistextension+>a+>a+>a */
a_word a_L4;a_word a_P[1];
a_1671(0,a_F3,a_F2,a_P);a_L4=a_P[0];
a_1753(a_F1,a_L4); return;
} /* createlistextension */
static a_word a_1674(a_word a_F1,a_word a_F2,a_word a_A[1]){ /* findlistselector+>a+>a+a> */
a_word a_L4;a_word a_P[1];
a_1729(a_F1,a_P);a_L4=a_P[0];
if(!a_1675(a_F2,a_L4,a_P)){ return 0;}a_L4=a_P[0];
a_1679(a_L4,a_P);a_A[0]=a_P[0]; return 1;
} /* findlistselector */
static void a_1669(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4){ /* addlistselector+>a+>a+>a+>a */
...
a_P[0]=2130705744;a_P[1]=a_L7;a_P[2]=a_F1;a_P[3]=a_F2;a_P[4]=to_LIST(a_1718)->offset[a_L6-3];a_1238(-1,5,a_P); return;
...
a_1248(a_1001,2130706231); return;
a_G3:a_1705=a_1706;
a_1703=a_1692;
a_1704=a_1699;
a_1688=1; return;
...
a_P[0]=2130705786;a_P[1]=500;a_1238(-1,2,a_P);
a_1184();
a_exit(3); return;
a_G7:a_1706=a_1705;
a_1692=a_1703;
...
a_1248(a_1001,2130706221); return;
a_G4:a_incr(a_1708);
...
a_1248(a_1001,2130706215); return 1;
} /* readfromrestore */
static void a_1687(a_word a_A[1]){ /* countrestore+>a> */
...
static void a_1684(a_word a_F1){ /* Rskip+>a */

if(!a_equal(a_F1,a_1692)){ return;}
a_1702(); return;
} /* Rskip */
static void a_1701(a_word a_F1){ /* must+>a */
a_word a_P[2];
if(!a_equal(a_F1,a_1692)){ goto a_G3;}
a_1702(); return;
a_G3:a_P[0]=2130705752;a_P[1]=a_F1;a_1238(-1,2,a_P); return;
} /* must */
static a_word a_1696(a_word a_A[1]){ /* israwttag+a> */

if(!a_was(a_1720,a_1692)){ return 0;}
a_A[0]=a_1692;
a_1702(); return 1;
} /* israwttag */
static a_word a_1698(a_word a_A[1]){ /* isttag+a> */
...
static a_word a_1695(a_word a_A[2]){ /* isqtag+a>+a> */
a_word a_L3;a_word a_P[1];
if(!a_was(a_1720,a_1692)){ return 0;}
a_A[1]=a_1692;
a_L3=a_1699;
...
a_P[0]=2130705760;a_1238(-1,1,a_P); return 1;
a_G10:a_A[0]=0;
if(!a_equal(a_1693,a_1706)){ return 1;}
a_1219(a_A[1],a_L3); return 1;
} /* isqtag */
static a_word a_1694(a_word a_A[2]){ /* isnumber+a>+a> */
a_word a_P[1];
...
static a_word a_1697(a_word a_A[1]){ /* isstring+a> */
...
static void a_1690(a_word a_A[1]){ /* getlinenum+a> */

a_A[0]=a_1699; return;
} /* getlinenum */
static void a_1710(a_word a_F1){ /* setlinenum+>a */
...
static void a_1727(a_word a_F1,a_word a_A[1]){ /* entertag+>a+a> */
a_word a_L3;a_word a_P[1];
...
{register a_word *a_r1=a_extension(a_1720,5);a_r1[3]=-1;a_r1[0]=a_r1[1]=a_r1[2]=a_r1[4]=0;to_LIST(a_1720)->aupb+=5;}
a_G12:a_A[0]=to_LIST(a_1720)->aupb; return;
a_G13:a_L3=to_LIST(a_1720)->offset[a_A[0]-3];
if(a_more(a_L3,0)){ goto a_G3;}
to_LIST(a_1720)->offset[a_A[0]-3]=to_LIST(a_1720)->aupb;
{register a_word *a_r1=a_extension(a_1720,5);a_r1[3]=-1;a_r1[0]=a_r1[1]=a_r1[2]=a_r1[4]=0;to_LIST(a_1720)->aupb+=5;}
  goto a_G12;
} /* entertag */
static void a_1740(a_word a_A[1]){ /* getttaghead+a> */

a_A[0]=604757249; return;
} /* getttaghead */
static void a_1724(a_word a_F1,a_word a_F2){ /* createlocalaffix+>a+>a */

{register a_word *a_r1=a_extension(a_1719,6);a_r1[3]=a_F1;a_r1[5]=a_F2;a_r1[0]=a_r1[1]=a_r1[2]=a_r1[4]=0;to_LIST(a_1719)->aupb+=6;}
  return;
} /* createlocalaffix */
static a_word a_1759(a_word a_F1){ /* wastagpointer+>a */
...
static void a_1739(a_word a_F1,a_word a_A[1]){ /* getttag+>a+a> */

a_A[0]=to_LIST(a_1718)->offset[a_F1]; return;
} /* getttag */
static void a_1736(a_word a_F1,a_word a_A[1]){ /* getrepr+>a+a> */

a_A[0]=to_LIST(a_1718)->offset[a_F1-2]; return;
} /* getrepr */
static void a_1729(a_word a_F1,a_word a_A[1]){ /* getadm+>a+a> */

a_A[0]=to_LIST(a_1718)->offset[a_F1-1]; return;
} /* getadm */
static void a_1735(a_word a_F1,a_word a_A[1]){ /* getnexttag+>a+a> */

a_A[0]=to_LIST(a_1718)->offset[a_F1-7]; return;
} /* getnexttag */
static void a_1741(a_word a_F1,a_word a_A[1]){ /* gettype+>a+a> */
...
static void a_1730(a_word a_F1,a_word a_A[1]){ /* getdefline+>a+a> */

a_A[0]=to_LIST(a_1718)->offset[a_F1-5]; return;
} /* getdefline */
static void a_1755(a_word a_F1,a_word a_F2){ /* putrepr+>a+>a */

to_LIST(a_1718)->offset[a_F1-2]=a_F2; return;
} /* putrepr */
static void a_1753(a_word a_F1,a_word a_F2){ /* putadm+>a+>a */

to_LIST(a_1718)->offset[a_F1-1]=a_F2; return;
} /* putadm */
static void a_1754(a_word a_F1,a_word a_F2){ /* putdefline+>a+>a */

to_LIST(a_1718)->offset[a_F1-5]=a_F2; return;
} /* putdefline */
static void a_1757(a_word a_F1,a_word a_F2){ /* settagflag+>a+>a */

a_boolor(to_LIST(a_1718)->offset[a_F1-4],a_F2,to_LIST(a_1718)->offset[a_F1-4]); return;
} /* settagflag */
static a_word a_1746(a_word a_F1,a_word a_F2){ /* istagflag+>a+>a */
a_word a_L3;
a_booland(to_LIST(a_1718)->offset[a_F1-4],a_F2,a_L3);
if(!a_noteq(a_L3,0)){ return 0;} return 1;
} /* istagflag */
static void a_1738(a_word a_F1,a_word a_F2,a_word a_A[1]){ /* gettagflag+>a+>a+a> */

a_booland(to_LIST(a_1718)->offset[a_F1-4],a_F2,a_A[0]); return;
} /* gettagflag */
static void a_1722(a_word a_F1,a_word a_F2){ /* cleartagflag+>a+>a */
a_word a_L3;
a_boolinvert(a_F2,a_L3);
a_booland(to_LIST(a_1718)->offset[a_F1-4],a_L3,to_LIST(a_1718)->offset[a_F1-4]); return;
} /* cleartagflag */
static void a_1758(a_word a_F1){ /* usetag+>a */
...
static void a_1752(a_word a_F1){ /* pushAFFS+>a */

{register a_word *a_r1=a_extension(a_1718,1);a_r1[0]=a_F1;to_LIST(a_1718)->aupb+=1;}
  return;
} /* pushAFFS */
static a_word a_1723(a_word a_F1,a_word a_F2){ /* compareAFFS+>a+>a */
a_word a_L3;
...
static void a_1743(a_word a_F2,a_word a_A[1]){ /* inserttoAFFS+>a>+>a */
a_word a_L3;
a_L3=16777872;
...
static void a_1725(a_word a_A[1]){ /* enterformalaffixes+a> */
a_word a_L2;a_word a_L3;a_word a_P[1];
a_L2=to_LIST(a_1718)->aupb;
{register a_word *a_r1=a_extension(a_1718,3);a_r1[1]=a_r1[0]=a_r1[2]=0;to_LIST(a_1718)->aupb+=3;}
a_A[0]=to_LIST(a_1718)->aupb;
a_L3=to_LIST(a_1719)->alwb;
a_G5:if(a_more(a_L3,to_LIST(a_1719)->aupb)){ goto a_G10;}
{register a_word a_r1=to_LIST(a_1719)->offset[a_L3-2];
...
static void a_1731(a_word a_F1,a_word a_A[1]){ /* getformalaffixno+>a+a> */
a_word a_L3;a_word a_P[1];
a_1729(a_F1,a_P);a_L3=a_P[0];
a_A[0]=to_LIST(a_1718)->offset[a_L3-2]; return;
} /* getformalaffixno */
static void a_1733(a_word a_F1,a_word a_F2,a_word a_A[1]){ /* getformaltype+>a+>a+a> */
a_word a_L4;a_word a_P[1];
a_1729(a_F1,a_P);a_L4=a_P[0];
a_add(a_L4,a_F2,a_L4);
a_A[0]=to_LIST(a_1718)->offset[a_L4]; return;
} /* getformaltype */
static void a_1732(a_word a_F1,a_word a_F2,a_word a_A[2]){ /* getformallistext+>a+>a+a>+a> */
a_word a_L5;a_word a_L6;a_word a_P[1];
a_1729(a_F1,a_P);a_L5=a_P[0];
a_add(a_L5,to_LIST(a_1718)->offset[a_L5-2],a_L6);
a_G3:a_incr(a_L5);
if(a_equal(to_LIST(a_1718)->offset[a_L5],16777283)){ goto a_G6;}
if(!a_equal(to_LIST(a_1718)->offset[a_L5],16777277)){ goto a_G11;}
a_G6:a_decr(a_F2);
...
static void a_1726(a_word a_F1){ /* enterpredefinedtag+>a */
a_word a_L2;a_word a_L3;a_word a_L4;a_word a_P[2];
...
a_next(a_1720,a_F1);
a_P[0]=2130705799;a_P[1]=a_F1;a_1238(0,2,a_P);
a_1248(a_1001,2130706244); return;
...
static a_word a_1745(a_word a_F1,a_word a_A[1]){ /* isstdstringstored+>a+a> */
a_word a_L3;a_word a_P[1];
...
static void a_1750(a_word a_F1,a_word a_F2,a_word a_A[1]){ /* newstdstring+>a+>a+a> */
a_word a_P[1];
...
static void a_1737(a_word a_A[1]){ /* getstdstringhead+a> */

a_A[0]=to_LIST(a_1720)->offset[604757376-2]; return;
} /* getstdstringhead */
static void a_1721(a_word a_F1,a_word a_F2){ /* addpragmatmatter+>a+>a */

{register a_word *a_r1=a_extension(a_1718,3);a_r1[1]=a_F1;a_r1[0]=a_F2;a_r1[2]=a_1749;to_LIST(a_1718)->aupb+=3;}
a_1749=to_LIST(a_1718)->aupb; return;
} /* addpragmatmatter */
static a_word a_1734(a_word a_A[3]){ /* getnextmatter+>a>+a>+a> */
...
static a_word a_1744(a_word a_F1,a_word a_A[1]){ /* isspecialrule+>a+a> */
...
static void a_1747(a_word a_F1,a_word a_F2,a_word a_F3){ /* linkmacrorule+>a+>a+>a */

{register a_word *a_r1=a_extension(a_1718,4);a_r1[1]=a_F3;a_r1[0]=a_F2;a_r1[3]=a_F1;a_r1[2]=a_1748;to_LIST(a_1718)->aupb+=4;}
a_1748=to_LIST(a_1718)->aupb; return;
} /* linkmacrorule */
static void a_1756(a_word a_F1,a_word a_A[2]){ /* searchmacrorule+>a+a>+a> */
a_word a_L4;a_word a_P[1];
a_L4=a_1748;
a_G2:if(!a_equal(a_L4,0)){ goto a_G4;}
a_1248(a_1001,2130706237); return;
...
static a_word a_1751(a_word a_A[1]){ /* nextmacrorule+>a> */
a_word a_L2;a_word a_P[1];
a_L2=a_1748;
...
static void a_1728(a_word a_F1){ /* extendBUFFER+>a */

{register a_word *a_r1=a_extension(a_1150,1);a_r1[0]=a_F1;to_LIST(a_1150)->aupb+=1;}
  return;
} /* extendBUFFER */
static a_word a_1762(a_word a_F1){ /* wastypepointer+>a */

if(!a_was(a_1761,a_F1)){ return 0;}
a_copystring(a_1761,a_F1,a_1150); return 1;
} /* wastypepointer */
static a_word a_1772(a_word a_A[1]){ /* isexpression+>a> */
a_word a_P[1];
...
if(!a_equal(1164737755,a_1692)){ goto a_G26;}
a_1702();
a_1154(1696719024); goto a_G4;
a_G26:if(!a_equal(1164737788,a_1692)){ return 1;}
a_1702();
a_1154(1696718895); goto a_G4;
} /* isexpression */
static void a_1769(a_word a_A[1]){ /* expectlisttag+>a> */
a_word a_L2;a_word a_L3;a_word a_P[3];
if(!a_1695(a_P)){ goto a_G3;}a_L2=a_P[0];a_L3=a_P[1];
a_1160(a_L2,a_L3); return;
a_G3:a_A[0]=1;
a_P[0]=2130705810;a_P[1]=a_1775;a_P[2]=a_1774;a_1238(-1,3,a_P); return;
} /* expectlisttag */
static a_word a_1770(a_word a_A[1]){ /* exprbase+>a> */
a_word a_L2;a_word a_L3;a_word a_P[3];
if(!a_1694(a_P)){ goto a_G3;}a_L3=a_P[0];
...
if(a_is(a_A[0])){ return 1;}
a_A[0]=1;
a_P[0]=2130705819;a_P[1]=a_1775;a_P[2]=a_1774;a_1238(-1,3,a_P); return 1;
a_G12:if(!a_equal(1164737728,a_1692)){ goto a_G16;}
a_1702();
a_G14:a_1154(1696718957);
a_G15:a_P[0]=a_A[0];a_1769(a_P);a_A[0]=a_P[0]; return 1;
a_G16:if(!a_equal(1164737731,a_1692)){ goto a_G20;}
a_1702();
a_G18:a_1154(1696719035); goto a_G15;
a_G20:if(!a_equal(1164737734,a_1692)){ goto a_G25;}
a_1702();
a_P[0]=2130705860;a_P[1]=a_1775;a_P[2]=a_1774;a_1240(1,-1,3,a_P); goto a_G14;
a_G25:if(!a_equal(1164737737,a_1692)){ goto a_G30;}
a_1702();
a_P[0]=2130705860;a_P[1]=a_1775;a_P[2]=a_1774;a_1240(1,-1,3,a_P); goto a_G18;
a_G30:if(!a_equal(1164737752,a_1692)){ goto a_G34;}
a_1702();
a_1154(1696718876); goto a_G15;
a_G34:if(!a_equal(1164737758,a_1692)){ return 0;}
a_1702();
a_1154(1696718979);
a_P[0]=a_A[0];if(a_1772(a_P)){a_A[0]=a_P[0]; goto a_G41;}
if(a_is(a_A[0])){ goto a_G41;}
a_A[0]=1;
a_P[0]=2130705819;a_P[1]=a_1775;a_P[2]=a_1774;a_1238(-1,3,a_P);
...
static void a_1767(a_word a_F1){ /* declarer+>a */
a_word a_L2;a_word a_P[1];
...
static void a_1771(a_word a_F1){ /* externaldeclarer+>a */
a_word a_L2;a_word a_L3;a_word a_P[3];
a_1300(a_1773,a_1774,a_1775,a_F1,a_P);a_L2=a_P[0];
a_1757(a_L2,2);
a_1757(a_L2,16);
...
a_L3=0;
a_P[0]=2130705836;a_P[1]=a_1775;a_P[2]=a_1774;a_1238(-1,3,a_P);
a_G8:a_1154(1696718920);
a_1162(a_L2);
a_1161(a_L3);
a_1154(1696718991); return;
} /* externaldeclarer */
static void a_1776(a_word a_F1){ /* prototype+>a */
a_word a_L2;a_word a_L3;a_word a_P[1];
a_1481(22019,a_P);a_L2=a_P[0];
if(!a_equal(a_L2,1)){ goto a_G10;}
...
static void a_1765(a_word a_A[1]){ /* declaration+>a> */
a_word a_L2;a_word a_P[2];
if(!a_1695(a_P)){ goto a_G20;}a_1773=a_P[0];a_1774=a_P[1];
a_1690(a_P);a_L2=a_P[0];
if(!a_equal(1164737725,a_1692)){ goto a_G12;}
a_1702();
if(!a_equal(a_A[0],3)){ goto a_G8;}
a_G6:a_P[0]=2130705847;a_P[1]=a_1775;a_1238(-1,2,a_P);
a_1712(); return;
a_G8:if(!a_equal(a_A[0],1)){ goto a_G10;}
...
a_A[0]=3;
a_1776(a_L2); return;
a_G20:a_P[0]=2130705826;a_P[1]=a_1775;a_1238(-1,2,a_P);
a_1712(); return;
} /* declaration */
static void a_1766(a_word a_F1){ /* declarationseries+>a */
a_word a_P[1];
...
static void a_1764(a_word a_F1){ /* constantdeclaration+>a */

a_1775=16777226;
a_1766(a_F1); return;
} /* constantdeclaration */
static void a_1778(a_word a_F1){ /* variabledeclaration+>a */
...
static void a_1847(a_word a_F1,a_word a_F2){ /* pushRULE+>a+>a */

a_next(a_1151,a_1796);
if(!a_equal(a_1803,3)){ return;}
a_1819(a_F1,a_F2); return;
} /* pushRULE */
static void a_1854(a_word a_F1){ /* setupformalstack+>a */
a_word a_L2;a_word a_L3;a_word a_L4;a_word a_L5;a_word a_L6;a_word a_P[2];
a_scratch(a_1719);
...
static void a_1855(a_word a_A[1]){ /* setuplabel+a> */
a_word a_P[1];
if(!a_1164(1696718945)){ goto a_G5;}
a_1201(a_P);a_A[0]=a_P[0];
a_1724(16777335,a_A[0]);
...
static void a_1857(a_word a_F1,a_word a_A[1]){ /* startrange+>a+a> */
a_word a_L3;a_word a_L4;
a_1847(1048577,0);
a_A[0]=a_1796;
if(!a_is(a_F1)){ goto a_G5;}
...
static void a_1806(a_word a_F1){ /* closerange+>a */

a_1847(1048578,a_F1); return;
} /* closerange */
static void a_1859(a_word a_F1,a_word a_A[1]){ /* utypetoslice+>a+a> */

a_boolor(a_F1,16,a_A[0]); return;
} /* utypetoslice */
static a_word a_1839(a_word a_F1){ /* inutype+>a */
a_word a_L2;
a_booland(a_F1,1,a_L2);
if(!a_noteq(a_L2,0)){ return 0;} return 1;
} /* inutype */
static a_word a_1845(a_word a_F1){ /* oututype+>a */
a_word a_L2;
a_booland(a_F1,2,a_L2);
if(!a_noteq(a_L2,0)){ return 0;} return 1;
} /* oututype */
static void a_1817(a_word a_F1){ /* expandmacro+>a */
...
static void a_1846(a_word a_C,a_word *a_V){ /* pushBUFFER+@+>a */

a_G1:a_1818(a_V[0]);
if(a_C>1){a_C--;a_V+=1; goto a_G1;}  return;
} /* pushBUFFER */
static void a_1811(a_word a_F1,a_word a_A[1]){ /* correctselector+>a+>a> */
a_word a_L3;a_word a_P[1];
if(!a_was(a_1718,a_F1)){ goto a_G3;}
...
static void a_1824(a_word a_A[1]){ /* garea+a> */
a_word a_L2;a_word a_P[2];
...
static void a_1829(a_word a_F1,a_word a_F2){ /* ghandleaffix+>a+>a */
...
static void a_1831(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4){ /* ghandlevarargblock+>a+>a+>a+>a */
a_word a_L5;a_word a_P[1];
...
static void a_1830(a_word a_F1){ /* ghandleshiftrule+>a */
...
static void a_1837(a_word a_F1,a_word a_A[1]){ /* gsimpleaffix+>a+a> */
a_word a_L3;a_word a_L4;a_word a_P[1];
a_A[0]=0;
if(a_1172(a_P)){ return;}
if(!a_1832()){ goto a_G5;}
...
static void a_1833(a_word a_F1,a_word a_A[1]){ /* gmatchformalactual+>a+a> */
a_word a_L3;a_word a_L4;a_word a_P[1];
{ if(a_F1==16777288||a_F1==16777283||a_F1==16777277){ goto a_G2;}
...
a_G11:a_1248(a_1001,2130706306); return;
} /* gmatchformalactual */
static void a_1821(a_word a_F1){ /* gactualrule+>a */
...
static void a_1851(a_word a_F1,a_word a_F2,a_word a_F3){ /* setRULEflag+>a+>a+>a */

a_addmult(a_F2,2,a_F1,a_F1);
a_boolor(to_LIST(a_1151)->offset[a_F1-1],a_F3,to_LIST(a_1151)->offset[a_F1-1]); return;
} /* setRULEflag */
static void a_1805(a_word a_F1,a_word a_F2,a_word a_F3){ /* clearRULEflag+>a+>a+>a */

a_addmult(a_F2,2,a_F1,a_F1);
a_boolinvert(a_F3,a_F3);
a_booland(to_LIST(a_1151)->offset[a_F1-1],a_F3,to_LIST(a_1151)->offset[a_F1-1]); return;
} /* clearRULEflag */
static void a_1808(a_word a_F1,a_word a_F2,a_word a_F3){ /* copyUf1toUf2+>a+>a+>a */
a_word a_L4;a_word a_L5;
a_L4=1;
...
static void a_1842(a_word a_F1,a_word a_F2,a_word a_F3){ /* mergeUf1toUf2+>a+>a+>a */
a_word a_L4;a_word a_L5;
a_L4=1;
a_G2:a_addmult(a_L4,2,a_F1,a_L5);
a_booland(to_LIST(a_1151)->offset[a_L5-1],1048576,a_L5);
...
static void a_1809(a_word a_F1,a_word a_F2){ /* copyjumpUf+>a+>a */
a_word a_L3;a_word a_L4;
a_L3=1;
...
static void a_1852(a_word a_F1,a_word a_F2,a_word a_F3){ /* setflagsforregion+>a+>a+>a */
a_word a_L4;a_word a_L5;
a_L4=1;
a_G2:a_addmult(a_L4,2,a_F1,a_L5);
a_booland(to_LIST(a_1151)->offset[a_L5-1],1048576,a_L5);
...
static void a_1848(a_word a_F1,a_word a_F2){ /* recoverflagsfromregion+>a+>a */
a_word a_L3;a_word a_L4;
a_L3=1;
a_G2:a_addmult(a_L3,2,a_F1,a_L4);
a_booland(to_LIST(a_1151)->offset[a_L4-1],1048576,a_L4);
...
static void a_1853(a_word a_F1){ /* setflagsforrule+>a */
...
static a_word a_1781(a_word a_F1,a_word a_A[1]){ /* Bdata+>a+a> */
...
static void a_1784(a_word a_F1){ /* Bsetflag+>a */
a_word a_L2;
a_L2=a_1801;
a_next(a_1151,a_L2);
to_LIST(a_1151)->offset[a_L2-1]=a_F1; return;
} /* Bsetflag */
static void a_1783(a_word a_F1){ /* Bsetdata+>a */
a_word a_L2;
a_L2=a_1801;
a_next(a_1151,a_L2);
...
static void a_1782(a_word a_A[1]){ /* Bgetptr+a> */

a_A[0]=a_1801;
a_next(a_1151,a_A[0]); return;
} /* Bgetptr */
static void a_1802(a_word a_F1){ /* Uregion+>a */
...
static a_word a_1797(a_word a_F1,a_word a_F2){ /* Uactualrule+>a+>a */
a_word a_L3;a_word a_L4;a_word a_P[1];
...
a_G14:if(!a_1781(1048595,a_P)){ goto a_G20;}a_L3=a_P[0];
a_addmult(a_L3,2,a_F1,a_L4);
a_booland(to_LIST(a_1151)->offset[a_L4-1],8,a_L4);
if(!a_noteq(a_L4,0)){ goto a_G13;}
a_1784(1048594); goto a_G13;
a_G20:if(a_equal(to_LIST(a_1151)->offset[a_1801-1],1048576)){ goto a_G2;}
if(!a_equal(to_LIST(a_1151)->offset[a_1801-1],1048582)){ goto a_G25;}
a_previous(a_1151,a_1801);
a_1842(a_F1,a_F2,8); goto a_G6;
a_G25:if(!a_equal(to_LIST(a_1151)->offset[a_1801-1],1048580)){ goto a_G27;}
a_previous(a_1151,a_1801); return 1;
a_G27:a_1248(a_1001,2130706295); return 1;
} /* Uactualrule */
static a_word a_1800(a_word a_F1,a_word a_F2){ /* Umember+>a+>a */
a_word a_L3;a_word a_P[1];
...
if(!a_equal(to_LIST(a_1151)->offset[a_1801-1],1048580)){ goto a_G28;}
a_previous(a_1151,a_1801);
a_1782(a_P);a_A[0]=a_P[0]; goto a_G3;
a_G28:if(a_1781(1048586,a_P)){a_A[0]=a_P[0]; goto a_G3;}
if(!a_equal(to_LIST(a_1151)->offset[a_1801-1],1048578)){ goto a_G32;}
a_previous(a_1151,a_1801);
a_1793(a_A[0],a_L5,a_P);a_A[0]=a_P[0]; goto a_G3;
a_G32:if(!a_equal(to_LIST(a_1151)->offset[a_1801-1],1048577)){ goto a_G35;}
a_previous(a_1151,a_1801);
a_1783(a_A[0]); return;
a_G35:a_1780(); goto a_G3;
} /* Lscani */
static void a_1795(a_word a_F1){ /* Lunroll+>a */
a_word a_L2;
a_L2=to_LIST(a_1151)->offset[a_F1];
if(a_equal(a_L2,-1)){ return;}
if(a_equal(a_L2,-2)){ return;}
if(!a_equal(a_L2,0)){ goto a_G6;}
a_1248(a_1001,2130706278); return;
...
a_G4:a_1248(a_1001,2130706274); return;
a_G5:a_1793(-1,-2,a_P);
a_1794(); return;
} /* Lfindlabels */
static void a_1841(a_word a_F1,a_word a_F2){ /* mergeDUflags+>a+>a */
a_word a_L3;a_word a_L4;
a_L3=1;
a_G2:a_addmult(a_L3,2,a_F1,a_L4);
a_booland(to_LIST(a_1151)->offset[a_L4-1],1048576,a_L4);
...
static a_word a_1791(a_word a_F1){ /* DUrule+>a */
a_word a_L2;a_word a_P[1];
if(!a_equal(to_LIST(a_1151)->offset[a_1801-1],1048581)){ goto a_G3;}
a_G2:a_previous(a_1151,a_1801); goto a_G5;
a_G3:if(!a_equal(to_LIST(a_1151)->offset[a_1801-1],1048583)){ return 0;} goto a_G2;
a_G5:if(!a_1781(1048593,a_P)){ goto a_G7;}a_L2=a_P[0];
a_1851(a_F1,a_L2,256); goto a_G5;
a_G7:if(!a_1781(1048594,a_P)){ goto a_G9;}a_L2=a_P[0];
a_1851(a_F1,a_L2,512); goto a_G5;
a_G9:if(a_equal(to_LIST(a_1151)->offset[a_1801-1],1048595)){ goto a_G2;}
...
static a_word a_1789(a_word a_F1){ /* DUmember+>a */
a_word a_L2;a_word a_P[1];
...
static void a_1788(a_word a_F1){ /* DUalternative+>a */
...
static void a_1790(a_word a_F1){ /* DUregion+>a */
...
a_1248(a_1001,2130706269); return;
a_G4:a_1790(a_L1); return;
} /* computeDUflags */
static void a_1813(a_word a_F1,a_word a_F2,a_word a_F3){ /* diagnoselocal+>a+>a+>a */
a_word a_L4;a_word a_P[3];
...
a_booland(to_LIST(a_1151)->offset[a_L4-1],512,a_L4);
if(!a_noteq(a_L4,0)){ return;}
a_P[0]=2130705873;a_P[1]=a_1850;a_P[2]=to_LIST(a_1719)->offset[a_F3];a_1240(4,-1,3,a_P); return;
} /* diagnoselocal */
static void a_1814(a_word a_F1,a_word a_F2){ /* diagnoseoutaffix+>a+>a */
a_word a_P[3];
if(a_noteq(a_1803,1)){ return;}
if(a_noteq(to_LIST(a_1151)->offset[a_1796-1],1048595)){ return;}
if(!a_equal(a_F1,2311427)){ goto a_G5;}
a_P[0]=2130705884;a_P[1]=a_1850;a_P[2]=to_LIST(a_1719)->offset[a_F2];a_1240(1,-1,3,a_P); return;
a_G5:a_P[0]=2130705884;a_P[1]=a_1850;a_P[2]=to_LIST(a_1719)->offset[a_F2];a_1240(4,-1,3,a_P); return;
} /* diagnoseoutaffix */
static void a_1812(void){ /* diagnoseformals */
a_word a_L1;a_word a_L2;a_word a_L3;a_word a_L4;a_word a_P[3];
...
{register a_word a_r1=to_LIST(a_1719)->offset[a_L1-2];
...
a_booland(to_LIST(a_1151)->offset[a_L4-1],512,a_L4);
if(!a_noteq(a_L4,0)){ goto a_G13;}
a_G12:a_P[0]=2130705899;a_P[1]=a_1850;a_P[2]=to_LIST(a_1719)->offset[a_L1];a_1240(4,-1,3,a_P);
...
a_P[0]=2130705914;a_P[1]=a_1850;a_P[2]=to_LIST(a_1719)->offset[a_L1];a_1240(4,-1,3,a_P); goto a_G13;
a_G24:a_next(a_1719,a_L1); goto a_G4;
} /* diagnoseformals */
static void a_1815(a_word a_F1){ /* diagnoserule+>a */
a_word a_L2;a_word a_L3;a_word a_L4;a_word a_P[2];
a_1211(a_P);a_L2=a_P[0];a_L3=a_P[1];
a_1816=0;
a_1803=3;
a_scratch(a_1151);
a_scratch(a_1150);
{register a_word a_r1=to_LIST(a_1151)->aupb;a_L4=a_r1;a_1796=a_r1;}
a_1854(a_F1);
a_1836();
a_1196(1696718991);
a_1858(a_F1);
...
static void a_1874(a_word a_F1){ /* wlabel+>a */
a_word a_L2;
a_1087(1696718985);
if(!a_equal(a_F1,0)){ goto a_G4;}
...
static void a_1881(a_word a_F1,a_word a_A[1]){ /* wtransportlist+>a+a> */
a_word a_L3;a_word a_P[2];
a_A[0]=0;
...
a_1248(a_1001,2130706263); return;
...
static a_word a_1875(a_word a_A[1]){ /* wlimit+a> */
...
static void a_1820(a_word a_F1,a_word a_F2,a_word a_A[1]){ /* finalssel+>a+>a+a> */
a_word a_P[1];
if(!a_is(a_F2)){ goto a_G3;}
a_A[0]=to_LIST(a_1719)->offset[a_F2-4]; return;
a_G3:if(!a_was(a_1719,a_F1)){ goto a_G5;}
...
static void a_1873(a_word a_F1){ /* whandleaffix+>a */
a_word a_P[1];
...
static void a_1868(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4){ /* wbeforevarargblock+>a+>a+>a+>a */
a_word a_L5;a_word a_P[1];
a_G1:a_next(a_1719,a_F1);
a_1733(a_F2,a_F4,a_P);a_L5=a_P[0];
a_incr(a_F4);
...
static void a_1867(a_word a_F1){ /* wbeforeshiftrule+>a */
...
static void a_1863(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4){ /* waftervarargblock+>a+>a+>a+>a */
a_word a_L5;a_word a_P[1];
a_G1:a_next(a_1719,a_F1);
a_1733(a_F2,a_F4,a_P);a_L5=a_P[0];
a_incr(a_F4);
...
static void a_1862(a_word a_F1){ /* waftershiftrule+>a */
...
static void a_1880(a_word a_F1,a_word a_A[1]){ /* wsimpleaffix+>a+a> */
...
a_1200(a_P);a_L3=a_P[0];
if(!a_was(a_1718,a_L3)){ goto a_G10;}
a_1677(a_L3,a_P);a_L6=a_P[0];
a_1117(a_L6,a_P);a_L6=a_P[0]; goto a_G3;
a_G10:a_P[0]=1696718876;a_P[1]=a_L3;a_1846(2,a_P); return;
a_G11:if(!a_1875(a_P)){ goto a_G14;}a_L6=a_P[0];
a_1200(a_P);a_L3=a_P[0];
...
a_1201(a_P);a_L6=a_P[0];
if(a_1674(a_L3,a_L6,a_P)){a_L6=a_P[0]; goto a_G26;}
a_1248(a_1001,2130706257); return;
a_G26:a_P[0]=a_L6;a_1811(a_L3,a_P);a_L6=a_P[0];
...
{ if(a_L4==16777310){ goto a_G31;}
 ...
 if(a_L4==16777293||a_L4==16777298||a_L4==16777304||a_L4==16777331){  goto a_G35;}
  goto a_G36;}
a_G31:a_1818(1696718853);
a_A[0]=a_L3; return;
a_G33:a_1820(a_L3,a_L5,a_P);a_L6=a_P[0];
a_P[0]=1696719027;a_P[1]=a_L3;a_P[2]=1696719035;a_P[3]=a_L3;a_P[4]=1696718871;a_P[5]=1696718889;a_P[6]=a_L6;a_1846(7,a_P); return;
a_G35:a_1873(a_F1);
a_G36:a_1818(a_L3); return;
} /* wsimpleaffix */
static void a_1876(a_word a_F1,a_word a_A[1]){ /* wmatchformalactual+>a+a> */
a_word a_L3;a_word a_L4;a_word a_P[1];
{ if(a_F1==16777288||a_F1==16777283||a_F1==16777277){ goto a_G2;}
...
a_G14:a_1248(a_1001,2130706251); return;
} /* wmatchformalactual */
static void a_1871(a_word a_A[1]){ /* wcopyaffixfromBUFFER+>a> */
...
a_G10:if(!a_was(a_1719,to_LIST(a_1150)->offset[a_A[0]])){ goto a_G13;}
a_G11:a_1095(to_LIST(a_1150)->offset[a_A[0]]); goto a_G9;
a_G13:if(a_was(a_1718,to_LIST(a_1150)->offset[a_A[0]])){ goto a_G11;}
a_1087(to_LIST(a_1150)->offset[a_A[0]]); goto a_G9;
} /* wcopyaffixfromBUFFER */
static void a_1810(a_word a_F1,a_word a_A[1]){ /* copyspareaffix+>a+>a> */
a_word a_P[1];
...
static void a_1861(a_word a_F1,a_word a_F2,a_word a_F3,a_word a_F4,a_word a_F5){ /* wafteraffixes+>a+>a+>a+>a+>a */
...
a_P[0]=a_F3;a_1810(a_L7,a_P);a_F3=a_P[0]; goto a_G26;
a_G24:a_P[0]=a_F3;a_1871(a_P);a_F3=a_P[0];
a_G26:a_incr(a_L6);
if(a_lseq(a_L6,a_F2)){ goto a_G4;}
a_L6=a_L8; goto a_G4;
} /* wafteraffixes */
static void a_1860(a_word a_F1){ /* wactualrule+>a */
a_word a_L2;a_word a_L3;a_word a_L4;a_word a_L5;a_word a_L6;a_word a_L7;a_word a_L8;a_word a_L9;a_word a_P[1];
a_1847(1048580,0);
a_1087(1696718976);
a_1087(to_LIST(a_1151)->offset[a_1796]);
...
static void a_1866(a_word a_F1){ /* warea+>a */
a_word a_P[1];
a_1087(1696718860);
a_incr(a_F1);
...
static void a_1827(a_word a_F1){ /* generaterule+>a */
a_word a_L2;a_word a_L3;a_word a_L4;a_word a_L5;a_word a_P[2];
a_1850=a_F1;
a_1815(a_F1);
...
static void a_1818(a_word a_F1){ /* extendBUFFER+>a */

{register a_word *a_r1=a_extension(a_1150,1);a_r1[0]=a_F1;to_LIST(a_1150)->aupb+=1;}
  return;
} /* extendBUFFER */
static void a_1819(a_word a_F1,a_word a_F2){ /* extendRULE+>a+>a */

{register a_word *a_r1=a_extension(a_1151,2);a_r1[0]=a_F1;a_r1[1]=a_F2;to_LIST(a_1151)->aupb+=2;}
  return;
} /* extendRULE */
static void a_1884(a_word a_F1,a_word a_F2,a_word a_F3){ /* putasstring+""f+t[]+>a */
a_word a_L2;a_word a_L3;a_word a_P[1];
a_L2=0;
a_putchar(a_F1,34);
...
static void a_1886(a_word a_F1,a_word a_F2,a_word a_F3){ /* putstring+""f+t[]+>a */
a_word a_L2;a_word a_L3;a_word a_P[1];
a_L2=0;
