...
static void a_1142(int a_A[1]); /* calltracearg */
static void a_1143(int a_A[1]); /* calltracecall */
static void a_1144(int a_F1); /* charfiledeclaration */
static void a_1145(int a_F1); /* charfileinitialization */
static int a_1146(int a_F1,int a_A[1]); /* checkBUFFERno */
static void a_1147(void); /* closetarget */
static void a_1148(void); /* constitem */
static void a_1149(int a_F1,int a_F2,int a_F3); /* copyaffix */
static void a_1150(int a_F1,int a_F2,int a_F3); /* copytextfromBUFFER */
static void a_1151(int a_F1,int a_A[1]); /* countfilearea */
static void a_1152(void); /* createrulenametable */
static void a_1153(void); /* datadeclaration */
static void a_1154(int a_F1); /* datafiledeclaration */
static void a_1155(int a_F1); /* datafileinitialization */
static void a_1156(void); /* datainitialization */
static void a_1157(int a_F1,int a_F2,int a_F3); /* declarecallargs */
static void a_1158(int a_F1,int a_F2,int a_F3); /* declarelocals */
static void a_1159(void); /* deletetarget */
static void a_1160(int a_F1,int a_F2,int a_F3); /* extensionblock */
static void a_1161(int a_A[1]); /* fillitem */
static int a_1162(int a_A[1]); /* fillrepeater */
static void a_1163(void); /* filltablehead */
static void a_1164(void); /* filltabletail */
static int a_1165=0; /* filltotal */
static void a_1166(int a_A[1]); /* findBUFFERalternative */
static void a_1167(int a_F1,int a_A[1]); /* findBUFFERversion */
static void a_1168(int a_F1,int a_F2,int a_F3); /* flushbuffer */
static void a_1169(int a_F1); /* formalargument */
static void a_1170(int a_F1,int a_F2,int a_F3,int a_F4); /* genassignment */
static int a_1171=0; /* genasync */
static void a_1172(void); /* generatefillentries */
static void a_1173(int a_F1,int a_F2,int a_F3); /* gengetaffixno */
static void a_1174(int a_F1,int a_F2); /* genshiftaffix */
static void a_1175(int a_F1,int a_F2); /* genwaitfor */
static int a_1176(int a_F1); /* hasoutaffix */
static int a_1177(void); /* isasyncwaitfor */
static int a_1178(int a_F1); /* iscompletearea */
static int a_1179(int a_F1); /* isdummyaffix */
static int a_1180(int a_F1,int a_F2,int a_F3); /* isrulediscarded */
static void a_1181(int a_F1); /* jumptolabel */
static int a_1182=0; /* lastprofile */
static void a_1183(int a_F1,int a_F2); /* listdeclaration */
static void a_1184(int a_F1); /* listinitialization */
static void a_1185(int a_F1); /* localargument */
static int a_1186=0; /* moduleroots */
static void a_1187(int a_A[1]); /* nextaffix */
static int a_1188=0; /* nextnodeidx */
static int a_1189(int a_F1,int a_F2); /* numbersequal */
static void a_1190(void); /* opentarget */
static void a_1191(int a_F1,int a_A[1]); /* outargs */
static void a_1192(int a_F1,int a_A[1]); /* pidginalttagtailtype */
static void a_1193(int a_F1,int a_F2); /* pidginrulecall */
static void a_1194(int a_F1); /* printBUFFER */
static void a_1195(int a_F1); /* printGOTO */
static void a_1196(int a_F1); /* printexternalrepr */
static void a_1197(int a_F1); /* printexternalrulerepr */
static void a_1198(int a_F1); /* printgoto */
static void a_1199(int a_F1); /* printint */
static void a_1200(int a_F1,int a_F2); /* printint1 */
static void a_1201(int a_F1); /* printnlptr */
static void a_1202(int a_F1); /* printnumber */
static void a_1203(int a_F1); /* printptr */
static void a_1204(int a_F1); /* printrepr */
static void a_1205(int a_F1); /* procwaitfor */
static void a_1206(void); /* profilingdeclaration */
static void a_1207(int a_F1); /* pushBUFFER */
static void a_1208(int a_F1,int a_F2,int a_F3,int a_A[1]); /* regularcalld1 */
static void a_1209(int a_F1,int a_F2); /* regularcalld2 */
static void a_1210(int a_F1,int a_F2,int a_F3); /* regularcalld3 */
static void a_1211(int a_F1); /* regularcallpostload */
static void a_1212(int a_F1); /* regularcallpreload */
static void a_1213(int a_F1); /* regularrulecall */
static void a_1214(int a_F1,int a_F2,int a_F3); /* repeatblockcall */
static void a_1215(int a_F1,int a_F2,int a_F3,int a_F4); /* repeatblockpostload */
static void a_1216(int a_F1,int a_F2,int a_F3,int a_F4); /* repeatblockpreload */
...
static int a_1235=0; /* waitforitem */
...
static int a_1295=100; /* nextreprno */
...
static int a_1401(int a_F1,int a_F2); /* firstargstarts */
static void a_1402(int a_A[1]); /* geticefile */
static int a_1403(int a_A[1]); /* getnextsource */
static void a_1404(void); /* gettargetfile */
static void a_1405(int a_F1,int a_A[1]); /* handlesourcefile */
static int a_1406(int a_F1,int a_F2); /* isfileflag */
static int a_1407(int a_F1,int a_F2); /* isfirstarg */
static int a_1408=0; /* libdir */
static int a_1409=0; /* libfile */
static int a_1410=0; /* mainfile */
static int a_1411(void); /* notstdlibsource */
static int a_1412(int a_F1,int a_A[1]); /* nthpath */
static void a_1413(int a_A[1]); /* openBUFFER */
static void a_1414(int a_F1); /* openfileaslast */
static void a_1415(int a_F1,int a_A[1]); /* openfilefirst */
static void a_1416(int a_F1); /* opensource */
static int a_1417=0; /* runtimearg */
static int a_1418(int a_F1,int a_A[1]); /* runtimechar */
static int a_1419(int a_F1); /* selectpath */
static void a_1420(int a_F1,int a_F2); /* setfileflag */
static void a_1421(int a_F1); /* setsource */
static void a_1422(int a_F1); /* stringtoBUFFER */
static int a_1423=0; /* targetfile */
static void a_1424(int a_F1,int a_A[1]); /* tryfilefirst */
static void a_1425(int a_F1,int a_A[1]); /* tryopen */
static void a_1426(int a_F1,int a_F2,int a_A[1]); /* tryopenwithpath */
static int a_1427(int a_F1,int a_A[1]); /* wasicesource */
#define a_1429 (a_1390+sizeof_LIST) /* MESSAGE */
#define a_1430 (a_1429+sizeof_LIST) /* PRINTFILE */
static void a_1431(int a_F1,int a_F2); /* corrupticefile */
static void a_1432(int a_C,int *a_V); /* error */
static int a_1433=0; /* errorno */
static void a_1434(int a_C,int *a_V); /* fatalerror */
static void a_1435(int a_C,int *a_V); /* formatprint */
static void a_1436(int a_F1,int a_F2); /* internalerror */
static void a_1437(int a_C,int *a_V); /* message */
static void a_1438(int a_F1); /* messagehead */
static void a_1439(void); /* nlcr */
static void a_1440(int a_F1,int a_F2); /* print */
static void a_1441(int a_F1); /* printbase */
static void a_1442(int a_F1); /* printchar */
static void a_1443(int a_F1); /* printform */
static void a_1444(int a_F1,int a_F2); /* printform1 */
static void a_1445(int a_F1); /* printint */
static void a_1446(int a_F1,int a_F2); /* printint1 */
static void a_1447(int a_F1); /* printitem */
static void a_1448(int a_F1); /* printline */
static void a_1449(int a_F1); /* printpointer */
static int a_1450=0; /* prpos */
static void a_1451(int a_F1); /* tabline */
static void a_1452(int a_C,int *a_V); /* warning */
static int a_1453(void); /* waserror */
#define a_1455 (a_1430+sizeof_CHFILE) /* BOLD */
#define a_1456 (a_1455+sizeof_LIST) /* BUFFER */
#define a_1457 (a_1456+sizeof_LIST) /* HASH */
static int a_1458=1; /* HASHentries */
static int a_1459=1023; /* HASHsize */
#define a_1460 (a_1457+sizeof_LIST) /* LEXT */
#define a_1461 (a_1460+sizeof_LIST) /* SOURCE */
static void a_1462(int a_A[1]); /* addLEXTentry */
static int a_1463=32; /* char */
static void a_1464(void); /* closesource */
static void a_1465(void); /* comment */
static void a_1466(int a_F1,int a_A[1]); /* enterstring */
static void a_1467(int a_F1); /* extendBUFFER */
static void a_1468(int a_F1,int a_A[1]); /* gettagdata */
static void a_1469(int a_F1,int a_A[1]); /* gettagimage */
static int a_1470=0; /* inpt */
static int a_1471=0; /* inptvalue */
static int a_1472=0; /* lastchar */
static int a_1473=0; /* lastfilepos */
static int a_1474=0; /* lastinpt */
static int a_1475=0; /* lastinptvalue */
static void a_1476(void); /* nextchar */
static void a_1477(void); /* nextsymbol */
static void a_1478(int a_F1,int a_F2); /* puttagdata */
static void a_1479(int a_A[1]); /* readbold */
static void a_1480(int a_A[1]); /* readdestination */
static void a_1481(int a_A[1]); /* readstring */
static void a_1482(int a_A[1]); /* readtargetnumber */
static void a_1483(int a_A[2]); /* readtargetstring */
static void a_1484(int a_A[1]); /* readtype */
static void a_1485(void); /* rehash */
static void a_1486(void); /* restoreinputposition */
static void a_1487(void); /* saveinputposition */
static int a_1488=1; /* sourceline */
static void a_1489(int a_A[1]); /* trytoopensource */
static int a_1490=0; /* xnumber */
static void a_1492(void); /* pass1 */
static void a_1493(void); /* pass2 */
static void a_1494(void); /* pass3 */
static void a_1495(void); /* pass4 */
static void a_1496(void); /* pass4a */
static void a_1497(void); /* pass5 */
static void a_1500(int a_F1,int a_F2,int a_F3); /* putstring */
#define a_1503 (a_1461+sizeof_CHFILE) /* STDARG */
static void a_1491(void); /* @main root */
static void a_1454(void); /* lexical root */
static void a_1309(void); /* item root */
static void a_1004(void); /* number root */
#define BLOCK_TOTAL (a_1503+sizeof_LIST)
...
a_1460,/* LEXT */
53,1818308398,979923045,1920169263,1668246575,1630497889,1752196460,0,24,9,0,0,1784968307,1667837555,101,9,5,0,0,926365233,909193783,0,8,5,0,0,808661298,875966519,12851,10,5,0,0,1885695073,776295016,29546,10,5,0,0,1092628271,1213220172,1685021472,101,13,6,0,0,1159737135,17999,6,4,0,0,0,
a_1429,/* MESSAGE */
236,1802398028,1162625312,1294813264,1667837472,1768300645,544433516,1780510580,1935767137,1885958755,1635000436,1952802674,1433281838,1701273971,1936334906,1802398060,757947168,1886152040,1982672252,1769173605,626880111,538976366,540701295,1768715114,1528851310,1769238639,1567845999,1818846752,1713385829,845507689,774778400,1884253733,1852795252,1847933555,1865228320,1635007520,1952802674,538976318,1701344288,1953853216,544503152,544434734,1701603686,538996261,1008749613,1047685476,538976288,1931485216,1684955508,543453793,1919052140,544830049,1701996900,1919906915,544089465,542584096,538976288,538976288,538976288,1869636978,1965061234,1702065518,1970282596,1667853410,1702127904,1847948141,1731010592,538976288,538976288,538976288,1852402720,1769414763,1663068276,543976545,1667331187,1852383339,1836216166,1869182049,544089454,1869491488,1685353261,543320428,538976288,1847619428,1881175151,1701015410,1931506547,1684955508,543453793,1919052140,628716129,757080174,1853453153,538976355,538976288,1701257248,1634887022,1629513076,1668184435,1852797544,544437615,1918986339,1702126433,1852383346,628389232,757080174,1027953197,2021161020,1047751214,1970413600,1835627630,1768693861,1918988898,1668489337,1953524082,1701062688,1819631974,622869108,1847929200,1847617097,1970217071,1953853556,544434464,1667592307,1701406313,1948265572,1847616872,543518049,1948280431,1830839656,544106849,1701013806,1818846752,1936269413,1937075749,1998611557,543716457,544434734,1702131813,1869181806,1851859054,1701257316,1634887022,543450484,1948282473,1663067496,1701999221,1679848558,1667592809,2037542772,1181623598,543976565,1969450852,1953391981,1869182049,1008745070,1886680168,791624307,1752459623,1663984245,1815047535,1919513443,796549485,1885695073,3030632,655,166,1346718785,541928776,1635148138,1769104243,1814066288,1701539433,1981820018,1769173605,622882415,1680158308,1866690085,1769109872,544499815,539575080,875704370,842019373,1632378933,1869380211,1769161504,2053205362,1750363685,1763734377,543236211,1701147238,1718580000,1918990196,1931488357,1948280165,1931502952,1668445551,1952522341,1953785888,792359792,1953064751,778204520,795701091,1769169772,2053205362,1701601583,1847945328,544370534,2037411683,1751607666,1852383348,1836216166,1869182049,1411395182,1701995880,544434464,1461735246,1095914049,995710030,1953459744,1702257952,1701650542,1851877475,1768057204,2037672300,628256544,1953064558,1936942446,1919903264,1881170208,1769239137,1634497891,1970282610,1936683122,11877,270,70,0,
a_1001,/* @StringTable */
50,1953723757,0,4,4,1852141679,1701603686,1634497377,29811,14,6,1769108595,1869899630,1179014466,21061,14,6,1163013421,61,5,4,26413,2,3,22317,2,3,19501,2,3,28461,2,3,2037604653,25454,6,4,762277421,1818522739,25193,10,5,1702243629,1869181810,110,9,5,1701326125,28780,6,4,0,
a_1429,/* MESSAGE */
...
-1}; /* fill table size 2458 */
static void a_data_setup(void){
 a_virtual_min=16777216;a_virtual_max=2130706432;
 a_setup_list(0,a_1001,"@StringTable",1,2130705077,2130706401,1325); /* @StringTable */
 a_setup_list(1,a_1005,"NUMBER",1,2075075424,2130705075,0); /* NUMBER */
 a_setup_list(1,a_1022,"REGISTER",1,2047260597,2075075422,0); /* REGISTER */
 a_setup_list(1,a_1041,"NODE",6,1741296828,2019445082,0); /* NODE */
 a_setup_list(1,a_1042,"ZONE",3,2019445770,2047260593,0); /* ZONE */
 a_setup_list(1,a_1239,"EXPRESSION",1,1546593040,1741296821,0); /* EXPRESSION */
 a_setup_list(1,a_1310,"AUX",6,712148251,990296505,0); /* AUX */
 a_setup_list(1,a_1311,"ITEM",8,990296519,1546593031,0); /* ITEM */
 a_setup_list(1,a_1390,"FILES",3,128036796,155851619,0); /* FILES */
 a_setup_list(0,a_1429,"MESSAGE",1,2019445089,2019445766,678); /* MESSAGE */
 a_setup_list(0,a_1455,"BOLD",1,16777217,16777486,270); /* BOLD */
 a_setup_list(1,a_1456,"BUFFER",1,72407141,128036792,0); /* BUFFER */
 a_setup_list(1,a_1457,"HASH",1,16777488,72407139,0); /* HASH */
 a_setup_list(1,a_1460,"LEXT",2,155851624,712148243,101); /* LEXT */
 a_setup_stdarg(a_1503,"STDARG",1);
 a_setup_charfile(a_1118,"TARGET",2,a_1001,2130706098); /* TARGET */
 a_setup_charfile(a_1430,"PRINTFILE",2,a_1001,2130706350); /* PRINTFILE */
 a_setup_charfile(a_1461,"SOURCE",1,a_1001,2130706397); /* SOURCE */
 a_list_fill(a_FILL);
}
static void a_waitfor(int a_F1,int a_F2){
 a_MODROOT(a_1454,"lexical")
...
a_1028(a_1456,a_F1,a_P);a_A[0]=a_P[0];a_L4=a_P[1];
a_L5=a_A[0];
...
int a_L1;int a_P[1];
 a_waitfor(a_1001,2130705094); a_1026(1,a_1005,0,a_P);a_L1=a_P[0];
a_1017(a_L1,a_P);a_1020=a_P[0];
if(a_equal(to_LIST(a_1005)->alwb,to_LIST(a_1005)->aupb)){ goto a_G6;}
a_1436(a_1001,2130705089); return;
...
int a_P[1];
a_A[0]=0;
a_G2:if(!a_equal(16777285,a_1470)){ goto a_G6;}
a_1477();
a_P[0]=a_A[0];a_1049(a_P);a_A[0]=a_P[0];
if(!a_equal(a_A[0],0)){ return;} goto a_G2;
a_G6:if(!a_equal(16777486,a_1470)){ goto a_G8;}
a_1477(); return;
a_G8:a_1431(a_1001,2130705141); return;
} /* findasyncrules */
static void a_1049(int a_A[1]){ /* checkrule+>a> */
int a_L2;int a_L3;int a_P[1];
if(!a_equal(16777471,a_1470)){ goto a_G4;}
a_L2=a_1471;
a_1477(); goto a_G5;
a_G4:a_1431(a_1001,2130705098); return;
a_G5:if(a_1349(a_L2,2048)){ goto a_G7;}
if(!a_1349(a_L2,16384)){ goto a_G8;}
a_G7:a_1104(); return;
a_G8:if(!a_equal(16777455,a_1470)){ goto a_G4;}

a_1477();
if(!a_equal(16777455,a_1470)){ goto a_G4;}

a_1477();
if(!a_equal(16777455,a_1470)){ goto a_G4;}

a_1477();
a_G17:if(!a_equal(16777227,a_1470)){ goto a_G20;}
a_G18:a_1477();
a_G19:a_1103(); goto a_G17;
a_G20:if(a_equal(16777241,a_1470)){ goto a_G18;}
if(!a_equal(16777281,a_1470)){ goto a_G33;}
a_1477();
if(!a_equal(16777467,a_1470)){ goto a_G4;}
...
a_G33:if(!a_equal(16777439,a_1470)){ goto a_G4;}

a_1477(); return;
} /* checkrule */
static void a_1103(void){ /* skipnode */

a_G1:if(!a_equal(16777412,a_1470)){ goto a_G3;}
a_1477(); return;
a_G3:if(!a_equal(16777486,a_1470)){ goto a_G6;}
a_1477();
a_1431(a_1001,2130705135); return;
a_G6:a_1477(); goto a_G1;
} /* skipnode */
static void a_1093(void){ /* rulesection */

a_G1:if(!a_equal(16777285,a_1470)){ goto a_G4;}
a_1477();
a_1080(); goto a_G1;
a_G4:if(!a_equal(16777486,a_1470)){ goto a_G6;}
a_1477(); return;
a_G6:a_1431(a_1001,2130705130); return;
} /* rulesection */
static void a_1104(void){ /* skiprule */

a_G1:if(!a_equal(16777439,a_1470)){ goto a_G3;}
a_G2:a_1477(); return;
a_G3:if(a_equal(16777486,a_1470)){ goto a_G2;}
a_1477(); goto a_G1;
} /* skiprule */
...
if(!a_equal(16777459,a_1470)){ goto a_G6;}
a_A[0]=a_1471;
a_1477();
a_G4:a_A[1]=a_A[0];
a_L4=1; goto a_G26;
a_G6:if(!a_equal(16777471,a_1470)){ goto a_G23;}
a_L3=a_1471;
a_1477();
a_P[0]=a_L3;a_1070(a_P);a_L3=a_P[0];
...
a_L4=2; goto a_G26;
a_G22:a_1431(a_1001,2130705125); return;
a_G23:a_1009(a_P);a_A[0]=a_P[0];
a_1009(a_P);a_A[1]=a_P[0];
a_L4=0;
a_G26:if(!a_equal(16777409,a_1470)){ goto a_G41;}
a_1477();
if(!a_equal(a_L4,0)){ goto a_G30;}
a_A[0]=a_1019; goto a_G31;
a_G30:if(!a_equal(a_L4,1)){ goto a_G22;}
a_G31:if(!a_equal(16777459,a_1470)){ goto a_G34;}
a_A[1]=a_1471;
a_1477(); return;
a_G34:if(!a_equal(16777471,a_1470)){ goto a_G40;}
a_L3=a_1471;
a_1477();
a_P[0]=a_L3;a_1070(a_P);a_L3=a_P[0];
{register int a_r1=to_LIST(a_1311)->offset[a_L3-6];
...
a_G11:a_P[0]=2019445103;a_P[1]=a_A[0];a_P[2]=a_L4;a_P[3]=a_L5;a_1432(4,a_P);
a_G12:if(!a_equal(16777442,a_1470)){ goto a_G14;}
a_1477(); goto a_G6;
a_G14:a_1083(a_F1);
if(a_is(a_L3)){ return;}
a_P[0]=2019445116;a_P[1]=a_A[0];a_1432(2,a_P); return;
} /* checkarea */
static void a_1047(void){ /* checkareas */
...
a_L2=0;a_L3=0;
a_G6:if(!a_equal(16777220,a_1470)){ goto a_G14;}
a_1477();
a_incr(a_L3);
a_1046(a_L1,a_P);a_L2=a_P[0];
if(!a_equal(16777433,a_1470)){ goto a_G13;}

a_1477(); goto a_G6;
a_G13:a_1431(a_1001,2130705098); return;
a_G14:if(!a_1053(a_L1)){ goto a_G18;}
a_1099(2048);
if(a_more(a_L3,1)){ goto a_G20;}
a_P[0]=2019445141;a_P[1]=a_L2;a_1432(2,a_P); goto a_G20;
a_G18:a_P[0]=2019445129;a_P[1]=a_L2;a_1452(2,a_P);
a_1114=1;
...
int a_L1;
a_scratch(a_1041);
if(!a_equal(16777455,a_1470)){ goto a_G5;}
a_L1=a_1471;
a_1477(); goto a_G6;
a_G5:a_1431(a_1001,2130705098); return;
...
a_1431(a_1001,2130705118); return;
} /* advancenode */
...
to_LIST(a_1456)->offset[a_F1]=1; return;
} /* marklocalaffix */
...
a_1056=0; return;
a_G3:a_1056=1;
a_subtr(to_LIST(a_1456)->aupb,a_F1,a_1078);
a_incr(a_1078);
...
a_G1:if(!a_equal(16777412,a_1470)){ goto a_G3;}
a_1477(); return;
a_G3:if(!a_equal(16777479,a_1470)){ goto a_G7;}
a_L1=a_1471;
a_1477();
a_1081(a_L1); goto a_G1;
a_G7:if(!a_equal(16777448,a_1470)){ goto a_G10;}
a_1477();
a_1074=1; goto a_G1;
a_G10:if(!a_equal(16777486,a_1470)){ goto a_G13;}
a_1477();
a_1431(a_1001,2130705113); return;
a_G13:a_1477(); goto a_G1;
} /* skiptocomma */
static void a_1107(int a_A[1]){ /* skiptolabel+a> */

a_G1:if(!a_equal(16777433,a_1470)){ goto a_G4;}
a_A[0]=a_1471;
a_1477(); return;
a_G4:if(!a_equal(16777486,a_1470)){ goto a_G7;}
a_1477();
a_1431(a_1001,2130705108); return;
a_G7:a_1477(); goto a_G1;
} /* skiptolabel */
static int a_1076(void){ /* islimit */

if(!a_equal(16777231,a_1470)){ goto a_G3;}
a_G2:a_1477(); return 1;
a_G3:if(a_equal(16777269,a_1470)){ goto a_G2;}
if(a_equal(16777291,a_1470)){ goto a_G2;}
if(a_equal(16777295,a_1470)){ goto a_G2;}
if(!a_equal(16777299,a_1470)){ return 0;} goto a_G2;
} /* islimit */
static void a_1102(void){ /* skiplist */

if(!a_equal(16777475,a_1470)){ goto a_G3;}
a_G2:a_1477(); return;
a_G3:if(!a_equal(16777471,a_1470)){ goto a_G5;}
 goto a_G2;
a_G5:a_1431(a_1001,2130705098); return;
} /* skiplist */
static void a_1101(void){ /* skipaffix */
int a_L1;
if(!a_equal(16777409,a_1470)){ goto a_G3;}
a_1477();
a_G3:if(!a_equal(16777475,a_1470)){ goto a_G5;}
a_G4:a_1477(); return;
a_G5:if(!a_equal(16777479,a_1470)){ goto a_G9;}
a_L1=a_1471;
a_1477();
a_1081(a_L1); return;
a_G9:if(a_equal(16777471,a_1470)){ goto a_G4;}
if(a_equal(16777424,a_1470)){ goto a_G4;}
if(a_equal(16777459,a_1470)){ goto a_G4;}
if(!a_1076()){ goto a_G14;}
a_1102(); return;
a_G14:if(!a_equal(16777448,a_1470)){ goto a_G25;}
a_1477();
a_1074=1;
a_1102();
a_1101();
if(!a_equal(16777403,a_1470)){ goto a_G22;}

a_1477(); goto a_G23;
a_G22:a_1431(a_1001,2130705098); return;
a_G23:if(!a_equal(16777455,a_1470)){ goto a_G22;}
 goto a_G4;
a_G25:a_1431(a_1001,2130705103); return;
} /* skipaffix */
static void a_1087(int a_C,int *a_V){ /* pushBUFFER+@+>a */

a_G1:{register int *a_r1=a_extension(a_1456,1);a_r1[0]=a_V[0];to_LIST(a_1456)->aupb+=1;}
if(a_C>1){a_C--;a_V+=1; goto a_G1;}  return;
} /* pushBUFFER */
static void a_1111(int a_F1){ /* storelist+>a */
int a_L2;int a_P[3];
if(!a_equal(16777475,a_1470)){ goto a_G5;}
a_L2=a_1471;
a_1477();
a_P[0]=a_F1;a_P[1]=16777475;a_P[2]=a_L2;a_1087(3,a_P); return;
a_G5:if(!a_equal(16777471,a_1470)){ goto a_G8;}
a_L2=a_1471;
a_1477(); goto a_G9;
a_G8:a_1431(a_1001,2130705098); return;
a_G9:a_P[0]=a_L2;a_1070(a_P);a_L2=a_P[0];
a_P[0]=a_F1;a_P[1]=16777471;a_P[2]=a_L2;a_1087(3,a_P); return;
} /* storelist */
static void a_1110(void){ /* storelimit */

if(!a_equal(16777269,a_1470)){ goto a_G4;}
a_1477();
a_1111(16777269); return;
a_G4:if(!a_equal(16777291,a_1470)){ goto a_G7;}
a_1477();
a_1111(16777291); return;
a_G7:if(!a_equal(16777295,a_1470)){ goto a_G10;}
a_1477();
a_1111(16777295); return;
a_G10:if(!a_equal(16777299,a_1470)){ goto a_G13;}
a_1477();
a_1111(16777299); return;
a_G13:if(!a_equal(16777231,a_1470)){ goto a_G16;}

a_1477(); goto a_G17;
a_G16:a_1431(a_1001,2130705098); return;
...
a_G9:if(!a_equal(16777471,a_1470)){ goto a_G14;}
a_L1=a_1471;
a_1477();
a_P[0]=a_L1;a_1070(a_P);a_L1=a_P[0];
a_P[0]=16777471;a_P[1]=a_L1;a_1087(2,a_P); return;
a_G14:if(!a_equal(16777459,a_1470)){ goto a_G18;}
a_L1=a_1471;
a_1477();
a_P[0]=16777459;a_P[1]=a_L1;a_1087(2,a_P); return;
a_G18:if(!a_equal(16777448,a_1470)){ goto a_G30;}
a_1477();
a_1111(16777448);
a_1109();
if(!a_equal(16777403,a_1470)){ goto a_G25;}

a_1477(); goto a_G26;
a_G25:a_1431(a_1001,2130705098); return;
a_G26:if(!a_equal(16777455,a_1470)){ goto a_G25;}
a_L1=a_1471;
a_1477();
...
int a_L2;int a_P[2];
if(!a_equal(16777409,a_1470)){ goto a_G6;}
a_1477();
a_A[0]=16777409;
a_P[0]=16777409;a_1087(1,a_P);
a_G5:a_1109(); return;
a_G6:if(!a_equal(16777424,a_1470)){ goto a_G10;}
a_1477();
a_A[0]=16777424;
a_P[0]=16777424;a_1087(1,a_P); return;
a_G10:if(!a_equal(16777397,a_1470)){ goto a_G18;}
a_1477();
a_A[0]=16777397;
if(!a_equal(16777455,a_1470)){ goto a_G16;}
a_L2=a_1471;
a_1477(); goto a_G17;
a_G16:a_L2=0;
...
static void a_1113(void){ /* storeruleaffixes */
int a_L1;int a_P[2];
a_G1:{ if(a_1470==16777479){ goto a_G2;}
 if(a_1470==16777471){ goto a_G5;}
 if(a_1470==16777475||a_1470==16777459||a_1470==16777455){ goto a_G3;}
 if(a_1470==16777448){ goto a_G6;}
 if(a_1470==16777269||a_1470==16777291||a_1470==16777295||a_1470==16777299||a_1470==16777231||a_1470==16777424||a_1470==16777403||a_1470==16777397||a_1470==16777409){ goto a_G11;}
  goto a_G12;}
a_G2:a_1081(a_1471);
a_G3:a_P[0]=a_1470;a_P[1]=a_1471;a_1087(2,a_P);
a_G4:a_1477(); goto a_G1;
a_G5:a_P[0]=a_1471;a_1070(a_P);a_1471=a_P[0]; goto a_G3;
a_G6:a_P[0]=a_1470;a_1087(1,a_P);
a_1477();
a_booland(to_LIST(a_1041)->offset[a_1115-4],8,a_L1);
if(a_noteq(a_L1,0)){ goto a_G1;}
a_1074=1; goto a_G1;
a_G11:a_P[0]=a_1470;a_1087(1,a_P); goto a_G4;
a_G12:if(!a_equal(16777433,a_1470)){ goto a_G15;}
to_LIST(a_1041)->offset[a_1115-1]=a_1471;
a_1477(); goto a_G16;
a_G15:a_1431(a_1001,2130705098); return;
a_G16:if(!a_equal(16777433,a_1470)){ goto a_G15;}
to_LIST(a_1041)->offset[a_1115]=a_1471;
a_1477();
if(!a_equal(16777412,a_1470)){ goto a_G15;}

a_1477(); return;
} /* storeruleaffixes */
static void a_1054(void){ /* computeruleaffixhash */
int a_L1;int a_P[1];
a_L1=to_LIST(a_1456)->aupb;
a_1113();
a_blockhash(a_1456,a_L1,a_P);to_LIST(a_1041)->offset[a_1115-5]=a_P[0];
a_unstackto(a_1456,a_L1); return;
...
a_G1:if(!a_equal(to_LIST(a_1456)->offset[a_F1],to_LIST(a_1456)->offset[a_F2])){ return 0;}
if(a_equal(to_LIST(a_1456)->offset[a_F1],16777412)){ return 1;}
a_decr(a_F1);
...
a_unstackto(a_1456,a_F1); return;
...
a_1113();
to_LIST(a_1041)->offset[a_1115-2]=to_LIST(a_1456)->aupb;
a_1052(a_L1); return;
a_G7:a_1106(); return;
} /* checknodehash */
...
a_1062(a_P);a_L1=a_P[0];
a_L2=0;a_L3=0;
a_G3:if(!a_equal(16777220,a_1470)){ goto a_G8;}
a_1477();
a_1082(0,a_L2);
a_L2=a_L3;
...
a_1477(); goto a_G5;
a_G4:a_1431(a_1001,2130705098); return;
a_G5:if(!a_equal(16777455,a_1470)){ goto a_G4;}
...
a_1477();
a_L7=to_LIST(a_1456)->aupb;
a_L2=0;a_L5=0;a_L6=0;
a_G16:if(!a_equal(16777433,a_1470)){ goto a_G21;}
a_1477();
if(!a_equal(16777433,a_1470)){ goto a_G4;}
...
a_unstackto(a_1456,a_L7); return;
} /* generaterulecall */
static void a_1067(void){ /* generateextension */
int a_L1;int a_L2;int a_L3;int a_L4;int a_P[2];
a_L1=to_LIST(a_1456)->aupb;
a_1111(0);
if(!a_equal(16777455,a_1470)){ goto a_G6;}
a_L2=a_1471;
a_1477(); goto a_G7;
a_G6:a_1431(a_1001,2130705098); return;
a_G7:a_add(a_L1,1,a_L3);
to_LIST(a_1456)->offset[a_L3]=a_L2;
a_P[0]=0;a_1087(1,a_P);
a_L3=to_LIST(a_1456)->aupb;
a_G11:a_1109();
a_P[0]=16777436;a_1087(1,a_P);
a_G13:if(!a_equal(16777288,a_1470)){ goto a_G19;}
a_1477();
if(!a_equal(16777455,a_1470)){ goto a_G6;}
a_L2=a_1471;
a_1477();
a_P[0]=a_L2;a_1087(1,a_P); goto a_G13;
a_G19:if(!a_equal(16777433,a_1470)){ goto a_G25;}
a_L4=a_1471;
a_1477();
...
{register int a_r1=to_LIST(a_1456)->aupb;to_LIST(a_1456)->offset[a_L3]=a_r1;a_L3=a_r1;} goto a_G11;
a_G27:a_unstackto(a_1456,a_L1); return;
} /* generateextension */
static void a_1064(void){ /* generatearea */
int a_L1;int a_L2;int a_P[2];
a_G1:a_1089(a_P);a_L1=a_P[0];a_L2=a_P[1];
a_P[0]=a_L1;a_P[1]=a_L2;a_1087(2,a_P);
if(!a_equal(16777442,a_1470)){ return;}
a_1477();
...
a_L1=0;
if(!a_equal(16777220,a_1470)){ goto a_G5;}

a_1477(); goto a_G6;
a_G5:a_1431(a_1001,2130705098); return;
a_G6:if(!a_equal(16777455,a_1470)){ goto a_G5;}

a_1477();
a_P[0]=0;a_1087(1,a_P);
if(a_equal(a_L1,0)){ goto a_G12;}
to_LIST(a_1456)->offset[a_L1]=to_LIST(a_1456)->aupb;
a_G12:a_L1=to_LIST(a_1456)->aupb;
a_P[0]=0;a_1087(1,a_P);
a_L2=to_LIST(a_1456)->aupb;
a_1064();
if(!a_equal(16777433,a_1470)){ goto a_G5;}
a_L3=a_1471;
a_1477();
a_1063(a_L3,a_P);to_LIST(a_1456)->offset[a_L2]=a_P[0];
if(!a_equal(16777220,a_1470)){ goto a_G23;}
a_1477();
...
a_G1:if(!a_equal(16777227,a_1470)){ goto a_G11;}
a_1477();
a_1044();
a_1099(4);
a_1101();
a_1047();
if(!a_equal(16777412,a_1470)){ goto a_G10;}

a_1477(); goto a_G1;
a_G10:a_1431(a_1001,2130705098); return;
a_G11:if(!a_equal(16777241,a_1470)){ goto a_G16;}
a_1477();
a_1044();
a_1099(2);
a_1106(); goto a_G1;
a_G16:if(!a_equal(16777281,a_1470)){ goto a_G22;}
a_1477();
a_1044();
a_1099(1);
a_1100();
a_1054(); goto a_G1;
a_G22:if(!a_equal(16777439,a_1470)){ goto a_G10;}
...
int a_L1;
a_L1=to_LIST(a_1456)->aupb;
a_G2:if(!a_equal(16777227,a_1470)){ goto a_G6;}
a_G3:a_1477();
a_1044();
a_1106(); goto a_G2;
a_G6:if(a_equal(16777241,a_1470)){ goto a_G3;}
if(!a_equal(16777281,a_1470)){ goto a_G12;}
a_1477();
a_1044();
a_1105();
a_1048(); goto a_G2;
a_G12:if(!a_equal(16777439,a_1470)){ goto a_G15;}

a_1477(); goto a_G16;
a_G15:a_1431(a_1001,2130705098); return;
a_G16:a_unstackto(a_1456,a_L1); return;
} /* scanii */
static void a_1097(void){ /* scaniii */

a_G1:if(!a_equal(16777227,a_1470)){ goto a_G10;}
a_1477();
a_1044();
a_1101();
a_1045();
a_G6:if(!a_equal(16777412,a_1470)){ goto a_G9;}

a_1477(); goto a_G1;
a_G9:a_1431(a_1001,2130705098); return;
a_G10:if(!a_equal(16777241,a_1470)){ goto a_G14;}
a_1477();
a_1044();
a_1058(); goto a_G6;
a_G14:if(!a_equal(16777281,a_1470)){ goto a_G19;}
a_1477();
a_1044();
a_1092();
a_1106(); goto a_G1;
a_G19:if(!a_equal(16777439,a_1470)){ goto a_G9;}

a_1477(); return;
} /* scaniii */
static void a_1098(void){ /* scaniv */
int a_L1;
a_G1:if(!a_equal(16777227,a_1470)){ goto a_G9;}
a_1477();
a_1068();
a_1066();
a_G5:if(!a_equal(16777412,a_1470)){ goto a_G8;}

a_1477(); goto a_G1;
a_G8:a_1431(a_1001,2130705098); return;
a_G9:if(!a_equal(16777241,a_1470)){ goto a_G13;}
a_1477();
a_1068();
a_1067(); goto a_G5;
a_G13:if(!a_equal(16777281,a_1470)){ goto a_G22;}
a_1477();
a_1068();
...
a_1069(); goto a_G5;
a_G22:if(!a_equal(16777439,a_1470)){ goto a_G8;}
...
a_1114=1; goto a_G18;
a_G17:a_1114=0;
a_G18:a_L2=to_LIST(a_1456)->aupb;
a_1051();
a_1108(a_L3,a_L4);
a_1487();
a_1115=0;
...
a_P[0]=2019445155;a_P[1]=to_LIST(a_1311)->offset[a_L1-4];a_P[2]=to_LIST(a_1311)->offset[a_L1-3];a_P[3]=to_LIST(a_1311)->offset[a_1079-4];a_1432(4,a_P); return;
a_G42:a_1225(a_1072);
a_1486();
a_1115=0;
a_1098();
...
int a_L1;int a_P[3];
a_1404();
if(!a_openfile(a_1118,119,a_1460,to_LIST(a_1460)->aupb)){ goto a_G5;}
a_unstackstring(a_1460);
a_1228=1; return;
a_G5:a_getfileerror(a_1118,a_L1);
a_P[0]=2019445169;a_P[1]=to_LIST(a_1460)->aupb;a_P[2]=a_L1;a_1432(3,a_P); return;
} /* opentarget */
static void a_1147(void){ /* closetarget */
...
a_1147();
a_1404();
a_unlinkfile(a_1460,to_LIST(a_1460)->aupb);
a_unstackstring(a_1460); return;
} /* deletetarget */
static void a_1199(int a_F1){ /* printint+>a */
...
a_putchar(a_1118,45);
a_getabs(a_F1,a_F1);
a_G11:a_1200(a_F1,48); return;
} /* printint */
static void a_1200(int a_F1,int a_F2){ /* printint1+>a+>a */
int a_L3;int a_L4;
...
static void a_1185(int a_F1){ /* localargument+>a */

a_putchar(a_1118,97);
a_putchar(a_1118,76);
a_1199(a_F1); return;
} /* localargument */
static void a_1169(int a_F1){ /* formalargument+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_L2=0;a_L4=0;
...
a_1500(a_1118,a_1001,2130706094); return;
a_G21:a_1500(a_1118,a_1001,2130706089);
a_1199(a_L2); goto a_G11;
a_G23:if(!a_equal(a_L2,a_F1)){ goto a_G2;}
a_putchar(a_1118,97);
a_putchar(a_1118,70);
a_1199(a_F1); return;
} /* formalargument */
static void a_1196(int a_F1){ /* printexternalrepr+>a */

{register int a_r1=to_LIST(a_1311)->offset[a_F1-6];
 if(a_r1==16777304||a_r1==16777309){ goto a_G2;}
 if(a_r1==16777349){ goto a_G3;}
  goto a_G4;}
a_G2:a_1203(to_LIST(a_1311)->offset[a_F1]); return;
a_G3:a_1197(to_LIST(a_1311)->offset[a_F1]); return;
a_G4:a_putchar(a_1118,97);
a_1199(to_LIST(a_1311)->offset[a_F1]); return;
} /* printexternalrepr */
static void a_1204(int a_F1){ /* printrepr+>a */

if(!a_was(a_1311,a_F1)){ goto a_G8;}
if(!a_1349(a_F1,16)){ goto a_G4;}
a_1196(a_F1); return;
a_G4:{register int a_r1=to_LIST(a_1311)->offset[a_F1-6];
 if(!(a_r1==16777304||a_r1==16777335)){ goto a_G6;}
}
a_1202(to_LIST(a_1311)->offset[a_F1]); return;
a_G6:a_putchar(a_1118,97);
a_1199(to_LIST(a_1311)->offset[a_F1]); return;
a_G8:a_1203(a_F1); return;
} /* printrepr */
static void a_1198(int a_F1){ /* printgoto+>a */

{ if(a_F1==0||a_F1==-1){ goto a_G2;}
 if(a_F1==-2){ goto a_G5;}
  goto a_G6;}
a_G2:if(!a_1349(a_1231,512)){ goto a_G4;}
a_1500(a_1118,a_1001,2130706084); return;
a_G4:a_1500(a_1118,a_1001,2130706079); return;
a_G5:a_1500(a_1118,a_1001,2130706074); return;
a_G6:a_1500(a_1118,a_1001,2130706069);
a_1199(a_F1);
a_1500(a_1118,a_1001,2130706065); return;
} /* printgoto */
static void a_1195(int a_F1){ /* printGOTO+>a */

if(!a_equal(a_F1,a_1188)){ goto a_G3;}
if(a_noteq(a_1188,0)){ return;}
a_G3:a_1198(a_F1); return;
} /* printGOTO */
static void a_1194(int a_F1){ /* printBUFFER+>a */

{register int a_r1=to_LIST(a_1456)->offset[a_F1];
 ...
 if(a_r1==16777475){ goto a_G10;}
  goto a_G12;}
a_G2:a_incr(a_F1);
a_1204(to_LIST(a_1456)->offset[a_F1]); return;
a_G4:a_incr(a_F1);
a_1199(to_LIST(a_1456)->offset[a_F1]); return;
a_G6:a_incr(a_F1);
a_1185(to_LIST(a_1456)->offset[a_F1]); return;
a_G8:a_incr(a_F1);
a_1202(to_LIST(a_1456)->offset[a_F1]); return;
a_G10:a_incr(a_F1);
a_1169(to_LIST(a_1456)->offset[a_F1]); return;
a_G12:a_1119(12); return;
} /* printBUFFER */
static void a_1203(int a_F1){ /* printptr+>a */
int a_P[1];
a_G1:if(!a_was(a_1311,a_F1)){ goto a_G3;}
a_F1=to_LIST(a_1311)->offset[a_F1-4]; goto a_G1;
a_G3:if(!a_was(a_1460,a_F1)){ goto a_G6;}
a_1469(a_F1,a_P);a_F1=a_P[0];
a_1500(a_1118,a_1460,a_F1); return;
a_G6:if(!a_was(a_1429,a_F1)){ goto a_G8;}
a_1500(a_1118,a_1429,a_F1); return;
a_G8:if(!a_was(a_1456,a_F1)){ goto a_G10;}
a_1194(a_F1); return;
a_G10:a_1119(13); return;
} /* printptr */
static void a_1197(int a_F1){ /* printexternalrulerepr+>a */
int a_L2;int a_L3;int a_P[1];
if(!a_was(a_1460,a_F1)){ goto a_G12;}
a_1469(a_F1,a_P);a_F1=a_P[0];
if(!a_stringelem(a_1460,a_F1,0,a_P)){ goto a_G8;}a_L3=a_P[0];
if(!a_equal(a_L3,37)){ goto a_G8;}
a_L2=1;
if(a_equal(a_1171,0)){ goto a_G9;}
a_1500(a_1118,a_1001,2130706060); goto a_G9;
a_G8:a_L2=0;
a_G9:if(!a_stringelem(a_1460,a_F1,a_L2,a_P)){ return;}a_L3=a_P[0];
a_putchar(a_1118,a_L3);
a_incr(a_L2); goto a_G9;
a_G12:a_1119(14); return;
} /* printexternalrulerepr */
static void a_1201(int a_F1){ /* printnlptr+>a */
int a_L2;int a_L3;int a_P[1];
if(!a_was(a_1460,a_F1)){ goto a_G17;}
a_1469(a_F1,a_P);a_F1=a_P[0];
{register int a_r1=to_LIST(a_1456)->aupb;a_L2=a_r1;a_L3=a_r1;}
a_unpackstring(a_1460,a_F1,a_1456);
a_G5:if(!a_lseq(to_LIST(a_1456)->aupb,a_L3)){ goto a_G7;}
a_unstackto(a_1456,a_L2); return;
a_G7:a_incr(a_L3);
if(!a_noteq(to_LIST(a_1456)->offset[a_L3],37)){ goto a_G10;}
a_G9:a_putchar(a_1118,to_LIST(a_1456)->offset[a_L3]); goto a_G5;
a_G10:a_incr(a_L3);
if(a_less(to_LIST(a_1456)->aupb,a_L3)){ goto a_G5;}
if(!a_equal(to_LIST(a_1456)->offset[a_L3],110)){ goto a_G14;}
a_putchar(a_1118,10); goto a_G5;
a_G14:if(!a_equal(to_LIST(a_1456)->offset[a_L3],37)){ goto a_G16;}
a_putchar(a_1118,37); goto a_G5;
a_G16:a_putchar(a_1118,37); goto a_G9;
a_G17:a_1203(a_F1); return;
} /* printnlptr */
static void a_1202(int a_F1){ /* printnumber+>a */
int a_L2;int a_L3;
{register int a_r1=to_LIST(a_1456)->aupb;a_L2=a_r1;a_L3=a_r1;}
a_1008(a_F1);
a_G3:if(!a_lseq(to_LIST(a_1456)->aupb,a_L3)){ goto a_G5;}
a_unstackto(a_1456,a_L2); return;
a_G5:a_incr(a_L3);
a_putchar(a_1118,to_LIST(a_1456)->offset[a_L3]); goto a_G3;
} /* printnumber */
static void a_1119(int a_F1){ /* TE+>a */

a_1500(a_1118,a_1001,2130706055);
a_1199(a_F1);
a_putchar(a_1118,10);
a_1436(a_1001,2130706051); return;
} /* TE */
static void a_1117(int a_F1,int a_C,int *a_V){ /* T+t[]+@+>a */
int a_L2;int a_L3;
a_L3=to_LIST(a_1456)->aupb;
a_unpackstring(a_F1,a_V[0],a_1456);
a_add(a_L3,1,a_L2);
a_G4:if(a_less(to_LIST(a_1456)->aupb,a_L2)){ goto a_G43;}
if(!a_noteq(to_LIST(a_1456)->offset[a_L2],37)){ goto a_G8;}
a_putchar(a_1118,to_LIST(a_1456)->offset[a_L2]);
a_G7:a_incr(a_L2); goto a_G4;
a_G8:a_incr(a_L2);
if(!a_more(a_L2,to_LIST(a_1456)->aupb)){ goto a_G11;}
a_putchar(a_1118,37); goto a_G43;
a_G11:{register int a_r1=to_LIST(a_1456)->offset[a_L2];
...
a_1500(a_1118,a_1001,2130706048); goto a_G7;
a_G24:a_1119(4); return;
a_G25:if(a_C<=1){ goto a_G28;} a_C--;a_V+=1;
if(a_equal(a_V[0],0)){ goto a_G7;}
a_1500(a_1118,a_1001,2130706044); goto a_G7;
a_G28:a_1119(5); return;
a_G29:a_putchar(a_1118,10); goto a_G7;
a_G30:if(a_C<=1){ goto a_G32;} a_C--;a_V+=1;
a_1199(a_V[0]); goto a_G7;
a_G32:a_1119(6); return;
a_G33:if(a_C<=1){ goto a_G35;} a_C--;a_V+=1;
a_1203(a_V[0]); goto a_G7;
a_G35:a_1119(7); return;
a_G36:if(a_C<=1){ goto a_G38;} a_C--;a_V+=1;
a_1201(a_V[0]); goto a_G7;
a_G38:a_1119(8); return;
a_G39:if(a_C<=1){ goto a_G41;} a_C--;a_V+=1;
a_1202(a_V[0]); goto a_G7;
a_G41:a_1119(9); return;
a_G42:a_1119(10); return;
a_G43:if(a_C<=1){ goto a_G45;} a_C--;a_V+=1;
a_1119(11); return;
a_G45:a_unstackto(a_1456,a_L3); return;
} /* T */
static void a_1142(int a_A[1]){ /* calltracearg+a> */
int a_P[1];
if(!a_equal(a_1141,0)){ goto a_G3;}
a_A[0]=0; return;
a_G3:a_P[0]=2130706040;a_1117(a_1001,1,a_P);
a_A[0]=1; return;
} /* calltracearg */
static void a_1143(int a_A[1]){ /* calltracecall+a> */
int a_P[1];
if(!a_equal(a_1141,0)){ goto a_G3;}
a_A[0]=0; return;
a_G3:a_P[0]=2130706037;a_1117(a_1001,1,a_P);
a_A[0]=1; return;
} /* calltracecall */
static void a_1131(int a_F1){ /* addcallstack+>a */
int a_P[2];
if(a_equal(a_1141,0)){ return;}
a_P[0]=2130706033;a_P[1]=to_LIST(a_1311)->offset[a_F1-2];a_1117(a_1001,2,a_P); return;
} /* addcallstack */
static void a_1233(void){ /* usecallstack */
...
a_P[0]=2130706022;a_P[1]=1;a_P[2]=1;a_1117(a_1001,3,a_P);
...
a_P[0]=2130706004;a_P[1]=to_LIST(a_1311)->offset[a_L1-5];a_1117(a_1001,2,a_P); goto a_G2;
a_G7:a_P[0]=2130705998;a_P[1]=a_L1;a_P[2]=to_LIST(a_1311)->offset[a_L1-5];a_1117(a_1001,3,a_P); goto a_G2;
a_G8:a_P[0]=2130705993;a_P[1]=155851712;a_1117(a_1001,2,a_P);
a_P[0]=2130705989;a_P[1]=a_1141;a_1117(a_1001,2,a_P);
a_P[0]=2130705980;a_P[1]=a_1171;a_1117(a_1001,2,a_P);
if(!a_1418(0,a_P)){ goto a_G18;}
a_P[0]=2130705971;a_1117(a_1001,1,a_P);
a_L1=0;
a_G14:if(!a_1418(a_L1,a_P)){ goto a_G17;}a_L2=a_P[0];
a_putchar(a_1118,a_L2);
a_incr(a_L1); goto a_G14;
a_G17:a_P[0]=2130705965;a_1117(a_1001,1,a_P);
a_G18:a_L1=0;
a_G19:a_P[0]=a_L1;if(!a_1339(1,a_P)){ goto a_G21;}a_L1=a_P[0];a_L2=a_P[1];
a_P[0]=2130705993;a_P[1]=a_L2;a_1117(a_1001,2,a_P); goto a_G19;
a_G21:a_P[0]=2130705961;a_P[1]=155851690;a_P[2]=155851697;a_1117(a_1001,3,a_P); return;
} /* targetprelude */
static void a_1229(void){ /* targetpostlude */
int a_L1;int a_L2;int a_P[2];
a_L1=0;
a_G2:a_P[0]=a_L1;if(!a_1339(0,a_P)){ goto a_G4;}a_L1=a_P[0];a_L2=a_P[1];
a_P[0]=2130705993;a_P[1]=a_L2;a_1117(a_1001,2,a_P); goto a_G2;
a_G4:a_P[0]=2130705993;a_P[1]=155851718;a_1117(a_1001,2,a_P); return;
} /* targetpostlude */
static void a_1234(int a_F1){ /* vardeclaration+>a */
int a_P[4];
if(a_1349(a_F1,16)){ return;}
a_P[0]=2130705947;a_P[1]=a_F1;a_P[2]=to_LIST(a_1311)->offset[a_F1-1];a_P[3]=a_F1;a_1117(a_1001,4,a_P); return;
} /* vardeclaration */
static void a_1183(int a_F1,int a_F2){ /* listdeclaration+>a+>a */
int a_L3;int a_L4;int a_L5;int a_L6;int a_P[8];
if(!a_1349(a_F2,16)){ goto a_G4;}
a_1333(a_F2,a_P);a_L3=a_P[0];
a_P[0]=2130705940;a_P[1]=a_F2;a_P[2]=a_F1;a_P[3]=a_F2;a_P[4]=a_L3;a_1117(a_1001,5,a_P); return;
a_G4:a_1333(a_F2,a_P);a_L3=a_P[0];
a_1344(a_F2,a_P);a_L5=a_P[0];
a_1343(a_F2,a_P);a_L4=a_P[0];
a_1336(a_F2,a_P);a_L6=a_P[0];
a_P[0]=2130705927;a_P[1]=a_F2;a_P[2]=a_F1;a_P[3]=a_F2;a_P[4]=a_L3;a_P[5]=a_L4;a_P[6]=a_L5;a_P[7]=a_L6;a_1117(a_1001,8,a_P); return;
} /* listdeclaration */
static void a_1144(int a_F1){ /* charfiledeclaration+>a */
int a_L2;int a_L3;int a_L4;int a_P[6];
if(!a_1349(a_F1,16)){ goto a_G3;}
a_P[0]=2130705913;a_P[1]=a_F1;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
...
a_G11:a_P[0]=2130705901;a_P[1]=a_F1;a_P[2]=a_F1;a_P[3]=a_L2;a_P[4]=a_L3;a_P[5]=a_L4;a_1117(a_1001,6,a_P); return;
} /* charfiledeclaration */
static void a_1154(int a_F1){ /* datafiledeclaration+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_P[7];
if(!a_1349(a_F1,16)){ goto a_G3;}
a_P[0]=2130705888;a_P[1]=a_F1;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
a_G3:if(!a_1349(a_F1,64)){ goto a_G5;}
a_L2=2; goto a_G6;
a_G5:a_L2=0;
a_G6:if(!a_1349(a_F1,32)){ goto a_G8;}
a_incr(a_L2);
a_G8:a_1335(a_F1,a_P);a_L3=a_P[0];a_L4=a_P[1];
a_1151(a_F1,a_P);a_L5=a_P[0];
if(!a_1349(a_L3,8)){ goto a_G12;}
a_L3=to_LIST(a_1311)->offset[a_L3];
a_G12:a_P[0]=2130705875;a_P[1]=a_F1;a_P[2]=a_F1;a_P[3]=a_L2;a_P[4]=a_L3;a_P[5]=a_L4;a_P[6]=a_L5;a_1117(a_1001,7,a_P); return;
} /* datafiledeclaration */
static void a_1221(int a_F1){ /* ruleprototype+>a */
int a_P[1];
if(!a_1349(a_F1,12288)){ goto a_G5;}
if(!a_1351(a_F1)){ return;}
a_1236=1;
a_1235=a_F1; return;
a_G5:if(a_1348(a_F1,a_P)){ return;}
...
if(a_equal(to_LIST(a_1311)->offset[a_F1-5],155851723)){ return;}
a_incr(a_1186); return;
} /* rootprototype */
static void a_1152(void){ /* createrulenametable */
int a_L1;int a_L2;int a_L3;int a_P[2];
a_P[0]=2130705861;a_1117(a_1001,1,a_P);
a_L1=to_LIST(a_1311)->alwb;
a_L2=0;a_L3=0;
if(!a_is(a_1141)){ goto a_G9;}
if(!a_more(a_1186,0)){ goto a_G9;}
if(!a_is(a_1236)){ goto a_G9;}
a_P[0]=2130705854;a_1117(a_1001,1,a_P);
a_L2=1;a_L3=1;
...
a_G14:a_P[0]=2130705849;a_1117(a_1001,1,a_P); return;
} /* createrulenametable */
...
a_P[0]=2130705845;a_P[1]=a_F1;a_1117(a_1001,2,a_P);
...
a_G7:a_1183(0,a_L1); goto a_G4;
a_G8:a_1183(1,a_L1); goto a_G4;
a_G9:a_1144(a_L1); goto a_G4;
a_G10:a_1154(a_L1); goto a_G4;
...
static void a_1207(int a_F1){ /* pushBUFFER+>a */

{register int *a_r1=a_extension(a_1456,1);a_r1[0]=a_F1;to_LIST(a_1456)->aupb+=1;}
  return;
} /* pushBUFFER */
static void a_1163(void){ /* filltablehead */
int a_P[1];
a_P[0]=2130705841;a_1117(a_1001,1,a_P);
a_1165=0; return;
} /* filltablehead */
static void a_1164(void){ /* filltabletail */
int a_P[2];
a_P[0]=2130705834;a_P[1]=a_1165;a_1117(a_1001,2,a_P); return;
} /* filltabletail */
static void a_1232(int a_A[1]){ /* untilnextcomma+>a> */

a_G1:if(!a_more(a_A[0],to_LIST(a_1456)->aupb)){ goto a_G3;}
a_1436(a_1001,2130705825); return;
a_G3:if(!a_equal(to_LIST(a_1456)->offset[a_A[0]],44)){ goto a_G6;}
a_putchar(a_1118,44);
a_incr(a_A[0]); return;
a_G6:a_putchar(a_1118,to_LIST(a_1456)->offset[a_A[0]]);
a_incr(a_A[0]); goto a_G1;
} /* untilnextcomma */
static void a_1148(void){ /* constitem */
int a_L1;
if(!a_equal(a_1470,16777459)){ goto a_G4;}
a_1008(a_1471);
a_1477(); return;
a_G4:if(!a_equal(16777471,a_1470)){ goto a_G7;}
a_L1=a_1471;
a_1477(); goto a_G8;
a_G7:a_1431(a_1001,2130705145); return;
a_G8:if(!a_1349(a_L1,8)){ goto a_G10;}
a_L1=to_LIST(a_1311)->offset[a_L1];
a_G10:a_1008(to_LIST(a_1311)->offset[a_L1]); return;
} /* constitem */
static void a_1161(int a_A[1]){ /* fillitem+a> */

if(!a_equal(16777427,a_1470)){ goto a_G9;}
a_1477();
a_A[0]=0;
a_G4:if(!a_equal(16777406,a_1470)){ goto a_G6;}
a_1477(); return;
a_G6:a_incr(a_A[0]);
a_1148();
a_1207(44); goto a_G4;
...
static int a_1162(int a_A[1]){ /* fillrepeater+a> */
int a_L2;int a_P[1];
if(!a_equal(16777445,a_1470)){ return 0;}
a_1477();
if(!a_equal(16777455,a_1470)){ goto a_G6;}
a_A[0]=a_1471;
a_1477(); return 1;
a_G6:if(!a_equal(16777471,a_1470)){ goto a_G9;}
a_L2=a_1471;
a_1477(); goto a_G10;
a_G9:a_1431(a_1001,2130705145); return 1;
...
static void a_1168(int a_F1,int a_F2,int a_F3){ /* flushbuffer+>a+>a+>a */
int a_P[2];
a_add(a_F1,a_1165,a_1165);
a_add(a_F2,a_1165,a_1165);
a_incr(a_F3);
if(a_equal(a_F1,0)){ goto a_G7;}
a_P[0]=2130705819;a_P[1]=a_F1;a_1117(a_1001,2,a_P);
a_incr(a_1165);
a_G7:if(a_equal(a_F1,0)){ goto a_G10;}
a_P[0]=a_F3;a_1232(a_P);a_F3=a_P[0];
a_decr(a_F1); goto a_G7;
a_G10:if(a_equal(a_F2,0)){ goto a_G13;}
a_P[0]=2130705819;a_P[1]=a_F2;a_1117(a_1001,2,a_P);
a_incr(a_1165);
...
a_G1:if(!a_equal(16777409,a_1470)){ return;}
a_1477();
if(!a_equal(16777471,a_1470)){ goto a_G6;}

a_1477(); goto a_G1;
a_G6:a_1431(a_1001,2130705145); return;
} /* skipfillinitializer */
static void a_1172(void){ /* generatefillentries */
...
a_L1=a_1471;
a_1477(); goto a_G5;
a_G4:a_1431(a_1001,2130705145); return;
a_G5:if(!a_1349(a_L1,8)){ goto a_G7;}
a_L1=to_LIST(a_1311)->offset[a_L1];
a_G7:if(!a_equal(16777455,a_1470)){ goto a_G4;}

a_1477();
a_incr(a_1165);
a_P[0]=2130705816;a_P[1]=a_L1;a_P[2]=a_L1;a_1117(a_1001,3,a_P);
a_L2=to_LIST(a_1456)->aupb;
a_L3=0;
a_G14:if(!a_equal(16777439,a_1470)){ goto a_G16;}
a_1477(); goto a_G25;
a_G16:a_1161(a_P);a_L4=a_P[0];
if(!a_1162(a_P)){ goto a_G23;}a_L5=a_P[0];
a_1168(a_L3,a_L4,a_L2);
a_P[0]=2130705811;a_P[1]=a_L5;a_1117(a_1001,2,a_P);
a_incr(a_1165);
a_unstackto(a_1456,a_L2);
a_L3=0; goto a_G24;
a_G23:a_add(a_L3,a_L4,a_L3);
a_G24:a_1224(); goto a_G14;
a_G25:a_1168(a_L3,0,a_L2);
a_unstackto(a_1456,a_L2);
a_incr(a_1165);
a_P[0]=2130705807;a_1117(a_1001,1,a_P); return;
} /* generatefillentries */
static void a_1138(int a_A[3]){ /* asyncmodules+a>+a>+a> */
int a_L4;int a_L5;int a_P[2];
a_A[0]=0;a_A[1]=0;a_A[2]=0;a_L4=0;
a_G2:a_P[0]=a_L4;if(!a_1339(2,a_P)){ return;}a_L4=a_P[0];a_L5=a_P[1];
if(!a_1349(a_L5,2048)){ goto a_G2;}
a_A[0]=1;
if(!a_equal(to_LIST(a_1311)->offset[a_L5-5],155851723)){ goto a_G7;}
a_A[2]=1; goto a_G2;
a_G7:a_A[1]=1; goto a_G2;
} /* asyncmodules */
static int a_1177(void){ /* isasyncwaitfor */
int a_L1;int a_P[3];
if(!a_is(a_1171)){ return 0;}
if(!a_is(a_1236)){ return 0;}
a_1138(a_P);a_L1=a_P[1];
if(!a_is(a_L1)){ return 0;}
a_1380(a_1235,2048); return 1;
} /* isasyncwaitfor */
static void a_1184(int a_F1){ /* listinitialization+>a */
int a_L2;int a_P[4];
if(!a_1349(a_F1,16)){ return;}
a_1343(a_F1,a_P);a_L2=a_P[0];
a_P[0]=2130705803;a_P[1]=a_L2;a_P[2]=a_F1;a_P[3]=a_F1;a_1117(a_1001,4,a_P); return;
} /* listinitialization */
static void a_1145(int a_F1){ /* charfileinitialization+>a */
int a_P[4];
if(!a_1349(a_F1,16)){ goto a_G3;}
a_P[0]=2130705803;a_P[1]=to_LIST(a_1311)->offset[a_F1-1];a_P[2]=a_F1;a_P[3]=a_F1;a_1117(a_1001,4,a_P); return;
a_G3:a_P[0]=2130705797;a_P[1]=a_F1;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
} /* charfileinitialization */
static void a_1151(int a_F1,int a_A[1]){ /* countfilearea+>a+a> */
int a_L3;int a_P[1];
a_A[0]=1;
...
static void a_1155(int a_F1){ /* datafileinitialization+>a */
int a_L2;int a_L3;int a_L4;int a_P[4];
if(!a_1349(a_F1,16)){ goto a_G3;}
a_P[0]=2130705803;a_P[1]=to_LIST(a_1311)->offset[a_F1-1];a_P[2]=a_F1;a_P[3]=a_F1;a_1117(a_1001,4,a_P); return;
a_G3:a_P[0]=2130705790;a_P[1]=a_F1;a_1117(a_1001,2,a_P);
a_L4=0;
a_L3=1;
a_G6:a_1334(a_F1,a_L3,a_P);a_L2=a_P[0];
if(!a_equal(a_L2,0)){ goto a_G9;}
a_P[0]=2130705784;a_P[1]=a_F1;a_1117(a_1001,2,a_P); return;
a_G9:if(!a_1349(a_L2,8)){ goto a_G11;}
a_L2=to_LIST(a_1311)->offset[a_L2];
a_G11:a_P[0]=a_L4;a_1136(a_P);a_L4=a_P[0];
a_P[0]=2130705779;a_P[1]=a_L2;a_1117(a_1001,2,a_P);
a_incr(a_L3); goto a_G6;
} /* datafileinitialization */
static void a_1156(void){ /* datainitialization */
int a_L1;int a_P[1];
a_P[0]=2130705776;a_1117(a_1001,1,a_P);
a_L1=to_LIST(a_1311)->alwb;
...
a_G12:{register int a_r1=to_LIST(a_1311)->offset[a_L1-6];
 ...
 if(a_r1==16777345){ goto a_G14;}
  goto a_G11;}
a_G13:a_1145(a_L1); goto a_G11;
a_G14:a_1155(a_L1); goto a_G11;
} /* datainitialization */
static void a_1205(int a_F1){ /* procwaitfor+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_P[6];
a_P[0]=2130705762;a_1117(a_1001,1,a_P);
a_P[0]=2130705755;a_P[1]=a_F1;a_1117(a_1001,2,a_P);
if(!a_equal(a_1141,0)){ goto a_G5;}
a_P[0]=2130705747;a_1117(a_1001,1,a_P); goto a_G6;
a_G5:a_P[0]=2130705742;a_1117(a_1001,1,a_P);
a_G6:a_L2=0;
a_G7:a_P[0]=a_L2;if(!a_1339(2,a_P)){ goto a_G20;}a_L2=a_P[0];a_L3=a_P[1];
a_L4=to_LIST(a_1311)->offset[a_L3-5];
if(a_equal(a_L4,155851723)){ goto a_G7;}
if(!a_1349(a_L3,2048)){ goto a_G12;}
a_L5=1; goto a_G13;
a_G12:a_L5=0;
a_G13:a_P[0]=2130705728;a_P[1]=a_L4;a_P[2]=a_L4;a_P[3]=a_L4;a_P[4]=a_L5;a_P[5]=a_L3;a_1117(a_1001,6,a_P);
a_1143(a_P);
a_P[0]=2130705708;a_1117(a_1001,1,a_P);
a_P[0]=2130705705;a_P[1]=a_L4;a_P[2]=a_L4;a_P[3]=a_L4;a_1117(a_1001,4,a_P);
if(a_equal(a_1141,0)){ goto a_G19;}
a_P[0]=2130705691;a_1117(a_1001,1,a_P);
a_G19:a_P[0]=2130705687;a_1117(a_1001,1,a_P); goto a_G7;
a_G20:a_P[0]=2130705683;a_1117(a_1001,1,a_P); return;
} /* procwaitfor */
static void a_1227(void){ /* targetmain */
int a_L1;int a_L2;int a_L3;int a_L4;int a_L5;int a_L6;int a_L7;int a_P[3];
if(a_equal(a_1236,0)){ goto a_G4;}
if(a_more(a_1186,0)){ goto a_G4;}
a_P[0]=2019445184;a_1452(1,a_P);
a_G4:a_1138(a_P);a_L5=a_P[0];a_L6=a_P[1];a_L7=a_P[2];
if(a_equal(a_1236,0)){ goto a_G7;}
a_1205(a_L6);
a_G7:a_P[0]=2130705680;a_P[1]=a_L5;a_1117(a_1001,2,a_P);
if(a_equal(a_1141,0)){ goto a_G10;}
a_P[0]=2130705672;a_1117(a_1001,1,a_P);
a_G10:a_1156();
a_L1=0;a_L4=0;
a_G12:a_P[0]=a_L1;if(!a_1339(2,a_P)){ goto a_G22;}a_L1=a_P[0];a_L2=a_P[1];
if(!a_equal(to_LIST(a_1311)->offset[a_L2-5],155851723)){ goto a_G15;}
a_L4=a_L2; goto a_G12;
a_G15:if(a_is(a_1236)){ goto a_G12;}
if(!a_1349(a_L2,2048)){ goto a_G18;}
a_L5=1; goto a_G19;
a_G18:a_L5=0;
a_G19:a_P[0]=2130705661;a_P[1]=a_L5;a_P[2]=a_L2;a_1117(a_1001,3,a_P);
a_1143(a_P);
a_P[0]=2130705708;a_1117(a_1001,1,a_P); goto a_G12;
a_G22:if(a_equal(a_1236,0)){ goto a_G27;}
a_P[0]=2130705657;a_P[1]=a_L6;a_1117(a_1001,2,a_P);
a_1143(a_P);a_L3=a_P[0];
a_P[0]=a_L3;a_1136(a_P);
a_P[0]=2130705651;a_1117(a_1001,1,a_P);
a_G27:if(!a_is(a_L4)){ goto a_G31;}
a_P[0]=2130705647;a_P[1]=a_L7;a_P[2]=a_L4;a_1117(a_1001,3,a_P);
a_1143(a_P);
a_P[0]=2130705643;a_1117(a_1001,1,a_P); return;
a_G31:a_1431(a_1001,2130705639); return;
} /* targetmain */
...
a_L3=1; goto a_G4;
a_G3:a_L3=0;
a_G4:a_P[0]=2130705634;a_P[1]=a_L3;a_P[2]=a_F1;a_1117(a_1001,3,a_P);
a_1142(a_P);a_A[0]=a_P[0]; return;
} /* ruletyper */
...
static void a_1191(int a_F1,int a_A[1]){ /* outargs+>a+>a> */
int a_P[1];
if(a_equal(a_F1,0)){ return;}
a_P[0]=a_A[0];a_1136(a_P);a_A[0]=a_P[0];
a_P[0]=2130705628;a_1117(a_1001,1,a_P); return;
} /* outargs */
...
a_P[0]=a_F2;a_1191(a_L6,a_P);a_F2=a_P[0];
a_P[0]=a_F2;a_1136(a_P);
a_P[0]=2130705625;a_1117(a_1001,1,a_P); return;
a_G13:a_P[0]=a_F2;a_1136(a_P);a_F2=a_P[0];
a_P[0]=2130705619;a_P[1]=a_L4;a_1117(a_1001,2,a_P); goto a_G3;
a_G15:a_P[0]=a_F2;a_1191(a_L6,a_P);
a_putchar(a_1118,41); return;
} /* ruleargs */
...
{ if(a_L4==16777371){ goto a_G7;}
 ...
 goto a_G13;}
a_G7:a_P[0]=2130705615;a_1117(a_1001,1,a_P); goto a_G3;
a_G8:a_P[0]=2130705612;a_1117(a_1001,1,a_P); goto a_G3;
a_G9:a_P[0]=2130705609;a_1117(a_1001,1,a_P); goto a_G3;
a_G10:a_P[0]=2130705605;a_1117(a_1001,1,a_P); goto a_G3;
a_G11:a_P[0]=2130705601;a_1117(a_1001,1,a_P); goto a_G3;
a_G12:a_P[0]=2130705597;a_1117(a_1001,1,a_P); goto a_G3;
a_G13:a_P[0]=2130705593;a_1117(a_1001,1,a_P); goto a_G3;
} /* showformalsascomment */
static void a_1158(int a_F1,int a_F2,int a_F3){ /* declarelocals+>a+>a+>a */
int a_P[2];
a_G1:if(a_equal(a_F1,0)){ return;}
if(a_more(a_F1,a_F2)){ return;}
if(!a_equal(to_LIST(a_1456)->offset[a_F3],0)){ goto a_G6;}
a_G4:a_incr(a_F1);
a_incr(a_F3); goto a_G1;
a_G6:a_P[0]=2130705590;a_P[1]=a_F1;a_1117(a_1001,2,a_P); goto a_G4;
} /* declarelocals */
static void a_1157(int a_F1,int a_F2,int a_F3){ /* declarecallargs+>a+>a+>a */
int a_L4;int a_P[3];
if(a_equal(a_F2,0)){ goto a_G7;}
a_P[0]=2130705585;a_1117(a_1001,1,a_P);
a_G3:if(!a_equal(a_F2,0)){ goto a_G5;}
a_P[0]=2130705580;a_1117(a_1001,1,a_P); goto a_G7;
a_G5:a_putchar(a_1118,44);
a_decr(a_F2); goto a_G3;
a_G7:if(a_equal(a_F3,0)){ goto a_G10;}
a_1332(a_F1,a_P);a_L4=a_P[0];
a_P[0]=2130705577;a_P[1]=a_F3;a_P[2]=a_L4;a_1117(a_1001,3,a_P);
...
a_1218(a_F1,a_L8);
a_P[0]=2130705567;a_P[1]=to_LIST(a_1311)->offset[a_F1-4];a_1117(a_1001,2,a_P);
a_1223(a_F1);
a_P[0]=2130705563;a_1117(a_1001,1,a_P);
a_add(a_F5,a_F7,a_F7);
a_1158(a_F5,a_F6,a_F7);
a_1157(a_F1,a_F2,a_F3);
a_1131(a_F1);
a_1134(a_F4);
a_1132();
a_1135(); return;
...
int a_P[1];
if(a_equal(a_F1,0)){ return;}
a_P[0]=2130705560;a_1117(a_1001,1,a_P); return;
} /* startrulebody */
static void a_1220(int a_F1){ /* ruledeclarationtail+>a */
int a_P[2];
if(!a_equal(a_F1,0)){ goto a_G3;}
a_P[0]=2130705548;a_P[1]=a_1231;a_1117(a_1001,2,a_P); return;
a_G3:a_P[0]=2130705544;a_P[1]=a_1231;a_1117(a_1001,2,a_P); return;
} /* ruledeclarationtail */
static void a_1133(void){ /* addprofilingdef */
int a_L1;int a_L2;int a_P[3];
...
a_P[0]=2130705539;a_P[1]=a_L2;a_P[2]=a_L1;a_1117(a_1001,3,a_P);
if(!a_equal(a_1182,0)){ goto a_G8;}
a_P[0]=2130705528;a_1117(a_1001,1,a_P); goto a_G9;
a_G8:a_P[0]=2130705524;a_P[1]=a_1182;a_1117(a_1001,2,a_P);
a_G9:a_P[0]=2130705520;a_1117(a_1001,1,a_P);
a_1182=a_L2; return;
} /* addprofilingdef */
static void a_1132(void){ /* addprofilingcount */
int a_P[2];
...
a_P[0]=2130705516;a_P[1]=to_LIST(a_1311)->offset[a_1231];a_1117(a_1001,2,a_P); return;
} /* addprofilingcount */
static void a_1206(void){ /* profilingdeclaration */
int a_P[2];
a_P[0]=2130705509;a_1117(a_1001,1,a_P);
if(!a_equal(a_1182,0)){ goto a_G4;}
a_P[0]=2130705502;a_1117(a_1001,1,a_P); return;
a_G4:a_P[0]=2130705498;a_P[1]=a_1182;a_1117(a_1001,2,a_P); return;
...
a_G10:a_P[0]=2130705493;a_P[1]=to_LIST(a_1311)->offset[a_1231-2];a_P[2]=a_L2;a_1117(a_1001,3,a_P);
a_L3=0;
...
a_putchar(a_1118,44);
a_1169(a_L3); goto a_G12;
a_G18:a_P[0]=2130705486;a_1117(a_1001,1,a_P); return;
} /* addtracing */
static void a_1134(int a_F1){ /* addrulename+>a */
int a_P[2];
if(a_equal(a_F1,0)){ return;}
if(a_mreq(to_LIST(a_1311)->offset[a_1231-2],0)){ return;}
a_P[0]=2130705482;a_P[1]=a_1231;a_1117(a_1001,2,a_P); return;
} /* addrulename */
...
a_P[0]=2130705473;a_P[1]=a_F1;a_1117(a_1001,2,a_P); return;
} /* Tlabel */
static void a_1181(int a_F1){ /* jumptolabel+>a */
int a_P[2];
if(a_equal(a_F1,a_1188)){ return;}
a_P[0]=2130705468;a_P[1]=a_F1;a_1117(a_1001,2,a_P); return;
} /* jumptolabel */
...
int a_L2;int a_P[3];
{register int a_r1=to_LIST(a_1456)->offset[a_A[0]];
 if(a_r1==16777475||a_r1==16777479||a_r1==16777471){ goto a_G2;}
 if(a_r1==16777459){ goto a_G2;}
 if(a_r1==16777448){ goto a_G5;}
  goto a_G7;}
a_G2:a_P[0]=2130705464;a_P[1]=a_A[0];a_1117(a_1001,2,a_P);
a_G3:a_incr(a_A[0]);
a_incr(a_A[0]); return;
a_G5:a_incr(a_A[0]);
a_P[0]=a_A[0];a_1125(a_P);a_A[0]=a_P[0]; return;
a_G7:a_1128(to_LIST(a_1456)->offset[a_A[0]],a_P);a_L2=a_P[0];
a_incr(a_A[0]);
a_P[0]=2130705461;a_P[1]=a_A[0];a_P[2]=a_L2;a_1117(a_1001,3,a_P); goto a_G3;
} /* Taffixinner */
...
{ if(a_F1==16777231){ goto a_G2;}
 ...
 if(a_F1==16777299){ goto a_G6;}
  goto a_G7;}
a_G2:a_A[0]=2019445188; return;
a_G3:a_A[0]=2019445192; return;
a_G4:a_A[0]=2019445196; return;
a_G5:a_A[0]=2019445200; return;
a_G6:a_A[0]=2019445204; return;
a_G7:a_1436(a_1001,2130705457); return;
} /* Tlimittail */
static void a_1125(int a_A[1]){ /* Tindex+>a> */
int a_L2;int a_P[3];
if(!a_1349(a_1231,67108864)){ goto a_G15;}
a_P[0]=2130705452;a_P[1]=a_A[0];a_P[2]=a_A[0];a_1117(a_1001,3,a_P);
a_incr(a_A[0]);
a_incr(a_A[0]);
a_P[0]=a_A[0];a_1121(a_P);a_A[0]=a_P[0];
a_incr(a_A[0]);
a_subtr(to_LIST(a_1456)->offset[a_A[0]],1,a_L2);
a_incr(a_A[0]);
if(a_equal(a_L2,0)){ goto a_G11;}
a_P[0]=2130705444;a_P[1]=a_L2;a_1117(a_1001,2,a_P);
a_G11:a_P[0]=2130705441;a_P[1]=to_LIST(a_1311)->offset[a_1231-2];a_1117(a_1001,2,a_P);
if(!a_equal(a_1141,0)){ goto a_G14;}
a_P[0]=2130705438;a_1117(a_1001,1,a_P); return;
a_G14:a_P[0]=2130705435;a_1117(a_1001,1,a_P); return;
a_G15:a_P[0]=2130705430;a_P[1]=a_A[0];a_P[2]=a_A[0];a_1117(a_1001,3,a_P);
a_incr(a_A[0]);
a_incr(a_A[0]);
a_P[0]=a_A[0];a_1121(a_P);a_A[0]=a_P[0];
a_incr(a_A[0]);
...
a_P[0]=2130705423;a_1117(a_1001,1,a_P); return;
a_G24:a_P[0]=2130705420;a_P[1]=a_L2;a_1117(a_1001,2,a_P); return;
} /* Tindex */
static void a_1160(int a_F1,int a_F2,int a_F3){ /* extensionblock+>a+>a+>a */
int a_L4;int a_L5;int a_P[4];
a_incr(a_F3);
a_L4=a_F3;
a_G3:if(a_equal(to_LIST(a_1456)->offset[a_L4],16777436)){ goto a_G5;}
a_incr(a_L4); goto a_G3;
a_G5:a_incr(a_L4);
a_G6:if(a_less(to_LIST(a_1456)->offset[a_L4],0)){ goto a_G10;}
a_subtr(a_F2,to_LIST(a_1456)->offset[a_L4],a_L5);
a_incr(a_L4);
a_P[0]=2130705416;a_P[1]=a_F1;a_P[2]=2019445207;a_P[3]=a_L5;a_1117(a_1001,4,a_P); goto a_G6;
a_G10:a_1120(a_F3);
...
a_incr(a_F1);
a_L4=to_LIST(a_1456)->offset[a_F1];
a_incr(a_F1);
a_L3=a_F1;
a_P[0]=2130705410;a_P[1]=2019445207;a_P[2]=a_L3;a_P[3]=a_L4;a_1117(a_1001,4,a_P);
if(a_equal(a_1141,0)){ goto a_G8;}
a_P[0]=2130705691;a_1117(a_1001,1,a_P);
a_G8:a_P[0]=2130705708;a_1117(a_1001,1,a_P);
a_add(2,a_F1,a_F1);
a_G10:a_1160(a_L3,a_L4,a_F1);
a_F1=to_LIST(a_1456)->offset[a_F1];
if(!a_equal(a_F1,0)){ goto a_G10;}
a_P[0]=2130705401;a_P[1]=a_L3;a_P[2]=a_L4;a_1117(a_1001,3,a_P);
a_1181(a_F2); return;
} /* Textension */
static int a_1189(int a_F1,int a_F2){ /* numbersequal+>a+>a */
int a_L3;int a_P[1];
...
a_P[0]=2130705395;a_P[1]=a_A[0];a_1117(a_1001,2,a_P);
a_1120(a_F1);
a_P[0]=2130705390;a_1117(a_1001,1,a_P); return;
} /* boxclassifier */
static int a_1178(int a_F1){ /* iscompletearea+>a */

if(!a_equal(to_LIST(a_1456)->offset[a_F1],0)){ return 0;}
a_incr(a_F1);
a_incr(a_F1);
if(!a_equal(to_LIST(a_1456)->offset[a_F1],a_1019)){ return 0;}
a_incr(a_F1);
if(!a_equal(to_LIST(a_1456)->offset[a_F1],a_1018)){ return 0;} return 1;
} /* iscompletearea */
static void a_1130(int a_F1,int a_F2,int a_F3){ /* Tsingleifcondition+>a+>a+>a */
int a_P[5];
if(!a_1189(a_F1,a_F2)){ goto a_G3;}
a_P[0]=2130705387;a_P[1]=a_F3;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
a_G3:if(!a_1189(a_F1,a_1019)){ goto a_G5;}
a_P[0]=2130705383;a_P[1]=a_F3;a_P[2]=a_F2;a_1117(a_1001,3,a_P); return;
a_G5:if(!a_1189(a_F2,a_1018)){ goto a_G7;}
a_P[0]=2130705379;a_P[1]=a_F3;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
a_G7:a_P[0]=2130705375;a_P[1]=a_F1;a_P[2]=a_F3;a_P[3]=a_F3;a_P[4]=a_F2;a_1117(a_1001,5,a_P); return;
} /* Tsingleifcondition */
static void a_1124(int a_F1,int a_F2){ /* Tifcondition+>a+>a */
int a_L3;int a_L4;int a_P[1];
a_G1:a_incr(a_F1);
a_L3=to_LIST(a_1456)->offset[a_F1];
a_incr(a_F1);
a_L4=to_LIST(a_1456)->offset[a_F1];
a_1130(a_L3,a_L4,a_F2);
a_incr(a_F1);
if(!a_equal(to_LIST(a_1456)->offset[a_F1],16777442)){ return;}
a_P[0]=2130705368;a_1117(a_1001,1,a_P); goto a_G1;
} /* Tifcondition */
static void a_1126(int a_F1,int a_F2){ /* Tjumptoareas+>a+>a */
int a_L3;int a_L4;int a_L5;int a_P[2];
a_G1:a_L5=to_LIST(a_1456)->offset[a_F1];
if(!a_equal(a_L5,0)){ goto a_G16;}
a_incr(a_F1);
a_L3=to_LIST(a_1456)->offset[a_F1];
a_P[0]=2130705365;a_1117(a_1001,1,a_P);
a_1124(a_F1,a_F2);
a_P[0]=2130705361;a_P[1]=a_F2;a_1117(a_1001,2,a_P);
if(!a_mreq(to_LIST(a_1311)->offset[a_1231-2],0)){ goto a_G10;}
a_P[0]=2130705354;a_P[1]=to_LIST(a_1311)->offset[a_1231-2];a_1117(a_1001,2,a_P); goto a_G11;
a_G10:a_P[0]=2130705348;a_1117(a_1001,1,a_P);
a_G11:if(a_equal(a_1141,0)){ goto a_G13;}
a_P[0]=2130705691;a_1117(a_1001,1,a_P);
a_G13:a_P[0]=2130705343;a_1117(a_1001,1,a_P);
if(a_equal(a_L3,a_1188)){ return;}
a_P[0]=2130705339;a_P[1]=to_LIST(a_1456)->offset[a_F1];a_1117(a_1001,2,a_P); return;
a_G16:if(!a_1178(a_L5)){ goto a_G31;}
a_incr(a_F1);
a_L3=to_LIST(a_1456)->offset[a_F1];
a_incr(a_L5);
a_L4=to_LIST(a_1456)->offset[a_L5];
if(!a_equal(a_L3,a_1188)){ goto a_G26;}
if(a_equal(a_L3,a_L4)){ return;}
a_P[0]=2130705365;a_1117(a_1001,1,a_P);
a_1124(a_F1,a_F2);
a_P[0]=2130705336;a_P[1]=a_L4;a_1117(a_1001,2,a_P); return;
a_G26:a_P[0]=2130705331;a_1117(a_1001,1,a_P);
a_1124(a_F1,a_F2);
a_P[0]=2130705327;a_P[1]=a_L3;a_1117(a_1001,2,a_P);
if(a_equal(a_L4,a_1188)){ return;}
a_P[0]=2130705339;a_P[1]=a_L4;a_1117(a_1001,2,a_P); return;
a_G31:a_incr(a_F1);
a_P[0]=2130705331;a_1117(a_1001,1,a_P);
a_1124(a_F1,a_F2);
a_P[0]=2130705322;a_P[1]=to_LIST(a_1456)->offset[a_F1];a_1117(a_1001,2,a_P);
a_F1=a_L5; goto a_G1;
} /* Tjumptoareas */
static void a_1122(int a_F1,int a_F2){ /* Tbox+>a+>a */
int a_L3;int a_P[1];
a_P[0]=2130705318;a_1117(a_1001,1,a_P);
a_incr(a_F1);
a_1139(a_F1,a_P);a_L3=a_P[0];
a_incr(a_F2);
a_1126(a_F2,a_L3);
a_P[0]=2130705683;a_1117(a_1001,1,a_P); return;
} /* Tbox */
...
a_1140=a_F1;
a_incr(a_F7);
if(!a_1180(a_F7,a_F3,a_F4)){ goto a_G5;}
a_P[0]=2130705315;a_P[1]=a_F1;a_P[2]=a_F4;a_1117(a_1001,3,a_P); return;
a_G5:if(!a_1351(a_F1)){ goto a_G7;}
a_1175(a_F7,a_F4); return;
a_G7:if(!a_1347(a_F1)){ goto a_G9;}
a_1170(a_F5,a_F6,a_F7,a_F4); return;
a_G9:if(!a_1348(a_F1,a_P)){ goto a_G13;}a_L8=a_P[0];
if(!a_equal(a_L8,1)){ goto a_G12;}
a_1174(a_F3,a_F4); return;
a_G12:a_1173(a_F2,a_F7,a_F4); return;
a_G13:if(!a_1349(a_F1,12288)){ goto a_G18;}
a_1208(1,a_F3,a_F4,a_P);a_L9=a_P[0];
a_1193(a_L9,a_F7);
a_1209(a_L9,a_F3);
a_G17:a_1210(a_L9,a_F3,a_F4); return;
a_G18:a_1212(a_F7);
a_1208(0,a_F3,a_F4,a_P);a_L9=a_P[0];
a_1213(a_F7);
a_1209(a_L9,a_F3);
a_1211(a_F7); goto a_G17;
} /* Trulecall */
static void a_1187(int a_A[1]){ /* nextaffix+>a> */

a_G1:if(!a_equal(to_LIST(a_1456)->offset[a_A[0]],16777436)){ goto a_G3;}
a_incr(a_A[0]); return;
a_G3:a_incr(a_A[0]); goto a_G1;
} /* nextaffix */
static int a_1179(int a_F1){ /* isdummyaffix+>a */

{register int a_r1=to_LIST(a_1456)->offset[a_F1];
 if(a_r1==16777424||a_r1==16777409){ return 1;}
  return 0;}
} /* isdummyaffix */
static int a_1176(int a_F1){ /* hasoutaffix+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_1341(a_1140,a_P);a_L2=a_P[0];
a_L3=0;
a_G3:if(a_mreq(a_L3,a_L2)){ return 0;}
if(!a_1179(a_F1)){ goto a_G7;}
a_G5:a_incr(a_L3);
a_P[0]=a_F1;a_1187(a_P);a_F1=a_P[0]; goto a_G3;
a_G7:a_1337(a_1140,a_L3,a_P);a_L4=a_P[0];
if(a_equal(a_L4,16777376)){ return 1;}
if(a_equal(a_L4,16777382)){ return 1;}
if(a_equal(a_L4,16777388)){ return 1;} goto a_G5;
} /* hasoutaffix */
static int a_1180(int a_F1,int a_F2,int a_F3){ /* isrulediscarded+>a+>a+>a */

if(a_1349(a_1140,256)){ return 0;}
if(a_1349(a_1140,1024)){ return 0;}
if(a_1349(a_1140,32768)){ return 0;}
if(a_1176(a_F1)){ return 0;}
if(!a_1349(a_1140,512)){ return 1;}
if(!a_equal(a_F2,a_F3)){ return 0;} return 1;
} /* isrulediscarded */
static void a_1174(int a_F1,int a_F2){ /* genshiftaffix+>a+>a */
int a_L3;int a_P[4];
a_1332(a_1231,a_P);a_L3=a_P[0];
if(a_equal(a_F1,a_1188)){ goto a_G6;}
if(!a_equal(a_F1,a_F2)){ goto a_G5;}
a_F2=a_1188; goto a_G6;
a_G5:if(!a_noteq(a_F2,a_1188)){ goto a_G7;}
a_G6:a_P[0]=2130705309;a_P[1]=a_L3;a_P[2]=a_F2;a_P[3]=a_F1;a_1117(a_1001,4,a_P); return;
a_G7:a_P[0]=2130705298;a_P[1]=a_F1;a_P[2]=a_L3;a_1117(a_1001,3,a_P); return;
} /* genshiftaffix */
static void a_1173(int a_F1,int a_F2,int a_F3){ /* gengetaffixno+>a+>a+>a */
int a_P[2];
if(!a_noteq(a_F1,2)){ goto a_G3;}
a_1431(a_1001,2130705288); return;
a_G3:if(!a_1179(a_F2)){ goto a_G5;}
a_P[0]=2130705282;a_P[1]=a_F3;a_1117(a_1001,2,a_P); return;
a_G5:a_1120(a_F2);
a_P[0]=2130705278;a_P[1]=a_F3;a_1117(a_1001,2,a_P); return;
} /* gengetaffixno */
static void a_1175(int a_F1,int a_F2){ /* genwaitfor+>a+>a */
int a_L3;int a_P[2];
a_P[0]=2130705273;a_1117(a_1001,1,a_P);
a_1143(a_P);a_L3=a_P[0];
a_P[0]=a_L3;a_1136(a_P);a_L3=a_P[0];
a_1120(a_F1);
a_P[0]=a_F1;a_1187(a_P);a_F1=a_P[0];
a_P[0]=a_L3;a_1136(a_P);
a_1120(a_F1);
a_P[0]=2130705268;a_P[1]=a_F2;a_1117(a_1001,2,a_P); return;
} /* genwaitfor */
...
a_P[0]=2130705264;a_P[1]=a_A[0];a_1117(a_1001,2,a_P);
a_1120(a_F1);
a_putchar(a_1118,59);
a_A[1]=1; return;
} /* assignmentsource */
static void a_1170(int a_F1,int a_F2,int a_F3,int a_F4){ /* genassignment+>a+>a+>a+>a */
int a_L5;int a_L6;int a_L7;int a_L8;int a_L9;int a_P[6];
a_L5=a_F3;
a_P[0]=a_F3;a_1187(a_P);a_F3=a_P[0];
a_L8=0;
a_L9=1;
a_G5:if(a_mreq(a_L9,a_F1)){ goto a_G10;}
a_incr(a_L9);
a_P[0]=a_F3;a_1187(a_P);a_F3=a_P[0];
{register int a_r1=to_LIST(a_1456)->offset[a_F3];
...
a_G26:a_P[0]=2130705259;a_P[1]=a_L6;a_1117(a_1001,2,a_P); goto a_G17;
a_G27:if(a_equal(a_F2,0)){ goto a_G29;}
a_P[0]=2130705255;a_P[1]=2019445210;a_P[2]=2019445210;a_P[3]=2019445210;a_P[4]=2019445210;a_P[5]=a_L6;a_1117(a_1001,6,a_P);
a_G29:if(a_equal(a_L7,0)){ goto a_G31;}
a_putchar(a_1118,125);
a_G31:a_P[0]=2130705282;a_P[1]=a_F4;a_1117(a_1001,2,a_P); return;
} /* genassignment */
static void a_1216(int a_F1,int a_F2,int a_F3,int a_F4){ /* repeatblockpreload+>a+>a+>a+>a */
int a_L5;int a_L6;int a_L7;int a_L8;int a_L9;int a_P[3];
a_incr(a_F1);
a_L5=to_LIST(a_1456)->offset[a_F1];
a_P[0]=a_F1;a_1187(a_P);a_F1=a_P[0];
a_L9=a_F3;
...
a_G8:a_L7=a_L5;
a_G9:a_1332(a_1140,a_P);a_L6=a_P[0];
a_mult(a_L7,a_L6,a_L7);
a_G11:if(a_equal(a_L7,0)){ goto a_G25;}
a_1337(a_1140,a_L9,a_P);a_L8=a_P[0];
if(a_equal(a_L8,16777376)){ goto a_G19;}
if(!a_more(a_L5,0)){ goto a_G18;}
a_P[0]=2130705242;a_P[1]=a_F4;a_1117(a_1001,2,a_P);
a_G16:a_1120(a_F1);
a_putchar(a_1118,59); goto a_G19;
a_G18:a_P[0]=2130705238;a_P[1]=a_F4;a_1117(a_1001,2,a_P); goto a_G16;
a_G19:a_incr(a_L9);
if(a_less(a_L9,a_F2)){ goto a_G22;}
a_L9=a_F3;
a_G22:a_decr(a_L7);
a_incr(a_F4);
a_P[0]=a_F1;a_1187(a_P);a_F1=a_P[0]; goto a_G11;
a_G25:if(a_mreq(a_L5,0)){ return;}
a_P[0]=2130705234;a_P[1]=a_L6;a_P[2]=a_F4;a_1117(a_1001,3,a_P); return;
} /* repeatblockpreload */
static void a_1212(int a_F1){ /* regularcallpreload+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_P[2];
a_1341(a_1140,a_P);a_L2=a_P[0];
a_L3=0;a_L4=0;
a_G3:if(a_equal(a_L3,a_L2)){ return;}
a_1337(a_1140,a_L3,a_P);a_L5=a_P[0];
a_incr(a_L3);
if(!a_equal(a_L5,16777376)){ goto a_G9;}
a_incr(a_L4);
a_G8:a_P[0]=a_F1;a_1187(a_P);a_F1=a_P[0]; goto a_G3;
a_G9:if(!a_equal(a_L5,16777382)){ goto a_G14;}
a_P[0]=2130705242;a_P[1]=a_L4;a_1117(a_1001,2,a_P);
a_incr(a_L4);
a_1120(a_F1);
a_putchar(a_1118,59); goto a_G8;
a_G14:if(!a_equal(a_L5,16777388)){ goto a_G8;}
a_1216(a_F1,a_L2,a_L3,a_L4); return;
} /* regularcallpreload */
static void a_1214(int a_F1,int a_F2,int a_F3){ /* repeatblockcall+>a+>a+>a */
int a_L4;int a_P[3];
if(a_equal(a_F2,0)){ goto a_G4;}
a_P[0]=a_F3;a_1136(a_P);a_F3=a_P[0];
a_P[0]=2130705218;a_1117(a_1001,1,a_P);
a_G4:a_incr(a_F1);
a_L4=to_LIST(a_1456)->offset[a_F1];
...
a_subtr(0,a_L4,a_L4);
a_P[0]=2130705215;a_P[1]=a_L4;a_1117(a_1001,2,a_P); return;
a_G12:if(!a_equal(a_F2,0)){ goto a_G14;}
a_P[0]=2130705210;a_P[1]=a_L4;a_1117(a_1001,2,a_P); return;
a_G14:a_P[0]=2130705205;a_P[1]=a_L4;a_P[2]=a_F2;a_1117(a_1001,3,a_P); return;
} /* repeatblockcall */
static void a_1213(int a_F1){ /* regularrulecall+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_L6;int a_L7;int a_P[3];
a_1341(a_1140,a_P);a_L2=a_P[0];
a_L7=0;
if(!a_1349(a_1140,2048)){ goto a_G7;}
a_L7=1;
if(a_1349(a_1231,2048)){ goto a_G7;}
a_P[0]=2019445255;a_P[1]=a_1140;a_P[2]=a_1231;a_1432(3,a_P);
a_G7:a_P[0]=2130705661;a_P[1]=a_L7;a_P[2]=a_1140;a_1117(a_1001,3,a_P);
a_L3=0;a_L4=0;
if(!a_1349(a_1140,16)){ goto a_G11;}
a_L5=0; goto a_G12;
a_G11:a_1143(a_P);a_L5=a_P[0];
a_G12:if(!a_equal(a_L3,a_L2)){ goto a_G17;}
if(!a_equal(a_L4,0)){ goto a_G15;}
a_putchar(a_1118,41); return;
a_G15:a_P[0]=a_L5;a_1136(a_P);
a_P[0]=2130705200;a_1117(a_1001,1,a_P); return;
a_G17:a_1337(a_1140,a_L3,a_P);a_L6=a_P[0];
a_incr(a_L3);
if(a_equal(a_L6,16777376)){ goto a_G21;}
if(!a_equal(a_L6,16777382)){ goto a_G23;}
a_G21:a_incr(a_L4);
a_G22:a_P[0]=a_F1;a_1187(a_P);a_F1=a_P[0]; goto a_G12;
a_G23:if(!a_equal(a_L6,16777388)){ goto a_G25;}
a_1214(a_F1,a_L4,a_L5); return;
a_G25:a_P[0]=a_L5;a_1136(a_P);a_L5=a_P[0];
a_1120(a_F1); goto a_G22;
} /* regularrulecall */
static void a_1215(int a_F1,int a_F2,int a_F3,int a_F4){ /* repeatblockpostload+>a+>a+>a+>a */
int a_L5;int a_L6;int a_L7;int a_L8;int a_L9;int a_P[3];
a_incr(a_F1);
a_L5=to_LIST(a_1456)->offset[a_F1];
a_P[0]=a_F1;a_1187(a_P);a_F1=a_P[0];
...
a_1337(a_1140,a_L7,a_P);a_L9=a_P[0];
if(a_1179(a_F1)){ goto a_G20;}
if(a_equal(a_L9,16777376)){ goto a_G16;}
if(!a_equal(a_L9,16777382)){ goto a_G20;}
a_G16:a_1120(a_F1);
if(!a_more(a_L5,0)){ goto a_G19;}
a_P[0]=2130705197;a_P[1]=a_F4;a_1117(a_1001,2,a_P); goto a_G20;
a_G19:a_P[0]=2130705192;a_P[1]=a_F4;a_1117(a_1001,2,a_P);
a_G20:a_incr(a_L7);
...
a_P[0]=2130705187;a_P[1]=a_L6;a_P[2]=a_F4;a_1117(a_1001,3,a_P); return;
} /* repeatblockpostload */
static void a_1211(int a_F1){ /* regularcallpostload+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_P[2];
a_1341(a_1140,a_P);a_L2=a_P[0];
a_L3=0;a_L4=0;
a_G3:if(a_equal(a_L3,a_L2)){ return;}
...
a_G8:if(a_1179(a_F1)){ goto a_G11;}
a_1120(a_F1);
a_P[0]=2130705197;a_P[1]=a_L4;a_1117(a_1001,2,a_P);
a_G11:a_incr(a_L4);
a_G12:a_P[0]=a_F1;a_1187(a_P);a_F1=a_P[0]; goto a_G3;
a_G13:if(!a_equal(a_L5,16777388)){ goto a_G12;}
a_1215(a_F1,a_L2,a_L3,a_L4); return;
} /* regularcallpostload */
static void a_1208(int a_F1,int a_F2,int a_F3,int a_A[1]){ /* regularcalld1+>a+>a+>a+a> */
int a_P[1];
if(!a_1349(a_1140,512)){ goto a_G10;}
if(!a_noteq(a_F2,a_1188)){ goto a_G9;}
if(a_equal(a_F3,a_1188)){ goto a_G5;}
if(!a_lseq(a_F2,0)){ goto a_G9;}
a_G5:a_A[0]=2;
if(!a_equal(a_F1,0)){ goto a_G8;}
a_P[0]=2130705171;a_1117(a_1001,1,a_P); return;
a_G8:a_P[0]=2130705167;a_1117(a_1001,1,a_P); return;
a_G9:a_A[0]=1; goto a_G8;
a_G10:a_A[0]=0; return;
} /* regularcalld1 */
static void a_1209(int a_F1,int a_F2){ /* regularcalld2+>a+>a */
int a_P[2];
if(!a_equal(a_F1,1)){ goto a_G3;}
a_P[0]=2130705164;a_1117(a_1001,1,a_P); return;
a_G3:if(!a_equal(a_F1,2)){ goto a_G5;}
a_P[0]=2130705161;a_P[1]=a_F2;a_1117(a_1001,2,a_P); return;
a_G5:a_putchar(a_1118,59); return;
} /* regularcalld2 */
static void a_1210(int a_F1,int a_F2,int a_F3){ /* regularcalld3+>a+>a+>a */
int a_P[3];
if(!a_equal(a_F1,1)){ goto a_G4;}
a_P[0]=2130705157;a_P[1]=a_F3;a_P[2]=a_F2;a_1117(a_1001,3,a_P); return;
a_G4:a_P[0]=2130705282;a_P[1]=a_F3;a_1117(a_1001,2,a_P); return;
} /* regularcalld3 */
static void a_1192(int a_F1,int a_A[1]){ /* pidginalttagtailtype+>a+a> */
int a_L3;int a_L4;int a_L5;int a_P[1];
a_1341(a_1140,a_P);a_L3=a_P[0];
a_L4=0;a_A[0]=0;
a_G3:if(a_equal(a_L4,a_L3)){ return;}
a_1337(a_1140,a_L4,a_P);a_L5=a_P[0];
a_incr(a_L4);
if(!a_equal(a_L5,16777376)){ goto a_G10;}
a_leftclear(a_A[0],1);
if(a_equal(to_LIST(a_1456)->offset[a_F1],16777424)){ goto a_G10;}
a_incr(a_A[0]);
a_G10:if(a_equal(a_L5,16777388)){ return;}
a_P[0]=a_F1;a_1187(a_P);a_F1=a_P[0]; goto a_G3;
} /* pidginalttagtailtype */
static int a_1146(int a_F1,int a_A[1]){ /* checkBUFFERno+>a+>a> */
int a_L3;
a_subtr(to_LIST(a_1456)->offset[a_A[0]],48,a_L3);
a_incr(a_A[0]);
a_G3:if(!a_equal(to_LIST(a_1456)->offset[a_A[0]],48)){ goto a_G6;}
a_incr(a_A[0]);
a_leftclear(a_L3,1); goto a_G3;
a_G6:if(!a_equal(to_LIST(a_1456)->offset[a_A[0]],49)){ goto a_G10;}
a_incr(a_A[0]);
a_leftclear(a_L3,1);
a_incr(a_L3); goto a_G3;
a_G10:if(!a_equal(a_L3,a_F1)){ return 0;} return 1;
} /* checkBUFFERno */
static void a_1167(int a_F1,int a_A[1]){ /* findBUFFERversion+>a+>a> */
int a_P[4];
a_G1:if(!a_mreq(a_A[0],to_LIST(a_1456)->aupb)){ goto a_G4;}
a_decr(a_A[0]);
a_P[0]=2019445226;a_P[1]=to_LIST(a_1311)->offset[a_1140];a_P[2]=a_1140;a_P[3]=a_F1;a_1432(4,a_P); return;
a_G4:if(!a_equal(to_LIST(a_1456)->offset[a_A[0]],64)){ goto a_G8;}
a_incr(a_A[0]);
if(!a_equal(to_LIST(a_1456)->offset[a_A[0]],48)){ goto a_G9;}
a_G7:a_P[0]=a_A[0];if(a_1146(a_F1,a_P)){a_A[0]=a_P[0]; return;}
a_G8:a_incr(a_A[0]); goto a_G1;
a_G9:if(a_equal(to_LIST(a_1456)->offset[a_A[0]],49)){ goto a_G7;} goto a_G1;
} /* findBUFFERversion */
static void a_1166(int a_A[1]){ /* findBUFFERalternative+>a> */

a_G1:if(!a_equal(to_LIST(a_1456)->offset[a_A[0]],64)){ goto a_G3;}
a_incr(a_A[0]); return;
a_G3:if(!a_less(a_A[0],to_LIST(a_1456)->aupb)){ goto a_G5;}
a_incr(a_A[0]); goto a_G1;
a_G5:a_1436(a_1001,2130705153); return;
} /* findBUFFERalternative */
static void a_1150(int a_F1,int a_F2,int a_F3){ /* copytextfromBUFFER+>a+>a+>a */
int a_L4;
a_G1:if(a_more(a_F1,to_LIST(a_1456)->aupb)){ return;}
if(a_equal(to_LIST(a_1456)->offset[a_F1],64)){ return;}
if(!a_equal(to_LIST(a_1456)->offset[a_F1],35)){ goto a_G17;}
a_incr(a_F1);
{register int a_r1=to_LIST(a_1456)->offset[a_F1];
 ...
 if(a_r1==48){ goto a_G14;}
  goto a_G17;}
a_G6:a_subtr(to_LIST(a_1456)->offset[a_F1],48,a_L4);
a_G7:a_1149(a_F2,a_F3,a_L4);
a_G8:a_incr(a_F1); goto a_G1;
a_G9:a_subtr(to_LIST(a_1456)->offset[a_F1],97,a_L4);
a_add(10,a_L4,a_L4); goto a_G7;
a_G11:a_incr(a_F1);
if(a_equal(a_1141,0)){ goto a_G1;}
a_1500(a_1118,a_1001,2130705691); goto a_G1;
a_G14:a_incr(a_F1);
if(a_equal(a_1141,0)){ goto a_G1;}
a_1500(a_1118,a_1001,2130706037); goto a_G1;
a_G17:a_putchar(a_1118,to_LIST(a_1456)->offset[a_F1]); goto a_G8;
} /* copytextfromBUFFER */
static void a_1149(int a_F1,int a_F2,int a_F3){ /* copyaffix+>a+>a+>a */
int a_P[4];
if(!a_more(a_F3,a_F1)){ goto a_G3;}
a_P[0]=2019445241;a_P[1]=to_LIST(a_1311)->offset[a_1140];a_P[2]=a_1140;a_P[3]=a_F3;a_1432(4,a_P); return;
a_G3:if(a_equal(a_F3,1)){ goto a_G6;}
a_decr(a_F3);
a_P[0]=a_F2;a_1187(a_P);a_F2=a_P[0]; goto a_G3;
a_G6:a_1120(a_F2); return;
} /* copyaffix */
static void a_1193(int a_F1,int a_F2){ /* pidginrulecall+>a+>a */
int a_L3;int a_L4;int a_L5;int a_P[1];
a_L3=to_LIST(a_1456)->aupb;
a_1469(to_LIST(a_1311)->offset[a_1140],a_P);a_L5=a_P[0];
a_unpackstring(a_1460,a_L5,a_1456);
a_1207(64);
a_L5=a_L3;
a_incr(a_L5);
if(!a_1349(a_1140,8192)){ goto a_G10;}
a_1192(a_F2,a_P);a_L4=a_P[0];
a_P[0]=a_L5;a_1167(a_L4,a_P);a_L5=a_P[0];
a_G10:if(a_noteq(a_F1,2)){ goto a_G12;}
a_P[0]=a_L5;a_1166(a_P);a_L5=a_P[0];
a_G12:a_1341(a_1140,a_P);a_L4=a_P[0];
a_1150(a_L5,a_L4,a_F2);
a_unstackto(a_1456,a_L3); return;
} /* pidginrulecall */
...
a_G3:a_1431(a_1001,2130706143); return;
} /* checklisttype */
...
a_G3:a_1431(a_1001,2130706137); return;
} /* checkcalibretype */
...
a_G5:a_1431(a_1001,2130706130); return;
} /* checkconstanttype */
static void a_1263(void){ /* readexpression */
int a_L1;int a_L2;int a_P[1];
if(!a_equal(16777471,a_1470)){ goto a_G4;}
a_L1=a_1471;
a_1477(); goto a_G5;
a_G4:a_1431(a_1001,2130706102); return;
a_G5:a_1245(a_L1,1);
if(a_equal(to_LIST(a_1311)->offset[a_L1-1],0)){ goto a_G8;}
a_G7:a_1431(a_1001,2130706123); return;
a_G8:a_1262(a_L1);
a_L2=to_LIST(a_1239)->aupb;
a_1262(a_1255);
a_1255=a_L2;
to_LIST(a_1311)->offset[a_L1-1]=to_LIST(a_1239)->aupb;
a_G13:{ if(a_1470==16777439){ goto a_G14;}
 if(a_1470==16777459){ goto a_G16;}
 if(a_1470==16777471){ goto a_G19;}
 if(a_1470==16777269||a_1470==16777291){ goto a_G23;}
 if(a_1470==16777231){ goto a_G31;}
 if(a_1470==16777436||a_1470==16777421||a_1470==16777445||a_1470==16777418||a_1470==16777400||a_1470==16777430||a_1470==16777451||a_1470==16777415||a_1470==16777427||a_1470==16777406){ goto a_G39;}
  goto a_G7;}
a_G14:a_1477();
a_1262(16777439); return;
a_G16:a_1262(16777459);
a_1262(a_1471);
a_G18:a_1477(); goto a_G13;
a_G19:a_L1=a_1471;
...
a_G39:a_1262(a_1470); goto a_G18;
} /* readexpression */
...
a_1436(a_1001,2130706117); return;
a_G3:if(a_1349(a_F1,32)){ return;}
if(!a_1349(a_F1,64)){ goto a_G8;}
a_P[0]=2019445269;a_P[1]=to_LIST(a_1311)->offset[a_F1-4];a_P[2]=a_F1;a_1432(3,a_P);
...
a_1431(a_1001,2130706117); return;
...
a_G24:a_1431(a_1001,2130706112); return;
} /* finalbase */
...
int a_L2;int a_L3;int a_P[3];
if(!a_1349(a_F1,8)){ goto a_G3;}
a_1436(a_1001,2130706107); return;
a_G3:if(a_1349(a_F1,32)){ return;}
if(!a_1349(a_F1,64)){ goto a_G8;}
a_P[0]=2019445269;a_P[1]=to_LIST(a_1311)->offset[a_F1-4];a_P[2]=a_F1;a_1432(3,a_P);
...
a_incr(a_1248);
if(a_was(a_1239,a_1248)){ goto a_G14;}
a_1431(a_1001,2130706107); return;
...
int a_L3;int a_L4;int a_L5;int a_P[1];
a_1266(155851690,a_P);a_L3=a_P[0];
a_1266(155851697,a_P);a_L4=a_P[0];
...
a_G3:if(!a_equal(16777486,a_1470)){ goto a_G6;}
a_1477();
a_1431(a_1001,2130706227); return;
a_G6:a_1477(); goto a_G1;
} /* skipentry */
static void a_1303(void){ /* skipdatasection */

a_G1:if(!a_equal(16777254,a_1470)){ goto a_G4;}
a_G2:a_1477();
a_1304(); goto a_G1;
a_G4:if(a_equal(16777236,a_1470)){ goto a_G2;}
if(a_equal(16777266,a_1470)){ goto a_G2;}
if(a_equal(16777250,a_1470)){ goto a_G2;}
if(a_equal(16777224,a_1470)){ goto a_G2;}
if(a_equal(16777258,a_1470)){ goto a_G2;}
if(a_equal(16777246,a_1470)){ goto a_G2;}
if(a_equal(a_1470,16777285)){ return;}
a_1431(a_1001,2130706222); return;
} /* skipdatasection */
static void a_1277(void){ /* datasectioni */

if(a_1453()){ return;}
a_G2:if(!a_equal(16777254,a_1470)){ goto a_G5;}
a_1477();
a_1305(); goto a_G2;
a_G5:if(!a_equal(16777236,a_1470)){ goto a_G8;}
a_1477();
a_1263(); goto a_G2;
a_G8:if(!a_equal(16777266,a_1470)){ goto a_G11;}
a_1477();
a_1289(); goto a_G2;
a_G11:if(!a_equal(16777250,a_1470)){ goto a_G14;}
a_1477();
a_1282(); goto a_G2;
a_G14:if(!a_equal(16777224,a_1470)){ goto a_G17;}
a_G15:a_1477();
a_1304(); goto a_G2;
a_G17:if(a_equal(16777258,a_1470)){ goto a_G15;}
if(a_equal(16777246,a_1470)){ goto a_G15;}
if(a_equal(a_1470,16777285)){ return;}
a_1431(a_1001,2130706216); return;
} /* datasectioni */
...
if(!a_1349(a_F1,24)){ return;}
a_G3:a_1431(a_1001,2130706210); return;
} /* checklisttype */
...
a_G4:a_1431(a_1001,2130706204); return;
} /* checkconstanttype */
...
a_G3:a_1431(a_1001,2130706197); return;
...
if(!a_1349(a_F1,24)){ return;}
a_G3:a_1431(a_1001,2130706189); return;
} /* checkfiletype */
static void a_1282(void){ /* fileentry */
int a_L1;int a_L2;int a_L3;int a_P[1];
if(!a_equal(16777471,a_1470)){ goto a_G4;}
a_L1=a_1471;
a_1477(); goto a_G5;
a_G4:a_1431(a_1001,2130706147); return;
a_G5:a_1271(a_L1);
if(!a_equal(16777455,a_1470)){ goto a_G4;}
a_L2=a_1471;
a_1477();
...
a_G15:a_1368(a_L1);
if(!a_equal(16777439,a_1470)){ goto a_G4;}
...
a_1477();
a_1298(a_L1);
a_G11:if(!a_equal(16777439,a_1470)){ goto a_G13;}
a_1477(); return;
a_G13:a_1307();
a_1308(a_L1);
...
static void a_1273(void){ /* checkfillitem */
int a_L1;
if(!a_equal(16777459,a_1470)){ goto a_G3;}
a_1477(); return;
a_G3:if(!a_equal(16777471,a_1470)){ goto a_G6;}
a_L1=a_1471;
a_1477(); goto a_G7;
a_G6:a_1431(a_1001,2130706147); return;
a_G7:a_1272(a_L1); return;
} /* checkfillitem */
static void a_1307(void){ /* skipfillitem */

if(!a_equal(16777427,a_1470)){ goto a_G6;}
a_1477();
a_G3:if(!a_equal(16777406,a_1470)){ goto a_G5;}
a_1477(); return;
...
if(!a_equal(16777445,a_1470)){ return;}
a_1477();
if(!a_equal(16777455,a_1470)){ goto a_G9;}
a_L3=a_1471;
a_1477();
if(!a_lseq(1,a_L3)){ goto a_G8;}
if(a_lseq(a_L3,1000)){ return;}
a_G8:a_P[0]=2019445285;a_P[1]=to_LIST(a_1311)->offset[a_F1-4];a_P[2]=a_L3;a_P[3]=1000;a_1432(4,a_P); return;
a_G9:if(!a_equal(16777471,a_1470)){ goto a_G12;}
a_L2=a_1471;
a_1477(); goto a_G13;
a_G12:a_1431(a_1001,2130706147); return;
...
a_G10:a_1431(a_1001,2130706183); return;
...
{ if(a_L2==0||a_L2==1||a_L2==2){ goto a_G10;}
 if(a_L2==3||a_L2==4){ goto a_G13;}
  goto a_G17;}
a_G10:if(!a_equal(16777455,a_1470)){ goto a_G4;}
a_L3=a_1471;
a_1477(); goto a_G18;
a_G13:if(!a_equal(16777471,a_1470)){ goto a_G4;}
a_L3=a_1471;
a_1477();
a_1270(a_L3,1); goto a_G18;
a_G17:a_1431(a_1001,2130706176); return;
...
a_G3:a_P[0]=2019445300;a_P[1]=to_LIST(a_1311)->offset[a_F2-4];a_P[2]=a_F1;a_P[3]=a_F2;a_1452(4,a_P);
a_G4:a_min(100,a_F1);
a_max(1,a_F1);
a_subtr(0,a_F1,a_F1);
...
a_G3:a_P[0]=2019445313;a_P[1]=to_LIST(a_1311)->offset[a_F2-4];a_P[2]=a_F1;a_P[3]=a_F2;a_1452(4,a_P);
...
a_A[0]=1;
a_P[0]=2019445325;a_P[1]=to_LIST(a_1311)->offset[a_F2-4];a_P[2]=to_LIST(a_1311)->offset[a_F1-4];a_P[3]=a_F2;a_1432(4,a_P); return;
} /* getestimator */
static void a_1278(void){ /* datasectionii */
...
a_G6:a_1477();
a_1304(); goto a_G2;
a_G8:if(a_equal(16777266,a_1470)){ goto a_G6;}
if(a_equal(16777250,a_1470)){ goto a_G6;}
if(!a_equal(16777224,a_1470)){ goto a_G13;}
a_1477();
a_1296(0); goto a_G2;
a_G13:if(!a_equal(16777258,a_1470)){ goto a_G16;}
a_1477();
a_1296(1); goto a_G2;
a_G16:if(!a_equal(16777246,a_1470)){ goto a_G19;}
a_1477();
a_1281(); goto a_G2;
a_G19:if(a_equal(a_1470,16777285)){ return;}
a_1436(a_1001,2130706171); return;
} /* datasectionii */
static void a_1281(void){ /* externalentry */
int a_L1;int a_L2;
if(!a_equal(16777471,a_1470)){ goto a_G4;}
...
a_1477(); goto a_G5;
a_G4:a_1431(a_1001,2130706147); return;
a_G5:if(!a_equal(16777483,a_1470)){ goto a_G4;}
a_L2=a_1471;
a_1477();
if(!a_equal(16777439,a_1470)){ goto a_G4;}
...
a_G12:a_1431(a_1001,2130706165); return;
...
int a_L2;
if(!a_equal(16777483,a_1470)){ goto a_G4;}
a_L2=a_1471;
a_1477(); goto a_G5;
a_G4:a_1431(a_1001,2130706147); return;
a_G5:if(!a_equal(16777439,a_1470)){ goto a_G4;}
...
a_L2=a_1471;
a_1477();
a_G9:if(!a_equal(16777439,a_1470)){ goto a_G11;}
a_1477(); return;
...
if(!a_equal(16777427,a_1470)){ goto a_G12;}
a_1477();
a_A[0]=0;
a_G4:if(!a_equal(16777406,a_1470)){ goto a_G6;}
a_1477(); return;
a_G6:if(!a_equal(16777459,a_1470)){ goto a_G9;}
a_G7:a_1477();
a_incr(a_A[0]); goto a_G4;
a_G9:if(!a_equal(16777471,a_1470)){ goto a_G11;}
 goto a_G7;
a_G11:a_1431(a_1001,2130706147); return;
a_G12:if(!a_equal(16777459,a_1470)){ goto a_G15;}
a_G13:a_1477();
a_A[0]=1; return;
a_G15:if(!a_equal(16777471,a_1470)){ goto a_G11;}
 goto a_G13;
} /* loosefillitem */
...
a_G4:a_P[0]=2019445358;a_P[1]=to_LIST(a_1311)->offset[a_F1-4];a_P[2]=a_F2;a_P[3]=a_A[0];a_P[4]=to_LIST(a_1311)->offset[a_F3-4];a_P[5]=1000;a_1432(6,a_P);
a_A[0]=1; return;
a_G6:a_A[0]=1;
a_P[0]=2019445339;a_P[1]=to_LIST(a_1311)->offset[a_F1-4];a_P[2]=a_F2;a_P[3]=to_LIST(a_1311)->offset[a_F3-4];a_1432(4,a_P); return;
} /* repeatervalue */
static void a_1294(int a_F1,int a_F2,int a_F3){ /* looserepeater+>a+>a+>a */
int a_L4;int a_L5;int a_P[1];
if(!a_equal(16777445,a_1470)){ goto a_G15;}
a_1477();
if(!a_equal(16777455,a_1470)){ goto a_G6;}
a_L5=a_1471;
a_1477(); goto a_G12;
...
a_L4=a_1471;
a_1477(); goto a_G10;
a_G9:a_1431(a_1001,2130706147); return;
...
a_1477();
a_1172(); goto a_G1;
a_G4:if(!a_equal(16777236,a_1470)){ goto a_G7;}
a_G5:a_1477();
a_1304(); goto a_G1;
a_G7:if(a_equal(16777266,a_1470)){ goto a_G5;}
if(a_equal(16777250,a_1470)){ goto a_G5;}
if(a_equal(16777224,a_1470)){ goto a_G5;}
if(a_equal(16777258,a_1470)){ goto a_G5;}
if(a_equal(16777246,a_1470)){ goto a_G5;}
if(a_equal(a_1470,16777285)){ return;}
a_1431(a_1001,2130706159); return;
} /* datasectioniii */
...
a_1247();
a_1276(); return;
a_G8:a_P[0]=2019445367;a_1432(1,a_P); return;
...
a_decr(a_F2);
if(!a_equal(16777463,a_1470)){ goto a_G6;}
a_L5=a_1471;
a_1477(); goto a_G7;
a_G6:a_1431(a_1001,2130706231); return;
a_G7:a_1362(a_L5);
{ if(a_L5==16777355||a_L5==16777361){ goto a_G9;}
 if(a_L5==16777371||a_L5==16777376||a_L5==16777382||a_L5==16777366||a_L5==16777388||a_L5==16777394){ goto a_G1;}
  goto a_G20;}
a_G9:if(!a_equal(16777455,a_1470)){ goto a_G6;}
a_L3=a_1471;
a_1477();
if(!a_equal(16777455,a_1470)){ goto a_G6;}
a_L4=a_1471;
...
a_incr(to_LIST(a_1310)->offset[a_F1-1]);
a_1362(a_L4); return;
a_G20:a_1431(a_1001,2130706264); return;
} /* formalaffixes */
...
a_L2=a_1471;
a_1477(); goto a_G5;
a_G4:a_1431(a_1001,2130706231); return;
...
a_1431(a_1001,2130706258); return;
} /* checkitemID */
static void a_1325(void){ /* enteritem */
int a_L1;int a_P[1];
...
a_1468(to_LIST(a_1311)->offset[to_LIST(a_1311)->aupb-4],a_P);a_L1=a_P[0];
a_G5:if(!a_equal(a_L1,0)){ goto a_G7;}
a_1478(to_LIST(a_1311)->offset[to_LIST(a_1311)->aupb-4],to_LIST(a_1310)->aupb); return;
...
int a_L1;int a_L2;int a_L3;int a_P[1];
a_1326();
if(!a_equal(16777463,a_1470)){ goto a_G5;}
to_LIST(a_1311)->offset[to_LIST(a_1311)->aupb-6]=a_1471;
a_1477(); goto a_G6;
a_G5:a_1431(a_1001,2130706231); return;
a_G6:if(!a_equal(16777471,a_1470)){ goto a_G5;}
a_L1=a_1471;
a_1477();
a_1318(a_L1);
if(!a_equal(16777455,a_1470)){ goto a_G5;}
...
a_G19:a_1431(a_1001,2130706253); return;
...
a_G24:if(!a_equal(16777483,a_1470)){ goto a_G5;}
to_LIST(a_1311)->offset[to_LIST(a_1311)->aupb-5]=a_1471;
a_1477();
if(!a_equal(16777483,a_1470)){ goto a_G5;}
to_LIST(a_1311)->offset[to_LIST(a_1311)->aupb-4]=a_1471;
a_1477();
a_1325(); return;
} /* readitem */
static void a_1352(void){ /* itemsection */
...
if(a_1453()){ return;}
a_G2:if(!a_equal(16777439,a_1470)){ goto a_G4;}
a_1477(); return;
...
to_LIST(a_1311)->offset[to_LIST(a_1311)->aupb-5]=155851723;
...
a_1477(); goto a_G5;
a_G4:a_1431(a_1001,2130706231); return;
a_G5:if(!a_equal(16777471,a_1470)){ goto a_G4;}
a_L4=a_1471;
a_1477();
...
if(!a_equal(16777448,a_1470)){ return;}
a_1477();
a_G12:if(!a_equal(16777403,a_1470)){ goto a_G14;}
a_1477(); return;
a_G14:if(!a_equal(16777471,a_1470)){ goto a_G4;}
a_L3=a_1471;
a_1477();
a_1362(a_L3);
...
a_P[0]=2019445377;a_P[1]=to_LIST(a_1311)->offset[a_1356-6];a_1432(2,a_P); return;
a_G3:a_1356=to_LIST(a_1311)->aupb; return;
} /* checkmainmodule */
static void a_1367(void){ /* readdefinitionlist */
int a_L1;int a_L2;int a_L3;
a_G1:if(!a_equal(16777455,a_1470)){ goto a_G4;}
a_L1=a_1471;
a_1477(); goto a_G5;
a_G4:a_1431(a_1001,2130706231); return;
a_G5:if(!a_equal(16777455,a_1470)){ goto a_G4;}
...
a_G10:a_1431(a_1001,2130706248); return;
a_G11:if(!a_equal(16777483,a_1470)){ goto a_G4;}
a_L3=a_1471;
a_1477();
...
to_LIST(a_1311)->offset[to_LIST(a_1311)->aupb-1]=to_LIST(a_1310)->aupb;
a_G17:if(!a_equal(16777439,a_1470)){ goto a_G1;}
a_1477(); return;
} /* readdefinitionlist */
static void a_1355(void){ /* linkmoduleheader */
...
if(!a_equal(16777277,a_1470)){ goto a_G18;}
a_1477();
a_1380(to_LIST(a_1311)->aupb,2);
if(!a_equal(16777483,a_1470)){ goto a_G14;}
to_LIST(a_1311)->offset[to_LIST(a_1311)->aupb-4]=a_1471;
a_1477(); goto a_G15;
a_G14:a_1431(a_1001,2130706231); return;
a_G15:if(!a_equal(16777483,a_1470)){ goto a_G14;}
to_LIST(a_1311)->offset[to_LIST(a_1311)->aupb-5]=a_1471;
a_1477(); goto a_G26;
a_G18:if(!a_equal(16777273,a_1470)){ goto a_G25;}
a_1477();
...
a_1477();
a_1319(); goto a_G26;
a_G25:a_1431(a_1001,2130706241); return;
a_G26:a_1355();
if(!a_equal(16777455,a_1470)){ goto a_G14;}
a_L2=a_1471;
a_1477();
if(a_equal(a_L2,32)){ goto a_G32;}
a_P[0]=2019445389;a_1432(1,a_P);
a_G32:a_1359=0;
a_1367();
...
a_1468(to_LIST(a_1311)->offset[a_F1-4],a_P);a_L4=a_P[0];
...
a_P[0]=2019445403;a_P[1]=to_LIST(a_1311)->offset[a_F1-4];a_P[2]=a_F1;a_1432(3,a_P); return;
a_G5:if(!a_1346(a_L2,a_F1)){ goto a_G7;}
a_P[0]=2019445414;a_P[1]=to_LIST(a_1311)->offset[a_F1-4];a_P[2]=a_L2;a_P[3]=a_F1;a_1432(4,a_P); return;
a_G7:if(!a_was(a_1311,to_LIST(a_1311)->offset[a_L2])){ goto a_G10;}
a_1380(a_L2,128);
a_1380(to_LIST(a_1311)->offset[a_L2],4); return;
a_G10:a_1436(a_1001,2130706236); return;
} /* scanitem */
...
a_1468(to_LIST(a_1311)->offset[a_F1-4],a_P);a_L3=a_P[0];
...
a_P[0]=2019445424;a_P[1]=to_LIST(a_1311)->offset[a_F1-4];a_P[2]=to_LIST(a_1311)->offset[a_F1];a_P[3]=a_L4;a_1432(4,a_P); return;
} /* scanitemfordbledef */
static void a_1374(void){ /* scanfordoubledefinitions */
int a_L1;int a_L2;int a_P[1];
...
a_P[0]=2019445395;a_1432(1,a_P); return;
a_G3:a_1345(0);
a_1353=a_1360;
a_G5:a_L1=0;
a_P[0]=a_L1;a_1373(a_P);a_L1=a_P[0];
if(a_is(a_L1)){ goto a_G5;}
if(a_1453()){ goto a_G10;}
a_1374();
a_G10:if(a_1453()){ return;}
a_1320(); return;
} /* scanlinkedmodules */
...
a_P[0]=2019445432;a_P[1]=to_LIST(a_1311)->offset[a_F1-4];a_P[2]=a_F1;a_1452(3,a_P); return;
} /* reportitem */
static void a_1371(void){ /* reportnotusedpublicitems */
int a_L1;int a_L2;int a_P[1];
...
if(a_equal(a_L2,0)){ return;}
if(!a_1349(a_1360,4)){ goto a_G1;}
a_1421(to_LIST(a_1311)->offset[a_1360-6]);
if(!a_1411()){ goto a_G1;}
a_L1=a_1360;
...
static int a_1406(int a_F1,int a_F2){ /* isfileflag+>a+>a */
int a_L3;
a_booland(to_LIST(a_1390)->offset[a_F1-2],a_F2,a_L3);
if(!a_is(a_L3)){ return 0;} return 1;
} /* isfileflag */
static void a_1420(int a_F1,int a_F2){ /* setfileflag+>a+>a */
...
{register int *a_r1=a_extension(a_1390,3);a_r1[0]=a_r1[1]=0;a_r1[2]=a_F1;to_LIST(a_1390)->aupb+=3;}
  return;
a_G4:a_P[0]=2019445705;a_P[1]=200;a_1434(2,a_P); return;
} /* extendFILES */
static int a_1407(int a_F1,int a_F2){ /* isfirstarg+t[]+>a */
int a_L2;int a_P[1];
a_comparestring(a_1503,a_1396,a_F1,a_F2,a_P);a_L2=a_P[0];
if(!a_equal(a_L2,0)){ return 0;} return 1;
} /* isfirstarg */
static int a_1401(int a_F1,int a_F2){ /* firstargstarts+t[]+>a */
int a_L2;int a_L3;int a_P[1];
a_stringlength(a_F1,a_F2,a_L2);
a_comparestringn(a_1503,a_1396,a_F1,a_F2,a_L2,a_P);a_L3=a_P[0];
if(!a_equal(a_L3,0)){ return 0;} return 1;
} /* firstargstarts */
static void a_1397(void){ /* checkcommandlinearguments */
int a_P[3];
a_1396=to_LIST(a_1503)->aupb;
a_1395=1;
a_1171=0;
a_G4:if(!a_less(a_1396,to_LIST(a_1503)->alwb)){ goto a_G6;}
a_P[0]=2019445684;a_1432(1,a_P); return;
a_G6:if(!a_1407(a_1001,2130706314)){ goto a_G8;}
a_P[0]=2019445598;a_P[1]=155851704;a_1437(2,a_P); return;
a_G8:if(!a_1407(a_1001,2130706310)){ goto a_G10;}
a_P[0]=2019445668;a_P[1]=1;a_P[2]=1;a_1437(3,a_P); return;
a_G10:if(!a_1407(a_1001,2130706305)){ goto a_G13;}
a_1395=0;
a_G12:a_previousstring(a_1503,a_1396); goto a_G4;
a_G13:if(!a_1407(a_1001,2130706300)){ goto a_G15;}
a_1171=1; goto a_G12;
a_G15:if(!a_1407(a_1001,2130706296)){ goto a_G20;}
a_previousstring(a_1503,a_1396);
if(!a_less(a_1396,to_LIST(a_1503)->alwb)){ goto a_G19;}
a_P[0]=2019445693;a_P[1]=111;a_1432(2,a_P); return;
a_G19:a_1423=a_1396; goto a_G12;
a_G20:if(!a_1407(a_1001,2130706293)){ goto a_G25;}
a_previousstring(a_1503,a_1396);
if(!a_less(a_1396,to_LIST(a_1503)->alwb)){ goto a_G24;}
a_P[0]=2019445693;a_P[1]=76;a_1432(2,a_P); return;
a_G24:a_1408=a_1396; goto a_G12;
a_G25:if(!a_1407(a_1001,2130706290)){ goto a_G27;}
a_1371(); goto a_G12;
a_G27:if(!a_1407(a_1001,2130706287)){ goto a_G29;}
a_1233(); goto a_G12;
a_G29:if(!a_1401(a_1001,2130706284)){ return;}
a_1417=a_1396; goto a_G12;
} /* checkcommandlinearguments */
static int a_1403(int a_A[1]){ /* getnextsource+a> */
int a_L2;int a_P[1];
...
a_G6:a_1405(a_A[0],a_P);a_L2=a_P[0];
if(a_equal(a_L2,0)){ return 1;} goto a_G5;
a_G8:if(!a_lseq(to_LIST(a_1503)->alwb,a_1396)){ goto a_G11;}
a_1399(a_1396);
a_previousstring(a_1503,a_1396); goto a_G6;
a_G11:if(!a_is(a_1395)){ return 0;}
a_1399(155851683);
a_1409=to_LIST(a_1390)->aupb;
a_1395=0; goto a_G6;
} /* getnextsource */
static int a_1411(void){ /* notstdlibsource */

if(a_equal(a_1409,0)){ return 1;}
if(a_equal(a_1391,0)){ return 1;}
if(!a_less(a_1391,a_1409)){ return 0;} return 1;
} /* notstdlibsource */
static int a_1418(int a_F1,int a_A[1]){ /* runtimechar+>a+a> */
int a_L3;int a_P[1];
if(!a_is(a_1417)){ goto a_G4;}
a_add(a_F1,5,a_F1);
if(!a_stringelem(a_1503,a_1417,a_F1,a_P)){ return 0;}a_A[0]=a_P[0]; return 1;
a_G4:a_1469(155851704,a_P);a_L3=a_P[0];
if(!a_stringelem(a_1460,a_L3,a_F1,a_P)){ return 0;}a_A[0]=a_P[0]; return 1;
} /* runtimechar */
static void a_1402(int a_A[1]){ /* geticefile+a> */
int a_P[1];
if(a_1427(a_1391,a_P)){a_A[0]=a_P[0]; return;}
a_A[0]=0; return;
} /* geticefile */
static int a_1427(int a_F1,int a_A[1]){ /* wasicesource+>a+a> */
...
if(a_equal(to_LIST(a_1456)->offset[to_LIST(a_1456)->aupb],47)){ return;}
a_1398(47); return;
} /* adddirseparator */
static void a_1413(int a_A[1]){ /* openBUFFER+a> */
int a_L2;int a_P[1];
a_listlength(a_1456,a_L2);
if(!a_lseq(a_L2,0)){ goto a_G4;}
a_A[0]=1; return;
a_G4:a_packstring(a_1456,a_L2,a_1460);
a_scratch(a_1456);
a_1464();
a_1489(a_P);a_A[0]=a_P[0]; return;
} /* openBUFFER */
static void a_1422(int a_F1){ /* stringtoBUFFER+>a */
int a_P[1];
if(!a_was(a_1460,a_F1)){ goto a_G4;}
a_1469(a_F1,a_P);a_F1=a_P[0];
a_unpackstring(a_1460,a_F1,a_1456); return;
a_G4:if(!a_was(a_1503,a_F1)){ goto a_G6;}
a_unpackstring(a_1503,a_F1,a_1456); return;
a_G6:a_1436(a_1001,2130706280); return;
} /* stringtoBUFFER */
static int a_1412(int a_F1,int a_A[1]){ /* nthpath+>a+a> */
int a_L3;
a_A[0]=to_LIST(a_1456)->alwb;
a_L3=to_LIST(a_1390)->offset[a_F1-1];
if(!a_lseq(a_A[0],to_LIST(a_1456)->aupb)){ return 0;}
a_G4:if(a_lseq(a_L3,1)){ return 1;}
if(!a_lseq(a_A[0],to_LIST(a_1456)->aupb)){ return 0;}
if(!a_equal(to_LIST(a_1456)->offset[a_A[0]],58)){ goto a_G8;}
a_decr(a_L3);
a_G8:a_incr(a_A[0]); goto a_G4;
} /* nthpath */
static int a_1419(int a_F1){ /* selectpath+>a */
int a_L2;int a_L3;int a_P[1];
if(!a_1412(a_F1,a_P)){ return 0;}a_L2=a_P[0];
if(!a_equal(to_LIST(a_1456)->offset[a_L2],58)){ goto a_G4;}
a_scratch(a_1456); return 1;
a_G4:a_L3=to_LIST(a_1456)->alwb;
a_G5:to_LIST(a_1456)->offset[a_L3]=to_LIST(a_1456)->offset[a_L2];
a_incr(a_L2);
if(a_more(a_L2,to_LIST(a_1456)->aupb)){ goto a_G10;}
if(a_equal(to_LIST(a_1456)->offset[a_L2],58)){ goto a_G10;}
a_incr(a_L3); goto a_G5;
a_G10:a_unstackto(a_1456,a_L3);
a_1392(); return 1;
} /* selectpath */
static void a_1415(int a_F1,int a_A[1]){ /* openfilefirst+>a+a> */
int a_P[1];
a_scratch(a_1456);
if(!a_1406(a_F1,2)){ goto a_G4;}
a_1426(a_F1,a_1408,a_P);a_A[0]=a_P[0]; return;
a_G4:if(!a_1406(a_F1,4)){ goto a_G6;}
a_1426(a_F1,155851676,a_P);a_A[0]=a_P[0]; return;
a_G6:a_1425(a_F1,a_P);a_A[0]=a_P[0]; return;
} /* openfilefirst */
static void a_1426(int a_F1,int a_F2,int a_A[1]){ /* tryopenwithpath+>a+>a+a> */
int a_P[1];
to_LIST(a_1390)->offset[a_F1-1]=1;
a_G2:a_1422(a_F2);
if(!a_1419(a_F1)){ goto a_G7;}
a_1425(a_F1,a_P);a_A[0]=a_P[0];
if(a_equal(a_A[0],0)){ return;}
a_incr(to_LIST(a_1390)->offset[a_F1-1]); goto a_G2;
a_G7:a_A[0]=1; return;
} /* tryopenwithpath */
static void a_1425(int a_F1,int a_A[1]){ /* tryopen+>a+a> */
int a_P[2];
a_1422(to_LIST(a_1390)->offset[a_F1]);
if(!a_1406(a_F1,1)){ goto a_G4;}
a_1393();
a_G4:a_1413(a_P);a_A[0]=a_P[0];
if(!a_equal(a_A[0],0)){ goto a_G7;}
a_1420(a_F1,8); return;
a_G7:if(a_more(a_A[0],0)){ return;}
a_P[0]=2019445714;a_P[1]=a_F1;a_1434(2,a_P); return;
} /* tryopen */
static void a_1414(int a_F1){ /* openfileaslast+>a */
int a_L2;int a_P[2];
if(a_1406(a_F1,8)){ goto a_G3;}
a_1436(a_1001,2130706274); return;
a_G3:a_scratch(a_1456);
if(!a_1406(a_F1,2)){ goto a_G7;}
a_1422(a_1408);
if(a_1419(a_F1)){}
a_G7:if(!a_1406(a_F1,4)){ goto a_G10;}
a_1422(155851676);
if(a_1419(a_F1)){}
a_G10:a_1422(to_LIST(a_1390)->offset[a_F1]);
if(!a_1406(a_F1,1)){ goto a_G13;}
a_1393();
a_G13:a_1413(a_P);a_L2=a_P[0];
if(a_equal(a_L2,0)){ return;}
a_P[0]=2019445714;a_P[1]=a_F1;a_1434(2,a_P); return;
} /* openfileaslast */
static void a_1421(int a_F1){ /* setsource+>a */

a_1391=a_F1; return;
} /* setsource */
static void a_1416(int a_F1){ /* opensource+>a */
...
static void a_1424(int a_F1,int a_A[1]){ /* tryfilefirst+>a+a> */
int a_P[1];
to_LIST(a_1390)->offset[a_F1-2]=0;
a_1415(a_F1,a_P);a_A[0]=a_P[0];
if(a_equal(a_A[0],0)){ return;}
a_1420(a_F1,1);
a_1415(a_F1,a_P);a_A[0]=a_P[0];
if(a_equal(a_A[0],0)){ return;}
if(!a_is(a_1408)){ goto a_G14;}
...
if(a_equal(a_A[0],0)){ return;}
a_1420(a_F1,1);
a_1415(a_F1,a_P);a_A[0]=a_P[0]; return;
} /* tryfilefirst */
static void a_1405(int a_F1,int a_A[1]){ /* handlesourcefile+>a+a> */
int a_P[2];
if(!a_1406(a_F1,8)){ goto a_G4;}
a_1414(a_F1);
a_A[0]=0; return;
a_G4:a_1424(a_F1,a_P);a_A[0]=a_P[0];
if(!a_is(a_A[0])){ goto a_G7;}
a_P[0]=2019445714;a_P[1]=a_F1;a_1434(2,a_P); return;
a_G7:if(!a_equal(a_1470,16777273)){ goto a_G9;}
a_1410=a_F1; return;
a_G9:if(!a_equal(a_1470,16777262)){ return;}
a_1394(a_F1);
a_A[0]=1; return;
} /* handlesourcefile */
...
a_P[0]=2019445725;a_P[1]=a_F1;a_1434(2,a_P); return;
a_G3:a_unstack(a_1390);
a_G4:if(!a_equal(16777262,a_1470)){ goto a_G11;}
a_1477();
if(!a_equal(16777483,a_1470)){ goto a_G9;}
a_L2=a_1471;
a_1477(); goto a_G10;
a_G9:a_1431(a_1001,2130706268); return;
a_G10:a_1399(a_L2); goto a_G4;
a_G11:a_1464(); return;
} /* addincludedicefiles */
static void a_1404(void){ /* gettargetfile */
int a_L1;int a_L2;int a_L3;int a_L4;int a_L5;int a_L6;
if(!a_is(a_1423)){ goto a_G4;}
a_L5=0;
a_L2=a_1423; goto a_G6;
a_G4:a_L5=1;
a_L2=to_LIST(a_1390)->offset[a_1410];
a_G6:a_L1=to_LIST(a_1456)->aupb;
a_1422(a_L2);
a_L4=to_LIST(a_1456)->aupb;
a_L6=1;
a_G10:if(a_lseq(a_L4,a_L1)){ goto a_G21;}
{register int a_r1=to_LIST(a_1456)->offset[a_L4];
...
a_L6=0;
a_unstackto(a_1456,a_L4); goto a_G10;
a_G19:if(a_equal(a_L5,1)){ goto a_G21;} goto a_G14;
a_G20:a_decr(a_L4); goto a_G10;
a_G21:if(a_equal(a_L5,2)){ goto a_G26;}
if(a_equal(to_LIST(a_1456)->offset[to_LIST(a_1456)->aupb],47)){ goto a_G26;}
a_1398(46);
a_1398(106);
a_1398(115);
a_G26:a_subtr(to_LIST(a_1456)->aupb,a_L4,a_L3);
a_packstring(a_1456,a_L3,a_1460);
a_unstackto(a_1456,a_L1); return;
} /* gettargetfile */
static void a_1442(int a_F1){ /* printchar+>a */

a_incr(a_1450);
a_putchar(a_1430,a_F1); return;
} /* printchar */
static void a_1439(void){ /* nlcr */

if(!a_lseq(a_1450,1)){ goto a_G3;}
a_1450=1; return;
a_G3:a_1450=0;
a_1442(10); return;
} /* nlcr */
static void a_1451(int a_F1){ /* tabline+>a */

a_G1:if(a_equal(a_1450,a_F1)){ return;}
if(!a_more(a_1450,a_F1)){ goto a_G4;}
a_1439(); goto a_G1;
a_G4:a_1442(32); goto a_G1;
} /* tabline */
static void a_1445(int a_F1){ /* printint+>a */

if(!a_equal(a_F1,(-1-2147483647))){ goto a_G5;}
a_1442(45);
a_subtr(-1,a_F1,a_F1);
a_1446(a_F1,49); return;
a_G5:if(!a_less(a_F1,0)){ goto a_G8;}
a_1442(45);
a_getabs(a_F1,a_F1);
a_G8:a_1446(a_F1,48); return;
} /* printint */
static void a_1446(int a_F1,int a_F2){ /* printint1+>a+>a */
int a_L3;int a_L4;
a_divrem11(a_F1,10,a_L3,a_L4);
if(a_equal(a_L3,0)){ goto a_G4;}
a_1446(a_L3,48);
...
static void a_1443(int a_F1){ /* printform+>a */

a_1444(a_F1,4); return;
} /* printform */
static void a_1444(int a_F1,int a_F2){ /* printform1+>a+>a */
int a_L3;int a_L4;
...
static void a_1440(int a_F1,int a_F2){ /* print+t[]+>a */
int a_L2;
if(!a_was(a_F1,a_F2)){ return;}
a_1500(a_1430,a_F1,a_F2);
a_stringlength(a_F1,a_F2,a_L2);
a_add(a_1450,a_L2,a_1450); return;
} /* print */
static void a_1449(int a_F1){ /* printpointer+>a */
int a_P[1];
a_G1:if(!a_equal(a_F1,0)){ goto a_G3;}
a_1440(a_1001,2130706345); return;
a_G3:if(a_1427(a_F1,a_P)){a_F1=a_P[0]; goto a_G1;}
if(!a_was(a_1429,a_F1)){ goto a_G6;}
a_1440(a_1429,a_F1); return;
a_G6:if(!a_was(a_1503,a_F1)){ goto a_G8;}
a_1440(a_1503,a_F1); return;
a_G8:if(!a_was(a_1460,a_F1)){ goto a_G11;}
a_1469(a_F1,a_P);a_F1=a_P[0];
a_1440(a_1460,a_F1); return;
a_G11:a_1436(a_1001,2130706341); return;
} /* printpointer */
static void a_1441(int a_F1){ /* printbase+>a */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_L2=to_LIST(a_1456)->aupb;
if(!a_was(a_1460,a_F1)){ goto a_G5;}
a_1469(a_F1,a_P);a_F1=a_P[0];
a_unpackstring(a_1460,a_F1,a_1456); goto a_G9;
a_G5:if(!a_was(a_1503,a_F1)){ goto a_G7;}
a_unpackstring(a_1503,a_F1,a_1456); goto a_G9;
a_G7:if(a_equal(a_F1,0)){ goto a_G9;}
a_1436(a_1001,2130706335); return;
a_G9:a_L3=to_LIST(a_1456)->aupb;
a_L4=0;
a_G11:if(a_lseq(a_L3,a_L2)){ goto a_G18;}
if(!a_equal(to_LIST(a_1456)->offset[a_L3],46)){ goto a_G15;}
a_incr(a_L4);
a_G14:a_decr(a_L3); goto a_G11;
a_G15:if(a_equal(to_LIST(a_1456)->offset[a_L3],47)){ goto a_G18;}
if(a_equal(to_LIST(a_1456)->offset[a_L3],92)){ goto a_G18;}
if(!a_equal(to_LIST(a_1456)->offset[a_L3],58)){ goto a_G14;}
a_G18:a_incr(a_L3);
if(a_more(a_L3,to_LIST(a_1456)->aupb)){ goto a_G25;}
if(!a_equal(to_LIST(a_1456)->offset[a_L3],46)){ goto a_G24;}
if(a_lseq(a_L4,1)){ goto a_G25;}
a_decr(a_L4);
a_1442(46); goto a_G18;
a_G24:a_1442(to_LIST(a_1456)->offset[a_L3]); goto a_G18;
a_G25:a_unstackto(a_1456,a_L2); return;
} /* printbase */
static void a_1447(int a_F1){ /* printitem+>a */
int a_L2;int a_L3;int a_L4;int a_P[3];
a_1328(a_F1,a_P);a_L2=a_P[0];a_L3=a_P[1];a_L4=a_P[2];
if(a_lseq(a_L2,0)){ goto a_G4;}
a_1443(a_L2);
a_G4:if(a_equal(a_L3,155851723)){ goto a_G7;}
a_1442(47);
a_1441(a_L3);
a_G7:if(a_equal(a_L4,0)){ return;}
a_1442(32);
a_1440(a_1001,2130706330);
a_1449(a_L4);
a_1442(41); return;
} /* printitem */
static void a_1448(int a_F1){ /* printline+>a */
int a_L2;int a_L3;int a_P[2];
a_1329(a_F1,a_P);a_L2=a_P[0];a_L3=a_P[1];
if(a_lseq(a_L2,0)){ goto a_G4;}
a_1443(a_L2);
a_G4:if(a_equal(a_L3,155851723)){ return;}
a_1442(47);
a_1441(a_L3); return;
} /* printline */
static void a_1435(int a_C,int *a_V){ /* formatprint+@+>a */
int a_L2;int a_L3;
a_L2=to_LIST(a_1456)->aupb;
a_unpackstring(a_1429,a_V[0],a_1456);
a_add(a_L2,1,a_L3);
a_G4:if(a_less(to_LIST(a_1456)->aupb,a_L3)){ goto a_G26;}
if(!a_noteq(to_LIST(a_1456)->offset[a_L3],37)){ goto a_G8;}
a_G6:a_1442(to_LIST(a_1456)->offset[a_L3]);
a_G7:a_incr(a_L3); goto a_G4;
a_G8:a_incr(a_L3);
if(!a_less(to_LIST(a_1456)->aupb,a_L3)){ goto a_G11;}
a_1442(37); goto a_G26;
a_G11:{register int a_r1=to_LIST(a_1456)->offset[a_L3];
...
a_G14:a_1440(a_1001,2130706325); goto a_G7;
a_G15:if(a_C<=1){ goto a_G14;} a_C--;a_V+=1;
a_1440(a_1460,a_V[0]); goto a_G7;
a_G17:if(a_C<=1){ goto a_G14;} a_C--;a_V+=1;
a_1447(a_V[0]); goto a_G7;
...
a_G25:a_1442(10); goto a_G7;
a_G26:if(a_C<=1){ goto a_G28;} a_C--;a_V+=1;
a_1440(a_1001,2130706322);
a_G28:a_unstackto(a_1456,a_L2); return;
} /* formatprint */
static int a_1453(void){ /* waserror */

if(!a_more(a_1433,0)){ return 0;} return 1;
} /* waserror */
static void a_1438(int a_F1){ /* messagehead+>a */
int a_L2;int a_P[1];
a_1439();
a_1442(a_F1);
a_1442(32);
a_1402(a_P);a_L2=a_P[0];
if(a_equal(a_L2,0)){ goto a_G7;}
a_1441(a_L2);
...
static void a_1432(int a_C,int *a_V){ /* error+@+>a */
int a_P[1];
if(a_mreq(a_1433,51)){ return;}
a_1438(69);
a_1435(a_C,a_V);
a_1439();
a_incr(a_1433);
if(a_less(a_1433,51)){ return;}
a_1438(70);
a_P[0]=2019445740;a_1435(1,a_P);
a_1439(); return;
} /* error */
static void a_1452(int a_C,int *a_V){ /* warning+@+>a */
...
static void a_1437(int a_C,int *a_V){ /* message+@+>a */

a_1435(a_C,a_V);
a_1439();
a_incr(a_1433); return;
} /* message */
static void a_1434(int a_C,int *a_V){ /* fatalerror+@+>a */
...
static void a_1431(int a_F1,int a_F2){ /* corrupticefile+t[]+>a */
int a_L2;int a_P[2];
a_1438(70);
a_1402(a_P);a_L2=a_P[0];
a_P[0]=2019445761;a_P[1]=a_L2;a_1435(2,a_P);
a_1440(a_F1,a_F2);
a_P[0]=2019445766;a_1435(1,a_P);
a_1439();
a_exit(3); return;
} /* corrupticefile */
static void a_1436(int a_F1,int a_F2){ /* internalerror+t[]+>a */
int a_P[1];
a_1438(70);
a_P[0]=2019445748;a_1435(1,a_P);
a_1440(a_F1,a_F2);
a_P[0]=2019445753;a_1435(1,a_P);
a_1439();
a_exit(15); return;
} /* internalerror */
static void a_1467(int a_F1){ /* extendBUFFER+>a */

{register int *a_r1=a_extension(a_1456,1);a_r1[0]=a_F1;to_LIST(a_1456)->aupb+=1;}
  return;
} /* extendBUFFER */
static void a_1489(int a_A[1]){ /* trytoopensource+a> */
int a_L2;
if(!a_openfile(a_1461,114,a_1460,to_LIST(a_1460)->aupb)){ goto a_G8;}
a_A[0]=0;
a_unstackstring(a_1460);
a_1488=1;
a_1463=32;
a_1476();
a_1477(); return;
a_G8:a_unstackstring(a_1460);
a_getfileerror(a_1461,a_L2);
...
a_closefile(a_1461); return;
} /* closesource */
static void a_1476(void){ /* nextchar */
int a_P[1];
a_G1:if(!a_getchar(a_1461,a_P)){ goto a_G4;}a_1463=a_P[0];
{ if(a_1463==10){ goto a_G3;}
 if(a_1463<=31){ goto a_G1;}
  return;}
a_G3:a_incr(a_1488); return;
a_G4:a_1463=1; return;
} /* nextchar */
static void a_1487(void){ /* saveinputposition */
int a_P[1];
a_getfilepos(a_1461,a_P);a_1473=a_P[0];
a_1472=a_1463;
a_1474=a_1470;
a_1475=a_1471; return;
} /* saveinputposition */
static void a_1486(void){ /* restoreinputposition */

a_setfilepos(a_1461,a_1473);
a_1463=a_1472;
a_1470=a_1474;
a_1471=a_1475; return;
} /* restoreinputposition */
static void a_1465(void){ /* comment */

a_G1:if(a_equal(a_1463,10)){ return;}
if(a_equal(a_1463,1)){ return;}
a_1476(); goto a_G1;
} /* comment */
static void a_1480(int a_A[1]){ /* readdestination+a> */
int a_L2;
{ if(a_1463==78){ goto a_G2;}
 if(a_1463==48){ goto a_G15;}
 if(a_1463==45){ goto a_G17;}
  goto a_G28;}
a_G2:a_1476();
{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G8;}
}
a_subtr(a_1463,48,a_A[0]);
a_1476();
if(a_more(a_A[0],0)){ goto a_G9;}
if(a_equal(0,0)){ goto a_G9;}
a_G8:a_1431(a_1001,2130706392); return;
a_G9:{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G13;}
}
a_subtr(a_1463,48,a_L2);
a_1476();
...
a_G23:{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G27;}
}
a_subtr(a_1463,48,a_L2);
a_1476();
a_addmult(a_A[0],10,a_L2,a_A[0]); goto a_G23;
a_G27:if(!a_is(1)){ return;} goto a_G14;
a_G28:a_1431(a_1001,2130706387); return;
} /* readdestination */
static void a_1482(int a_A[1]){ /* readtargetnumber+a> */
int a_L2;int a_L3;int a_P[1];
a_L2=to_LIST(a_1456)->aupb;
a_L3=0;
a_G3:{ if(a_1463==45){ goto a_G4;}
 if((48<=a_1463 && a_1463<=57)){ goto a_G6;}
  goto a_G7;}
a_G4:a_L3=1;
a_G5:a_1476(); goto a_G3;
a_G6:a_1467(a_1463); goto a_G5;
a_G7:a_1006(a_L3,a_L2,a_P);a_A[0]=a_P[0];
a_unstackto(a_1456,a_L2); return;
} /* readtargetnumber */
static void a_1468(int a_F1,int a_A[1]){ /* gettagdata+>a+a> */

a_A[0]=to_LIST(a_1460)->offset[a_F1]; return;
} /* gettagdata */
static void a_1469(int a_F1,int a_A[1]){ /* gettagimage+>a+a> */

a_subtr(a_F1,2,a_A[0]); return;
} /* gettagimage */
static void a_1478(int a_F1,int a_F2){ /* puttagdata+>a+>a */

to_LIST(a_1460)->offset[a_F1]=a_F2; return;
} /* puttagdata */
static void a_1462(int a_A[1]){ /* addLEXTentry+a> */
int a_P[1];
{register int *a_r1=a_extension(a_1460,2);a_r1[0]=a_r1[1]=0;to_LIST(a_1460)->aupb+=2;}
a_1466(to_LIST(a_1460)->aupb,a_P);a_A[0]=a_P[0];
if(a_equal(a_A[0],to_LIST(a_1460)->aupb)){ return;}
a_unstack(a_1460);
a_unstackstring(a_1460); return;
} /* addLEXTentry */
static void a_1466(int a_F1,int a_A[1]){ /* enterstring+>a+a> */
int a_L3;int a_L4;int a_L5;int a_L6;int a_L7;int a_P[1];
a_subtr(a_F1,2,a_L3);
a_stringhash(a_1460,a_L3,a_P);a_L4=a_P[0];
a_booland(a_L4,2147483647,a_L4);
a_divrem01(a_L4,a_1459,a_L4);
a_add(a_L4,to_LIST(a_1457)->alwb,a_L4);
a_L5=to_LIST(a_1457)->offset[a_L4];
a_G7:if(!a_equal(a_L5,0)){ goto a_G14;}
to_LIST(a_1460)->offset[a_F1-1]=to_LIST(a_1457)->offset[a_L4];
to_LIST(a_1457)->offset[a_L4]=a_F1;a_A[0]=a_F1;
a_incr(a_1458);
if(a_less(a_1458,a_1459)){ return;}
a_add(a_1459,1024,a_1459);
a_1485(); return;
a_G14:a_subtr(a_L5,2,a_L6);
a_comparestring(a_1460,a_L3,a_1460,a_L6,a_P);a_L7=a_P[0];
if(!a_equal(a_L7,0)){ goto a_G18;}
a_A[0]=a_L5; return;
a_G18:a_L5=to_LIST(a_1460)->offset[a_L5-1]; goto a_G7;
} /* enterstring */
static void a_1485(void){ /* rehash */
int a_L1;int a_L2;int a_P[1];
a_1458=0;
a_L1=to_LIST(a_1457)->aupb;
a_G3:if(a_less(a_L1,to_LIST(a_1457)->alwb)){ goto a_G6;}
to_LIST(a_1457)->offset[a_L1]=0;
a_previous(a_1457,a_L1); goto a_G3;
a_G6:a_subtr(to_LIST(a_1457)->aupb,to_LIST(a_1457)->alwb,a_L2);
a_G7:a_incr(a_L2);
if(a_mreq(a_L2,a_1459)){ goto a_G10;}
{register int *a_r1=a_extension(a_1457,1);a_r1[0]=0;to_LIST(a_1457)->aupb+=1;}
  goto a_G7;
a_G10:a_L1=to_LIST(a_1460)->aupb;
a_G11:if(a_less(a_L1,to_LIST(a_1460)->alwb)){ return;}
a_1466(a_L1,a_P);a_L2=a_P[0];
if(!a_equal(a_L2,a_L1)){ goto a_G16;}
a_previous(a_1460,a_L1);
a_previousstring(a_1460,a_L1); goto a_G11;
a_G16:a_1436(a_1001,2130706381); return;
} /* rehash */
static void a_1481(int a_A[1]){ /* readstring+a> */
int a_L2;int a_L3;int a_P[1];
a_L3=to_LIST(a_1456)->aupb;
a_L2=0;
a_G3:a_1476();
{ if(a_1463==34){ goto a_G5;}
 if(a_1463==10||a_1463==1){ goto a_G14;}
  goto a_G7;}
a_G5:a_1476();
if(!a_equal(a_1463,34)){ goto a_G9;}
a_G7:a_1467(a_1463);
a_incr(a_L2); goto a_G3;
a_G9:if(!a_equal(a_L2,0)){ goto a_G11;}
a_A[0]=155851723; return;
a_G11:a_packstring(a_1456,a_L2,a_1460);
a_unstackto(a_1456,a_L3);
a_1462(a_P);a_A[0]=a_P[0]; return;
a_G14:a_1431(a_1001,2130706377); return;
} /* readstring */
static void a_1483(int a_A[2]){ /* readtargetstring+a>+a> */
int a_L3;int a_P[2];
a_L3=to_LIST(a_1456)->aupb;
if(a_equal(a_1463,34)){ goto a_G4;}
a_G3:a_1431(a_1001,2130706372); return;
a_G4:a_1476();
{ if(a_1463==34){ goto a_G6;}
 if(a_1463==10||a_1463==1){ goto a_G3;}
  goto a_G8;}
a_G6:a_1476();
if(!a_equal(a_1463,34)){ goto a_G9;}
a_G8:a_1467(a_1463); goto a_G4;
a_G9:a_1007(a_L3,a_P);a_A[0]=a_P[0];a_A[1]=a_P[1];
a_unstackto(a_1456,a_L3); return;
} /* readtargetstring */
static void a_1479(int a_A[1]){ /* readbold+a> */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_1476();
a_L3=to_LIST(a_1456)->aupb;
a_L2=0;
a_G4:{ if(!((97<=a_1463 && a_1463<=122))){ goto a_G9;}
}
a_L4=a_1463;
a_1476();
a_1467(a_L4);
a_incr(a_L2); goto a_G4;
a_G9:if(!a_equal(a_1463,39)){ goto a_G11;}
a_1476(); goto a_G12;
a_G11:a_1431(a_1001,2130706365); return;
a_G12:a_packstring(a_1456,a_L2,a_1460);
a_unstackto(a_1456,a_L3);
a_A[0]=16777299;
a_G15:a_comparestring(a_1455,a_A[0],a_1460,to_LIST(a_1460)->aupb,a_P);a_L2=a_P[0];
if(a_equal(a_L2,0)){ goto a_G19;}
if(a_equal(a_A[0],16777220)){ goto a_G11;}
a_previousstring(a_1455,a_A[0]); goto a_G15;
a_G19:a_unstackstring(a_1460); return;
} /* readbold */
static void a_1484(int a_A[1]){ /* readtype+a> */
int a_L2;int a_L3;int a_L4;int a_P[1];
a_1476();
a_L3=to_LIST(a_1456)->aupb;
a_L2=0;
...
a_1467(a_L4);
a_incr(a_L2); goto a_G4;
a_G9:if(!a_equal(a_1463,32)){ goto a_G13;}
a_1467(32);
a_incr(a_L2);
a_1476(); goto a_G4;
a_G13:if(!a_equal(a_1463,62)){ goto a_G15;}
a_1476(); goto a_G16;
a_G15:a_1431(a_1001,2130706360); return;
a_G16:a_packstring(a_1456,a_L2,a_1460);
a_unstackto(a_1456,a_L3);
a_A[0]=16777394;
a_G19:a_comparestring(a_1455,a_A[0],a_1460,to_LIST(a_1460)->aupb,a_P);a_L2=a_P[0];
if(a_equal(a_L2,0)){ goto a_G23;}
if(a_equal(a_A[0],16777304)){ goto a_G15;}
a_previousstring(a_1455,a_A[0]); goto a_G19;
a_G23:a_unstackstring(a_1460); return;
} /* readtype */
static void a_1477(void){ /* nextsymbol */
int a_L1;int a_P[2];
a_G1:a_P[0]=a_1490;a_1013(a_P);a_1490=a_P[0];a_1471=a_P[1];
if(!a_more(a_1490,0)){ goto a_G4;}
a_1470=16777459; return;
a_G4:{ if(a_1463==32||a_1463==10){ goto a_G5;}
 if(a_1463==36){ goto a_G6;}
 if(a_1463==48){ goto a_G7;}
 if((49<=a_1463 && a_1463<=57)){ goto a_G10;}
 if(a_1463==70){ goto a_G23;}
 if(a_1463==73){ goto a_G34;}
 if(a_1463==76){ goto a_G48;}
 if(a_1463==78){ goto a_G59;}
 if(a_1463==88){ goto a_G70;}
 if(a_1463==84){ goto a_G73;}
 if(a_1463==39){ goto a_G76;}
 if(a_1463==60){ goto a_G77;}
 if(a_1463==34){ goto a_G79;}
 if(a_1463==38){ goto a_G81;}
 if(a_1463==93){ goto a_G82;}
 if(a_1463==41){ goto a_G83;}
 if(a_1463==58){ goto a_G84;}
 if(a_1463==44){ goto a_G85;}
 if(a_1463==126){ goto a_G86;}
 if(a_1463==47){ goto a_G87;}
 if(a_1463==45){ goto a_G88;}
 if(a_1463==35){ goto a_G103;}
 if(a_1463==40){ goto a_G104;}
 if(a_1463==124){ goto a_G105;}
 if(a_1463==62){ goto a_G106;}
 if(a_1463==43){ goto a_G109;}
 if(a_1463==46){ goto a_G110;}
 if(a_1463==59){ goto a_G111;}
 if(a_1463==42){ goto a_G112;}
 if(a_1463==91){ goto a_G113;}
 if(a_1463==94){ goto a_G114;}
 if(a_1463==64){ goto a_G115;}
 if(a_1463==1){ goto a_G116;}
  goto a_G117;}
a_G5:a_1476(); goto a_G1;
a_G6:a_1465(); goto a_G1;
a_G7:a_1470=16777455;
a_1471=0;
a_G9:a_1476(); return;
a_G10:a_1470=16777455;
{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G16;}
}
a_subtr(a_1463,48,a_1471);
a_1476();
if(a_more(a_1471,0)){ goto a_G17;}
if(a_equal(0,0)){ goto a_G17;}
a_G16:a_1431(a_1001,2130706392); return;
a_G17:{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G21;}
}
a_subtr(a_1463,48,a_L1);
a_1476();
a_addmult(a_1471,10,a_L1,a_1471); goto a_G17;
a_G21:if(!a_is(0)){ return;}
a_G22:a_subtr(0,a_1471,a_1471); return;
a_G23:a_1470=16777475;
a_1476();
{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G16;}
}
a_subtr(a_1463,48,a_1471);
a_1476();
if(a_more(a_1471,0)){ goto a_G30;}
if(!a_equal(0,0)){ goto a_G16;}
a_G30:{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G21;}
}
a_subtr(a_1463,48,a_L1);
a_1476();
a_addmult(a_1471,10,a_L1,a_1471); goto a_G30;
a_G34:a_1470=16777471;
a_1476();
{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G16;}
}
a_subtr(a_1463,48,a_1471);
a_1476();
if(a_more(a_1471,0)){ goto a_G41;}
if(!a_equal(0,0)){ goto a_G16;}
a_G41:{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G45;}
}
a_subtr(a_1463,48,a_L1);
a_1476();
a_addmult(a_1471,10,a_L1,a_1471); goto a_G41;
a_G45:if(!a_is(0)){ goto a_G47;}
a_subtr(0,a_1471,a_1471);
a_G47:a_P[0]=a_1471;a_1323(a_P);a_1471=a_P[0]; return;
a_G48:a_1470=16777479;
a_1476();
{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G16;}
}
a_subtr(a_1463,48,a_1471);
a_1476();
if(a_more(a_1471,0)){ goto a_G55;}
if(!a_equal(0,0)){ goto a_G16;}
a_G55:{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G21;}
}
a_subtr(a_1463,48,a_L1);
a_1476();
a_addmult(a_1471,10,a_L1,a_1471); goto a_G55;
a_G59:a_1470=16777467;
a_1476();
{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G16;}
}
a_subtr(a_1463,48,a_1471);
a_1476();
if(a_more(a_1471,0)){ goto a_G66;}
if(!a_equal(0,0)){ goto a_G16;}
a_G66:{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G21;}
}
a_subtr(a_1463,48,a_L1);
a_1476();
a_addmult(a_1471,10,a_L1,a_1471); goto a_G66;
a_G70:a_1470=16777459;
a_1476();
a_1482(a_P);a_1471=a_P[0]; return;
a_G73:a_1470=16777459;
a_1476();
a_1483(a_P);a_1490=a_P[0];a_1471=a_P[1]; return;
a_G76:a_1479(a_P);a_1470=a_P[0]; return;
a_G77:a_1470=16777463;
a_1484(a_P);a_1471=a_P[0]; return;
a_G79:a_1470=16777483;
a_1481(a_P);a_1471=a_P[0]; return;
a_G81:a_1470=16777400; goto a_G9;
a_G82:a_1470=16777403; goto a_G9;
a_G83:a_1470=16777406; goto a_G9;
a_G84:a_1470=16777409; goto a_G9;
a_G85:a_1470=16777412; goto a_G9;
a_G86:a_1470=16777415; goto a_G9;
a_G87:a_1470=16777418; goto a_G9;
a_G88:a_1476();
{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G101;}
}
a_1470=16777455;
{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G16;}
}
a_subtr(a_1463,48,a_1471);
a_1476();
if(a_more(a_1471,0)){ goto a_G96;}
if(!a_equal(1,0)){ goto a_G16;}
a_G96:{ if(!((48<=a_1463 && a_1463<=57))){ goto a_G100;}
}
a_subtr(a_1463,48,a_L1);
a_1476();
a_addmult(a_1471,10,a_L1,a_1471); goto a_G96;
a_G100:if(!a_is(1)){ return;} goto a_G22;
a_G101:a_1470=16777421;
a_1471=0; return;
a_G103:a_1470=16777424; goto a_G9;
a_G104:a_1470=16777427; goto a_G9;
a_G105:a_1470=16777430; goto a_G9;
a_G106:a_1470=16777433;
a_1476();
a_1480(a_P);a_1471=a_P[0]; return;
a_G109:a_1470=16777436; goto a_G9;
a_G110:a_1470=16777439; goto a_G9;
a_G111:a_1470=16777442; goto a_G9;
a_G112:a_1470=16777445; goto a_G9;
a_G113:a_1470=16777448; goto a_G9;
a_G114:a_1470=16777451; goto a_G9;
a_G115:a_1470=16777397; goto a_G9;
a_G116:a_1470=16777486; return;
a_G117:a_1431(a_1001,2130706355); return;
} /* nextsymbol */
...
static void a_1492(void){ /* pass1 */
int a_L1;int a_P[1];
a_G1:if(a_1453()){ return;}
if(!a_1403(a_P)){ return;}a_L1=a_P[0];
a_1345(a_L1);
a_1352();
a_1464(); goto a_G1;
} /* pass1 */
...
static void a_1496(void){ /* pass4a */
int a_L2;int a_L3;int a_P[1];
a_G1:if(a_equal(a_1171,0)){ return;}
a_L2=0;
...
a_1269();
a_1190();
if(!a_1453()){ goto a_G24;}
a_exit(4); return;
a_G24:a_1230();
a_1153();
a_1495();
a_1496();
if(!a_1177()){ goto a_G30;}
a_1496();
a_G30:a_1227();
a_1497();
a_1206();
...
static void a_1500(int a_F1,int a_F2,int a_F3){ /* putstring+""f+t[]+>a */
int a_L2;int a_L3;int a_P[1];
a_L2=0;
