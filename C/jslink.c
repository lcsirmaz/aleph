...
-1}; /* fill table size 2465 */
static void a_data_setup(void){
 a_virtual_min=16777216;a_virtual_max=2130706432;
 a_setup_list(0,a_1001,"@StringTable",1,2130705107,2130706408,1302); /* @StringTable */
 a_setup_list(1,a_1005,"NUMBER",1,2075075454,2130705105,0); /* NUMBER */
 a_setup_list(1,a_1022,"REGISTER",1,2047260627,2075075452,0); /* REGISTER */
 a_setup_list(1,a_1041,"NODE",6,1741296858,2019445112,0); /* NODE */
 a_setup_list(1,a_1042,"ZONE",3,2019445800,2047260623,0); /* ZONE */
 ...
 a_setup_list(0,a_1430,"MESSAGE",1,2019445119,2019445796,678); /* MESSAGE */
 ...
 a_setup_charfile(a_1431,"PRINTFILE",2,a_1001,2130706357); /* PRINTFILE */
 a_setup_charfile(a_1462,"SOURCE",1,a_1001,2130706404); /* SOURCE */
 a_list_fill(a_FILL);
}
...
int a_L1;int a_P[1];
a_waitfor(a_1001,2130705124);a_1026(1,a_1005,0,a_P);a_L1=a_P[0];
a_1017(a_L1,a_P);a_1020=a_P[0];
if(a_equal(to_LIST(a_1005)->alwb,to_LIST(a_1005)->aupb)){ goto a_G6;}
a_1437(a_1001,2130705119); return;
...
a_1478(); return;
a_G8:a_1432(a_1001,2130705171); return;
} /* findasyncrules */
...
a_L2=a_1472;
a_1478(); goto a_G5;
a_G4:a_1432(a_1001,2130705128); return;
...
a_1478();
a_1432(a_1001,2130705165); return;
...
a_1478(); return;
a_G6:a_1432(a_1001,2130705160); return;
} /* rulesection */
static void a_1104(void){ /* skiprule */
...
a_L4=2; goto a_G26;
a_G22:a_1432(a_1001,2130705155); return;
...
a_1478(); goto a_G6;
a_G13:a_1432(a_1001,2130705128); return;
...
a_L1=a_1472;
a_1478(); goto a_G6;
a_G5:a_1432(a_1001,2130705128); return;
...
a_1432(a_1001,2130705148); return;
} /* advancenode */
...
a_1478();
a_1432(a_1001,2130705143); return;
...
a_1478();
a_1432(a_1001,2130705138); return;
...
a_1478(); goto a_G23;
a_G22:a_1432(a_1001,2130705128); return;
a_G23:if(!a_equal(16777455,a_1471)){ goto a_G22;}
 goto a_G4;
a_G25:a_1432(a_1001,2130705133); return;
} /* skipaffix */
...
a_L2=a_1472;
a_1478(); goto a_G9;
a_G8:a_1432(a_1001,2130705128); return;
...
a_1478(); goto a_G17;
a_G16:a_1432(a_1001,2130705128); return;
...
a_1478(); goto a_G26;
a_G25:a_1432(a_1001,2130705128); return;
...
a_1478(); goto a_G16;
a_G15:a_1432(a_1001,2130705128); return;
...
a_L2=a_1472;
a_1478(); goto a_G7;
a_G6:a_1432(a_1001,2130705128); return;
...
a_1478(); goto a_G1;
a_G10:a_1432(a_1001,2130705128); return;
...
a_1478(); goto a_G1;
a_G9:a_1432(a_1001,2130705128); return;
...
a_L1=a_1472;
a_1478(); goto a_G8;
a_G7:a_1432(a_1001,2130705175); return;
...
a_L2=a_1472;
a_1478(); goto a_G10;
a_G9:a_1432(a_1001,2130705175); return 1;
...
a_1478(); goto a_G1;
a_G6:a_1432(a_1001,2130705175); return;
} /* skipfillinitializer */
static void a_1170(void){ /* generatefillentries */
...
a_L1=a_1472;
a_1478(); goto a_G5;
a_G4:a_1432(a_1001,2130705175); return;
...
a_P[0]=2130705260;a_1117(a_1001,1,a_P);
a_G4:a_incr(a_F1);
a_L4=to_LIST(a_1457)->offset[a_F1];
...
a_subtr(0,a_L4,a_L4);
a_P[0]=2130705257;a_P[1]=a_L4;a_1117(a_1001,2,a_P); return;
a_G12:if(!a_equal(a_F2,0)){ goto a_G14;}
a_P[0]=2130705252;a_P[1]=a_L4;a_1117(a_1001,2,a_P); return;
a_G14:a_P[0]=2130705247;a_P[1]=a_L4;a_P[2]=a_F2;a_1117(a_1001,3,a_P); return;
} /* repeatblockcall */
...
if(a_equal(a_F1,0)){ return;}
a_P[0]=2130705242;a_1117(a_1001,1,a_P); return;
} /* tracepre */
...
if(a_lseq(a_F2,0)){ return;}
a_P[0]=2130705237;a_1117(a_1001,1,a_P); return;
...
a_G7:a_1232(a_F2);
a_P[0]=2130705234;a_P[1]=a_L9;a_P[2]=a_1140;a_1117(a_1001,3,a_P);
...
a_P[0]=2130705230;a_1117(a_1001,1,a_P);
...
a_P[0]=2130705227;a_P[1]=a_F4;a_1117(a_1001,2,a_P); goto a_G20;
a_G19:a_P[0]=2130705222;a_P[1]=a_F4;a_1117(a_1001,2,a_P);
a_G20:a_incr(a_L7);
...
a_P[0]=2130705217;a_P[1]=a_L6;a_P[2]=a_F4;a_1117(a_1001,3,a_P); return;
} /* repeatblockpostload */
...
a_1120(a_F1);
a_P[0]=2130705227;a_P[1]=a_L4;a_1117(a_1001,2,a_P);
a_G11:a_incr(a_L4);
...
a_P[0]=2130705201;a_1117(a_1001,1,a_P); return;
a_G8:a_P[0]=2130705197;a_1117(a_1001,1,a_P); return;
...
a_P[0]=2130705194;a_1117(a_1001,1,a_P); return;
a_G3:if(!a_equal(a_F1,2)){ goto a_G5;}
a_P[0]=2130705191;a_P[1]=a_F2;a_1117(a_1001,2,a_P); return;
...
a_P[0]=2130705187;a_P[1]=a_F3;a_P[2]=a_F2;a_1117(a_1001,3,a_P); return;
...
a_incr(a_A[0]); goto a_G1;
a_G5:a_1437(a_1001,2130705183); return;
...
{register int *a_r1=a_extension(a_1391,3);a_r1[0]=a_r1[1]=0;a_r1[2]=a_F1;to_LIST(a_1391)->aupb+=3;}
  return;
a_G4:a_P[0]=2019445735;a_P[1]=200;a_1435(2,a_P); return;
} /* extendFILES */
...
a_P[0]=2019445714;a_1433(1,a_P); return;
a_G6:if(!a_1408(a_1001,2130706321)){ goto a_G8;}
a_P[0]=2019445628;a_P[1]=155851704;a_1438(2,a_P); return;
a_G8:if(!a_1408(a_1001,2130706317)){ goto a_G10;}
a_P[0]=2019445698;a_P[1]=1;a_P[2]=2;a_1438(3,a_P); return;
a_G10:if(!a_1408(a_1001,2130706312)){ goto a_G13;}
a_1396=0;
a_G12:a_previousstring(a_1504,a_1397); goto a_G4;
a_G13:if(!a_1408(a_1001,2130706307)){ goto a_G15;}
a_1169=1; goto a_G12;
...
a_P[0]=2019445723;a_P[1]=111;a_1433(2,a_P); return;
...
a_P[0]=2019445723;a_P[1]=76;a_1433(2,a_P); return;
...
a_P[0]=2019445744;a_P[1]=a_F1;a_1435(2,a_P); return;
} /* tryopen */
...
a_P[0]=2019445755;a_P[1]=a_F1;a_1435(2,a_P); return;
...
a_1441(a_1001,2130706352); return;
...
a_G11:a_1437(a_1001,2130706348); return;
} /* printpointer */
...
a_1437(a_1001,2130706342); return;
...
a_G14:a_1441(a_1001,2130706332); goto a_G7;
...
a_1439(70);
a_1403(a_P);a_L2=a_P[0];
a_P[0]=2019445791;a_P[1]=a_L2;a_1436(2,a_P);
a_1441(a_F1,a_F2);
a_P[0]=2019445796;a_1436(1,a_P);
a_1440();
a_exit(3); return;
} /* corrupticefile */
...
int a_P[1];
a_1439(70);
a_P[0]=2019445778;a_1436(1,a_P);
a_1441(a_F1,a_F2);
a_P[0]=2019445783;a_1436(1,a_P);
a_1440();
a_exit(15); return;
} /* internalerror */
...
a_G8:a_1432(a_1001,2130706399); return;
...
a_G28:a_1432(a_1001,2130706394); return;
} /* readdestination */
...
a_G16:a_1437(a_1001,2130706388); return;
} /* rehash */
...
a_1477(); goto a_G12;
a_G11:a_1432(a_1001,2130706372); return;
...
a_1477(); goto a_G16;
a_G15:a_1432(a_1001,2130706367); return;
...
a_G16:a_1432(a_1001,2130706399); return;
...
a_G117:a_1432(a_1001,2130706362); return;
} /* nextsymbol */
