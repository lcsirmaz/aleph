...
-1}; /* fill table size 2468 */
static void a_data_setup(void){
 a_virtual_min=16777216;a_virtual_max=2130706432;
 a_setup_list(0,a_1001,"@StringTable",1,2130705109,2130706411,1303); /* @StringTable */
 ...
 a_setup_charfile(a_1118,"TARGET",2,a_1001,2130706107); /* TARGET */
 a_setup_charfile(a_1431,"PRINTFILE",2,a_1001,2130706360); /* PRINTFILE */
 a_setup_charfile(a_1462,"SOURCE",1,a_1001,2130706407); /* SOURCE */
 a_list_fill(a_FILL);
}
...
a_1501(a_1118,a_1001,2130706102); return;
a_G21:a_1501(a_1118,a_1001,2130706097);
...
a_1501(a_1118,a_1001,2130706092); return;
a_G4:a_1501(a_1118,a_1001,2130706087); return;
a_G5:a_1501(a_1118,a_1001,2130706082); return;
a_G6:a_1501(a_1118,a_1001,2130706077);
a_1198(a_F1);
a_1501(a_1118,a_1001,2130706073); return;
} /* printgoto */
...
a_1501(a_1118,a_1001,2130706068); goto a_G9;
a_G8:a_L2=0;
...
a_1501(a_1118,a_1001,2130706063);
a_1198(a_F1);
a_putchar(a_1118,10);
a_1437(a_1001,2130706059); return;
} /* TE */
...
a_add(a_L3,1,a_L2);
a_G4:if(a_less(to_LIST(a_1457)->aupb,a_L2)){ goto a_G45;}
...
a_putchar(a_1118,37); goto a_G45;
a_G11:{register int a_r1=to_LIST(a_1457)->offset[a_L2];
 ...
 if(a_r1==112){ goto a_G35;}
 if(a_r1==115){ goto a_G38;}
 if(a_r1==116){ goto a_G41;}
  goto a_G44;}
...
a_G4:a_P[0]=2130706043;a_P[1]=a_F1;a_1117(a_1001,2,a_P); return;
} /* addcallstack */
static void a_1234(void){ /* usecallstack */
...
a_P[0]=2130706032;a_P[1]=1;a_P[2]=2;a_1117(a_1001,3,a_P);
...
a_P[0]=2130706014;a_P[1]=to_LIST(a_1312)->offset[a_L1-5];a_1117(a_1001,2,a_P); goto a_G2;
a_G7:a_P[0]=2130706008;a_P[1]=a_L1;a_P[2]=to_LIST(a_1312)->offset[a_L1-5];a_1117(a_1001,3,a_P); goto a_G2;
a_G8:if(!a_1419(0,a_P)){ goto a_G15;}
a_P[0]=2130706003;a_1117(a_1001,1,a_P);
a_L1=0;
a_G11:if(!a_1419(a_L1,a_P)){ goto a_G14;}a_L2=a_P[0];
a_putchar(a_1118,a_L2);
a_incr(a_L1); goto a_G11;
a_G14:a_P[0]=2130705997;a_1117(a_1001,1,a_P);
a_G15:a_P[0]=2130705993;a_P[1]=155851729;a_1117(a_1001,2,a_P);
a_P[0]=2130705989;a_P[1]=a_1141;a_1117(a_1001,2,a_P);
a_P[0]=2130705980;a_P[1]=a_1169;a_1117(a_1001,2,a_P);
...
a_P[0]=2130705993;a_P[1]=a_L2;a_1117(a_1001,2,a_P); goto a_G21;
a_G23:a_P[0]=2130705959;a_P[1]=155851690;a_P[2]=155851697;a_1117(a_1001,3,a_P); return;
} /* targetprelude */
static void a_1228(void){ /* targetpostlude */
int a_L1;int a_L2;int a_P[2];
a_L1=0;
...
a_G4:a_P[0]=2130705993;a_P[1]=155851748;a_1117(a_1001,2,a_P); return;
} /* targetpostlude */
static void a_1235(int a_F1){ /* vardeclaration+>a */
int a_P[4];
if(a_1350(a_F1,16)){ return;}
a_P[0]=2130705945;a_P[1]=a_F1;a_P[2]=to_LIST(a_1312)->offset[a_F1-1];a_P[3]=a_F1;a_1117(a_1001,4,a_P); return;
} /* vardeclaration */
...
a_P[0]=2130705938;a_P[1]=a_F2;a_P[2]=a_F1;a_P[3]=a_F2;a_P[4]=a_L3;a_1117(a_1001,5,a_P); return;
a_G4:a_1334(a_F2,a_P);a_L3=a_P[0];
a_1345(a_F2,a_P);a_L5=a_P[0];
a_1344(a_F2,a_P);a_L4=a_P[0];
a_1337(a_F2,a_P);a_L6=a_P[0];
a_P[0]=2130705925;a_P[1]=a_F2;a_P[2]=a_F1;a_P[3]=a_F2;a_P[4]=a_L3;a_P[5]=a_L4;a_P[6]=a_L5;a_P[7]=a_L6;a_1117(a_1001,8,a_P); return;
} /* listdeclaration */
static void a_1142(int a_F1){ /* charfiledeclaration+>a */
int a_L2;int a_L3;int a_L4;int a_P[6];
if(!a_1350(a_F1,16)){ goto a_G3;}
a_P[0]=2130705911;a_P[1]=a_F1;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
...
a_G11:a_P[0]=2130705899;a_P[1]=a_F1;a_P[2]=a_F1;a_P[3]=a_L2;a_P[4]=a_L3;a_P[5]=a_L4;a_1117(a_1001,6,a_P); return;
} /* charfiledeclaration */
static void a_1152(int a_F1){ /* datafiledeclaration+>a */
int a_L2;int a_L3;int a_L4;int a_L5;int a_P[7];
if(!a_1350(a_F1,16)){ goto a_G3;}
a_P[0]=2130705886;a_P[1]=a_F1;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
a_G3:if(!a_1350(a_F1,64)){ goto a_G5;}
a_L2=2; goto a_G6;
a_G5:a_L2=0;
a_G6:if(!a_1350(a_F1,32)){ goto a_G8;}
...
a_L3=to_LIST(a_1312)->offset[a_L3];
a_G12:a_P[0]=2130705873;a_P[1]=a_F1;a_P[2]=a_F1;a_P[3]=a_L2;a_P[4]=a_L3;a_P[5]=a_L4;a_P[6]=a_L5;a_1117(a_1001,7,a_P); return;
} /* datafiledeclaration */
...
a_G14:a_P[0]=2130705847;a_1117(a_1001,1,a_P); return;
} /* createrulenametable */
...
a_P[0]=2130705843;a_P[1]=a_F1;a_1117(a_1001,2,a_P);
...
static void a_1161(void){ /* filltablehead */
int a_P[1];
a_P[0]=2130705839;a_1117(a_1001,1,a_P);
a_1163=0; return;
} /* filltablehead */
static void a_1162(void){ /* filltabletail */
int a_P[2];
a_P[0]=2130705832;a_P[1]=a_1163;a_1117(a_1001,2,a_P); return;
} /* filltabletail */
static void a_1233(int a_A[1]){ /* untilnextcomma+>a> */

a_G1:if(!a_more(a_A[0],to_LIST(a_1457)->aupb)){ goto a_G3;}
a_1437(a_1001,2130705823); return;
...
a_1478();
a_incr(a_1163);
a_P[0]=2130705814;a_P[1]=a_L1;a_P[2]=a_L1;a_1117(a_1001,3,a_P);
a_L2=to_LIST(a_1457)->aupb;
a_L3=0;
...
a_P[0]=2130705809;a_P[1]=a_L5;a_1117(a_1001,2,a_P);
a_incr(a_1163);
a_unstackto(a_1457,a_L2);
a_L3=0; goto a_G24;
...
a_unstackto(a_1457,a_L2);
a_incr(a_1163);
a_P[0]=2130705805;a_1117(a_1001,1,a_P); return;
} /* generatefillentries */
...
a_P[0]=2130705801;a_P[1]=a_L2;a_P[2]=a_F1;a_P[3]=a_F1;a_1117(a_1001,4,a_P); return;
} /* listinitialization */
static void a_1143(int a_F1){ /* charfileinitialization+>a */
int a_P[4];
if(!a_1350(a_F1,16)){ goto a_G3;}
a_P[0]=2130705801;a_P[1]=to_LIST(a_1312)->offset[a_F1-1];a_P[2]=a_F1;a_P[3]=a_F1;a_1117(a_1001,4,a_P); return;
a_G3:a_P[0]=2130705795;a_P[1]=a_F1;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
...
if(!a_1350(a_F1,16)){ goto a_G3;}
a_P[0]=2130705801;a_P[1]=to_LIST(a_1312)->offset[a_F1-1];a_P[2]=a_F1;a_P[3]=a_F1;a_1117(a_1001,4,a_P); return;
a_G3:a_P[0]=2130705788;a_P[1]=a_F1;a_1117(a_1001,2,a_P);
a_L4=0;
a_L3=1;
a_G6:a_1335(a_F1,a_L3,a_P);a_L2=a_P[0];
if(!a_equal(a_L2,0)){ goto a_G9;}
a_P[0]=2130705782;a_P[1]=a_F1;a_1117(a_1001,2,a_P); return;
a_G9:if(!a_1350(a_L2,8)){ goto a_G11;}
a_L2=to_LIST(a_1312)->offset[a_L2];
a_G11:a_P[0]=a_L4;a_1136(a_P);a_L4=a_P[0];
a_P[0]=2130705777;a_P[1]=a_L2;a_1117(a_1001,2,a_P);
a_incr(a_L3); goto a_G6;
} /* datafileinitialization */
static void a_1154(void){ /* datainitialization */
int a_L1;int a_P[1];
a_P[0]=2130705774;a_1117(a_1001,1,a_P);
a_L1=to_LIST(a_1312)->alwb;
...
a_P[0]=2130705760;a_1117(a_1001,1,a_P);
a_P[0]=2130705753;a_P[1]=a_F1;a_1117(a_1001,2,a_P);
a_1131(0);
a_L2=0;
...
a_L5=1; goto a_G11;
a_G10:a_L5=0;
a_G11:a_P[0]=2130705742;a_P[1]=a_L4;a_P[2]=a_L4;a_P[3]=a_L4;a_P[4]=a_L5;a_P[5]=a_L3;a_P[6]=a_L4;a_P[7]=a_L4;a_P[8]=a_L4;a_1117(a_1001,9,a_P); goto a_G5;
a_G12:a_P[0]=2130705708;a_1117(a_1001,1,a_P); return;
} /* procwaitfor */
static void a_1226(void){ /* targetmain */
...
a_1204(a_L5);
a_G7:a_P[0]=2130705705;a_P[1]=a_L4;a_1117(a_1001,2,a_P);
a_1131(-1);
a_1154();
a_L1=0;a_L3=0;
...
a_L4=1; goto a_G18;
a_G17:a_L4=0;
a_G18:a_P[0]=2130705697;a_P[1]=a_L4;a_P[2]=a_L2;a_1117(a_1001,3,a_P); goto a_G11;
a_G19:if(a_equal(a_1237,0)){ goto a_G21;}
a_P[0]=2130705692;a_P[1]=a_L5;a_1117(a_1001,2,a_P);
a_G21:if(!a_is(a_L3)){ goto a_G23;}
a_P[0]=2130705684;a_P[1]=a_L6;a_P[2]=a_L3;a_1117(a_1001,3,a_P); return;
a_G23:a_1432(a_1001,2130705678); return;
} /* targetmain */
...
a_L2=1; goto a_G4;
a_G3:a_L2=0;
a_G4:a_P[0]=2130705673;a_P[1]=a_L2;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
} /* ruletyper */
...
a_P[0]=2130705667;a_1117(a_1001,1,a_P); return;
} /* outargs */
...
a_P[0]=2130705664;a_1117(a_1001,1,a_P); return;
a_G13:a_P[0]=a_L2;a_1136(a_P);a_L2=a_P[0];
a_P[0]=2130705658;a_P[1]=a_L4;a_1117(a_1001,2,a_P); goto a_G3;
...
{ if(a_L4==16777371){ goto a_G7;}
 ...
 goto a_G13;}
a_G7:a_P[0]=2130705654;a_1117(a_1001,1,a_P); goto a_G3;
a_G8:a_P[0]=2130705651;a_1117(a_1001,1,a_P); goto a_G3;
a_G9:a_P[0]=2130705648;a_1117(a_1001,1,a_P); goto a_G3;
a_G10:a_P[0]=2130705644;a_1117(a_1001,1,a_P); goto a_G3;
a_G11:a_P[0]=2130705640;a_1117(a_1001,1,a_P); goto a_G3;
a_G12:a_P[0]=2130705636;a_1117(a_1001,1,a_P); goto a_G3;
a_G13:a_P[0]=2130705632;a_1117(a_1001,1,a_P); goto a_G3;
...
a_P[0]=2130705629;a_1117(a_1001,1,a_P);
a_L4=32;
...
a_1221(a_F1);
a_1217(a_F1);
a_P[0]=2130705604;a_P[1]=to_LIST(a_1312)->offset[a_F1-4];a_1117(a_1001,2,a_P);
a_1222(a_F1);
a_P[0]=2130705600;a_1117(a_1001,1,a_P);
...
int a_P[1];
if(a_equal(a_F1,0)){ return;}
a_P[0]=2130705597;a_1117(a_1001,1,a_P); return;
} /* startrulebody */
static void a_1219(int a_F1){ /* ruledeclarationtail+>a */
int a_P[2];
if(!a_equal(a_F1,0)){ goto a_G3;}
a_P[0]=2130705585;a_P[1]=a_1230;a_1117(a_1001,2,a_P); return;
a_G3:a_P[0]=2130705581;a_P[1]=a_1230;a_1117(a_1001,2,a_P); return;
} /* ruledeclarationtail */
static void a_1133(void){ /* addprofilingdef */
int a_L1;int a_L2;int a_P[3];
...
a_P[0]=2130705576;a_P[1]=a_L2;a_P[2]=a_L1;a_1117(a_1001,3,a_P);
if(!a_equal(a_1180,0)){ goto a_G8;}
a_P[0]=2130705565;a_1117(a_1001,1,a_P); goto a_G9;
a_G8:a_P[0]=2130705561;a_P[1]=a_1180;a_1117(a_1001,2,a_P);
a_G9:a_P[0]=2130705557;a_1117(a_1001,1,a_P);
a_1180=a_L2; return;
} /* addprofilingdef */
static void a_1132(void){ /* addprofilingcount */
int a_P[2];
...
a_P[0]=2130705553;a_P[1]=to_LIST(a_1312)->offset[a_1230];a_1117(a_1001,2,a_P); return;
} /* addprofilingcount */
static void a_1205(void){ /* profilingdeclaration */
int a_P[2];
a_P[0]=2130705546;a_1117(a_1001,1,a_P);
if(!a_equal(a_1180,0)){ goto a_G4;}
a_P[0]=2130705539;a_1117(a_1001,1,a_P); return;
a_G4:a_P[0]=2130705535;a_P[1]=a_1180;a_1117(a_1001,2,a_P); return;
...
a_G10:a_P[0]=2130705530;a_P[1]=to_LIST(a_1312)->offset[a_1230-2];a_P[2]=a_L2;a_1117(a_1001,3,a_P);
a_L3=0;
...
a_G18:a_P[0]=2130705523;a_1117(a_1001,1,a_P); return;
} /* addtracing */
static void a_1134(int a_F1){ /* addrulename+>a */
int a_P[2];
if(a_equal(a_F1,0)){ return;}
if(a_mreq(to_LIST(a_1312)->offset[a_1230-2],0)){ return;}
a_P[0]=2130705519;a_P[1]=a_1230;a_1117(a_1001,2,a_P); return;
} /* addrulename */
...
a_P[0]=2130705510;a_P[1]=a_F1;a_1117(a_1001,2,a_P); return;
} /* Tlabel */
static void a_1179(int a_F1){ /* jumptolabel+>a */
int a_P[2];
if(a_equal(a_F1,a_1186)){ return;}
a_P[0]=2130705505;a_P[1]=a_F1;a_1117(a_1001,2,a_P); return;
} /* jumptolabel */
...
{register int a_r1=to_LIST(a_1457)->offset[a_A[0]];
 ...
 if(a_r1==16777448){ goto a_G5;}
  goto a_G7;}
a_G2:a_P[0]=2130705501;a_P[1]=a_A[0];a_1117(a_1001,2,a_P);
a_G3:a_incr(a_A[0]);
a_incr(a_A[0]); return;
a_G5:a_incr(a_A[0]);
...
a_incr(a_A[0]);
a_P[0]=2130705498;a_P[1]=a_A[0];a_P[2]=a_L2;a_1117(a_1001,3,a_P); goto a_G3;
} /* Taffixinner */
...
a_G7:a_1437(a_1001,2130705494); return;
} /* Tlimittail */
static void a_1125(int a_A[1]){ /* Tindex+>a> */
int a_L2;int a_P[3];
if(!a_1350(a_1230,67108864)){ goto a_G12;}
a_P[0]=2130705489;a_P[1]=a_A[0];a_P[2]=a_A[0];a_1117(a_1001,3,a_P);
a_incr(a_A[0]);
a_incr(a_A[0]);
...
a_P[0]=2130705481;a_P[1]=a_L2;a_1117(a_1001,2,a_P);
a_G11:a_P[0]=2130705478;a_P[1]=to_LIST(a_1312)->offset[a_1230-2];a_1117(a_1001,2,a_P); return;
a_G12:a_P[0]=2130705474;a_P[1]=a_A[0];a_P[2]=a_A[0];a_1117(a_1001,3,a_P);
a_incr(a_A[0]);
a_incr(a_A[0]);
a_P[0]=a_A[0];a_1121(a_P);a_A[0]=a_P[0];
a_incr(a_A[0]);
...
a_P[0]=2130705467;a_1117(a_1001,1,a_P); return;
a_G21:a_P[0]=2130705464;a_P[1]=a_L2;a_1117(a_1001,2,a_P); return;
} /* Tindex */
...
a_incr(a_L4);
a_P[0]=2130705460;a_P[1]=a_F1;a_P[2]=2019445237;a_P[3]=a_L5;a_1117(a_1001,4,a_P); goto a_G6;
a_G10:a_1120(a_F3);
a_putchar(a_1118,59); return;
} /* extensionblock */
...
a_incr(a_F1);
a_L3=a_F1;
a_P[0]=2130705454;a_P[1]=2019445237;a_P[2]=a_L3;a_P[3]=a_L4;a_1117(a_1001,4,a_P);
a_add(2,a_F1,a_F1);
a_G7:a_1158(a_L3,a_L4,a_F1);
a_F1=to_LIST(a_1457)->offset[a_F1];
if(!a_equal(a_F1,0)){ goto a_G7;}
a_P[0]=2130705445;a_P[1]=a_L3;a_P[2]=a_L4;a_1117(a_1001,3,a_P);
a_1179(a_F2); return;
} /* Textension */
...
a_P[0]=2130705439;a_P[1]=a_A[0];a_1117(a_1001,2,a_P);
a_1120(a_F1);
a_P[0]=2130705434;a_1117(a_1001,1,a_P); return;
} /* boxclassifier */
...
a_P[0]=2130705431;a_P[1]=a_F3;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
a_G3:if(!a_1188(a_F1,a_1019)){ goto a_G5;}
a_P[0]=2130705427;a_P[1]=a_F3;a_P[2]=a_F2;a_1117(a_1001,3,a_P); return;
a_G5:if(!a_1188(a_F2,a_1018)){ goto a_G7;}
a_P[0]=2130705423;a_P[1]=a_F3;a_P[2]=a_F1;a_1117(a_1001,3,a_P); return;
a_G7:a_P[0]=2130705419;a_P[1]=a_F1;a_P[2]=a_F3;a_P[3]=a_F3;a_P[4]=a_F2;a_1117(a_1001,5,a_P); return;
} /* Tsingleifcondition */
...
a_P[0]=2130705412;a_1117(a_1001,1,a_P); goto a_G1;
} /* Tifcondition */
...
a_incr(a_F1);
a_L3=to_LIST(a_1457)->offset[a_F1];
a_P[0]=2130705409;a_1117(a_1001,1,a_P);
a_1124(a_F1,a_F2);
a_P[0]=2130705405;a_P[1]=a_F2;a_1117(a_1001,2,a_P);
if(!a_mreq(to_LIST(a_1312)->offset[a_1230-2],0)){ goto a_G10;}
a_P[0]=2130705398;a_P[1]=to_LIST(a_1312)->offset[a_1230-2];a_1117(a_1001,2,a_P); goto a_G11;
a_G10:a_P[0]=2130705392;a_1117(a_1001,1,a_P);
a_G11:a_P[0]=2130705387;a_1117(a_1001,1,a_P);
if(a_equal(a_L3,a_1186)){ return;}
a_P[0]=2130705383;a_P[1]=to_LIST(a_1457)->offset[a_F1];a_1117(a_1001,2,a_P); return;
...
a_P[0]=2130705409;a_1117(a_1001,1,a_P);
a_1124(a_F1,a_F2);
a_P[0]=2130705380;a_P[1]=a_L4;a_1117(a_1001,2,a_P); return;
a_G24:a_P[0]=2130705375;a_1117(a_1001,1,a_P);
a_1124(a_F1,a_F2);
a_P[0]=2130705371;a_P[1]=a_L3;a_1117(a_1001,2,a_P);
if(a_equal(a_L4,a_1186)){ return;}
a_P[0]=2130705383;a_P[1]=a_L4;a_1117(a_1001,2,a_P); return;
a_G29:a_incr(a_F1);
a_P[0]=2130705375;a_1117(a_1001,1,a_P);
a_1124(a_F1,a_F2);
a_P[0]=2130705366;a_P[1]=to_LIST(a_1457)->offset[a_F1];a_1117(a_1001,2,a_P);
a_F1=a_L5; goto a_G1;
} /* Tjumptoareas */
static void a_1122(int a_F1,int a_F2){ /* Tbox+>a+>a */
int a_L3;int a_P[1];
a_P[0]=2130705362;a_1117(a_1001,1,a_P);
a_incr(a_F1);
a_1139(a_F1,a_P);a_L3=a_P[0];
a_incr(a_F2);
a_1126(a_F2,a_L3);
a_P[0]=2130705708;a_1117(a_1001,1,a_P); return;
} /* Tbox */
...
a_P[0]=2130705359;a_P[1]=a_F1;a_P[2]=a_F4;a_1117(a_1001,3,a_P); return;
...
a_G6:a_P[0]=2130705353;a_P[1]=a_L3;a_P[2]=a_F2;a_P[3]=a_F1;a_1117(a_1001,4,a_P); return;
a_G7:a_P[0]=2130705342;a_P[1]=a_F1;a_P[2]=a_L3;a_1117(a_1001,3,a_P); return;
} /* genshiftaffix */
static void a_1171(int a_F1,int a_F2,int a_F3){ /* gengetaffixno+>a+>a+>a */
int a_P[2];
if(!a_noteq(a_F1,2)){ goto a_G3;}
a_1432(a_1001,2130705332); return;
a_G3:if(!a_1177(a_F2)){ goto a_G5;}
a_P[0]=2130705326;a_P[1]=a_F3;a_1117(a_1001,2,a_P); return;
a_G5:a_1120(a_F2);
a_P[0]=2130705322;a_P[1]=a_F3;a_1117(a_1001,2,a_P); return;
} /* gengetaffixno */
static void a_1173(int a_F1,int a_F2){ /* genwaitfor+>a+>a */
int a_P[2];
a_P[0]=2130705317;a_1117(a_1001,1,a_P);
a_1120(a_F1);
a_P[0]=a_F1;a_1185(a_P);a_F1=a_P[0];
a_putchar(a_1118,44);
a_1120(a_F1);
a_P[0]=2130705312;a_P[1]=a_F2;a_1117(a_1001,2,a_P); return;
} /* genwaitfor */
...
a_P[0]=2130705308;a_P[1]=a_A[0];a_1117(a_1001,2,a_P);
a_1120(a_F1);
a_putchar(a_1118,59);
a_A[1]=1; return;
} /* assignmentsource */
...
a_G26:a_P[0]=2130705303;a_P[1]=a_L6;a_1117(a_1001,2,a_P); goto a_G17;
a_G27:if(a_equal(a_F2,0)){ goto a_G29;}
a_P[0]=2130705299;a_P[1]=2019445240;a_P[2]=2019445240;a_P[3]=2019445240;a_P[4]=2019445240;a_P[5]=a_L6;a_1117(a_1001,6,a_P);
a_G29:if(a_equal(a_L7,0)){ goto a_G31;}
a_putchar(a_1118,125);
a_G31:a_P[0]=2130705326;a_P[1]=a_F4;a_1117(a_1001,2,a_P); return;
} /* genassignment */
...
a_P[0]=2130705286;a_P[1]=a_F4;a_1117(a_1001,2,a_P);
a_G16:a_1120(a_F1);
a_putchar(a_1118,59); goto a_G19;
a_G18:a_P[0]=2130705282;a_P[1]=a_F4;a_1117(a_1001,2,a_P); goto a_G16;
a_G19:a_incr(a_L9);
...
a_P[0]=2130705278;a_P[1]=a_L6;a_P[2]=a_F4;a_1117(a_1001,3,a_P); return;
} /* repeatblockpreload */
...
a_P[0]=2130705286;a_P[1]=a_L4;a_1117(a_1001,2,a_P);
a_incr(a_L4);
a_1120(a_F1);
...
a_P[0]=2130705262;a_1117(a_1001,1,a_P);
a_G4:a_incr(a_F1);
a_L4=to_LIST(a_1457)->offset[a_F1];
...
a_P[0]=2130705254;a_P[1]=a_L4;a_1117(a_1001,2,a_P); return;
a_G14:a_P[0]=2130705249;a_P[1]=a_L4;a_P[2]=a_F2;a_1117(a_1001,3,a_P); return;
} /* repeatblockcall */
...
if(a_equal(a_F1,0)){ return;}
a_P[0]=2130705244;a_1117(a_1001,1,a_P); return;
} /* tracepre */
...
if(a_lseq(a_F2,0)){ return;}
a_P[0]=2130705239;a_1117(a_1001,1,a_P); return;
...
a_G7:a_1232(a_F2);
a_P[0]=2130705236;a_P[1]=a_L9;a_P[2]=a_1140;a_1117(a_1001,3,a_P);
...
a_P[0]=2130705232;a_1117(a_1001,1,a_P);
...
a_P[0]=2130705229;a_P[1]=a_F4;a_1117(a_1001,2,a_P); goto a_G20;
a_G19:a_P[0]=2130705224;a_P[1]=a_F4;a_1117(a_1001,2,a_P);
a_G20:a_incr(a_L7);
...
a_P[0]=2130705219;a_P[1]=a_L6;a_P[2]=a_F4;a_1117(a_1001,3,a_P); return;
} /* repeatblockpostload */
...
a_1120(a_F1);
a_P[0]=2130705229;a_P[1]=a_L4;a_1117(a_1001,2,a_P);
a_G11:a_incr(a_L4);
...
a_G4:a_P[0]=2130705326;a_P[1]=a_F3;a_1117(a_1001,2,a_P); return;
} /* regularcalld3 */
...
a_G3:a_1432(a_1001,2130706152); return;
} /* checklisttype */
...
a_G3:a_1432(a_1001,2130706146); return;
} /* checkcalibretype */
...
a_G5:a_1432(a_1001,2130706139); return;
} /* checkconstanttype */
static void a_1264(void){ /* readexpression */
int a_L1;int a_L2;int a_P[1];
if(!a_equal(16777471,a_1471)){ goto a_G4;}
a_L1=a_1472;
a_1478(); goto a_G5;
a_G4:a_1432(a_1001,2130706111); return;
a_G5:a_1246(a_L1,1);
if(a_equal(to_LIST(a_1312)->offset[a_L1-1],0)){ goto a_G8;}
a_G7:a_1432(a_1001,2130706132); return;
a_G8:a_1263(a_L1);
...
a_1437(a_1001,2130706126); return;
...
a_1432(a_1001,2130706126); return;
...
a_G24:a_1432(a_1001,2130706121); return;
} /* finalbase */
...
int a_L2;int a_L3;int a_P[3];
if(!a_1350(a_F1,8)){ goto a_G3;}
a_1437(a_1001,2130706116); return;
a_G3:if(a_1350(a_F1,32)){ return;}
if(!a_1350(a_F1,64)){ goto a_G8;}
a_P[0]=2019445299;a_P[1]=to_LIST(a_1312)->offset[a_F1-4];a_P[2]=a_F1;a_1433(3,a_P);
...
a_incr(a_1249);
if(a_was(a_1240,a_1249)){ goto a_G14;}
a_1432(a_1001,2130706116); return;
...
a_G3:if(!a_equal(16777486,a_1471)){ goto a_G6;}
a_1478();
a_1432(a_1001,2130706236); return;
a_G6:a_1478(); goto a_G1;
} /* skipentry */
static void a_1304(void){ /* skipdatasection */
...
a_1432(a_1001,2130706231); return;
} /* skipdatasection */
static void a_1278(void){ /* datasectioni */
...
if(a_equal(a_1471,16777285)){ return;}
a_1432(a_1001,2130706225); return;
} /* datasectioni */
...
if(!a_1350(a_F1,24)){ return;}
a_G3:a_1432(a_1001,2130706219); return;
} /* checklisttype */
...
a_G4:a_1432(a_1001,2130706213); return;
} /* checkconstanttype */
...
a_G3:a_1432(a_1001,2130706206); return;
...
if(!a_1350(a_F1,24)){ return;}
a_G3:a_1432(a_1001,2130706198); return;
} /* checkfiletype */
static void a_1283(void){ /* fileentry */
int a_L1;int a_L2;int a_L3;int a_P[1];
if(!a_equal(16777471,a_1471)){ goto a_G4;}
a_L1=a_1472;
a_1478(); goto a_G5;
a_G4:a_1432(a_1001,2130706156); return;
a_G5:a_1272(a_L1);
if(!a_equal(16777455,a_1471)){ goto a_G4;}
a_L2=a_1472;
a_1478();
...
a_L1=a_1472;
a_1478(); goto a_G7;
a_G6:a_1432(a_1001,2130706156); return;
...
a_L2=a_1472;
a_1478(); goto a_G13;
a_G12:a_1432(a_1001,2130706156); return;
...
a_G10:a_1432(a_1001,2130706192); return;
...
a_G17:a_1432(a_1001,2130706185); return;
...
a_1437(a_1001,2130706180); return;
} /* datasectionii */
static void a_1282(void){ /* externalentry */
int a_L1;int a_L2;
if(!a_equal(16777471,a_1471)){ goto a_G4;}
...
a_G12:a_1432(a_1001,2130706174); return;
...
a_G9:if(!a_equal(16777471,a_1471)){ goto a_G11;}
 goto a_G7;
a_G11:a_1432(a_1001,2130706156); return;
...
a_L4=a_1472;
a_1478(); goto a_G10;
a_G9:a_1432(a_1001,2130706156); return;
...
if(a_equal(a_1471,16777285)){ return;}
a_1432(a_1001,2130706168); return;
} /* datasectioniii */
...
a_G12:a_1437(a_1001,2130706162); return;
...
a_L5=a_1472;
a_1478(); goto a_G7;
a_G6:a_1432(a_1001,2130706240); return;
a_G7:a_1363(a_L5);
...
a_incr(to_LIST(a_1311)->offset[a_F1-1]);
a_1363(a_L4); return;
a_G20:a_1432(a_1001,2130706273); return;
} /* formalaffixes */
...
a_L2=a_1472;
a_1478(); goto a_G5;
a_G4:a_1432(a_1001,2130706240); return;
...
a_1432(a_1001,2130706267); return;
} /* checkitemID */
static void a_1326(void){ /* enteritem */
int a_L1;int a_P[1];
...
a_1478(); goto a_G6;
a_G5:a_1432(a_1001,2130706240); return;
...
a_G19:a_1432(a_1001,2130706262); return;
...
a_G10:a_1432(a_1001,2130706257); return;
...
to_LIST(a_1312)->offset[to_LIST(a_1312)->aupb-4]=a_1472;
a_1478(); goto a_G15;
a_G14:a_1432(a_1001,2130706240); return;
...
a_1478();
a_1320(); goto a_G26;
a_G25:a_1432(a_1001,2130706250); return;
a_G26:a_1356();
...
a_G10:a_1437(a_1001,2130706245); return;
} /* scanitem */
...
a_G6:if(!a_1408(a_1001,2130706324)){ goto a_G8;}
a_P[0]=2019445630;a_P[1]=155851704;a_1438(2,a_P); return;
a_G8:if(!a_1408(a_1001,2130706320)){ goto a_G10;}
a_P[0]=2019445700;a_P[1]=1;a_P[2]=2;a_1438(3,a_P); return;
a_G10:if(!a_1408(a_1001,2130706315)){ goto a_G13;}
a_1396=0;
a_G12:a_previousstring(a_1504,a_1397); goto a_G4;
a_G13:if(!a_1408(a_1001,2130706310)){ goto a_G15;}
a_1169=0; goto a_G12;
a_G15:if(!a_1408(a_1001,2130706305)){ goto a_G20;}
...
a_G20:if(!a_1408(a_1001,2130706302)){ goto a_G25;}
a_previousstring(a_1504,a_1397);
...
a_G25:if(!a_1408(a_1001,2130706299)){ goto a_G27;}
a_1372(); goto a_G12;
a_G27:if(!a_1408(a_1001,2130706296)){ goto a_G29;}
a_1234(); goto a_G12;
a_G29:if(!a_1402(a_1001,2130706293)){ return;}
...
a_G6:a_1437(a_1001,2130706289); return;
} /* stringtoBUFFER */
...
a_1437(a_1001,2130706283); return;
...
a_L2=a_1472;
a_1478(); goto a_G10;
a_G9:a_1432(a_1001,2130706277); return;
...
a_1441(a_1001,2130706355); return;
...
a_G11:a_1437(a_1001,2130706351); return;
} /* printpointer */
...
a_1437(a_1001,2130706345); return;
...
a_G14:a_1441(a_1001,2130706335); goto a_G7;
...
a_G8:a_1432(a_1001,2130706402); return;
...
a_G28:a_1432(a_1001,2130706397); return;
} /* readdestination */
...
a_G16:a_1437(a_1001,2130706391); return;
} /* rehash */
...
a_1477(); goto a_G12;
a_G11:a_1432(a_1001,2130706375); return;
...
a_1477(); goto a_G16;
a_G15:a_1432(a_1001,2130706370); return;
...
a_G16:a_1432(a_1001,2130706402); return;
...
a_G117:a_1432(a_1001,2130706365); return;
} /* nextsymbol */
