...
followed by and \g{input-tail}, whereas the rule for \g{primary} can be read
...
The following approximate translation to \g{ALGOL 68} might be helpful:
\begin{program}
...
This definition of \pp|get next symbol|
%\footnote{In the manuscript {\tft get char}.}
implies we have decided that spaces and
...
\end{program}
\noindent
the virtual address space could have the layout in Table \ref{4.1.4}.
...
of the file and be reread or rewritten. The file
...
the \g{area}. The data-item then consists of the offset
