...
\end{program}
If \pp|is zero| were substituted verbatim, it would shifts out all affixes
and the computation in \pp|math| cannot be carried over. 
...
affix blockno| would give syntax error:
...
The \g{dummy affix} \pp|\#| translates to nothing, thus leaves an empty parameter
