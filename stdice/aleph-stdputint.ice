...
350 383 "aleph-stdarg"
384 429 "aleph-stdputint"
430 463 "aleph-stdputline"
464 497 "aleph-stdputstring"
498 534 "aleph-stdputasstring"
535 583 "aleph-stdgetint"
584 626 "aleph-stdgetline"
627 661 "aleph-stdwait"
662 695 "aleph-stdin"
696 729 "aleph-stdout"
.
<rule> I1 520 114 2 <formal in> <formal in> "stdlib" "@equal"
<rule> I2 520 114 2 <formal in> <formal in> "stdlib" "@less"
<rule> I3 520 115 2 <formal in> <formal in> "stdlib" "@more"
<rule> I4 16640 46 0 "stdlib" "@root"
<rule> I5 8 104 3 <formal in> <formal in> <formal out> "stdlib" "add"
<rule> I6 8 106 1 <formal inout> "stdlib" "decr"
<rule> I7 8 106 4 <formal in> <formal in> <formal out> <formal out> "stdlib" "divrem"
<rule> I8 8 107 2 <formal in> <formal out> "stdlib" "getabs"
<constant> I9 0 346 "stdlib" "intsize"
<constant> I10 0 344 "stdlib" "maxint"
<constant> I11 0 345 "stdlib" "minint"
<rule> I12 264 199 2 <formal file> <formal in> "stdlib" "putchar"
